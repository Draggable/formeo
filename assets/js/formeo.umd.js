...
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
  ...
  class I18N {
    ...
    processConfig(options) {
      const { location: location2, ...restOptions } = { ...DEFAULT_CONFIG$3, ...options };
      const parsedLocation = location2.replace(/\/?$/, "/");
  ...
  const { env, resolve } = { url: typeof document === "undefined" && typeof location === "undefined" ? require("url").pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("formeo.umd.js", document.baseURI).href };
  const name = pkg.name;
  ...
  class Field extends Component {
    ...
    constructor(fieldData = /* @__PURE__ */ Object.create(null)) {
      ...
      __publicField(this, "toggleCheckedOptions", (optionIndex, type2) => {
        const updatedOptionData = this.get("options").map((option, index2) => {
    ...
    processOptions(options, elem, isPreview) {
      ...
      const optionMap = (option, i) => {
        ...
        const optionMarkup = {
          ...
          button: (option2) => {
            const { type: type2, label: label2, className, id: id2 } = option2;
            return {
              ...elem,
              attrs: {
                type: type2
