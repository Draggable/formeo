...
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const f of document.querySelectorAll('link[rel="modulepreload"]'))n(f);new MutationObserver(f=>{for(const d of f)if(d.type==="childList")for(const g of d.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&n(g)}).observe(document,{childList:!0,subtree:!0});function t(f){const d={};return f.integrity&&(d.integrity=f.integrity),f.referrerPolicy&&(d.referrerPolicy=f.referrerPolicy),f.crossOrigin==="use-credentials"?d.credentials="include":f.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function n(f){if(f.ep)return;f.ep=!0;const d=t(f);fetch(f.href,d)}})();async function ld(l){try{const e=await fetch(l);if(!e.ok)throw new Error(`HTTP error! status: ${e.status}`);const t=l.endsWith(".lang")?"text":"json";return await e[t]()}catch(e){throw console.error("There has been a problem with your fetch operation:",e),e}}const ca={extension:".lang",location:"assets/lang/",langs:["en-US"],locale:"en-US",override:{}};class Gt{constructor(e=ca){this.langs=Object.create(null),this.loaded=[],this.processConfig(e)}processConfig(e){const{location:t,...n}={...ca,...e},f=t.replace(/\/?$/,"/");this.config={location:f,...n};const{override:d,preloaded:g={}}=this.config,m=Object.entries(this.langs).concat(Object.entries(d||g));this.langs=m.reduce((c,[p,r])=>(c[p]=this.applyLanguage(p,r),c),{}),this.locale=this.config.locale||this.config.langs[0]}init(e){return this.processConfig({...this.config,...e}),this.setCurrent(this.locale)}addLanguage(e,t={}){t=typeof t=="string"?Gt.processFile(t):t,this.applyLanguage(e,t),this.config.langs.push("locale")}getValue(e,t=this.locale){var n;return((n=this.langs[t])==null?void 0:n[e])||this.getFallbackValue(e)}getFallbackValue(e){const t=Object.values(this.langs).find(n=>n[e]);return t?.[e]}makeSafe(e){const t={"{":"\\{","}":"\\}","|":"\\|"};return e=e.replace(/[{}|]/g,n=>t[n]),new RegExp(e,"g")}put(e,t){return this.current[e]=t,t}get(e,t){const n=this;let f=this.getValue(e);if(!f)return;const d=f.match(/\{[^}]+?\}/g);if(t&&d)if(typeof t=="object")for(const g of d){const m=g.substring(1,g.length-1);f=f.replace(n.makeSafe(g),t[m]||"")}else f=f.replace(/\{[^}]+?\}/g,t);return f}static processFile(e){return Gt.fromFile(e.replace(/\n\n/g,`
`))}static fromFile(e){const t=e.split(`
`),n={};for(let f,d=0;d<t.length;d++)f=/^(.+?) *?= *?([^\n]+)/.exec(t[d]),f&&(n[f[1]]=f[2].replace(/(^\s+|\s+$)/g,""));return n}loadLang(e,t=!0){const n=this;return new Promise(function(f,d){if(n.loaded.indexOf(e)!==-1&&t)return n.applyLanguage(n.langs[e]),f(n.langs[e]);{const g=[n.config.location,e,n.config.extension].join("");return ld(g).then(m=>{const c=Gt.processFile(m);return n.applyLanguage(e,c),n.loaded.push(e),f(n.langs[e])}).catch(m=>{console.error(m);const c=n.applyLanguage(e);f(c)})}})}applyLanguage(e,t={}){const n=this.config.override[e]||{},f=this.langs[e]||{};return this.langs[e]={...f,...t,...n},this.langs[e]}get getLangs(){return this.config.langs}async setCurrent(e="en-US"){return await this.loadLang(e),this.locale=e,this.current=this.langs[e],this.current}}const X=new Gt;(function(){try{if(typeof document<"u"){var l=document.createElement("style");l.appendChild(document.createTextNode('._3x4ZIcu-{position:absolute;background:#1f2937;color:#fff;padding:.75rem;border-radius:.375rem;max-width:200px;z-index:50;visibility:hidden;opacity:0;transition:opacity .2s;pointer-events:none;left:0;top:0}._3x4ZIcu-.JIt36hCJ{visibility:visible;opacity:1;pointer-events:all}._3x4ZIcu-:before{content:"";position:absolute;width:0;height:0;border:6px solid transparent}._3x4ZIcu-[data-position=top]:before{border-top-color:#1f2937;bottom:-12px;left:50%;transform:translate(-50%)}._3x4ZIcu-[data-position=bottom]:before{border-bottom-color:#1f2937;top:-12px;left:50%;transform:translate(-50%)}._3x4ZIcu-[data-position=left]:before{border-left-color:#1f2937;right:-12px;top:50%;transform:translateY(-50%)}._3x4ZIcu-[data-position=right]:before{border-right-color:#1f2937;left:-12px;top:50%;transform:translateY(-50%)}._3x4ZIcu-[data-position=top-left]:before{border-top-color:#1f2937;bottom:-12px;left:12px;transform:none}._3x4ZIcu-[data-position=top-right]:before{border-top-color:#1f2937;bottom:-12px;right:12px;left:auto;transform:none}._3x4ZIcu-[data-position=bottom-left]:before{border-bottom-color:#1f2937;top:-12px;left:12px;transform:none}._3x4ZIcu-[data-position=bottom-right]:before{border-bottom-color:#1f2937;top:-12px;right:12px;left:auto;transform:none}')),document.head.appendChild(l)}}catch(e){console.error("vite-plugin-css-injected-by-js",e)}})();var cd=Object.defineProperty,ud=(l,e,t)=>e in l?cd(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t,Ke=(l,e,t)=>ud(l,typeof e!="symbol"?e+"":e,t);const hd="_3x4ZIcu-",dd="JIt36hCJ",Ft={tooltip:hd,visible:dd},fd={triggerName:"tooltip"};class Nu{constructor(e=fd){Ke(this,"triggerName"),Ke(this,"tooltip"),Ke(this,"activeTriggerType",null),Ke(this,"spacing",12),Ke(this,"handleClick",t=>{const n=this.triggerName,f=t.target.closest(`[${n}][${n}-type="click"]`);if(f)if(this.isVisible())this.hide();else{const d=f.getAttribute(`${n}`);this.show(f,d),this.activeTriggerType="click"}else this.hide()}),Ke(this,"handleMouseOver",t=>{const n=this.triggerName,f=t.target.closest(`[${n}]`);if(this.activeTriggerType!=="click"&&f?.getAttribute(`${n}-type`)!=="click"){const d=f?.getAttribute(`${n}`);d&&(this.show(f,d),this.activeTriggerType="hover")}}),Ke(this,"handleMouseOut",t=>{const n=this.triggerName,f=t.target.closest(`[${n}]`);this.activeTriggerType!=="click"&&f?.getAttribute(`${n}-type`)!=="click"&&this.hide()}),Ke(this,"handleResize",()=>{this.isVisible()&&this.hide()}),Ke(this,"handleScroll",()=>{this.isVisible()&&this.hide()}),this.triggerName=`data-${e.triggerName}`,this.tooltip=document.createElement("div"),this.tooltip.className=`d-tooltip ${Ft.tooltip}`,document.body.appendChild(this.tooltip),this.setupEventListeners()}setupEventListeners(){document.addEventListener("mouseover",this.handleMouseOver),document.addEventListener("mouseout",this.handleMouseOut),document.addEventListener("touchstart",this.handleMouseOver),document.addEventListener("touchend",this.handleMouseOut),document.addEventListener("click",this.handleClick),window.addEventListener("resize",this.handleResize),window.addEventListener("scroll",this.handleScroll,!0)}isVisible(){return this.tooltip.classList.contains(Ft.visible)}calculatePosition(e){const t=e.getBoundingClientRect(),n=this.tooltip.getBoundingClientRect(),f=[{name:"top",x:t.left+(t.width-n.width)/2,y:t.top-n.height-this.spacing},{name:"bottom",x:t.left+(t.width-n.width)/2,y:t.bottom+this.spacing},{name:"left",x:t.left-n.width-this.spacing,y:t.top+(t.height-n.height)/2},{name:"right",x:t.right+this.spacing,y:t.top+(t.height-n.height)/2},{name:"top-left",x:t.left,y:t.top-n.height-this.spacing},{name:"top-right",x:t.right-n.width,y:t.top-n.height-this.spacing},{name:"bottom-left",x:t.left,y:t.bottom+this.spacing},{name:"bottom-right",x:t.right-n.width,y:t.bottom+this.spacing}];return f.find(d=>this.fitsInViewport(d,n))||f[0]}fitsInViewport(e,t){return e.x>=0&&e.y>=0&&e.x+t.width<=window.innerWidth&&e.y+t.height<=window.innerHeight?[[e.x,e.y],[e.x+t.width,e.y],[e.x,e.y+t.height],[e.x+t.width,e.y+t.height],[e.x+t.width/2,e.y+t.height/2]].flatMap(([m,c])=>Array.from(document.elementsFromPoint(m,c))).filter(m=>{if(this.tooltip.contains(m)||m===this.tooltip||m.classList.contains(Ft.tooltip)||getComputedStyle(m).pointerEvents==="none")return!1}).length===0:!1}show(e,t){this.tooltip.innerHTML=t??"",this.tooltip.classList.add(Ft.visible);const n=this.calculatePosition(e);this.tooltip.style.left=`${n.x}px`,this.tooltip.style.top=`${n.y}px`,this.tooltip.dataset.position=n.name}hide(){this.tooltip.classList.remove(Ft.visible),this.activeTriggerType=null}destroy(){document.removeEventListener("mouseover",this.handleMouseOver),document.removeEventListener("mouseout",this.handleMouseOut),document.removeEventListener("touchstart",this.handleMouseOver),document.removeEventListener("touchend",this.handleMouseOut),document.removeEventListener("click",this.handleClick),window.removeEventListener("resize",this.handleResize),window.removeEventListener("scroll",this.handleScroll,!0),this.tooltip.remove()}}window!==void 0&&(window.SmartTooltip=Nu);const pd="formeo",gd="4.2.5",Fu={name:pd,version:gd};var an=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function kt(l){return l&&l.__esModule&&Object.prototype.hasOwnProperty.call(l,"default")?l.default:l}var ei,ua;function md(){if(ua)return ei;ua=1;function l(){this.__data__=[],this.size=0}return ei=l,ei}var ti,ha;function nn(){if(ha)return ti;ha=1;function l(e,t){return e===t||e!==e&&t!==t}return ti=l,ti}var ni,da;function Fn(){if(da)return ni;da=1;var l=nn();function e(t,n){for(var f=t.length;f--;)if(l(t[f][0],n))return f;return-1}return ni=e,ni}var ii,fa;function vd(){if(fa)return ii;fa=1;var l=Fn(),e=Array.prototype,t=e.splice;function n(f){var d=this.__data__,g=l(d,f);if(g<0)return!1;var m=d.length-1;return g==m?d.pop():t.call(d,g,1),--this.size,!0}return ii=n,ii}var ri,pa;function yd(){if(pa)return ri;pa=1;var l=Fn();function e(t){var n=this.__data__,f=l(n,t);return f<0?void 0:n[f][1]}return ri=e,ri}var oi,ga;function wd(){if(ga)return oi;ga=1;var l=Fn();function e(t){return l(this.__data__,t)>-1}return oi=e,oi}var si,ma;function bd(){if(ma)return si;ma=1;var l=Fn();function e(t,n){var f=this.__data__,d=l(f,t);return d<0?(++this.size,f.push([t,n])):f[d][1]=n,this}return si=e,si}var ai,va;function Pn(){if(va)return ai;va=1;var l=md(),e=vd(),t=yd(),n=wd(),f=bd();function d(g){var m=-1,c=g==null?0:g.length;for(this.clear();++m<c;){var p=g[m];this.set(p[0],p[1])}}return d.prototype.clear=l,d.prototype.delete=e,d.prototype.get=t,d.prototype.has=n,d.prototype.set=f,ai=d,ai}var li,ya;function Cd(){if(ya)return li;ya=1;var l=Pn();function e(){this.__data__=new l,this.size=0}return li=e,li}var ci,wa;function Sd(){if(wa)return ci;wa=1;function l(e){var t=this.__data__,n=t.delete(e);return this.size=t.size,n}return ci=l,ci}var ui,ba;function Ad(){if(ba)return ui;ba=1;function l(e){return this.__data__.get(e)}return ui=l,ui}var hi,Ca;function $d(){if(Ca)return hi;Ca=1;function l(e){return this.__data__.has(e)}return hi=l,hi}var di,Sa;function Pu(){if(Sa)return di;Sa=1;var l=typeof an=="object"&&an&&an.Object===Object&&an;return di=l,di}var fi,Aa;function qe(){if(Aa)return fi;Aa=1;var l=Pu(),e=typeof self=="object"&&self&&self.Object===Object&&self,t=l||e||Function("return this")();return fi=t,fi}var pi,$a;function Hn(){if($a)return pi;$a=1;var l=qe(),e=l.Symbol;return pi=e,pi}var gi,Ma;function Md(){if(Ma)return gi;Ma=1;var l=Hn(),e=Object.prototype,t=e.hasOwnProperty,n=e.toString,f=l?l.toStringTag:void 0;function d(g){var m=t.call(g,f),c=g[f];try{g[f]=void 0;var p=!0}catch{}var r=n.call(g);return p&&(m?g[f]=c:delete g[f]),r}return gi=d,gi}var mi,xa;function xd(){if(xa)return mi;xa=1;var l=Object.prototype,e=l.toString;function t(n){return e.call(n)}return mi=t,mi}var vi,Ea;function Dt(){if(Ea)return vi;Ea=1;var l=Hn(),e=Md(),t=xd(),n="[object Null]",f="[object Undefined]",d=l?l.toStringTag:void 0;function g(m){return m==null?m===void 0?f:n:d&&d in Object(m)?e(m):t(m)}return vi=g,vi}var yi,_a;function ct(){if(_a)return yi;_a=1;function l(e){var t=typeof e;return e!=null&&(t=="object"||t=="function")}return yi=l,yi}var wi,Ta;function _s(){if(Ta)return wi;Ta=1;var l=Dt(),e=ct(),t="[object AsyncFunction]",n="[object Function]",f="[object GeneratorFunction]",d="[object Proxy]";function g(m){if(!e(m))return!1;var c=l(m);return c==n||c==f||c==t||c==d}return wi=g,wi}var bi,La;function Ed(){if(La)return bi;La=1;var l=qe(),e=l["__core-js_shared__"];return bi=e,bi}var Ci,Ra;function _d(){if(Ra)return Ci;Ra=1;var l=Ed(),e=(function(){var n=/[^.]+$/.exec(l&&l.keys&&l.keys.IE_PROTO||"");return n?"Symbol(src)_1."+n:""})();function t(n){return!!e&&e in n}return Ci=t,Ci}var Si,ka;function Hu(){if(ka)return Si;ka=1;var l=Function.prototype,e=l.toString;function t(n){if(n!=null){try{return e.call(n)}catch{}try{return n+""}catch{}}return""}return Si=t,Si}var Ai,Da;function Td(){if(Da)return Ai;Da=1;var l=_s(),e=_d(),t=ct(),n=Hu(),f=/[\\^$.*+?()[\]{}|]/g,d=/^\[object .+?Constructor\]$/,g=Function.prototype,m=Object.prototype,c=g.toString,p=m.hasOwnProperty,r=RegExp("^"+c.call(p).replace(f,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function o(s){if(!t(s)||e(s))return!1;var a=l(s)?r:d;return a.test(n(s))}return Ai=o,Ai}var $i,Oa;function Ld(){if(Oa)return $i;Oa=1;function l(e,t){return e?.[t]}return $i=l,$i}var Mi,Ia;function yt(){if(Ia)return Mi;Ia=1;var l=Td(),e=Ld();function t(n,f){var d=e(n,f);return l(d)?d:void 0}return Mi=t,Mi}var xi,Na;function Ts(){if(Na)return xi;Na=1;var l=yt(),e=qe(),t=l(e,"Map");return xi=t,xi}var Ei,Fa;function Wn(){if(Fa)return Ei;Fa=1;var l=yt(),e=l(Object,"create");return Ei=e,Ei}var _i,Pa;function Rd(){if(Pa)return _i;Pa=1;var l=Wn();function e(){this.__data__=l?l(null):{},this.size=0}return _i=e,_i}var Ti,Ha;function kd(){if(Ha)return Ti;Ha=1;function l(e){var t=this.has(e)&&delete this.__data__[e];return this.size-=t?1:0,t}return Ti=l,Ti}var Li,Wa;function Dd(){if(Wa)return Li;Wa=1;var l=Wn(),e="__lodash_hash_undefined__",t=Object.prototype,n=t.hasOwnProperty;function f(d){var g=this.__data__;if(l){var m=g[d];return m===e?void 0:m}return n.call(g,d)?g[d]:void 0}return Li=f,Li}var Ri,za;function Od(){if(za)return Ri;za=1;var l=Wn(),e=Object.prototype,t=e.hasOwnProperty;function n(f){var d=this.__data__;return l?d[f]!==void 0:t.call(d,f)}return Ri=n,Ri}var ki,Ba;function Id(){if(Ba)return ki;Ba=1;var l=Wn(),e="__lodash_hash_undefined__";function t(n,f){var d=this.__data__;return this.size+=this.has(n)?0:1,d[n]=l&&f===void 0?e:f,this}return ki=t,ki}var Di,ja;function Nd(){if(ja)return Di;ja=1;var l=Rd(),e=kd(),t=Dd(),n=Od(),f=Id();function d(g){var m=-1,c=g==null?0:g.length;for(this.clear();++m<c;){var p=g[m];this.set(p[0],p[1])}}return d.prototype.clear=l,d.prototype.delete=e,d.prototype.get=t,d.prototype.has=n,d.prototype.set=f,Di=d,Di}var Oi,Va;function Fd(){if(Va)return Oi;Va=1;var l=Nd(),e=Pn(),t=Ts();function n(){this.size=0,this.__data__={hash:new l,map:new(t||e),string:new l}}return Oi=n,Oi}var Ii,Ua;function Pd(){if(Ua)return Ii;Ua=1;function l(e){var t=typeof e;return t=="string"||t=="number"||t=="symbol"||t=="boolean"?e!=="__proto__":e===null}return Ii=l,Ii}var Ni,Ga;function zn(){if(Ga)return Ni;Ga=1;var l=Pd();function e(t,n){var f=t.__data__;return l(n)?f[typeof n=="string"?"string":"hash"]:f.map}return Ni=e,Ni}var Fi,qa;function Hd(){if(qa)return Fi;qa=1;var l=zn();function e(t){var n=l(this,t).delete(t);return this.size-=n?1:0,n}return Fi=e,Fi}var Pi,Ka;function Wd(){if(Ka)return Pi;Ka=1;var l=zn();function e(t){return l(this,t).get(t)}return Pi=e,Pi}var Hi,Ya;function zd(){if(Ya)return Hi;Ya=1;var l=zn();function e(t){return l(this,t).has(t)}return Hi=e,Hi}var Wi,Za;function Bd(){if(Za)return Wi;Za=1;var l=zn();function e(t,n){var f=l(this,t),d=f.size;return f.set(t,n),this.size+=f.size==d?0:1,this}return Wi=e,Wi}var zi,Xa;function Ls(){if(Xa)return zi;Xa=1;var l=Fd(),e=Hd(),t=Wd(),n=zd(),f=Bd();function d(g){var m=-1,c=g==null?0:g.length;for(this.clear();++m<c;){var p=g[m];this.set(p[0],p[1])}}return d.prototype.clear=l,d.prototype.delete=e,d.prototype.get=t,d.prototype.has=n,d.prototype.set=f,zi=d,zi}var Bi,Qa;function jd(){if(Qa)return Bi;Qa=1;var l=Pn(),e=Ts(),t=Ls(),n=200;function f(d,g){var m=this.__data__;if(m instanceof l){var c=m.__data__;if(!e||c.length<n-1)return c.push([d,g]),this.size=++m.size,this;m=this.__data__=new t(c)}return m.set(d,g),this.size=m.size,this}return Bi=f,Bi}var ji,Ja;function Wu(){if(Ja)return ji;Ja=1;var l=Pn(),e=Cd(),t=Sd(),n=Ad(),f=$d(),d=jd();function g(m){var c=this.__data__=new l(m);this.size=c.size}return g.prototype.clear=e,g.prototype.delete=t,g.prototype.get=n,g.prototype.has=f,g.prototype.set=d,ji=g,ji}var Vi,el;function zu(){if(el)return Vi;el=1;var l=yt(),e=(function(){try{var t=l(Object,"defineProperty");return t({},"",{}),t}catch{}})();return Vi=e,Vi}var Ui,tl;function Rs(){if(tl)return Ui;tl=1;var l=zu();function e(t,n,f){n=="__proto__"&&l?l(t,n,{configurable:!0,enumerable:!0,value:f,writable:!0}):t[n]=f}return Ui=e,Ui}var Gi,nl;function Bu(){if(nl)return Gi;nl=1;var l=Rs(),e=nn();function t(n,f,d){(d!==void 0&&!e(n[f],d)||d===void 0&&!(f in n))&&l(n,f,d)}return Gi=t,Gi}var qi,il;function Vd(){if(il)return qi;il=1;function l(e){return function(t,n,f){for(var d=-1,g=Object(t),m=f(t),c=m.length;c--;){var p=m[e?c:++d];if(n(g[p],p,g)===!1)break}return t}}return qi=l,qi}var Ki,rl;function Ud(){if(rl)return Ki;rl=1;var l=Vd(),e=l();return Ki=e,Ki}var Wt={exports:{}};Wt.exports;var ol;function Gd(){return ol||(ol=1,(function(l,e){var t=qe(),n=e&&!e.nodeType&&e,f=n&&!0&&l&&!l.nodeType&&l,d=f&&f.exports===n,g=d?t.Buffer:void 0,m=g?g.allocUnsafe:void 0;function c(p,r){if(r)return p.slice();var o=p.length,s=m?m(o):new p.constructor(o);return p.copy(s),s}l.exports=c})(Wt,Wt.exports)),Wt.exports}var Yi,sl;function ju(){if(sl)return Yi;sl=1;var l=qe(),e=l.Uint8Array;return Yi=e,Yi}var Zi,al;function qd(){if(al)return Zi;al=1;var l=ju();function e(t){var n=new t.constructor(t.byteLength);return new l(n).set(new l(t)),n}return Zi=e,Zi}var Xi,ll;function Kd(){if(ll)return Xi;ll=1;var l=qd();function e(t,n){var f=n?l(t.buffer):t.buffer;return new t.constructor(f,t.byteOffset,t.length)}return Xi=e,Xi}var Qi,cl;function Yd(){if(cl)return Qi;cl=1;function l(e,t){var n=-1,f=e.length;for(t||(t=Array(f));++n<f;)t[n]=e[n];return t}return Qi=l,Qi}var Ji,ul;function Zd(){if(ul)return Ji;ul=1;var l=ct(),e=Object.create,t=(function(){function n(){}return function(f){if(!l(f))return{};if(e)return e(f);n.prototype=f;var d=new n;return n.prototype=void 0,d}})();return Ji=t,Ji}var er,hl;function Vu(){if(hl)return er;hl=1;function l(e,t){return function(n){return e(t(n))}}return er=l,er}var tr,dl;function Uu(){if(dl)return tr;dl=1;var l=Vu(),e=l(Object.getPrototypeOf,Object);return tr=e,tr}var nr,fl;function ks(){if(fl)return nr;fl=1;var l=Object.prototype;function e(t){var n=t&&t.constructor,f=typeof n=="function"&&n.prototype||l;return t===f}return nr=e,nr}var ir,pl;function Xd(){if(pl)return ir;pl=1;var l=Zd(),e=Uu(),t=ks();function n(f){return typeof f.constructor=="function"&&!t(f)?l(e(f)):{}}return ir=n,ir}var rr,gl;function wt(){if(gl)return rr;gl=1;function l(e){return e!=null&&typeof e=="object"}return rr=l,rr}var or,ml;function Qd(){if(ml)return or;ml=1;var l=Dt(),e=wt(),t="[object Arguments]";function n(f){return e(f)&&l(f)==t}return or=n,or}var sr,vl;function Gu(){if(vl)return sr;vl=1;var l=Qd(),e=wt(),t=Object.prototype,n=t.hasOwnProperty,f=t.propertyIsEnumerable,d=l((function(){return arguments})())?l:function(g){return e(g)&&n.call(g,"callee")&&!f.call(g,"callee")};return sr=d,sr}var ar,yl;function bt(){if(yl)return ar;yl=1;var l=Array.isArray;return ar=l,ar}var lr,wl;function qu(){if(wl)return lr;wl=1;var l=9007199254740991;function e(t){return typeof t=="number"&&t>-1&&t%1==0&&t<=l}return lr=e,lr}var cr,bl;function Bn(){if(bl)return cr;bl=1;var l=_s(),e=qu();function t(n){return n!=null&&e(n.length)&&!l(n)}return cr=t,cr}var ur,Cl;function Jd(){if(Cl)return ur;Cl=1;var l=Bn(),e=wt();function t(n){return e(n)&&l(n)}return ur=t,ur}var zt={exports:{}},hr,Sl;function ef(){if(Sl)return hr;Sl=1;function l(){return!1}return hr=l,hr}zt.exports;var Al;function Ds(){return Al||(Al=1,(function(l,e){var t=qe(),n=ef(),f=e&&!e.nodeType&&e,d=f&&!0&&l&&!l.nodeType&&l,g=d&&d.exports===f,m=g?t.Buffer:void 0,c=m?m.isBuffer:void 0,p=c||n;l.exports=p})(zt,zt.exports)),zt.exports}var dr,$l;function tf(){if($l)return dr;$l=1;var l=Dt(),e=Uu(),t=wt(),n="[object Object]",f=Function.prototype,d=Object.prototype,g=f.toString,m=d.hasOwnProperty,c=g.call(Object);function p(r){if(!t(r)||l(r)!=n)return!1;var o=e(r);if(o===null)return!0;var s=m.call(o,"constructor")&&o.constructor;return typeof s=="function"&&s instanceof s&&g.call(s)==c}return dr=p,dr}var fr,Ml;function nf(){if(Ml)return fr;Ml=1;var l=Dt(),e=qu(),t=wt(),n="[object Arguments]",f="[object Array]",d="[object Boolean]",g="[object Date]",m="[object Error]",c="[object Function]",p="[object Map]",r="[object Number]",o="[object Object]",s="[object RegExp]",a="[object Set]",i="[object String]",u="[object WeakMap]",h="[object ArrayBuffer]",y="[object DataView]",w="[object Float32Array]",x="[object Float64Array]",$="[object Int8Array]",A="[object Int16Array]",S="[object Int32Array]",E="[object Uint8Array]",R="[object Uint8ClampedArray]",L="[object Uint16Array]",_="[object Uint32Array]",D={};D[w]=D[x]=D[$]=D[A]=D[S]=D[E]=D[R]=D[L]=D[_]=!0,D[n]=D[f]=D[h]=D[d]=D[y]=D[g]=D[m]=D[c]=D[p]=D[r]=D[o]=D[s]=D[a]=D[i]=D[u]=!1;function b(v){return t(v)&&e(v.length)&&!!D[l(v)]}return fr=b,fr}var pr,xl;function rf(){if(xl)return pr;xl=1;function l(e){return function(t){return e(t)}}return pr=l,pr}var Bt={exports:{}};Bt.exports;var El;function of(){return El||(El=1,(function(l,e){var t=Pu(),n=e&&!e.nodeType&&e,f=n&&!0&&l&&!l.nodeType&&l,d=f&&f.exports===n,g=d&&t.process,m=(function(){try{var c=f&&f.require&&f.require("util").types;return c||g&&g.binding&&g.binding("util")}catch{}})();l.exports=m})(Bt,Bt.exports)),Bt.exports}var gr,_l;function Os(){if(_l)return gr;_l=1;var l=nf(),e=rf(),t=of(),n=t&&t.isTypedArray,f=n?e(n):l;return gr=f,gr}var mr,Tl;function Ku(){if(Tl)return mr;Tl=1;function l(e,t){if(!(t==="constructor"&&typeof e[t]=="function")&&t!="__proto__")return e[t]}return mr=l,mr}var vr,Ll;function Yu(){if(Ll)return vr;Ll=1;var l=Rs(),e=nn(),t=Object.prototype,n=t.hasOwnProperty;function f(d,g,m){var c=d[g];(!(n.call(d,g)&&e(c,m))||m===void 0&&!(g in d))&&l(d,g,m)}return vr=f,vr}var yr,Rl;function sf(){if(Rl)return yr;Rl=1;var l=Yu(),e=Rs();function t(n,f,d,g){var m=!d;d||(d={});for(var c=-1,p=f.length;++c<p;){var r=f[c],o=g?g(d[r],n[r],r,d,n):void 0;o===void 0&&(o=n[r]),m?e(d,r,o):l(d,r,o)}return d}return yr=t,yr}var wr,kl;function af(){if(kl)return wr;kl=1;function l(e,t){for(var n=-1,f=Array(e);++n<e;)f[n]=t(n);return f}return wr=l,wr}var br,Dl;function Is(){if(Dl)return br;Dl=1;var l=9007199254740991,e=/^(?:0|[1-9]\d*)$/;function t(n,f){var d=typeof n;return f=f??l,!!f&&(d=="number"||d!="symbol"&&e.test(n))&&n>-1&&n%1==0&&n<f}return br=t,br}var Cr,Ol;function Zu(){if(Ol)return Cr;Ol=1;var l=af(),e=Gu(),t=bt(),n=Ds(),f=Is(),d=Os(),g=Object.prototype,m=g.hasOwnProperty;function c(p,r){var o=t(p),s=!o&&e(p),a=!o&&!s&&n(p),i=!o&&!s&&!a&&d(p),u=o||s||a||i,h=u?l(p.length,String):[],y=h.length;for(var w in p)(r||m.call(p,w))&&!(u&&(w=="length"||a&&(w=="offset"||w=="parent")||i&&(w=="buffer"||w=="byteLength"||w=="byteOffset")||f(w,y)))&&h.push(w);return h}return Cr=c,Cr}var Sr,Il;function lf(){if(Il)return Sr;Il=1;function l(e){var t=[];if(e!=null)for(var n in Object(e))t.push(n);return t}return Sr=l,Sr}var Ar,Nl;function cf(){if(Nl)return Ar;Nl=1;var l=ct(),e=ks(),t=lf(),n=Object.prototype,f=n.hasOwnProperty;function d(g){if(!l(g))return t(g);var m=e(g),c=[];for(var p in g)p=="constructor"&&(m||!f.call(g,p))||c.push(p);return c}return Ar=d,Ar}var $r,Fl;function Xu(){if(Fl)return $r;Fl=1;var l=Zu(),e=cf(),t=Bn();function n(f){return t(f)?l(f,!0):e(f)}return $r=n,$r}var Mr,Pl;function uf(){if(Pl)return Mr;Pl=1;var l=sf(),e=Xu();function t(n){return l(n,e(n))}return Mr=t,Mr}var xr,Hl;function hf(){if(Hl)return xr;Hl=1;var l=Bu(),e=Gd(),t=Kd(),n=Yd(),f=Xd(),d=Gu(),g=bt(),m=Jd(),c=Ds(),p=_s(),r=ct(),o=tf(),s=Os(),a=Ku(),i=uf();function u(h,y,w,x,$,A,S){var E=a(h,w),R=a(y,w),L=S.get(R);if(L){l(h,w,L);return}var _=A?A(E,R,w+"",h,y,S):void 0,D=_===void 0;if(D){var b=g(R),v=!b&&c(R),C=!b&&!v&&s(R);_=R,b||v||C?g(E)?_=E:m(E)?_=n(E):v?(D=!1,_=e(R,!0)):C?(D=!1,_=t(R,!0)):_=[]:o(R)||d(R)?(_=E,d(E)?_=i(E):(!r(E)||p(E))&&(_=f(R))):D=!1}D&&(S.set(R,_),$(_,R,x,A,S),S.delete(R)),l(h,w,_)}return xr=u,xr}var Er,Wl;function df(){if(Wl)return Er;Wl=1;var l=Wu(),e=Bu(),t=Ud(),n=hf(),f=ct(),d=Xu(),g=Ku();function m(c,p,r,o,s){c!==p&&t(p,function(a,i){if(s||(s=new l),f(a))n(c,p,i,r,m,o,s);else{var u=o?o(g(c,i),a,i+"",c,p,s):void 0;u===void 0&&(u=a),e(c,i,u)}},d)}return Er=m,Er}var _r,zl;function Qu(){if(zl)return _r;zl=1;function l(e){return e}return _r=l,_r}var Tr,Bl;function ff(){if(Bl)return Tr;Bl=1;function l(e,t,n){switch(n.length){case 0:return e.call(t);case 1:return e.call(t,n[0]);case 2:return e.call(t,n[0],n[1]);case 3:return e.call(t,n[0],n[1],n[2])}return e.apply(t,n)}return Tr=l,Tr}var Lr,jl;function pf(){if(jl)return Lr;jl=1;var l=ff(),e=Math.max;function t(n,f,d){return f=e(f===void 0?n.length-1:f,0),function(){for(var g=arguments,m=-1,c=e(g.length-f,0),p=Array(c);++m<c;)p[m]=g[f+m];m=-1;for(var r=Array(f+1);++m<f;)r[m]=g[m];return r[f]=d(p),l(n,this,r)}}return Lr=t,Lr}var Rr,Vl;function gf(){if(Vl)return Rr;Vl=1;function l(e){return function(){return e}}return Rr=l,Rr}var kr,Ul;function mf(){if(Ul)return kr;Ul=1;var l=gf(),e=zu(),t=Qu(),n=e?function(f,d){return e(f,"toString",{configurable:!0,enumerable:!1,value:l(d),writable:!0})}:t;return kr=n,kr}var Dr,Gl;function vf(){if(Gl)return Dr;Gl=1;var l=800,e=16,t=Date.now;function n(f){var d=0,g=0;return function(){var m=t(),c=e-(m-g);if(g=m,c>0){if(++d>=l)return arguments[0]}else d=0;return f.apply(void 0,arguments)}}return Dr=n,Dr}var Or,ql;function yf(){if(ql)return Or;ql=1;var l=mf(),e=vf(),t=e(l);return Or=t,Or}var Ir,Kl;function wf(){if(Kl)return Ir;Kl=1;var l=Qu(),e=pf(),t=yf();function n(f,d){return t(e(f,d,l),f+"")}return Ir=n,Ir}var Nr,Yl;function bf(){if(Yl)return Nr;Yl=1;var l=nn(),e=Bn(),t=Is(),n=ct();function f(d,g,m){if(!n(m))return!1;var c=typeof g;return(c=="number"?e(m)&&t(g,m.length):c=="string"&&g in m)?l(m[g],d):!1}return Nr=f,Nr}var Fr,Zl;function Cf(){if(Zl)return Fr;Zl=1;var l=wf(),e=bf();function t(n){return l(function(f,d){var g=-1,m=d.length,c=m>1?d[m-1]:void 0,p=m>2?d[2]:void 0;for(c=n.length>3&&typeof c=="function"?(m--,c):void 0,p&&e(d[0],d[1],p)&&(c=m<3?void 0:c,m=1),f=Object(f);++g<m;){var r=d[g];r&&n(f,r,g,c)}return f})}return Fr=t,Fr}var Pr,Xl;function Sf(){if(Xl)return Pr;Xl=1;var l=df(),e=Cf(),t=e(function(n,f,d,g){l(n,f,d,g)});return Pr=t,Pr}var Af=Sf();const $f=kt(Af),Mf=()=>crypto.randomUUID().slice(0,8),xf=()=>Mf().slice(0,8),Ql=(l="",e)=>{if(!e)return console.warn("utils.match missing argument 2."),!1;const t=/[|\\{}()[\]^*$+?.]/g;let n=typeof e=="string"?[e]:e;n=n.map(d=>d==="*"?"":d.replace(t,"\\$&"));let f=!0;return n.length&&(f=!new RegExp(n.join("|"),"i").exec(l)),f},Ef=(l,e)=>{const t=l.indexOf(e);t!==-1&&l.splice(t,1)},Le=l=>{const e=l.className?.match(Bf);return e&&Wf[e[0]]},gt=l=>Array.from(new Set(l)),He=l=>l?.attrs?.id||l?.id||xf(),je=(l,e)=>$f({},l,e,(n,f)=>{if(Array.isArray(n))return f!=null?gt(n.concat(f)):f;if(Array.isArray(f))return n!=null?gt(f.concat(n)):f}),Xe=l=>{let e;const t=l instanceof Promise;if(l===null||!(typeof l=="object")||t)return l;if(l instanceof Date)return e=new Date,e.setTime(l.getTime()),e;if(Array.isArray(l)){e=[];for(let f=0,d=l.length;f<d;f++)e[f]=Xe(l[f]);return e}if(l instanceof Object){e={};for(const f in l)Object.hasOwn(l,f)&&(e[f]=Xe(l[f]));return e}throw new Error("Unable to copy Object, type not supported.")},Hr=(l,e)=>l/e*100,vs=l=>`${l.toString()}%`,Ju=Object.create(null,{get:{value:l=>{const e=window.sessionStorage?.getItem(l);try{return JSON.parse(e)}catch{return e}}},set:{value:(l,e)=>{try{return window.sessionStorage?.setItem(l,JSON.stringify(e))}catch(t){console.error(t)}}}}),Pe=l=>/^(stage|row|column|field)s./.test(l),_f=l=>Nf.test(l);function Tf(l,e=zs){let t=0;return function(...n){const f=Date.now();f-t>=e&&(t=f,l.apply(this,n))}}function xn(l,e=mt){let t;return function(...n){t&&clearTimeout(t),t=setTimeout(()=>l.apply(this,n),e)}}function ys(l){return l}function ws(){}function jn(l=Object.create(null)){if(typeof l=="string")try{return JSON.parse(l)}catch(e){return console.error("Invalid JSON string provided:",e),Object.create(null)}return l}const Mt=l=>l?Xe(jn(l)):En();function eh(l,e,t,n={}){if(!e||!l[t][e])return n;const f=`${t}.${e}`;n[f]=l[t][e];const d=Uf.get(t);if(d){const g=l[t][e].data?.children||[];for(const m of g)eh(l,m,d,n)}return n}const Lf='<?xml version="1.0" encoding="utf-8"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><symbol id="f-i-autocomplete" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M6,5h1v1H6V5z M4,4H3v1h1V4z M6,4H5v1h1V4z M2,5v1h1V5H2z M3,7h1V6H3V7z M5,7h1V6H5V7z M4,5v1h1V5H4z M2,14h1v-1H2V14z M4,14h1v-1H4V14z M6,14h1v-1H6V14z M9,13H8v1h1V13z M16,3.5v4C16,8.3,15.3,9,14.5,9H14v3v3c0,0.6-0.4,1-1,1H1c-0.6,0-1-0.4-1-1V3.5 C0,2.7,0.7,2,1.5,2h3H8V1.5V1H7H6V0.5V0h2.5H11v0.5V1h-1H9v0.5V2h3h2.5C15.3,2,16,2.7,16,3.5z M13,12H7H1v3h12V12z M3,11v-1H2v1H3z M5,11v-1H4v1H5z M15,3.5C15,3.2,14.8,3,14.5,3H9v2.5V8H8.5H8V7.5V7H7V6h1V5.5V5H7V4h1V3.5V3H1.5C1.2,3,1,3.2,1,3.5v4 C1,7.8,1.2,8,1.5,8H8v1H6v0.5V10h2.5H11V9.5V9H9V8h5.5C14.8,8,15,7.8,15,7.5V3.5z"/></symbol><symbol viewBox="0 0 32 32" id="f-i-bin" xmlns="http://www.w3.org/2000/svg"><path d="M4 10v20c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2v-20h-22zM10 28h-2v-14h2v14zM14 28h-2v-14h2v14zM18 28h-2v-14h2v14zM22 28h-2v-14h2v14zM26.5 4h-6.5v-2.5c0-.825-.675-1.5-1.5-1.5h-7c-.825 0-1.5.675-1.5 1.5v2.5h-6.5c-.825 0-1.5.675-1.5 1.5v2.5h26v-2.5c0-.825-.675-1.5-1.5-1.5zM18 4h-6v-1.975h6v1.975z"/></symbol><symbol id="f-i-button" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><metadata id="acprefix__metadata8"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><path id="acprefix__rect4140" d="M 0.4765625,4 A 0.47706934,0.47706934 0 0 0 0,4.4765625 L 0,11.523438 A 0.47706934,0.47706934 0 0 0 0.4765625,12 L 15.523438,12 A 0.47706934,0.47706934 0 0 0 16,11.523438 L 16,4.4765625 A 0.47706934,0.47706934 0 0 0 15.523438,4 L 0.4765625,4 Z m 0.4765625,0.953125 14.09375,0 0,6.09375 -14.09375,0 0,-6.09375 z"/><g id="acprefix__layer1"><g id="acprefix__text4203"><g id="acprefix__g4212" transform="translate(0.10112835,0.1001358)"><path id="acprefix__path4208" d="m 6.0690374,6.4093857 q -0.5371093,0 -0.8544922,0.4003906 -0.3149414,0.4003906 -0.3149414,1.0913086 0,0.6884766 0.3149414,1.0888672 0.3173829,0.4003906 0.8544922,0.4003906 0.5371094,0 0.8496094,-0.4003906 0.3149414,-0.4003906 0.3149414,-1.0888672 0,-0.690918 -0.3149414,-1.0913086 -0.3125,-0.4003906 -0.8496094,-0.4003906 z m 0,-0.4003906 q 0.7666016,0 1.225586,0.5151367 0.4589843,0.5126953 0.4589843,1.3769531 0,0.8618164 -0.4589843,1.3769531 -0.4589844,0.5126953 -1.225586,0.5126953 -0.7690429,0 -1.2304687,-0.5126953 -0.4589844,-0.5126953 -0.4589844,-1.3769531 0,-0.8642578 0.4589844,-1.3769531 0.4614258,-0.5151367 1.2304687,-0.5151367 z"/><path id="acprefix__path4210" d="m 8.5250921,6.074913 0.4931641,0 0,1.5405274 1.6357418,-1.5405274 0.634766,0 -1.809082,1.6992188 1.938477,1.9458008 -0.649415,0 -1.7504878,-1.7553711 0,1.7553711 -0.4931641,0 0,-3.6450196 z"/></g></g></g></symbol><symbol viewBox="0 0 32 32" id="f-i-calendar" xmlns="http://www.w3.org/2000/svg"><path d="M12.048 16.961c-0.178 0.257-0.395 0.901-0.652 1.059-0.257 0.157-0.547 0.267-0.869 0.328-0.323 0.062-0.657 0.089-1.002 0.079v1.527h2.467v6.046h1.991v-9.996h-1.584c-0.056 0.381-0.173 0.7-0.351 0.957zM23 8h2c0.553 0 1-0.448 1-1v-6c0-0.552-0.447-1-1-1h-2c-0.553 0-1 0.448-1 1v6c0 0.552 0.447 1 1 1zM7 8h2c0.552 0 1-0.448 1-1v-6c0-0.552-0.448-1-1-1h-2c-0.552 0-1 0.448-1 1v6c0 0.552 0.448 1 1 1zM30 4h-2v5c0 0.552-0.447 1-1 1h-6c-0.553 0-1-0.448-1-1v-5h-8v5c0 0.552-0.448 1-1 1h-6c-0.552 0-1-0.448-1-1v-5h-2c-1.104 0-2 0.896-2 2v24c0 1.104 0.896 2 2 2h28c1.104 0 2-0.896 2-2v-24c0-1.104-0.896-2-2-2zM30 29c0 0.553-0.447 1-1 1h-26c-0.552 0-1-0.447-1-1v-16c0-0.552 0.448-1 1-1h26c0.553 0 1 0.448 1 1v16zM15.985 17.982h4.968c-0.936 1.152-1.689 2.325-2.265 3.705-0.575 1.381-0.638 2.818-0.749 4.312h2.131c0.009-0.666-0.195-1.385-0.051-2.156 0.146-0.771 0.352-1.532 0.617-2.285 0.267-0.752 0.598-1.461 0.996-2.127 0.396-0.667 0.853-1.229 1.367-1.686v-1.742h-7.015v1.979z"/></symbol><symbol id="f-i-checkbox" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M13.5,5v8c0,0.8-0.7,1.5-1.5,1.5H3c-0.8,0-1.5-0.7-1.5-1.5V4c0-0.8,0.7-1.5,1.5-1.5h9c0.7,0,1.3,0.5,1.5,1.2l2.4-1.4L13.5,5 z M12.5,6.2L7.7,12L2.8,5.5l4.9,1.6l4.8-2.9V4c0-0.3-0.2-0.5-0.5-0.5H3C2.7,3.5,2.5,3.7,2.5,4v9c0,0.3,0.2,0.5,0.5,0.5h9 c0.3,0,0.5-0.2,0.5-0.5V6.2z"/></symbol><symbol id="f-i-checkbox-group" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M0,1h16V0H0V1z M0,3h16V2H0V3z M6,5v1h9V5H6z M15,14v-1H6v1H15z M6,10h9V9H6V10z M4,12l-2.5,1.5L0,13l1.5,2L4,12z M4,8 L1.5,9.5L0,9l1.5,2L4,8z M4,4L1.5,5.5L0,5l1.5,2L4,4z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-columns" xmlns="http://www.w3.org/2000/svg"><metadata id="agprefix__metadata4318"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><path id="agprefix__rect4860-3-5" d="M 16,0.5 A 0.50004997,0.50004997 0 0 0 15.5,0 l -5,0 -5,0 -5,0 A 0.50004997,0.50004997 0 0 0 0,0.5 l 0,15 A 0.50004997,0.50004997 0 0 0 0.5,16 l 5,0 5,0 5,0 A 0.50004997,0.50004997 0 0 0 16,15.5 l 0,-15 z M 15,1 15,15 11,15 11,1 15,1 Z M 10,1 10,15 6,15 6,1 10,1 Z M 5,1 5,15 1,15 1,1 5,1 Z"/></symbol><symbol viewBox="0 0 32 32" id="f-i-copy" xmlns="http://www.w3.org/2000/svg"><path d="M20 8v-8h-14l-6 6v18h12v8h20v-24h-12zM6 2.828v3.172h-3.172l3.172-3.172zM2 22v-14h6v-6h10v6l-6 6v8h-10zM18 10.828v3.172h-3.172l3.172-3.172zM30 30h-16v-14h6v-6h10v20z"/></symbol><symbol id="f-i-divider" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg"><metadata id="aiprefix__metadata10"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><rect y="7" x="0" height="1" width="15" id="aiprefix__rect4182"/></symbol><symbol viewBox="0 0 28 32" id="f-i-edit" xmlns="http://www.w3.org/2000/svg"><path d="M22 2l-4 4 6 6 4-4-6-6zM0 24l0.021 6.018 5.979-0.018 16-16-6-6-16 16zM6 28h-4v-4h2v2h2v2z"/></symbol><symbol fill="#000000" viewBox="0 0 24 24" id="f-i-email" xmlns="http://www.w3.org/2000/svg"><path d="M12,2 C17.4292399,2 21.8479317,6.32667079 21.9961582,11.7200952 L22,12 L22,13 C22,15.1729208 20.477434,17 18.5,17 C17.3269391,17 16.3139529,16.3570244 15.6839382,15.3803024 C14.770593,16.3757823 13.4581934,17 12,17 C9.23857625,17 7,14.7614237 7,12 C7,9.23857625 9.23857625,7 12,7 C14.6887547,7 16.8818181,9.12230671 16.9953805,11.7831104 L17,12 L17,13 C17,14.1407877 17.7160103,15 18.5,15 C19.2447902,15 19.928229,14.2245609 19.9947109,13.1689341 L20,13 L20,12 C20,7.581722 16.418278,4 12,4 C7.581722,4 4,7.581722 4,12 C4,16.418278 7.581722,20 12,20 C13.1630948,20 14.2892822,19.7522618 15.3225159,19.2798331 C15.8247876,19.0501777 16.4181317,19.271177 16.647787,19.7734487 C16.8774423,20.2757205 16.656443,20.8690646 16.1541713,21.0987199 C14.861218,21.689901 13.4515463,22 12,22 C6.4771525,22 2,17.5228475 2,12 C2,6.4771525 6.4771525,2 12,2 Z M12,9 C10.3431458,9 9,10.3431458 9,12 C9,13.6568542 10.3431458,15 12,15 C13.6568542,15 15,13.6568542 15,12 C15,10.3431458 13.6568542,9 12,9 Z"/></symbol><symbol viewBox="0 0 32 32" id="f-i-floppy-disk" xmlns="http://www.w3.org/2000/svg"><path d="M28 0h-28v32h32v-28l-4-4zM16 4h4v8h-4v-8zM28 28h-24v-24h2v10h18v-10h2.343l1.657 1.657v22.343z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle" xmlns="http://www.w3.org/2000/svg"><metadata id="aqprefix__metadata8"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><g transform="translate(0,-2)" id="aqprefix__g4220"><rect id="aqprefix__rect4191" width="2" height="2" x="2" y="7"/><rect id="aqprefix__rect4191-2" width="2" height="2" x="7" y="7"/><rect id="aqprefix__rect4191-4" width="2" height="2" x="12" y="7"/></g><g transform="translate(0,2)" id="aqprefix__g4220-6"><rect id="aqprefix__rect4191-40" width="2" height="2" x="2" y="7"/><rect id="aqprefix__rect4191-2-3" width="2" height="2" x="7" y="7"/><rect id="aqprefix__rect4191-4-9" width="2" height="2" x="12" y="7"/></g></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-column" xmlns="http://www.w3.org/2000/svg"><path d="M2 7h2v2H2zM7 7h2v2H7zM12 7h2v2h-2zM2 12h2v2H2zM7 12h2v2H7zM12 12h2v2h-2z" transform="rotate(90 9.25 9.25)"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-field" xmlns="http://www.w3.org/2000/svg"><path d="M9.5-6.5h2v2h-2zm-5 0h2v2h-2zm5-5h2v2h-2zm-5 0h2v2h-2z" transform="rotate(90)"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-row" xmlns="http://www.w3.org/2000/svg"><path d="M12 9.5h2v2h-2zm-5 0h2v2H7Zm-5 0h2v2H2Zm10-5h2v2h-2zm-5 0h2v2H7Zm-5 0h2v2H2Z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-stage" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5h2v2H2zM7 4.5h2v2H7zM12 4.5h2v2h-2zM2 9.5h2v2H2zM7 9.5h2v2H7zM12 9.5h2v2h-2zM2-.5h2v2H2zM7-.5h2v2H7zM12-.5h2v2h-2z" transform="translate(0 2.5)"/></symbol><symbol viewBox="0 0 448 512" id="f-i-hash" xmlns="http://www.w3.org/2000/svg"><g id="arprefix__icomoon-ignore"/><path fill="#000" d="M448 192v-64h-80.064l16-128h-64l-16 128h-127.968l16-128h-64l-16 128h-111.968v64h103.968l-15.968 128h-88v64h80l-16 128h64l16-128h127.968l-16 128h64.032l16-128h112v-64h-104l15.936-128h88.064zM279.968 320h-127.968l15.968-128h127.968l-15.968 128z"/></symbol><symbol viewBox="0 0 28 28" id="f-i-header" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M26.281 26q-0.688 0-2.070-0.055t-2.086-0.055q-0.688 0-2.063 0.055t-2.063 0.055q-0.375 0-0.578-0.32t-0.203-0.711q0-0.484 0.266-0.719t0.609-0.266 0.797-0.109 0.703-0.234q0.516-0.328 0.516-2.188l-0.016-6.109q0-0.328-0.016-0.484-0.203-0.063-0.781-0.063h-10.547q-0.594 0-0.797 0.063-0.016 0.156-0.016 0.484l-0.016 5.797q0 2.219 0.578 2.562 0.25 0.156 0.75 0.203t0.891 0.055 0.703 0.234 0.313 0.711q0 0.406-0.195 0.75t-0.57 0.344q-0.734 0-2.18-0.055t-2.164-0.055q-0.672 0-2 0.055t-1.984 0.055q-0.359 0-0.555-0.328t-0.195-0.703q0-0.469 0.242-0.703t0.562-0.273 0.742-0.117 0.656-0.234q0.516-0.359 0.516-2.234l-0.016-0.891v-12.703q0-0.047 0.008-0.406t0-0.57-0.023-0.602-0.055-0.656-0.102-0.57-0.172-0.492-0.25-0.281q-0.234-0.156-0.703-0.187t-0.828-0.031-0.641-0.219-0.281-0.703q0-0.406 0.187-0.75t0.562-0.344q0.719 0 2.164 0.055t2.164 0.055q0.656 0 1.977-0.055t1.977-0.055q0.391 0 0.586 0.344t0.195 0.75q0 0.469-0.266 0.68t-0.602 0.227-0.773 0.063-0.672 0.203q-0.547 0.328-0.547 2.5l0.016 5q0 0.328 0.016 0.5 0.203 0.047 0.609 0.047h10.922q0.391 0 0.594-0.047 0.016-0.172 0.016-0.5l0.016-5q0-2.172-0.547-2.5-0.281-0.172-0.914-0.195t-1.031-0.203-0.398-0.773q0-0.406 0.195-0.75t0.586-0.344q0.688 0 2.063 0.055t2.063 0.055q0.672 0 2.016-0.055t2.016-0.055q0.391 0 0.586 0.344t0.195 0.75q0 0.469-0.273 0.688t-0.625 0.227-0.805 0.047-0.688 0.195q-0.547 0.359-0.547 2.516l0.016 14.734q0 1.859 0.531 2.188 0.25 0.156 0.719 0.211t0.836 0.070 0.648 0.242 0.281 0.695q0 0.406-0.187 0.75t-0.562 0.344z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-hidden" xmlns="http://www.w3.org/2000/svg"><path d="M0 12h1v-1H0Zm15-7h1V4h-1zm-1 7h1v-1h-1zm-2 0h1v-1h-1zm-2 0h1v-1h-1Zm-2 0h1v-1H8Zm-2 0h1v-1H6Zm-2 0h1v-1H4Zm-2 0h1v-1H2Zm13-1h1v-1h-1ZM0 10h1V9H0Zm15-1h1V8h-1ZM0 8h1V7H0Zm15-1h1V6h-1ZM0 6h1V5H0Zm13-1h1V4h-1zm-2 0h1V4h-1ZM9 5h1V4H9ZM7 5h1V4H7ZM5 5h1V4H5ZM3 5h1V4H3ZM1 5h1V4H1Z"/></symbol><symbol viewBox="0 0 384 512" id="f-i-menu" xmlns="http://www.w3.org/2000/svg"><g id="auprefix__icomoon-ignore"/><path d="M0 96v64h384v-64h-384zM0 288h384v-64h-384v64zM0 416h384v-64h-384v64z"/></symbol><symbol viewBox="0 0 24 24" fill="none" id="f-i-minus" xmlns="http://www.w3.org/2000/svg"><path d="M6 12L18 12" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></symbol><symbol viewBox="0 0 512 512" id="f-i-move" xmlns="http://www.w3.org/2000/svg"><path d="M287.744 94.736v129.008h128v-64l96.256 96.256-96.256 96.24v-65.488h-128v129.008h64.496l-96.24 96.24-96.256-96.24h64v-129.008h-128v64.992l-95.744-95.744 95.744-95.744v63.488h128v-129.008h-62.496l94.752-94.736 94.752 94.736h-63.008z"/></symbol><symbol viewBox="0 0 512 512" id="f-i-move-vertical" xmlns="http://www.w3.org/2000/svg"><metadata id="awprefix__metadata10"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><sodipodi:namedview pagecolor="#ffffff" bordercolor="#666666" borderopacity="1" objecttolerance="10" gridtolerance="10" guidetolerance="10" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" inkscape:pageopacity="0" inkscape:pageshadow="2" inkscape:window-width="3440" inkscape:window-height="1416" id="awprefix__namedview6" showgrid="false" inkscape:zoom="1.84375" inkscape:cx="421.4312" inkscape:cy="218.56484" inkscape:window-x="0" inkscape:window-y="24" inkscape:window-maximized="1" inkscape:current-layer="svg2" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd"/><path d="m 287.744,94.736 0,321.024 64.496,0 L 256,512 l -96.256,-96.24 64,0 0,-321.024 -62.496,0 L 256,0 350.752,94.736 Z" id="awprefix__path4" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" inkscape:connector-curvature="0" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" sodipodi:nodetypes="ccccccccccc"/></symbol><symbol viewBox="0 0 20 28" id="f-i-paragraph" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M19.969 2.953v1.141q0 0.453-0.289 0.953t-0.664 0.5q-0.781 0-0.844 0.016-0.406 0.094-0.5 0.484-0.047 0.172-0.047 1v18q0 0.391-0.281 0.672t-0.672 0.281h-1.687q-0.391 0-0.672-0.281t-0.281-0.672v-19.031h-2.234v19.031q0 0.391-0.273 0.672t-0.68 0.281h-1.687q-0.406 0-0.68-0.281t-0.273-0.672v-7.75q-2.297-0.187-3.828-0.922-1.969-0.906-3-2.797-1-1.828-1-4.047 0-2.594 1.375-4.469 1.375-1.844 3.266-2.484 1.734-0.578 6.516-0.578h7.484q0.391 0 0.672 0.281t0.281 0.672z"/></symbol><symbol id="f-i-phone-receiver" viewBox="0 0 578.106 578.106" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><g><g><path d="M577.83,456.128c1.225,9.385-1.635,17.545-8.568,24.48l-81.396,80.781 c-3.672,4.08-8.465,7.551-14.381,10.404c-5.916,2.857-11.729,4.693-17.439,5.508c-0.408,0-1.635,0.105-3.676,0.309 c-2.037,0.203-4.689,0.307-7.953,0.307c-7.754,0-20.301-1.326-37.641-3.979s-38.555-9.182-63.645-19.584 c-25.096-10.404-53.553-26.012-85.376-46.818c-31.823-20.805-65.688-49.367-101.592-85.68 c-28.56-28.152-52.224-55.08-70.992-80.783c-18.768-25.705-33.864-49.471-45.288-71.299 c-11.425-21.828-19.993-41.616-25.705-59.364S4.59,177.362,2.55,164.51s-2.856-22.95-2.448-30.294 c0.408-7.344,0.612-11.424,0.612-12.24c0.816-5.712,2.652-11.526,5.508-17.442s6.324-10.71,10.404-14.382L98.022,8.756 c5.712-5.712,12.24-8.568,19.584-8.568c5.304,0,9.996,1.53,14.076,4.59s7.548,6.834,10.404,11.322l65.484,124.236 c3.672,6.528,4.692,13.668,3.06,21.42c-1.632,7.752-5.1,14.28-10.404,19.584l-29.988,29.988c-0.816,0.816-1.53,2.142-2.142,3.978 s-0.918,3.366-0.918,4.59c1.632,8.568,5.304,18.36,11.016,29.376c4.896,9.792,12.444,21.726,22.644,35.802 s24.684,30.293,43.452,48.653c18.36,18.77,34.68,33.354,48.96,43.76c14.277,10.4,26.215,18.053,35.803,22.949 c9.588,4.896,16.932,7.854,22.031,8.871l7.648,1.531c0.816,0,2.145-0.307,3.979-0.918c1.836-0.613,3.162-1.326,3.979-2.143 l34.883-35.496c7.348-6.527,15.912-9.791,25.705-9.791c6.938,0,12.443,1.223,16.523,3.672h0.611l118.115,69.768 C571.098,441.238,576.197,447.968,577.83,456.128z"/></g></g><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/></symbol><symbol viewBox="0 0 24 24" fill="none" id="f-i-plus" xmlns="http://www.w3.org/2000/svg"><path d="M6 12H18M12 6V18" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></symbol><symbol id="f-i-radio-group" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M0,1h16V0H0V1z M0,3h16V2H0V3z M5,6h10V5H5V6z M15,9H5v1h10V9z M15,14v-1H5v1H15z M1.5,7C0.7,7,0,6.3,0,5.5S0.7,4,1.5,4 S3,4.7,3,5.5S2.3,7,1.5,7z M1.5,5C1.2,5,1,5.2,1,5.5S1.2,6,1.5,6S2,5.8,2,5.5S1.8,5,1.5,5z M1.5,11.1C0.7,11.1,0,10.4,0,9.6 s0.7-1.5,1.5-1.5S3,8.7,3,9.6S2.3,11.1,1.5,11.1z M1.5,9.1C1.2,9.1,1,9.3,1,9.6s0.2,0.5,0.5,0.5S2,9.8,2,9.6S1.8,9.1,1.5,9.1z M1.5,15C0.7,15,0,14.3,0,13.5S0.7,12,1.5,12S3,12.7,3,13.5S2.3,15,1.5,15z M1.5,13C1.2,13,1,13.2,1,13.5S1.2,14,1.5,14 S2,13.8,2,13.5S1.8,13,1.5,13z"/></symbol><symbol viewBox="0 0 512 512" id="f-i-remove" xmlns="http://www.w3.org/2000/svg"><path d="M193.694-139.2h87.322v510.916h-87.322zM-18.103 159.92V72.597h510.915v87.322z" transform="rotate(45 77.994 208.636)"/></symbol><symbol id="f-i-rich-text" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M15,1H1C0.4,1,0,1.4,0,2v12c0,0.6,0.4,1,1,1h14c0.6,0,1-0.4,1-1V2C16,1.4,15.6,1,15,1z M1,3.1h0.8v0.3H1V3.1z M1,3.6h0.8 v0.3H1V3.6z M15,14H1V5.1h14V14z M15,4.9H1V4.6h14V4.9z M15,4.4H1V4.1h0.8v0.2h1.5V4.1h1.3v0.2H6V4.1h1.3v0.2h1.5V4.1H10v0.2h1.5 V4.1h1.3v0.2h1.5V4.1H15V4.4z M4.5,3.6v0.3H3.3V3.6H4.5z M3.3,3.4V3.1h1.3v0.3H3.3z M7.3,3.6v0.3H6V3.6H7.3z M6,3.4V3.1h1.3v0.3H6z M10,3.6v0.3H8.8V3.6H10z M8.8,3.4V3.1H10v0.3H8.8z M12.8,3.6v0.3h-1.3V3.6H12.8z M11.5,3.4V3.1h1.3v0.3H11.5z M15,3.9h-0.8V3.6H15 V3.9z M15,3.4h-0.8V3.1H15V3.4z M15,2.9h-0.8V2.8h-1.5v0.2h-1.3V2.8H10v0.2H8.8V2.8H7.3v0.2H6V2.8H4.5v0.2H3.3V2.8H1.8v0.2H1V2.6h14 V2.9z M15,2.4H1V2.1h14V2.4z M3,12v-1h10v1H3z M13,10H3V9h10V10z M11,8H3V7h8V8z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-rows" xmlns="http://www.w3.org/2000/svg"><metadata id="beprefix__metadata4318"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><g transform="matrix(0,1,-1,0,3.0984025,11.835155)" id="beprefix__g7209"><path id="beprefix__rect4860-3-5" d="m 4.1640625,-12.402344 a 0.50004997,0.50004997 0 0 0 -0.5,-0.5 l -5,0 -5,0 -5.0000005,0 a 0.50004997,0.50004997 0 0 0 -0.5,0.5 l 0,15.0000002 a 0.50004997,0.50004997 0 0 0 0.5,0.5 l 4.9648442,0 a 0.50004997,0.50004997 0 0 0 0.035156,0 l 4.9648437,0 a 0.50004997,0.50004997 0 0 0 0.035156,0 l 5,0 a 0.50004997,0.50004997 0 0 0 0.5,-0.5 l 0,-15.0000002 z m -1,0.5 0,14.0000002 -4,0 0,-14.0000002 4,0 z m -5,0 0,14.0000002 -4,0 0,-14.0000002 4,0 z m -5,0 0,14.0000002 -4.0000005,0 0,-14.0000002 4.0000005,0 z"/></g></symbol><symbol id="f-i-select" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path id="bfprefix__XMLID_1_" d="M0,0v14h0c0,0.6,0.4,1,1,1h10c0.6,0,1-0.4,1-1h0V5h4V0H0z M1,1h10v3H1V1z M1,7h10v3H1V7z M1,14v-3h10v3H1z M15,4h-3V1h3V4z M2,2h1v1H2V2z M2,12h1v1H2V12z M4,12h1v1H4V12z M6,12h1v1H6V12z M9,12v1H8v-1H9z M2,8h1v1H2V8z M4,8h1v1H4V8z M6,8 h1v1H6V8z M13.5,3.1l-1-1.1h1.9L13.5,3.1z M2,6V5h1v1H2L2,6z M4,6V5h1v1H4L4,6z"/></symbol><symbol viewBox="0 0 448 512" id="f-i-settings" xmlns="http://www.w3.org/2000/svg"><g id="bgprefix__icomoon-ignore"/><path d="M223.969 175c-44.703 0-80.969 36.266-80.969 81 0 44.688 36.266 81.031 80.969 81.031 44.719 0 80.719-36.344 80.719-81.031-0-44.734-36-81-80.719-81zM386.313 302.531l-14.594 35.156 29.469 57.875-36.094 36.094-59.218-27.969-35.156 14.438-17.844 54.625-2.281 7.25h-51.016l-22.078-61.656-35.156-14.5-57.952 29.344-36.078-36.063 27.938-59.25-14.484-35.125-61.767-20.156v-50.984l61.703-22.109 14.485-35.094-25.953-51.234-3.422-6.719 36.031-36.031 59.297 27.922 35.109-14.516 17.828-54.594 2.297-7.234h51l22.094 61.734 35.063 14.516 58.031-29.406 36.063 36.031-27.938 59.203 14.438 35.172 61.875 20.125v50.969l-61.688 22.187z"/></symbol><symbol id="f-i-text-input" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path id="bhprefix__XMLID_10_" d="M15,4H4.5V3H6V2H4.5h-1H2v1h1.5v1H1C0.4,4,0,4.5,0,5v6c0,0.6,0.4,1,1,1h2.5v1H2v1h4v-1H4.5v-1H15 c0.6,0,1-0.4,1-1V5C16,4.5,15.6,4,15,4z M1,11V5h2.5v6H1z M15,11H4.5V5H15V11z"/></symbol><symbol id="f-i-textarea" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path id="biprefix__XMLID_1_" d="M3,11v-1h8v1H3L3,11z M3,7h10V6H3V7L3,7z M3,8v1h10V8H3L3,8z M13,4H3v1h10V4L13,4z M16,14V2c0-0.6-0.4-1-1-1 H1C0.4,1,0,1.4,0,2v12c0,0.6,0.4,1,1,1h14C15.6,15,16,14.6,16,14z M15,2v12H1V2H15z"/></symbol><symbol viewBox="0 0 24 32" id="f-i-triangle-down" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M0 12l11.992 11.992 11.992-11.992h-23.984z"/></symbol><symbol viewBox="0 0 12 32" id="f-i-triangle-left" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M0 15.996l11.992 11.992v-23.984l-11.992 11.992z"/></symbol><symbol viewBox="0 0 12 32" id="f-i-triangle-right" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M0.002 4.008l11.992 11.992-11.992 11.992v-23.984z"/></symbol><symbol viewBox="0 0 24 32" id="f-i-triangle-up" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M11.992 8l-11.992 11.992h23.984l-11.992-11.992z"/></symbol><symbol viewBox="0 0 512 512" id="f-i-upload" xmlns="http://www.w3.org/2000/svg"><g id="bnprefix__icomoon-ignore"/><path d="M240 352h-240v128h480v-128h-240zM448 416h-64v-32h64v32zM112 160l128-128 128 128h-80v160h-96v-160z"/></symbol></svg>',Ns=Fu.name,Fs=Fu.version,Vn=Ns,Rf="formeo-sprite",kf=null,Df=`https://cdn.jsdelivr.net/npm/formeo@${Fs}/dist/${Rf}.svg`,Of=`https://cdn.jsdelivr.net/npm/formeo@${Fs}/dist/formeo.min.css`,Jl="https://draggable.github.io/formeo/assets/css/formeo.min.css",th="f-panel",st="control-group",Ot=`${Vn}-stage`,Qe=`${Vn}-row`,Je=`${Vn}-column`,It=`${Vn}-field`,bs="custom-column-widths",nh="column-preset",Wr="resizing-columns",If=new Map([[Ot,Qe],[Qe,Je],[Je,It]]),Ps=["stage","row","column","field"],Hs=Ps.map(l=>`${l}s`);new Map(Hs.map((l,e)=>[l,Ps[e]]));const Nf=new RegExp(`^${Hs.join("|")}.`),ih=[...Ps],Ff=[...Hs],Pf=new Map(Ff.map((l,e)=>[l,ih[e]])),zr=ih.reduce((l,e)=>(l[e]=e,l),{}),Hf=[{name:"controls",className:st},{name:"stage",className:Ot},{name:"row",className:Qe},{name:"column",className:Je},{name:"field",className:It}],Ws={controls:st,stage:Ot,row:Qe,column:Je,field:It},Wf=Object.entries(Ws).reduce((l,[e,t])=>(l[t]=e,l),{}),zf=Object.values(Ws),Bf=new RegExp(`${zf.join("|")}`,"g"),{childTypeMapVals:rh,childTypeIndexMapVals:jf}=Hf.reduce((l,{name:e},t,n)=>{const{name:f}=n[t+1]||{};return f&&(l.childTypeMapVals.push([e,f]),l.childTypeIndexMapVals.push([`${e}s`,`${f}s`])),l},{childTypeMapVals:[],childTypeIndexMapVals:[]}),Vf=rh.slice().map(l=>l.slice().reverse()).reverse(),ec=new Map(rh),Uf=new Map(jf),Gf=new Map(Vf.slice()),qf=[[{value:"100.0",label:"100%"}],[{value:"50.0,50.0",label:"50 | 50"},{value:"33.3,66.6",label:"33 | 66"},{value:"66.6,33.3",label:"66 | 33"}],[{value:"33.3,33.3,33.3",label:"33 | 33 | 33"},{value:"25.0,25.0,50.0",label:"25 | 25 | 50"},{value:"50.0,25.0,25.0",label:"50 | 25 | 25"},{value:"25.0,50.0,25.0",label:"25 | 50 | 25"}],[{value:"25.0,25.0,25.0,25.0",label:"25 | 25 | 25 | 25"}],[{value:"20.0,20.0,20.0,20.0,20.0",label:"20 | 20 | 20 | 20 | 20"}],[{value:"16.66,16.66,16.66,16.66,16.66,16.66",label:"16.66 | 16.66 | 16.66 | 16.66 | 16.66 | 16.66"}]],Kf=new Map(qf.reduce((l,e,t)=>(l.push([t,e]),l),[])),oh=`${Ns}-formData`,tc=`${Ns}-locale`,Ye=333,mt=Math.round(Ye/2),zs=Math.round(Ye*2),sh="formeoSaved",Jt="formeoUpdated",Yf="formeoChanged",ah="formeoUpdatedStage",lh="formeoUpdatedRow",ch="formeoUpdatedColumn",uh="formeoUpdatedField",Zf="formeoCleared",hh="formeoOnRender",Xf="formeoConditionUpdated",Bs="formeoAddedRow",js="formeoAddedColumn",Vs="formeoAddedField",Us="formeoRemovedRow",Gs="formeoRemovedColumn",qs="formeoRemovedField",dh={equals:"==",notEquals:"!=",contains:"⊃",notContains:"!⊃"},Qf={and:"&&",or:"||"},fh={equals:"="},Jf=["logical","source","sourceProperty","comparison","target","targetProperty","assignment","value"],nc=["isChecked","isNotChecked"],ic=["isVisible","isNotVisible"],mn=["value"],ep={comparison:dh,assignment:fh,logical:Qf},ph="if",tp="then",Ks=()=>({[ph]:[{source:"",sourceProperty:"",comparison:"",target:"",targetProperty:""}],[tp]:[{target:"",targetProperty:"",assignment:"",value:""}]}),np=/(\b[0-9a-f]{8}\b-[0-9a-f]{4}-[0-9a-f]{4}-[0-9a-f]{4}-\b[0-9a-f]{12}\b)|(\b[0-9a-f]{8}\b)/g,Cs=/\bcol-\w+-\d+/g,gh="f-i-",En=()=>({id:He(),stages:{[He()]:{}},rows:{},columns:{},fields:{}}),_n=["selected","checked"],ip=_n.toReversed(),rp="a an and as at but by for for from in into near nor of on onto or the to with".split(" ").map(l=>`\\s${l}\\s`),op=new RegExp(`(?!${rp.join("|")})\\w\\S*`,"g"),sp=/\s+/g;function at(l){return typeof l!="string"||l.trim().match(sp)?l:l.replace(op,t=>t.charAt(0).toUpperCase()+t.substring(1).replace(/[A-Z]/g,n=>` ${n}`))}const mh=(l,e="-")=>l.toString().normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim().replace(/[^a-z0-9 -]/g,"").replace(/\s+/g,e),vt=l=>{if(Array.isArray(l))return l;const e=/[.[\]]/g,t=[];let n=0,f=e.exec(l);for(;f!==null;)t.push(l.slice(n,f.index)),n=f.index+f[0].length,f=e.exec(l);return n<l.length&&t.push(l.slice(n)),t.filter(Boolean)},rc=(l,e="-")=>vt(l).join(e),ap=l=>{const e=document.createElement("div");return e.innerHTML=l,e.textContent||e.innerText||""},lp=(l,e,t="…")=>{if(l.length<=e)return l;const n=l.slice(0,e),f=n.lastIndexOf(" ");let d=`${f>0?n.slice(0,f):n}`;return t&&(d+=t),d};var Br,oc;function Ys(){if(oc)return Br;oc=1;var l=Dt(),e=wt(),t="[object Symbol]";function n(f){return typeof f=="symbol"||e(f)&&l(f)==t}return Br=n,Br}var jr,sc;function cp(){if(sc)return jr;sc=1;var l=bt(),e=Ys(),t=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,n=/^\w*$/;function f(d,g){if(l(d))return!1;var m=typeof d;return m=="number"||m=="symbol"||m=="boolean"||d==null||e(d)?!0:n.test(d)||!t.test(d)||g!=null&&d in Object(g)}return jr=f,jr}var Vr,ac;function up(){if(ac)return Vr;ac=1;var l=Ls(),e="Expected a function";function t(n,f){if(typeof n!="function"||f!=null&&typeof f!="function")throw new TypeError(e);var d=function(){var g=arguments,m=f?f.apply(this,g):g[0],c=d.cache;if(c.has(m))return c.get(m);var p=n.apply(this,g);return d.cache=c.set(m,p)||c,p};return d.cache=new(t.Cache||l),d}return t.Cache=l,Vr=t,Vr}var Ur,lc;function hp(){if(lc)return Ur;lc=1;var l=up(),e=500;function t(n){var f=l(n,function(g){return d.size===e&&d.clear(),g}),d=f.cache;return f}return Ur=t,Ur}var Gr,cc;function dp(){if(cc)return Gr;cc=1;var l=hp(),e=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,t=/\\(\\)?/g,n=l(function(f){var d=[];return f.charCodeAt(0)===46&&d.push(""),f.replace(e,function(g,m,c,p){d.push(c?p.replace(t,"$1"):m||g)}),d});return Gr=n,Gr}var qr,uc;function fp(){if(uc)return qr;uc=1;function l(e,t){for(var n=-1,f=e==null?0:e.length,d=Array(f);++n<f;)d[n]=t(e[n],n,e);return d}return qr=l,qr}var Kr,hc;function pp(){if(hc)return Kr;hc=1;var l=Hn(),e=fp(),t=bt(),n=Ys(),f=l?l.prototype:void 0,d=f?f.toString:void 0;function g(m){if(typeof m=="string")return m;if(t(m))return e(m,g)+"";if(n(m))return d?d.call(m):"";var c=m+"";return c=="0"&&1/m==-1/0?"-0":c}return Kr=g,Kr}var Yr,dc;function Un(){if(dc)return Yr;dc=1;var l=pp();function e(t){return t==null?"":l(t)}return Yr=e,Yr}var Zr,fc;function vh(){if(fc)return Zr;fc=1;var l=bt(),e=cp(),t=dp(),n=Un();function f(d,g){return l(d)?d:e(d,g)?[d]:t(n(d))}return Zr=f,Zr}var Xr,pc;function yh(){if(pc)return Xr;pc=1;var l=Ys();function e(t){if(typeof t=="string"||l(t))return t;var n=t+"";return n=="0"&&1/t==-1/0?"-0":n}return Xr=e,Xr}var Qr,gc;function gp(){if(gc)return Qr;gc=1;var l=vh(),e=yh();function t(n,f){f=l(f,n);for(var d=0,g=f.length;n!=null&&d<g;)n=n[e(f[d++])];return d&&d==g?n:void 0}return Qr=t,Qr}var Jr,mc;function mp(){if(mc)return Jr;mc=1;var l=gp();function e(t,n,f){var d=t==null?void 0:l(t,n);return d===void 0?f:d}return Jr=e,Jr}var vp=mp();const yp=kt(vp);var eo,vc;function wp(){if(vc)return eo;vc=1;var l=Yu(),e=vh(),t=Is(),n=ct(),f=yh();function d(g,m,c,p){if(!n(g))return g;m=e(m,g);for(var r=-1,o=m.length,s=o-1,a=g;a!=null&&++r<o;){var i=f(m[r]),u=c;if(i==="__proto__"||i==="constructor"||i==="prototype")return g;if(r!=s){var h=a[i];u=p?p(h,i,a):void 0,u===void 0&&(u=n(h)?h:t(m[r+1])?[]:{})}l(a,i,u),a=a[i]}return g}return eo=d,eo}var to,yc;function bp(){if(yc)return to;yc=1;var l=wp();function e(t,n,f){return t==null?t:l(t,n,f)}return to=e,to}var Cp=bp();const Sp=kt(Cp),Ie=yp,Gn=Sp;function Ap(l,e={}){const t={...l};for(const n in e)Object.hasOwn(e,n)&&(Object.hasOwn(t,n)?Array.isArray(t[n])?t[n].push(e[n]):t[n]=[t[n],e[n]]:t[n]=e[n]);return t}function vn(...l){return l.flat().reduce((e,t)=>(e[t]=t,e),{})}var no,wc;function $p(){if(wc)return no;wc=1;var l="__lodash_hash_undefined__";function e(t){return this.__data__.set(t,l),this}return no=e,no}var io,bc;function Mp(){if(bc)return io;bc=1;function l(e){return this.__data__.has(e)}return io=l,io}var ro,Cc;function xp(){if(Cc)return ro;Cc=1;var l=Ls(),e=$p(),t=Mp();function n(f){var d=-1,g=f==null?0:f.length;for(this.__data__=new l;++d<g;)this.add(f[d])}return n.prototype.add=n.prototype.push=e,n.prototype.has=t,ro=n,ro}var oo,Sc;function Ep(){if(Sc)return oo;Sc=1;function l(e,t){for(var n=-1,f=e==null?0:e.length;++n<f;)if(t(e[n],n,e))return!0;return!1}return oo=l,oo}var so,Ac;function _p(){if(Ac)return so;Ac=1;function l(e,t){return e.has(t)}return so=l,so}var ao,$c;function wh(){if($c)return ao;$c=1;var l=xp(),e=Ep(),t=_p(),n=1,f=2;function d(g,m,c,p,r,o){var s=c&n,a=g.length,i=m.length;if(a!=i&&!(s&&i>a))return!1;var u=o.get(g),h=o.get(m);if(u&&h)return u==m&&h==g;var y=-1,w=!0,x=c&f?new l:void 0;for(o.set(g,m),o.set(m,g);++y<a;){var $=g[y],A=m[y];if(p)var S=s?p(A,$,y,m,g,o):p($,A,y,g,m,o);if(S!==void 0){if(S)continue;w=!1;break}if(x){if(!e(m,function(E,R){if(!t(x,R)&&($===E||r($,E,c,p,o)))return x.push(R)})){w=!1;break}}else if(!($===A||r($,A,c,p,o))){w=!1;break}}return o.delete(g),o.delete(m),w}return ao=d,ao}var lo,Mc;function Tp(){if(Mc)return lo;Mc=1;function l(e){var t=-1,n=Array(e.size);return e.forEach(function(f,d){n[++t]=[d,f]}),n}return lo=l,lo}var co,xc;function Lp(){if(xc)return co;xc=1;function l(e){var t=-1,n=Array(e.size);return e.forEach(function(f){n[++t]=f}),n}return co=l,co}var uo,Ec;function Rp(){if(Ec)return uo;Ec=1;var l=Hn(),e=ju(),t=nn(),n=wh(),f=Tp(),d=Lp(),g=1,m=2,c="[object Boolean]",p="[object Date]",r="[object Error]",o="[object Map]",s="[object Number]",a="[object RegExp]",i="[object Set]",u="[object String]",h="[object Symbol]",y="[object ArrayBuffer]",w="[object DataView]",x=l?l.prototype:void 0,$=x?x.valueOf:void 0;function A(S,E,R,L,_,D,b){switch(R){case w:if(S.byteLength!=E.byteLength||S.byteOffset!=E.byteOffset)return!1;S=S.buffer,E=E.buffer;case y:return!(S.byteLength!=E.byteLength||!D(new e(S),new e(E)));case c:case p:case s:return t(+S,+E);case r:return S.name==E.name&&S.message==E.message;case a:case u:return S==E+"";case o:var v=f;case i:var C=L&g;if(v||(v=d),S.size!=E.size&&!C)return!1;var M=b.get(S);if(M)return M==E;L|=m,b.set(S,E);var T=n(v(S),v(E),L,_,D,b);return b.delete(S),T;case h:if($)return $.call(S)==$.call(E)}return!1}return uo=A,uo}var ho,_c;function kp(){if(_c)return ho;_c=1;function l(e,t){for(var n=-1,f=t.length,d=e.length;++n<f;)e[d+n]=t[n];return e}return ho=l,ho}var fo,Tc;function Dp(){if(Tc)return fo;Tc=1;var l=kp(),e=bt();function t(n,f,d){var g=f(n);return e(n)?g:l(g,d(n))}return fo=t,fo}var po,Lc;function Op(){if(Lc)return po;Lc=1;function l(e,t){for(var n=-1,f=e==null?0:e.length,d=0,g=[];++n<f;){var m=e[n];t(m,n,e)&&(g[d++]=m)}return g}return po=l,po}var go,Rc;function Ip(){if(Rc)return go;Rc=1;function l(){return[]}return go=l,go}var mo,kc;function Np(){if(kc)return mo;kc=1;var l=Op(),e=Ip(),t=Object.prototype,n=t.propertyIsEnumerable,f=Object.getOwnPropertySymbols,d=f?function(g){return g==null?[]:(g=Object(g),l(f(g),function(m){return n.call(g,m)}))}:e;return mo=d,mo}var vo,Dc;function Fp(){if(Dc)return vo;Dc=1;var l=Vu(),e=l(Object.keys,Object);return vo=e,vo}var yo,Oc;function Pp(){if(Oc)return yo;Oc=1;var l=ks(),e=Fp(),t=Object.prototype,n=t.hasOwnProperty;function f(d){if(!l(d))return e(d);var g=[];for(var m in Object(d))n.call(d,m)&&m!="constructor"&&g.push(m);return g}return yo=f,yo}var wo,Ic;function Hp(){if(Ic)return wo;Ic=1;var l=Zu(),e=Pp(),t=Bn();function n(f){return t(f)?l(f):e(f)}return wo=n,wo}var bo,Nc;function Wp(){if(Nc)return bo;Nc=1;var l=Dp(),e=Np(),t=Hp();function n(f){return l(f,t,e)}return bo=n,bo}var Co,Fc;function zp(){if(Fc)return Co;Fc=1;var l=Wp(),e=1,t=Object.prototype,n=t.hasOwnProperty;function f(d,g,m,c,p,r){var o=m&e,s=l(d),a=s.length,i=l(g),u=i.length;if(a!=u&&!o)return!1;for(var h=a;h--;){var y=s[h];if(!(o?y in g:n.call(g,y)))return!1}var w=r.get(d),x=r.get(g);if(w&&x)return w==g&&x==d;var $=!0;r.set(d,g),r.set(g,d);for(var A=o;++h<a;){y=s[h];var S=d[y],E=g[y];if(c)var R=o?c(E,S,y,g,d,r):c(S,E,y,d,g,r);if(!(R===void 0?S===E||p(S,E,m,c,r):R)){$=!1;break}A||(A=y=="constructor")}if($&&!A){var L=d.constructor,_=g.constructor;L!=_&&"constructor"in d&&"constructor"in g&&!(typeof L=="function"&&L instanceof L&&typeof _=="function"&&_ instanceof _)&&($=!1)}return r.delete(d),r.delete(g),$}return Co=f,Co}var So,Pc;function Bp(){if(Pc)return So;Pc=1;var l=yt(),e=qe(),t=l(e,"DataView");return So=t,So}var Ao,Hc;function jp(){if(Hc)return Ao;Hc=1;var l=yt(),e=qe(),t=l(e,"Promise");return Ao=t,Ao}var $o,Wc;function Vp(){if(Wc)return $o;Wc=1;var l=yt(),e=qe(),t=l(e,"Set");return $o=t,$o}var Mo,zc;function Up(){if(zc)return Mo;zc=1;var l=yt(),e=qe(),t=l(e,"WeakMap");return Mo=t,Mo}var xo,Bc;function Gp(){if(Bc)return xo;Bc=1;var l=Bp(),e=Ts(),t=jp(),n=Vp(),f=Up(),d=Dt(),g=Hu(),m="[object Map]",c="[object Object]",p="[object Promise]",r="[object Set]",o="[object WeakMap]",s="[object DataView]",a=g(l),i=g(e),u=g(t),h=g(n),y=g(f),w=d;return(l&&w(new l(new ArrayBuffer(1)))!=s||e&&w(new e)!=m||t&&w(t.resolve())!=p||n&&w(new n)!=r||f&&w(new f)!=o)&&(w=function(x){var $=d(x),A=$==c?x.constructor:void 0,S=A?g(A):"";if(S)switch(S){case a:return s;case i:return m;case u:return p;case h:return r;case y:return o}return $}),xo=w,xo}var Eo,jc;function qp(){if(jc)return Eo;jc=1;var l=Wu(),e=wh(),t=Rp(),n=zp(),f=Gp(),d=bt(),g=Ds(),m=Os(),c=1,p="[object Arguments]",r="[object Array]",o="[object Object]",s=Object.prototype,a=s.hasOwnProperty;function i(u,h,y,w,x,$){var A=d(u),S=d(h),E=A?r:f(u),R=S?r:f(h);E=E==p?o:E,R=R==p?o:R;var L=E==o,_=R==o,D=E==R;if(D&&g(u)){if(!g(h))return!1;A=!0,L=!1}if(D&&!L)return $||($=new l),A||m(u)?e(u,h,y,w,x,$):t(u,h,E,y,w,x,$);if(!(y&c)){var b=L&&a.call(u,"__wrapped__"),v=_&&a.call(h,"__wrapped__");if(b||v){var C=b?u.value():u,M=v?h.value():h;return $||($=new l),x(C,M,y,w,$)}}return D?($||($=new l),n(u,h,y,w,x,$)):!1}return Eo=i,Eo}var _o,Vc;function Kp(){if(Vc)return _o;Vc=1;var l=qp(),e=wt();function t(n,f,d,g,m){return n===f?!0:n==null||f==null||!e(n)&&!e(f)?n!==n&&f!==f:l(n,f,d,g,t,m)}return _o=t,_o}var To,Uc;function Yp(){if(Uc)return To;Uc=1;var l=Kp();function e(t,n){return l(t,n)}return To=e,To}var Zp=Yp();const Ss=kt(Zp),Xp=(l,e)=>l===void 0?"added":e===void 0?"removed":Ss(l,e)?"unchanged":"changed";class Zs{constructor(e,t=Object.create(null)){this.name=e,this.data=t,this.dataPath=""}get size(){return Object.keys(this.data).length}get js(){return this.data}get json(){return this.data}toJSON=(e,t)=>JSON.stringify(e,null,t);get=e=>Ie(this.data,e);set(e,t){const n=Ie(this.data,e),f=Gn(this.data,e,t),d=Array.isArray(e)?e.join("."):e,g=Object.keys(this.setCallbacks).filter(c=>new RegExp(c).test(d)),m={newVal:t,oldVal:n,path:e};for(const c of g)for(const p of this.setCallbacks[c])p(m);if(!this.disableEvents){const c={entity:this,dataPath:this.dataPath.replace(/\.+$/,""),changePath:this.dataPath+e,value:t,data:f,changeType:Xp(n,t),src:this.dom};if(n&&(c.previousValue=n),J.formeoUpdated(c),this.name){const r={stage:ah,row:lh,column:ch,field:uh}[this.name];r&&J.formeoUpdated(c,r)}}return f}addSetCallback(e,t){this.setCallbacks[e]?this.setCallbacks[e].push(t):this.setCallbacks[e]=[t]}removeSetCallback(e,t){this.setCallbacks[e]=this.setCallbacks[e].filter(n=>n!==t)}add=(e,t=Object.create(null))=>{const{id:n}=t,f=e||n||He();return this.set(f,t)};remove=e=>{const t=vt(e),n=t.pop(),f=this.get(t);return Array.isArray(f)?f.splice(Number(n),1):f&&delete f[n],f};empty(){this.data=Object.create(null)}getData=()=>Object.entries(this.data).reduce((e,[t,n])=>(e[t]=n?.data?n.getData():n,e),{});setCallbacks={};configVal=Object.create(null)}class qn extends Zs{load=e=>{const t=jn(e);this.empty();for(const[n,f]of Object.entries(t))this.add(n,f);return this.data};get=e=>e?Ie(this.data,e):this.add();add=(e,t=Object.create(null))=>{const n=e||He(),f=this.Component({...t,id:n});this.data[n]=f,this.active=f;const g={row:Bs,column:js,field:Vs}[this.name];return g&&J.formeoUpdated({entity:f,componentId:n,componentType:this.name,data:f.data},g),f};remove=e=>{if(Array.isArray(e))for(const t of e)this.get(t).remove();else this.get(e).remove();return this.data};delete=e=>(delete this.data[e],e);clearAll=(e=!0)=>{const t=Object.values(this.data).map(n=>n.empty(e));return Promise.all(t)};set config(e){this.configVal=je(this.configVal,Xe(e))}get config(){return this.configVal}conditionMap=new Map}function Gc(l,e){var t=Object.keys(l);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(l);e&&(n=n.filter(function(f){return Object.getOwnPropertyDescriptor(l,f).enumerable})),t.push.apply(t,n)}return t}function Ge(l){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?Gc(Object(t),!0).forEach(function(n){Qp(l,n,t[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(l,Object.getOwnPropertyDescriptors(t)):Gc(Object(t)).forEach(function(n){Object.defineProperty(l,n,Object.getOwnPropertyDescriptor(t,n))})}return l}function yn(l){"@babel/helpers - typeof";return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?yn=function(e){return typeof e}:yn=function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},yn(l)}function Qp(l,e,t){return e in l?Object.defineProperty(l,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):l[e]=t,l}function et(){return et=Object.assign||function(l){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(l[n]=t[n])}return l},et.apply(this,arguments)}function Jp(l,e){if(l==null)return{};var t={},n=Object.keys(l),f,d;for(d=0;d<n.length;d++)f=n[d],!(e.indexOf(f)>=0)&&(t[f]=l[f]);return t}function eg(l,e){if(l==null)return{};var t=Jp(l,e),n,f;if(Object.getOwnPropertySymbols){var d=Object.getOwnPropertySymbols(l);for(f=0;f<d.length;f++)n=d[f],!(e.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(l,n)&&(t[n]=l[n])}return t}var tg="1.15.3";function Ze(l){if(typeof window<"u"&&window.navigator)return!!navigator.userAgent.match(l)}var nt=Ze(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),rn=Ze(/Edge/i),qc=Ze(/firefox/i),qt=Ze(/safari/i)&&!Ze(/chrome/i)&&!Ze(/android/i),bh=Ze(/iP(ad|od|hone)/i),Ch=Ze(/chrome/i)&&Ze(/android/i),Sh={capture:!1,passive:!1};function se(l,e,t){l.addEventListener(e,t,!nt&&Sh)}function oe(l,e,t){l.removeEventListener(e,t,!nt&&Sh)}function Tn(l,e){if(e){if(e[0]===">"&&(e=e.substring(1)),l)try{if(l.matches)return l.matches(e);if(l.msMatchesSelector)return l.msMatchesSelector(e);if(l.webkitMatchesSelector)return l.webkitMatchesSelector(e)}catch{return!1}return!1}}function Ah(l){return l.host&&l!==document&&l.host.nodeType?l.host:l.parentNode}function Be(l,e,t,n){if(l){t=t||document;do{if(e!=null&&(e[0]===">"?l.parentNode===t&&Tn(l,e):Tn(l,e))||n&&l===t)return l;if(l===t)break}while(l=Ah(l))}return null}var Kc=/\s+/g;function De(l,e,t){if(l&&e)if(l.classList)l.classList[t?"add":"remove"](e);else{var n=(" "+l.className+" ").replace(Kc," ").replace(" "+e+" "," ");l.className=(n+(t?" "+e:"")).replace(Kc," ")}}function ne(l,e,t){var n=l&&l.style;if(n){if(t===void 0)return document.defaultView&&document.defaultView.getComputedStyle?t=document.defaultView.getComputedStyle(l,""):l.currentStyle&&(t=l.currentStyle),e===void 0?t:t[e];!(e in n)&&e.indexOf("webkit")===-1&&(e="-webkit-"+e),n[e]=t+(typeof t=="string"?"":"px")}}function _t(l,e){var t="";if(typeof l=="string")t=l;else do{var n=ne(l,"transform");n&&n!=="none"&&(t=n+" "+t)}while(!e&&(l=l.parentNode));var f=window.DOMMatrix||window.WebKitCSSMatrix||window.CSSMatrix||window.MSCSSMatrix;return f&&new f(t)}function $h(l,e,t){if(l){var n=l.getElementsByTagName(e),f=0,d=n.length;if(t)for(;f<d;f++)t(n[f],f);return n}return[]}function Ue(){var l=document.scrollingElement;return l||document.documentElement}function be(l,e,t,n,f){if(!(!l.getBoundingClientRect&&l!==window)){var d,g,m,c,p,r,o;if(l!==window&&l.parentNode&&l!==Ue()?(d=l.getBoundingClientRect(),g=d.top,m=d.left,c=d.bottom,p=d.right,r=d.height,o=d.width):(g=0,m=0,c=window.innerHeight,p=window.innerWidth,r=window.innerHeight,o=window.innerWidth),(e||t)&&l!==window&&(f=f||l.parentNode,!nt))do if(f&&f.getBoundingClientRect&&(ne(f,"transform")!=="none"||t&&ne(f,"position")!=="static")){var s=f.getBoundingClientRect();g-=s.top+parseInt(ne(f,"border-top-width")),m-=s.left+parseInt(ne(f,"border-left-width")),c=g+d.height,p=m+d.width;break}while(f=f.parentNode);if(n&&l!==window){var a=_t(f||l),i=a&&a.a,u=a&&a.d;a&&(g/=u,m/=i,o/=i,r/=u,c=g+r,p=m+o)}return{top:g,left:m,bottom:c,right:p,width:o,height:r}}}function Yc(l,e,t){for(var n=ot(l,!0),f=be(l)[e];n;){var d=be(n)[t],g=void 0;if(g=f>=d,!g)return n;if(n===Ue())break;n=ot(n,!1)}return!1}function Tt(l,e,t,n){for(var f=0,d=0,g=l.children;d<g.length;){if(g[d].style.display!=="none"&&g[d]!==te.ghost&&(n||g[d]!==te.dragged)&&Be(g[d],t.draggable,l,!1)){if(f===e)return g[d];f++}d++}return null}function Xs(l,e){for(var t=l.lastElementChild;t&&(t===te.ghost||ne(t,"display")==="none"||e&&!Tn(t,e));)t=t.previousElementSibling;return t||null}function Fe(l,e){var t=0;if(!l||!l.parentNode)return-1;for(;l=l.previousElementSibling;)l.nodeName.toUpperCase()!=="TEMPLATE"&&l!==te.clone&&(!e||Tn(l,e))&&t++;return t}function Zc(l){var e=0,t=0,n=Ue();if(l)do{var f=_t(l),d=f.a,g=f.d;e+=l.scrollLeft*d,t+=l.scrollTop*g}while(l!==n&&(l=l.parentNode));return[e,t]}function ng(l,e){for(var t in l)if(l.hasOwnProperty(t)){for(var n in e)if(e.hasOwnProperty(n)&&e[n]===l[t][n])return Number(t)}return-1}function ot(l,e){if(!l||!l.getBoundingClientRect)return Ue();var t=l,n=!1;do if(t.clientWidth<t.scrollWidth||t.clientHeight<t.scrollHeight){var f=ne(t);if(t.clientWidth<t.scrollWidth&&(f.overflowX=="auto"||f.overflowX=="scroll")||t.clientHeight<t.scrollHeight&&(f.overflowY=="auto"||f.overflowY=="scroll")){if(!t.getBoundingClientRect||t===document.body)return Ue();if(n||e)return t;n=!0}}while(t=t.parentNode);return Ue()}function ig(l,e){if(l&&e)for(var t in e)e.hasOwnProperty(t)&&(l[t]=e[t]);return l}function Lo(l,e){return Math.round(l.top)===Math.round(e.top)&&Math.round(l.left)===Math.round(e.left)&&Math.round(l.height)===Math.round(e.height)&&Math.round(l.width)===Math.round(e.width)}var Kt;function Mh(l,e){return function(){if(!Kt){var t=arguments,n=this;t.length===1?l.call(n,t[0]):l.apply(n,t),Kt=setTimeout(function(){Kt=void 0},e)}}}function rg(){clearTimeout(Kt),Kt=void 0}function xh(l,e,t){l.scrollLeft+=e,l.scrollTop+=t}function Eh(l){var e=window.Polymer,t=window.jQuery||window.Zepto;return e&&e.dom?e.dom(l).cloneNode(!0):t?t(l).clone(!0)[0]:l.cloneNode(!0)}function _h(l,e,t){var n={};return Array.from(l.children).forEach(function(f){var d,g,m,c;if(!(!Be(f,e.draggable,l,!1)||f.animated||f===t)){var p=be(f);n.left=Math.min((d=n.left)!==null&&d!==void 0?d:1/0,p.left),n.top=Math.min((g=n.top)!==null&&g!==void 0?g:1/0,p.top),n.right=Math.max((m=n.right)!==null&&m!==void 0?m:-1/0,p.right),n.bottom=Math.max((c=n.bottom)!==null&&c!==void 0?c:-1/0,p.bottom)}}),n.width=n.right-n.left,n.height=n.bottom-n.top,n.x=n.left,n.y=n.top,n}var Re="Sortable"+new Date().getTime();function og(){var l=[],e;return{captureAnimationState:function(){if(l=[],!!this.options.animation){var n=[].slice.call(this.el.children);n.forEach(function(f){if(!(ne(f,"display")==="none"||f===te.ghost)){l.push({target:f,rect:be(f)});var d=Ge({},l[l.length-1].rect);if(f.thisAnimationDuration){var g=_t(f,!0);g&&(d.top-=g.f,d.left-=g.e)}f.fromRect=d}})}},addAnimationState:function(n){l.push(n)},removeAnimationState:function(n){l.splice(ng(l,{target:n}),1)},animateAll:function(n){var f=this;if(!this.options.animation){clearTimeout(e),typeof n=="function"&&n();return}var d=!1,g=0;l.forEach(function(m){var c=0,p=m.target,r=p.fromRect,o=be(p),s=p.prevFromRect,a=p.prevToRect,i=m.rect,u=_t(p,!0);u&&(o.top-=u.f,o.left-=u.e),p.toRect=o,p.thisAnimationDuration&&Lo(s,o)&&!Lo(r,o)&&(i.top-o.top)/(i.left-o.left)===(r.top-o.top)/(r.left-o.left)&&(c=ag(i,s,a,f.options)),Lo(o,r)||(p.prevFromRect=r,p.prevToRect=o,c||(c=f.options.animation),f.animate(p,i,o,c)),c&&(d=!0,g=Math.max(g,c),clearTimeout(p.animationResetTimer),p.animationResetTimer=setTimeout(function(){p.animationTime=0,p.prevFromRect=null,p.fromRect=null,p.prevToRect=null,p.thisAnimationDuration=null},c),p.thisAnimationDuration=c)}),clearTimeout(e),d?e=setTimeout(function(){typeof n=="function"&&n()},g):typeof n=="function"&&n(),l=[]},animate:function(n,f,d,g){if(g){ne(n,"transition",""),ne(n,"transform","");var m=_t(this.el),c=m&&m.a,p=m&&m.d,r=(f.left-d.left)/(c||1),o=(f.top-d.top)/(p||1);n.animatingX=!!r,n.animatingY=!!o,ne(n,"transform","translate3d("+r+"px,"+o+"px,0)"),this.forRepaintDummy=sg(n),ne(n,"transition","transform "+g+"ms"+(this.options.easing?" "+this.options.easing:"")),ne(n,"transform","translate3d(0,0,0)"),typeof n.animated=="number"&&clearTimeout(n.animated),n.animated=setTimeout(function(){ne(n,"transition",""),ne(n,"transform",""),n.animated=!1,n.animatingX=!1,n.animatingY=!1},g)}}}}function sg(l){return l.offsetWidth}function ag(l,e,t,n){return Math.sqrt(Math.pow(e.top-l.top,2)+Math.pow(e.left-l.left,2))/Math.sqrt(Math.pow(e.top-t.top,2)+Math.pow(e.left-t.left,2))*n.animation}var Ct=[],Ro={initializeByDefault:!0},on={mount:function(e){for(var t in Ro)Ro.hasOwnProperty(t)&&!(t in e)&&(e[t]=Ro[t]);Ct.forEach(function(n){if(n.pluginName===e.pluginName)throw"Sortable: Cannot mount plugin ".concat(e.pluginName," more than once")}),Ct.push(e)},pluginEvent:function(e,t,n){var f=this;this.eventCanceled=!1,n.cancel=function(){f.eventCanceled=!0};var d=e+"Global";Ct.forEach(function(g){t[g.pluginName]&&(t[g.pluginName][d]&&t[g.pluginName][d](Ge({sortable:t},n)),t.options[g.pluginName]&&t[g.pluginName][e]&&t[g.pluginName][e](Ge({sortable:t},n)))})},initializePlugins:function(e,t,n,f){Ct.forEach(function(m){var c=m.pluginName;if(!(!e.options[c]&&!m.initializeByDefault)){var p=new m(e,t,e.options);p.sortable=e,p.options=e.options,e[c]=p,et(n,p.defaults)}});for(var d in e.options)if(e.options.hasOwnProperty(d)){var g=this.modifyOption(e,d,e.options[d]);typeof g<"u"&&(e.options[d]=g)}},getEventProperties:function(e,t){var n={};return Ct.forEach(function(f){typeof f.eventProperties=="function"&&et(n,f.eventProperties.call(t[f.pluginName],e))}),n},modifyOption:function(e,t,n){var f;return Ct.forEach(function(d){e[d.pluginName]&&d.optionListeners&&typeof d.optionListeners[t]=="function"&&(f=d.optionListeners[t].call(e[d.pluginName],n))}),f}};function lg(l){var e=l.sortable,t=l.rootEl,n=l.name,f=l.targetEl,d=l.cloneEl,g=l.toEl,m=l.fromEl,c=l.oldIndex,p=l.newIndex,r=l.oldDraggableIndex,o=l.newDraggableIndex,s=l.originalEvent,a=l.putSortable,i=l.extraEventProperties;if(e=e||t&&t[Re],!!e){var u,h=e.options,y="on"+n.charAt(0).toUpperCase()+n.substr(1);window.CustomEvent&&!nt&&!rn?u=new CustomEvent(n,{bubbles:!0,cancelable:!0}):(u=document.createEvent("Event"),u.initEvent(n,!0,!0)),u.to=g||t,u.from=m||t,u.item=f||t,u.clone=d,u.oldIndex=c,u.newIndex=p,u.oldDraggableIndex=r,u.newDraggableIndex=o,u.originalEvent=s,u.pullMode=a?a.lastPutMode:void 0;var w=Ge(Ge({},i),on.getEventProperties(n,e));for(var x in w)u[x]=w[x];t&&t.dispatchEvent(u),h[y]&&h[y].call(e,u)}}var cg=["evt"],Te=function(e,t){var n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},f=n.evt,d=eg(n,cg);on.pluginEvent.bind(te)(e,t,Ge({dragEl:q,parentEl:ve,ghostEl:ie,rootEl:fe,nextEl:pt,lastDownEl:wn,cloneEl:pe,cloneHidden:rt,dragStarted:jt,putSortable:Se,activeSortable:te.active,originalEvent:f,oldIndex:xt,oldDraggableIndex:Yt,newIndex:Oe,newDraggableIndex:it,hideGhostForTarget:kh,unhideGhostForTarget:Dh,cloneNowHidden:function(){rt=!0},cloneNowShown:function(){rt=!1},dispatchSortableEvent:function(m){Me({sortable:t,name:m,originalEvent:f})}},d))};function Me(l){lg(Ge({putSortable:Se,cloneEl:pe,targetEl:q,rootEl:fe,oldIndex:xt,oldDraggableIndex:Yt,newIndex:Oe,newDraggableIndex:it},l))}var q,ve,ie,fe,pt,wn,pe,rt,xt,Oe,Yt,it,ln,Se,At=!1,Ln=!1,Rn=[],dt,We,ko,Do,Xc,Qc,jt,St,Zt,Xt=!1,cn=!1,bn,Ae,Oo=[],As=!1,kn=[],Kn=typeof document<"u",un=bh,Jc=rn||nt?"cssFloat":"float",ug=Kn&&!Ch&&!bh&&"draggable"in document.createElement("div"),Th=(function(){if(Kn){if(nt)return!1;var l=document.createElement("x");return l.style.cssText="pointer-events:auto",l.style.pointerEvents==="auto"}})(),Lh=function(e,t){var n=ne(e),f=parseInt(n.width)-parseInt(n.paddingLeft)-parseInt(n.paddingRight)-parseInt(n.borderLeftWidth)-parseInt(n.borderRightWidth),d=Tt(e,0,t),g=Tt(e,1,t),m=d&&ne(d),c=g&&ne(g),p=m&&parseInt(m.marginLeft)+parseInt(m.marginRight)+be(d).width,r=c&&parseInt(c.marginLeft)+parseInt(c.marginRight)+be(g).width;if(n.display==="flex")return n.flexDirection==="column"||n.flexDirection==="column-reverse"?"vertical":"horizontal";if(n.display==="grid")return n.gridTemplateColumns.split(" ").length<=1?"vertical":"horizontal";if(d&&m.float&&m.float!=="none"){var o=m.float==="left"?"left":"right";return g&&(c.clear==="both"||c.clear===o)?"vertical":"horizontal"}return d&&(m.display==="block"||m.display==="flex"||m.display==="table"||m.display==="grid"||p>=f&&n[Jc]==="none"||g&&n[Jc]==="none"&&p+r>f)?"vertical":"horizontal"},hg=function(e,t,n){var f=n?e.left:e.top,d=n?e.right:e.bottom,g=n?e.width:e.height,m=n?t.left:t.top,c=n?t.right:t.bottom,p=n?t.width:t.height;return f===m||d===c||f+g/2===m+p/2},dg=function(e,t){var n;return Rn.some(function(f){var d=f[Re].options.emptyInsertThreshold;if(!(!d||Xs(f))){var g=be(f),m=e>=g.left-d&&e<=g.right+d,c=t>=g.top-d&&t<=g.bottom+d;if(m&&c)return n=f}}),n},Rh=function(e){function t(d,g){return function(m,c,p,r){var o=m.options.group.name&&c.options.group.name&&m.options.group.name===c.options.group.name;if(d==null&&(g||o))return!0;if(d==null||d===!1)return!1;if(g&&d==="clone")return d;if(typeof d=="function")return t(d(m,c,p,r),g)(m,c,p,r);var s=(g?m:c).options.group.name;return d===!0||typeof d=="string"&&d===s||d.join&&d.indexOf(s)>-1}}var n={},f=e.group;(!f||yn(f)!="object")&&(f={name:f}),n.name=f.name,n.checkPull=t(f.pull,!0),n.checkPut=t(f.put),n.revertClone=f.revertClone,e.group=n},kh=function(){!Th&&ie&&ne(ie,"display","none")},Dh=function(){!Th&&ie&&ne(ie,"display","")};Kn&&!Ch&&document.addEventListener("click",function(l){if(Ln)return l.preventDefault(),l.stopPropagation&&l.stopPropagation(),l.stopImmediatePropagation&&l.stopImmediatePropagation(),Ln=!1,!1},!0);var ft=function(e){if(q){e=e.touches?e.touches[0]:e;var t=dg(e.clientX,e.clientY);if(t){var n={};for(var f in e)e.hasOwnProperty(f)&&(n[f]=e[f]);n.target=n.rootEl=t,n.preventDefault=void 0,n.stopPropagation=void 0,t[Re]._onDragOver(n)}}},fg=function(e){q&&q.parentNode[Re]._isOutsideThisEl(e.target)};function te(l,e){if(!(l&&l.nodeType&&l.nodeType===1))throw"Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(l));this.el=l,this.options=e=et({},e),l[Re]=this;var t={group:null,sort:!0,disabled:!1,store:null,handle:null,draggable:/^[uo]l$/i.test(l.nodeName)?">li":">*",swapThreshold:1,invertSwap:!1,invertedSwapThreshold:null,removeCloneOnHide:!0,direction:function(){return Lh(l,this.options)},ghostClass:"sortable-ghost",chosenClass:"sortable-chosen",dragClass:"sortable-drag",ignore:"a, img",filter:null,preventOnFilter:!0,animation:0,easing:null,setData:function(g,m){g.setData("Text",m.textContent)},dropBubble:!1,dragoverBubble:!1,dataIdAttr:"data-id",delay:0,delayOnTouchOnly:!1,touchStartThreshold:(Number.parseInt?Number:window).parseInt(window.devicePixelRatio,10)||1,forceFallback:!1,fallbackClass:"sortable-fallback",fallbackOnBody:!1,fallbackTolerance:0,fallbackOffset:{x:0,y:0},supportPointer:te.supportPointer!==!1&&"PointerEvent"in window&&!qt,emptyInsertThreshold:5};on.initializePlugins(this,l,t);for(var n in t)!(n in e)&&(e[n]=t[n]);Rh(e);for(var f in this)f.charAt(0)==="_"&&typeof this[f]=="function"&&(this[f]=this[f].bind(this));this.nativeDraggable=e.forceFallback?!1:ug,this.nativeDraggable&&(this.options.touchStartThreshold=1),e.supportPointer?se(l,"pointerdown",this._onTapStart):(se(l,"mousedown",this._onTapStart),se(l,"touchstart",this._onTapStart)),this.nativeDraggable&&(se(l,"dragover",this),se(l,"dragenter",this)),Rn.push(this.el),e.store&&e.store.get&&this.sort(e.store.get(this)||[]),et(this,og())}te.prototype={constructor:te,_isOutsideThisEl:function(e){!this.el.contains(e)&&e!==this.el&&(St=null)},_getDirection:function(e,t){return typeof this.options.direction=="function"?this.options.direction.call(this,e,t,q):this.options.direction},_onTapStart:function(e){if(e.cancelable){var t=this,n=this.el,f=this.options,d=f.preventOnFilter,g=e.type,m=e.touches&&e.touches[0]||e.pointerType&&e.pointerType==="touch"&&e,c=(m||e).target,p=e.target.shadowRoot&&(e.path&&e.path[0]||e.composedPath&&e.composedPath()[0])||c,r=f.filter;if(Cg(n),!q&&!(/mousedown|pointerdown/.test(g)&&e.button!==0||f.disabled)&&!p.isContentEditable&&!(!this.nativeDraggable&&qt&&c&&c.tagName.toUpperCase()==="SELECT")&&(c=Be(c,f.draggable,n,!1),!(c&&c.animated)&&wn!==c)){if(xt=Fe(c),Yt=Fe(c,f.draggable),typeof r=="function"){if(r.call(this,e,c,this)){Me({sortable:t,rootEl:p,name:"filter",targetEl:c,toEl:n,fromEl:n}),Te("filter",t,{evt:e}),d&&e.cancelable&&e.preventDefault();return}}else if(r&&(r=r.split(",").some(function(o){if(o=Be(p,o.trim(),n,!1),o)return Me({sortable:t,rootEl:o,name:"filter",targetEl:c,fromEl:n,toEl:n}),Te("filter",t,{evt:e}),!0}),r)){d&&e.cancelable&&e.preventDefault();return}f.handle&&!Be(p,f.handle,n,!1)||this._prepareDragStart(e,m,c)}}},_prepareDragStart:function(e,t,n){var f=this,d=f.el,g=f.options,m=d.ownerDocument,c;if(n&&!q&&n.parentNode===d){var p=be(n);if(fe=d,q=n,ve=q.parentNode,pt=q.nextSibling,wn=n,ln=g.group,te.dragged=q,dt={target:q,clientX:(t||e).clientX,clientY:(t||e).clientY},Xc=dt.clientX-p.left,Qc=dt.clientY-p.top,this._lastX=(t||e).clientX,this._lastY=(t||e).clientY,q.style["will-change"]="all",c=function(){if(Te("delayEnded",f,{evt:e}),te.eventCanceled){f._onDrop();return}f._disableDelayedDragEvents(),!qc&&f.nativeDraggable&&(q.draggable=!0),f._triggerDragStart(e,t),Me({sortable:f,name:"choose",originalEvent:e}),De(q,g.chosenClass,!0)},g.ignore.split(",").forEach(function(r){$h(q,r.trim(),Io)}),se(m,"dragover",ft),se(m,"mousemove",ft),se(m,"touchmove",ft),se(m,"mouseup",f._onDrop),se(m,"touchend",f._onDrop),se(m,"touchcancel",f._onDrop),qc&&this.nativeDraggable&&(this.options.touchStartThreshold=4,q.draggable=!0),Te("delayStart",this,{evt:e}),g.delay&&(!g.delayOnTouchOnly||t)&&(!this.nativeDraggable||!(rn||nt))){if(te.eventCanceled){this._onDrop();return}se(m,"mouseup",f._disableDelayedDrag),se(m,"touchend",f._disableDelayedDrag),se(m,"touchcancel",f._disableDelayedDrag),se(m,"mousemove",f._delayedDragTouchMoveHandler),se(m,"touchmove",f._delayedDragTouchMoveHandler),g.supportPointer&&se(m,"pointermove",f._delayedDragTouchMoveHandler),f._dragStartTimer=setTimeout(c,g.delay)}else c()}},_delayedDragTouchMoveHandler:function(e){var t=e.touches?e.touches[0]:e;Math.max(Math.abs(t.clientX-this._lastX),Math.abs(t.clientY-this._lastY))>=Math.floor(this.options.touchStartThreshold/(this.nativeDraggable&&window.devicePixelRatio||1))&&this._disableDelayedDrag()},_disableDelayedDrag:function(){q&&Io(q),clearTimeout(this._dragStartTimer),this._disableDelayedDragEvents()},_disableDelayedDragEvents:function(){var e=this.el.ownerDocument;oe(e,"mouseup",this._disableDelayedDrag),oe(e,"touchend",this._disableDelayedDrag),oe(e,"touchcancel",this._disableDelayedDrag),oe(e,"mousemove",this._delayedDragTouchMoveHandler),oe(e,"touchmove",this._delayedDragTouchMoveHandler),oe(e,"pointermove",this._delayedDragTouchMoveHandler)},_triggerDragStart:function(e,t){t=t||e.pointerType=="touch"&&e,!this.nativeDraggable||t?this.options.supportPointer?se(document,"pointermove",this._onTouchMove):t?se(document,"touchmove",this._onTouchMove):se(document,"mousemove",this._onTouchMove):(se(q,"dragend",this),se(fe,"dragstart",this._onDragStart));try{document.selection?Cn(function(){document.selection.empty()}):window.getSelection().removeAllRanges()}catch{}},_dragStarted:function(e,t){if(At=!1,fe&&q){Te("dragStarted",this,{evt:t}),this.nativeDraggable&&se(document,"dragover",fg);var n=this.options;!e&&De(q,n.dragClass,!1),De(q,n.ghostClass,!0),te.active=this,e&&this._appendGhost(),Me({sortable:this,name:"start",originalEvent:t})}else this._nulling()},_emulateDragOver:function(){if(We){this._lastX=We.clientX,this._lastY=We.clientY,kh();for(var e=document.elementFromPoint(We.clientX,We.clientY),t=e;e&&e.shadowRoot&&(e=e.shadowRoot.elementFromPoint(We.clientX,We.clientY),e!==t);)t=e;if(q.parentNode[Re]._isOutsideThisEl(e),t)do{if(t[Re]){var n=void 0;if(n=t[Re]._onDragOver({clientX:We.clientX,clientY:We.clientY,target:e,rootEl:t}),n&&!this.options.dragoverBubble)break}e=t}while(t=Ah(t));Dh()}},_onTouchMove:function(e){if(dt){var t=this.options,n=t.fallbackTolerance,f=t.fallbackOffset,d=e.touches?e.touches[0]:e,g=ie&&_t(ie,!0),m=ie&&g&&g.a,c=ie&&g&&g.d,p=un&&Ae&&Zc(Ae),r=(d.clientX-dt.clientX+f.x)/(m||1)+(p?p[0]-Oo[0]:0)/(m||1),o=(d.clientY-dt.clientY+f.y)/(c||1)+(p?p[1]-Oo[1]:0)/(c||1);if(!te.active&&!At){if(n&&Math.max(Math.abs(d.clientX-this._lastX),Math.abs(d.clientY-this._lastY))<n)return;this._onDragStart(e,!0)}if(ie){g?(g.e+=r-(ko||0),g.f+=o-(Do||0)):g={a:1,b:0,c:0,d:1,e:r,f:o};var s="matrix(".concat(g.a,",").concat(g.b,",").concat(g.c,",").concat(g.d,",").concat(g.e,",").concat(g.f,")");ne(ie,"webkitTransform",s),ne(ie,"mozTransform",s),ne(ie,"msTransform",s),ne(ie,"transform",s),ko=r,Do=o,We=d}e.cancelable&&e.preventDefault()}},_appendGhost:function(){if(!ie){var e=this.options.fallbackOnBody?document.body:fe,t=be(q,!0,un,!0,e),n=this.options;if(un){for(Ae=e;ne(Ae,"position")==="static"&&ne(Ae,"transform")==="none"&&Ae!==document;)Ae=Ae.parentNode;Ae!==document.body&&Ae!==document.documentElement?(Ae===document&&(Ae=Ue()),t.top+=Ae.scrollTop,t.left+=Ae.scrollLeft):Ae=Ue(),Oo=Zc(Ae)}ie=q.cloneNode(!0),De(ie,n.ghostClass,!1),De(ie,n.fallbackClass,!0),De(ie,n.dragClass,!0),ne(ie,"transition",""),ne(ie,"transform",""),ne(ie,"box-sizing","border-box"),ne(ie,"margin",0),ne(ie,"top",t.top),ne(ie,"left",t.left),ne(ie,"width",t.width),ne(ie,"height",t.height),ne(ie,"opacity","0.8"),ne(ie,"position",un?"absolute":"fixed"),ne(ie,"zIndex","100000"),ne(ie,"pointerEvents","none"),te.ghost=ie,e.appendChild(ie),ne(ie,"transform-origin",Xc/parseInt(ie.style.width)*100+"% "+Qc/parseInt(ie.style.height)*100+"%")}},_onDragStart:function(e,t){var n=this,f=e.dataTransfer,d=n.options;if(Te("dragStart",this,{evt:e}),te.eventCanceled){this._onDrop();return}Te("setupClone",this),te.eventCanceled||(pe=Eh(q),pe.removeAttribute("id"),pe.draggable=!1,pe.style["will-change"]="",this._hideClone(),De(pe,this.options.chosenClass,!1),te.clone=pe),n.cloneId=Cn(function(){Te("clone",n),!te.eventCanceled&&(n.options.removeCloneOnHide||fe.insertBefore(pe,q),n._hideClone(),Me({sortable:n,name:"clone"}))}),!t&&De(q,d.dragClass,!0),t?(Ln=!0,n._loopId=setInterval(n._emulateDragOver,50)):(oe(document,"mouseup",n._onDrop),oe(document,"touchend",n._onDrop),oe(document,"touchcancel",n._onDrop),f&&(f.effectAllowed="move",d.setData&&d.setData.call(n,f,q)),se(document,"drop",n),ne(q,"transform","translateZ(0)")),At=!0,n._dragStartId=Cn(n._dragStarted.bind(n,t,e)),se(document,"selectstart",n),jt=!0,qt&&ne(document.body,"user-select","none")},_onDragOver:function(e){var t=this.el,n=e.target,f,d,g,m=this.options,c=m.group,p=te.active,r=ln===c,o=m.sort,s=Se||p,a,i=this,u=!1;if(As)return;function h(O,I){Te(O,i,Ge({evt:e,isOwner:r,axis:a?"vertical":"horizontal",revert:g,dragRect:f,targetRect:d,canSort:o,fromSortable:s,target:n,completed:w,onMove:function(P,B){return hn(fe,t,q,f,P,be(P),e,B)},changed:x},I))}function y(){h("dragOverAnimationCapture"),i.captureAnimationState(),i!==s&&s.captureAnimationState()}function w(O){return h("dragOverCompleted",{insertion:O}),O&&(r?p._hideClone():p._showClone(i),i!==s&&(De(q,Se?Se.options.ghostClass:p.options.ghostClass,!1),De(q,m.ghostClass,!0)),Se!==i&&i!==te.active?Se=i:i===te.active&&Se&&(Se=null),s===i&&(i._ignoreWhileAnimating=n),i.animateAll(function(){h("dragOverAnimationComplete"),i._ignoreWhileAnimating=null}),i!==s&&(s.animateAll(),s._ignoreWhileAnimating=null)),(n===q&&!q.animated||n===t&&!n.animated)&&(St=null),!m.dragoverBubble&&!e.rootEl&&n!==document&&(q.parentNode[Re]._isOutsideThisEl(e.target),!O&&ft(e)),!m.dragoverBubble&&e.stopPropagation&&e.stopPropagation(),u=!0}function x(){Oe=Fe(q),it=Fe(q,m.draggable),Me({sortable:i,name:"change",toEl:t,newIndex:Oe,newDraggableIndex:it,originalEvent:e})}if(e.preventDefault!==void 0&&e.cancelable&&e.preventDefault(),n=Be(n,m.draggable,t,!0),h("dragOver"),te.eventCanceled)return u;if(q.contains(e.target)||n.animated&&n.animatingX&&n.animatingY||i._ignoreWhileAnimating===n)return w(!1);if(Ln=!1,p&&!m.disabled&&(r?o||(g=ve!==fe):Se===this||(this.lastPutMode=ln.checkPull(this,p,q,e))&&c.checkPut(this,p,q,e))){if(a=this._getDirection(e,n)==="vertical",f=be(q),h("dragOverValid"),te.eventCanceled)return u;if(g)return ve=fe,y(),this._hideClone(),h("revert"),te.eventCanceled||(pt?fe.insertBefore(q,pt):fe.appendChild(q)),w(!0);var $=Xs(t,m.draggable);if(!$||vg(e,a,this)&&!$.animated){if($===q)return w(!1);if($&&t===e.target&&(n=$),n&&(d=be(n)),hn(fe,t,q,f,n,d,e,!!n)!==!1)return y(),$&&$.nextSibling?t.insertBefore(q,$.nextSibling):t.appendChild(q),ve=t,x(),w(!0)}else if($&&mg(e,a,this)){var A=Tt(t,0,m,!0);if(A===q)return w(!1);if(n=A,d=be(n),hn(fe,t,q,f,n,d,e,!1)!==!1)return y(),t.insertBefore(q,A),ve=t,x(),w(!0)}else if(n.parentNode===t){d=be(n);var S=0,E,R=q.parentNode!==t,L=!hg(q.animated&&q.toRect||f,n.animated&&n.toRect||d,a),_=a?"top":"left",D=Yc(n,"top","top")||Yc(q,"top","top"),b=D?D.scrollTop:void 0;St!==n&&(E=d[_],Xt=!1,cn=!L&&m.invertSwap||R),S=yg(e,n,d,a,L?1:m.swapThreshold,m.invertedSwapThreshold==null?m.swapThreshold:m.invertedSwapThreshold,cn,St===n);var v;if(S!==0){var C=Fe(q);do C-=S,v=ve.children[C];while(v&&(ne(v,"display")==="none"||v===ie))}if(S===0||v===n)return w(!1);St=n,Zt=S;var M=n.nextElementSibling,T=!1;T=S===1;var k=hn(fe,t,q,f,n,d,e,T);if(k!==!1)return(k===1||k===-1)&&(T=k===1),As=!0,setTimeout(gg,30),y(),T&&!M?t.appendChild(q):n.parentNode.insertBefore(q,T?M:n),D&&xh(D,0,b-D.scrollTop),ve=q.parentNode,E!==void 0&&!cn&&(bn=Math.abs(E-be(n)[_])),x(),w(!0)}if(t.contains(q))return w(!1)}return!1},_ignoreWhileAnimating:null,_offMoveEvents:function(){oe(document,"mousemove",this._onTouchMove),oe(document,"touchmove",this._onTouchMove),oe(document,"pointermove",this._onTouchMove),oe(document,"dragover",ft),oe(document,"mousemove",ft),oe(document,"touchmove",ft)},_offUpEvents:function(){var e=this.el.ownerDocument;oe(e,"mouseup",this._onDrop),oe(e,"touchend",this._onDrop),oe(e,"pointerup",this._onDrop),oe(e,"touchcancel",this._onDrop),oe(document,"selectstart",this)},_onDrop:function(e){var t=this.el,n=this.options;if(Oe=Fe(q),it=Fe(q,n.draggable),Te("drop",this,{evt:e}),ve=q&&q.parentNode,Oe=Fe(q),it=Fe(q,n.draggable),te.eventCanceled){this._nulling();return}At=!1,cn=!1,Xt=!1,clearInterval(this._loopId),clearTimeout(this._dragStartTimer),$s(this.cloneId),$s(this._dragStartId),this.nativeDraggable&&(oe(document,"drop",this),oe(t,"dragstart",this._onDragStart)),this._offMoveEvents(),this._offUpEvents(),qt&&ne(document.body,"user-select",""),ne(q,"transform",""),e&&(jt&&(e.cancelable&&e.preventDefault(),!n.dropBubble&&e.stopPropagation()),ie&&ie.parentNode&&ie.parentNode.removeChild(ie),(fe===ve||Se&&Se.lastPutMode!=="clone")&&pe&&pe.parentNode&&pe.parentNode.removeChild(pe),q&&(this.nativeDraggable&&oe(q,"dragend",this),Io(q),q.style["will-change"]="",jt&&!At&&De(q,Se?Se.options.ghostClass:this.options.ghostClass,!1),De(q,this.options.chosenClass,!1),Me({sortable:this,name:"unchoose",toEl:ve,newIndex:null,newDraggableIndex:null,originalEvent:e}),fe!==ve?(Oe>=0&&(Me({rootEl:ve,name:"add",toEl:ve,fromEl:fe,originalEvent:e}),Me({sortable:this,name:"remove",toEl:ve,originalEvent:e}),Me({rootEl:ve,name:"sort",toEl:ve,fromEl:fe,originalEvent:e}),Me({sortable:this,name:"sort",toEl:ve,originalEvent:e})),Se&&Se.save()):Oe!==xt&&Oe>=0&&(Me({sortable:this,name:"update",toEl:ve,originalEvent:e}),Me({sortable:this,name:"sort",toEl:ve,originalEvent:e})),te.active&&((Oe==null||Oe===-1)&&(Oe=xt,it=Yt),Me({sortable:this,name:"end",toEl:ve,originalEvent:e}),this.save()))),this._nulling()},_nulling:function(){Te("nulling",this),fe=q=ve=ie=pt=pe=wn=rt=dt=We=jt=Oe=it=xt=Yt=St=Zt=Se=ln=te.dragged=te.ghost=te.clone=te.active=null,kn.forEach(function(e){e.checked=!0}),kn.length=ko=Do=0},handleEvent:function(e){switch(e.type){case"drop":case"dragend":this._onDrop(e);break;case"dragenter":case"dragover":q&&(this._onDragOver(e),pg(e));break;case"selectstart":e.preventDefault();break}},toArray:function(){for(var e=[],t,n=this.el.children,f=0,d=n.length,g=this.options;f<d;f++)t=n[f],Be(t,g.draggable,this.el,!1)&&e.push(t.getAttribute(g.dataIdAttr)||bg(t));return e},sort:function(e,t){var n={},f=this.el;this.toArray().forEach(function(d,g){var m=f.children[g];Be(m,this.options.draggable,f,!1)&&(n[d]=m)},this),t&&this.captureAnimationState(),e.forEach(function(d){n[d]&&(f.removeChild(n[d]),f.appendChild(n[d]))}),t&&this.animateAll()},save:function(){var e=this.options.store;e&&e.set&&e.set(this)},closest:function(e,t){return Be(e,t||this.options.draggable,this.el,!1)},option:function(e,t){var n=this.options;if(t===void 0)return n[e];var f=on.modifyOption(this,e,t);typeof f<"u"?n[e]=f:n[e]=t,e==="group"&&Rh(n)},destroy:function(){Te("destroy",this);var e=this.el;e[Re]=null,oe(e,"mousedown",this._onTapStart),oe(e,"touchstart",this._onTapStart),oe(e,"pointerdown",this._onTapStart),this.nativeDraggable&&(oe(e,"dragover",this),oe(e,"dragenter",this)),Array.prototype.forEach.call(e.querySelectorAll("[draggable]"),function(t){t.removeAttribute("draggable")}),this._onDrop(),this._disableDelayedDragEvents(),Rn.splice(Rn.indexOf(this.el),1),this.el=e=null},_hideClone:function(){if(!rt){if(Te("hideClone",this),te.eventCanceled)return;ne(pe,"display","none"),this.options.removeCloneOnHide&&pe.parentNode&&pe.parentNode.removeChild(pe),rt=!0}},_showClone:function(e){if(e.lastPutMode!=="clone"){this._hideClone();return}if(rt){if(Te("showClone",this),te.eventCanceled)return;q.parentNode==fe&&!this.options.group.revertClone?fe.insertBefore(pe,q):pt?fe.insertBefore(pe,pt):fe.appendChild(pe),this.options.group.revertClone&&this.animate(q,pe),ne(pe,"display",""),rt=!1}}};function pg(l){l.dataTransfer&&(l.dataTransfer.dropEffect="move"),l.cancelable&&l.preventDefault()}function hn(l,e,t,n,f,d,g,m){var c,p=l[Re],r=p.options.onMove,o;return window.CustomEvent&&!nt&&!rn?c=new CustomEvent("move",{bubbles:!0,cancelable:!0}):(c=document.createEvent("Event"),c.initEvent("move",!0,!0)),c.to=e,c.from=l,c.dragged=t,c.draggedRect=n,c.related=f||e,c.relatedRect=d||be(e),c.willInsertAfter=m,c.originalEvent=g,l.dispatchEvent(c),r&&(o=r.call(p,c,g)),o}function Io(l){l.draggable=!1}function gg(){As=!1}function mg(l,e,t){var n=be(Tt(t.el,0,t.options,!0)),f=_h(t.el,t.options,ie),d=10;return e?l.clientX<f.left-d||l.clientY<n.top&&l.clientX<n.right:l.clientY<f.top-d||l.clientY<n.bottom&&l.clientX<n.left}function vg(l,e,t){var n=be(Xs(t.el,t.options.draggable)),f=_h(t.el,t.options,ie),d=10;return e?l.clientX>f.right+d||l.clientY>n.bottom&&l.clientX>n.left:l.clientY>f.bottom+d||l.clientX>n.right&&l.clientY>n.top}function yg(l,e,t,n,f,d,g,m){var c=n?l.clientY:l.clientX,p=n?t.height:t.width,r=n?t.top:t.left,o=n?t.bottom:t.right,s=!1;if(!g){if(m&&bn<p*f){if(!Xt&&(Zt===1?c>r+p*d/2:c<o-p*d/2)&&(Xt=!0),Xt)s=!0;else if(Zt===1?c<r+bn:c>o-bn)return-Zt}else if(c>r+p*(1-f)/2&&c<o-p*(1-f)/2)return wg(e)}return s=s||g,s&&(c<r+p*d/2||c>o-p*d/2)?c>r+p/2?1:-1:0}function wg(l){return Fe(q)<Fe(l)?1:-1}function bg(l){for(var e=l.tagName+l.className+l.src+l.href+l.textContent,t=e.length,n=0;t--;)n+=e.charCodeAt(t);return n.toString(36)}function Cg(l){kn.length=0;for(var e=l.getElementsByTagName("input"),t=e.length;t--;){var n=e[t];n.checked&&kn.push(n)}}function Cn(l){return setTimeout(l,0)}function $s(l){return clearTimeout(l)}Kn&&se(document,"touchmove",function(l){(te.active||At)&&l.cancelable&&l.preventDefault()});te.utils={on:se,off:oe,css:ne,find:$h,is:function(e,t){return!!Be(e,t,e,!1)},extend:ig,throttle:Mh,closest:Be,toggleClass:De,clone:Eh,index:Fe,nextTick:Cn,cancelNextTick:$s,detectDirection:Lh,getChild:Tt,expando:Re};te.get=function(l){return l[Re]};te.mount=function(){for(var l=arguments.length,e=new Array(l),t=0;t<l;t++)e[t]=arguments[t];e[0].constructor===Array&&(e=e[0]),e.forEach(function(n){if(!n.prototype||!n.prototype.constructor)throw"Sortable: Mounted plugin must be a constructor function, not ".concat({}.toString.call(n));n.utils&&(te.utils=Ge(Ge({},te.utils),n.utils)),on.mount(n)})};te.create=function(l,e){return new te(l,e)};te.version=tg;var we=[],Vt,Ms,xs=!1,No,Fo,Dn,Ut;function Sg(){function l(){this.defaults={scroll:!0,forceAutoScrollFallback:!1,scrollSensitivity:30,scrollSpeed:10,bubbleScroll:!0};for(var e in this)e.charAt(0)==="_"&&typeof this[e]=="function"&&(this[e]=this[e].bind(this))}return l.prototype={dragStarted:function(t){var n=t.originalEvent;this.sortable.nativeDraggable?se(document,"dragover",this._handleAutoScroll):this.options.supportPointer?se(document,"pointermove",this._handleFallbackAutoScroll):n.touches?se(document,"touchmove",this._handleFallbackAutoScroll):se(document,"mousemove",this._handleFallbackAutoScroll)},dragOverCompleted:function(t){var n=t.originalEvent;!this.options.dragOverBubble&&!n.rootEl&&this._handleAutoScroll(n)},drop:function(){this.sortable.nativeDraggable?oe(document,"dragover",this._handleAutoScroll):(oe(document,"pointermove",this._handleFallbackAutoScroll),oe(document,"touchmove",this._handleFallbackAutoScroll),oe(document,"mousemove",this._handleFallbackAutoScroll)),eu(),Sn(),rg()},nulling:function(){Dn=Ms=Vt=xs=Ut=No=Fo=null,we.length=0},_handleFallbackAutoScroll:function(t){this._handleAutoScroll(t,!0)},_handleAutoScroll:function(t,n){var f=this,d=(t.touches?t.touches[0]:t).clientX,g=(t.touches?t.touches[0]:t).clientY,m=document.elementFromPoint(d,g);if(Dn=t,n||this.options.forceAutoScrollFallback||rn||nt||qt){Po(t,this.options,m,n);var c=ot(m,!0);xs&&(!Ut||d!==No||g!==Fo)&&(Ut&&eu(),Ut=setInterval(function(){var p=ot(document.elementFromPoint(d,g),!0);p!==c&&(c=p,Sn()),Po(t,f.options,p,n)},10),No=d,Fo=g)}else{if(!this.options.bubbleScroll||ot(m,!0)===Ue()){Sn();return}Po(t,this.options,ot(m,!1),!1)}}},et(l,{pluginName:"scroll",initializeByDefault:!0})}function Sn(){we.forEach(function(l){clearInterval(l.pid)}),we=[]}function eu(){clearInterval(Ut)}var Po=Mh(function(l,e,t,n){if(e.scroll){var f=(l.touches?l.touches[0]:l).clientX,d=(l.touches?l.touches[0]:l).clientY,g=e.scrollSensitivity,m=e.scrollSpeed,c=Ue(),p=!1,r;Ms!==t&&(Ms=t,Sn(),Vt=e.scroll,r=e.scrollFn,Vt===!0&&(Vt=ot(t,!0)));var o=0,s=Vt;do{var a=s,i=be(a),u=i.top,h=i.bottom,y=i.left,w=i.right,x=i.width,$=i.height,A=void 0,S=void 0,E=a.scrollWidth,R=a.scrollHeight,L=ne(a),_=a.scrollLeft,D=a.scrollTop;a===c?(A=x<E&&(L.overflowX==="auto"||L.overflowX==="scroll"||L.overflowX==="visible"),S=$<R&&(L.overflowY==="auto"||L.overflowY==="scroll"||L.overflowY==="visible")):(A=x<E&&(L.overflowX==="auto"||L.overflowX==="scroll"),S=$<R&&(L.overflowY==="auto"||L.overflowY==="scroll"));var b=A&&(Math.abs(w-f)<=g&&_+x<E)-(Math.abs(y-f)<=g&&!!_),v=S&&(Math.abs(h-d)<=g&&D+$<R)-(Math.abs(u-d)<=g&&!!D);if(!we[o])for(var C=0;C<=o;C++)we[C]||(we[C]={});(we[o].vx!=b||we[o].vy!=v||we[o].el!==a)&&(we[o].el=a,we[o].vx=b,we[o].vy=v,clearInterval(we[o].pid),(b!=0||v!=0)&&(p=!0,we[o].pid=setInterval((function(){n&&this.layer===0&&te.active._onTouchMove(Dn);var M=we[this.layer].vy?we[this.layer].vy*m:0,T=we[this.layer].vx?we[this.layer].vx*m:0;typeof r=="function"&&r.call(te.dragged.parentNode[Re],T,M,l,Dn,we[this.layer].el)!=="continue"||xh(we[this.layer].el,T,M)}).bind({layer:o}),24))),o++}while(e.bubbleScroll&&s!==c&&(s=ot(s,!1)));xs=p}},30),Oh=function(e){var t=e.originalEvent,n=e.putSortable,f=e.dragEl,d=e.activeSortable,g=e.dispatchSortableEvent,m=e.hideGhostForTarget,c=e.unhideGhostForTarget;if(t){var p=n||d;m();var r=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:t,o=document.elementFromPoint(r.clientX,r.clientY);c(),p&&!p.el.contains(o)&&(g("spill"),this.onSpill({dragEl:f,putSortable:n}))}};function Qs(){}Qs.prototype={startIndex:null,dragStart:function(e){var t=e.oldDraggableIndex;this.startIndex=t},onSpill:function(e){var t=e.dragEl,n=e.putSortable;this.sortable.captureAnimationState(),n&&n.captureAnimationState();var f=Tt(this.sortable.el,this.startIndex,this.options);f?this.sortable.el.insertBefore(t,f):this.sortable.el.appendChild(t),this.sortable.animateAll(),n&&n.animateAll()},drop:Oh};et(Qs,{pluginName:"revertOnSpill"});function Js(){}Js.prototype={onSpill:function(e){var t=e.dragEl,n=e.putSortable,f=n||this.sortable;f.captureAnimationState(),t.parentNode&&t.parentNode.removeChild(t),f.animateAll()},drop:Oh};et(Js,{pluginName:"removeOnSpill"});te.mount(new Sg);te.mount(Js,Qs);const $e={getStyle:(l,e=!1)=>{let t;return window.getComputedStyle?t=window.getComputedStyle(l,null):l.currentStyle&&(t=l.currentStyle),e?t[e]:t},fadeOut:(l,e=250)=>{const t=1/(e/60);l.style.opacity=1,(function n(){const f=Number(l.style.opacity)-t;f>0?(l.style.opacity=f,window.requestAnimationFrame(n)):l.remove()})()},slideDown:(l,e=250,t=!1)=>{l.style.display="block";const n=$e.getStyle(l),f=Number.parseInt(n.height,10),d=f/(e/60);l.style.height="0px",(function g(){const m=Number.parseFloat(l.style.height),c=m+d;m<f?(l.style.height=`${c}px`,window.requestAnimationFrame(g)):(l.style.height="auto",t&&t(l))})()},slideUp:(l,e=250,t=!1)=>{const n=$e.getStyle(l),f=Number.parseInt(n.height,10),d=n.overflow;l.style.overflow="hidden",l.style.height=`${f}px`;const g=n.minHeight;l.style.minHeight="auto";const m=parseFloat(f/(e/60)).toFixed(2);(function c(){const r=Number.parseInt(l.style.height,10)-m;r>0?(l.style.height=`${r}px`,window.requestAnimationFrame(c)):(l.style.overflow=d,l.style.display="none",l.style.minHeight=g,delete l.style.height,t&&t(l))})()},slideToggle:(l,e=250,t=$e.getStyle(l,"display")==="none")=>{t?$e.slideDown(l,e):$e.slideUp(l,e)}},Ih=l=>Number.isInteger(Number(l)),lt=l=>{let e=0,t=l;for(;t?.previousElementSibling;)t=t.previousElementSibling,e++;return e},On=(l,e,t)=>{const n=t.split("||"),d=gt(e).map(g=>l.find(m=>{const c=n.find(p=>!!Ie(m,p));return c&&Ie(m,c)===g})).filter(Boolean).concat(l);return gt(d)},Yn=(l,e,t)=>{for(let n=0;n<l.length;n++)e.call(t,l[n],n)},ea=(l,e)=>{const t=[];return Yn(l,(n,f)=>t.push(e(n,f))),t},Ho={},Nh=l=>{const e={className:"class"};if(Ho[l])return Ho[l];const n=(e[l]||l).replace(/^\d+/,"").replace(/[^a-zA-Z0-9-:]/g,"");return Ho[l]=n,n},Fh=l=>l.replace(/\b\w/g,e=>e.toUpperCase()),Ag=l=>window.JSON.parse(window.JSON.stringify(l)),$g=(l,e)=>e.filter(t=>!~l.indexOf(t)),Ne={capitalize:Fh,safeAttrName:Nh,forEach:Yn,copyObj:Ag,map:ea,subtract:$g,indexOfNode:lt,isInt:Ih,get:Ie,orderObjectsBy:On},Ve={js:new Set,css:new Set,formeoSprite:null},tu=(l,e,t=ws)=>new Promise(n=>fetch(l).then(f=>{if(!f.ok)return n(t(f));n(e?e(f):f)}).catch(f=>t(f))),Ph=(l,e)=>{l.removeEventListener("load",Ph),e(l.src)},Hh=(l,e)=>{l.removeEventListener("load",Hh),e(l.src)},Mg=l=>new Promise((e,t)=>{if(Ve.js.has(l))return e(l);Ve.js.add(l);const n=V.create({tag:"script",attrs:{type:"text/javascript",async:!0,src:l},action:{load:()=>Hh(n,e),error:()=>t(new Error(`${l} failed to load.`))}});document.head.appendChild(n)}),Es=l=>{l=Array.isArray(l)?l:[l];const e=l.map(t=>new Promise((n,f)=>{if(Ve.css.has(t))return n(t);Ve.css.add(t);const d=V.create({tag:"link",attrs:{rel:"stylesheet",href:t},action:{load:()=>Ph(d,n),error:()=>f(new Error(`${(void 0).src} failed to load.`))}});document.head.appendChild(d)}));return Promise.all(e)},xg=l=>{l=Array.isArray(l)?l:[l];const e=l.map(t=>Mg(t));return Promise.all(e)},Eg=l=>{l=Array.isArray(l)?l:[l];const e=l.map(t=>Es(t));return Promise.all(e)},nu=l=>{const t=new DOMParser().parseFromString(l,"image/svg+xml");return Ve.formeoSprite=t.documentElement,Ve.formeoSprite},_g=async(l=kf)=>{if(Ve.formeoSprite)return Ve.formeoSprite;if(!l)return nu(Lf);const e=async t=>nu(await t.text());return tu(l,e,()=>tu(Df,e))},Tg={js:xg,css:Eg},Wh=l=>{const e=Object.entries(l).map(([t,n])=>Tg[t](n));return Promise.all(e)},Lg=async l=>{if(!Ve.css.has(l)&&(await Es(l),!Ve.css.has(Jl)))return await Es(Jl)},Rg={glyphicons:l=>`<span class="glyphicon glyphicon-${l}" aria-hidden="true"></span>`,"font-awesome":l=>{const[e,t]=l.split(" ");return`<i class="${e} fa-${t}"></i>`},fontello:l=>`<i class="${gh}${l}">${l}</i>`},kg=new Set(["input","textarea","select"]),Dg=l=>l.replace(/^on([A-Z])/,(e,t)=>t.toLowerCase()),Og=new Set(["focus","blur"]),Ig=l=>{const e=Dg(l);return(t,n)=>t.addEventListener(e,n,Og.has(e))},zh=(l={})=>{let e=l?.attrs?.name||l?.name;if(e)return e;const t=He(l);let n=l.config?.label||l.attrs?.label||l?.label;return n&&(typeof n=="object"&&(n=V.create(n).textContent),/^<.+>.+<.+>$/gim.test(n)&&(n=ap(n)),e=`${t}-${mh(lp(n,24,null))}`),e||t};class Ng{constructor(e=Object.create(null)){this.options=e}set setOptions(e){this.options=je(this.options,e)}processElemArg(e){let t=e,n;if(typeof t=="string")return n=t,t={tag:n},t;if(t.attrs){const{tag:f,...d}=t.attrs;f&&(typeof f=="string"?n=f:n=(f.find(m=>m.selected===!0)||f[0]).value),t.attrs=d}return t.tag=n||t.tag||"div",t}render=e=>(e.id=`f-${e.id||He()}`,this.create(e));create=(e,t=!1)=>{if(!e)return;if(this.isDOMElement(e))return e;const n=this,f=["children","content"],{className:d,options:g,dataset:m,...c}=this.processElemArg(e);f.push("tag");let p;const{tag:r}=c;let o;const s={attrs:{},className:[Ne.get(c,"config.inputWrap")],children:[],config:{}};let a=document.createElement(r);const i={string:h=>{a.innerHTML+=h},object:h=>h&&a.appendChild(n.create(h,t)),node:h=>a.appendChild(h),component:h=>a.appendChild(h.dom),array:h=>{for(const y of h)p=n.childType(y),i[p](y)},function:h=>{h=h(),p=n.childType(h),i[p](h)},undefined:()=>null,boolean:()=>null};if(d&&(c.attrs=je(c.attrs,{className:d})),g){const h=this.processOptions(g,c,t);if(this.holdsContent(a)&&r!=="button")i.array.call(this,h),c.content=void 0;else return Ne.forEach(h,y=>{s.children.push(n.create(y,t))}),c.attrs.className&&(s.className=c.attrs.className),s.id=c.id,s.config={...c.config},this.create(s,t);f.push("options")}if(c.attrs&&(n.processAttrs(c,a,t),f.push("attrs")),c.config){if(c.config.label&&(c.config.label&&r!=="button"||["radio","checkbox"].includes(Ne.get(c,"attrs.type")))&&!t){const h=n.label(c);if(!c.config.hideLabel){const y=[h,a];n.labelAfter(c)&&y.reverse(),s.children.push(y)}}f.push("config")}if(c.content||c.children){const h=c.content||c.children;p=n.childType(h),i[p]||console.error(`childType: ${p} is not supported`),i[p].call(this,h)}if(m){for(const h in m)Object.hasOwn(m,h)&&(a.dataset[h]=typeof m[h]=="function"?m[h]():m[h]);f.push("dataset")}c.action&&(this.actionHandler(a,c.action),f.push("action"));const u=Ne.subtract(f,Object.keys(c));for(o=u.length-1;o>=0;o--)a[u[o]]=c[u[o]];return s.children.length&&(a=this.create(s)),a};onRender=(e,t,n=Ye)=>{const f=Date.now(),d=()=>{!e.parentElement&&Date.now()-f<n?window.requestAnimationFrame(d):e.parentElement&&t(e)};d()};actionHandler(e,t){const n={onRender:V.onRender,render:V.onRender};return Object.entries(t).map(([f,d])=>(Array.isArray(d)?d:[d]).map(m=>(n[f]||Ig(f))(e,m)))}get icons(){if(this.iconSymbols)return this.iconSymbols;const e=Ve.formeoSprite.querySelectorAll("svg symbol"),t=n=>{const f=n.getAttribute("viewBox")||"0 0 24 24",d=Array.from(n.children).map(g=>g.cloneNode(!0).outerHTML).join("");return{tag:"svg",attrs:{className:["svg-icon",n.id],viewBox:f,xmlns:"http://www.w3.org/2000/svg"},children:d}};return this.iconSymbols=Array.from(e).reduce((n,f)=>{const d=f.id.replace(gh,"");return n[d]=t(f),n},{}),this.cachedIcons={},this.iconSymbols}icon(e,t){if(!e)return;const n=`${e}?${new URLSearchParams(t).toString()}`;if(this.cachedIcons?.[n])return this.cachedIcons[n];const f=this.icons[e];if(f){if(t){const d=je(f,t);return this.cachedIcons[n]=V.create(d).outerHTML,this.cachedIcons[n]}return this.cachedIcons[n]=V.create(f).outerHTML,this.cachedIcons[n]}return Rg[V.options.iconFont]?.(e)||e}processAttrs(e,t,n){const{attrs:f={}}=e;if(!n&&!f.name&&f.name!==null&&this.isInput(e.tag)){const d=zh(e);d&&t.setAttribute("name",d)}for(const d of Object.keys(f)){const g=Ne.safeAttrName(d),m=this.processAttrValue(f[d]);m!==!1&&t.setAttribute(g,m)}}processAttrValue(e){if(typeof e=="function")return e();if(typeof e=="boolean")return e&&"";let t=e||"";if(Array.isArray(t))if(typeof t[0]=="object"){const n=t.filter(f=>f.selected===!0);t=n.length?n[0].value:t[0].value}else t=t.join(" ");return t}toggleElementsByStr=(e,t)=>{const n=[],f=(d,g)=>{g?(d.style.display="block",n.push(d)):d.style.display="none"};return V.elementsContainText(e,t,f),n};elementsContainText=(e,t,n)=>{const f=[];return Yn(e,d=>{const m=d.textContent.toLowerCase().indexOf(t.toLowerCase())!==-1;n?.(d,m),m&&f.push(d)}),f};generateOption=({type:e="option",label:t,value:n,i:f=0,selected:d})=>({tag:e==="option"?"option":"input",attrs:{type:e,value:n||`${e}-${f}`,[e==="option"?"selected":"checked"]:d||!f},config:{label:t||X.get("labelCount",{label:X.get("option"),count:f})}});processOptions(e,t,n){const{action:f,attrs:d={}}=t,g=d.type||t.tag,m=d.id||t.id,c=(r,o)=>{const{label:s,value:a,...i}=r,u=()=>{const y={tag:"input",attrs:{name:m,type:g,value:a||"",id:`${m}-${o}`,...i},action:f},w={tag:"label",attrs:{for:`${m}-${o}`},children:s},x={children:[y,w],className:[`f-${g}`]};return d.className&&(t.config.inputWrap=d.className),t.config.inline&&x.className.push(`f-${g}-inline`),r.selected&&(y.attrs.checked=!0),n&&(w.attrs.contenteditable=!0),x};return{select:()=>{const y=r.attrs||r,w={attrs:y,...r,...y},{label:x,checked:$,selected:A,attrs:S}=w;return{tag:"option",attrs:{...S,selected:!!($||A)},children:x}},button:y=>{const{type:w,label:x,className:$,id:A}=y;return{...t,attrs:{type:w},className:$,id:A||He(),options:void 0,children:x,action:t.action}},checkbox:u,radio:u}[g]?.(r)};return e.map(c)}holdsContent(e){return e.outerHTML.indexOf("/")!==-1}isBlockInput(e){return!this.isInput(e)&&this.holdsContent(e)}isInput(e){let t=e;return typeof t!="string"&&(t=t.tagName),kg.has(t)}parsedHtml(e){const t=document.createElement("textarea");return t.innerHTML=e,t.textContent}labelAfter(e){const t=Ne.get(e,"attrs.type"),n=Ne.get(e,"config.labelAfter");return n!==void 0?n:t==="checkbox"||t==="radio"}requiredMark=()=>({tag:"span",className:"text-error",children:"*"});label(e,t){const n=Ne.get(e,"attrs.required");let{config:{label:f=""}}=e;const{id:d,attrs:g}=e;typeof f=="function"&&(f=f());const m={tag:"label",attrs:{for:d||g?.id},className:[],children:[f,n&&this.requiredMark()],action:{}};return t&&(m.attrs.for=void 0,m.attrs.contenteditable=!0,m.fMap=t),m}childType(e){return e===void 0?e:[["array",t=>Array.isArray(t)],["node",t=>t instanceof window.Node||t instanceof window.HTMLElement],["component",()=>e?.dom],[typeof e,()=>!0]].find(t=>t[1](e))[0]}getStyle(e,t=!1){let n;return window.getComputedStyle?n=window.getComputedStyle(e,null):e.currentStyle&&(n=e.currentStyle),t?n[t]:n}getElement(e){const t={node:()=>e,object:()=>document.getElementById(e.id),string:()=>document.getElementById(e)},n=this.childType(e);return t[n]()}empty(e){for(;e.firstChild;)this.remove(e.firstChild);return e}removeEmpty=e=>{const t=e.parentElement,n=Le(e),f=t.getElementsByClassName(`formeo-${n}`);if(this.remove(e),!f.length)return this.isStage(t)?this.emptyClass(t):this.removeEmpty(t)};remove(e){const t=Le(e);return t?ce.remove(`${t}s.${e.id}`):e.parentElement.removeChild(e)}removeClasses(e,t){const n={string:f=>f.classList.remove(t),array:f=>{for(const d of t)f.classList.remove(d)}};n.object=n.string,Ne.forEach(e,n[this.childType(t)])}addClasses(e,t){const n={string:f=>f.classList.add(t),array:f=>{for(const d of t)f.classList.add(d)}};Ne.forEach(e,n[this.childType(t)])}formGroup(e,t=""){return{className:["f-field-group",t],children:e}}coords(e){const t=e.getBoundingClientRect(),n=document.body.getBoundingClientRect();return{pageX:t.left+t.width/2,pageY:t.top-n.top-t.height/2}}clearStage(e){e.classList.add("removing-all-fields");const t=()=>{V.empty(e),e.classList.remove("removing-all-fields"),V.emptyClass(e),$e.slideDown(e,300)};$e.slideUp(e,600,t)}toggleSortable(e,t){let n=t;const f=Le(e);if(!f)return;const d=Le(e.parentElement),g=V[f].get(e.id).sortable;n||(n=!g.option("disabled")),g.option("disabled",n),d&&["rows","columns","stages"].includes(d)&&this.toggleSortable(e.parentElement,n)}emptyClass(e){const t=e.getElementsByClassName(If.get(e.classList.item(0)));e.classList.toggle("empty",!t.length)}btnTemplate=({title:e="",...t})=>({tag:"button",attrs:{type:"button",title:e},...t});isControls=e=>Le(e)===st;isStage=e=>Le(e)===Ot;isRow=e=>Le(e)===Qe;isColumn=e=>Le(e)===Je;isField=e=>Le(e)===It;asComponent=e=>ce[`${Le(e)}s`].get(e.id);isDOMElement(e){return e instanceof window.Element||e instanceof window.HTMLElement||!!(e&&typeof e=="object"&&e.nodeType===1&&typeof e.nodeName=="string")}}const V=new Ng,Fg="modulepreload",Pg=function(l){return"/formeo/"+l},iu={},$t=function(e,t,n){let f=Promise.resolve();if(t&&t.length>0){let c=function(p){return Promise.all(p.map(r=>Promise.resolve(r).then(o=>({status:"fulfilled",value:o}),o=>({status:"rejected",reason:o}))))};document.getElementsByTagName("link");const g=document.querySelector("meta[property=csp-nonce]"),m=g?.nonce||g?.getAttribute("nonce");f=c(t.map(p=>{if(p=Pg(p),p in iu)return;iu[p]=!0;const r=p.endsWith(".css"),o=r?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${o}`))return;const s=document.createElement("link");if(s.rel=r?"stylesheet":Fg,r||(s.as="script"),s.crossOrigin="",s.href=p,m&&s.setAttribute("nonce",m),document.head.appendChild(s),r)return new Promise((a,i)=>{s.addEventListener("load",a),s.addEventListener("error",()=>i(new Error(`Unable to preload CSS for ${p}`)))})}))}function d(g){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=g,window.dispatchEvent(m),!m.defaultPrevented)throw g}return f.then(g=>{for(const m of g||[])m.status==="rejected"&&d(m.reason);return e().catch(d)})},Et="f-autocomplete",Hg=`${Et}-display-field`,ta=`${Et}-list`,Pt="highlight-component",In=`${ta}-item`,Wg=(l,e)=>{const t=l.reduce((n,f)=>n+(f===e),0);return t>1?`(${t})`:""},Bh=["config.label","config.controlId"],zg=["config.legend","name"],Bg=[...Bh,...zg],Wo=l=>Bh.reduce((e,t)=>e||l.get(t),null),ru=l=>Bg.reduce((e,t)=>e||l.get(t),null)||at(l.name),jg=new Map([["condition.source",Wo],["if.condition.source",Wo],["if.condition.target",Wo],["then.condition.target",ru],["condition.target",ru]]),jh=({id:l,...e},t)=>{const{name:n,label:f}=e;return n?jg.get(t)(e):f},Vg=({selectedId:l,...e})=>(e.value===l&&(e.selected=!0),e),zo=l=>(l.classList.contains(In)||(l=l.parentElement),l),Vh=({value:l,textLabel:e,htmlLabel:t,componentType:n,depth:f=0},d)=>{const g={tag:"li",children:t,dataset:{value:l,label:e},className:[In,`${In}-depth-${f}`,`component-type-${n}`],action:{mousedown:({target:m})=>{m=zo(m),d.setValue(m),d.selectOption(m),d.hideList()},mouseover:({target:m})=>{m=zo(m),d.removeHighlight(),d.highlightComponent(m)},mouseleave:({target:m})=>{m=zo(m),d.removeHighlight()}}};return V.create(g)},Ug=(l,e)=>{const t=l.data.options.map((f,d)=>{const g=`${l.address}.options[${d}]`,m=f.label,c=f.label;return Vh({value:g,textLabel:m,htmlLabel:c,componentType:"option",depth:1},e)});return V.create({tag:"ul",attrs:{className:[ta,"options-list"]},children:t})},Gg=l=>{const e=l.value,t=[],n=ce.flatList();return Object.entries(n).reduce((d,[g,m])=>{const c=jh(m,l.key);if(c){const p=m.name,r={tag:"span",content:` ${at(p)}`,className:"component-type"},o=`${p}.${c}`;t.push(o);const s=Wg(t,o),a={tag:"span",content:s,className:"component-label-count"},i=[`${c} `,a,r],u=[c,s].join(" ").trim();if(m.isCheckable){const y=Ug(m,l);i.push(y)}const h=Vg({value:g,textLabel:u,htmlLabel:i,componentType:p,selectedId:e});d.push(Vh(h,l))}return d},[])};class qg{lastCache=Date.now();optionsCache=null;constructor({key:e,value:t,className:n,onChange:f=ws}){this.key=e,this.className=[n||this.key.replace(/\./g,"-")].flat(),this.value=t,this.onChange=f||ws,this.events=[],this.build()}createProxy(){return new Proxy(this,{get(e,t){if(t in e)return e[t];if(t in e.dom){const n=e.dom[t];return typeof n=="function"?n.bind(e.dom):n}},set(e,t,n){return t in e?e[t]=n:e.dom[t]=n,!0}})}get isAddress(){return Pe(this.value)}get valueComponent(){return Pe(this.value)&&ce.getAddress(this.value)}build(){const e=n=>{const f=this.list,d=this.getActiveOption();let m=new Map([[38,()=>{const c=this.getPreviousOption(d);c&&this.selectOption(c)}],[40,()=>{const c=this.getNextOption(d);c&&this.selectOption(c)}],[13,()=>{d&&(this.selectOption(d),this.setValue(d),f.style.display==="none"?this.showList(d):this.hideList()),n.preventDefault()}],[27,()=>{this.hideList()}]]).get(n.keyCode);return m||(m=()=>!1),m()},t={focus:({target:n})=>{this.updateOptions(),n.parentElement.classList.add(`${Et}-focused`);const f=V.toggleElementsByStr(this.list.querySelectorAll(`.${In}-depth-0`),n.value);n.addEventListener("keydown",e);const d=this.list.querySelector(".active-option")||f[0];this.showList(d)},blur:({target:n})=>{n.parentElement.classList.remove(`${Et}-focused`),n.removeEventListener("keydown",e),this.hideList()},input:n=>{const{value:f}=n.target,d=V.toggleElementsByStr(this.list.querySelectorAll("li"),f);if(f.length===0&&this.clearValue(),d.length===0)this.hideList();else{const g=this.getActiveOption()||d[0];this.showList(g)}this.setValue({dataset:{label:f,value:f}})}};return this.displayField=V.create({tag:"input",autocomplete:"off",action:t,attrs:{type:"text",className:Hg,value:this.label||this.value,placeholder:X.get(`${this.key}.placeholder`)}}),this.hiddenField=V.create({tag:"input",attrs:{type:"hidden",className:Et,value:this.value}}),this.list=V.create({tag:"ul",attrs:{className:ta}}),this.clearButton=V.create({tag:"span",content:V.icon("remove"),className:"clear-button hidden",action:{click:()=>this.clearValue()}}),this.dom=V.create({children:[this.displayField,this.clearButton,this.hiddenField],className:[Et,this.className].flat(),action:{onRender:n=>{this.stage=n.closest(".formeo-stage"),this.value&&(this.displayField.value=this.label),this.clearButton.classList.toggle("hidden",!this.value.length)}}}),this.dom}get label(){if(!Pe(this.value))return this.value;const e=this.value&&ce.getAddress(this.value);return e&&jh(e,`${this.key}`)||this.value}updateOptions(){let e=this.optionsCache;const t=Date.now();(t-this.lastCache>zs*5||!e)&&(V.empty(this.list),e=this.generateOptions(),this.lastCache=t),this.list.children.length||this.list.append(...e)}generateOptions(){return this.optionsCache=Gg(this),this.optionsCache}setListPosition(){const{offsetHeight:e,offsetWidth:t}=this.displayField,n=this.displayField.closest(".formeo-stage").getBoundingClientRect(),f=this.displayField.getBoundingClientRect(),d={position:"absolute",top:`${f.y+e-n.y}px`,left:`${f.x+window.scrollX-n.x+2}px`,width:`${t}px`};Object.assign(this.list.style,d)}showList(e,t=this.list){this.stage.contains(this.list)||this.stage.appendChild(this.list),this.setListPosition(),this.selectOption(e),$e.slideDown(t,mt)}hideList(e=this.list){$e.slideUp(e,mt),this.removeHighlight(),this.stage.contains(this.list)&&this.stage.removeChild(this.list)}getActiveOption(e=this.list){const t=e.querySelector(".active-option");return t?.style.display!=="none"?t:null}getPreviousOption(e){let t=e;do t=t?t.previousSibling:null;while(t!=null&&t.style.display==="none");return t}getNextOption(e){let t=e;do t=t?t.nextSibling:null;while(t!=null&&t.style.display==="none");return t}selectOption(e,t=this.list){const n=t.querySelectorAll("li");for(const f of n){const{dataset:{value:d}}=f;f.classList.remove("active-option"),Pe(d)&&ce.getAddress(d)?.dom?.classList.remove(Pt)}e&&(e.classList.add("active-option"),this.highlightComponent(e))}removeHighlight(){const e=document.getElementsByClassName(Pt);for(const t of e)t.classList.remove(Pt)}highlightComponent(e){const{dataset:{value:t}}=e;if(Pe(t)){const{componentAddress:n,isOptionAddress:f,optionIndex:d}=vt(t).reduce((m,c)=>c==="options"?(m.isOptionAddress=!0,m):m.isOptionAddress?(m.optionIndex=+c,m):(m.componentAddress.push(c),m),{componentAddress:[],optionIndex:null,isOptionAddress:!1}),g=ce.getAddress(n);g?.dom&&(g.dom.classList.add(Pt),f&&g.dom.querySelectorAll(".field-preview .f-checkbox, .field-preview .f-radio")[d]?.classList.add(Pt))}}clearValue(){this.selectOption(null),this.setValue({dataset:{label:"",value:""}}),this.displayField.focus()}setValue(e){const{label:t,value:n}=e.dataset;this.displayField.value=t,this.hiddenField.value=n,this.value=n,this.clearButton.classList.toggle("hidden",!n.length),this.onChange?.({target:this.hiddenField})}}function Bo({key:l,value:e,type:t="text",checked:n}){const f={tag:"input",attrs:{type:t,value:e,placeholder:X.get(`${l}.placeholder`)||at(l)},className:[l.replace(/\./g,"-")],config:{}};return n&&(f.attrs.checked=!0),f}function Uh(l){const e=X.get(l);if(e)return e;const t=l.split(".");return X.get(t[t.length-1])}const Lt={autocomplete:(...l)=>new qg(...l).createProxy(),string:({key:l,value:e})=>Bo({key:l,value:e}),boolean:({key:l,value:e})=>Bo({key:l,value:e,type:l==="selected"?"radio":"checkbox",checked:!!e}),number:({key:l,value:e})=>Bo({key:l,value:e,type:"number"}),array:({key:l,value:e})=>({tag:"select",attrs:{placeholder:Uh(`placeholder.${l}`)},className:[l.replace(/\./g,"-")],options:e}),object:l=>Object.entries(l).map(([e,t])=>Lt[V.childType(t)]({key:e,value:t}))},Kg={boolean:(l,e)=>({click:({target:t})=>{if(t.type==="radio"){const n=e.data.options.map(f=>({...f,selected:!1}));e.set("options",n)}e.set(l,t.checked),e.updatePreview()}}),string:(l,e)=>({input:({target:{value:t}})=>{e.set(l,t),e.debouncedUpdatePreview()}}),number:(l,e)=>({input:({target:{value:t}})=>{e.set(l,Number(t)),e.debouncedUpdatePreview()}}),array:(l,e)=>({change:({target:{value:t}})=>{e.set(l,t),e.debouncedUpdatePreview()}}),object:()=>({})},Gh="hidden-property",Yg="hidden-option",jo=/\.options\[\d+\]$/,Zg={"if-sourceProperty":vn(mn,nc,ic),"if-targetProperty":vn(mn),"then-targetProperty":vn(mn,nc,ic),...Object.entries(ep).reduce((l,[e,t])=>(l[`if-${e}`]=t,l[`then-${e}`]=t,l),{})},qh={assignment:Ht,comparison:Ht,logical:Ht,source:({key:l,value:e,onChange:t,conditionType:n})=>Lt.autocomplete({key:`${n}.condition.${l}`,value:e,onChange:t,className:`condition-${l}`}),sourceProperty:Ht,targetProperty:Ht,target:l=>qh.source(l),value:({key:l,value:e,onChange:t},n)=>{const f=Lt.string({key:`condition.${l}`,value:e});return f.action={input:t},f}};function Xg({key:l,value:e,conditionType:t}){const n=`${t}-${l}`,f=Zg[n];return Object.entries(f||{}).map(([d,g])=>Qg({fieldName:l,fieldValue:e,key:d,optionValue:g}))}function Qg({fieldName:l,fieldValue:e,key:t,optionValue:n}){return{label:X.get(`${l}.${t}`)||at(t).toLowerCase(),value:n,selected:n===e}}function Ht({key:l,value:e,onChange:t,conditionType:n}){const f=Xg({key:l,value:e,conditionType:n}),d=Lt.array({key:`condition.${l}`,value:f});return d.action={change:t},d}const Jg=l=>!l?.classList.contains(Gh),em={sourceProperty:l=>{const e=l.get("source"),t=l.get("sourceProperty"),n=!!e.value,f=!!e.value.match(jo);return su(f,t),!n},comparison:l=>{const e=l.get("source"),t=l.get("sourceProperty"),n=!!e.value,f=!!e.value.match(jo);return!n||f||t.value!=="value"},assignment:l=>{const e=l.get("target"),t=l.get("targetProperty");return!!!e.value||t.value.startsWith("is")},targetProperty:l=>{const e=l.get("target"),t=l.get("targetProperty"),n=!!e.value.match(jo);return su(n,t),!_f(e.value)},target:l=>{const e=l.get("source"),t=l.get("sourceProperty"),n=!!e?.value;return t&&!n?!0:t&&t?.value!=="value"},value:l=>{const e=l.get("target"),t=l.get("targetProperty");return t===void 0?!1:e&&!e.value||!Jg(l.get("comparison"))||t.value===Kh?!0:t.value.startsWith("is")}},ou=l=>{for(const[e,t]of l){const n=!!em[e]?.(l)||!1;t.classList.toggle(Gh,n)}},Kh="isChecked",Vo=l=>l.value.endsWith("Checked"),su=(l,e)=>{if(l&&Vo(e))return null;const t=Array.from(e.querySelectorAll("option")),n=[];for(const f of t){const d=Vo(f),g=l?!d:d;g&&n.push(f.value),f.classList.toggle(Yg,g)}n.includes(e.value)&&(e.value=l?Kh:t.find(f=>!Vo(f))?.value||e.value)};function tm(l,e=Jf){return e.reduce((t,n)=>(l[n]!==void 0&&t.push([n,l[n]]),t),[])}class nm{constructor({conditionValues:e,conditionType:t,conditionCount:n,index:f},d){this.values=new Map(tm(e)),this.conditionType=t,this.parent=d,this.baseAddress=`${d.address}.${t}`,this.fields=new Map,this.conditionCount=n,this.index=f,this.dom=this.generateDom()}setConditionIndex(e){this.index=e}get address(){return`${this.baseAddress}[${this.index}]`}destroy(){const e=ce.getAddress(this.baseAddress);e.splice(this.index,1),ce.setAddress(this.baseAddress,e),$e.slideUp(this.dom,mt,()=>{this.dom.remove()})}label(){return this.index?null:{tag:"label",className:`condition-label ${this.conditionType}-condition-label`,content:X.get(`condition.type.${this.conditionType}`)}}generateDom(){const e=[];for(const[f,d]of this.values){const g=r=>this.onChangeCondition({key:f,target:r.target}),m={key:f,value:d,conditionType:this.conditionType,onChange:g},c=qh[f](m,this.values),p=c.dom||V.create(c);this.fields.set(f,c.dom?c:p),e.push(p)}const n={children:[this.label(),...e,...this.generateConditionTypeActionButtons()],className:`f-condition-row ${this.conditionType}-condition-row display-none`,action:{onRender:f=>{this.processUiState()}}};return V.create(n)}generateConditionTypeActionButtons(){const e=[],t="manage-condition-type",n=g=>`${g}-condition-type`,f=V.btnTemplate({title:X.get(`remove${this.conditionType}Condition`),className:[t,n("remove")],content:V.icon("minus"),action:{click:()=>this.destroy(),mouseover:g=>{this.dom.classList.add("to-remove")},mouseout:g=>{this.dom.classList.remove("to-remove")}}});e.push(f);const d=V.btnTemplate({title:X.get(`add${this.conditionType}Condition`),className:[t,n("add")],content:V.icon("plus"),action:{click:()=>{const g=this.parent.addConditionType(this.conditionType),m={changedProperty:null,dataPath:g.address,value:g.value,src:g.dom};this.updateDataDebounced(m)}}});return e.push(d),e}get value(){return Array.from(this.fields).reduce((e,[t,n])=>(e[t]=n.value,e),{})}processUiState(){ou(this.fields),this.dom.classList.remove("display-none")}updateDataDebounced=xn(e=>{J.formeoUpdated(e),ce.setAddress(e.dataPath,e.value)});onChangeCondition=({key:e,target:t})=>{const n={changedProperty:e,dataPath:this.address,value:this.value,src:t};ou(this.fields),this.updateDataDebounced(n)}}const im=new Map([["attrs",({itemKey:l})=>l],["options",({itemKey:l,key:e})=>`${l}.${e}`]]),Yh=(l,e)=>{if(e.controlId==="select"){const t=e.editPanels.get("options"),[n,f]=l?_n:ip,d=t.data.map(({[n]:g,...m})=>({[f]:g,...m}));t.setData(d)}},rm=new Map([["attrs-multiple",l=>({change:({target:e})=>{l.field.controlId==="select"&&Yh(e.checked,l.field)}})]]);class dn{constructor({key:e,index:t,field:n,panel:f,data:d}){this.field=n,this.itemKey=e,this.itemIndex=t,this.panel=f,this.panelName=f.name,this.isDisabled=n.isDisabledProp(e,this.panelName),this.isHidden=this.isDisabled&&n.config.panels[this.panelName].hideDisabled,this.isLocked=n.isLockedProp(e,this.panelName),this.address=`${n.indexName}.${n.id}.${e}`,this.itemSlug=rc(e),this.conditionTypeWrap=new Map,d!==void 0&&this.field.get(this.itemKey)===void 0&&this.field.set(this.itemKey,d);const g=[`field-${this.itemSlug}`,"prop-wrap"];this.isHidden&&g.push("hidden-property"),this.dom=V.create({tag:"li",className:g,children:{className:"component-prop",children:[this.itemInputs(),this.itemControls]}})}get itemValues(){const e=this.field.get(this.itemKey);return e?.constructor===Object?On(Object.entries(e),_n,"0"):[[this.itemKey,e]]}findOrCreateConditionTypeWrap(e){let t=this.conditionTypeWrap.get(e);return t||(t=V.create({className:`type-conditions-wrap ${e}-conditions-wrap`}),this.conditionTypeWrap.set(e,t),t)}itemInputs(){const e=V.create({className:`${this.panelName}-prop-inputs prop-inputs f-input-group`,children:this.itemValues.map(([t,n])=>this.panelName==="conditions"?this.generateConditionFields(t,n):this.itemInput(t,n))});return this.inputs&&this.inputs.replaceWith(e),this.inputs=e,e}addConditionType=(e,t)=>{const n=this.findOrCreateConditionTypeWrap(e);let f=t;if(!f){const[g]=Ks()[e],m=n.children.length;e===ph&&(g.logical="||"),f={conditionValues:g,conditionCount:m,index:m}}const d=new nm({conditionType:e,...f},this);return n.appendChild(d.dom),d};removeConditionType=(e,t)=>{const n=this.conditionTypeWrap.get(e),f=n.children[t];f.destroy(),n.removeChild(f.dom)};generateConditionFields=(e,t)=>(this.conditions=new Map,t.forEach((n,f)=>{const d=this.addConditionType(e,{index:f,conditionCount:t.length,conditionValues:n});this.conditions.set(f,d)}),this.findOrCreateConditionTypeWrap(e));get itemControls(){if(this.isLocked)return{className:`${this.panelName}-prop-controls prop-controls`,content:[]};const e={tag:"button",attrs:{type:"button",className:"prop-remove prop-control"},action:{click:()=>{$e.slideUp(this.dom,Ye,n=>{this.field.remove(this.itemKey),n.remove(),this.panel.updateProps()})},mouseover:n=>{this.dom.classList.add("to-remove")},mouseout:n=>{this.dom.classList.remove("to-remove")}},content:V.icon("remove")};return{className:`${this.panelName}-prop-controls prop-controls`,content:[e]}}itemInput(e,t){const n=V.childType(t)||"string",f=im.get(this.panelName)?.({itemKey:this.itemKey,key:e})||this.itemKey,d=f.split(".").filter(Number.isNaN).join(".")||e,g=Lt[n]({key:e,value:t}),m=`${this.field.shortId}-${rc(f).replace(/-\d+-(selected)/g,"-$1")}`,c={label:this.panelName!=="options"&&(Uh(d)||at(d)),labelAfter:!1},p={name:g.attrs.type==="checkbox"?`${m}[]`:m};p.disabled=this.isDisabled,p.locked=this.isLocked;const r=rm.get(this.itemSlug)?.(this),o=Ap(Kg[n](f,this.field),r||{}),s=je(Lt[n]({key:e,value:t}),{action:o,attrs:p,config:c});return _n.includes(e)?{className:"f-addon",children:s}:s}}const om={multiple:(l,e)=>{Yh(!!l,e)}};class sm{constructor(e,t,n){this.type=V.childType(e),this.name=t,this.component=n,this.panelConfig=this.getPanelConfig(this.data)}get data(){const e=this.component.get(this.name);return this.type==="object"?Object.entries(e):e}getPanelConfig(e){return this.props=this.createProps(e),this.editButtons=this.createEditButtons(),{config:{label:X.get(`panel.label.${this.name}`)},attrs:{className:`${th} ${this.name}-panel`},children:[this.props,this.editButtons]}}createProps(e=this.data){this.editPanelItems=Array.from(e).map((n,f)=>{const d=this.type==="array",g=d?`[${f}]`:`.${n[0]}`,m=d?n:{[n[0]]:n[1]};return new dn({key:`${this.name}${g}`,data:m,field:this.component,index:f,panel:this})});const t={tag:"ul",attrs:{className:["edit-group",`${this.component.name}-edit-group`,`${this.component.name}-edit-${this.name}`]},editGroup:this.name,isSortable:this.name==="options",content:this.editPanelItems};return V.create(t)}updateProps(){const e=this.createProps();this.props.replaceWith(e),this.props=e}createEditButtons(){const e=this.name,t=X.get(`panelEditButtons.${e}`),n={attrs:this.addAttribute,options:this.addOption,conditions:this.addCondition},f=[];if(e==="conditions"){X.current&&!X.current.clearAll&&X.put("clearAll","Clear All");const m={...V.btnTemplate({content:[V.icon("bin"),X.get("clearAll")],title:X.get("clearAll")}),className:`clear-all-${e}`,action:{click:()=>{this.clearAllItems()}}};f.push(m)}const d={...V.btnTemplate({content:t,title:t}),className:`add-${e}`,action:{click:m=>{const c={btnCoords:V.coords(m.target),addAction:n[e]};e==="attrs"&&(c.isDisabled=this.component.isDisabledProp,c.isLocked=this.component.isLockedProp,c.message={attr:X.get(`action.add.${e}.attr`),value:X.get(`action.add.${e}.value`)});const p=at(e),r=new window.CustomEvent(`onAdd${p}`,{detail:c});xe.add[e](c),document.dispatchEvent(r)}}};return f.push(d),{className:"panel-action-buttons",content:f}}addAttribute=(e,t)=>{let n=t;const f=Nh(e),d=`attrs.${f}`;X.current[d]||X.put(d,Fh(e)),typeof n=="string"&&["true","false"].includes(n)&&(n=JSON.parse(n)),this.component.set(`attrs.${e}`,n),om[f]?.(n,this.component);const g=this.props.querySelector(`.${this.component.name}-attrs-${f}`),m=new dn({key:d,data:{[f]:n},field:this.component,panel:this});g?g.replaceWith(m.dom):this.props.appendChild(m.dom),this.component.resizePanelWrap()};addOption=()=>{const e=this.component.data.config.controlId,t=this.component.get("options"),n=e==="select"?"option":e,f=X.get("newOptionLabel",{type:n})||"New Option",d=`${this.name}[${this.data.length}]`,g=t[t.length-1],c={...t.length?g:{},label:f};e!=="button"&&(c.value=mh(f));const p=new dn({key:d,data:c,field:this.component,index:this.props.children.length,panel:this});this.editPanelItems.push(p),this.props.appendChild(p.dom),this.component.debouncedUpdatePreview(),this.component.resizePanelWrap()};addCondition=e=>{const n=`conditions[${this.component.get("conditions").length}]`,f=new dn({key:n,data:e.template,field:this.component,panel:this});this.props.appendChild(f.dom),this.component.set(n,e.template),this.component.resizePanelWrap()};clearAllItems=()=>{const e=this.type==="array"?[]:{},t={type:this.name,removeAction:()=>{this.component.set(this.name,e),this.updateProps()}};xe.remove[this.name](t);const n=at(this.name),f=new window.CustomEvent(`onRemove${n}`,{detail:t});document.dispatchEvent(f)};setData(e){this.data=e,this.component.set(this.name,e),this.updateProps()}}const au=Object.freeze({type:"field",displayType:"slider"}),fn=l=>({transform:`translateX(${l?`${l}px`:0})`});class Zh{constructor(e){this.opts=je(au,e),this.panelDisplay=this.opts.displayType,this.activePanelIndex=0,this.panelNav=this.createPanelNav();const t=this.createPanelsWrap();this.nav=this.navActions(),this.nav.groupChange(this.activePanelIndex);const n=new window.ResizeObserver(([{contentRect:{width:d}}])=>{this.currentWidth!==d&&(this.toggleTabbedLayout(),this.currentWidth=d,this.nav.setTranslateX(this.activePanelIndex,!1))}),f=window.setTimeout(()=>{n.observe(t),window.clearTimeout(f)},zs)}getPanelDisplay(){const e=this.panelsWrap,n=Number.parseInt(V.getStyle(e,"width"),10)>390?"tabbed":"slider",f=this.opts.displayType==="auto";return this.panelDisplay=f?n:this.opts.displayType||au.displayType,this.panelDisplay}toggleTabbedLayout=()=>{this.getPanelDisplay();const e=this.isTabbed;return this.panelsWrap.parentElement?.classList.toggle("tabbed-panels",e),e&&this.panelNav.removeAttribute("style"),e};resizePanels=()=>{this.toggleTabbedLayout()};createPanelsWrap(){const e=V.create({className:"panels",content:this.opts.panels.map(({config:t,...n})=>n)});return this.opts.type==="field"&&this.sortableProperties(e),this.panelsWrap=e,this.panels=e.children,this.currentPanel=this.panels[this.activePanelIndex],e}sortableProperties(e){const t=e.getElementsByClassName("field-edit-group");return Ne.forEach(t,n=>{n.fieldId=this.opts.id,n.isSortable&&te.create(n,{animation:150,group:{name:`edit-${n.editGroup}`,pull:!0,put:["properties"]},sort:!0,handle:".prop-order",onSort:f=>{this.propertySave(f.to),this.resizePanels()}})})}createPanelNavLabels(){const e=this.opts.panels.map(f=>({tag:"h5",action:{click:d=>{const g=lt(d.target);this.nav.setTranslateX(g,!1),this.nav.groupChange(g)}},content:f.config.label})),t={className:"panel-labels",content:{content:e}},[n]=e;return n.className="active-tab",V.create(t)}createPanelNav(){this.labels=this.createPanelNavLabels();const e={tag:"button",attrs:{className:"next-group",title:X.get("controlGroups.nextGroup"),type:"button"},dataset:{toggle:"tooltip",placement:"top"},action:{click:n=>this.nav.nextGroup(n)},content:V.icon("triangle-right")},t={tag:"button",attrs:{className:"prev-group",title:X.get("controlGroups.prevGroup"),type:"button"},dataset:{toggle:"tooltip",placement:"top"},action:{click:n=>this.nav.prevGroup(n)},content:V.icon("triangle-left")};return V.create({tag:"nav",attrs:{className:"panel-nav"},content:[t,this.labels,e]})}get isTabbed(){return this.panelDisplay==="tabbed"}navActions(){const e={},t=this.currentPanel.parentElement,n=this.labels.firstChild,f=n.children,d=this.currentPanel.parentElement.childNodes;this.activePanelIndex=lt(this.currentPanel);let g={nav:0,panel:0},m={...g};e.groupChange=r=>(this.activePanelIndex=r,this.currentPanel=d[r],V.removeClasses(d,"active-panel"),V.removeClasses(f,"active-tab"),this.currentPanel.classList.add("active-panel"),f[r].classList.add("active-tab"),this.currentPanel);const c=r=>({nav:-n.offsetWidth*r,panel:-t.offsetWidth*r}),p=({offset:r,reset:o,duration:s=mt,animate:a=!this.isTabbed})=>{const i=[fn(m.panel),fn(r.panel)],u=[fn(m.nav),fn(this.isTabbed?0:r.nav)];if(o){const[x]=i,[$]=u;i.push(x),u.push($)}const h={easing:"ease-in-out",duration:a?s:0,fill:"forwards"},y=t.animate(i,h);n.animate(u,h);const w=()=>{y.removeEventListener("finish",w),o||(m=r)};y.addEventListener("finish",w)};return e.setTranslateX=(r=this.activePanelIndex,o=!0)=>{g=c(r),p({offset:g,animate:o})},e.refresh=(r=this.activePanelIndex)=>{this.activePanelIndex!==r&&e.groupChange(r),e.setTranslateX(this.activePanelIndex,!1),this.resizePanels()},e.nextGroup=()=>{const r=this.activePanelIndex+1;if(r!==d.length){const o=d[r];g={nav:-n.offsetWidth*r,panel:-o.offsetLeft},p({offset:g}),e.groupChange(r)}else g={nav:m.nav-8,panel:m.panel-8},p({offset:g,reset:!0});return this.currentPanel},e.prevGroup=()=>{if(this.activePanelIndex!==0){const r=this.activePanelIndex-1,o=d[r];g={nav:-n.offsetWidth*r,panel:-o.offsetLeft},p({offset:g}),e.groupChange(r)}else g={nav:8,panel:8},p({offset:g,reset:!0})},e}}let Uo=null;const Go=vn(mn);class Zn extends Zs{constructor(e,t={}){const n={...t,id:t.id||He()};super(e,n),this.id=n.id,this.shortId=this.id.slice(0,this.id.indexOf("-")),this.name=e,this.indexName=`${e}s`,this.config=ce[`${this.name}s`].config,je(this.config,n.config),this.address=`${this.name}s.${this.id}`,this.dataPath=`${this.address}.`,this.editPanels=new Map,this.eventListeners=new Map,this.initEventHandlers()}initEventHandlers(){this.config.events&&Object.entries(this.config.events).forEach(([e,t])=>{this.addEventListener(e,t)})}addEventListener(e,t){this.eventListeners.has(e)||this.eventListeners.set(e,[]),this.eventListeners.get(e).push(t)}removeEventListener(e,t){if(!this.eventListeners?.has(e))return;const n=this.eventListeners.get(e),f=n.indexOf(t);f>-1&&n.splice(f,1)}dispatchComponentEvent(e,t={}){const n={component:this,target:this,type:e,timestamp:Date.now(),...t};return this.eventListeners?.has(e)&&this.eventListeners.get(e).forEach(f=>{try{typeof f=="function"&&f(n)}catch(d){console.error(`Error in ${e} event handler for ${this.name} ${this.id}:`,d)}}),n}set(e,t){const n=this.get(e),f=super.set(e,t);return n!==t&&this.dom&&this.dispatchComponentEvent("onUpdate",{path:e,oldValue:n,newValue:t}),f}get js(){return this.data}get json(){return this.data}remove=e=>{if(e){const g=vt(e),m=g.pop(),c=this.get(g);return Array.isArray(c)?Ih(m)?c.splice(Number(m),1):this.set(g,c.filter(p=>p!==m)):delete c[m],c}if(this.name==="stage")return null;const t=this.parent,n=this.children;this.dispatchComponentEvent("onRemove",{path:e,parent:t,children:[...n]}),Yn(n,g=>g.remove()),this.dom.parentElement.removeChild(this.dom),Ef(ce.getAddress(`${t.name}s.${t.id}.children`),this.id),t.children.length||t.emptyClass(),t.name==="row"&&t.autoColumnWidths();const d={row:Us,column:Gs,field:qs}[this.name];return d&&J.formeoUpdated({componentId:this.id,componentType:this.name,parent:t},d),ce[`${this.name}s`].delete(this.id)};empty(){const e=this.children.map(t=>(t.remove(),t));return this.dom.classList.add("empty"),e}emptyClass=()=>this.dom.classList.toggle("empty",!this.children.length);getActionButtons(){const e=[`hovering-${this.name}`,"hovering"];return{className:[`${this.name}-actions`,"group-actions"],action:{mouseenter:()=>{ce.stages.active.dom.classList.add(`active-hover-${this.name}`),this.dom.classList.add(...e)},mouseleave:({target:t})=>{this.dom.classList.remove(...e),ce.stages.active.dom.classList.remove(`active-hover-${this.name}`),t.removeAttribute("style")}},children:[{...V.btnTemplate({content:V.icon(`handle-${this.name}`)}),className:["component-handle",`${this.name}-handle`]},{className:["action-btn-wrap",`${this.name}-action-btn-wrap`],children:this.buttons}]}}getComponentTag=()=>V.create({tag:"span",className:["component-tag",`${this.name}-tag`],children:[V.icon(`handle-${this.name}`),at(this.name)].filter(Boolean)});toggleEdit(e=!this.isEditing){this.isEditing=e;const t=this.dom,n="editing",f=`${n}-${this.name}`,d=this.dom.querySelector(`.${this.name}-edit`);$e.slideToggle(d,Ye,e),this.name==="field"&&($e.slideToggle(this.preview,Ye,!e),t.parentElement.classList.toggle(`column-${f}`,e)),t.classList.toggle(n,e),t.classList.toggle(f,e)}get buttons(){if(this.actionButtons)return this.actionButtons;const e={handle:(g=`handle-${this.name}`)=>({...V.btnTemplate({content:V.icon(g)}),className:["component-handle"]}),move:(g="move")=>({...V.btnTemplate({content:V.icon(g)}),className:["item-move"],meta:{id:"move"}}),edit:(g="edit")=>({...V.btnTemplate({content:V.icon(g)}),className:["edit-toggle"],meta:{id:"edit"},action:{click:()=>{this.toggleEdit()}}}),remove:(g="remove")=>({...V.btnTemplate({content:V.icon(g)}),className:["item-remove"],meta:{id:"remove"},action:{click:()=>{$e.slideUp(this.dom,Ye,()=>{this.name==="column"?(this.parent.autoColumnWidths(),this.remove()):this.remove()})}}}),clone:(g="copy")=>({...V.btnTemplate({content:V.icon(g)}),className:["item-clone"],meta:{id:"clone"},action:{click:()=>{this.clone(this.parent),this.name==="column"&&this.parent.autoColumnWidths()}}})},{buttons:t,disabled:n}=this.config.actionButtons,d=t.filter(g=>!n.includes(g)).map(g=>e[g]?.()||g);return this.actionButtons=d,this.actionButtons}get index(){return lt(this.dom)}removeClasses=e=>{const t={string:()=>this.dom.classList.remove(e),array:()=>e.map(n=>this.dom.classList.remove(n))};return t.object=t.string,t[V.childType(e)](this.dom)};get parentType(){return Gf.get(this.name)}get parent(){const e=this.parentType;if(!this.dom||!e)return null;const t=this.dom.closest(`.${Ws[e]}`);return t&&V.asComponent(t)}get children(){if(!this.dom)return[];const e=this.domChildren,t=ec.get(this.name);return ea(e,n=>ce.getAddress(`${t}s.${n.id}`)).filter(Boolean)}loadChildren=(e=this.data.children)=>e.map(t=>this.addChild({id:t}));get domChildren(){const e=this.dom.querySelector(".children");return e?e.children:[]}addChild(e={},t=this.domChildren.length){let n=e;typeof e!="object"&&(n={id:n});const f=this.dom.querySelector(".children"),{id:d=He()}=n,g=ec.get(this.name);if(!g)return null;const m=`${g}s`,c=ce.getAddress(`${m}.${d}`)||ce[m].add(d,n);t>=f.children.length?f.appendChild(c.dom):f.children[t].before(c.dom),this.dispatchComponentEvent("onAddChild",{parent:this,target:c,child:c,index:t}),c.dispatchComponentEvent("onAdd",{parent:this,target:c,index:t,addedVia:"addChild"}),this.config.events?.onAddChild?.({parent:this,child:c});const p=c.get("children");return p?.length&&c.loadChildren(p),this.removeClasses("empty"),this.saveChildOrder(),c}saveChildOrder=()=>{if(this.render)return;const e=this.children.map(({id:t})=>t);return this.set("children",e),e};onAdd({from:e,to:t,item:n,newIndex:f}){e.classList.contains(st)||(e=e.parentElement);const d=Le(e),g=Le(t.parentElement),m=()=>{this.saveChildOrder(),this.removeClasses("empty")},c=new Map([[-2,()=>{const o=this.addChild({},f).addChild();return o.addChild.bind(o)}],[-1,()=>{const o=this.addChild({},f);return o.addChild.bind(o)}],[0,()=>this.addChild.bind(this)],[1,o=>{const s=lt(this.dom);return()=>this.parent.addChild(o,s+1)}],[2,o=>()=>this.parent.parent.addChild(o)]]),r={controls:async()=>{if(!Uo){const{default:w}=await $t(async()=>{const{default:x}=await Promise.resolve().then(()=>Sm);return{default:x}},void 0);Uo=w}const{controlData:{meta:{id:o},...s}}=Uo.get(n.id);Gn(s,"config.controlId",o);const a=o.startsWith("layout-")?o.replace(/^layout-/,""):"field",u=Ie({stage:{row:0,column:-1,field:-2},row:{row:1,column:0,field:-1},column:{row:2,column:1,field:0},field:1},`${this.name}.${a}`),h=c.get(u)();return V.remove(n),h(s,f)},row:()=>{const o={stage:-1,row:0,column:1};return(c.get(o[g])||ys)()?.({id:n.id},f)},column:()=>{const o={stage:-2,row:-1};return(c.get(o[g])||ys)()?.(n.id)}}[d]?.(n,f);return this.dispatchComponentEvent("onAdd",{from:e,to:t,item:n,newIndex:f,fromType:d,toType:g,addedComponent:r,addedVia:"dragDrop"}),m(),r}onSort=()=>this.saveChildOrder();onRemove({from:{parentElement:e}}){return e.classList.contains(Je)&&e.classList.remove("column-editing-field"),this.name!=="stage"&&!this.children.length?this.remove():(this.emptyClass(),this.saveChildOrder())}onEnd=({to:{parentElement:e},from:{parentElement:t}})=>{e?.classList.remove(`hovering-${Le(e)}`),t?.classList.remove(`hovering-${Le(t)}`)};onRender(){this.dispatchComponentEvent("onRender",{dom:this.dom});const{events:e}=this.config;if(!e)return null;e.onRender&&V.onRender(this.dom,e.onRender)}set config(e){const t=Ie(e,"all"),n=Ie(this.data,"config.controlId"),f=n&&Ie(e,n),d=Ie(e,this.id),g=[t,f,d].reduce((m,c)=>c?je(m,c):m,this.configVal);this.configVal=g}get config(){return this.configVal}runConditions=()=>{const e=this.get("conditions");return e?.length?e.map(n=>{const f=this.processConditions(n.if),d=this.processResults(n.then);return f.map(g=>this.evaluateConditions(g)&&this.execResults(d))}):null};getComponent(e){const[t,n]=e.split("."),f=ce[t];return n===this.id?this:f?.get(n)}value=(e,t)=>{const n=e.split("."),f=this.getComponent(e),d=f&&n.slice(2,n.length).join(".");return[!f,!d,!Go[d]].some(Boolean)?e:t?f.set(Go[d],t):f.get(Go[d])};getResult=e=>({"=":(n,f,d)=>n.set(f,d)})[e];processResults=e=>e.map(({operator:t,target:n,value:f})=>{const d=this.getComponent(n),g=d&&n.split(".").slice(2,n.length).join(".");return{target:d,propertyPath:g,action:this.getResult(t),value:this.value(f)}});execResults=e=>{const t=e.map(n=>this.execResult(n));return Promise.all(t)};execResult=({target:e,action:t,value:n,_propertyPath:f})=>new Promise((d,g)=>{try{return d(t(e,n))}catch(m){return g(m)}});cloneData=()=>{const e={...Xe(this.data),id:He()};return this.name!=="field"&&(e.children=[]),e};clone=(e=this.parent)=>{const t=e.addChild(this.cloneData(),this.index+1);return this.name!=="field"&&this.cloneChildren(t),this.dispatchComponentEvent("onClone",{original:this,clone:t,parent:e}),t};cloneChildren(e){for(const t of this.children)t?.clone(e)}createChildWrap=e=>V.create({tag:"ul",attrs:{className:"children"},children:e});get isRow(){return this.name===zr.row}get isColumn(){return this.name===zr.column}get isField(){return this.name===zr.field}isDisabledProp=(e,t="attrs")=>{const n=this.config.panels[t];return n?n.disabled.concat(this.get("config.disabled")).includes(e):!1};isLockedProp=(e,t="attrs")=>{const n=this.config.panels[t];return n?n.locked.concat(this.get("config.locked")).includes(e):!1};get editWindow(){const e={className:["component-edit",`${this.name}-edit`,"slide-toggle","formeo-panels-wrap"]},t=this.editPanels.size;return t&&(e.className.push(`panel-count-${t}`),e.content=[this.panels.panelNav,this.panels.panelsWrap],this.panelNav=this.panels.nav,this.resizePanelWrap=this.panels.nav.refresh),e.action={onRender:()=>{if(t===0){const n=this.dom.querySelector(".edit-toggle"),f=this.dom.querySelector(`.${this.name}-actions`),d=f.getElementsByTagName("button");f.style.maxWidth=`${d.length*d[0].clientWidth}px`,V.remove(n)}else this.resizePanelWrap()}},V.create(e)}updateEditPanels=()=>{if(!this.config)return null;const e=["object","array"],t=gt([...this.config.panels.order,...Object.keys(this.data)]),n=["children","config","meta","action","events",...this.config.panels.disabled],f=t.filter(g=>!n.includes(g));for(const g of f){const m=this.get(g),c=V.childType(m);if(e.includes(c)){const p=new sm(m,g,this);this.editPanels.set(p.name,p)}}const d={panels:Array.from(this.editPanels.values()).map(({panelConfig:g})=>g),id:this.id,displayType:"auto"};this.panels=new Zh(d),this.dom&&(this.dom.querySelector(".panel-nav").replaceWith(this.panels.panelNav),this.dom.querySelector(".panels").replaceWith(this.panels.panelsWrap))}}class am{constructor(){this.onMove=this.onMove.bind(this),this.onStop=this.onStop.bind(this),this.cleanup=this.cleanup.bind(this)}getRowWidth(e){const t=e.querySelector(".children");if(!t)return 0;const n=t.children.length,f=V.getStyle(t,"gap")||"0px",d=parseFloat(f,10)||0;return this.totalGapWidth=d*(n-1),t.offsetWidth-this.totalGapWidth}validateResizeTarget(e,t){return e&&t&&e.offsetWidth&&t.offsetWidth}onStart(e){if(e.preventDefault(),this.resized=!1,e.button!==0)return;const t=e.target.parentElement,n=t.nextSibling||t.previousSibling,f=t.closest(`.${Qe}`);if(!this.validateResizeTarget(t,n)){console.warn("Invalid resize targets"),this.cleanup();return}if(this.startX=e.type==="touchstart"?e.touches[0].clientX:e.clientX,f.classList.add(Wr),this.columnPreset=f.querySelector(`.${nh}`),this.originalColumnClass=t.className,this.originalSiblingClass=n.className,t.className=t.className.replace(Cs,""),n.className=n.className.replace(Cs,""),this.colStartWidth=t.offsetWidth,this.sibStartWidth=n.offsetWidth,this.rowWidth=this.getRowWidth(f),this.rowWidth<=0){console.warn("Invalid row width calculated"),this.cleanup();return}this.column=t,this.sibling=n,this.row=f;try{window.addEventListener("pointermove",this.onMove,!1),window.addEventListener("pointerup",this.onStop,!1)}catch(d){console.error("Failed to initialize resize listeners:",d),this.cleanup()}}calculateNewWidths(e){const t=this.colStartWidth+e-this.startX,n=this.sibStartWidth-e+this.startX,f=parseFloat(Hr(t,this.rowWidth)),d=parseFloat(Hr(n,this.rowWidth));return f<10||d<10?null:{colWidth:vs(f.toFixed(1)),siblingColWidth:vs(d.toFixed(1))}}onMove(e){e.preventDefault();const{column:t,sibling:n}=this,f=e.type==="touchmove"?e.touches[0].clientX:e.clientX,d=this.calculateNewWidths(f);if(!d)return;const{colWidth:g,siblingColWidth:m}=d;t.dataset.colWidth=g,n.dataset.colWidth=m,t.style.width=g,n.style.width=m,this.resized=!0}onStop(){const{column:e,sibling:t}=this;window.removeEventListener("pointermove",this.onMove),window.removeEventListener("pointerup",this.onStop),this.resized&&(this.setCustomWidthValue(),ce.setAddress(`columns.${e.id}.config.width`,e.dataset.colWidth),ce.setAddress(`columns.${t.id}.config.width`,t.dataset.colWidth),this.row.classList.remove(Wr),this.resized=!1,this.cleanup())}cleanup(){this.column&&this.originalColumnClass&&(this.column.className=this.originalColumnClass),this.sibling&&this.originalSiblingClass&&(this.sibling.className=this.originalSiblingClass),this.row&&this.row.classList.remove(Wr),window.removeEventListener("pointermove",this.onMove),window.removeEventListener("pointerup",this.onStop)}setCustomWidthValue(){const e=this.columnPreset;let t=e.querySelector(`.${bs}`);const n=this.row.querySelector(".children").children,f=ea(n,m=>Hr(m.clientWidth,this.rowWidth).toFixed(1)),d=f.join(","),g=f.join(" | ");return t||(t=V.create({tag:"option",attrs:{className:bs,value:d,selected:!0},content:g}),e.append(t)),t.value=d,t.textContent=g,d}}const lm=()=>Object.freeze({config:{width:"100%"},children:[],className:[Je]}),lu={resizeHandle:l=>({className:"resize-x-handle",action:{pointerdown:l.onStart.bind(l)},content:[V.icon("triangle-down"),V.icon("triangle-up")]}),editWindow:()=>({className:"column-edit group-config"})};class cm extends Zn{constructor(e){super("column",{...lm(),...e});const t=this.createChildWrap();this.dom=V.create({tag:"li",className:[Je,"empty"],dataset:{hoverTag:X.get("column")},id:this.id,content:[this.getComponentTag(),this.getActionButtons(),lu.editWindow(),lu.resizeHandle(new am),t]}),this.processConfig(),J.columnResized=new window.CustomEvent("columnResized",{detail:{column:this.dom,instance:this}}),te.create(t,{animation:150,fallbackClass:"field-moving",forceFallback:!0,group:{name:"column",pull:!0,put:["column","controls"]},sort:!0,disabled:!1,onEnd:this.onEnd.bind(this),onAdd:this.onAdd.bind(this),onSort:this.onSort.bind(this),onRemove:this.onRemove.bind(this),onMove:n=>{n.from!==n.to&&n.from.classList.remove("hovering-column")},draggable:`.${It}`,handle:".item-move"})}processConfig(){const e=Ne.get(this.data,"config.width");e&&this.setDomWidth(e)}refreshFieldPanels=()=>{for(const e of this.children)e.panels.nav.refresh()};setDomWidth=e=>{this.dom.dataset.colWidth=e,this.dom.style.width=e};setWidth=e=>(this.setDomWidth(e),this.set("config.width",e))}const um={actionButtons:{buttons:["clone","move","remove"],disabled:[]}};let hm=class extends qn{constructor(e){super("columns",e),this.config={all:um}}Component(e){return new cm(e)}};const Xh=new hm,dm=()=>Object.freeze({config:{fieldset:!1,legend:"",inputGroup:!1},children:[],className:[Qe]});class fm extends Zn{constructor(e){super("row",{...dm(),...e});const t=this.createChildWrap();this.dom=V.create({tag:"li",className:[Qe,"empty"],dataset:{hoverTag:X.get("row"),editingHoverTag:X.get("editing.row")},id:this.id,content:[this.getComponentTag(),this.getActionButtons(),this.editWindow,t]}),te.create(t,{animation:150,fallbackClass:"column-moving",forceFallback:!0,group:{name:"row",pull:!0,put:["row","column","controls"]},sort:!0,disabled:!1,onRemove:this.onRemove.bind(this),onEnd:this.onEnd.bind(this),onAdd:this.onAdd.bind(this),onSort:this.onSort.bind(this),draggable:`.${Je}`,handle:".item-move"})}get editWindow(){const e={tag:"input",id:`${this.id}-fieldset`,attrs:{type:"checkbox",checked:this.get("config.fieldset"),ariaLabel:X.get("row.settings.fieldsetWrap.aria")},action:{click:({target:{checked:s}})=>{this.set("config.fieldset",!!s)}},config:{label:X.get("row.settings.fieldsetWrap")}},t={tag:"input",id:`${this.id}-inputGroup`,attrs:{type:"checkbox",checked:this.get("config.inputGroup"),ariaLabel:X.get("row.settings.inputGroup.aria")},action:{click:({target:{checked:s}})=>this.set("config.inputGroup",s)},config:{label:X.get("row.makeInputGroup"),description:X.get("row.makeInputGroupDesc")}},n={tag:"span",content:" ⓘ",dataset:{tooltip:"Row title will be used as the legend for the fieldset"}},d={className:"input-group",content:{tag:"input",attrs:{type:"text",ariaLabel:"Legend for fieldset",value:this.get("config.legend"),placeholder:"Title"},config:{label:{children:["Row Title",n]}},action:{input:({target:{value:s}})=>this.set("config.legend",s)},className:""}},g=V.formGroup([e,d]),m={tag:"label",content:X.get("defineColumnWidths"),className:"col-sm-4 form-control-label"};this.columnPresetControl=V.create(this.columnPresetControlConfig);const c={className:"col-sm-8",content:this.columnPresetControl,action:{onRender:()=>{this.updateColumnPreset()}}},p=V.formGroup([m,c],"row"),r=[t,"hr",g,"hr",p];return V.create({className:`${this.name}-edit group-config`,action:{onRender:s=>{const a=r.map(i=>V.create(i));s.append(...a)}}})}onAdd(...e){super.onAdd(...e),this.autoColumnWidths()}onRemove(...e){super.onRemove(...e),this.autoColumnWidths()}autoColumnWidths=()=>{const e=this.children;if(!e.length)return;const t=Number.parseFloat((100/e.length).toFixed(1))/1;for(const n of e){n.removeClasses(Cs);const f=n.dom,d=vs(t);n.set("config.width",d),f.style.width=d,f.dataset.colWidth=d;const g=setTimeout(()=>{clearTimeout(g),n.refreshFieldPanels()},mt);document.dispatchEvent(J.columnResized)}this.updateColumnPreset()};updateColumnPreset=()=>{this.columnPresetControl.innerHTML="";const e=this.getColumnPresetOptions.map(({label:t,...n})=>V.create({tag:"option",content:t,attrs:n}));this.columnPresetControl.append(...e)};setColumnWidths=e=>{typeof e=="string"&&(e=e.split(",")),this.children.forEach((t,n)=>{t.setWidth(`${e[n]}%`),t.refreshFieldPanels()})};get getColumnPresetOptions(){const e=this.children,n=Kf.get(e.length-1)||[],f=e.map(d=>{const g=d.get("config.width")||"";return Number(g.replace("%","")).toFixed(1)}).join(",");if(n.length){const d=n.slice();return!d.find(m=>m.value===f)&&d.push({value:f,label:f.replace(/,/g," | "),className:bs}),d.map(m=>{const c={...m};return c.selected=m.value===f,c})}return[]}get columnPresetControlConfig(){return{tag:"select",attrs:{ariaLabel:X.get("defineColumnLayout"),className:nh},action:{change:({target:t})=>{const{value:n}=t;this.setColumnWidths(n)}},options:this.getColumnPresetOptions}}}const pm={actionButtons:{buttons:["move","edit","clone","remove"],disabled:[]}};let gm=class extends qn{constructor(e){super("rows",e),this.config={all:pm}}Component(e){return new fm(e)}};const na=new gm,mm=()=>({conditions:[Ks()],children:[]});class vm extends Zn{constructor(e){super("stage",{...mm(),...e}),this.updateEditPanels(),this.debouncedUpdateEditPanels=xn(this.updateEditPanels),X.get("Untitled Form"),X.get("Untitled Form"),X.get("Form Title"),X.get("Form novalidate"),X.get("Tags");const t=this.createChildWrap();this.dom=V.create({attrs:{className:[Ot,"empty"],id:this.id},children:[this.getComponentTag(),this.getActionButtons(),this.editWindow,t]}),te.create(t,{animation:150,fallbackClass:"row-moving",group:{name:"stage",pull:!0,put:["row","column","controls"]},sort:!0,disabled:!1,onAdd:this.onAdd.bind(this),onRemove:this.onRemove.bind(this),onStart:()=>{en.active=this},onSort:this.onSort.bind(this),draggable:`.${Qe}`,handle:".item-move"})}empty(e=!0){return new Promise(t=>{e?(this.dom.classList.add("removing-all-fields"),$e.slideUp(this.dom,Ye,()=>{t(super.empty(e)),this.dom.classList.remove("removing-all-fields"),$e.slideDown(this.dom,Ye)})):t(super.empty())})}onAdd(...e){const t=super.onAdd(...e);t?.name==="column"&&t.parent.autoColumnWidths()}}const ym=()=>({actionButtons:{buttons:["edit"],disabled:[]},panels:{disabled:[],order:["attrs","options","conditions"]}});let wm=class extends qn{constructor(e){super("stages",e),this.config={all:ym()}}Component(e){return new vm(e)}};const en=new wm;class bm{controlCache=new Set;constructor({events:e={},dependencies:t={},controlAction:n,...f}){this.events=e,this.controlData=f,this.controlAction=n,this.dependencies=t,this.id=f.id||He()}get controlId(){return this.controlData.meta?.id||this.controlData.config?.controlId}get dom(){const{meta:e,config:t}=this.controlData,n=this.i18n(t.label)||t.label,f={tag:"button",attrs:{type:"button"},content:[{tag:"span",className:"control-icon",children:V.icon(e.icon)},{tag:"span",className:"control-label",content:n}],action:{focus:({target:d})=>{const g=d.closest(`.${st}`);return g&&Rt.panels.nav.refresh(lt(g))},click:({target:d})=>{const g=d.closest(".field-control")?.id;g&&Rt.addElement(g)}}};return V.create({tag:"li",id:this.id,className:["field-control",`${e.group}-control`,`${e.id}-control`],content:f,meta:e,action:this.controlAction})}promise(){return Wh(this.dependencies)}i18n(e,t){const n=X.locale,d=this.definition?.i18n?.[n]||{};return(d[e]?.()??d[e])||X.get(e,t)}}const Cm=Object.freeze({sortable:!0,elementOrder:{},groupOrder:[],groups:[{id:"layout",label:"controls.groups.layout",elementOrder:["row","column"]},{id:"common",label:"controls.groups.form",elementOrder:["button","checkbox"]},{id:"html",label:"controls.groups.html",elementOrder:["header","block-text"]}],disable:{groups:[],elements:[],formActions:[]},elements:[],container:null,panels:{displayType:"slider"}});let Qh=class{constructor(){this.data=new Map,this.buttonActions={focus:({target:e})=>{const t=e.closest(`.${st}`);return t&&this.panels.nav.refresh(lt(t))},click:({target:e})=>{this.addElement(e.parentElement.id)}}}async init(e,t=!1){return await this.applyOptions(e),this.buildDOM(t),this}registerControls(e){return this.controls=[],e.map(t=>{const f=typeof t=="function"?new t:new bm(t);return this.add(f),this.controls.push(f.dom),f.promise()})}groupLabel=e=>X.get(e)||e||"";groupElements(){let e=this.options.groups.slice(),t=this.controls.slice(),n=[];const f=[];return e=On(e,this.groupOrder,"id"),e=e.filter(d=>Ql(d.id,this.options.disable.groups)),n=e.map(d=>{const g={tag:"ul",attrs:{className:[st,th],id:`${d.id}-${st}`},config:{label:this.groupLabel(d.label)}};if(this.options.elementOrder[d.id]){const m=this.options.elementOrder[d.id],c=gt(m.concat(d.elementOrder));d.elementOrder=c}return t=On(t,d.elementOrder,"meta.id"),g.content=t.filter(m=>{const{controlData:c}=this.get(m.id),p=c.meta.id||"",r=[Ql(p,this.options.disable.elements),c.meta.group===d.id,!f.includes(p)];let o=!0;return o=r.every(s=>s===!0),o&&f.push(p),o}),g}),n}add(e=Object.create(null)){const t=Xe(e);return this.data.set(t.id,t),t.controlData.meta.id&&this.data.set(t.controlData.meta.id,t.controlData),t}get(e){return Xe(this.data.get(e))}formActions(){if(this.options.disable.formActions===!0)return null;const e={...V.btnTemplate({content:[V.icon("bin"),X.get("clear")],title:X.get("clearAll")}),className:["clear-form"],action:{click:f=>{na.size?(J.confirmClearAll=new window.CustomEvent("confirmClearAll",{detail:{confirmationMessage:X.get("confirmClearAll"),clearAllAction:()=>{en.clearAll().then(()=>{const d={src:f.target};J.formeoCleared(d)})},btnCoords:V.coords(f.target)}}),document.dispatchEvent(J.confirmClearAll)):window.alert(X.get("cannotClearFields"))}}},t={...V.btnTemplate({content:[V.icon("floppy-disk"),X.get("save")],title:X.get("save")}),className:["save-form"],action:{click:async({target:f})=>{const{default:d}=await $t(async()=>{const{default:c}=await Promise.resolve().then(()=>Lm);return{default:c}},void 0),{formData:g}=d,m={action:()=>{},coords:V.coords(f),message:"",button:f};return xe.click.btn(m),xe.save.form(g)}}};return{className:"form-actions f-btn-group",content:Object.entries({clearBtn:e,saveBtn:t}).reduce((f,[d,g])=>(this.options.disable.formActions.includes(d)||f.push(g),f),[])}}buildDOM(e){const t=this.groupElements(),n=this.formActions(),{displayType:f}=this.options.panels;this.panels=new Zh({panels:t,type:"controls",displayType:f});const d=["control-groups","formeo-panels-wrap",`panel-count-${t.length}`],g=V.create({className:d,content:[this.panels.panelNav,this.panels.panelsWrap]}),m=["formeo-controls"];e&&m.push("formeo-sticky");const c=V.create({className:m,content:[g,n]}),p=c.getElementsByClassName("control-group");this.dom=c,this.groups=p;const[r]=p;this.currentGroup=r,this.actions={filter:o=>{const s=o!=="",a=this.controls;let i=g.querySelector(".filtered-term");if(V.toggleElementsByStr(a,o),s){const u=X.get("controls.filteringTerm",o);c.classList.add("filtered"),i?i.textContent=u:(i=V.create({tag:"h5",className:"filtered-term",content:u}),g.insertBefore(i,g.firstChild))}else i&&(c.classList.remove("filtered"),i.remove())},addElement:this.addElement,addGroup:o=>console.log(o)};for(let o=p.length-1;o>=0;o--){const s=`formeo-controls-${p[o]}`;this.options.sortable||globalThis.localStorage.removeItem(s),te.create(p[o],{animation:150,fallbackClass:"control-moving",fallbackOnBody:!0,forceFallback:!0,fallbackTolerance:5,group:{name:"controls",pull:"clone",put:!1,revertClone:!0},onClone:({clone:a,item:i})=>{if(a.id=i.id,this.options.ghostPreview){const{controlData:u}=this.get(i.id);$t(async()=>{const{default:h}=await Promise.resolve().then(()=>xm);return{default:h}},void 0).then(({default:h})=>{a.innerHTML="",a.appendChild(new h(u).preview)})}},onStart:()=>{this.originalDocumentOverflow=document.documentElement.style.overflow,document.documentElement.style.overflow="hidden"},onEnd:()=>{document.documentElement.style.overflow=this.originalDocumentOverflow,this.originalDocumentOverflow=null},sort:this.options.sortable,store:{get:()=>{const a=globalThis.localStorage.getItem(s);return a?a.split("|"):[]},set:a=>{const i=a.toArray();globalThis.localStorage.setItem(s,i.join("|"))}}})}return c}layoutTypes={row:()=>en.active.addChild(),column:()=>this.layoutTypes.row().addChild(),field:e=>this.layoutTypes.column().addChild(e)};addElement=e=>{const{meta:{group:t,id:n},...f}=Ie(this.get(e),"controlData");return Gn(f,"config.controlId",n),t==="layout"?this.layoutTypes[n.replace("layout-","")]():this.layoutTypes.field(f)};applyOptions=async(e={})=>{const{container:t,elements:n,groupOrder:f,...d}=je(Cm,e);this.container=t,this.groupOrder=gt(f.concat(["common","html","layout"])),this.options=d;const[g,m,c]=await Promise.all([$t(()=>import("./index.min.js"),[]),$t(()=>import("./index.min2.js"),[]),$t(()=>import("./index.min3.js"),[])]),p=[g.default,m.default,c.default].flat();return Promise.all(this.registerControls([...p,...n]))}};const Rt=new Qh,Sm=Object.freeze(Object.defineProperty({__proto__:null,Controls:Qh,default:Rt},Symbol.toStringTag,{value:"Module"})),Am=()=>({}),$m=new Set(["checkbox","radio"]),Mm=new Set(["radio","checkbox","select-one","select-multiple"]);class Jh extends Zn{constructor(e=Object.create(null)){super("field",{...Am(),...e}),this.debouncedUpdateEditPanels=xn(this.updateEditPanels),this.debouncedUpdatePreview=xn(this.updatePreview),this.label=V.create(this.labelConfig),this.preview=this.fieldPreview(),this.controlId=this.get("config.controlId")||this.get("meta.id");const t=this.getActionButtons(),n=this.actionButtons.some(d=>d.meta?.id==="edit");this.updateEditPanels();const f=V.create({tag:"li",attrs:{className:It},id:this.id,children:[this.label,this.getComponentTag(),t,n&&this.editWindow,this.preview].filter(Boolean),panelNav:this.panelNav,dataset:{hoverTag:X.get("field")}});this.dom=f,this.isEditing=!1}get labelConfig(){if(!!this.get("config.hideLabel"))return null;const t=this.get("config.editorLabel")||this.get("config.label"),n=this.get("attrs.required"),f=this.config.label.disableHTML;return{className:"prev-label",children:[{...(()=>{const c={tag:"label",attrs:{}};return f?(c.tag="input",c.attrs.value=t,c):(c.attrs.contenteditable=!0,c.children=t,c)})(),action:{input:({target:{innerHTML:c,innerText:p}})=>{super.set("config.label",f?p:c)}}},n&&V.requiredMark()]}}setData=(e,t)=>super.set(e,t);set(e,t){const n=this.setData(e,t);return this.debouncedUpdatePreview(),n}updateLabel(){if(!this.label)return null;const e=V.create(this.labelConfig);this.label.replaceWith(e),this.label=e}updatePreview=()=>{this.updateLabel();const e=this.fieldPreview();this.preview.replaceWith(e),this.preview=e};get defaultPreviewActions(){return{change:e=>{const{target:t}=e,{type:n}=t;if(Mm.has(n)){const f=this.preview.querySelectorAll(":checked"),d=this.get("options"),g=d?.[0]?.selected!==void 0?"selected":"checked",m=d.reduce((c,p)=>(c[p.value]=p,c[p.value][g]=!1,c),{});for(const c of f)m[c.value][g]=c.value===m[c.value].value;return super.set("options",Object.values(m)),this.debouncedUpdateEditPanels()}},click:e=>{e.target.contentEditable==="true"&&e.preventDefault()},input:({target:e})=>{if(["input","meter","progress","button"].includes(e.tagName.toLowerCase()))return super.set("attrs.value",e.value),this.debouncedUpdateEditPanels();if(e.contentEditable&&!e.type?.startsWith("select-")){const t=e.parentElement.classList;if(t.contains("f-checkbox")||t.contains("f-radio")){const f=e.parentElement,d=lt(f);return this.setData(`options[${d}].label`,e.innerHTML),this.debouncedUpdateEditPanels()}this.setData("content",e.innerHTML||e.value)}}}}fieldPreview(){const{action:e={},...t}=Xe(this.data);t.id=`prev-${this.id}`,t.action=Object.entries(e).reduce((f,[d,g])=>(f[d]=g.bind(this),f),{}),this.data?.config.editableContent&&(t.attrs={...t.attrs,contenteditable:!0});const n={attrs:{className:"field-preview",style:this.isEditing&&"display: none;"},content:V.create(t,!0),action:this.defaultPreviewActions};return V.create(n,!0)}get isCheckable(){return $m.has(this.get("config.controlId"))}}const xm=Object.freeze(Object.defineProperty({__proto__:null,default:Jh},Symbol.toStringTag,{value:"Module"})),Em=()=>({actionButtons:{buttons:["move","edit","clone","remove"],disabled:[]},panels:{disabled:[],attrs:{disabled:["type"],hideDisabled:!0,locked:[]},order:["attrs","options","conditions"]},label:{disableHTML:!1}});let _m=class extends qn{constructor(e){super("fields",e),this.config={all:Em()}}Component(e){return new Jh(e)}get=e=>{let t=e&&Ie(this.data,e);if(!t){const n=Rt.get(e);n&&(t=this.add(null,n.controlData))}return t};getData=()=>Object.entries(this.data).reduce((e,[t,n])=>{const{conditions:f,...d}=n?.getData()||n;if(f?.length){let g=!0;if(f.length===1){const[m]=f;g=!!m.if[0].source}g&&(d.conditions=f)}return e[t]=d,e},{});load=(e=Object.create(null))=>{const t=jn(e);this.empty();for(const[n,f]of Object.entries(t)){const{meta:d,...g}=f;d?.id&&Gn(g,"config.controlId",d?.id),this.add(n,g)}return this.data}};const ed=new _m,An=en,$n=na,Qt=Xh,Mn=ed,Nn=Rt,Tm=(l,e=!1)=>l?Xe(jn(l)):e&&Ju.get(oh)||En();class td extends Zs{constructor(){super("components"),this.disableEvents=!0,this.stages=An,this.rows=$n,this.columns=Qt,this.fields=Mn,this.controls=Nn}load=(e,t)=>{this.empty();const n=Tm(e,t.sessionStorage);this.opts=t,this.set("id",n.id),this.add("stages",An.load(n.stages)),this.add("rows",$n.load(n.rows)),this.add("columns",Qt.load(n.columns)),this.add("fields",Mn.load(n.fields));for(const f of Object.values(this.get("stages")))f.loadChildren();return this.data};flatList(){const e={};for(const t of Object.keys(this.data.stages))eh(this.data,t,"stages",e);return e}getChildData=({type:e,id:t})=>{const n=this.get(e,t);if(n)return n.getData()};get json(){return window.JSON.stringify({$schema:`https://cdn.jsdelivr.net/npm/formeo@${Fs}/dist/formData_schema.json`,...this.formData})}get formData(){return{id:this.get("id"),stages:en.getData(),rows:na.getData(),columns:Xh.getData(),fields:ed.getData()}}set config(e){const{stages:t,rows:n,columns:f,fields:d}=e;An.config=t,$n.config=n,Qt.config=f,Mn.config=d}getIndex(e){return this[e]||this[Pf.get(e)]}setAddress(e,t){if(!Pe(e))return;const[n,f,...d]=Array.isArray(e)?e:vt(e),m=this.getIndex(n).get(f);return m?.set(d,t),m}getAddress(e){if(!Pe(e))return;const[t,n,...f]=Array.isArray(e)?e:vt(e),g=this.getIndex(t).get(n);if(!(f.length&&!g))return f.length?g.get(f):g}}const ce=new td,Lm=Object.freeze(Object.defineProperty({__proto__:null,Columns:Qt,Components:td,Controls:Nn,Fields:Mn,Rows:$n,Stages:An,default:ce},Symbol.toStringTag,{value:"Module"})),cu="no-transition",Rm={debug:!1,bubbles:!0,formeoLoaded:l=>{},onAdd:()=>{},onChange:l=>J.opts?.debug&&console.log(l),onUpdate:l=>J.opts?.debug&&console.log(l),onUpdateStage:l=>J.opts?.debug&&console.log(l),onUpdateRow:l=>J.opts?.debug&&console.log(l),onUpdateColumn:l=>J.opts?.debug&&console.log(l),onUpdateField:l=>J.opts?.debug&&console.log(l),onAddRow:l=>J.opts?.debug&&console.log(l),onAddColumn:l=>J.opts?.debug&&console.log(l),onAddField:l=>J.opts?.debug&&console.log(l),onRemoveRow:l=>J.opts?.debug&&console.log(l),onRemoveColumn:l=>J.opts?.debug&&console.log(l),onRemoveField:l=>J.opts?.debug&&console.log(l),onRender:l=>J.opts?.debug&&console.log(l),onSave:l=>{},confirmClearAll:l=>{window.confirm(l.confirmationMessage)&&l.clearAllAction(l)}},ze=({src:l,...e},t=Jt)=>{const n=new window.CustomEvent(t,{detail:e,bubbles:J.opts?.debug||J.opts?.bubbles});if(n.data=(l||document).dispatchEvent(n),t===Jt){const f=new window.CustomEvent(Yf,{detail:e,bubbles:J.opts?.debug||J.opts?.bubbles});(l||document).dispatchEvent(f)}return n},J={init:function(l){return this.opts={...Rm,...l},this},formeoSaved:l=>ze(l,sh),formeoUpdated:(l,e)=>ze(l,e||Jt),formeoCleared:l=>ze(l,Zf),formeoOnRender:l=>ze(l,hh),formeoConditionUpdated:l=>ze(l,Xf),formeoAddedRow:l=>ze(l,Bs),formeoAddedColumn:l=>ze(l,js),formeoAddedField:l=>ze(l,Vs),formeoRemovedRow:l=>ze(l,Us),formeoRemovedColumn:l=>ze(l,Gs),formeoRemovedField:l=>ze(l,qs)},km=Tf(()=>{const l={timeStamp:window.performance.now(),type:Jt,detail:ce.formData};J.opts.onUpdate(l),J.opts.onChange!==J.opts.onUpdate&&J.opts.onChange(l)},mt);document.addEventListener(Jt,km);document.addEventListener(ah,l=>{const{timeStamp:e,type:t,detail:n}=l,f={timeStamp:e,type:t,detail:n};J.opts.onUpdate(f),J.opts.onUpdateStage(f)});document.addEventListener(lh,l=>{const{timeStamp:e,type:t,detail:n}=l,f={timeStamp:e,type:t,detail:n};J.opts.onUpdate(f),J.opts.onUpdateRow(f)});document.addEventListener(ch,l=>{const{timeStamp:e,type:t,detail:n}=l,f={timeStamp:e,type:t,detail:n};J.opts.onUpdate(f),J.opts.onUpdateColumn(f)});document.addEventListener(uh,l=>{const{timeStamp:e,type:t,detail:n}=l,f={timeStamp:e,type:t,detail:n};J.opts.onUpdate(f),J.opts.onUpdateField(f)});document.addEventListener(Bs,l=>{const{timeStamp:e,type:t,detail:n}=l,f={timeStamp:e,type:t,detail:n};J.opts.onAddRow(f)});document.addEventListener(js,l=>{const{timeStamp:e,type:t,detail:n}=l,f={timeStamp:e,type:t,detail:n};J.opts.onAddColumn(f)});document.addEventListener(Vs,l=>{const{timeStamp:e,type:t,detail:n}=l,f={timeStamp:e,type:t,detail:n};J.opts.onAddField(f)});document.addEventListener(Us,l=>{const{timeStamp:e,type:t,detail:n}=l,f={timeStamp:e,type:t,detail:n};J.opts.onRemoveRow(f)});document.addEventListener(Gs,l=>{const{timeStamp:e,type:t,detail:n}=l,f={timeStamp:e,type:t,detail:n};J.opts.onRemoveColumn(f)});document.addEventListener(qs,l=>{const{timeStamp:e,type:t,detail:n}=l,f={timeStamp:e,type:t,detail:n};J.opts.onRemoveField(f)});document.addEventListener(hh,l=>{const{timeStamp:e,type:t,detail:n}=l;J.opts.onRender({timeStamp:e,type:t,detail:n})});document.addEventListener("confirmClearAll",l=>{l={timeStamp:l.timeStamp,type:l.type,confirmationMessage:l.detail.confirmationMessage,clearAllAction:l.detail.clearAllAction,btnCoords:l.detail.btnCoords},J.opts.confirmClearAll(l)});document.addEventListener(sh,({timeStamp:l,type:e,detail:{formData:t}})=>{const n={timeStamp:l,type:e,formData:t};J.opts.onSave(n)});document.addEventListener("formeoLoaded",l=>{J.opts.formeoLoaded(l.detail.formeo)});let qo;function Dm(){qo=qo||window.requestAnimationFrame(()=>{qo=!1;for(const l of Object.values(Qt.data))l.dom.classList.add(cu),Nn.dom.classList.add(cu),Nn.panels.nav.refresh(),l.refreshFieldPanels()})}window.addEventListener("resize",Dm);const uu={add:{attr:l=>{const e=window.prompt(l.message.attr);if(e&&l.isDisabled(e))return window.alert(X.get("attributeNotPermitted",e||"")),xe.add.attrs(l);let t;e&&(t=String(window.prompt(l.message.value,"")),l.addAction(e,t))},option:l=>{l.addAction()},condition:l=>{l.addAction(l)}},remove:{attrs:l=>{l.removeAction()},options:l=>{l.removeAction()},conditions:l=>{l.removeAction()}},click:{btn:l=>{l.action()}},save:{form:ys}},xe={init:function(l){const e=Object.keys(uu);return this.opts=e.reduce((t,n)=>(t[n]={...uu[n],...l[n]},t),l),this},add:{attrs:l=>xe.opts.add.attr(l),options:l=>xe.opts.add.option(l),conditions:l=>(l.template=l.template||Ks(),xe.opts.add.condition(l))},remove:{attrs:l=>xe.opts.remove.attrs(l),options:l=>xe.opts.remove.options(l),conditions:l=>xe.opts.remove.conditions(l)},click:{btn:l=>xe.opts.click.btn(l)},save:{form:l=>(xe.opts.sessionStorage&&Ju.set(oh,l),J.formeoSaved({formData:l}),xe.opts.save.form(l))}},Om={"en-US":{"en-US":"English",dir:"ltr","af-ZA":"Afrikaans (South Africa)","ar-TN":"Arabic (Tunisia)","cs-CZ":"Czech (Czechia)","de-DE":"German (Germany)","es-ES":"European Spanish","fa-IR":"Persian (Iran)","fi-FI":"Finnish (Finland)","fr-FR":"French (France)","hu-HU":"Hungarian (Hungary)","it-IT":"Italian (Italy)","ja-JP":"Japanese (Japan)","nb-NO":"Norwegian Bokmål (Norway)","pl-PL":"Polish (Poland)","pt-BR":"Brazilian Portuguese","pt-PT":"European Portuguese","ro-RO":"Romanian (Romania)","ru-RU":"Russian (Russia)","th-TH":"Thai (Thailand)","tr-TR":"Turkish (Türkiye)","zh-CN":"Chinese (China)","zh-HK":"Chinese (Hong Kong SAR China)","action.add.attrs.attr":"What attribute would you like to add?","action.add.attrs.value":"Default Value",addOption:"Add Option",allFieldsRemoved:"All fields were removed.",allowSelect:"Allow Select",and:"and",attribute:"Attribute",attributeNotPermitted:'Attribute "{attribute}" is not permitted, please choose another.',attributes:"Attributes","attrs.class":"Class","attrs.className":"Class","attrs.dir":"Direction","attrs.id":"Id","attrs.required":"Required","attrs.style":"Style","attrs.title":"Title","attrs.type":"Type","attrs.value":"Value",autocomplete:"Autocomplete",button:"Button",cannotBeEmpty:"This field cannot be empty",cannotClearFields:"There are no fields to clear",checkbox:"Checkbox",checkboxes:"Checkboxes",class:"Class",clear:"Clear",clearAllMessage:"Are you sure you want to clear all fields?",close:"Close",column:"Column","condition.target.placeholder":"target","condition.type.and":"And","condition.type.if":"If","condition.type.or":"Or","condition.type.then":"Then","condition.value.placeholder":"value",confirmClearAll:"Are you sure you want to remove all fields?",content:"Content",control:"Control","controlGroups.nextGroup":"Next Group","controlGroups.prevGroup":"Previous Group","controls.filteringTerm":'Filtering "{term}"',"controls.form.button":"Button","controls.form.checkbox-group":"Checkbox Group","controls.form.input.date":"Date","controls.form.input.email":"Email","controls.form.input.file":"File Upload","controls.form.input.hidden":"Hidden Input","controls.form.input.number":"Number","controls.form.input.text":"Text Input","controls.form.radio-group":"Radio Group","controls.form.select":"Select","controls.form.textarea":"TextArea","controls.groups.form":"Form Fields","controls.groups.html":"HTML Elements","controls.groups.layout":"Layout","controls.html.divider":"Divider","controls.html.header":"Header","controls.html.paragraph":"Paragraph","controls.layout.column":"Column","controls.layout.row":"Row",copy:"Copy To Clipboard",danger:"Danger",defineColumnLayout:"Define a column layout",defineColumnWidths:"Define column widths",description:"Help Text",descriptionField:"Description","editing.row":"Editing Row",editorTitle:"Form Elements",field:"Field","field.property.invalid":"not valid","field.property.isChecked":"is checked","field.property.isNotVisible":"is not visible","field.property.isVisible":"is visible","field.property.label":"label","field.property.valid":"valid","field.property.value":"value",fieldNonEditable:"This field cannot be edited.",fieldRemoveWarning:"Are you sure you want to remove this field?",fileUpload:"File Upload",formUpdated:"Form Updated",getStarted:"Drag a field from the right to get started.",group:"Group",grouped:"Grouped",hidden:"Hidden Input",hide:"Edit",htmlElements:"HTML Elements",if:"If","if.condition.source.placeholder":"source","if.condition.target.placeholder":"target / value",info:"Info","input.date":"Date","input.text":"Text",label:"Label",labelCount:"{label} {count}",labelEmpty:"Field Label cannot be empty","lang.af":"Afrikaans","lang.ar":"Arabic","lang.cs":"Czech","lang.de":"German","lang.en":"English","lang.es":"Spanish","lang.fa":"Persian","lang.fi":"Finnish","lang.fr":"French","lang.hu":"Hungarian","lang.it":"Italian","lang.ja":"Japanese","lang.nb":"Norwegian Bokmål","lang.pl":"Polish","lang.pt":"Portuguese","lang.ro":"Romanian","lang.ru":"Russian","lang.th":"Thai","lang.tr":"Turkish","lang.zh":"Chinese",layout:"Layout",limitRole:"Limit access to one or more of the following roles:",mandatory:"Mandatory",maxlength:"Max Length","meta.group":"Group","meta.icon":"Ico","meta.label":"Label",minOptionMessage:"This field requires a minimum of 2 options",name:"Name",newOptionLabel:"New {type}",no:"No",number:"Number",off:"Off",on:"On","operator.contains":"contains","operator.equals":"equals","operator.notContains":"not contains","operator.notEquals":"not equal","operator.notVisible":"not visible","operator.visible":"visible",option:"Option",optional:"optional",optionEmpty:"Option value required",optionLabel:"Option {count}",options:"Options",or:"or",order:"Order","panel.label.attrs":"Attributes","panel.label.conditions":"Conditions","panel.label.config":"Configuration","panel.label.meta":"Meta","panel.label.options":"Options","panelEditButtons.attrs":"+ Attribute","panelEditButtons.conditions":"+ Condition","panelEditButtons.options":"+ Option",placeholder:"Placeholder","placeholder.className":"space separated classes","placeholder.email":"Enter you email","placeholder.label":"Label","placeholder.password":"Enter your password","placeholder.placeholder":"Placeholder","placeholder.text":"Enter some Text","placeholder.textarea":"Enter a lot of text","placeholder.value":"Value",preview:"Preview",primary:"Primary",remove:"Remove",removeMessage:"Remove Element",removeType:"Remove {type}",required:"Required",reset:"Reset",richText:"Rich Text Editor",roles:"Access",row:"Row","row.makeInputGroup":"Make this row an input group.","row.makeInputGroupDesc":"Input Groups enable users to add sets of inputs at a time.","row.settings.fieldsetWrap":"Wrap row in a &lt;fieldset&gt; tag","row.settings.fieldsetWrap.aria":"Wrap Row in Fieldset",save:"Save",secondary:"Secondary",select:"Select",selectColor:"Select Color",selectionsMessage:"Allow Multiple Selections",selectOptions:"Options",separator:"Separator",settings:"Settings",size:"Size",sizes:"Sizes","sizes.lg":"Large","sizes.m":"Default","sizes.sm":"Small","sizes.xs":"Extra Small",style:"Style",styles:"Styles","styles.btn":"Button Style","styles.btn.danger":"Danger","styles.btn.default":"Default","styles.btn.info":"Info","styles.btn.primary":"Primary","styles.btn.success":"Success","styles.btn.warning":"Warning",subtype:"Type",success:"Success",text:"Text Field",then:"Then","then.condition.target.placeholder":"target",toggle:"Toggle",ungrouped:"Un-Grouped",warning:"Warning",yes:"Yes"}},Im=Om["en-US"],nd="en-US";X.addLanguage(nd,Im);X.setCurrent(nd);const Nm={get editor(){return{stickyControls:!1,allowEdit:!0,dataType:"json",debug:!1,sessionStorage:!1,editorContainer:null,svgSprite:null,style:Of,iconFont:null,config:{},events:{},actions:{},controls:{},i18n:{location:"https://draggable.github.io/formeo/assets/lang/"},onLoad:()=>{}}}};new Nu;let id=class{constructor({formData:e,...t},n){const f=je(Nm.editor,t),{actions:d,events:g,debug:m,config:c,editorContainer:p,...r}=f;p&&(this.editorContainer=typeof p=="string"?document.querySelector(p):p),this.opts=r,V.setOptions=r,ce.config=c,this.userFormData=n||e,this.Components=ce,this.dom=V,J.init({debug:m,...g}),xe.init({debug:m,sessionStorage:r.sessionStorage,...d}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",this.loadResources.bind(this)):this.loadResources()}get formData(){return this.Components.formData}set formData(e={}){this.userFormData=Mt(e),this.load(this.userFormData,this.opts)}loadData(e={}){this.formData=e}get json(){return this.Components.json}clear(){this.userFormData=En(),this.Components.load(this.userFormData,this.opts),this.render()}async loadResources(){document.removeEventListener("DOMContentLoaded",this.loadResources);const e=[];e.push(_g(this.opts.svgSprite),Lg(this.opts.style),X.init({...this.opts.i18n,locale:globalThis.sessionStorage?.getItem(tc)})),await Promise.all(e),this.opts.allowEdit&&this.init()}init(){return Rt.init(this.opts.controls,this.opts.stickyControls).then(e=>{this.controls=e,this.load(this.userFormData,this.opts),this.formId=ce.get("id"),this.i18n={setLang:t=>{window.sessionStorage?.setItem(tc,t),X.setCurrent(t).then(()=>{this.init()},console.error)}},this.opts.onLoad?.(this)})}load(e=this.userFormData,t=this.opts){this.Components.load(e,t),this.render()}render(){if(!this.controls)return window.requestAnimationFrame(()=>this.render());if(this.stages=Object.values(ce.get("stages")),this.opts.controlOnLeft)for(const n of this.stages)n.dom.style.order=1;const e={attrs:{className:"formeo formeo-editor",id:this.formId},content:[this.stages.map(({dom:n})=>n)]};X.current.dir&&(e.attrs.dir=X.current.dir,V.dir=X.current.dir),this.editor=V.create(e),(this.controls.container||this.editor).appendChild(this.controls.dom),this.editorContainer&&(V.empty(this.editorContainer),this.editorContainer.appendChild(this.editor)),J.formeoLoaded=new globalThis.CustomEvent("formeoLoaded",{detail:{formeo:this}}),document.dispatchEvent(J.formeoLoaded)}};const pn="f-",hu=l=>typeof l=="string"?document.querySelector(l):l,Fm=({editorContainer:l,renderContainer:e,formData:t,...n})=>{const f={renderContainer:hu(e),editorContainer:hu(l),formData:Mt(t)};return{elements:{},...n,...f}},gn=l=>l.match(np)?.[0]||l,du=l=>{if(!l||l.hasAttribute("hidden")||l.parentElement.hasAttribute("hidden"))return!1;const e=window.getComputedStyle(l);return!(e.display==="none"||e.visibility==="hidden"||e.opacity==="0")},Pm={isChecked:l=>l.checked,isNotChecked:l=>!l.checked,value:l=>l.value,isVisible:l=>du(l),isNotVisible:l=>!du(l)},Hm=()=>V.btnTemplate({className:"remove-input-group",children:V.icon("remove"),action:{mouseover:({target:l})=>l.parentElement.classList.add("will-remove"),mouseleave:({target:l})=>l.parentElement.classList.remove("will-remove"),click:({target:l})=>l.parentElement.remove()}}),fu={equals:Ss,notEquals:(l,e)=>!Ss(l,e),contains:(l,e)=>l.includes(e),notContains:(l,e)=>!l.includes(e)},Wm=Object.entries(dh).reduce((l,[e,t])=>(l[t]=fu[e],l[e]=fu[e],l),{}),pu={equals:(l,{targetProperty:e,value:t})=>{l[`_${e}`]=l[e],l[e]=t}},zm=Object.entries(fh).reduce((l,[e,t])=>(l[t]=pu[e],l[e]=pu[e],l),{}),Bm={isChecked:l=>{l.checked=!0},isNotChecked:l=>{l.checked=!1},value:(l,{assignment:e,...t})=>{const n=zm[e]?.(l,t),f=new Event("input",{bubbles:!0});return l.dispatchEvent(f),n},isNotVisible:l=>{l?._required===void 0&&(l._required=l.required),l.parentElement.setAttribute("hidden",!0),l.required=!1},isVisible:l=>{l.parentElement.removeAttribute("hidden"),l.required=l._required}};let rd=class{constructor(e,t){const{renderContainer:n,elements:f,formData:d,config:g}=Fm(e);this.container=n,this.form=Mt(t||d),this.elements=f,this.config=g,this.components=Object.create(null),this.dom=V}get formData(){return this.form}set formData(e){this.form=Mt(e)}get userData(){const e=this.container.querySelector(".formeo-render")||this.renderedForm;if(!e)return{};const t=new FormData(e),n={};for(const[f,d]of t.entries())n[f]?Array.isArray(n[f])?n[f].push(d):n[f]=[n[f],d]:n[f]=d;return n}get userFormData(){const e=[];for(const[t,n]of Object.entries(this.userData)){const f={key:t,value:n,label:this.components[gn(t)]?.config?.label||""};e.push(f)}return e}set userData(e={}){const t=this.container.querySelector("form");for(const n of Object.keys(e)){const f=t.elements[n];if(f.length&&f[0].type==="checkbox"){const d=Array.isArray(e[n])?e[n]:[e[n]];for(const g of f)g.checked=d.includes(g.value)}else if(f.length&&f[0].type==="radio")for(const d of f)d.checked=d.value===e[n];else f.type&&(f.value=e[n])}}render(e=this.form){this.form=Mt(e);const t=this.getRenderedForm(e),n=this.container.querySelector(".formeo-render");n?n.replaceWith(t):this.container.appendChild(t)}getRenderedForm(e=this.form){this.form=Mt(e);const t=document.getElementsByClassName("formeo-render").length,n={...this.config,tag:"form",id:this.form.id,className:`formeo-render formeo formeo-rendered-${t}`,children:this.processedData};return this.renderedForm=V.render(n),this.applyConditions(),this.renderedForm}get html(){return(this.renderedForm||this.getRenderedForm()).outerHTML}orderChildren=(e,t)=>t.reduce((n,f)=>(n.push(this.form[e][f]),n),[]);prefixId=e=>pn+e;processColumn=({id:e,...t})=>({...t,id:this.prefixId(e),children:this.processFields(t.children),style:`width: ${t.config.width||"100%"}`});processRows=e=>this.orderChildren("rows",this.form.stages[e].children).reduce((t,n)=>(n&&t.push(this.processRow(n)),t),[]);cacheComponent=e=>(this.components[gn(e.id)]=e,e);processRow=(e,t="row")=>{const{config:n,id:f}=e,d=[`formeo-${t}-wrap`],g={...e,children:this.processColumns(e.id),id:this.prefixId(f)};this.cacheComponent(g);const c=[{condition:n.legend,result:()=>({tag:n.fieldset?"legend":"h3",children:n.legend})},{condition:!0,result:()=>g},{condition:n.inputGroup,result:()=>this.addButton(f)}].reduce((p,{condition:r,result:o})=>(r&&p.push(o()),p),[]);return n.inputGroup&&d.push(`${pn}input-group-wrap`),{tag:n.fieldset?"fieldset":"div",className:d,children:c}};cloneComponentData=e=>{const{children:t=[],id:n,attrs:f={},...d}=this.components[e],g={...f,"data-clone-of":n};return d.tag==="input"&&(g.name=zh(this.components[e])),{...d,id:pn+He(n),children:t?.length&&t.map(({id:m})=>this.cloneComponentData(gn(m))),attrs:g}};addButton=e=>({tag:"button",attrs:{className:"add-input-group btn pull-right",type:"button"},children:"Add +",action:{click:t=>{const n=t.target.parentElement,f=V.create(this.cloneComponentData(e));n.insertBefore(f,n.lastChild);const d=V.create(Hm());f.appendChild(d)}}});processColumns=e=>this.orderChildren("columns",this.form.rows[e].children).map(t=>this.cacheComponent(this.processColumn(t)));processFields=e=>this.orderChildren("fields",e).map(({id:t,...n})=>{const f=n.config?.controlId||n.meta?.id,{action:d={},dependencies:g={}}=this.elements[f]||{};g&&Wh(g);const m=je({action:d},n);return this.cacheComponent({...m,id:this.prefixId(t)})});get processedData(){return Object.values(this.form.stages).map(e=>(e.children=this.processRows(e.id),e.className=Ot,this.components[gn(e.id)]=e,e))}handleComponentCondition=(e,t,n)=>{if(e.length){for(const g of e)this.handleComponentCondition(g,t,n);return}const f=Vm(e);f&&e.addEventListener(f,g=>{if(this.evaluateCondition(t,g))for(const m of n)this.execResult(m,g)},!1);const d={target:e};if(this.evaluateCondition(t,d))for(const g of n)this.execResult(g,d)};applyConditions=()=>{for(const{conditions:e}of Object.values(this.components))if(e)for(const t of e){const{if:n,then:f}=t;for(const d of n){const{source:g,target:m}=d;if(Pe(g)){const{component:c,options:p}=this.getComponent(g),r=p||c;this.handleComponentCondition(r,d,f)}if(Pe(m)){const{component:c,options:p}=this.getComponent(m),r=p||c;this.handleComponentCondition(r,d,f)}}}};evaluateCondition=({source:e,sourceProperty:t,targetProperty:n,comparison:f,target:d})=>{const g=this.getComponentProperty(e,t);if(typeof g=="boolean")return g;const m=String(Pe(d)?this.getComponentProperty(d,n):d);return Wm[f]?.(g,m)};execResult=({target:e,targetProperty:t,assignment:n,value:f})=>{if(Pe(e)){const{component:d,option:g}=this.getComponent(e),m=g||d;Bm[t]?.(m,{targetProperty:t,assignment:n,value:f})}};getComponentProperty=(e,t)=>{const{component:n,option:f}=this.getComponent(e),d=f||n;return Pm[t]?.(d)||d[t]};getComponent=e=>{const t={component:null};if(!Pe(e))return null;const[,n,f,d]=vt(e),g=this.renderedForm.querySelector(`#${pn}${n}`);if(!g)return t;if(t.component=g,f){const m=g.querySelectorAll("input"),c=m[d];return t.options=m,t.option=c,t}return t};getComponents=e=>{const t=[],n=e.slice(e.indexOf(".")+1);return t.push(...this.renderedForm.querySelectorAll(`[name=f-${n}]`)),t}};const jm=[["input",l=>["textarea","text"].includes(l.type)],["change",l=>["select"].includes(l.tagName.toLowerCase())||["checkbox","radio"].includes(l.type)]],Vm=l=>{const[e]=jm.find(t=>t[1](l))||[!1];return e};window!==void 0&&(window.FormeoEditor=id,window.FormeoRenderer=rd);const ia=id,ra=rd,Um={rows:{all:{events:{onAdd:l=>{if(console.log(`You just added a new row with the id "${l.target.id}"`,l.index),l.index===2){const e=l.target.dom.querySelector(".action-btn-wrap"),t=document.createElement("button");t.type="button",t.className="btn btn-sm btn-secondary",t.textContent="Add Column",t.style.border="1px solid #ccc",t.style.width="auto",t.addEventListener("click",()=>{l.target.addChild()}),e.appendChild(t)}}}}},fields:{all:{events:{onRemove:l=>{console.log(`You just removed the field with the id "${l.target.id}"`,l)}}},checkbox:{actionButtons:{},panels:{attrs:{hideDisabled:!0}}}}},Gm={sortable:!1,groupOrder:["common","html"],disable:{},elements:[{tag:"input",config:{label:"Email",disabledAttrs:["type"],lockedAttrs:["required","className"]},meta:{group:"common",id:"email",icon:"@"},attrs:{className:"custom-email",type:"email",required:!0}}],elementOrder:{common:["button","checkbox","date-input","hidden","upload","number","radio","select","text-input","textarea"]}},qm=".build-form",Km=".render-form",tn={editorContainer:qm,actions:{},controls:Gm,config:Um,events:{onSave:console.log,onChange:console.log},sessionStorage:!0,editPanelOrder:["attrs","options"],onLoad:()=>{console.log("demo loaded")}},oa={renderContainer:Km,elements:{tinymce:{action:{onRender:l=>{if(l.id){const e=`#${l.id}`;window.tinymce.remove(e),window.tinymce.init({selector:e})}}}}}};async function Ym(l){l.innerHTML=`
  ...
  `;try{await Zm(),await Xm()&&console.log("Highlight.js loaded successfully"),l.innerHTML=`
      <div class="angular-demo">
        <h3>Angular Integration Demo</h3>
...
npm install formeo</code></pre>
          ...
          <div class="guide-section">
            ...
            <pre><code class="language-typescript">${Yo(ev)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>3. Service for Formeo Management (Optional)</h4>
            <pre><code class="language-typescript">${Yo(tv)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>4. Module Configuration</h4>
            <pre><code class="language-typescript">${Yo(nv)}</code></pre>
          </div>
        </div>
    ...
    `;const t=await Jm();gu();const n=l.querySelector("#toggle-instructions"),f=l.querySelector("#instructions-section"),d=n.querySelector(".toggle-text"),g=n.querySelector(".toggle-icon");return n&&f&&n.addEventListener("click",()=>{const m=f.style.display==="block";f.style.display=m?"none":"block",d.textContent=m?"Show Implementation Guide":"Hide Implementation Guide",g.textContent=m?"▼":"▲",m||setTimeout(()=>gu(),50)}),{angularApp:t,cleanup:()=>{t?.destroy&&t.destroy();const m=document.getElementById("angular-app-root");m&&(m.innerHTML="")}}}catch(e){return console.error("Failed to load Angular demo:",e),l.innerHTML=`
      <div class="angular-demo">
        <h3>Angular Integration Demo</h3>
    ...
    `,{cleanup:()=>{}}}}async function Zm(){await new Promise(l=>setTimeout(l,500)),console.log("Angular-style demo environment ready")}async function Xm(){if(window.hljs)return window.hljs;try{const l=document.createElement("link");return l.rel="stylesheet",l.href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css",document.head.appendChild(l),Qm(),await Ko("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"),await Ko("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/typescript.min.js"),await Ko("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/bash.min.js"),window.hljs}catch(l){return console.warn("Failed to load Highlight.js:",l),null}}function Qm(){const l=document.createElement("style");l.textContent=`
  ...
  `;const e=l.querySelector(".angular-form-editor"),t=l.querySelector(".angular-form-renderer");if(e&&t){const n=document.createElement("form");n.className="build-form-angular-real";const f=document.createElement("div");f.className="render-form-angular-real",e.appendChild(n),t.appendChild(f);const d={...tn,editorContainer:".build-form-angular-real",events:{...tn.events,onSave:s=>{console.log("Angular Component - Form saved:",s)},onChange:s=>{console.log("Angular Component - Form changed:",s)}}},g={...oa,renderContainer:".render-form-angular-real"},m=new ia(d),c=new ra(g),p=l.querySelector("#angular-save-btn"),r=l.querySelector("#angular-render-btn"),o=l.querySelector("#angular-clear-btn");return p&&p.addEventListener("click",()=>{const s=m.formData;console.log("Angular Component - Save clicked:",s),alert("Form saved! Check console for form data.")}),r&&r.addEventListener("click",()=>{const s=m.formData;s&&Object.keys(s).length>0?(f.style.display="block",c.render(s),console.log("Angular Component - Render clicked:",s)):alert("Please create a form first before rendering")}),o&&o.addEventListener("click",()=>{m&&m.clear(),c&&f&&(f.innerHTML="",f.style.display="none"),console.log("Angular Component - Clear clicked")}),{editor:m,renderer:c,destroy:()=>{m?.destroy&&m.destroy(),c?.destroy&&c.destroy()}}}return null}function Yo(l){const e=document.createElement("div");return e.textContent=l,e.innerHTML}const ev=`import { Component, OnInit, OnDestroy, ElementRef, ViewChild, inject } from '@angular/core';
...
}`,tv=`import { Injectable, signal } from '@angular/core';
import { FormeoEditor, FormeoRenderer } from 'formeo';
...
}`,nv=`// app.config.ts (for standalone applications)
...
bootstrapApplication(AppComponent, appConfig)
  .catch(err => console.error(err));`;async function iv(l){l.innerHTML=`
  ...
  `;try{await rv(),await ov()&&console.log("Highlight.js loaded successfully for React demo"),l.innerHTML=`
      <div class="react-demo">
        <h3>React Integration Demo</h3>
        <div class="demo-description">
...
npm install --save-dev @types/react @types/react-dom typescript</code></pre>
          ...
          <div class="guide-section">
            ...
            <pre><code class="language-typescript">${Xo(lv)}</code></pre>
          </div>
          
          <div class="guide-section">
            <h4>3. React Component Implementation</h4>
            <pre><code class="language-typescript">${Xo(cv)}</code></pre>
          </div>
          
          <div class="guide-section">
            <h4>4. Context Provider (Advanced)</h4>
            <pre><code class="language-typescript">${Xo(uv)}</code></pre>
          </div>
        </div>
    ...
    `,{cleanup:()=>{}}}}async function rv(){await new Promise(l=>setTimeout(l,500)),console.log("React-style demo environment ready")}async function ov(){if(window.hljs)return window.hljs;try{const l=document.createElement("link");return l.rel="stylesheet",l.href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css",document.head.appendChild(l),sv(),await Zo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"),await Zo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/typescript.min.js"),await Zo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/bash.min.js"),window.hljs}catch(l){return console.warn("Failed to load Highlight.js:",l),null}}function sv(){const l=document.createElement("style");l.textContent=`
  ...
  `;const e=l.querySelector(".react-form-editor"),t=l.querySelector(".react-form-renderer");if(e&&t){const n=document.createElement("form");n.className="build-form-react-real";const f=document.createElement("div");f.className="render-form-react-real",e.appendChild(n),t.appendChild(f);const d={...tn,editorContainer:".build-form-react-real",events:{...tn.events,onSave:a=>{console.log("React Component - Form saved:",a)},onChange:a=>{console.log("React Component - Form changed:",a)}}},g={...oa,renderContainer:".render-form-react-real"},m=new ia(d),c=new ra(g),p=l.querySelector("#react-save-btn"),r=l.querySelector("#react-render-btn"),o=l.querySelector("#react-clear-btn"),s=l.querySelector("#react-export-btn");return p&&p.addEventListener("click",()=>{const a=m.formData;console.log("React Component - Save clicked:",a),localStorage.setItem("formeo-react-form",JSON.stringify(a)),alert("Form saved! Check console for form data.")}),r&&r.addEventListener("click",()=>{const a=m.formData;a&&Object.keys(a).length>0?(f.style.display="block",c.render(a),console.log("React Component - Render clicked:",a)):alert("Please create a form first before rendering")}),o&&o.addEventListener("click",()=>{m?.clear(),f.style.display="none",localStorage.removeItem("formeo-react-form"),console.log("React Component - Clear clicked")}),s&&s.addEventListener("click",()=>{const a=m.formData;if(a&&Object.keys(a).length>0){const i=new Blob([JSON.stringify(a,null,2)],{type:"application/json"}),u=URL.createObjectURL(i),h=document.createElement("a");h.href=u,h.download="formeo-react-form.json",h.click(),URL.revokeObjectURL(u),console.log("React Component - Export clicked")}else alert("Please create a form first before exporting")}),console.log(m),{editor:m,renderer:c,cleanup:()=>{m?.destroy&&m.destroy(),c?.destroy&&c.destroy()}}}return null}function Xo(l){const e=document.createElement("div");return e.textContent=l,e.innerHTML}const lv=`import { useEffect, useRef, useCallback } from 'react';
import { FormeoEditor, FormeoRenderer } from 'formeo';
...
}`,cv=`import React, { useState } from 'react';
...
}`,uv=`import React, { createContext, useContext, useReducer, useCallback } from 'react';
import { FormeoEditor, FormeoRenderer } from 'formeo';
...
};`;var Qo={exports:{}},vu;function hv(){return vu||(vu=1,(function(l,e){(function(){var t="ace",n=(function(){return this})();!n&&typeof window<"u"&&(n=window);var f=function(r,o,s){if(typeof r!="string"){f.original?f.original.apply(this,arguments):(console.error("dropping module because define wasn't a string."),console.trace());return}arguments.length==2&&(s=o),f.modules[r]||(f.payloads[r]=s,f.modules[r]=null)};f.modules={},f.payloads={};var d=function(r,o,s){if(typeof o=="string"){var a=c(r,o);if(a!=null)return s&&s(),a}else if(Object.prototype.toString.call(o)==="[object Array]"){for(var i=[],u=0,h=o.length;u<h;++u){var y=c(r,o[u]);if(y==null&&g.original)return;i.push(y)}return s&&s.apply(null,i)||!0}},g=function(r,o){var s=d("",r,o);return s==null&&g.original?g.original.apply(this,arguments):s},m=function(r,o){if(o.indexOf("!")!==-1){var s=o.split("!");return m(r,s[0])+"!"+m(r,s[1])}if(o.charAt(0)=="."){var a=r.split("/").slice(0,-1).join("/");for(o=a+"/"+o;o.indexOf(".")!==-1&&i!=o;){var i=o;o=o.replace(/\/\.\//,"/").replace(/[^\/]+\/\.\.\//,"")}}return o},c=function(r,o){o=m(r,o);var s=f.modules[o];if(!s){if(s=f.payloads[o],typeof s=="function"){var a={},i={id:o,uri:"",exports:a,packaged:!0},u=function(y,w){return d(o,y,w)},h=s(u,a,i);a=h||i.exports,f.modules[o]=a,delete f.payloads[o]}s=f.modules[o]=a||s}return s};function p(r){var o=n;n[r]||(n[r]={}),o=n[r],(!o.define||!o.define.packaged)&&(f.original=o.define,o.define=f,o.define.packaged=!0),(!o.require||!o.require.packaged)&&(g.original=o.require,o.require=g,o.require.packaged=!0)}p(t)})(),ace.define("ace/lib/es6-shim",["require","exports","module"],function(t,n,f){function d(g,m,c){Object.defineProperty(g,m,{value:c,enumerable:!1,writable:!0,configurable:!0})}String.prototype.startsWith||d(String.prototype,"startsWith",function(g,m){return m=m||0,this.lastIndexOf(g,m)===m}),String.prototype.endsWith||d(String.prototype,"endsWith",function(g,m){var c=this;(m===void 0||m>c.length)&&(m=c.length),m-=g.length;var p=c.indexOf(g,m);return p!==-1&&p===m}),String.prototype.repeat||d(String.prototype,"repeat",function(g){for(var m="",c=this;g>0;)g&1&&(m+=c),(g>>=1)&&(c+=c);return m}),String.prototype.includes||d(String.prototype,"includes",function(g,m){return this.indexOf(g,m)!=-1}),Object.assign||(Object.assign=function(g){if(g==null)throw new TypeError("Cannot convert undefined or null to object");for(var m=Object(g),c=1;c<arguments.length;c++){var p=arguments[c];p!=null&&Object.keys(p).forEach(function(r){m[r]=p[r]})}return m}),Object.values||(Object.values=function(g){return Object.keys(g).map(function(m){return g[m]})}),Array.prototype.find||d(Array.prototype,"find",function(g){for(var m=this.length,c=arguments[1],p=0;p<m;p++){var r=this[p];if(g.call(c,r,p,this))return r}}),Array.prototype.findIndex||d(Array.prototype,"findIndex",function(g){for(var m=this.length,c=arguments[1],p=0;p<m;p++){var r=this[p];if(g.call(c,r,p,this))return p}}),Array.prototype.includes||d(Array.prototype,"includes",function(g,m){return this.indexOf(g,m)!=-1}),Array.prototype.fill||d(Array.prototype,"fill",function(g){for(var m=this,c=m.length>>>0,p=arguments[1],r=p>>0,o=r<0?Math.max(c+r,0):Math.min(r,c),s=arguments[2],a=s===void 0?c:s>>0,i=a<0?Math.max(c+a,0):Math.min(a,c);o<i;)m[o]=g,o++;return m}),Array.of||d(Array,"of",function(){return Array.prototype.slice.call(arguments)})}),ace.define("ace/lib/fixoldbrowsers",["require","exports","module","ace/lib/es6-shim"],function(t,n,f){t("./es6-shim")}),ace.define("ace/lib/deep_copy",["require","exports","module"],function(t,n,f){n.deepCopy=function d(g){if(typeof g!="object"||!g)return g;var m;if(Array.isArray(g)){m=[];for(var c=0;c<g.length;c++)m[c]=d(g[c]);return m}if(Object.prototype.toString.call(g)!=="[object Object]")return g;m={};for(var c in g)m[c]=d(g[c]);return m}}),ace.define("ace/lib/lang",["require","exports","module","ace/lib/deep_copy"],function(t,n,f){n.last=function(m){return m[m.length-1]},n.stringReverse=function(m){return m.split("").reverse().join("")},n.stringRepeat=function(m,c){for(var p="";c>0;)c&1&&(p+=m),(c>>=1)&&(m+=m);return p};var d=/^\s\s*/,g=/\s\s*$/;n.stringTrimLeft=function(m){return m.replace(d,"")},n.stringTrimRight=function(m){return m.replace(g,"")},n.copyObject=function(m){var c={};for(var p in m)c[p]=m[p];return c},n.copyArray=function(m){for(var c=[],p=0,r=m.length;p<r;p++)m[p]&&typeof m[p]=="object"?c[p]=this.copyObject(m[p]):c[p]=m[p];return c},n.deepCopy=t("./deep_copy").deepCopy,n.arrayToMap=function(m){for(var c={},p=0;p<m.length;p++)c[m[p]]=1;return c},n.createMap=function(m){var c=Object.create(null);for(var p in m)c[p]=m[p];return c},n.arrayRemove=function(m,c){for(var p=0;p<=m.length;p++)c===m[p]&&m.splice(p,1)},n.escapeRegExp=function(m){return m.replace(/([.*+?^${}()|[\]\/\\])/g,"\\$1")},n.escapeHTML=function(m){return(""+m).replace(/&/g,"&#38;").replace(/"/g,"&#34;").replace(/'/g,"&#39;").replace(/</g,"&#60;")},n.getMatchOffsets=function(m,c){var p=[];return m.replace(c,function(r){p.push({offset:arguments[arguments.length-2],length:r.length})}),p},n.deferredCall=function(m){var c=null,p=function(){c=null,m()},r=function(o){return r.cancel(),c=setTimeout(p,o||0),r};return r.schedule=r,r.call=function(){return this.cancel(),m(),r},r.cancel=function(){return clearTimeout(c),c=null,r},r.isPending=function(){return c},r},n.delayedCall=function(m,c){var p=null,r=function(){p=null,m()},o=function(s){p==null&&(p=setTimeout(r,s||c))};return o.delay=function(s){p&&clearTimeout(p),p=setTimeout(r,s||c)},o.schedule=o,o.call=function(){this.cancel(),m()},o.cancel=function(){p&&clearTimeout(p),p=null},o.isPending=function(){return p},o},n.supportsLookbehind=function(){try{new RegExp("(?<=.)")}catch{return!1}return!0},n.skipEmptyMatch=function(m,c,p){return p&&m.codePointAt(c)>65535?2:1}}),ace.define("ace/lib/useragent",["require","exports","module"],function(t,n,f){n.OS={LINUX:"LINUX",MAC:"MAC",WINDOWS:"WINDOWS"},n.getOS=function(){return n.isMac?n.OS.MAC:n.isLinux?n.OS.LINUX:n.OS.WINDOWS};var d=typeof navigator=="object"?navigator:{},g=(/mac|win|linux/i.exec(d.platform)||["other"])[0].toLowerCase(),m=d.userAgent||"",c=d.appName||"";n.isWin=g=="win",n.isMac=g=="mac",n.isLinux=g=="linux",n.isIE=c=="Microsoft Internet Explorer"||c.indexOf("MSAppHost")>=0?parseFloat((m.match(/(?:MSIE |Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/)||[])[1]):parseFloat((m.match(/(?:Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/)||[])[1]),n.isOldIE=n.isIE&&n.isIE<9,n.isGecko=n.isMozilla=m.match(/ Gecko\/\d+/),n.isOpera=typeof opera=="object"&&Object.prototype.toString.call(window.opera)=="[object Opera]",n.isWebKit=parseFloat(m.split("WebKit/")[1])||void 0,n.isChrome=parseFloat(m.split(" Chrome/")[1])||void 0,n.isSafari=parseFloat(m.split(" Safari/")[1])&&!n.isChrome||void 0,n.isEdge=parseFloat(m.split(" Edge/")[1])||void 0,n.isAIR=m.indexOf("AdobeAIR")>=0,n.isAndroid=m.indexOf("Android")>=0,n.isChromeOS=m.indexOf(" CrOS ")>=0,n.isIOS=/iPad|iPhone|iPod/.test(m)&&!window.MSStream,n.isIOS&&(n.isMac=!0),n.isMobile=n.isIOS||n.isAndroid}),ace.define("ace/lib/dom",["require","exports","module","ace/lib/useragent"],function(t,n,f){var d=t("./useragent"),g="http://www.w3.org/1999/xhtml";n.buildDom=function s(a,i,u){if(typeof a=="string"&&a){var h=document.createTextNode(a);return i&&i.appendChild(h),h}if(!Array.isArray(a))return a&&a.appendChild&&i&&i.appendChild(a),a;if(typeof a[0]!="string"||!a[0]){for(var y=[],w=0;w<a.length;w++){var x=s(a[w],i,u);x&&y.push(x)}return y}var $=document.createElement(a[0]),A=a[1],S=1;A&&typeof A=="object"&&!Array.isArray(A)&&(S=2);for(var w=S;w<a.length;w++)s(a[w],$,u);return S==2&&Object.keys(A).forEach(function(E){var R=A[E];E==="class"?$.className=Array.isArray(R)?R.join(" "):R:typeof R=="function"||E=="value"||E[0]=="$"?$[E]=R:E==="ref"?u&&(u[R]=$):E==="style"?typeof R=="string"&&($.style.cssText=R):R!=null&&$.setAttribute(E,R)}),i&&i.appendChild($),$},n.getDocumentHead=function(s){return s||(s=document),s.head||s.getElementsByTagName("head")[0]||s.documentElement},n.createElement=function(s,a){return document.createElementNS?document.createElementNS(a||g,s):document.createElement(s)},n.removeChildren=function(s){s.innerHTML=""},n.createTextNode=function(s,a){var i=a?a.ownerDocument:document;return i.createTextNode(s)},n.createFragment=function(s){var a=s?s.ownerDocument:document;return a.createDocumentFragment()},n.hasCssClass=function(s,a){var i=(s.className+"").split(/\s+/g);return i.indexOf(a)!==-1},n.addCssClass=function(s,a){n.hasCssClass(s,a)||(s.className+=" "+a)},n.removeCssClass=function(s,a){for(var i=s.className.split(/\s+/g);;){var u=i.indexOf(a);if(u==-1)break;i.splice(u,1)}s.className=i.join(" ")},n.toggleCssClass=function(s,a){for(var i=s.className.split(/\s+/g),u=!0;;){var h=i.indexOf(a);if(h==-1)break;u=!1,i.splice(h,1)}return u&&i.push(a),s.className=i.join(" "),u},n.setCssClass=function(s,a,i){i?n.addCssClass(s,a):n.removeCssClass(s,a)},n.hasCssString=function(s,a){var i=0,u;if(a=a||document,u=a.querySelectorAll("style")){for(;i<u.length;)if(u[i++].id===s)return!0}},n.removeElementById=function(s,a){a=a||document,a.getElementById(s)&&a.getElementById(s).remove()};var m,c=[];n.useStrictCSP=function(s){m=s,s==!1?p():c||(c=[])};function p(){var s=c;c=null,s&&s.forEach(function(a){r(a[0],a[1])})}function r(s,a,i){if(!(typeof document>"u")){if(c){if(i)p();else if(i===!1)return c.push([s,a])}if(!m){var u=i;!i||!i.getRootNode?u=document:(u=i.getRootNode(),(!u||u==i)&&(u=document));var h=u.ownerDocument||u;if(a&&n.hasCssString(a,u))return null;a&&(s+=`
/*# sourceURL=ace/css/`+a+" */");var y=n.createElement("style");y.appendChild(h.createTextNode(s)),a&&(y.id=a),u==h&&(u=n.getDocumentHead(h)),u.insertBefore(y,u.firstChild)}}}if(n.importCssString=r,n.importCssStylsheet=function(s,a){n.buildDom(["link",{rel:"stylesheet",href:s}],n.getDocumentHead(a))},n.scrollbarWidth=function(s){var a=n.createElement("ace_inner");a.style.width="100%",a.style.minWidth="0px",a.style.height="200px",a.style.display="block";var i=n.createElement("ace_outer"),u=i.style;u.position="absolute",u.left="-10000px",u.overflow="hidden",u.width="200px",u.minWidth="0px",u.height="150px",u.display="block",i.appendChild(a);var h=s&&s.documentElement||document&&document.documentElement;if(!h)return 0;h.appendChild(i);var y=a.offsetWidth;u.overflow="scroll";var w=a.offsetWidth;return y===w&&(w=i.clientWidth),h.removeChild(i),y-w},n.computedStyle=function(s,a){return window.getComputedStyle(s,"")||{}},n.setStyle=function(s,a,i){s[a]!==i&&(s[a]=i)},n.HAS_CSS_ANIMATION=!1,n.HAS_CSS_TRANSFORMS=!1,n.HI_DPI=d.isWin?typeof window<"u"&&window.devicePixelRatio>=1.5:!0,d.isChromeOS&&(n.HI_DPI=!1),typeof document<"u"){var o=document.createElement("div");n.HI_DPI&&o.style.transform!==void 0&&(n.HAS_CSS_TRANSFORMS=!0),!d.isEdge&&typeof o.style.animationName<"u"&&(n.HAS_CSS_ANIMATION=!0),o=null}n.HAS_CSS_TRANSFORMS?n.translate=function(s,a,i){s.style.transform="translate("+Math.round(a)+"px, "+Math.round(i)+"px)"}:n.translate=function(s,a,i){s.style.top=Math.round(i)+"px",s.style.left=Math.round(a)+"px"}}),ace.define("ace/lib/net",["require","exports","module","ace/lib/dom"],function(t,n,f){var d=t("./dom");n.get=function(g,m){var c=new XMLHttpRequest;c.open("GET",g,!0),c.onreadystatechange=function(){c.readyState===4&&m(c.responseText)},c.send(null)},n.loadScript=function(g,m){var c=d.getDocumentHead(),p=document.createElement("script");p.src=g,c.appendChild(p),p.onload=p.onreadystatechange=function(r,o){(o||!p.readyState||p.readyState=="loaded"||p.readyState=="complete")&&(p=p.onload=p.onreadystatechange=null,o||m())}},n.qualifyURL=function(g){var m=document.createElement("a");return m.href=g,m.href}}),ace.define("ace/lib/oop",["require","exports","module"],function(t,n,f){n.inherits=function(d,g){d.super_=g,d.prototype=Object.create(g.prototype,{constructor:{value:d,enumerable:!1,writable:!0,configurable:!0}})},n.mixin=function(d,g){for(var m in g)d[m]=g[m];return d},n.implement=function(d,g){n.mixin(d,g)}}),ace.define("ace/lib/event_emitter",["require","exports","module"],function(t,n,f){var d={},g=function(){this.propagationStopped=!0},m=function(){this.defaultPrevented=!0};d._emit=d._dispatchEvent=function(c,p){this._eventRegistry||(this._eventRegistry={}),this._defaultHandlers||(this._defaultHandlers={});var r=this._eventRegistry[c]||[],o=this._defaultHandlers[c];if(!(!r.length&&!o)){(typeof p!="object"||!p)&&(p={}),p.type||(p.type=c),p.stopPropagation||(p.stopPropagation=g),p.preventDefault||(p.preventDefault=m),r=r.slice();for(var s=0;s<r.length&&(r[s](p,this),!p.propagationStopped);s++);if(o&&!p.defaultPrevented)return o(p,this)}},d._signal=function(c,p){var r=(this._eventRegistry||{})[c];if(r){r=r.slice();for(var o=0;o<r.length;o++)r[o](p,this)}},d.once=function(c,p){var r=this;if(this.on(c,function o(){r.off(c,o),p.apply(null,arguments)}),!p)return new Promise(function(o){p=o})},d.setDefaultHandler=function(c,p){var r=this._defaultHandlers;if(r||(r=this._defaultHandlers={_disabled_:{}}),r[c]){var o=r[c],s=r._disabled_[c];s||(r._disabled_[c]=s=[]),s.push(o);var a=s.indexOf(p);a!=-1&&s.splice(a,1)}r[c]=p},d.removeDefaultHandler=function(c,p){var r=this._defaultHandlers;if(r){var o=r._disabled_[c];if(r[c]==p)o&&this.setDefaultHandler(c,o.pop());else if(o){var s=o.indexOf(p);s!=-1&&o.splice(s,1)}}},d.on=d.addEventListener=function(c,p,r){this._eventRegistry=this._eventRegistry||{};var o=this._eventRegistry[c];return o||(o=this._eventRegistry[c]=[]),o.indexOf(p)==-1&&o[r?"unshift":"push"](p),p},d.off=d.removeListener=d.removeEventListener=function(c,p){this._eventRegistry=this._eventRegistry||{};var r=this._eventRegistry[c];if(r){var o=r.indexOf(p);o!==-1&&r.splice(o,1)}},d.removeAllListeners=function(c){c||(this._eventRegistry=this._defaultHandlers=void 0),this._eventRegistry&&(this._eventRegistry[c]=void 0),this._defaultHandlers&&(this._defaultHandlers[c]=void 0)},n.EventEmitter=d}),ace.define("ace/lib/report_error",["require","exports","module"],function(t,n,f){n.reportError=function(g,m){var c=new Error(g);c.data=m,typeof console=="object"&&console.error&&console.error(c),setTimeout(function(){throw c})}}),ace.define("ace/lib/default_english_messages",["require","exports","module"],function(t,n,f){var d={"autocomplete.popup.aria-roledescription":"Autocomplete suggestions","autocomplete.popup.aria-label":"Autocomplete suggestions","autocomplete.popup.item.aria-roledescription":"item","autocomplete.loading":"Loading...","editor.scroller.aria-roledescription":"editor","editor.scroller.aria-label":"Editor content, press Enter to start editing, press Escape to exit","editor.gutter.aria-roledescription":"editor","editor.gutter.aria-label":"Editor gutter, press Enter to interact with controls using arrow keys, press Escape to exit","error-marker.good-state":"Looks good!","prompt.recently-used":"Recently used","prompt.other-commands":"Other commands","prompt.no-matching-commands":"No matching commands","search-box.find.placeholder":"Search for","search-box.find-all.text":"All","search-box.replace.placeholder":"Replace with","search-box.replace-next.text":"Replace","search-box.replace-all.text":"All","search-box.toggle-replace.title":"Toggle Replace mode","search-box.toggle-regexp.title":"RegExp Search","search-box.toggle-case.title":"CaseSensitive Search","search-box.toggle-whole-word.title":"Whole Word Search","search-box.toggle-in-selection.title":"Search In Selection","search-box.search-counter":"$0 of $1","text-input.aria-roledescription":"editor","text-input.aria-label":"Cursor at row $0","gutter.code-folding.range.aria-label":"Toggle code folding, rows $0 through $1","gutter.code-folding.closed.aria-label":"Toggle code folding, rows $0 through $1","gutter.code-folding.open.aria-label":"Toggle code folding, row $0","gutter.code-folding.closed.title":"Unfold code","gutter.code-folding.open.title":"Fold code","gutter.annotation.aria-label.error":"Error, read annotations row $0","gutter.annotation.aria-label.warning":"Warning, read annotations row $0","gutter.annotation.aria-label.info":"Info, read annotations row $0","inline-fold.closed.title":"Unfold code","gutter-tooltip.aria-label.error.singular":"error","gutter-tooltip.aria-label.error.plural":"errors","gutter-tooltip.aria-label.warning.singular":"warning","gutter-tooltip.aria-label.warning.plural":"warnings","gutter-tooltip.aria-label.info.singular":"information message","gutter-tooltip.aria-label.info.plural":"information messages","gutter.annotation.aria-label.security":"Security finding, read annotations row $0","gutter.annotation.aria-label.hint":"Suggestion, read annotations row $0","gutter-tooltip.aria-label.security.singular":"security finding","gutter-tooltip.aria-label.security.plural":"security findings","gutter-tooltip.aria-label.hint.singular":"suggestion","gutter-tooltip.aria-label.hint.plural":"suggestions"};n.defaultEnglishMessages=d}),ace.define("ace/lib/app_config",["require","exports","module","ace/lib/oop","ace/lib/event_emitter","ace/lib/report_error","ace/lib/default_english_messages"],function(t,n,f){"no use strict";var d=t("./oop"),g=t("./event_emitter").EventEmitter,m=t("./report_error").reportError,c=t("./default_english_messages").defaultEnglishMessages,p={setOptions:function(i){Object.keys(i).forEach(function(u){this.setOption(u,i[u])},this)},getOptions:function(i){var u={};if(i)Array.isArray(i)||(u=i,i=Object.keys(u));else{var h=this.$options;i=Object.keys(h).filter(function(y){return!h[y].hidden})}return i.forEach(function(y){u[y]=this.getOption(y)},this),u},setOption:function(i,u){if(this["$"+i]!==u){var h=this.$options[i];if(!h)return r('misspelled option "'+i+'"');if(h.forwardTo)return this[h.forwardTo]&&this[h.forwardTo].setOption(i,u);h.handlesSet||(this["$"+i]=u),h&&h.set&&h.set.call(this,u)}},getOption:function(i){var u=this.$options[i];return u?u.forwardTo?this[u.forwardTo]&&this[u.forwardTo].getOption(i):u&&u.get?u.get.call(this):this["$"+i]:r('misspelled option "'+i+'"')}};function r(i){typeof console<"u"&&console.warn&&console.warn.apply(console,arguments)}var o,s,a=(function(){function i(){this.$defaultOptions={},o=c,s="dollarSigns"}return i.prototype.defineOptions=function(u,h,y){return u.$options||(this.$defaultOptions[h]=u.$options={}),Object.keys(y).forEach(function(w){var x=y[w];typeof x=="string"&&(x={forwardTo:x}),x.name||(x.name=w),u.$options[x.name]=x,"initialValue"in x&&(u["$"+x.name]=x.initialValue)}),d.implement(u,p),this},i.prototype.resetOptions=function(u){Object.keys(u.$options).forEach(function(h){var y=u.$options[h];"value"in y&&u.setOption(h,y.value)})},i.prototype.setDefaultValue=function(u,h,y){if(!u){for(u in this.$defaultOptions)if(this.$defaultOptions[u][h])break;if(!this.$defaultOptions[u][h])return!1}var w=this.$defaultOptions[u]||(this.$defaultOptions[u]={});w[h]&&(w.forwardTo?this.setDefaultValue(w.forwardTo,h,y):w[h].value=y)},i.prototype.setDefaultValues=function(u,h){Object.keys(h).forEach(function(y){this.setDefaultValue(u,y,h[y])},this)},i.prototype.setMessages=function(u,h){o=u,h&&h.placeholders&&(s=h.placeholders)},i.prototype.nls=function(u,h,y){o[u]||(r("No message found for the key '"+u+"' in the provided messages, trying to find a translation for the default string '"+h+"'."),o[h]||r("No message found for the default string '"+h+"' in the provided messages. Falling back to the default English message."));var w=o[u]||o[h]||h;return y&&(s==="dollarSigns"&&(w=w.replace(/\$(\$|[\d]+)/g,function(x,$){return $=="$"?"$":y[$]})),s==="curlyBrackets"&&(w=w.replace(/\{([^\}]+)\}/g,function(x,$){return y[$]}))),w},i})();a.prototype.warn=r,a.prototype.reportError=m,d.implement(a.prototype,g),n.AppConfig=a}),ace.define("ace/theme/textmate-css",["require","exports","module"],function(t,n,f){f.exports=`.ace-tm .ace_gutter {
  background: #f0f0f0;
  color: #333;
}
...
`,"error_marker.css",!1)}),ace.define("ace/ace",["require","exports","module","ace/lib/dom","ace/range","ace/editor","ace/edit_session","ace/undomanager","ace/virtual_renderer","ace/worker/worker_client","ace/keyboard/hash_handler","ace/placeholder","ace/multi_select","ace/mode/folding/fold_mode","ace/theme/textmate","ace/ext/error_marker","ace/config","ace/loader_build"],function(t,n,f){t("./loader_build")(n);var d=t("./lib/dom"),g=t("./range").Range,m=t("./editor").Editor,c=t("./edit_session").EditSession,p=t("./undomanager").UndoManager,r=t("./virtual_renderer").VirtualRenderer;t("./worker/worker_client"),t("./keyboard/hash_handler"),t("./placeholder"),t("./multi_select"),t("./mode/folding/fold_mode"),t("./theme/textmate"),t("./ext/error_marker"),n.config=t("./config"),n.edit=function(s,a){if(typeof s=="string"){var i=s;if(s=document.getElementById(i),!s)throw new Error("ace.edit can't find div #"+i)}if(s&&s.env&&s.env.editor instanceof m)return s.env.editor;var u="";if(s&&/input|textarea/i.test(s.tagName)){var h=s;u=h.value,s=d.createElement("pre"),h.parentNode.replaceChild(s,h)}else s&&(u=s.textContent,s.innerHTML="");var y=n.createEditSession(u),w=new m(new r(s),y,a),x={document:y,editor:w,onResize:w.resize.bind(w,null)};return h&&(x.textarea=h),w.on("destroy",function(){x.editor.container.env=null}),w.container.env=w.env=x,w},n.createEditSession=function(s,a){var i=new c(s,a);return i.setUndoManager(new p),i},n.Range=g,n.Editor=m,n.EditSession=c,n.UndoManager=p,n.VirtualRenderer=r;var o=n.config.version;n.version=o}),(function(){ace.require(["ace/ace"],function(t){t&&(t.config.init(!0),t.define=ace.define);var n=(function(){return this})();!n&&typeof window<"u"&&(n=window),!n&&typeof self<"u"&&(n=self),n.ace||(n.ace=t);for(var f in t)t.hasOwnProperty(f)&&(n.ace[f]=t[f]);n.ace.default=n.ace,l&&(l.exports=n.ace)})})()})(Qo)),Qo.exports}var sa=hv();const dv=kt(sa),fv="/formeo/assets/js/mode-json.min.js",pv="/formeo/assets/js/theme-github_light_default.min.js";var Jo,yu;function gv(){if(yu)return Jo;yu=1;function l(e,t,n,f){var d=-1,g=e==null?0:e.length;for(f&&g&&(n=e[++d]);++d<g;)n=t(n,e[d],d,e);return n}return Jo=l,Jo}var es,wu;function mv(){if(wu)return es;wu=1;function l(e){return function(t){return e?.[t]}}return es=l,es}var ts,bu;function vv(){if(bu)return ts;bu=1;var l=mv(),e={À:"A",Á:"A",Â:"A",Ã:"A",Ä:"A",Å:"A",à:"a",á:"a",â:"a",ã:"a",ä:"a",å:"a",Ç:"C",ç:"c",Ð:"D",ð:"d",È:"E",É:"E",Ê:"E",Ë:"E",è:"e",é:"e",ê:"e",ë:"e",Ì:"I",Í:"I",Î:"I",Ï:"I",ì:"i",í:"i",î:"i",ï:"i",Ñ:"N",ñ:"n",Ò:"O",Ó:"O",Ô:"O",Õ:"O",Ö:"O",Ø:"O",ò:"o",ó:"o",ô:"o",õ:"o",ö:"o",ø:"o",Ù:"U",Ú:"U",Û:"U",Ü:"U",ù:"u",ú:"u",û:"u",ü:"u",Ý:"Y",ý:"y",ÿ:"y",Æ:"Ae",æ:"ae",Þ:"Th",þ:"th",ß:"ss",Ā:"A",Ă:"A",Ą:"A",ā:"a",ă:"a",ą:"a",Ć:"C",Ĉ:"C",Ċ:"C",Č:"C",ć:"c",ĉ:"c",ċ:"c",č:"c",Ď:"D",Đ:"D",ď:"d",đ:"d",Ē:"E",Ĕ:"E",Ė:"E",Ę:"E",Ě:"E",ē:"e",ĕ:"e",ė:"e",ę:"e",ě:"e",Ĝ:"G",Ğ:"G",Ġ:"G",Ģ:"G",ĝ:"g",ğ:"g",ġ:"g",ģ:"g",Ĥ:"H",Ħ:"H",ĥ:"h",ħ:"h",Ĩ:"I",Ī:"I",Ĭ:"I",Į:"I",İ:"I",ĩ:"i",ī:"i",ĭ:"i",į:"i",ı:"i",Ĵ:"J",ĵ:"j",Ķ:"K",ķ:"k",ĸ:"k",Ĺ:"L",Ļ:"L",Ľ:"L",Ŀ:"L",Ł:"L",ĺ:"l",ļ:"l",ľ:"l",ŀ:"l",ł:"l",Ń:"N",Ņ:"N",Ň:"N",Ŋ:"N",ń:"n",ņ:"n",ň:"n",ŋ:"n",Ō:"O",Ŏ:"O",Ő:"O",ō:"o",ŏ:"o",ő:"o",Ŕ:"R",Ŗ:"R",Ř:"R",ŕ:"r",ŗ:"r",ř:"r",Ś:"S",Ŝ:"S",Ş:"S",Š:"S",ś:"s",ŝ:"s",ş:"s",š:"s",Ţ:"T",Ť:"T",Ŧ:"T",ţ:"t",ť:"t",ŧ:"t",Ũ:"U",Ū:"U",Ŭ:"U",Ů:"U",Ű:"U",Ų:"U",ũ:"u",ū:"u",ŭ:"u",ů:"u",ű:"u",ų:"u",Ŵ:"W",ŵ:"w",Ŷ:"Y",ŷ:"y",Ÿ:"Y",Ź:"Z",Ż:"Z",Ž:"Z",ź:"z",ż:"z",ž:"z",Ĳ:"IJ",ĳ:"ij",Œ:"Oe",œ:"oe",ŉ:"'n",ſ:"s"},t=l(e);return ts=t,ts}var ns,Cu;function yv(){if(Cu)return ns;Cu=1;var l=vv(),e=Un(),t=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,n="\\u0300-\\u036f",f="\\ufe20-\\ufe2f",d="\\u20d0-\\u20ff",g=n+f+d,m="["+g+"]",c=RegExp(m,"g");function p(r){return r=e(r),r&&r.replace(t,l).replace(c,"")}return ns=p,ns}var is,Su;function wv(){if(Su)return is;Su=1;var l=/[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g;function e(t){return t.match(l)||[]}return is=e,is}var rs,Au;function bv(){if(Au)return rs;Au=1;var l=/[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;function e(t){return l.test(t)}return rs=e,rs}var os,$u;function Cv(){if($u)return os;$u=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",f=e+t+n,d="\\u2700-\\u27bf",g="a-z\\xdf-\\xf6\\xf8-\\xff",m="\\xac\\xb1\\xd7\\xf7",c="\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf",p="\\u2000-\\u206f",r=" \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",o="A-Z\\xc0-\\xd6\\xd8-\\xde",s="\\ufe0e\\ufe0f",a=m+c+p+r,i="['’]",u="["+a+"]",h="["+f+"]",y="\\d+",w="["+d+"]",x="["+g+"]",$="[^"+l+a+y+d+g+o+"]",A="\\ud83c[\\udffb-\\udfff]",S="(?:"+h+"|"+A+")",E="[^"+l+"]",R="(?:\\ud83c[\\udde6-\\uddff]){2}",L="[\\ud800-\\udbff][\\udc00-\\udfff]",_="["+o+"]",D="\\u200d",b="(?:"+x+"|"+$+")",v="(?:"+_+"|"+$+")",C="(?:"+i+"(?:d|ll|m|re|s|t|ve))?",M="(?:"+i+"(?:D|LL|M|RE|S|T|VE))?",T=S+"?",k="["+s+"]?",O="(?:"+D+"(?:"+[E,R,L].join("|")+")"+k+T+")*",I="\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",N="\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",P=k+T+O,B="(?:"+[w,R,L].join("|")+")"+P,F=RegExp([_+"?"+x+"+"+C+"(?="+[u,_,"$"].join("|")+")",v+"+"+M+"(?="+[u,_+b,"$"].join("|")+")",_+"?"+b+"+"+C,_+"+"+M,N,I,y,B].join("|"),"g");function H(z){return z.match(F)||[]}return os=H,os}var ss,Mu;function Sv(){if(Mu)return ss;Mu=1;var l=wv(),e=bv(),t=Un(),n=Cv();function f(d,g,m){return d=t(d),g=m?void 0:g,g===void 0?e(d)?n(d):l(d):d.match(g)||[]}return ss=f,ss}var as,xu;function Av(){if(xu)return as;xu=1;var l=gv(),e=yv(),t=Sv(),n="['’]",f=RegExp(n,"g");function d(g){return function(m){return l(t(e(m).replace(f,"")),g,"")}}return as=d,as}var ls,Eu;function $v(){if(Eu)return ls;Eu=1;function l(e,t,n){var f=-1,d=e.length;t<0&&(t=-t>d?0:d+t),n=n>d?d:n,n<0&&(n+=d),d=t>n?0:n-t>>>0,t>>>=0;for(var g=Array(d);++f<d;)g[f]=e[f+t];return g}return ls=l,ls}var cs,_u;function Mv(){if(_u)return cs;_u=1;var l=$v();function e(t,n,f){var d=t.length;return f=f===void 0?d:f,!n&&f>=d?t:l(t,n,f)}return cs=e,cs}var us,Tu;function od(){if(Tu)return us;Tu=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",f=e+t+n,d="\\ufe0e\\ufe0f",g="\\u200d",m=RegExp("["+g+l+f+d+"]");function c(p){return m.test(p)}return us=c,us}var hs,Lu;function xv(){if(Lu)return hs;Lu=1;function l(e){return e.split("")}return hs=l,hs}var ds,Ru;function Ev(){if(Ru)return ds;Ru=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",f=e+t+n,d="\\ufe0e\\ufe0f",g="["+l+"]",m="["+f+"]",c="\\ud83c[\\udffb-\\udfff]",p="(?:"+m+"|"+c+")",r="[^"+l+"]",o="(?:\\ud83c[\\udde6-\\uddff]){2}",s="[\\ud800-\\udbff][\\udc00-\\udfff]",a="\\u200d",i=p+"?",u="["+d+"]?",h="(?:"+a+"(?:"+[r,o,s].join("|")+")"+u+i+")*",y=u+i+h,w="(?:"+[r+m+"?",m,o,s,g].join("|")+")",x=RegExp(c+"(?="+c+")|"+w+y,"g");function $(A){return A.match(x)||[]}return ds=$,ds}var fs,ku;function _v(){if(ku)return fs;ku=1;var l=xv(),e=od(),t=Ev();function n(f){return e(f)?t(f):l(f)}return fs=n,fs}var ps,Du;function Tv(){if(Du)return ps;Du=1;var l=Mv(),e=od(),t=_v(),n=Un();function f(d){return function(g){g=n(g);var m=e(g)?t(g):void 0,c=m?m[0]:g.charAt(0),p=m?l(m,1).join(""):g.slice(1);return c[d]()+p}}return ps=f,ps}var gs,Ou;function Lv(){if(Ou)return gs;Ou=1;var l=Tv(),e=l("toUpperCase");return gs=e,gs}var ms,Iu;function Rv(){if(Iu)return ms;Iu=1;var l=Av(),e=Lv(),t=l(function(n,f,d){return n+(d?" ":"")+e(f)});return ms=t,ms}var kv=Rv();const Dv=kt(kv);sa.config.setModuleUrl("ace/mode/json",fv);sa.config.setModuleUrl("ace/theme/github_light_default",pv);const tt=dv.edit("formData-editor");tt.session.setOption("useWorker",!1);tt.setOptions({theme:"ace/theme/github_light_default",mode:"ace/mode/json"});const Ov=document.getElementById("submit-formData"),Iv=document.getElementById("formData-popover"),Nv=document.getElementById("editor-action-buttons"),Fv=(l,e)=>({renderForm:()=>{const t=document.querySelector(".render-form");t.style.display="block",e.render(l.formData)},getHtml:()=>{e.formData=l.formData;const t=e.html,n=window.open("","_blank");n.document.body.innerHTML=t},getUserData:()=>{console.log(e.userData),console.log("User Form Data:",e.userFormData)},resetEditor:()=>{window.sessionStorage.removeItem("formeo-formData"),window.location.reload()},editData:()=>{tt.setValue(JSON.stringify(l.formData,null,2),1)}}),Pv={editData:{popovertarget:"formData-popover"}},Hv=l=>{const e=Pv[l]||{};return{id:l,type:"button",...e}},Wv=(l,e)=>{Ov.addEventListener("click",()=>{l.formData=tt.session.getValue(),Iv.hidePopover()});const t=Fv(l,e);return Object.entries(t).map(([f,d])=>{const g=Hv(f),m=Object.assign(document.createElement("button"),g);for(const[p,r]of Object.entries(g))m.setAttribute(p,r);const c=document.createTextNode(Dv(f));return m.appendChild(c),m.addEventListener("click",d,!1),Nv.appendChild(m),m})};document.getElementById("format-json").addEventListener("click",zv);document.getElementById("collapse-json").addEventListener("click",Bv);document.getElementById("copy-json").addEventListener("click",jv);function zv(){const l=tt.session.getValue(),e=JSON.parse(l);tt.setValue(JSON.stringify(e,null,2),1)}function Bv(){const l=tt.session.getValue(),e=JSON.parse(l);tt.setValue(JSON.stringify(e,null,0),1)}async function jv({target:l}){const e=l.textContent;l.textContent="Copied!";const t=setTimeout(()=>{l.textContent=e,clearTimeout(t)},3e3);try{await navigator.clipboard.writeText(tt.session.getValue()),console.log("Text copied to clipboard")}catch(n){console.error("Failed to copy: ",n)}}const Vv=l=>{const e=document.getElementById("control-filter"),t=document.getElementById("locale"),n=window.sessionStorage.getItem("formeo-locale"),f=({target:{value:g}})=>l.controls.actions.filter(g),d=({target:{value:g}})=>{window.sessionStorage.setItem("formeo-locale",g),l.i18n.setLang(g)};e.addEventListener("input",f),t.value=n||"en-US",t.addEventListener("change",d,!1)};async function Uv(l){l.innerHTML=`
    <form class="build-form"></form>
    <div class="render-form"></div>
  `;const e=new ia(tn),t=new ra(oa);return Wv(e,t),Vv(e),{editor:e,renderer:t,cleanup:()=>{e?.destroy&&e.destroy(),t?.destroy&&t.destroy();const n=document.getElementById("editor-action-buttons");n&&(n.innerHTML="")}}}class Gv{constructor(){if(this.currentFramework=null,this.frameworkContainer=document.getElementById("framework-container"),this.frameworkSelect=document.getElementById("framework-select"),this.currentDemo=null,this.isLoading=!1,this.validFrameworks=["vanilla","angular","react"],!this.frameworkContainer){console.error("Framework container not found");return}if(!this.frameworkSelect){console.error("Framework selector not found");return}this.init()}init(){this.frameworkSelect.addEventListener("change",t=>{this.switchFramework(t.target.value)}),window.addEventListener("popstate",()=>{const t=this.getFrameworkFromURL();this.switchFramework(t,{updateURL:!1})});const e=this.getFrameworkFromURL();this.switchFramework(e)}async switchFramework(e,t={}){const{updateURL:n=!0}=t;if(this.isLoading){console.warn("Framework switch already in progress");return}if(!(this.currentFramework===e&&this.currentDemo!==null)){this.isLoading=!0,this.showLoadingState();try{switch(await this.cleanupCurrentDemo(),this.frameworkContainer.innerHTML="",e){case"vanilla":this.currentDemo=await Uv(this.frameworkContainer);break;case"angular":this.currentDemo=await Ym(this.frameworkContainer);break;case"react":this.currentDemo=await iv(this.frameworkContainer);break;default:throw new Error(`Unknown framework: ${e}`)}this.currentFramework=e,this.syncFrameworkSelector(e),n&&this.updateURL(e),console.log(`Loaded ${e} demo successfully`)}catch(f){console.error(`Failed to load ${e} demo:`,f),this.showErrorState(e,f)}finally{this.isLoading=!1}}}async cleanupCurrentDemo(){if(this.currentDemo?.cleanup)try{await Promise.resolve(this.currentDemo.cleanup())}catch(e){console.warn("Error during demo cleanup:",e)}this.currentDemo=null}syncFrameworkSelector(e){this.frameworkSelect.value!==e&&(this.frameworkSelect.value=e)}getFrameworkFromURL(){const t=new URLSearchParams(window.location.search).get("framework");return t&&this.validFrameworks.includes(t)?t:"vanilla"}updateURL(e){const t=new URL(window.location);e==="vanilla"?t.searchParams.delete("framework"):t.searchParams.set("framework",e),window.history.pushState({framework:e},"",t.toString())}showLoadingState(){this.frameworkContainer.innerHTML=`
      <div class="loading-message">
    ...
    `}}document.addEventListener("DOMContentLoaded",()=>{window.frameworkLoader=new Gv});export{bm as C,je as a,X as m,at as t};
