...
`),n={};for(let p,d=0;d<t.length;d++)p=/^(.+?) *?= *?([^\n]+)/.exec(t[d]),p&&(n[p[1]]=p[2].replace(/(^\s+|\s+$)/g,""));return n}loadLang(e,t=!0){const n=this;return new Promise(function(p,d){if(n.loaded.indexOf(e)!==-1&&t)return n.applyLanguage(n.langs[e]),p(n.langs[e]);{const g=[n.config.location,e,n.config.extension].join("");return hd(g).then(m=>{const c=Gt.processFile(m);return n.applyLanguage(e,c),n.loaded.push(e),p(n.langs[e])}).catch(m=>{console.error(m);const c=n.applyLanguage(e);p(c)})}})}applyLanguage(e,t={}){const n=this.config.override[e]||{},p=this.langs[e]||{};return this.langs[e]={...p,...t,...n},this.langs[e]}get getLangs(){return this.config.langs}async setCurrent(e="en-US"){return await this.loadLang(e),this.locale=e,this.current=this.langs[e],this.current}}const Q=new Gt;(function(){try{if(typeof document<"u"){var l=document.createElement("style");l.appendChild(document.createTextNode('._3x4ZIcu-{position:absolute;background:#1f2937;color:#fff;padding:.75rem;border-radius:.375rem;max-width:200px;z-index:50;visibility:hidden;opacity:0;transition:opacity .2s;pointer-events:none;left:0;top:0}._3x4ZIcu-.JIt36hCJ{visibility:visible;opacity:1;pointer-events:all}._3x4ZIcu-:before{content:"";position:absolute;width:0;height:0;border:6px solid transparent}._3x4ZIcu-[data-position=top]:before{border-top-color:#1f2937;bottom:-12px;left:50%;transform:translate(-50%)}._3x4ZIcu-[data-position=bottom]:before{border-bottom-color:#1f2937;top:-12px;left:50%;transform:translate(-50%)}._3x4ZIcu-[data-position=left]:before{border-left-color:#1f2937;right:-12px;top:50%;transform:translateY(-50%)}._3x4ZIcu-[data-position=right]:before{border-right-color:#1f2937;left:-12px;top:50%;transform:translateY(-50%)}._3x4ZIcu-[data-position=top-left]:before{border-top-color:#1f2937;bottom:-12px;left:12px;transform:none}._3x4ZIcu-[data-position=top-right]:before{border-top-color:#1f2937;bottom:-12px;right:12px;left:auto;transform:none}._3x4ZIcu-[data-position=bottom-left]:before{border-bottom-color:#1f2937;top:-12px;left:12px;transform:none}._3x4ZIcu-[data-position=bottom-right]:before{border-bottom-color:#1f2937;top:-12px;right:12px;left:auto;transform:none}')),document.head.appendChild(l)}}catch(e){console.error("vite-plugin-css-injected-by-js",e)}})();var dd=Object.defineProperty,fd=(l,e,t)=>e in l?dd(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t,Ke=(l,e,t)=>fd(l,typeof e!="symbol"?e+"":e,t);const pd="_3x4ZIcu-",gd="JIt36hCJ",Nt={tooltip:pd,visible:gd},md={triggerName:"tooltip"};class Pu{constructor(e=md){Ke(this,"triggerName"),Ke(this,"tooltip"),Ke(this,"activeTriggerType",null),Ke(this,"spacing",12),Ke(this,"handleClick",t=>{const n=this.triggerName,p=t.target.closest(`[${n}][${n}-type="click"]`);if(p)if(this.isVisible())this.hide();else{const d=p.getAttribute(`${n}`);this.show(p,d),this.activeTriggerType="click"}else this.hide()}),Ke(this,"handleMouseOver",t=>{const n=this.triggerName,p=t.target.closest(`[${n}]`);if(this.activeTriggerType!=="click"&&p?.getAttribute(`${n}-type`)!=="click"){const d=p?.getAttribute(`${n}`);d&&(this.show(p,d),this.activeTriggerType="hover")}}),Ke(this,"handleMouseOut",t=>{const n=this.triggerName,p=t.target.closest(`[${n}]`);this.activeTriggerType!=="click"&&p?.getAttribute(`${n}-type`)!=="click"&&this.hide()}),Ke(this,"handleResize",()=>{this.isVisible()&&this.hide()}),Ke(this,"handleScroll",()=>{this.isVisible()&&this.hide()}),this.triggerName=`data-${e.triggerName}`,this.tooltip=document.createElement("div"),this.tooltip.className=`d-tooltip ${Nt.tooltip}`,document.body.appendChild(this.tooltip),this.setupEventListeners()}setupEventListeners(){document.addEventListener("mouseover",this.handleMouseOver),document.addEventListener("mouseout",this.handleMouseOut),document.addEventListener("touchstart",this.handleMouseOver),document.addEventListener("touchend",this.handleMouseOut),document.addEventListener("click",this.handleClick),window.addEventListener("resize",this.handleResize),window.addEventListener("scroll",this.handleScroll,!0)}isVisible(){return this.tooltip.classList.contains(Nt.visible)}calculatePosition(e){const t=e.getBoundingClientRect(),n=this.tooltip.getBoundingClientRect(),p=[{name:"top",x:t.left+(t.width-n.width)/2,y:t.top-n.height-this.spacing},{name:"bottom",x:t.left+(t.width-n.width)/2,y:t.bottom+this.spacing},{name:"left",x:t.left-n.width-this.spacing,y:t.top+(t.height-n.height)/2},{name:"right",x:t.right+this.spacing,y:t.top+(t.height-n.height)/2},{name:"top-left",x:t.left,y:t.top-n.height-this.spacing},{name:"top-right",x:t.right-n.width,y:t.top-n.height-this.spacing},{name:"bottom-left",x:t.left,y:t.bottom+this.spacing},{name:"bottom-right",x:t.right-n.width,y:t.bottom+this.spacing}];return p.find(d=>this.fitsInViewport(d,n))||p[0]}fitsInViewport(e,t){return e.x>=0&&e.y>=0&&e.x+t.width<=window.innerWidth&&e.y+t.height<=window.innerHeight?[[e.x,e.y],[e.x+t.width,e.y],[e.x,e.y+t.height],[e.x+t.width,e.y+t.height],[e.x+t.width/2,e.y+t.height/2]].flatMap(([m,c])=>Array.from(document.elementsFromPoint(m,c))).filter(m=>{if(this.tooltip.contains(m)||m===this.tooltip||m.classList.contains(Nt.tooltip)||getComputedStyle(m).pointerEvents==="none")return!1}).length===0:!1}show(e,t){this.tooltip.innerHTML=t??"",this.tooltip.classList.add(Nt.visible);const n=this.calculatePosition(e);this.tooltip.style.left=`${n.x}px`,this.tooltip.style.top=`${n.y}px`,this.tooltip.dataset.position=n.name}hide(){this.tooltip.classList.remove(Nt.visible),this.activeTriggerType=null}destroy(){document.removeEventListener("mouseover",this.handleMouseOver),document.removeEventListener("mouseout",this.handleMouseOut),document.removeEventListener("touchstart",this.handleMouseOver),document.removeEventListener("touchend",this.handleMouseOut),document.removeEventListener("click",this.handleClick),window.removeEventListener("resize",this.handleResize),window.removeEventListener("scroll",this.handleScroll,!0),this.tooltip.remove()}}window!==void 0&&(window.SmartTooltip=Pu);const vd="formeo",yd="4.2.0",Wu={name:vd,version:yd};var an=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Rt(l){return l&&l.__esModule&&Object.prototype.hasOwnProperty.call(l,"default")?l.default:l}var Jn,ha;function bd(){if(ha)return Jn;ha=1;function l(){this.__data__=[],this.size=0}return Jn=l,Jn}var ei,da;function nn(){if(da)return ei;da=1;function l(e,t){return e===t||e!==e&&t!==t}return ei=l,ei}var ti,fa;function Nn(){if(fa)return ti;fa=1;var l=nn();function e(t,n){for(var p=t.length;p--;)if(l(t[p][0],n))return p;return-1}return ti=e,ti}var ni,pa;function wd(){if(pa)return ni;pa=1;var l=Nn(),e=Array.prototype,t=e.splice;function n(p){var d=this.__data__,g=l(d,p);if(g<0)return!1;var m=d.length-1;return g==m?d.pop():t.call(d,g,1),--this.size,!0}return ni=n,ni}var ii,ga;function Cd(){if(ga)return ii;ga=1;var l=Nn();function e(t){var n=this.__data__,p=l(n,t);return p<0?void 0:n[p][1]}return ii=e,ii}var ri,ma;function Sd(){if(ma)return ri;ma=1;var l=Nn();function e(t){return l(this.__data__,t)>-1}return ri=e,ri}var oi,va;function Ad(){if(va)return oi;va=1;var l=Nn();function e(t,n){var p=this.__data__,d=l(p,t);return d<0?(++this.size,p.push([t,n])):p[d][1]=n,this}return oi=e,oi}var si,ya;function Fn(){if(ya)return si;ya=1;var l=bd(),e=wd(),t=Cd(),n=Sd(),p=Ad();function d(g){var m=-1,c=g==null?0:g.length;for(this.clear();++m<c;){var f=g[m];this.set(f[0],f[1])}}return d.prototype.clear=l,d.prototype.delete=e,d.prototype.get=t,d.prototype.has=n,d.prototype.set=p,si=d,si}var ai,ba;function $d(){if(ba)return ai;ba=1;var l=Fn();function e(){this.__data__=new l,this.size=0}return ai=e,ai}var li,wa;function Ed(){if(wa)return li;wa=1;function l(e){var t=this.__data__,n=t.delete(e);return this.size=t.size,n}return li=l,li}var ci,Ca;function Td(){if(Ca)return ci;Ca=1;function l(e){return this.__data__.get(e)}return ci=l,ci}var ui,Sa;function Md(){if(Sa)return ui;Sa=1;function l(e){return this.__data__.has(e)}return ui=l,ui}var hi,Aa;function Bu(){if(Aa)return hi;Aa=1;var l=typeof an=="object"&&an&&an.Object===Object&&an;return hi=l,hi}var di,$a;function Ve(){if($a)return di;$a=1;var l=Bu(),e=typeof self=="object"&&self&&self.Object===Object&&self,t=l||e||Function("return this")();return di=t,di}var fi,Ea;function Pn(){if(Ea)return fi;Ea=1;var l=Ve(),e=l.Symbol;return fi=e,fi}var pi,Ta;function _d(){if(Ta)return pi;Ta=1;var l=Pn(),e=Object.prototype,t=e.hasOwnProperty,n=e.toString,p=l?l.toStringTag:void 0;function d(g){var m=t.call(g,p),c=g[p];try{g[p]=void 0;var f=!0}catch{}var r=n.call(g);return f&&(m?g[p]=c:delete g[p]),r}return pi=d,pi}var gi,Ma;function xd(){if(Ma)return gi;Ma=1;var l=Object.prototype,e=l.toString;function t(n){return e.call(n)}return gi=t,gi}var mi,_a;function kt(){if(_a)return mi;_a=1;var l=Pn(),e=_d(),t=xd(),n="[object Null]",p="[object Undefined]",d=l?l.toStringTag:void 0;function g(m){return m==null?m===void 0?p:n:d&&d in Object(m)?e(m):t(m)}return mi=g,mi}var vi,xa;function ct(){if(xa)return vi;xa=1;function l(e){var t=typeof e;return e!=null&&(t=="object"||t=="function")}return vi=l,vi}var yi,La;function xs(){if(La)return yi;La=1;var l=kt(),e=ct(),t="[object AsyncFunction]",n="[object Function]",p="[object GeneratorFunction]",d="[object Proxy]";function g(m){if(!e(m))return!1;var c=l(m);return c==n||c==p||c==t||c==d}return yi=g,yi}var bi,Ra;function Ld(){if(Ra)return bi;Ra=1;var l=Ve(),e=l["__core-js_shared__"];return bi=e,bi}var wi,ka;function Rd(){if(ka)return wi;ka=1;var l=Ld(),e=(function(){var n=/[^.]+$/.exec(l&&l.keys&&l.keys.IE_PROTO||"");return n?"Symbol(src)_1."+n:""})();function t(n){return!!e&&e in n}return wi=t,wi}var Ci,Oa;function Hu(){if(Oa)return Ci;Oa=1;var l=Function.prototype,e=l.toString;function t(n){if(n!=null){try{return e.call(n)}catch{}try{return n+""}catch{}}return""}return Ci=t,Ci}var Si,Da;function kd(){if(Da)return Si;Da=1;var l=xs(),e=Rd(),t=ct(),n=Hu(),p=/[\\^$.*+?()[\]{}|]/g,d=/^\[object .+?Constructor\]$/,g=Function.prototype,m=Object.prototype,c=g.toString,f=m.hasOwnProperty,r=RegExp("^"+c.call(f).replace(p,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function o(s){if(!t(s)||e(s))return!1;var a=l(s)?r:d;return a.test(n(s))}return Si=o,Si}var Ai,Ia;function Od(){if(Ia)return Ai;Ia=1;function l(e,t){return e?.[t]}return Ai=l,Ai}var $i,Na;function yt(){if(Na)return $i;Na=1;var l=kd(),e=Od();function t(n,p){var d=e(n,p);return l(d)?d:void 0}return $i=t,$i}var Ei,Fa;function Ls(){if(Fa)return Ei;Fa=1;var l=yt(),e=Ve(),t=l(e,"Map");return Ei=t,Ei}var Ti,Pa;function Wn(){if(Pa)return Ti;Pa=1;var l=yt(),e=l(Object,"create");return Ti=e,Ti}var Mi,Wa;function Dd(){if(Wa)return Mi;Wa=1;var l=Wn();function e(){this.__data__=l?l(null):{},this.size=0}return Mi=e,Mi}var _i,Ba;function Id(){if(Ba)return _i;Ba=1;function l(e){var t=this.has(e)&&delete this.__data__[e];return this.size-=t?1:0,t}return _i=l,_i}var xi,Ha;function Nd(){if(Ha)return xi;Ha=1;var l=Wn(),e="__lodash_hash_undefined__",t=Object.prototype,n=t.hasOwnProperty;function p(d){var g=this.__data__;if(l){var m=g[d];return m===e?void 0:m}return n.call(g,d)?g[d]:void 0}return xi=p,xi}var Li,za;function Fd(){if(za)return Li;za=1;var l=Wn(),e=Object.prototype,t=e.hasOwnProperty;function n(p){var d=this.__data__;return l?d[p]!==void 0:t.call(d,p)}return Li=n,Li}var Ri,ja;function Pd(){if(ja)return Ri;ja=1;var l=Wn(),e="__lodash_hash_undefined__";function t(n,p){var d=this.__data__;return this.size+=this.has(n)?0:1,d[n]=l&&p===void 0?e:p,this}return Ri=t,Ri}var ki,Ua;function Wd(){if(Ua)return ki;Ua=1;var l=Dd(),e=Id(),t=Nd(),n=Fd(),p=Pd();function d(g){var m=-1,c=g==null?0:g.length;for(this.clear();++m<c;){var f=g[m];this.set(f[0],f[1])}}return d.prototype.clear=l,d.prototype.delete=e,d.prototype.get=t,d.prototype.has=n,d.prototype.set=p,ki=d,ki}var Oi,Ga;function Bd(){if(Ga)return Oi;Ga=1;var l=Wd(),e=Fn(),t=Ls();function n(){this.size=0,this.__data__={hash:new l,map:new(t||e),string:new l}}return Oi=n,Oi}var Di,Va;function Hd(){if(Va)return Di;Va=1;function l(e){var t=typeof e;return t=="string"||t=="number"||t=="symbol"||t=="boolean"?e!=="__proto__":e===null}return Di=l,Di}var Ii,Ka;function Bn(){if(Ka)return Ii;Ka=1;var l=Hd();function e(t,n){var p=t.__data__;return l(n)?p[typeof n=="string"?"string":"hash"]:p.map}return Ii=e,Ii}var Ni,qa;function zd(){if(qa)return Ni;qa=1;var l=Bn();function e(t){var n=l(this,t).delete(t);return this.size-=n?1:0,n}return Ni=e,Ni}var Fi,Ya;function jd(){if(Ya)return Fi;Ya=1;var l=Bn();function e(t){return l(this,t).get(t)}return Fi=e,Fi}var Pi,Xa;function Ud(){if(Xa)return Pi;Xa=1;var l=Bn();function e(t){return l(this,t).has(t)}return Pi=e,Pi}var Wi,Qa;function Gd(){if(Qa)return Wi;Qa=1;var l=Bn();function e(t,n){var p=l(this,t),d=p.size;return p.set(t,n),this.size+=p.size==d?0:1,this}return Wi=e,Wi}var Bi,Za;function Rs(){if(Za)return Bi;Za=1;var l=Bd(),e=zd(),t=jd(),n=Ud(),p=Gd();function d(g){var m=-1,c=g==null?0:g.length;for(this.clear();++m<c;){var f=g[m];this.set(f[0],f[1])}}return d.prototype.clear=l,d.prototype.delete=e,d.prototype.get=t,d.prototype.has=n,d.prototype.set=p,Bi=d,Bi}var Hi,Ja;function Vd(){if(Ja)return Hi;Ja=1;var l=Fn(),e=Ls(),t=Rs(),n=200;function p(d,g){var m=this.__data__;if(m instanceof l){var c=m.__data__;if(!e||c.length<n-1)return c.push([d,g]),this.size=++m.size,this;m=this.__data__=new t(c)}return m.set(d,g),this.size=m.size,this}return Hi=p,Hi}var zi,el;function zu(){if(el)return zi;el=1;var l=Fn(),e=$d(),t=Ed(),n=Td(),p=Md(),d=Vd();function g(m){var c=this.__data__=new l(m);this.size=c.size}return g.prototype.clear=e,g.prototype.delete=t,g.prototype.get=n,g.prototype.has=p,g.prototype.set=d,zi=g,zi}var ji,tl;function ju(){if(tl)return ji;tl=1;var l=yt(),e=(function(){try{var t=l(Object,"defineProperty");return t({},"",{}),t}catch{}})();return ji=e,ji}var Ui,nl;function ks(){if(nl)return Ui;nl=1;var l=ju();function e(t,n,p){n=="__proto__"&&l?l(t,n,{configurable:!0,enumerable:!0,value:p,writable:!0}):t[n]=p}return Ui=e,Ui}var Gi,il;function Uu(){if(il)return Gi;il=1;var l=ks(),e=nn();function t(n,p,d){(d!==void 0&&!e(n[p],d)||d===void 0&&!(p in n))&&l(n,p,d)}return Gi=t,Gi}var Vi,rl;function Kd(){if(rl)return Vi;rl=1;function l(e){return function(t,n,p){for(var d=-1,g=Object(t),m=p(t),c=m.length;c--;){var f=m[e?c:++d];if(n(g[f],f,g)===!1)break}return t}}return Vi=l,Vi}var Ki,ol;function qd(){if(ol)return Ki;ol=1;var l=Kd(),e=l();return Ki=e,Ki}var Wt={exports:{}};Wt.exports;var sl;function Yd(){return sl||(sl=1,(function(l,e){var t=Ve(),n=e&&!e.nodeType&&e,p=n&&!0&&l&&!l.nodeType&&l,d=p&&p.exports===n,g=d?t.Buffer:void 0,m=g?g.allocUnsafe:void 0;function c(f,r){if(r)return f.slice();var o=f.length,s=m?m(o):new f.constructor(o);return f.copy(s),s}l.exports=c})(Wt,Wt.exports)),Wt.exports}var qi,al;function Gu(){if(al)return qi;al=1;var l=Ve(),e=l.Uint8Array;return qi=e,qi}var Yi,ll;function Xd(){if(ll)return Yi;ll=1;var l=Gu();function e(t){var n=new t.constructor(t.byteLength);return new l(n).set(new l(t)),n}return Yi=e,Yi}var Xi,cl;function Qd(){if(cl)return Xi;cl=1;var l=Xd();function e(t,n){var p=n?l(t.buffer):t.buffer;return new t.constructor(p,t.byteOffset,t.length)}return Xi=e,Xi}var Qi,ul;function Zd(){if(ul)return Qi;ul=1;function l(e,t){var n=-1,p=e.length;for(t||(t=Array(p));++n<p;)t[n]=e[n];return t}return Qi=l,Qi}var Zi,hl;function Jd(){if(hl)return Zi;hl=1;var l=ct(),e=Object.create,t=(function(){function n(){}return function(p){if(!l(p))return{};if(e)return e(p);n.prototype=p;var d=new n;return n.prototype=void 0,d}})();return Zi=t,Zi}var Ji,dl;function Vu(){if(dl)return Ji;dl=1;function l(e,t){return function(n){return e(t(n))}}return Ji=l,Ji}var er,fl;function Ku(){if(fl)return er;fl=1;var l=Vu(),e=l(Object.getPrototypeOf,Object);return er=e,er}var tr,pl;function Os(){if(pl)return tr;pl=1;var l=Object.prototype;function e(t){var n=t&&t.constructor,p=typeof n=="function"&&n.prototype||l;return t===p}return tr=e,tr}var nr,gl;function ef(){if(gl)return nr;gl=1;var l=Jd(),e=Ku(),t=Os();function n(p){return typeof p.constructor=="function"&&!t(p)?l(e(p)):{}}return nr=n,nr}var ir,ml;function bt(){if(ml)return ir;ml=1;function l(e){return e!=null&&typeof e=="object"}return ir=l,ir}var rr,vl;function tf(){if(vl)return rr;vl=1;var l=kt(),e=bt(),t="[object Arguments]";function n(p){return e(p)&&l(p)==t}return rr=n,rr}var or,yl;function qu(){if(yl)return or;yl=1;var l=tf(),e=bt(),t=Object.prototype,n=t.hasOwnProperty,p=t.propertyIsEnumerable,d=l((function(){return arguments})())?l:function(g){return e(g)&&n.call(g,"callee")&&!p.call(g,"callee")};return or=d,or}var sr,bl;function wt(){if(bl)return sr;bl=1;var l=Array.isArray;return sr=l,sr}var ar,wl;function Yu(){if(wl)return ar;wl=1;var l=9007199254740991;function e(t){return typeof t=="number"&&t>-1&&t%1==0&&t<=l}return ar=e,ar}var lr,Cl;function Hn(){if(Cl)return lr;Cl=1;var l=xs(),e=Yu();function t(n){return n!=null&&e(n.length)&&!l(n)}return lr=t,lr}var cr,Sl;function nf(){if(Sl)return cr;Sl=1;var l=Hn(),e=bt();function t(n){return e(n)&&l(n)}return cr=t,cr}var Bt={exports:{}},ur,Al;function rf(){if(Al)return ur;Al=1;function l(){return!1}return ur=l,ur}Bt.exports;var $l;function Ds(){return $l||($l=1,(function(l,e){var t=Ve(),n=rf(),p=e&&!e.nodeType&&e,d=p&&!0&&l&&!l.nodeType&&l,g=d&&d.exports===p,m=g?t.Buffer:void 0,c=m?m.isBuffer:void 0,f=c||n;l.exports=f})(Bt,Bt.exports)),Bt.exports}var hr,El;function of(){if(El)return hr;El=1;var l=kt(),e=Ku(),t=bt(),n="[object Object]",p=Function.prototype,d=Object.prototype,g=p.toString,m=d.hasOwnProperty,c=g.call(Object);function f(r){if(!t(r)||l(r)!=n)return!1;var o=e(r);if(o===null)return!0;var s=m.call(o,"constructor")&&o.constructor;return typeof s=="function"&&s instanceof s&&g.call(s)==c}return hr=f,hr}var dr,Tl;function sf(){if(Tl)return dr;Tl=1;var l=kt(),e=Yu(),t=bt(),n="[object Arguments]",p="[object Array]",d="[object Boolean]",g="[object Date]",m="[object Error]",c="[object Function]",f="[object Map]",r="[object Number]",o="[object Object]",s="[object RegExp]",a="[object Set]",i="[object String]",u="[object WeakMap]",h="[object ArrayBuffer]",y="[object DataView]",b="[object Float32Array]",T="[object Float64Array]",$="[object Int8Array]",A="[object Int16Array]",S="[object Int32Array]",M="[object Uint8Array]",R="[object Uint8ClampedArray]",L="[object Uint16Array]",_="[object Uint32Array]",O={};O[b]=O[T]=O[$]=O[A]=O[S]=O[M]=O[R]=O[L]=O[_]=!0,O[n]=O[p]=O[h]=O[d]=O[y]=O[g]=O[m]=O[c]=O[f]=O[r]=O[o]=O[s]=O[a]=O[i]=O[u]=!1;function w(v){return t(v)&&e(v.length)&&!!O[l(v)]}return dr=w,dr}var fr,Ml;function af(){if(Ml)return fr;Ml=1;function l(e){return function(t){return e(t)}}return fr=l,fr}var Ht={exports:{}};Ht.exports;var _l;function lf(){return _l||(_l=1,(function(l,e){var t=Bu(),n=e&&!e.nodeType&&e,p=n&&!0&&l&&!l.nodeType&&l,d=p&&p.exports===n,g=d&&t.process,m=(function(){try{var c=p&&p.require&&p.require("util").types;return c||g&&g.binding&&g.binding("util")}catch{}})();l.exports=m})(Ht,Ht.exports)),Ht.exports}var pr,xl;function Is(){if(xl)return pr;xl=1;var l=sf(),e=af(),t=lf(),n=t&&t.isTypedArray,p=n?e(n):l;return pr=p,pr}var gr,Ll;function Xu(){if(Ll)return gr;Ll=1;function l(e,t){if(!(t==="constructor"&&typeof e[t]=="function")&&t!="__proto__")return e[t]}return gr=l,gr}var mr,Rl;function Qu(){if(Rl)return mr;Rl=1;var l=ks(),e=nn(),t=Object.prototype,n=t.hasOwnProperty;function p(d,g,m){var c=d[g];(!(n.call(d,g)&&e(c,m))||m===void 0&&!(g in d))&&l(d,g,m)}return mr=p,mr}var vr,kl;function cf(){if(kl)return vr;kl=1;var l=Qu(),e=ks();function t(n,p,d,g){var m=!d;d||(d={});for(var c=-1,f=p.length;++c<f;){var r=p[c],o=g?g(d[r],n[r],r,d,n):void 0;o===void 0&&(o=n[r]),m?e(d,r,o):l(d,r,o)}return d}return vr=t,vr}var yr,Ol;function uf(){if(Ol)return yr;Ol=1;function l(e,t){for(var n=-1,p=Array(e);++n<e;)p[n]=t(n);return p}return yr=l,yr}var br,Dl;function Ns(){if(Dl)return br;Dl=1;var l=9007199254740991,e=/^(?:0|[1-9]\d*)$/;function t(n,p){var d=typeof n;return p=p??l,!!p&&(d=="number"||d!="symbol"&&e.test(n))&&n>-1&&n%1==0&&n<p}return br=t,br}var wr,Il;function Zu(){if(Il)return wr;Il=1;var l=uf(),e=qu(),t=wt(),n=Ds(),p=Ns(),d=Is(),g=Object.prototype,m=g.hasOwnProperty;function c(f,r){var o=t(f),s=!o&&e(f),a=!o&&!s&&n(f),i=!o&&!s&&!a&&d(f),u=o||s||a||i,h=u?l(f.length,String):[],y=h.length;for(var b in f)(r||m.call(f,b))&&!(u&&(b=="length"||a&&(b=="offset"||b=="parent")||i&&(b=="buffer"||b=="byteLength"||b=="byteOffset")||p(b,y)))&&h.push(b);return h}return wr=c,wr}var Cr,Nl;function hf(){if(Nl)return Cr;Nl=1;function l(e){var t=[];if(e!=null)for(var n in Object(e))t.push(n);return t}return Cr=l,Cr}var Sr,Fl;function df(){if(Fl)return Sr;Fl=1;var l=ct(),e=Os(),t=hf(),n=Object.prototype,p=n.hasOwnProperty;function d(g){if(!l(g))return t(g);var m=e(g),c=[];for(var f in g)f=="constructor"&&(m||!p.call(g,f))||c.push(f);return c}return Sr=d,Sr}var Ar,Pl;function Ju(){if(Pl)return Ar;Pl=1;var l=Zu(),e=df(),t=Hn();function n(p){return t(p)?l(p,!0):e(p)}return Ar=n,Ar}var $r,Wl;function ff(){if(Wl)return $r;Wl=1;var l=cf(),e=Ju();function t(n){return l(n,e(n))}return $r=t,$r}var Er,Bl;function pf(){if(Bl)return Er;Bl=1;var l=Uu(),e=Yd(),t=Qd(),n=Zd(),p=ef(),d=qu(),g=wt(),m=nf(),c=Ds(),f=xs(),r=ct(),o=of(),s=Is(),a=Xu(),i=ff();function u(h,y,b,T,$,A,S){var M=a(h,b),R=a(y,b),L=S.get(R);if(L){l(h,b,L);return}var _=A?A(M,R,b+"",h,y,S):void 0,O=_===void 0;if(O){var w=g(R),v=!w&&c(R),C=!w&&!v&&s(R);_=R,w||v||C?g(M)?_=M:m(M)?_=n(M):v?(O=!1,_=e(R,!0)):C?(O=!1,_=t(R,!0)):_=[]:o(R)||d(R)?(_=M,d(M)?_=i(M):(!r(M)||f(M))&&(_=p(R))):O=!1}O&&(S.set(R,_),$(_,R,T,A,S),S.delete(R)),l(h,b,_)}return Er=u,Er}var Tr,Hl;function gf(){if(Hl)return Tr;Hl=1;var l=zu(),e=Uu(),t=qd(),n=pf(),p=ct(),d=Ju(),g=Xu();function m(c,f,r,o,s){c!==f&&t(f,function(a,i){if(s||(s=new l),p(a))n(c,f,i,r,m,o,s);else{var u=o?o(g(c,i),a,i+"",c,f,s):void 0;u===void 0&&(u=a),e(c,i,u)}},d)}return Tr=m,Tr}var Mr,zl;function eh(){if(zl)return Mr;zl=1;function l(e){return e}return Mr=l,Mr}var _r,jl;function mf(){if(jl)return _r;jl=1;function l(e,t,n){switch(n.length){case 0:return e.call(t);case 1:return e.call(t,n[0]);case 2:return e.call(t,n[0],n[1]);case 3:return e.call(t,n[0],n[1],n[2])}return e.apply(t,n)}return _r=l,_r}var xr,Ul;function vf(){if(Ul)return xr;Ul=1;var l=mf(),e=Math.max;function t(n,p,d){return p=e(p===void 0?n.length-1:p,0),function(){for(var g=arguments,m=-1,c=e(g.length-p,0),f=Array(c);++m<c;)f[m]=g[p+m];m=-1;for(var r=Array(p+1);++m<p;)r[m]=g[m];return r[p]=d(f),l(n,this,r)}}return xr=t,xr}var Lr,Gl;function yf(){if(Gl)return Lr;Gl=1;function l(e){return function(){return e}}return Lr=l,Lr}var Rr,Vl;function bf(){if(Vl)return Rr;Vl=1;var l=yf(),e=ju(),t=eh(),n=e?function(p,d){return e(p,"toString",{configurable:!0,enumerable:!1,value:l(d),writable:!0})}:t;return Rr=n,Rr}var kr,Kl;function wf(){if(Kl)return kr;Kl=1;var l=800,e=16,t=Date.now;function n(p){var d=0,g=0;return function(){var m=t(),c=e-(m-g);if(g=m,c>0){if(++d>=l)return arguments[0]}else d=0;return p.apply(void 0,arguments)}}return kr=n,kr}var Or,ql;function Cf(){if(ql)return Or;ql=1;var l=bf(),e=wf(),t=e(l);return Or=t,Or}var Dr,Yl;function Sf(){if(Yl)return Dr;Yl=1;var l=eh(),e=vf(),t=Cf();function n(p,d){return t(e(p,d,l),p+"")}return Dr=n,Dr}var Ir,Xl;function Af(){if(Xl)return Ir;Xl=1;var l=nn(),e=Hn(),t=Ns(),n=ct();function p(d,g,m){if(!n(m))return!1;var c=typeof g;return(c=="number"?e(m)&&t(g,m.length):c=="string"&&g in m)?l(m[g],d):!1}return Ir=p,Ir}var Nr,Ql;function $f(){if(Ql)return Nr;Ql=1;var l=Sf(),e=Af();function t(n){return l(function(p,d){var g=-1,m=d.length,c=m>1?d[m-1]:void 0,f=m>2?d[2]:void 0;for(c=n.length>3&&typeof c=="function"?(m--,c):void 0,f&&e(d[0],d[1],f)&&(c=m<3?void 0:c,m=1),p=Object(p);++g<m;){var r=d[g];r&&n(p,r,g,c)}return p})}return Nr=t,Nr}var Fr,Zl;function Ef(){if(Zl)return Fr;Zl=1;var l=gf(),e=$f(),t=e(function(n,p,d,g){l(n,p,d,g)});return Fr=t,Fr}var Tf=Ef();const Mf=Rt(Tf),_f=()=>crypto.randomUUID().slice(0,8),xf=()=>_f().slice(0,8),Jl=(l="",e)=>{if(!e)return console.warn("utils.match missing argument 2."),!1;const t=/[|\\{}()[\]^*$+?.]/g;let n=typeof e=="string"?[e]:e;n=n.map(d=>d==="*"?"":d.replace(t,"\\$&"));let p=!0;return n.length&&(p=!new RegExp(n.join("|"),"i").exec(l)),p},Lf=(l,e)=>{const t=l.indexOf(e);t!==-1&&l.splice(t,1)},Le=l=>{const e=l.className?.match(jf);return e&&Hf[e[0]]},gt=l=>Array.from(new Set(l)),We=l=>l?.attrs?.id||l?.id||xf(),je=(l,e)=>Mf({},l,e,(n,p)=>{if(Array.isArray(n))return p!=null?gt(n.concat(p)):p;if(Array.isArray(p))return n!=null?gt(p.concat(n)):p}),Xe=l=>{let e;const t=l instanceof Promise;if(l===null||!(typeof l=="object")||t)return l;if(l instanceof Date)return e=new Date,e.setTime(l.getTime()),e;if(Array.isArray(l)){e=[];for(let p=0,d=l.length;p<d;p++)e[p]=Xe(l[p]);return e}if(l instanceof Object){e={};for(const p in l)Object.hasOwn(l,p)&&(e[p]=Xe(l[p]));return e}throw new Error("Unable to copy Object, type not supported.")},Pr=(l,e)=>l/e*100,ys=l=>`${l.toString()}%`,th=Object.create(null,{get:{value:l=>{const e=window.sessionStorage?.getItem(l);try{return JSON.parse(e)}catch{return e}}},set:{value:(l,e)=>{try{return window.sessionStorage?.setItem(l,JSON.stringify(e))}catch(t){console.error(t)}}}}),Pe=l=>/^(stage|row|column|field)s./.test(l),Rf=l=>Ff.test(l);function kf(l,e=zs){let t=0;return function(...n){const p=Date.now();p-t>=e&&(t=p,l.apply(this,n))}}function $n(l,e=mt){let t;return function(...n){t&&clearTimeout(t),t=setTimeout(()=>l.apply(this,n),e)}}function bs(l){return l}function ws(){}function zn(l=Object.create(null)){if(typeof l=="string")try{return JSON.parse(l)}catch(e){return console.error("Invalid JSON string provided:",e),Object.create(null)}return l}const Vt=l=>l?Xe(zn(l)):En();function nh(l,e,t,n={}){if(!e||!l[t][e])return n;const p=`${t}.${e}`;n[p]=l[t][e];const d=Vf.get(t);if(d){const g=l[t][e].data?.children||[];for(const m of g)nh(l,m,d,n)}return n}const Fs=Wu.name,Ps=Wu.version,jn=Fs,st="formeo-sprite",ec=[{name:"cssPreload",src:"//cdnjs.cloudflare.com/ajax/libs/loadCSS/2.0.1/cssrelpreload.min.js"},{name:"mutationObserver",src:"//cdn.jsdelivr.net/npm/mutationobserver-shim/dist/mutationobserver.min.js"},{name:"fetch",src:"https://unpkg.com/unfetch/polyfill"}],tc=`../../lib/icons/${st}.svg`;typeof import.meta.resolve=="function"&&import.meta.resolve(tc);const ih=`https://cdn.jsdelivr.net/npm/formeo@${Ps}/dist/${st}.svg`,Of=`https://draggable.github.io/formeo/assets/img/${st}.svg`,Df=`https://cdn.jsdelivr.net/npm/formeo@${Ps}/dist/formeo.min.css`,If="https://draggable.github.io/formeo/assets/css/formeo.min.css",rh="f-panel",ot="control-group",Ot=`${jn}-stage`,Qe=`${jn}-row`,Ze=`${jn}-column`,Dt=`${jn}-field`,Cs="custom-column-widths",oh="column-preset",Wr="resizing-columns",Nf=new Map([[Ot,Qe],[Qe,Ze],[Ze,Dt]]),Ws=["stage","row","column","field"],Bs=Ws.map(l=>`${l}s`);new Map(Bs.map((l,e)=>[l,Ws[e]]));const Ff=new RegExp(`^${Bs.join("|")}.`),sh=[...Ws],Pf=[...Bs],Wf=new Map(Pf.map((l,e)=>[l,sh[e]])),Br=sh.reduce((l,e)=>(l[e]=e,l),{}),Bf=[{name:"controls",className:ot},{name:"stage",className:Ot},{name:"row",className:Qe},{name:"column",className:Ze},{name:"field",className:Dt}],Hs={controls:ot,stage:Ot,row:Qe,column:Ze,field:Dt},Hf=Object.entries(Hs).reduce((l,[e,t])=>(l[t]=e,l),{}),zf=Object.values(Hs),jf=new RegExp(`${zf.join("|")}`,"g"),{childTypeMapVals:ah,childTypeIndexMapVals:Uf}=Bf.reduce((l,{name:e},t,n)=>{const{name:p}=n[t+1]||{};return p&&(l.childTypeMapVals.push([e,p]),l.childTypeIndexMapVals.push([`${e}s`,`${p}s`])),l},{childTypeMapVals:[],childTypeIndexMapVals:[]}),Gf=ah.slice().map(l=>l.slice().reverse()).reverse(),nc=new Map(ah),Vf=new Map(Uf),Kf=new Map(Gf.slice()),qf=[[{value:"100.0",label:"100%"}],[{value:"50.0,50.0",label:"50 | 50"},{value:"33.3,66.6",label:"33 | 66"},{value:"66.6,33.3",label:"66 | 33"}],[{value:"33.3,33.3,33.3",label:"33 | 33 | 33"},{value:"25.0,25.0,50.0",label:"25 | 25 | 50"},{value:"50.0,25.0,25.0",label:"50 | 25 | 25"},{value:"25.0,50.0,25.0",label:"25 | 50 | 25"}],[{value:"25.0,25.0,25.0,25.0",label:"25 | 25 | 25 | 25"}],[{value:"20.0,20.0,20.0,20.0,20.0",label:"20 | 20 | 20 | 20 | 20"}],[{value:"16.66,16.66,16.66,16.66,16.66,16.66",label:"16.66 | 16.66 | 16.66 | 16.66 | 16.66 | 16.66"}]],Yf=new Map(qf.reduce((l,e,t)=>(l.push([t,e]),l),[])),lh=`${Fs}-formData`,ic=`${Fs}-locale`,qe=333,mt=Math.round(qe/2),zs=Math.round(qe*2),ch="formeoSaved",Jt="formeoUpdated",Xf="formeoChanged",uh="formeoUpdatedStage",hh="formeoUpdatedRow",dh="formeoUpdatedColumn",fh="formeoUpdatedField",Qf="formeoCleared",ph="formeoOnRender",Zf="formeoConditionUpdated",js="formeoAddedRow",Us="formeoAddedColumn",Gs="formeoAddedField",Vs="formeoRemovedRow",Ks="formeoRemovedColumn",qs="formeoRemovedField",gh={equals:"==",notEquals:"!=",contains:"⊃",notContains:"!⊃"},Jf={and:"&&",or:"||"},mh={equals:"="},ep=["logical","source","sourceProperty","comparison","target","targetProperty","assignment","value"],rc=["isChecked","isNotChecked"],oc=["isVisible","isNotVisible"],pn=["value"],tp={comparison:gh,assignment:mh,logical:Jf},vh="if",np="then",Ys=()=>({[vh]:[{source:"",sourceProperty:"",comparison:"",target:"",targetProperty:""}],[np]:[{target:"",targetProperty:"",assignment:"",value:""}]}),ip=/(\b[0-9a-f]{8}\b-[0-9a-f]{4}-[0-9a-f]{4}-[0-9a-f]{4}-\b[0-9a-f]{12}\b)|(\b[0-9a-f]{8}\b)/g,Ss=/\bcol-\w+-\d+/g,yh="f-i-",En=()=>({id:We(),stages:{[We()]:{}},rows:{},columns:{},fields:{}}),Tn=["selected","checked"],rp=Tn.toReversed(),op="a an and as at but by for for from in into near nor of on onto or the to with".split(" ").map(l=>`\\s${l}\\s`),sp=new RegExp(`(?!${op.join("|")})\\w\\S*`,"g"),ap=/\s+/g;function at(l){return typeof l!="string"||l.trim().match(ap)?l:l.replace(sp,t=>t.charAt(0).toUpperCase()+t.substring(1).replace(/[A-Z]/g,n=>` ${n}`))}const bh=(l,e="-")=>l.toString().normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim().replace(/[^a-z0-9 -]/g,"").replace(/\s+/g,e),vt=l=>{if(Array.isArray(l))return l;const e=/[.[\]]/g,t=[];let n=0,p=e.exec(l);for(;p!==null;)t.push(l.slice(n,p.index)),n=p.index+p[0].length,p=e.exec(l);return n<l.length&&t.push(l.slice(n)),t.filter(Boolean)},sc=(l,e="-")=>vt(l).join(e),lp=l=>{const e=document.createElement("div");return e.innerHTML=l,e.textContent||e.innerText||""},cp=(l,e,t="…")=>{if(l.length<=e)return l;const n=l.slice(0,e),p=n.lastIndexOf(" ");let d=`${p>0?n.slice(0,p):n}`;return t&&(d+=t),d};var Hr,ac;function Xs(){if(ac)return Hr;ac=1;var l=kt(),e=bt(),t="[object Symbol]";function n(p){return typeof p=="symbol"||e(p)&&l(p)==t}return Hr=n,Hr}var zr,lc;function up(){if(lc)return zr;lc=1;var l=wt(),e=Xs(),t=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,n=/^\w*$/;function p(d,g){if(l(d))return!1;var m=typeof d;return m=="number"||m=="symbol"||m=="boolean"||d==null||e(d)?!0:n.test(d)||!t.test(d)||g!=null&&d in Object(g)}return zr=p,zr}var jr,cc;function hp(){if(cc)return jr;cc=1;var l=Rs(),e="Expected a function";function t(n,p){if(typeof n!="function"||p!=null&&typeof p!="function")throw new TypeError(e);var d=function(){var g=arguments,m=p?p.apply(this,g):g[0],c=d.cache;if(c.has(m))return c.get(m);var f=n.apply(this,g);return d.cache=c.set(m,f)||c,f};return d.cache=new(t.Cache||l),d}return t.Cache=l,jr=t,jr}var Ur,uc;function dp(){if(uc)return Ur;uc=1;var l=hp(),e=500;function t(n){var p=l(n,function(g){return d.size===e&&d.clear(),g}),d=p.cache;return p}return Ur=t,Ur}var Gr,hc;function fp(){if(hc)return Gr;hc=1;var l=dp(),e=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,t=/\\(\\)?/g,n=l(function(p){var d=[];return p.charCodeAt(0)===46&&d.push(""),p.replace(e,function(g,m,c,f){d.push(c?f.replace(t,"$1"):m||g)}),d});return Gr=n,Gr}var Vr,dc;function pp(){if(dc)return Vr;dc=1;function l(e,t){for(var n=-1,p=e==null?0:e.length,d=Array(p);++n<p;)d[n]=t(e[n],n,e);return d}return Vr=l,Vr}var Kr,fc;function gp(){if(fc)return Kr;fc=1;var l=Pn(),e=pp(),t=wt(),n=Xs(),p=l?l.prototype:void 0,d=p?p.toString:void 0;function g(m){if(typeof m=="string")return m;if(t(m))return e(m,g)+"";if(n(m))return d?d.call(m):"";var c=m+"";return c=="0"&&1/m==-1/0?"-0":c}return Kr=g,Kr}var qr,pc;function Un(){if(pc)return qr;pc=1;var l=gp();function e(t){return t==null?"":l(t)}return qr=e,qr}var Yr,gc;function wh(){if(gc)return Yr;gc=1;var l=wt(),e=up(),t=fp(),n=Un();function p(d,g){return l(d)?d:e(d,g)?[d]:t(n(d))}return Yr=p,Yr}var Xr,mc;function Ch(){if(mc)return Xr;mc=1;var l=Xs();function e(t){if(typeof t=="string"||l(t))return t;var n=t+"";return n=="0"&&1/t==-1/0?"-0":n}return Xr=e,Xr}var Qr,vc;function mp(){if(vc)return Qr;vc=1;var l=wh(),e=Ch();function t(n,p){p=l(p,n);for(var d=0,g=p.length;n!=null&&d<g;)n=n[e(p[d++])];return d&&d==g?n:void 0}return Qr=t,Qr}var Zr,yc;function vp(){if(yc)return Zr;yc=1;var l=mp();function e(t,n,p){var d=t==null?void 0:l(t,n);return d===void 0?p:d}return Zr=e,Zr}var yp=vp();const bp=Rt(yp);var Jr,bc;function wp(){if(bc)return Jr;bc=1;var l=Qu(),e=wh(),t=Ns(),n=ct(),p=Ch();function d(g,m,c,f){if(!n(g))return g;m=e(m,g);for(var r=-1,o=m.length,s=o-1,a=g;a!=null&&++r<o;){var i=p(m[r]),u=c;if(i==="__proto__"||i==="constructor"||i==="prototype")return g;if(r!=s){var h=a[i];u=f?f(h,i,a):void 0,u===void 0&&(u=n(h)?h:t(m[r+1])?[]:{})}l(a,i,u),a=a[i]}return g}return Jr=d,Jr}var eo,wc;function Cp(){if(wc)return eo;wc=1;var l=wp();function e(t,n,p){return t==null?t:l(t,n,p)}return eo=e,eo}var Sp=Cp();const Ap=Rt(Sp),Ie=bp,Gn=Ap;function $p(l,e={}){const t={...l};for(const n in e)Object.hasOwn(e,n)&&(Object.hasOwn(t,n)?Array.isArray(t[n])?t[n].push(e[n]):t[n]=[t[n],e[n]]:t[n]=e[n]);return t}function gn(...l){return l.flat().reduce((e,t)=>(e[t]=t,e),{})}var to,Cc;function Ep(){if(Cc)return to;Cc=1;var l="__lodash_hash_undefined__";function e(t){return this.__data__.set(t,l),this}return to=e,to}var no,Sc;function Tp(){if(Sc)return no;Sc=1;function l(e){return this.__data__.has(e)}return no=l,no}var io,Ac;function Mp(){if(Ac)return io;Ac=1;var l=Rs(),e=Ep(),t=Tp();function n(p){var d=-1,g=p==null?0:p.length;for(this.__data__=new l;++d<g;)this.add(p[d])}return n.prototype.add=n.prototype.push=e,n.prototype.has=t,io=n,io}var ro,$c;function _p(){if($c)return ro;$c=1;function l(e,t){for(var n=-1,p=e==null?0:e.length;++n<p;)if(t(e[n],n,e))return!0;return!1}return ro=l,ro}var oo,Ec;function xp(){if(Ec)return oo;Ec=1;function l(e,t){return e.has(t)}return oo=l,oo}var so,Tc;function Sh(){if(Tc)return so;Tc=1;var l=Mp(),e=_p(),t=xp(),n=1,p=2;function d(g,m,c,f,r,o){var s=c&n,a=g.length,i=m.length;if(a!=i&&!(s&&i>a))return!1;var u=o.get(g),h=o.get(m);if(u&&h)return u==m&&h==g;var y=-1,b=!0,T=c&p?new l:void 0;for(o.set(g,m),o.set(m,g);++y<a;){var $=g[y],A=m[y];if(f)var S=s?f(A,$,y,m,g,o):f($,A,y,g,m,o);if(S!==void 0){if(S)continue;b=!1;break}if(T){if(!e(m,function(M,R){if(!t(T,R)&&($===M||r($,M,c,f,o)))return T.push(R)})){b=!1;break}}else if(!($===A||r($,A,c,f,o))){b=!1;break}}return o.delete(g),o.delete(m),b}return so=d,so}var ao,Mc;function Lp(){if(Mc)return ao;Mc=1;function l(e){var t=-1,n=Array(e.size);return e.forEach(function(p,d){n[++t]=[d,p]}),n}return ao=l,ao}var lo,_c;function Rp(){if(_c)return lo;_c=1;function l(e){var t=-1,n=Array(e.size);return e.forEach(function(p){n[++t]=p}),n}return lo=l,lo}var co,xc;function kp(){if(xc)return co;xc=1;var l=Pn(),e=Gu(),t=nn(),n=Sh(),p=Lp(),d=Rp(),g=1,m=2,c="[object Boolean]",f="[object Date]",r="[object Error]",o="[object Map]",s="[object Number]",a="[object RegExp]",i="[object Set]",u="[object String]",h="[object Symbol]",y="[object ArrayBuffer]",b="[object DataView]",T=l?l.prototype:void 0,$=T?T.valueOf:void 0;function A(S,M,R,L,_,O,w){switch(R){case b:if(S.byteLength!=M.byteLength||S.byteOffset!=M.byteOffset)return!1;S=S.buffer,M=M.buffer;case y:return!(S.byteLength!=M.byteLength||!O(new e(S),new e(M)));case c:case f:case s:return t(+S,+M);case r:return S.name==M.name&&S.message==M.message;case a:case u:return S==M+"";case o:var v=p;case i:var C=L&g;if(v||(v=d),S.size!=M.size&&!C)return!1;var E=w.get(S);if(E)return E==M;L|=m,w.set(S,M);var x=n(v(S),v(M),L,_,O,w);return w.delete(S),x;case h:if($)return $.call(S)==$.call(M)}return!1}return co=A,co}var uo,Lc;function Op(){if(Lc)return uo;Lc=1;function l(e,t){for(var n=-1,p=t.length,d=e.length;++n<p;)e[d+n]=t[n];return e}return uo=l,uo}var ho,Rc;function Dp(){if(Rc)return ho;Rc=1;var l=Op(),e=wt();function t(n,p,d){var g=p(n);return e(n)?g:l(g,d(n))}return ho=t,ho}var fo,kc;function Ip(){if(kc)return fo;kc=1;function l(e,t){for(var n=-1,p=e==null?0:e.length,d=0,g=[];++n<p;){var m=e[n];t(m,n,e)&&(g[d++]=m)}return g}return fo=l,fo}var po,Oc;function Np(){if(Oc)return po;Oc=1;function l(){return[]}return po=l,po}var go,Dc;function Fp(){if(Dc)return go;Dc=1;var l=Ip(),e=Np(),t=Object.prototype,n=t.propertyIsEnumerable,p=Object.getOwnPropertySymbols,d=p?function(g){return g==null?[]:(g=Object(g),l(p(g),function(m){return n.call(g,m)}))}:e;return go=d,go}var mo,Ic;function Pp(){if(Ic)return mo;Ic=1;var l=Vu(),e=l(Object.keys,Object);return mo=e,mo}var vo,Nc;function Wp(){if(Nc)return vo;Nc=1;var l=Os(),e=Pp(),t=Object.prototype,n=t.hasOwnProperty;function p(d){if(!l(d))return e(d);var g=[];for(var m in Object(d))n.call(d,m)&&m!="constructor"&&g.push(m);return g}return vo=p,vo}var yo,Fc;function Bp(){if(Fc)return yo;Fc=1;var l=Zu(),e=Wp(),t=Hn();function n(p){return t(p)?l(p):e(p)}return yo=n,yo}var bo,Pc;function Hp(){if(Pc)return bo;Pc=1;var l=Dp(),e=Fp(),t=Bp();function n(p){return l(p,t,e)}return bo=n,bo}var wo,Wc;function zp(){if(Wc)return wo;Wc=1;var l=Hp(),e=1,t=Object.prototype,n=t.hasOwnProperty;function p(d,g,m,c,f,r){var o=m&e,s=l(d),a=s.length,i=l(g),u=i.length;if(a!=u&&!o)return!1;for(var h=a;h--;){var y=s[h];if(!(o?y in g:n.call(g,y)))return!1}var b=r.get(d),T=r.get(g);if(b&&T)return b==g&&T==d;var $=!0;r.set(d,g),r.set(g,d);for(var A=o;++h<a;){y=s[h];var S=d[y],M=g[y];if(c)var R=o?c(M,S,y,g,d,r):c(S,M,y,d,g,r);if(!(R===void 0?S===M||f(S,M,m,c,r):R)){$=!1;break}A||(A=y=="constructor")}if($&&!A){var L=d.constructor,_=g.constructor;L!=_&&"constructor"in d&&"constructor"in g&&!(typeof L=="function"&&L instanceof L&&typeof _=="function"&&_ instanceof _)&&($=!1)}return r.delete(d),r.delete(g),$}return wo=p,wo}var Co,Bc;function jp(){if(Bc)return Co;Bc=1;var l=yt(),e=Ve(),t=l(e,"DataView");return Co=t,Co}var So,Hc;function Up(){if(Hc)return So;Hc=1;var l=yt(),e=Ve(),t=l(e,"Promise");return So=t,So}var Ao,zc;function Gp(){if(zc)return Ao;zc=1;var l=yt(),e=Ve(),t=l(e,"Set");return Ao=t,Ao}var $o,jc;function Vp(){if(jc)return $o;jc=1;var l=yt(),e=Ve(),t=l(e,"WeakMap");return $o=t,$o}var Eo,Uc;function Kp(){if(Uc)return Eo;Uc=1;var l=jp(),e=Ls(),t=Up(),n=Gp(),p=Vp(),d=kt(),g=Hu(),m="[object Map]",c="[object Object]",f="[object Promise]",r="[object Set]",o="[object WeakMap]",s="[object DataView]",a=g(l),i=g(e),u=g(t),h=g(n),y=g(p),b=d;return(l&&b(new l(new ArrayBuffer(1)))!=s||e&&b(new e)!=m||t&&b(t.resolve())!=f||n&&b(new n)!=r||p&&b(new p)!=o)&&(b=function(T){var $=d(T),A=$==c?T.constructor:void 0,S=A?g(A):"";if(S)switch(S){case a:return s;case i:return m;case u:return f;case h:return r;case y:return o}return $}),Eo=b,Eo}var To,Gc;function qp(){if(Gc)return To;Gc=1;var l=zu(),e=Sh(),t=kp(),n=zp(),p=Kp(),d=wt(),g=Ds(),m=Is(),c=1,f="[object Arguments]",r="[object Array]",o="[object Object]",s=Object.prototype,a=s.hasOwnProperty;function i(u,h,y,b,T,$){var A=d(u),S=d(h),M=A?r:p(u),R=S?r:p(h);M=M==f?o:M,R=R==f?o:R;var L=M==o,_=R==o,O=M==R;if(O&&g(u)){if(!g(h))return!1;A=!0,L=!1}if(O&&!L)return $||($=new l),A||m(u)?e(u,h,y,b,T,$):t(u,h,M,y,b,T,$);if(!(y&c)){var w=L&&a.call(u,"__wrapped__"),v=_&&a.call(h,"__wrapped__");if(w||v){var C=w?u.value():u,E=v?h.value():h;return $||($=new l),T(C,E,y,b,$)}}return O?($||($=new l),n(u,h,y,b,T,$)):!1}return To=i,To}var Mo,Vc;function Yp(){if(Vc)return Mo;Vc=1;var l=qp(),e=bt();function t(n,p,d,g,m){return n===p?!0:n==null||p==null||!e(n)&&!e(p)?n!==n&&p!==p:l(n,p,d,g,t,m)}return Mo=t,Mo}var _o,Kc;function Xp(){if(Kc)return _o;Kc=1;var l=Yp();function e(t,n){return l(t,n)}return _o=e,_o}var Qp=Xp();const As=Rt(Qp),Zp=(l,e)=>l===void 0?"added":e===void 0?"removed":As(l,e)?"unchanged":"changed";class Qs{constructor(e,t=Object.create(null)){this.name=e,this.data=t,this.dataPath=""}get size(){return Object.keys(this.data).length}get js(){return this.data}get json(){return this.data}toJSON=(e,t)=>JSON.stringify(e,null,t);get=e=>Ie(this.data,e);set(e,t){const n=Ie(this.data,e),p=Gn(this.data,e,t),d=Array.isArray(e)?e.join("."):e,g=Object.keys(this.setCallbacks).filter(c=>new RegExp(c).test(d)),m={newVal:t,oldVal:n,path:e};for(const c of g)for(const f of this.setCallbacks[c])f(m);if(!this.disableEvents){const c={entity:this,dataPath:this.dataPath.replace(/\.+$/,""),changePath:this.dataPath+e,value:t,data:p,changeType:Zp(n,t),src:this.dom};if(n&&(c.previousValue=n),J.formeoUpdated(c),this.name){const r={stage:uh,row:hh,column:dh,field:fh}[this.name];r&&J.formeoUpdated(c,r)}}return p}addSetCallback(e,t){this.setCallbacks[e]?this.setCallbacks[e].push(t):this.setCallbacks[e]=[t]}removeSetCallback(e,t){this.setCallbacks[e]=this.setCallbacks[e].filter(n=>n!==t)}add=(e,t=Object.create(null))=>{const{id:n}=t,p=e||n||We();return this.set(p,t)};remove=e=>{const t=vt(e),n=t.pop(),p=this.get(t);return Array.isArray(p)?p.splice(Number(n),1):p&&delete p[n],p};empty(){this.data=Object.create(null)}getData=()=>Object.entries(this.data).reduce((e,[t,n])=>(e[t]=n?.data?n.getData():n,e),{});setCallbacks={};configVal=Object.create(null)}class Vn extends Qs{load=e=>{const t=zn(e);this.empty();for(const[n,p]of Object.entries(t))this.add(n,p);return this.data};get=e=>e?Ie(this.data,e):this.add();add=(e,t=Object.create(null))=>{const n=e||We(),p=this.Component({...t,id:n});this.data[n]=p,this.active=p;const g={row:js,column:Us,field:Gs}[this.name];return g&&J.formeoUpdated({entity:p,componentId:n,componentType:this.name,data:p.data},g),p};remove=e=>{if(Array.isArray(e))for(const t of e)this.get(t).remove();else this.get(e).remove();return this.data};delete=e=>(delete this.data[e],e);clearAll=(e=!0)=>{const t=Object.values(this.data).map(n=>n.empty(e));return Promise.all(t)};set config(e){this.configVal=je(this.configVal,Xe(e))}get config(){return this.configVal}conditionMap=new Map}function qc(l,e){var t=Object.keys(l);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(l);e&&(n=n.filter(function(p){return Object.getOwnPropertyDescriptor(l,p).enumerable})),t.push.apply(t,n)}return t}function Ge(l){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?qc(Object(t),!0).forEach(function(n){Jp(l,n,t[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(l,Object.getOwnPropertyDescriptors(t)):qc(Object(t)).forEach(function(n){Object.defineProperty(l,n,Object.getOwnPropertyDescriptor(t,n))})}return l}function mn(l){"@babel/helpers - typeof";return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?mn=function(e){return typeof e}:mn=function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},mn(l)}function Jp(l,e,t){return e in l?Object.defineProperty(l,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):l[e]=t,l}function Je(){return Je=Object.assign||function(l){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(l[n]=t[n])}return l},Je.apply(this,arguments)}function eg(l,e){if(l==null)return{};var t={},n=Object.keys(l),p,d;for(d=0;d<n.length;d++)p=n[d],!(e.indexOf(p)>=0)&&(t[p]=l[p]);return t}function tg(l,e){if(l==null)return{};var t=eg(l,e),n,p;if(Object.getOwnPropertySymbols){var d=Object.getOwnPropertySymbols(l);for(p=0;p<d.length;p++)n=d[p],!(e.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(l,n)&&(t[n]=l[n])}return t}var ng="1.15.3";function Ye(l){if(typeof window<"u"&&window.navigator)return!!navigator.userAgent.match(l)}var tt=Ye(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),rn=Ye(/Edge/i),Yc=Ye(/firefox/i),Kt=Ye(/safari/i)&&!Ye(/chrome/i)&&!Ye(/android/i),Ah=Ye(/iP(ad|od|hone)/i),$h=Ye(/chrome/i)&&Ye(/android/i),Eh={capture:!1,passive:!1};function se(l,e,t){l.addEventListener(e,t,!tt&&Eh)}function oe(l,e,t){l.removeEventListener(e,t,!tt&&Eh)}function Mn(l,e){if(e){if(e[0]===">"&&(e=e.substring(1)),l)try{if(l.matches)return l.matches(e);if(l.msMatchesSelector)return l.msMatchesSelector(e);if(l.webkitMatchesSelector)return l.webkitMatchesSelector(e)}catch{return!1}return!1}}function Th(l){return l.host&&l!==document&&l.host.nodeType?l.host:l.parentNode}function ze(l,e,t,n){if(l){t=t||document;do{if(e!=null&&(e[0]===">"?l.parentNode===t&&Mn(l,e):Mn(l,e))||n&&l===t)return l;if(l===t)break}while(l=Th(l))}return null}var Xc=/\s+/g;function Oe(l,e,t){if(l&&e)if(l.classList)l.classList[t?"add":"remove"](e);else{var n=(" "+l.className+" ").replace(Xc," ").replace(" "+e+" "," ");l.className=(n+(t?" "+e:"")).replace(Xc," ")}}function ne(l,e,t){var n=l&&l.style;if(n){if(t===void 0)return document.defaultView&&document.defaultView.getComputedStyle?t=document.defaultView.getComputedStyle(l,""):l.currentStyle&&(t=l.currentStyle),e===void 0?t:t[e];!(e in n)&&e.indexOf("webkit")===-1&&(e="-webkit-"+e),n[e]=t+(typeof t=="string"?"":"px")}}function Mt(l,e){var t="";if(typeof l=="string")t=l;else do{var n=ne(l,"transform");n&&n!=="none"&&(t=n+" "+t)}while(!e&&(l=l.parentNode));var p=window.DOMMatrix||window.WebKitCSSMatrix||window.CSSMatrix||window.MSCSSMatrix;return p&&new p(t)}function Mh(l,e,t){if(l){var n=l.getElementsByTagName(e),p=0,d=n.length;if(t)for(;p<d;p++)t(n[p],p);return n}return[]}function Ue(){var l=document.scrollingElement;return l||document.documentElement}function we(l,e,t,n,p){if(!(!l.getBoundingClientRect&&l!==window)){var d,g,m,c,f,r,o;if(l!==window&&l.parentNode&&l!==Ue()?(d=l.getBoundingClientRect(),g=d.top,m=d.left,c=d.bottom,f=d.right,r=d.height,o=d.width):(g=0,m=0,c=window.innerHeight,f=window.innerWidth,r=window.innerHeight,o=window.innerWidth),(e||t)&&l!==window&&(p=p||l.parentNode,!tt))do if(p&&p.getBoundingClientRect&&(ne(p,"transform")!=="none"||t&&ne(p,"position")!=="static")){var s=p.getBoundingClientRect();g-=s.top+parseInt(ne(p,"border-top-width")),m-=s.left+parseInt(ne(p,"border-left-width")),c=g+d.height,f=m+d.width;break}while(p=p.parentNode);if(n&&l!==window){var a=Mt(p||l),i=a&&a.a,u=a&&a.d;a&&(g/=u,m/=i,o/=i,r/=u,c=g+r,f=m+o)}return{top:g,left:m,bottom:c,right:f,width:o,height:r}}}function Qc(l,e,t){for(var n=rt(l,!0),p=we(l)[e];n;){var d=we(n)[t],g=void 0;if(g=p>=d,!g)return n;if(n===Ue())break;n=rt(n,!1)}return!1}function _t(l,e,t,n){for(var p=0,d=0,g=l.children;d<g.length;){if(g[d].style.display!=="none"&&g[d]!==te.ghost&&(n||g[d]!==te.dragged)&&ze(g[d],t.draggable,l,!1)){if(p===e)return g[d];p++}d++}return null}function Zs(l,e){for(var t=l.lastElementChild;t&&(t===te.ghost||ne(t,"display")==="none"||e&&!Mn(t,e));)t=t.previousElementSibling;return t||null}function Fe(l,e){var t=0;if(!l||!l.parentNode)return-1;for(;l=l.previousElementSibling;)l.nodeName.toUpperCase()!=="TEMPLATE"&&l!==te.clone&&(!e||Mn(l,e))&&t++;return t}function Zc(l){var e=0,t=0,n=Ue();if(l)do{var p=Mt(l),d=p.a,g=p.d;e+=l.scrollLeft*d,t+=l.scrollTop*g}while(l!==n&&(l=l.parentNode));return[e,t]}function ig(l,e){for(var t in l)if(l.hasOwnProperty(t)){for(var n in e)if(e.hasOwnProperty(n)&&e[n]===l[t][n])return Number(t)}return-1}function rt(l,e){if(!l||!l.getBoundingClientRect)return Ue();var t=l,n=!1;do if(t.clientWidth<t.scrollWidth||t.clientHeight<t.scrollHeight){var p=ne(t);if(t.clientWidth<t.scrollWidth&&(p.overflowX=="auto"||p.overflowX=="scroll")||t.clientHeight<t.scrollHeight&&(p.overflowY=="auto"||p.overflowY=="scroll")){if(!t.getBoundingClientRect||t===document.body)return Ue();if(n||e)return t;n=!0}}while(t=t.parentNode);return Ue()}function rg(l,e){if(l&&e)for(var t in e)e.hasOwnProperty(t)&&(l[t]=e[t]);return l}function xo(l,e){return Math.round(l.top)===Math.round(e.top)&&Math.round(l.left)===Math.round(e.left)&&Math.round(l.height)===Math.round(e.height)&&Math.round(l.width)===Math.round(e.width)}var qt;function _h(l,e){return function(){if(!qt){var t=arguments,n=this;t.length===1?l.call(n,t[0]):l.apply(n,t),qt=setTimeout(function(){qt=void 0},e)}}}function og(){clearTimeout(qt),qt=void 0}function xh(l,e,t){l.scrollLeft+=e,l.scrollTop+=t}function Lh(l){var e=window.Polymer,t=window.jQuery||window.Zepto;return e&&e.dom?e.dom(l).cloneNode(!0):t?t(l).clone(!0)[0]:l.cloneNode(!0)}function Rh(l,e,t){var n={};return Array.from(l.children).forEach(function(p){var d,g,m,c;if(!(!ze(p,e.draggable,l,!1)||p.animated||p===t)){var f=we(p);n.left=Math.min((d=n.left)!==null&&d!==void 0?d:1/0,f.left),n.top=Math.min((g=n.top)!==null&&g!==void 0?g:1/0,f.top),n.right=Math.max((m=n.right)!==null&&m!==void 0?m:-1/0,f.right),n.bottom=Math.max((c=n.bottom)!==null&&c!==void 0?c:-1/0,f.bottom)}}),n.width=n.right-n.left,n.height=n.bottom-n.top,n.x=n.left,n.y=n.top,n}var Re="Sortable"+new Date().getTime();function sg(){var l=[],e;return{captureAnimationState:function(){if(l=[],!!this.options.animation){var n=[].slice.call(this.el.children);n.forEach(function(p){if(!(ne(p,"display")==="none"||p===te.ghost)){l.push({target:p,rect:we(p)});var d=Ge({},l[l.length-1].rect);if(p.thisAnimationDuration){var g=Mt(p,!0);g&&(d.top-=g.f,d.left-=g.e)}p.fromRect=d}})}},addAnimationState:function(n){l.push(n)},removeAnimationState:function(n){l.splice(ig(l,{target:n}),1)},animateAll:function(n){var p=this;if(!this.options.animation){clearTimeout(e),typeof n=="function"&&n();return}var d=!1,g=0;l.forEach(function(m){var c=0,f=m.target,r=f.fromRect,o=we(f),s=f.prevFromRect,a=f.prevToRect,i=m.rect,u=Mt(f,!0);u&&(o.top-=u.f,o.left-=u.e),f.toRect=o,f.thisAnimationDuration&&xo(s,o)&&!xo(r,o)&&(i.top-o.top)/(i.left-o.left)===(r.top-o.top)/(r.left-o.left)&&(c=lg(i,s,a,p.options)),xo(o,r)||(f.prevFromRect=r,f.prevToRect=o,c||(c=p.options.animation),p.animate(f,i,o,c)),c&&(d=!0,g=Math.max(g,c),clearTimeout(f.animationResetTimer),f.animationResetTimer=setTimeout(function(){f.animationTime=0,f.prevFromRect=null,f.fromRect=null,f.prevToRect=null,f.thisAnimationDuration=null},c),f.thisAnimationDuration=c)}),clearTimeout(e),d?e=setTimeout(function(){typeof n=="function"&&n()},g):typeof n=="function"&&n(),l=[]},animate:function(n,p,d,g){if(g){ne(n,"transition",""),ne(n,"transform","");var m=Mt(this.el),c=m&&m.a,f=m&&m.d,r=(p.left-d.left)/(c||1),o=(p.top-d.top)/(f||1);n.animatingX=!!r,n.animatingY=!!o,ne(n,"transform","translate3d("+r+"px,"+o+"px,0)"),this.forRepaintDummy=ag(n),ne(n,"transition","transform "+g+"ms"+(this.options.easing?" "+this.options.easing:"")),ne(n,"transform","translate3d(0,0,0)"),typeof n.animated=="number"&&clearTimeout(n.animated),n.animated=setTimeout(function(){ne(n,"transition",""),ne(n,"transform",""),n.animated=!1,n.animatingX=!1,n.animatingY=!1},g)}}}}function ag(l){return l.offsetWidth}function lg(l,e,t,n){return Math.sqrt(Math.pow(e.top-l.top,2)+Math.pow(e.left-l.left,2))/Math.sqrt(Math.pow(e.top-t.top,2)+Math.pow(e.left-t.left,2))*n.animation}var Ct=[],Lo={initializeByDefault:!0},on={mount:function(e){for(var t in Lo)Lo.hasOwnProperty(t)&&!(t in e)&&(e[t]=Lo[t]);Ct.forEach(function(n){if(n.pluginName===e.pluginName)throw"Sortable: Cannot mount plugin ".concat(e.pluginName," more than once")}),Ct.push(e)},pluginEvent:function(e,t,n){var p=this;this.eventCanceled=!1,n.cancel=function(){p.eventCanceled=!0};var d=e+"Global";Ct.forEach(function(g){t[g.pluginName]&&(t[g.pluginName][d]&&t[g.pluginName][d](Ge({sortable:t},n)),t.options[g.pluginName]&&t[g.pluginName][e]&&t[g.pluginName][e](Ge({sortable:t},n)))})},initializePlugins:function(e,t,n,p){Ct.forEach(function(m){var c=m.pluginName;if(!(!e.options[c]&&!m.initializeByDefault)){var f=new m(e,t,e.options);f.sortable=e,f.options=e.options,e[c]=f,Je(n,f.defaults)}});for(var d in e.options)if(e.options.hasOwnProperty(d)){var g=this.modifyOption(e,d,e.options[d]);typeof g<"u"&&(e.options[d]=g)}},getEventProperties:function(e,t){var n={};return Ct.forEach(function(p){typeof p.eventProperties=="function"&&Je(n,p.eventProperties.call(t[p.pluginName],e))}),n},modifyOption:function(e,t,n){var p;return Ct.forEach(function(d){e[d.pluginName]&&d.optionListeners&&typeof d.optionListeners[t]=="function"&&(p=d.optionListeners[t].call(e[d.pluginName],n))}),p}};function cg(l){var e=l.sortable,t=l.rootEl,n=l.name,p=l.targetEl,d=l.cloneEl,g=l.toEl,m=l.fromEl,c=l.oldIndex,f=l.newIndex,r=l.oldDraggableIndex,o=l.newDraggableIndex,s=l.originalEvent,a=l.putSortable,i=l.extraEventProperties;if(e=e||t&&t[Re],!!e){var u,h=e.options,y="on"+n.charAt(0).toUpperCase()+n.substr(1);window.CustomEvent&&!tt&&!rn?u=new CustomEvent(n,{bubbles:!0,cancelable:!0}):(u=document.createEvent("Event"),u.initEvent(n,!0,!0)),u.to=g||t,u.from=m||t,u.item=p||t,u.clone=d,u.oldIndex=c,u.newIndex=f,u.oldDraggableIndex=r,u.newDraggableIndex=o,u.originalEvent=s,u.pullMode=a?a.lastPutMode:void 0;var b=Ge(Ge({},i),on.getEventProperties(n,e));for(var T in b)u[T]=b[T];t&&t.dispatchEvent(u),h[y]&&h[y].call(e,u)}}var ug=["evt"],xe=function(e,t){var n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},p=n.evt,d=tg(n,ug);on.pluginEvent.bind(te)(e,t,Ge({dragEl:K,parentEl:ve,ghostEl:ie,rootEl:fe,nextEl:pt,lastDownEl:vn,cloneEl:pe,cloneHidden:it,dragStarted:zt,putSortable:Se,activeSortable:te.active,originalEvent:p,oldIndex:Et,oldDraggableIndex:Yt,newIndex:De,newDraggableIndex:nt,hideGhostForTarget:Ih,unhideGhostForTarget:Nh,cloneNowHidden:function(){it=!0},cloneNowShown:function(){it=!1},dispatchSortableEvent:function(m){Ee({sortable:t,name:m,originalEvent:p})}},d))};function Ee(l){cg(Ge({putSortable:Se,cloneEl:pe,targetEl:K,rootEl:fe,oldIndex:Et,oldDraggableIndex:Yt,newIndex:De,newDraggableIndex:nt},l))}var K,ve,ie,fe,pt,vn,pe,it,Et,De,Yt,nt,ln,Se,At=!1,_n=!1,xn=[],dt,Be,Ro,ko,Jc,eu,zt,St,Xt,Qt=!1,cn=!1,yn,Ae,Oo=[],$s=!1,Ln=[],Kn=typeof document<"u",un=Ah,tu=rn||tt?"cssFloat":"float",hg=Kn&&!$h&&!Ah&&"draggable"in document.createElement("div"),kh=(function(){if(Kn){if(tt)return!1;var l=document.createElement("x");return l.style.cssText="pointer-events:auto",l.style.pointerEvents==="auto"}})(),Oh=function(e,t){var n=ne(e),p=parseInt(n.width)-parseInt(n.paddingLeft)-parseInt(n.paddingRight)-parseInt(n.borderLeftWidth)-parseInt(n.borderRightWidth),d=_t(e,0,t),g=_t(e,1,t),m=d&&ne(d),c=g&&ne(g),f=m&&parseInt(m.marginLeft)+parseInt(m.marginRight)+we(d).width,r=c&&parseInt(c.marginLeft)+parseInt(c.marginRight)+we(g).width;if(n.display==="flex")return n.flexDirection==="column"||n.flexDirection==="column-reverse"?"vertical":"horizontal";if(n.display==="grid")return n.gridTemplateColumns.split(" ").length<=1?"vertical":"horizontal";if(d&&m.float&&m.float!=="none"){var o=m.float==="left"?"left":"right";return g&&(c.clear==="both"||c.clear===o)?"vertical":"horizontal"}return d&&(m.display==="block"||m.display==="flex"||m.display==="table"||m.display==="grid"||f>=p&&n[tu]==="none"||g&&n[tu]==="none"&&f+r>p)?"vertical":"horizontal"},dg=function(e,t,n){var p=n?e.left:e.top,d=n?e.right:e.bottom,g=n?e.width:e.height,m=n?t.left:t.top,c=n?t.right:t.bottom,f=n?t.width:t.height;return p===m||d===c||p+g/2===m+f/2},fg=function(e,t){var n;return xn.some(function(p){var d=p[Re].options.emptyInsertThreshold;if(!(!d||Zs(p))){var g=we(p),m=e>=g.left-d&&e<=g.right+d,c=t>=g.top-d&&t<=g.bottom+d;if(m&&c)return n=p}}),n},Dh=function(e){function t(d,g){return function(m,c,f,r){var o=m.options.group.name&&c.options.group.name&&m.options.group.name===c.options.group.name;if(d==null&&(g||o))return!0;if(d==null||d===!1)return!1;if(g&&d==="clone")return d;if(typeof d=="function")return t(d(m,c,f,r),g)(m,c,f,r);var s=(g?m:c).options.group.name;return d===!0||typeof d=="string"&&d===s||d.join&&d.indexOf(s)>-1}}var n={},p=e.group;(!p||mn(p)!="object")&&(p={name:p}),n.name=p.name,n.checkPull=t(p.pull,!0),n.checkPut=t(p.put),n.revertClone=p.revertClone,e.group=n},Ih=function(){!kh&&ie&&ne(ie,"display","none")},Nh=function(){!kh&&ie&&ne(ie,"display","")};Kn&&!$h&&document.addEventListener("click",function(l){if(_n)return l.preventDefault(),l.stopPropagation&&l.stopPropagation(),l.stopImmediatePropagation&&l.stopImmediatePropagation(),_n=!1,!1},!0);var ft=function(e){if(K){e=e.touches?e.touches[0]:e;var t=fg(e.clientX,e.clientY);if(t){var n={};for(var p in e)e.hasOwnProperty(p)&&(n[p]=e[p]);n.target=n.rootEl=t,n.preventDefault=void 0,n.stopPropagation=void 0,t[Re]._onDragOver(n)}}},pg=function(e){K&&K.parentNode[Re]._isOutsideThisEl(e.target)};function te(l,e){if(!(l&&l.nodeType&&l.nodeType===1))throw"Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(l));this.el=l,this.options=e=Je({},e),l[Re]=this;var t={group:null,sort:!0,disabled:!1,store:null,handle:null,draggable:/^[uo]l$/i.test(l.nodeName)?">li":">*",swapThreshold:1,invertSwap:!1,invertedSwapThreshold:null,removeCloneOnHide:!0,direction:function(){return Oh(l,this.options)},ghostClass:"sortable-ghost",chosenClass:"sortable-chosen",dragClass:"sortable-drag",ignore:"a, img",filter:null,preventOnFilter:!0,animation:0,easing:null,setData:function(g,m){g.setData("Text",m.textContent)},dropBubble:!1,dragoverBubble:!1,dataIdAttr:"data-id",delay:0,delayOnTouchOnly:!1,touchStartThreshold:(Number.parseInt?Number:window).parseInt(window.devicePixelRatio,10)||1,forceFallback:!1,fallbackClass:"sortable-fallback",fallbackOnBody:!1,fallbackTolerance:0,fallbackOffset:{x:0,y:0},supportPointer:te.supportPointer!==!1&&"PointerEvent"in window&&!Kt,emptyInsertThreshold:5};on.initializePlugins(this,l,t);for(var n in t)!(n in e)&&(e[n]=t[n]);Dh(e);for(var p in this)p.charAt(0)==="_"&&typeof this[p]=="function"&&(this[p]=this[p].bind(this));this.nativeDraggable=e.forceFallback?!1:hg,this.nativeDraggable&&(this.options.touchStartThreshold=1),e.supportPointer?se(l,"pointerdown",this._onTapStart):(se(l,"mousedown",this._onTapStart),se(l,"touchstart",this._onTapStart)),this.nativeDraggable&&(se(l,"dragover",this),se(l,"dragenter",this)),xn.push(this.el),e.store&&e.store.get&&this.sort(e.store.get(this)||[]),Je(this,sg())}te.prototype={constructor:te,_isOutsideThisEl:function(e){!this.el.contains(e)&&e!==this.el&&(St=null)},_getDirection:function(e,t){return typeof this.options.direction=="function"?this.options.direction.call(this,e,t,K):this.options.direction},_onTapStart:function(e){if(e.cancelable){var t=this,n=this.el,p=this.options,d=p.preventOnFilter,g=e.type,m=e.touches&&e.touches[0]||e.pointerType&&e.pointerType==="touch"&&e,c=(m||e).target,f=e.target.shadowRoot&&(e.path&&e.path[0]||e.composedPath&&e.composedPath()[0])||c,r=p.filter;if(Sg(n),!K&&!(/mousedown|pointerdown/.test(g)&&e.button!==0||p.disabled)&&!f.isContentEditable&&!(!this.nativeDraggable&&Kt&&c&&c.tagName.toUpperCase()==="SELECT")&&(c=ze(c,p.draggable,n,!1),!(c&&c.animated)&&vn!==c)){if(Et=Fe(c),Yt=Fe(c,p.draggable),typeof r=="function"){if(r.call(this,e,c,this)){Ee({sortable:t,rootEl:f,name:"filter",targetEl:c,toEl:n,fromEl:n}),xe("filter",t,{evt:e}),d&&e.cancelable&&e.preventDefault();return}}else if(r&&(r=r.split(",").some(function(o){if(o=ze(f,o.trim(),n,!1),o)return Ee({sortable:t,rootEl:o,name:"filter",targetEl:c,fromEl:n,toEl:n}),xe("filter",t,{evt:e}),!0}),r)){d&&e.cancelable&&e.preventDefault();return}p.handle&&!ze(f,p.handle,n,!1)||this._prepareDragStart(e,m,c)}}},_prepareDragStart:function(e,t,n){var p=this,d=p.el,g=p.options,m=d.ownerDocument,c;if(n&&!K&&n.parentNode===d){var f=we(n);if(fe=d,K=n,ve=K.parentNode,pt=K.nextSibling,vn=n,ln=g.group,te.dragged=K,dt={target:K,clientX:(t||e).clientX,clientY:(t||e).clientY},Jc=dt.clientX-f.left,eu=dt.clientY-f.top,this._lastX=(t||e).clientX,this._lastY=(t||e).clientY,K.style["will-change"]="all",c=function(){if(xe("delayEnded",p,{evt:e}),te.eventCanceled){p._onDrop();return}p._disableDelayedDragEvents(),!Yc&&p.nativeDraggable&&(K.draggable=!0),p._triggerDragStart(e,t),Ee({sortable:p,name:"choose",originalEvent:e}),Oe(K,g.chosenClass,!0)},g.ignore.split(",").forEach(function(r){Mh(K,r.trim(),Do)}),se(m,"dragover",ft),se(m,"mousemove",ft),se(m,"touchmove",ft),se(m,"mouseup",p._onDrop),se(m,"touchend",p._onDrop),se(m,"touchcancel",p._onDrop),Yc&&this.nativeDraggable&&(this.options.touchStartThreshold=4,K.draggable=!0),xe("delayStart",this,{evt:e}),g.delay&&(!g.delayOnTouchOnly||t)&&(!this.nativeDraggable||!(rn||tt))){if(te.eventCanceled){this._onDrop();return}se(m,"mouseup",p._disableDelayedDrag),se(m,"touchend",p._disableDelayedDrag),se(m,"touchcancel",p._disableDelayedDrag),se(m,"mousemove",p._delayedDragTouchMoveHandler),se(m,"touchmove",p._delayedDragTouchMoveHandler),g.supportPointer&&se(m,"pointermove",p._delayedDragTouchMoveHandler),p._dragStartTimer=setTimeout(c,g.delay)}else c()}},_delayedDragTouchMoveHandler:function(e){var t=e.touches?e.touches[0]:e;Math.max(Math.abs(t.clientX-this._lastX),Math.abs(t.clientY-this._lastY))>=Math.floor(this.options.touchStartThreshold/(this.nativeDraggable&&window.devicePixelRatio||1))&&this._disableDelayedDrag()},_disableDelayedDrag:function(){K&&Do(K),clearTimeout(this._dragStartTimer),this._disableDelayedDragEvents()},_disableDelayedDragEvents:function(){var e=this.el.ownerDocument;oe(e,"mouseup",this._disableDelayedDrag),oe(e,"touchend",this._disableDelayedDrag),oe(e,"touchcancel",this._disableDelayedDrag),oe(e,"mousemove",this._delayedDragTouchMoveHandler),oe(e,"touchmove",this._delayedDragTouchMoveHandler),oe(e,"pointermove",this._delayedDragTouchMoveHandler)},_triggerDragStart:function(e,t){t=t||e.pointerType=="touch"&&e,!this.nativeDraggable||t?this.options.supportPointer?se(document,"pointermove",this._onTouchMove):t?se(document,"touchmove",this._onTouchMove):se(document,"mousemove",this._onTouchMove):(se(K,"dragend",this),se(fe,"dragstart",this._onDragStart));try{document.selection?bn(function(){document.selection.empty()}):window.getSelection().removeAllRanges()}catch{}},_dragStarted:function(e,t){if(At=!1,fe&&K){xe("dragStarted",this,{evt:t}),this.nativeDraggable&&se(document,"dragover",pg);var n=this.options;!e&&Oe(K,n.dragClass,!1),Oe(K,n.ghostClass,!0),te.active=this,e&&this._appendGhost(),Ee({sortable:this,name:"start",originalEvent:t})}else this._nulling()},_emulateDragOver:function(){if(Be){this._lastX=Be.clientX,this._lastY=Be.clientY,Ih();for(var e=document.elementFromPoint(Be.clientX,Be.clientY),t=e;e&&e.shadowRoot&&(e=e.shadowRoot.elementFromPoint(Be.clientX,Be.clientY),e!==t);)t=e;if(K.parentNode[Re]._isOutsideThisEl(e),t)do{if(t[Re]){var n=void 0;if(n=t[Re]._onDragOver({clientX:Be.clientX,clientY:Be.clientY,target:e,rootEl:t}),n&&!this.options.dragoverBubble)break}e=t}while(t=Th(t));Nh()}},_onTouchMove:function(e){if(dt){var t=this.options,n=t.fallbackTolerance,p=t.fallbackOffset,d=e.touches?e.touches[0]:e,g=ie&&Mt(ie,!0),m=ie&&g&&g.a,c=ie&&g&&g.d,f=un&&Ae&&Zc(Ae),r=(d.clientX-dt.clientX+p.x)/(m||1)+(f?f[0]-Oo[0]:0)/(m||1),o=(d.clientY-dt.clientY+p.y)/(c||1)+(f?f[1]-Oo[1]:0)/(c||1);if(!te.active&&!At){if(n&&Math.max(Math.abs(d.clientX-this._lastX),Math.abs(d.clientY-this._lastY))<n)return;this._onDragStart(e,!0)}if(ie){g?(g.e+=r-(Ro||0),g.f+=o-(ko||0)):g={a:1,b:0,c:0,d:1,e:r,f:o};var s="matrix(".concat(g.a,",").concat(g.b,",").concat(g.c,",").concat(g.d,",").concat(g.e,",").concat(g.f,")");ne(ie,"webkitTransform",s),ne(ie,"mozTransform",s),ne(ie,"msTransform",s),ne(ie,"transform",s),Ro=r,ko=o,Be=d}e.cancelable&&e.preventDefault()}},_appendGhost:function(){if(!ie){var e=this.options.fallbackOnBody?document.body:fe,t=we(K,!0,un,!0,e),n=this.options;if(un){for(Ae=e;ne(Ae,"position")==="static"&&ne(Ae,"transform")==="none"&&Ae!==document;)Ae=Ae.parentNode;Ae!==document.body&&Ae!==document.documentElement?(Ae===document&&(Ae=Ue()),t.top+=Ae.scrollTop,t.left+=Ae.scrollLeft):Ae=Ue(),Oo=Zc(Ae)}ie=K.cloneNode(!0),Oe(ie,n.ghostClass,!1),Oe(ie,n.fallbackClass,!0),Oe(ie,n.dragClass,!0),ne(ie,"transition",""),ne(ie,"transform",""),ne(ie,"box-sizing","border-box"),ne(ie,"margin",0),ne(ie,"top",t.top),ne(ie,"left",t.left),ne(ie,"width",t.width),ne(ie,"height",t.height),ne(ie,"opacity","0.8"),ne(ie,"position",un?"absolute":"fixed"),ne(ie,"zIndex","100000"),ne(ie,"pointerEvents","none"),te.ghost=ie,e.appendChild(ie),ne(ie,"transform-origin",Jc/parseInt(ie.style.width)*100+"% "+eu/parseInt(ie.style.height)*100+"%")}},_onDragStart:function(e,t){var n=this,p=e.dataTransfer,d=n.options;if(xe("dragStart",this,{evt:e}),te.eventCanceled){this._onDrop();return}xe("setupClone",this),te.eventCanceled||(pe=Lh(K),pe.removeAttribute("id"),pe.draggable=!1,pe.style["will-change"]="",this._hideClone(),Oe(pe,this.options.chosenClass,!1),te.clone=pe),n.cloneId=bn(function(){xe("clone",n),!te.eventCanceled&&(n.options.removeCloneOnHide||fe.insertBefore(pe,K),n._hideClone(),Ee({sortable:n,name:"clone"}))}),!t&&Oe(K,d.dragClass,!0),t?(_n=!0,n._loopId=setInterval(n._emulateDragOver,50)):(oe(document,"mouseup",n._onDrop),oe(document,"touchend",n._onDrop),oe(document,"touchcancel",n._onDrop),p&&(p.effectAllowed="move",d.setData&&d.setData.call(n,p,K)),se(document,"drop",n),ne(K,"transform","translateZ(0)")),At=!0,n._dragStartId=bn(n._dragStarted.bind(n,t,e)),se(document,"selectstart",n),zt=!0,Kt&&ne(document.body,"user-select","none")},_onDragOver:function(e){var t=this.el,n=e.target,p,d,g,m=this.options,c=m.group,f=te.active,r=ln===c,o=m.sort,s=Se||f,a,i=this,u=!1;if($s)return;function h(D,I){xe(D,i,Ge({evt:e,isOwner:r,axis:a?"vertical":"horizontal",revert:g,dragRect:p,targetRect:d,canSort:o,fromSortable:s,target:n,completed:b,onMove:function(P,z){return hn(fe,t,K,p,P,we(P),e,z)},changed:T},I))}function y(){h("dragOverAnimationCapture"),i.captureAnimationState(),i!==s&&s.captureAnimationState()}function b(D){return h("dragOverCompleted",{insertion:D}),D&&(r?f._hideClone():f._showClone(i),i!==s&&(Oe(K,Se?Se.options.ghostClass:f.options.ghostClass,!1),Oe(K,m.ghostClass,!0)),Se!==i&&i!==te.active?Se=i:i===te.active&&Se&&(Se=null),s===i&&(i._ignoreWhileAnimating=n),i.animateAll(function(){h("dragOverAnimationComplete"),i._ignoreWhileAnimating=null}),i!==s&&(s.animateAll(),s._ignoreWhileAnimating=null)),(n===K&&!K.animated||n===t&&!n.animated)&&(St=null),!m.dragoverBubble&&!e.rootEl&&n!==document&&(K.parentNode[Re]._isOutsideThisEl(e.target),!D&&ft(e)),!m.dragoverBubble&&e.stopPropagation&&e.stopPropagation(),u=!0}function T(){De=Fe(K),nt=Fe(K,m.draggable),Ee({sortable:i,name:"change",toEl:t,newIndex:De,newDraggableIndex:nt,originalEvent:e})}if(e.preventDefault!==void 0&&e.cancelable&&e.preventDefault(),n=ze(n,m.draggable,t,!0),h("dragOver"),te.eventCanceled)return u;if(K.contains(e.target)||n.animated&&n.animatingX&&n.animatingY||i._ignoreWhileAnimating===n)return b(!1);if(_n=!1,f&&!m.disabled&&(r?o||(g=ve!==fe):Se===this||(this.lastPutMode=ln.checkPull(this,f,K,e))&&c.checkPut(this,f,K,e))){if(a=this._getDirection(e,n)==="vertical",p=we(K),h("dragOverValid"),te.eventCanceled)return u;if(g)return ve=fe,y(),this._hideClone(),h("revert"),te.eventCanceled||(pt?fe.insertBefore(K,pt):fe.appendChild(K)),b(!0);var $=Zs(t,m.draggable);if(!$||yg(e,a,this)&&!$.animated){if($===K)return b(!1);if($&&t===e.target&&(n=$),n&&(d=we(n)),hn(fe,t,K,p,n,d,e,!!n)!==!1)return y(),$&&$.nextSibling?t.insertBefore(K,$.nextSibling):t.appendChild(K),ve=t,T(),b(!0)}else if($&&vg(e,a,this)){var A=_t(t,0,m,!0);if(A===K)return b(!1);if(n=A,d=we(n),hn(fe,t,K,p,n,d,e,!1)!==!1)return y(),t.insertBefore(K,A),ve=t,T(),b(!0)}else if(n.parentNode===t){d=we(n);var S=0,M,R=K.parentNode!==t,L=!dg(K.animated&&K.toRect||p,n.animated&&n.toRect||d,a),_=a?"top":"left",O=Qc(n,"top","top")||Qc(K,"top","top"),w=O?O.scrollTop:void 0;St!==n&&(M=d[_],Qt=!1,cn=!L&&m.invertSwap||R),S=bg(e,n,d,a,L?1:m.swapThreshold,m.invertedSwapThreshold==null?m.swapThreshold:m.invertedSwapThreshold,cn,St===n);var v;if(S!==0){var C=Fe(K);do C-=S,v=ve.children[C];while(v&&(ne(v,"display")==="none"||v===ie))}if(S===0||v===n)return b(!1);St=n,Xt=S;var E=n.nextElementSibling,x=!1;x=S===1;var k=hn(fe,t,K,p,n,d,e,x);if(k!==!1)return(k===1||k===-1)&&(x=k===1),$s=!0,setTimeout(mg,30),y(),x&&!E?t.appendChild(K):n.parentNode.insertBefore(K,x?E:n),O&&xh(O,0,w-O.scrollTop),ve=K.parentNode,M!==void 0&&!cn&&(yn=Math.abs(M-we(n)[_])),T(),b(!0)}if(t.contains(K))return b(!1)}return!1},_ignoreWhileAnimating:null,_offMoveEvents:function(){oe(document,"mousemove",this._onTouchMove),oe(document,"touchmove",this._onTouchMove),oe(document,"pointermove",this._onTouchMove),oe(document,"dragover",ft),oe(document,"mousemove",ft),oe(document,"touchmove",ft)},_offUpEvents:function(){var e=this.el.ownerDocument;oe(e,"mouseup",this._onDrop),oe(e,"touchend",this._onDrop),oe(e,"pointerup",this._onDrop),oe(e,"touchcancel",this._onDrop),oe(document,"selectstart",this)},_onDrop:function(e){var t=this.el,n=this.options;if(De=Fe(K),nt=Fe(K,n.draggable),xe("drop",this,{evt:e}),ve=K&&K.parentNode,De=Fe(K),nt=Fe(K,n.draggable),te.eventCanceled){this._nulling();return}At=!1,cn=!1,Qt=!1,clearInterval(this._loopId),clearTimeout(this._dragStartTimer),Es(this.cloneId),Es(this._dragStartId),this.nativeDraggable&&(oe(document,"drop",this),oe(t,"dragstart",this._onDragStart)),this._offMoveEvents(),this._offUpEvents(),Kt&&ne(document.body,"user-select",""),ne(K,"transform",""),e&&(zt&&(e.cancelable&&e.preventDefault(),!n.dropBubble&&e.stopPropagation()),ie&&ie.parentNode&&ie.parentNode.removeChild(ie),(fe===ve||Se&&Se.lastPutMode!=="clone")&&pe&&pe.parentNode&&pe.parentNode.removeChild(pe),K&&(this.nativeDraggable&&oe(K,"dragend",this),Do(K),K.style["will-change"]="",zt&&!At&&Oe(K,Se?Se.options.ghostClass:this.options.ghostClass,!1),Oe(K,this.options.chosenClass,!1),Ee({sortable:this,name:"unchoose",toEl:ve,newIndex:null,newDraggableIndex:null,originalEvent:e}),fe!==ve?(De>=0&&(Ee({rootEl:ve,name:"add",toEl:ve,fromEl:fe,originalEvent:e}),Ee({sortable:this,name:"remove",toEl:ve,originalEvent:e}),Ee({rootEl:ve,name:"sort",toEl:ve,fromEl:fe,originalEvent:e}),Ee({sortable:this,name:"sort",toEl:ve,originalEvent:e})),Se&&Se.save()):De!==Et&&De>=0&&(Ee({sortable:this,name:"update",toEl:ve,originalEvent:e}),Ee({sortable:this,name:"sort",toEl:ve,originalEvent:e})),te.active&&((De==null||De===-1)&&(De=Et,nt=Yt),Ee({sortable:this,name:"end",toEl:ve,originalEvent:e}),this.save()))),this._nulling()},_nulling:function(){xe("nulling",this),fe=K=ve=ie=pt=pe=vn=it=dt=Be=zt=De=nt=Et=Yt=St=Xt=Se=ln=te.dragged=te.ghost=te.clone=te.active=null,Ln.forEach(function(e){e.checked=!0}),Ln.length=Ro=ko=0},handleEvent:function(e){switch(e.type){case"drop":case"dragend":this._onDrop(e);break;case"dragenter":case"dragover":K&&(this._onDragOver(e),gg(e));break;case"selectstart":e.preventDefault();break}},toArray:function(){for(var e=[],t,n=this.el.children,p=0,d=n.length,g=this.options;p<d;p++)t=n[p],ze(t,g.draggable,this.el,!1)&&e.push(t.getAttribute(g.dataIdAttr)||Cg(t));return e},sort:function(e,t){var n={},p=this.el;this.toArray().forEach(function(d,g){var m=p.children[g];ze(m,this.options.draggable,p,!1)&&(n[d]=m)},this),t&&this.captureAnimationState(),e.forEach(function(d){n[d]&&(p.removeChild(n[d]),p.appendChild(n[d]))}),t&&this.animateAll()},save:function(){var e=this.options.store;e&&e.set&&e.set(this)},closest:function(e,t){return ze(e,t||this.options.draggable,this.el,!1)},option:function(e,t){var n=this.options;if(t===void 0)return n[e];var p=on.modifyOption(this,e,t);typeof p<"u"?n[e]=p:n[e]=t,e==="group"&&Dh(n)},destroy:function(){xe("destroy",this);var e=this.el;e[Re]=null,oe(e,"mousedown",this._onTapStart),oe(e,"touchstart",this._onTapStart),oe(e,"pointerdown",this._onTapStart),this.nativeDraggable&&(oe(e,"dragover",this),oe(e,"dragenter",this)),Array.prototype.forEach.call(e.querySelectorAll("[draggable]"),function(t){t.removeAttribute("draggable")}),this._onDrop(),this._disableDelayedDragEvents(),xn.splice(xn.indexOf(this.el),1),this.el=e=null},_hideClone:function(){if(!it){if(xe("hideClone",this),te.eventCanceled)return;ne(pe,"display","none"),this.options.removeCloneOnHide&&pe.parentNode&&pe.parentNode.removeChild(pe),it=!0}},_showClone:function(e){if(e.lastPutMode!=="clone"){this._hideClone();return}if(it){if(xe("showClone",this),te.eventCanceled)return;K.parentNode==fe&&!this.options.group.revertClone?fe.insertBefore(pe,K):pt?fe.insertBefore(pe,pt):fe.appendChild(pe),this.options.group.revertClone&&this.animate(K,pe),ne(pe,"display",""),it=!1}}};function gg(l){l.dataTransfer&&(l.dataTransfer.dropEffect="move"),l.cancelable&&l.preventDefault()}function hn(l,e,t,n,p,d,g,m){var c,f=l[Re],r=f.options.onMove,o;return window.CustomEvent&&!tt&&!rn?c=new CustomEvent("move",{bubbles:!0,cancelable:!0}):(c=document.createEvent("Event"),c.initEvent("move",!0,!0)),c.to=e,c.from=l,c.dragged=t,c.draggedRect=n,c.related=p||e,c.relatedRect=d||we(e),c.willInsertAfter=m,c.originalEvent=g,l.dispatchEvent(c),r&&(o=r.call(f,c,g)),o}function Do(l){l.draggable=!1}function mg(){$s=!1}function vg(l,e,t){var n=we(_t(t.el,0,t.options,!0)),p=Rh(t.el,t.options,ie),d=10;return e?l.clientX<p.left-d||l.clientY<n.top&&l.clientX<n.right:l.clientY<p.top-d||l.clientY<n.bottom&&l.clientX<n.left}function yg(l,e,t){var n=we(Zs(t.el,t.options.draggable)),p=Rh(t.el,t.options,ie),d=10;return e?l.clientX>p.right+d||l.clientY>n.bottom&&l.clientX>n.left:l.clientY>p.bottom+d||l.clientX>n.right&&l.clientY>n.top}function bg(l,e,t,n,p,d,g,m){var c=n?l.clientY:l.clientX,f=n?t.height:t.width,r=n?t.top:t.left,o=n?t.bottom:t.right,s=!1;if(!g){if(m&&yn<f*p){if(!Qt&&(Xt===1?c>r+f*d/2:c<o-f*d/2)&&(Qt=!0),Qt)s=!0;else if(Xt===1?c<r+yn:c>o-yn)return-Xt}else if(c>r+f*(1-p)/2&&c<o-f*(1-p)/2)return wg(e)}return s=s||g,s&&(c<r+f*d/2||c>o-f*d/2)?c>r+f/2?1:-1:0}function wg(l){return Fe(K)<Fe(l)?1:-1}function Cg(l){for(var e=l.tagName+l.className+l.src+l.href+l.textContent,t=e.length,n=0;t--;)n+=e.charCodeAt(t);return n.toString(36)}function Sg(l){Ln.length=0;for(var e=l.getElementsByTagName("input"),t=e.length;t--;){var n=e[t];n.checked&&Ln.push(n)}}function bn(l){return setTimeout(l,0)}function Es(l){return clearTimeout(l)}Kn&&se(document,"touchmove",function(l){(te.active||At)&&l.cancelable&&l.preventDefault()});te.utils={on:se,off:oe,css:ne,find:Mh,is:function(e,t){return!!ze(e,t,e,!1)},extend:rg,throttle:_h,closest:ze,toggleClass:Oe,clone:Lh,index:Fe,nextTick:bn,cancelNextTick:Es,detectDirection:Oh,getChild:_t,expando:Re};te.get=function(l){return l[Re]};te.mount=function(){for(var l=arguments.length,e=new Array(l),t=0;t<l;t++)e[t]=arguments[t];e[0].constructor===Array&&(e=e[0]),e.forEach(function(n){if(!n.prototype||!n.prototype.constructor)throw"Sortable: Mounted plugin must be a constructor function, not ".concat({}.toString.call(n));n.utils&&(te.utils=Ge(Ge({},te.utils),n.utils)),on.mount(n)})};te.create=function(l,e){return new te(l,e)};te.version=ng;var be=[],jt,Ts,Ms=!1,Io,No,Rn,Ut;function Ag(){function l(){this.defaults={scroll:!0,forceAutoScrollFallback:!1,scrollSensitivity:30,scrollSpeed:10,bubbleScroll:!0};for(var e in this)e.charAt(0)==="_"&&typeof this[e]=="function"&&(this[e]=this[e].bind(this))}return l.prototype={dragStarted:function(t){var n=t.originalEvent;this.sortable.nativeDraggable?se(document,"dragover",this._handleAutoScroll):this.options.supportPointer?se(document,"pointermove",this._handleFallbackAutoScroll):n.touches?se(document,"touchmove",this._handleFallbackAutoScroll):se(document,"mousemove",this._handleFallbackAutoScroll)},dragOverCompleted:function(t){var n=t.originalEvent;!this.options.dragOverBubble&&!n.rootEl&&this._handleAutoScroll(n)},drop:function(){this.sortable.nativeDraggable?oe(document,"dragover",this._handleAutoScroll):(oe(document,"pointermove",this._handleFallbackAutoScroll),oe(document,"touchmove",this._handleFallbackAutoScroll),oe(document,"mousemove",this._handleFallbackAutoScroll)),nu(),wn(),og()},nulling:function(){Rn=Ts=jt=Ms=Ut=Io=No=null,be.length=0},_handleFallbackAutoScroll:function(t){this._handleAutoScroll(t,!0)},_handleAutoScroll:function(t,n){var p=this,d=(t.touches?t.touches[0]:t).clientX,g=(t.touches?t.touches[0]:t).clientY,m=document.elementFromPoint(d,g);if(Rn=t,n||this.options.forceAutoScrollFallback||rn||tt||Kt){Fo(t,this.options,m,n);var c=rt(m,!0);Ms&&(!Ut||d!==Io||g!==No)&&(Ut&&nu(),Ut=setInterval(function(){var f=rt(document.elementFromPoint(d,g),!0);f!==c&&(c=f,wn()),Fo(t,p.options,f,n)},10),Io=d,No=g)}else{if(!this.options.bubbleScroll||rt(m,!0)===Ue()){wn();return}Fo(t,this.options,rt(m,!1),!1)}}},Je(l,{pluginName:"scroll",initializeByDefault:!0})}function wn(){be.forEach(function(l){clearInterval(l.pid)}),be=[]}function nu(){clearInterval(Ut)}var Fo=_h(function(l,e,t,n){if(e.scroll){var p=(l.touches?l.touches[0]:l).clientX,d=(l.touches?l.touches[0]:l).clientY,g=e.scrollSensitivity,m=e.scrollSpeed,c=Ue(),f=!1,r;Ts!==t&&(Ts=t,wn(),jt=e.scroll,r=e.scrollFn,jt===!0&&(jt=rt(t,!0)));var o=0,s=jt;do{var a=s,i=we(a),u=i.top,h=i.bottom,y=i.left,b=i.right,T=i.width,$=i.height,A=void 0,S=void 0,M=a.scrollWidth,R=a.scrollHeight,L=ne(a),_=a.scrollLeft,O=a.scrollTop;a===c?(A=T<M&&(L.overflowX==="auto"||L.overflowX==="scroll"||L.overflowX==="visible"),S=$<R&&(L.overflowY==="auto"||L.overflowY==="scroll"||L.overflowY==="visible")):(A=T<M&&(L.overflowX==="auto"||L.overflowX==="scroll"),S=$<R&&(L.overflowY==="auto"||L.overflowY==="scroll"));var w=A&&(Math.abs(b-p)<=g&&_+T<M)-(Math.abs(y-p)<=g&&!!_),v=S&&(Math.abs(h-d)<=g&&O+$<R)-(Math.abs(u-d)<=g&&!!O);if(!be[o])for(var C=0;C<=o;C++)be[C]||(be[C]={});(be[o].vx!=w||be[o].vy!=v||be[o].el!==a)&&(be[o].el=a,be[o].vx=w,be[o].vy=v,clearInterval(be[o].pid),(w!=0||v!=0)&&(f=!0,be[o].pid=setInterval((function(){n&&this.layer===0&&te.active._onTouchMove(Rn);var E=be[this.layer].vy?be[this.layer].vy*m:0,x=be[this.layer].vx?be[this.layer].vx*m:0;typeof r=="function"&&r.call(te.dragged.parentNode[Re],x,E,l,Rn,be[this.layer].el)!=="continue"||xh(be[this.layer].el,x,E)}).bind({layer:o}),24))),o++}while(e.bubbleScroll&&s!==c&&(s=rt(s,!1)));Ms=f}},30),Fh=function(e){var t=e.originalEvent,n=e.putSortable,p=e.dragEl,d=e.activeSortable,g=e.dispatchSortableEvent,m=e.hideGhostForTarget,c=e.unhideGhostForTarget;if(t){var f=n||d;m();var r=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:t,o=document.elementFromPoint(r.clientX,r.clientY);c(),f&&!f.el.contains(o)&&(g("spill"),this.onSpill({dragEl:p,putSortable:n}))}};function Js(){}Js.prototype={startIndex:null,dragStart:function(e){var t=e.oldDraggableIndex;this.startIndex=t},onSpill:function(e){var t=e.dragEl,n=e.putSortable;this.sortable.captureAnimationState(),n&&n.captureAnimationState();var p=_t(this.sortable.el,this.startIndex,this.options);p?this.sortable.el.insertBefore(t,p):this.sortable.el.appendChild(t),this.sortable.animateAll(),n&&n.animateAll()},drop:Fh};Je(Js,{pluginName:"revertOnSpill"});function ea(){}ea.prototype={onSpill:function(e){var t=e.dragEl,n=e.putSortable,p=n||this.sortable;p.captureAnimationState(),t.parentNode&&t.parentNode.removeChild(t),p.animateAll()},drop:Fh};Je(ea,{pluginName:"removeOnSpill"});te.mount(new Ag);te.mount(ea,Js);const $e={getStyle:(l,e=!1)=>{let t;return window.getComputedStyle?t=window.getComputedStyle(l,null):l.currentStyle&&(t=l.currentStyle),e?t[e]:t},fadeOut:(l,e=250)=>{const t=1/(e/60);l.style.opacity=1,(function n(){const p=Number(l.style.opacity)-t;p>0?(l.style.opacity=p,window.requestAnimationFrame(n)):l.remove()})()},slideDown:(l,e=250,t=!1)=>{l.style.display="block";const n=$e.getStyle(l),p=Number.parseInt(n.height,10),d=p/(e/60);l.style.height="0px",(function g(){const m=Number.parseFloat(l.style.height),c=m+d;m<p?(l.style.height=`${c}px`,window.requestAnimationFrame(g)):(l.style.height="auto",t&&t(l))})()},slideUp:(l,e=250,t=!1)=>{const n=$e.getStyle(l),p=Number.parseInt(n.height,10),d=n.overflow;l.style.overflow="hidden",l.style.height=`${p}px`;const g=n.minHeight;l.style.minHeight="auto";const m=parseFloat(p/(e/60)).toFixed(2);(function c(){const r=Number.parseInt(l.style.height,10)-m;r>0?(l.style.height=`${r}px`,window.requestAnimationFrame(c)):(l.style.overflow=d,l.style.display="none",l.style.minHeight=g,delete l.style.height,t&&t(l))})()},slideToggle:(l,e=250,t=$e.getStyle(l,"display")==="none")=>{t?$e.slideDown(l,e):$e.slideUp(l,e)}},Ph=l=>Number.isInteger(Number(l)),lt=l=>{let e=0,t=l;for(;t?.previousElementSibling;)t=t.previousElementSibling,e++;return e},kn=(l,e,t)=>{const n=t.split("||"),d=gt(e).map(g=>l.find(m=>{const c=n.find(f=>!!Ie(m,f));return c&&Ie(m,c)===g})).filter(Boolean).concat(l);return gt(d)},qn=(l,e,t)=>{for(let n=0;n<l.length;n++)e.call(t,l[n],n)},ta=(l,e)=>{const t=[];return qn(l,(n,p)=>t.push(e(n,p))),t},Po={},Wh=l=>{const e={className:"class"};if(Po[l])return Po[l];const n=(e[l]||l).replace(/^\d+/,"").replace(/[^a-zA-Z0-9-:]/g,"");return Po[l]=n,n},Bh=l=>l.replace(/\b\w/g,e=>e.toUpperCase()),$g=l=>window.JSON.parse(window.JSON.stringify(l)),Eg=(l,e)=>e.filter(t=>!~l.indexOf(t)),Hh=()=>window.navigator.userAgent.indexOf("MSIE ")!==-1,Ne={capitalize:Bh,safeAttrName:Wh,forEach:qn,copyObj:$g,map:ta,subtract:Eg,indexOfNode:lt,isInt:Ph,get:Ie,orderObjectsBy:kn,isIE:Hh},Tg={glyphicons:l=>`<span class="glyphicon glyphicon-${l}" aria-hidden="true"></span>`,"font-awesome":l=>{const[e,t]=l.split(" ");return`<i class="${e} fa-${t}"></i>`},fontello:l=>`<i class="${yh}${l}">${l}</i>`},Mg=new Set(["input","textarea","select"]),_g=(l={})=>{let e=l?.attrs?.name||l?.name;if(e)return e;const t=We(l);let n=l.config?.label||l.attrs?.label||l?.label;return n&&(typeof n=="object"&&(n=U.create(n).textContent),/^<.+>.+<.+>$/gim.test(n)&&(n=lp(n)),e=`${t}-${bh(cp(n,24,null))}`),e||t};class xg{constructor(e=Object.create(null)){this.options=e}set setOptions(e){this.options=je(this.options,e)}processElemArg(e){let t=e,n;if(typeof t=="string")return n=t,t={tag:n},t;if(t.attrs){const{tag:p,...d}=t.attrs;p&&(typeof p=="string"?n=p:n=(p.find(m=>m.selected===!0)||p[0]).value),t.attrs=d}return t.tag=n||t.tag||"div",t}render=e=>(e.id=`f-${e.id||We()}`,this.create(e));create=(e,t=!1)=>{if(!e)return;if(this.isDOMElement(e))return e;const n=this,p=["children","content"],{className:d,options:g,dataset:m,...c}=this.processElemArg(e);p.push("tag");let f;const{tag:r}=c;let o;const s={attrs:{},className:[Ne.get(c,"config.inputWrap")],children:[],config:{}};let a=document.createElement(r);const i={string:h=>{a.innerHTML+=h},object:h=>h&&a.appendChild(n.create(h,t)),node:h=>a.appendChild(h),component:h=>a.appendChild(h.dom),array:h=>{for(const y of h)f=n.childType(y),i[f](y)},function:h=>{h=h(),f=n.childType(h),i[f](h)},undefined:()=>null,boolean:()=>null};if(d&&(c.attrs=je(c.attrs,{className:d})),g){const h=this.processOptions(g,c,t);if(this.holdsContent(a)&&r!=="button")i.array.call(this,h),c.content=void 0;else return Ne.forEach(h,y=>{s.children.push(n.create(y,t))}),c.attrs.className&&(s.className=c.attrs.className),s.id=c.id,s.config={...c.config},this.create(s,t);p.push("options")}if(c.attrs&&(n.processAttrs(c,a,t),p.push("attrs")),c.config){if(c.config.label&&(c.config.label&&r!=="button"||["radio","checkbox"].includes(Ne.get(c,"attrs.type")))&&!t){const h=n.label(c);if(!c.config.hideLabel){const y=[h,a];n.labelAfter(c)&&y.reverse(),s.children.push(y)}}p.push("config")}if(c.content||c.children){const h=c.content||c.children;f=n.childType(h),i[f]||console.error(`childType: ${f} is not supported`),i[f].call(this,h)}if(m){for(const h in m)Object.hasOwn(m,h)&&(a.dataset[h]=typeof m[h]=="function"?m[h]():m[h]);p.push("dataset")}c.action&&(this.actionHandler(a,c.action),p.push("action"));const u=Ne.subtract(p,Object.keys(c));for(o=u.length-1;o>=0;o--)a[u[o]]=c[u[o]];return s.children.length&&(a=this.create(s)),a};onRender=(e,t,n=qe)=>{const p=Date.now(),d=()=>{!e.parentElement&&Date.now()-p<n?window.requestAnimationFrame(d):e.parentElement&&t(e)};d()};actionHandler(e,t){const n={onRender:U.onRender,render:U.onRender},p=["focus","blur"],d=g=>(m,c)=>m.addEventListener(g,c,p.includes(g));return Object.entries(t).map(([g,m])=>(Array.isArray(m)?m:[m]).map(f=>(n[g]||d(g))(e,f)))}get icons(){if(this.iconSymbols)return this.iconSymbols;const e=document.querySelectorAll(`#${st} svg symbol`),t=n=>({tag:"svg",attrs:{className:["svg-icon",n]},children:[{tag:"use",attrs:{"xmlns:xlink":"http://www.w3.org/1999/xlink","xlink:href":`#${n}`}}]});return this.iconSymbols=Array.from(e).reduce((n,p)=>{const d=p.id.replace(yh,"");return n[d]=t(p.id),n},{}),this.cachedIcons={},this.iconSymbols}icon(e,t){if(!e)return;const n=`${e}?${new URLSearchParams(t).toString()}`;if(this.cachedIcons?.[n])return this.cachedIcons[n];const p=this.icons[e];if(p){if(t){const d=je(p,t);return this.cachedIcons[n]=U.create(d).outerHTML,this.cachedIcons[n]}return this.cachedIcons[n]=U.create(p).outerHTML,this.cachedIcons[n]}return Tg[U.options.iconFont]?.(e)||e}processAttrs(e,t,n){const{attrs:p={}}=e;if(!n&&!p.name&&p.name!==null&&this.isInput(e.tag)){const d=_g(e);d&&t.setAttribute("name",d)}for(const d of Object.keys(p)){const g=Ne.safeAttrName(d),m=this.processAttrValue(p[d]);m!==!1&&t.setAttribute(g,m)}}processAttrValue(e){if(typeof e=="function")return e();if(typeof e=="boolean")return e&&"";let t=e||"";if(Array.isArray(t))if(typeof t[0]=="object"){const n=t.filter(p=>p.selected===!0);t=n.length?n[0].value:t[0].value}else t=t.join(" ");return t}toggleElementsByStr=(e,t)=>{const n=[],p=(d,g)=>{g?(d.style.display="block",n.push(d)):d.style.display="none"};return U.elementsContainText(e,t,p),n};elementsContainText=(e,t,n)=>{const p=[];return qn(e,d=>{const m=d.textContent.toLowerCase().indexOf(t.toLowerCase())!==-1;n?.(d,m),m&&p.push(d)}),p};generateOption=({type:e="option",label:t,value:n,i:p=0,selected:d})=>({tag:e==="option"?"option":"input",attrs:{type:e,value:n||`${e}-${p}`,[e==="option"?"selected":"checked"]:d||!p},config:{label:t||Q.get("labelCount",{label:Q.get("option"),count:p})}});processOptions(e,t,n){const{action:p,attrs:d={}}=t,g=d.type||t.tag,m=d.id||t.id,c=(r,o)=>{const{label:s,value:a,...i}=r,u=()=>{const y={tag:"input",attrs:{name:m,type:g,value:a||"",id:`${m}-${o}`,...i},action:p},b={tag:"label",attrs:{for:`${m}-${o}`},children:s},T={children:[y,b],className:[`f-${g}`]};return d.className&&(t.config.inputWrap=d.className),t.config.inline&&T.className.push(`f-${g}-inline`),r.selected&&(y.attrs.checked=!0),n&&(b.attrs.contenteditable=!0),T};return{select:()=>{const y=r.attrs||r,b={attrs:y,...r,...y},{label:T,checked:$,selected:A,attrs:S}=b;return{tag:"option",attrs:{...S,selected:!!($||A)},children:T}},button:y=>{const{type:b,label:T,className:$,id:A}=y;return{...t,attrs:{type:b},className:$,id:A||We(),options:void 0,children:T,action:t.action}},checkbox:u,radio:u}[g]?.(r)};return e.map(c)}holdsContent(e){return e.outerHTML.indexOf("/")!==-1}isBlockInput(e){return!this.isInput(e)&&this.holdsContent(e)}isInput(e){let t=e;return typeof t!="string"&&(t=t.tagName),Mg.has(t)}parsedHtml(e){const t=document.createElement("textarea");return t.innerHTML=e,t.textContent}labelAfter(e){const t=Ne.get(e,"attrs.type"),n=Ne.get(e,"config.labelAfter");return n!==void 0?n:t==="checkbox"||t==="radio"}requiredMark=()=>({tag:"span",className:"text-error",children:"*"});label(e,t){const n=Ne.get(e,"attrs.required");let{config:{label:p=""}}=e;const{id:d,attrs:g}=e;typeof p=="function"&&(p=p());const m={tag:"label",attrs:{for:d||g?.id},className:[],children:[p,n&&this.requiredMark()],action:{}};return t&&(m.attrs.for=void 0,m.attrs.contenteditable=!0,m.fMap=t),m}childType(e){return e===void 0?e:[["array",t=>Array.isArray(t)],["node",t=>t instanceof window.Node||t instanceof window.HTMLElement],["component",()=>e?.dom],[typeof e,()=>!0]].find(t=>t[1](e))[0]}getStyle(e,t=!1){let n;return window.getComputedStyle?n=window.getComputedStyle(e,null):e.currentStyle&&(n=e.currentStyle),t?n[t]:n}getElement(e){const t={node:()=>e,object:()=>document.getElementById(e.id),string:()=>document.getElementById(e)},n=this.childType(e);return t[n]()}empty(e){for(;e.firstChild;)this.remove(e.firstChild);return e}removeEmpty=e=>{const t=e.parentElement,n=Le(e),p=t.getElementsByClassName(`formeo-${n}`);if(this.remove(e),!p.length)return this.isStage(t)?this.emptyClass(t):this.removeEmpty(t)};remove(e){const t=Le(e);return t?ce.remove(`${t}s.${e.id}`):e.parentElement.removeChild(e)}removeClasses(e,t){const n={string:p=>p.classList.remove(t),array:p=>{for(const d of t)p.classList.remove(d)}};n.object=n.string,Ne.forEach(e,n[this.childType(t)])}addClasses(e,t){const n={string:p=>p.classList.add(t),array:p=>{for(const d of t)p.classList.add(d)}};Ne.forEach(e,n[this.childType(t)])}formGroup(e,t=""){return{className:["f-field-group",t],children:e}}coords(e){const t=e.getBoundingClientRect(),n=document.body.getBoundingClientRect();return{pageX:t.left+t.width/2,pageY:t.top-n.top-t.height/2}}clearStage(e){e.classList.add("removing-all-fields");const t=()=>{U.empty(e),e.classList.remove("removing-all-fields"),U.emptyClass(e),$e.slideDown(e,300)};$e.slideUp(e,600,t)}toggleSortable(e,t){let n=t;const p=Le(e);if(!p)return;const d=Le(e.parentElement),g=U[p].get(e.id).sortable;n||(n=!g.option("disabled")),g.option("disabled",n),d&&["rows","columns","stages"].includes(d)&&this.toggleSortable(e.parentElement,n)}emptyClass(e){const t=e.getElementsByClassName(Nf.get(e.classList.item(0)));e.classList.toggle("empty",!t.length)}btnTemplate=({title:e="",...t})=>({tag:"button",attrs:{type:"button",title:e},...t});isControls=e=>Le(e)===ot;isStage=e=>Le(e)===Ot;isRow=e=>Le(e)===Qe;isColumn=e=>Le(e)===Ze;isField=e=>Le(e)===Dt;asComponent=e=>ce[`${Le(e)}s`].get(e.id);isDOMElement(e){return e instanceof window.Element||e instanceof window.HTMLElement||!!(e&&typeof e=="object"&&e.nodeType===1&&typeof e.nodeName=="string")}}const U=new xg,Lg="modulepreload",Rg=function(l){return"/formeo/"+l},iu={},$t=function(e,t,n){let p=Promise.resolve();if(t&&t.length>0){let c=function(f){return Promise.all(f.map(r=>Promise.resolve(r).then(o=>({status:"fulfilled",value:o}),o=>({status:"rejected",reason:o}))))};document.getElementsByTagName("link");const g=document.querySelector("meta[property=csp-nonce]"),m=g?.nonce||g?.getAttribute("nonce");p=c(t.map(f=>{if(f=Rg(f),f in iu)return;iu[f]=!0;const r=f.endsWith(".css"),o=r?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${o}`))return;const s=document.createElement("link");if(s.rel=r?"stylesheet":Lg,r||(s.as="script"),s.crossOrigin="",s.href=f,m&&s.setAttribute("nonce",m),document.head.appendChild(s),r)return new Promise((a,i)=>{s.addEventListener("load",a),s.addEventListener("error",()=>i(new Error(`Unable to preload CSS for ${f}`)))})}))}function d(g){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=g,window.dispatchEvent(m),!m.defaultPrevented)throw g}return p.then(g=>{for(const m of g||[])m.status==="rejected"&&d(m.reason);return e().catch(d)})},Tt="f-autocomplete",kg=`${Tt}-display-field`,na=`${Tt}-list`,Ft="highlight-component",On=`${na}-item`,Og=(l,e)=>{const t=l.reduce((n,p)=>n+(p===e),0);return t>1?`(${t})`:""},zh=["config.label","config.controlId"],Dg=["config.legend","name"],Ig=[...zh,...Dg],Wo=l=>zh.reduce((e,t)=>e||l.get(t),null),ru=l=>Ig.reduce((e,t)=>e||l.get(t),null)||at(l.name),Ng=new Map([["condition.source",Wo],["if.condition.source",Wo],["if.condition.target",Wo],["then.condition.target",ru],["condition.target",ru]]),jh=({id:l,...e},t)=>{const{name:n,label:p}=e;return n?Ng.get(t)(e):p},Fg=({selectedId:l,...e})=>(e.value===l&&(e.selected=!0),e),Bo=l=>(l.classList.contains(On)||(l=l.parentElement),l),Uh=({value:l,textLabel:e,htmlLabel:t,componentType:n,depth:p=0},d)=>{const g={tag:"li",children:t,dataset:{value:l,label:e},className:[On,`${On}-depth-${p}`,`component-type-${n}`],action:{mousedown:({target:m})=>{m=Bo(m),d.setValue(m),d.selectOption(m),d.hideList()},mouseover:({target:m})=>{m=Bo(m),d.removeHighlight(),d.highlightComponent(m)},mouseleave:({target:m})=>{m=Bo(m),d.removeHighlight()}}};return U.create(g)},Pg=(l,e)=>{const t=l.data.options.map((p,d)=>{const g=`${l.address}.options[${d}]`,m=p.label,c=p.label;return Uh({value:g,textLabel:m,htmlLabel:c,componentType:"option",depth:1},e)});return U.create({tag:"ul",attrs:{className:[na,"options-list"]},children:t})},Wg=l=>{const e=l.value,t=[],n=ce.flatList();return Object.entries(n).reduce((d,[g,m])=>{const c=jh(m,l.key);if(c){const f=m.name,r={tag:"span",content:` ${at(f)}`,className:"component-type"},o=`${f}.${c}`;t.push(o);const s=Og(t,o),a={tag:"span",content:s,className:"component-label-count"},i=[`${c} `,a,r],u=[c,s].join(" ").trim();if(m.isCheckable){const y=Pg(m,l);i.push(y)}const h=Fg({value:g,textLabel:u,htmlLabel:i,componentType:f,selectedId:e});d.push(Uh(h,l))}return d},[])};class Bg{lastCache=Date.now();optionsCache=null;constructor({key:e,value:t,className:n,onChange:p=ws}){this.key=e,this.className=[n||this.key.replace(/\./g,"-")].flat(),this.value=t,this.onChange=p||ws,this.events=[],this.build()}createProxy(){return new Proxy(this,{get(e,t){if(t in e)return e[t];if(t in e.dom){const n=e.dom[t];return typeof n=="function"?n.bind(e.dom):n}},set(e,t,n){return t in e?e[t]=n:e.dom[t]=n,!0}})}get isAddress(){return Pe(this.value)}get valueComponent(){return Pe(this.value)&&ce.getAddress(this.value)}build(){const e=n=>{const p=this.list,d=this.getActiveOption();let m=new Map([[38,()=>{const c=this.getPreviousOption(d);c&&this.selectOption(c)}],[40,()=>{const c=this.getNextOption(d);c&&this.selectOption(c)}],[13,()=>{d&&(this.selectOption(d),this.setValue(d),p.style.display==="none"?this.showList(d):this.hideList()),n.preventDefault()}],[27,()=>{this.hideList()}]]).get(n.keyCode);return m||(m=()=>!1),m()},t={focus:({target:n})=>{this.updateOptions(),n.parentElement.classList.add(`${Tt}-focused`);const p=U.toggleElementsByStr(this.list.querySelectorAll(`.${On}-depth-0`),n.value);n.addEventListener("keydown",e);const d=this.list.querySelector(".active-option")||p[0];this.showList(d)},blur:({target:n})=>{n.parentElement.classList.remove(`${Tt}-focused`),n.removeEventListener("keydown",e),this.hideList()},input:n=>{const{value:p}=n.target,d=U.toggleElementsByStr(this.list.querySelectorAll("li"),p);if(p.length===0&&this.clearValue(),d.length===0)this.hideList();else{const g=this.getActiveOption()||d[0];this.showList(g)}this.setValue({dataset:{label:p,value:p}})}};return this.displayField=U.create({tag:"input",autocomplete:"off",action:t,attrs:{type:"text",className:kg,value:this.label||this.value,placeholder:Q.get(`${this.key}.placeholder`)}}),this.hiddenField=U.create({tag:"input",attrs:{type:"hidden",className:Tt,value:this.value}}),this.list=U.create({tag:"ul",attrs:{className:na}}),this.clearButton=U.create({tag:"span",content:U.icon("remove"),className:"clear-button hidden",action:{click:()=>this.clearValue()}}),this.dom=U.create({children:[this.displayField,this.clearButton,this.hiddenField],className:[Tt,this.className].flat(),action:{onRender:n=>{this.stage=n.closest(".formeo-stage"),this.value&&(this.displayField.value=this.label),this.clearButton.classList.toggle("hidden",!this.value.length)}}}),this.dom}get label(){if(!Pe(this.value))return this.value;const e=this.value&&ce.getAddress(this.value);return e&&jh(e,`${this.key}`)||this.value}updateOptions(){let e=this.optionsCache;const t=Date.now();(t-this.lastCache>zs*5||!e)&&(U.empty(this.list),e=this.generateOptions(),this.lastCache=t),this.list.children.length||this.list.append(...e)}generateOptions(){return this.optionsCache=Wg(this),this.optionsCache}setListPosition(){const{offsetHeight:e,offsetWidth:t}=this.displayField,n=this.displayField.closest(".formeo-stage").getBoundingClientRect(),p=this.displayField.getBoundingClientRect(),d={position:"absolute",top:`${p.y+e-n.y}px`,left:`${p.x+window.scrollX-n.x+2}px`,width:`${t}px`};Object.assign(this.list.style,d)}showList(e,t=this.list){this.stage.contains(this.list)||this.stage.appendChild(this.list),this.setListPosition(),this.selectOption(e),$e.slideDown(t,mt)}hideList(e=this.list){$e.slideUp(e,mt),this.removeHighlight(),this.stage.contains(this.list)&&this.stage.removeChild(this.list)}getActiveOption(e=this.list){const t=e.querySelector(".active-option");return t?.style.display!=="none"?t:null}getPreviousOption(e){let t=e;do t=t?t.previousSibling:null;while(t!=null&&t.style.display==="none");return t}getNextOption(e){let t=e;do t=t?t.nextSibling:null;while(t!=null&&t.style.display==="none");return t}selectOption(e,t=this.list){const n=t.querySelectorAll("li");for(const p of n){const{dataset:{value:d}}=p;p.classList.remove("active-option"),Pe(d)&&ce.getAddress(d)?.dom?.classList.remove(Ft)}e&&(e.classList.add("active-option"),this.highlightComponent(e))}removeHighlight(){const e=document.getElementsByClassName(Ft);for(const t of e)t.classList.remove(Ft)}highlightComponent(e){const{dataset:{value:t}}=e;if(Pe(t)){const{componentAddress:n,isOptionAddress:p,optionIndex:d}=vt(t).reduce((m,c)=>c==="options"?(m.isOptionAddress=!0,m):m.isOptionAddress?(m.optionIndex=+c,m):(m.componentAddress.push(c),m),{componentAddress:[],optionIndex:null,isOptionAddress:!1}),g=ce.getAddress(n);g?.dom&&(g.dom.classList.add(Ft),p&&g.dom.querySelectorAll(".field-preview .f-checkbox, .field-preview .f-radio")[d]?.classList.add(Ft))}}clearValue(){this.selectOption(null),this.setValue({dataset:{label:"",value:""}}),this.displayField.focus()}setValue(e){const{label:t,value:n}=e.dataset;this.displayField.value=t,this.hiddenField.value=n,this.value=n,this.clearButton.classList.toggle("hidden",!n.length),this.onChange?.({target:this.hiddenField})}}function Ho({key:l,value:e,type:t="text",checked:n}){const p={tag:"input",attrs:{type:t,value:e,placeholder:Q.get(`${l}.placeholder`)||at(l)},className:[l.replace(/\./g,"-")],config:{}};return n&&(p.attrs.checked=!0),p}function Gh(l){const e=Q.get(l);if(e)return e;const t=l.split(".");return Q.get(t[t.length-1])}const xt={autocomplete:(...l)=>new Bg(...l).createProxy(),string:({key:l,value:e})=>Ho({key:l,value:e}),boolean:({key:l,value:e})=>Ho({key:l,value:e,type:l==="selected"?"radio":"checkbox",checked:!!e}),number:({key:l,value:e})=>Ho({key:l,value:e,type:"number"}),array:({key:l,value:e})=>({tag:"select",attrs:{placeholder:Gh(`placeholder.${l}`)},className:[l.replace(/\./g,"-")],options:e}),object:l=>Object.entries(l).map(([e,t])=>xt[U.childType(t)]({key:e,value:t}))},Hg={boolean:(l,e)=>({click:({target:t})=>{if(t.type==="radio"){const n=e.data.options.map(p=>({...p,selected:!1}));e.set("options",n)}e.set(l,t.checked),e.updatePreview()}}),string:(l,e)=>({input:({target:{value:t}})=>{e.set(l,t),e.debouncedUpdatePreview()}}),number:(l,e)=>({input:({target:{value:t}})=>{e.set(l,Number(t)),e.debouncedUpdatePreview()}}),array:(l,e)=>({change:({target:{value:t}})=>{e.set(l,t),e.debouncedUpdatePreview()}}),object:()=>({})},Vh="hidden-property",zg="hidden-option",zo=/\.options\[\d+\]$/,jg={"if-sourceProperty":gn(pn,rc,oc),"if-targetProperty":gn(pn),"then-targetProperty":gn(pn,rc,oc),...Object.entries(tp).reduce((l,[e,t])=>(l[`if-${e}`]=t,l[`then-${e}`]=t,l),{})},Kh={assignment:Pt,comparison:Pt,logical:Pt,source:({key:l,value:e,onChange:t,conditionType:n})=>xt.autocomplete({key:`${n}.condition.${l}`,value:e,onChange:t,className:`condition-${l}`}),sourceProperty:Pt,targetProperty:Pt,target:l=>Kh.source(l),value:({key:l,value:e,onChange:t},n)=>{const p=xt.string({key:`condition.${l}`,value:e});return p.action={input:t},p}};function Ug({key:l,value:e,conditionType:t}){const n=`${t}-${l}`,p=jg[n];return Object.entries(p||{}).map(([d,g])=>Gg({fieldName:l,fieldValue:e,key:d,optionValue:g}))}function Gg({fieldName:l,fieldValue:e,key:t,optionValue:n}){return{label:Q.get(`${l}.${t}`)||at(t).toLowerCase(),value:n,selected:n===e}}function Pt({key:l,value:e,onChange:t,conditionType:n}){const p=Ug({key:l,value:e,conditionType:n}),d=xt.array({key:`condition.${l}`,value:p});return d.action={change:t},d}const Vg=l=>!l?.classList.contains(Vh),Kg={sourceProperty:l=>{const e=l.get("source"),t=l.get("sourceProperty"),n=!!e.value,p=!!e.value.match(zo);return su(p,t),!n},comparison:l=>{const e=l.get("source"),t=l.get("sourceProperty"),n=!!e.value,p=!!e.value.match(zo);return!n||p||t.value!=="value"},assignment:l=>{const e=l.get("target"),t=l.get("targetProperty");return!!!e.value||t.value.startsWith("is")},targetProperty:l=>{const e=l.get("target"),t=l.get("targetProperty"),n=!!e.value.match(zo);return su(n,t),!Rf(e.value)},target:l=>{const e=l.get("source"),t=l.get("sourceProperty"),n=!!e?.value;return t&&!n?!0:t&&t?.value!=="value"},value:l=>{const e=l.get("target"),t=l.get("targetProperty");return t===void 0?!1:e&&!e.value||!Vg(l.get("comparison"))||t.value===qh?!0:t.value.startsWith("is")}},ou=l=>{for(const[e,t]of l){const n=!!Kg[e]?.(l)||!1;t.classList.toggle(Vh,n)}},qh="isChecked",jo=l=>l.value.endsWith("Checked"),su=(l,e)=>{if(l&&jo(e))return null;const t=Array.from(e.querySelectorAll("option")),n=[];for(const p of t){const d=jo(p),g=l?!d:d;g&&n.push(p.value),p.classList.toggle(zg,g)}n.includes(e.value)&&(e.value=l?qh:t.find(p=>!jo(p))?.value||e.value)};function qg(l,e=ep){return e.reduce((t,n)=>(l[n]!==void 0&&t.push([n,l[n]]),t),[])}class Yg{constructor({conditionValues:e,conditionType:t,conditionCount:n,index:p},d){this.values=new Map(qg(e)),this.conditionType=t,this.parent=d,this.baseAddress=`${d.address}.${t}`,this.fields=new Map,this.conditionCount=n,this.index=p,this.dom=this.generateDom()}setConditionIndex(e){this.index=e}get address(){return`${this.baseAddress}[${this.index}]`}destroy(){const e=ce.getAddress(this.baseAddress);e.splice(this.index,1),ce.setAddress(this.baseAddress,e),$e.slideUp(this.dom,mt,()=>{this.dom.remove()})}label(){return this.index?null:{tag:"label",className:`condition-label ${this.conditionType}-condition-label`,content:Q.get(`condition.type.${this.conditionType}`)}}generateDom(){const e=[];for(const[p,d]of this.values){const g=r=>this.onChangeCondition({key:p,target:r.target}),m={key:p,value:d,conditionType:this.conditionType,onChange:g},c=Kh[p](m,this.values),f=c.dom||U.create(c);this.fields.set(p,c.dom?c:f),e.push(f)}const n={children:[this.label(),...e,...this.generateConditionTypeActionButtons()],className:`f-condition-row ${this.conditionType}-condition-row display-none`,action:{onRender:p=>{this.processUiState()}}};return U.create(n)}generateConditionTypeActionButtons(){const e=[],t="manage-condition-type",n=g=>`${g}-condition-type`,p=U.btnTemplate({title:Q.get(`remove${this.conditionType}Condition`),className:[t,n("remove")],content:U.icon("minus"),action:{click:()=>this.destroy(),mouseover:g=>{this.dom.classList.add("to-remove")},mouseout:g=>{this.dom.classList.remove("to-remove")}}});e.push(p);const d=U.btnTemplate({title:Q.get(`add${this.conditionType}Condition`),className:[t,n("add")],content:U.icon("plus"),action:{click:()=>{const g=this.parent.addConditionType(this.conditionType),m={changedProperty:null,dataPath:g.address,value:g.value,src:g.dom};this.updateDataDebounced(m)}}});return e.push(d),e}get value(){return Array.from(this.fields).reduce((e,[t,n])=>(e[t]=n.value,e),{})}processUiState(){ou(this.fields),this.dom.classList.remove("display-none")}updateDataDebounced=$n(e=>{J.formeoUpdated(e),ce.setAddress(e.dataPath,e.value)});onChangeCondition=({key:e,target:t})=>{const n={changedProperty:e,dataPath:this.address,value:this.value,src:t};ou(this.fields),this.updateDataDebounced(n)}}const Xg=new Map([["attrs",({itemKey:l})=>l],["options",({itemKey:l,key:e})=>`${l}.${e}`]]),Yh=(l,e)=>{if(e.controlId==="select"){const t=e.editPanels.get("options"),[n,p]=l?Tn:rp,d=t.data.map(({[n]:g,...m})=>({[p]:g,...m}));t.setData(d)}},Qg=new Map([["attrs-multiple",l=>({change:({target:e})=>{l.field.controlId==="select"&&Yh(e.checked,l.field)}})]]);class dn{constructor({key:e,index:t,field:n,panel:p,data:d}){this.field=n,this.itemKey=e,this.itemIndex=t,this.panel=p,this.panelName=p.name,this.isDisabled=n.isDisabledProp(e,this.panelName),this.isHidden=this.isDisabled&&n.config.panels[this.panelName].hideDisabled,this.isLocked=n.isLockedProp(e,this.panelName),this.address=`${n.indexName}.${n.id}.${e}`,this.itemSlug=sc(e),this.conditionTypeWrap=new Map,d!==void 0&&this.field.get(this.itemKey)===void 0&&this.field.set(this.itemKey,d);const g=[`field-${this.itemSlug}`,"prop-wrap"];this.isHidden&&g.push("hidden-property"),this.dom=U.create({tag:"li",className:g,children:{className:"component-prop",children:[this.itemInputs(),this.itemControls]}})}get itemValues(){const e=this.field.get(this.itemKey);return e?.constructor===Object?kn(Object.entries(e),Tn,"0"):[[this.itemKey,e]]}findOrCreateConditionTypeWrap(e){let t=this.conditionTypeWrap.get(e);return t||(t=U.create({className:`type-conditions-wrap ${e}-conditions-wrap`}),this.conditionTypeWrap.set(e,t),t)}itemInputs(){const e=U.create({className:`${this.panelName}-prop-inputs prop-inputs f-input-group`,children:this.itemValues.map(([t,n])=>this.panelName==="conditions"?this.generateConditionFields(t,n):this.itemInput(t,n))});return this.inputs&&this.inputs.replaceWith(e),this.inputs=e,e}addConditionType=(e,t)=>{const n=this.findOrCreateConditionTypeWrap(e);let p=t;if(!p){const[g]=Ys()[e],m=n.children.length;e===vh&&(g.logical="||"),p={conditionValues:g,conditionCount:m,index:m}}const d=new Yg({conditionType:e,...p},this);return n.appendChild(d.dom),d};removeConditionType=(e,t)=>{const n=this.conditionTypeWrap.get(e),p=n.children[t];p.destroy(),n.removeChild(p.dom)};generateConditionFields=(e,t)=>(this.conditions=new Map,t.forEach((n,p)=>{const d=this.addConditionType(e,{index:p,conditionCount:t.length,conditionValues:n});this.conditions.set(p,d)}),this.findOrCreateConditionTypeWrap(e));get itemControls(){if(this.isLocked)return{className:`${this.panelName}-prop-controls prop-controls`,content:[]};const e={tag:"button",attrs:{type:"button",className:"prop-remove prop-control"},action:{click:()=>{$e.slideUp(this.dom,qe,n=>{this.field.remove(this.itemKey),n.remove(),this.panel.updateProps()})},mouseover:n=>{this.dom.classList.add("to-remove")},mouseout:n=>{this.dom.classList.remove("to-remove")}},content:U.icon("remove")};return{className:`${this.panelName}-prop-controls prop-controls`,content:[e]}}itemInput(e,t){const n=U.childType(t)||"string",p=Xg.get(this.panelName)?.({itemKey:this.itemKey,key:e})||this.itemKey,d=p.split(".").filter(Number.isNaN).join(".")||e,g=xt[n]({key:e,value:t}),m=`${this.field.shortId}-${sc(p).replace(/-\d+-(selected)/g,"-$1")}`,c={label:this.panelName!=="options"&&(Gh(d)||at(d)),labelAfter:!1},f={name:g.attrs.type==="checkbox"?`${m}[]`:m};f.disabled=this.isDisabled,f.locked=this.isLocked;const r=Qg.get(this.itemSlug)?.(this),o=$p(Hg[n](p,this.field),r||{}),s=je(xt[n]({key:e,value:t}),{action:o,attrs:f,config:c});return Tn.includes(e)?{className:"f-addon",children:s}:s}}const Zg={multiple:(l,e)=>{Yh(!!l,e)}};class Jg{constructor(e,t,n){this.type=U.childType(e),this.name=t,this.component=n,this.panelConfig=this.getPanelConfig(this.data)}get data(){const e=this.component.get(this.name);return this.type==="object"?Object.entries(e):e}getPanelConfig(e){return this.props=this.createProps(e),this.editButtons=this.createEditButtons(),{config:{label:Q.get(`panel.label.${this.name}`)},attrs:{className:`${rh} ${this.name}-panel`},children:[this.props,this.editButtons]}}createProps(e=this.data){this.editPanelItems=Array.from(e).map((n,p)=>{const d=this.type==="array",g=d?`[${p}]`:`.${n[0]}`,m=d?n:{[n[0]]:n[1]};return new dn({key:`${this.name}${g}`,data:m,field:this.component,index:p,panel:this})});const t={tag:"ul",attrs:{className:["edit-group",`${this.component.name}-edit-group`,`${this.component.name}-edit-${this.name}`]},editGroup:this.name,isSortable:this.name==="options",content:this.editPanelItems};return U.create(t)}updateProps(){const e=this.createProps();this.props.replaceWith(e),this.props=e}createEditButtons(){const e=this.name,t=Q.get(`panelEditButtons.${e}`),n={attrs:this.addAttribute,options:this.addOption,conditions:this.addCondition},p=[];if(e==="conditions"){Q.current&&!Q.current.clearAll&&Q.put("clearAll","Clear All");const m={...U.btnTemplate({content:[U.icon("bin"),Q.get("clearAll")],title:Q.get("clearAll")}),className:`clear-all-${e}`,action:{click:()=>{this.clearAllItems()}}};p.push(m)}const d={...U.btnTemplate({content:t,title:t}),className:`add-${e}`,action:{click:m=>{const c={btnCoords:U.coords(m.target),addAction:n[e]};e==="attrs"&&(c.isDisabled=this.component.isDisabledProp,c.isLocked=this.component.isLockedProp,c.message={attr:Q.get(`action.add.${e}.attr`),value:Q.get(`action.add.${e}.value`)});const f=at(e),r=new window.CustomEvent(`onAdd${f}`,{detail:c});Te.add[e](c),document.dispatchEvent(r)}}};return p.push(d),{className:"panel-action-buttons",content:p}}addAttribute=(e,t)=>{let n=t;const p=Wh(e),d=`attrs.${p}`;Q.current[d]||Q.put(d,Bh(e)),typeof n=="string"&&["true","false"].includes(n)&&(n=JSON.parse(n)),this.component.set(`attrs.${e}`,n),Zg[p]?.(n,this.component);const g=this.props.querySelector(`.${this.component.name}-attrs-${p}`),m=new dn({key:d,data:{[p]:n},field:this.component,panel:this});g?g.replaceWith(m.dom):this.props.appendChild(m.dom),this.component.resizePanelWrap()};addOption=()=>{const e=this.component.data.config.controlId,t=this.component.get("options"),n=e==="select"?"option":e,p=Q.get("newOptionLabel",{type:n})||"New Option",d=`${this.name}[${this.data.length}]`,g=t[t.length-1],c={...t.length?g:{},label:p};e!=="button"&&(c.value=bh(p));const f=new dn({key:d,data:c,field:this.component,index:this.props.children.length,panel:this});this.editPanelItems.push(f),this.props.appendChild(f.dom),this.component.debouncedUpdatePreview(),this.component.resizePanelWrap()};addCondition=e=>{const n=`conditions[${this.component.get("conditions").length}]`,p=new dn({key:n,data:e.template,field:this.component,panel:this});this.props.appendChild(p.dom),this.component.set(n,e.template),this.component.resizePanelWrap()};clearAllItems=()=>{const e=this.type==="array"?[]:{},t={type:this.name,removeAction:()=>{this.component.set(this.name,e),this.updateProps()}};Te.remove[this.name](t);const n=at(this.name),p=new window.CustomEvent(`onRemove${n}`,{detail:t});document.dispatchEvent(p)};setData(e){this.data=e,this.component.set(this.name,e),this.updateProps()}}const au=Object.freeze({type:"field",displayType:"slider"}),fn=l=>({transform:`translateX(${l?`${l}px`:0})`});class Xh{constructor(e){this.opts=je(au,e),this.panelDisplay=this.opts.displayType,this.activePanelIndex=0,this.panelNav=this.createPanelNav();const t=this.createPanelsWrap();this.nav=this.navActions(),this.nav.groupChange(this.activePanelIndex);const n=new window.ResizeObserver(([{contentRect:{width:d}}])=>{this.currentWidth!==d&&(this.toggleTabbedLayout(),this.currentWidth=d,this.nav.setTranslateX(this.activePanelIndex,!1))}),p=window.setTimeout(()=>{n.observe(t),window.clearTimeout(p)},zs)}getPanelDisplay(){const e=this.panelsWrap,n=Number.parseInt(U.getStyle(e,"width"),10)>390?"tabbed":"slider",p=this.opts.displayType==="auto";return this.panelDisplay=p?n:this.opts.displayType||au.displayType,this.panelDisplay}toggleTabbedLayout=()=>{this.getPanelDisplay();const e=this.isTabbed;return this.panelsWrap.parentElement?.classList.toggle("tabbed-panels",e),e&&this.panelNav.removeAttribute("style"),e};resizePanels=()=>{this.toggleTabbedLayout()};createPanelsWrap(){const e=U.create({className:"panels",content:this.opts.panels.map(({config:t,...n})=>n)});return this.opts.type==="field"&&this.sortableProperties(e),this.panelsWrap=e,this.panels=e.children,this.currentPanel=this.panels[this.activePanelIndex],e}sortableProperties(e){const t=e.getElementsByClassName("field-edit-group");return Ne.forEach(t,n=>{n.fieldId=this.opts.id,n.isSortable&&te.create(n,{animation:150,group:{name:`edit-${n.editGroup}`,pull:!0,put:["properties"]},sort:!0,handle:".prop-order",onSort:p=>{this.propertySave(p.to),this.resizePanels()}})})}createPanelNavLabels(){const e=this.opts.panels.map(p=>({tag:"h5",action:{click:d=>{const g=lt(d.target);this.nav.setTranslateX(g,!1),this.nav.groupChange(g)}},content:p.config.label})),t={className:"panel-labels",content:{content:e}},[n]=e;return n.className="active-tab",U.create(t)}createPanelNav(){this.labels=this.createPanelNavLabels();const e={tag:"button",attrs:{className:"next-group",title:Q.get("controlGroups.nextGroup"),type:"button"},dataset:{toggle:"tooltip",placement:"top"},action:{click:n=>this.nav.nextGroup(n)},content:U.icon("triangle-right")},t={tag:"button",attrs:{className:"prev-group",title:Q.get("controlGroups.prevGroup"),type:"button"},dataset:{toggle:"tooltip",placement:"top"},action:{click:n=>this.nav.prevGroup(n)},content:U.icon("triangle-left")};return U.create({tag:"nav",attrs:{className:"panel-nav"},content:[t,this.labels,e]})}get isTabbed(){return this.panelDisplay==="tabbed"}navActions(){const e={},t=this.currentPanel.parentElement,n=this.labels.firstChild,p=n.children,d=this.currentPanel.parentElement.childNodes;this.activePanelIndex=lt(this.currentPanel);let g={nav:0,panel:0},m={...g};e.groupChange=r=>(this.activePanelIndex=r,this.currentPanel=d[r],U.removeClasses(d,"active-panel"),U.removeClasses(p,"active-tab"),this.currentPanel.classList.add("active-panel"),p[r].classList.add("active-tab"),this.currentPanel);const c=r=>({nav:-n.offsetWidth*r,panel:-t.offsetWidth*r}),f=({offset:r,reset:o,duration:s=mt,animate:a=!this.isTabbed})=>{const i=[fn(m.panel),fn(r.panel)],u=[fn(m.nav),fn(this.isTabbed?0:r.nav)];if(o){const[T]=i,[$]=u;i.push(T),u.push($)}const h={easing:"ease-in-out",duration:a?s:0,fill:"forwards"},y=t.animate(i,h);n.animate(u,h);const b=()=>{y.removeEventListener("finish",b),o||(m=r)};y.addEventListener("finish",b)};return e.setTranslateX=(r=this.activePanelIndex,o=!0)=>{g=c(r),f({offset:g,animate:o})},e.refresh=(r=this.activePanelIndex)=>{this.activePanelIndex!==r&&e.groupChange(r),e.setTranslateX(this.activePanelIndex,!1),this.resizePanels()},e.nextGroup=()=>{const r=this.activePanelIndex+1;if(r!==d.length){const o=d[r];g={nav:-n.offsetWidth*r,panel:-o.offsetLeft},f({offset:g}),e.groupChange(r)}else g={nav:m.nav-8,panel:m.panel-8},f({offset:g,reset:!0});return this.currentPanel},e.prevGroup=()=>{if(this.activePanelIndex!==0){const r=this.activePanelIndex-1,o=d[r];g={nav:-n.offsetWidth*r,panel:-o.offsetLeft},f({offset:g}),e.groupChange(r)}else g={nav:8,panel:8},f({offset:g,reset:!0})},e}}let Uo=null;const Go=gn(pn);class Yn extends Qs{constructor(e,t={}){const n={...t,id:t.id||We()};super(e,n),this.id=n.id,this.shortId=this.id.slice(0,this.id.indexOf("-")),this.name=e,this.indexName=`${e}s`,this.config=ce[`${this.name}s`].config,je(this.config,n.config),this.address=`${this.name}s.${this.id}`,this.dataPath=`${this.address}.`,this.editPanels=new Map,this.eventListeners=new Map,this.initEventHandlers()}initEventHandlers(){this.config.events&&Object.entries(this.config.events).forEach(([e,t])=>{this.addEventListener(e,t)})}addEventListener(e,t){this.eventListeners.has(e)||this.eventListeners.set(e,[]),this.eventListeners.get(e).push(t)}removeEventListener(e,t){if(!this.eventListeners?.has(e))return;const n=this.eventListeners.get(e),p=n.indexOf(t);p>-1&&n.splice(p,1)}dispatchComponentEvent(e,t={}){const n={component:this,target:this,type:e,timestamp:Date.now(),...t};return this.eventListeners?.has(e)&&this.eventListeners.get(e).forEach(p=>{try{typeof p=="function"&&p(n)}catch(d){console.error(`Error in ${e} event handler for ${this.name} ${this.id}:`,d)}}),n}set(e,t){const n=this.get(e),p=super.set(e,t);return n!==t&&this.dom&&this.dispatchComponentEvent("onUpdate",{path:e,oldValue:n,newValue:t}),p}get js(){return this.data}get json(){return this.data}remove=e=>{if(e){const g=vt(e),m=g.pop(),c=this.get(g);return Array.isArray(c)?Ph(m)?c.splice(Number(m),1):this.set(g,c.filter(f=>f!==m)):delete c[m],c}if(this.name==="stage")return null;const t=this.parent,n=this.children;this.dispatchComponentEvent("onRemove",{path:e,parent:t,children:[...n]}),qn(n,g=>g.remove()),this.dom.parentElement.removeChild(this.dom),Lf(ce.getAddress(`${t.name}s.${t.id}.children`),this.id),t.children.length||t.emptyClass(),t.name==="row"&&t.autoColumnWidths();const d={row:Vs,column:Ks,field:qs}[this.name];return d&&J.formeoUpdated({componentId:this.id,componentType:this.name,parent:t},d),ce[`${this.name}s`].delete(this.id)};empty(){const e=this.children.map(t=>(t.remove(),t));return this.dom.classList.add("empty"),e}emptyClass=()=>this.dom.classList.toggle("empty",!this.children.length);getActionButtons(){const e=[`hovering-${this.name}`,"hovering"];return{className:[`${this.name}-actions`,"group-actions"],action:{mouseenter:()=>{ce.stages.active.dom.classList.add(`active-hover-${this.name}`),this.dom.classList.add(...e)},mouseleave:({target:t})=>{this.dom.classList.remove(...e),ce.stages.active.dom.classList.remove(`active-hover-${this.name}`),t.removeAttribute("style")}},children:[{...U.btnTemplate({content:U.icon(`handle-${this.name}`)}),className:["component-handle",`${this.name}-handle`]},{className:["action-btn-wrap",`${this.name}-action-btn-wrap`],children:this.buttons}]}}getComponentTag=()=>U.create({tag:"span",className:["component-tag",`${this.name}-tag`],children:[(this.isColumn||this.isField)&&U.icon("component-corner",{className:"bottom-left"}),U.icon(`handle-${this.name}`),at(this.name),(this.isColumn||this.isRow)&&U.icon("component-corner",{className:"bottom-right"})].filter(Boolean)});toggleEdit(e=!this.isEditing){this.isEditing=e;const t=this.dom,n="editing",p=`${n}-${this.name}`,d=this.dom.querySelector(`.${this.name}-edit`);$e.slideToggle(d,qe,e),this.name==="field"&&($e.slideToggle(this.preview,qe,!e),t.parentElement.classList.toggle(`column-${p}`,e)),t.classList.toggle(n,e),t.classList.toggle(p,e)}get buttons(){if(this.actionButtons)return this.actionButtons;const e={handle:(g=`handle-${this.name}`)=>({...U.btnTemplate({content:U.icon(g)}),className:["component-handle"]}),move:(g="move")=>({...U.btnTemplate({content:U.icon(g)}),className:["item-move"],meta:{id:"move"}}),edit:(g="edit")=>({...U.btnTemplate({content:U.icon(g)}),className:["edit-toggle"],meta:{id:"edit"},action:{click:()=>{this.toggleEdit()}}}),remove:(g="remove")=>({...U.btnTemplate({content:U.icon(g)}),className:["item-remove"],meta:{id:"remove"},action:{click:()=>{$e.slideUp(this.dom,qe,()=>{this.name==="column"?(this.parent.autoColumnWidths(),this.remove()):this.remove()})}}}),clone:(g="copy")=>({...U.btnTemplate({content:U.icon(g)}),className:["item-clone"],meta:{id:"clone"},action:{click:()=>{this.clone(this.parent),this.name==="column"&&this.parent.autoColumnWidths()}}})},{buttons:t,disabled:n}=this.config.actionButtons,d=t.filter(g=>!n.includes(g)).map(g=>e[g]?.()||g);return this.actionButtons=d,this.actionButtons}get index(){return lt(this.dom)}removeClasses=e=>{const t={string:()=>this.dom.classList.remove(e),array:()=>e.map(n=>this.dom.classList.remove(n))};return t.object=t.string,t[U.childType(e)](this.dom)};get parentType(){return Kf.get(this.name)}get parent(){const e=this.parentType;if(!this.dom||!e)return null;const t=this.dom.closest(`.${Hs[e]}`);return t&&U.asComponent(t)}get children(){if(!this.dom)return[];const e=this.domChildren,t=nc.get(this.name);return ta(e,n=>ce.getAddress(`${t}s.${n.id}`)).filter(Boolean)}loadChildren=(e=this.data.children)=>e.map(t=>this.addChild({id:t}));get domChildren(){const e=this.dom.querySelector(".children");return e?e.children:[]}addChild(e={},t=this.domChildren.length){let n=e;typeof e!="object"&&(n={id:n});const p=this.dom.querySelector(".children"),{id:d=We()}=n,g=nc.get(this.name);if(!g)return null;const m=`${g}s`,c=ce.getAddress(`${m}.${d}`)||ce[m].add(d,n);t>=p.children.length?p.appendChild(c.dom):p.children[t].before(c.dom),this.dispatchComponentEvent("onAddChild",{parent:this,target:c,child:c,index:t}),c.dispatchComponentEvent("onAdd",{parent:this,target:c,index:t,addedVia:"addChild"}),this.config.events?.onAddChild?.({parent:this,child:c});const f=c.get("children");return f?.length&&c.loadChildren(f),this.removeClasses("empty"),this.saveChildOrder(),c}saveChildOrder=()=>{if(this.render)return;const e=this.children.map(({id:t})=>t);return this.set("children",e),e};onAdd({from:e,to:t,item:n,newIndex:p}){e.classList.contains(ot)||(e=e.parentElement);const d=Le(e),g=Le(t.parentElement),m=()=>{this.saveChildOrder(),this.removeClasses("empty")},c=new Map([[-2,()=>{const o=this.addChild({},p).addChild();return o.addChild.bind(o)}],[-1,()=>{const o=this.addChild({},p);return o.addChild.bind(o)}],[0,()=>this.addChild.bind(this)],[1,o=>{const s=lt(this.dom);return()=>this.parent.addChild(o,s+1)}],[2,o=>()=>this.parent.parent.addChild(o)]]),r={controls:async()=>{if(!Uo){const{default:b}=await $t(async()=>{const{default:T}=await Promise.resolve().then(()=>Sm);return{default:T}},void 0);Uo=b}const{controlData:{meta:{id:o},...s}}=Uo.get(n.id);Gn(s,"config.controlId",o);const a=o.startsWith("layout-")?o.replace(/^layout-/,""):"field",u=Ie({stage:{row:0,column:-1,field:-2},row:{row:1,column:0,field:-1},column:{row:2,column:1,field:0},field:1},`${this.name}.${a}`),h=c.get(u)();return U.remove(n),h(s,p)},row:()=>{const o={stage:-1,row:0,column:1};return(c.get(o[g])||bs)()?.({id:n.id},p)},column:()=>{const o={stage:-2,row:-1};return(c.get(o[g])||bs)()?.(n.id)}}[d]?.(n,p);return this.dispatchComponentEvent("onAdd",{from:e,to:t,item:n,newIndex:p,fromType:d,toType:g,addedComponent:r,addedVia:"dragDrop"}),m(),r}onSort=()=>this.saveChildOrder();onRemove({from:{parentElement:e}}){return e.classList.contains(Ze)&&e.classList.remove("column-editing-field"),this.name!=="stage"&&!this.children.length?this.remove():(this.emptyClass(),this.saveChildOrder())}onEnd=({to:{parentElement:e},from:{parentElement:t}})=>{e?.classList.remove(`hovering-${Le(e)}`),t?.classList.remove(`hovering-${Le(t)}`)};onRender(){this.dispatchComponentEvent("onRender",{dom:this.dom});const{events:e}=this.config;if(!e)return null;e.onRender&&U.onRender(this.dom,e.onRender)}set config(e){const t=Ie(e,"all"),n=Ie(this.data,"config.controlId"),p=n&&Ie(e,n),d=Ie(e,this.id),g=[t,p,d].reduce((m,c)=>c?je(m,c):m,this.configVal);this.configVal=g}get config(){return this.configVal}runConditions=()=>{const e=this.get("conditions");return e?.length?e.map(n=>{const p=this.processConditions(n.if),d=this.processResults(n.then);return p.map(g=>this.evaluateConditions(g)&&this.execResults(d))}):null};getComponent(e){const[t,n]=e.split("."),p=ce[t];return n===this.id?this:p?.get(n)}value=(e,t)=>{const n=e.split("."),p=this.getComponent(e),d=p&&n.slice(2,n.length).join(".");return[!p,!d,!Go[d]].some(Boolean)?e:t?p.set(Go[d],t):p.get(Go[d])};getResult=e=>({"=":(n,p,d)=>n.set(p,d)})[e];processResults=e=>e.map(({operator:t,target:n,value:p})=>{const d=this.getComponent(n),g=d&&n.split(".").slice(2,n.length).join(".");return{target:d,propertyPath:g,action:this.getResult(t),value:this.value(p)}});execResults=e=>{const t=e.map(n=>this.execResult(n));return Promise.all(t)};execResult=({target:e,action:t,value:n,_propertyPath:p})=>new Promise((d,g)=>{try{return d(t(e,n))}catch(m){return g(m)}});cloneData=()=>{const e={...Xe(this.data),id:We()};return this.name!=="field"&&(e.children=[]),e};clone=(e=this.parent)=>{const t=e.addChild(this.cloneData(),this.index+1);return this.name!=="field"&&this.cloneChildren(t),this.dispatchComponentEvent("onClone",{original:this,clone:t,parent:e}),t};cloneChildren(e){for(const t of this.children)t?.clone(e)}createChildWrap=e=>U.create({tag:"ul",attrs:{className:"children"},children:e});get isRow(){return this.name===Br.row}get isColumn(){return this.name===Br.column}get isField(){return this.name===Br.field}isDisabledProp=(e,t="attrs")=>{const n=this.config.panels[t];return n?n.disabled.concat(this.get("config.disabled")).includes(e):!1};isLockedProp=(e,t="attrs")=>{const n=this.config.panels[t];return n?n.locked.concat(this.get("config.locked")).includes(e):!1};get editWindow(){const e={className:["component-edit",`${this.name}-edit`,"slide-toggle","formeo-panels-wrap"]},t=this.editPanels.size;return t&&(e.className.push(`panel-count-${t}`),e.content=[this.panels.panelNav,this.panels.panelsWrap],this.panelNav=this.panels.nav,this.resizePanelWrap=this.panels.nav.refresh),e.action={onRender:()=>{if(t===0){const n=this.dom.querySelector(".edit-toggle"),p=this.dom.querySelector(`.${this.name}-actions`),d=p.getElementsByTagName("button");p.style.maxWidth=`${d.length*d[0].clientWidth}px`,U.remove(n)}else this.resizePanelWrap()}},U.create(e)}updateEditPanels=()=>{if(!this.config)return null;const e=["object","array"],t=gt([...this.config.panels.order,...Object.keys(this.data)]),n=["children","config","meta","action","events",...this.config.panels.disabled],p=t.filter(g=>!n.includes(g));for(const g of p){const m=this.get(g),c=U.childType(m);if(e.includes(c)){const f=new Jg(m,g,this);this.editPanels.set(f.name,f)}}const d={panels:Array.from(this.editPanels.values()).map(({panelConfig:g})=>g),id:this.id,displayType:"auto"};this.panels=new Xh(d),this.dom&&(this.dom.querySelector(".panel-nav").replaceWith(this.panels.panelNav),this.dom.querySelector(".panels").replaceWith(this.panels.panelsWrap))}}class em{constructor(){this.onMove=this.onMove.bind(this),this.onStop=this.onStop.bind(this),this.cleanup=this.cleanup.bind(this)}getRowWidth(e){const t=e.querySelector(".children");if(!t)return 0;const n=t.children.length,p=U.getStyle(t,"gap")||"0px",d=parseFloat(p,10)||0;return this.totalGapWidth=d*(n-1),t.offsetWidth-this.totalGapWidth}validateResizeTarget(e,t){return e&&t&&e.offsetWidth&&t.offsetWidth}onStart(e){if(e.preventDefault(),this.resized=!1,e.button!==0)return;const t=e.target.parentElement,n=t.nextSibling||t.previousSibling,p=t.closest(`.${Qe}`);if(!this.validateResizeTarget(t,n)){console.warn("Invalid resize targets"),this.cleanup();return}if(this.startX=e.type==="touchstart"?e.touches[0].clientX:e.clientX,p.classList.add(Wr),this.columnPreset=p.querySelector(`.${oh}`),this.originalColumnClass=t.className,this.originalSiblingClass=n.className,t.className=t.className.replace(Ss,""),n.className=n.className.replace(Ss,""),this.colStartWidth=t.offsetWidth,this.sibStartWidth=n.offsetWidth,this.rowWidth=this.getRowWidth(p),this.rowWidth<=0){console.warn("Invalid row width calculated"),this.cleanup();return}this.column=t,this.sibling=n,this.row=p;try{window.addEventListener("pointermove",this.onMove,!1),window.addEventListener("pointerup",this.onStop,!1)}catch(d){console.error("Failed to initialize resize listeners:",d),this.cleanup()}}calculateNewWidths(e){const t=this.colStartWidth+e-this.startX,n=this.sibStartWidth-e+this.startX,p=parseFloat(Pr(t,this.rowWidth)),d=parseFloat(Pr(n,this.rowWidth));return p<10||d<10?null:{colWidth:ys(p.toFixed(1)),siblingColWidth:ys(d.toFixed(1))}}onMove(e){e.preventDefault();const{column:t,sibling:n}=this,p=e.type==="touchmove"?e.touches[0].clientX:e.clientX,d=this.calculateNewWidths(p);if(!d)return;const{colWidth:g,siblingColWidth:m}=d;t.dataset.colWidth=g,n.dataset.colWidth=m,t.style.width=g,n.style.width=m,this.resized=!0}onStop(){const{column:e,sibling:t}=this;window.removeEventListener("pointermove",this.onMove),window.removeEventListener("pointerup",this.onStop),this.resized&&(this.setCustomWidthValue(),ce.setAddress(`columns.${e.id}.config.width`,e.dataset.colWidth),ce.setAddress(`columns.${t.id}.config.width`,t.dataset.colWidth),this.row.classList.remove(Wr),this.resized=!1,this.cleanup())}cleanup(){this.column&&this.originalColumnClass&&(this.column.className=this.originalColumnClass),this.sibling&&this.originalSiblingClass&&(this.sibling.className=this.originalSiblingClass),this.row&&this.row.classList.remove(Wr),window.removeEventListener("pointermove",this.onMove),window.removeEventListener("pointerup",this.onStop)}setCustomWidthValue(){const e=this.columnPreset;let t=e.querySelector(`.${Cs}`);const n=this.row.querySelector(".children").children,p=ta(n,m=>Pr(m.clientWidth,this.rowWidth).toFixed(1)),d=p.join(","),g=p.join(" | ");return t||(t=U.create({tag:"option",attrs:{className:Cs,value:d,selected:!0},content:g}),e.append(t)),t.value=d,t.textContent=g,d}}const tm=()=>Object.freeze({config:{width:"100%"},children:[],className:[Ze]}),lu={resizeHandle:l=>({className:"resize-x-handle",action:{pointerdown:l.onStart.bind(l)},content:[U.icon("triangle-down"),U.icon("triangle-up")]}),editWindow:()=>({className:"column-edit group-config"})};class nm extends Yn{constructor(e){super("column",{...tm(),...e});const t=this.createChildWrap();this.dom=U.create({tag:"li",className:[Ze,"empty"],dataset:{hoverTag:Q.get("column")},id:this.id,content:[this.getComponentTag(),this.getActionButtons(),lu.editWindow(),lu.resizeHandle(new em),t]}),this.processConfig(),J.columnResized=new window.CustomEvent("columnResized",{detail:{column:this.dom,instance:this}}),te.create(t,{animation:150,fallbackClass:"field-moving",group:{name:"column",pull:!0,put:["column","controls"]},sort:!0,disabled:!1,onEnd:this.onEnd.bind(this),onAdd:this.onAdd.bind(this),onSort:this.onSort.bind(this),onRemove:this.onRemove.bind(this),onMove:n=>{n.from!==n.to&&n.from.classList.remove("hovering-column")},draggable:`.${Dt}`,handle:".item-move"})}processConfig(){const e=Ne.get(this.data,"config.width");e&&this.setDomWidth(e)}refreshFieldPanels=()=>{for(const e of this.children)e.panels.nav.refresh()};setDomWidth=e=>{this.dom.dataset.colWidth=e,this.dom.style.width=e};setWidth=e=>(this.setDomWidth(e),this.set("config.width",e))}const im={actionButtons:{buttons:["clone","move","remove"],disabled:[]}};let rm=class extends Vn{constructor(e){super("columns",e),this.config={all:im}}Component(e){return new nm(e)}};const Qh=new rm,om=()=>Object.freeze({config:{fieldset:!1,legend:"",inputGroup:!1},children:[],className:[Qe]});class sm extends Yn{constructor(e){super("row",{...om(),...e});const t=this.createChildWrap();this.dom=U.create({tag:"li",className:[Qe,"empty"],dataset:{hoverTag:Q.get("row"),editingHoverTag:Q.get("editing.row")},id:this.id,content:[this.getComponentTag(),this.getActionButtons(),this.editWindow,t]}),te.create(t,{animation:150,fallbackClass:"column-moving",group:{name:"row",pull:!0,put:["row","column","controls"]},sort:!0,disabled:!1,onRemove:this.onRemove.bind(this),onEnd:this.onEnd.bind(this),onAdd:this.onAdd.bind(this),onSort:this.onSort.bind(this),draggable:`.${Ze}`,handle:".item-move"})}get editWindow(){const e={tag:"input",id:`${this.id}-fieldset`,attrs:{type:"checkbox",checked:this.get("config.fieldset"),ariaLabel:Q.get("row.settings.fieldsetWrap.aria")},action:{click:({target:{checked:s}})=>{this.set("config.fieldset",!!s)}},config:{label:Q.get("row.settings.fieldsetWrap")}},t={tag:"input",id:`${this.id}-inputGroup`,attrs:{type:"checkbox",checked:this.get("config.inputGroup"),ariaLabel:Q.get("row.settings.inputGroup.aria")},action:{click:({target:{checked:s}})=>this.set("config.inputGroup",s)},config:{label:Q.get("row.makeInputGroup"),description:Q.get("row.makeInputGroupDesc")}},n={tag:"span",content:" ⓘ",dataset:{tooltip:"Row title will be used as the legend for the fieldset"}},d={className:"input-group",content:{tag:"input",attrs:{type:"text",ariaLabel:"Legend for fieldset",value:this.get("config.legend"),placeholder:"Title"},config:{label:{children:["Row Title",n]}},action:{input:({target:{value:s}})=>this.set("config.legend",s)},className:""}},g=U.formGroup([e,d]),m={tag:"label",content:Q.get("defineColumnWidths"),className:"col-sm-4 form-control-label"};this.columnPresetControl=U.create(this.columnPresetControlConfig);const c={className:"col-sm-8",content:this.columnPresetControl,action:{onRender:()=>{this.updateColumnPreset()}}},f=U.formGroup([m,c],"row"),r=[t,"hr",g,"hr",f];return U.create({className:`${this.name}-edit group-config`,action:{onRender:s=>{const a=r.map(i=>U.create(i));s.append(...a)}}})}onAdd(...e){super.onAdd(...e),this.autoColumnWidths()}onRemove(...e){super.onRemove(...e),this.autoColumnWidths()}autoColumnWidths=()=>{const e=this.children;if(!e.length)return;const t=Number.parseFloat((100/e.length).toFixed(1))/1;for(const n of e){n.removeClasses(Ss);const p=n.dom,d=ys(t);n.set("config.width",d),p.style.width=d,p.dataset.colWidth=d;const g=setTimeout(()=>{clearTimeout(g),n.refreshFieldPanels()},mt);document.dispatchEvent(J.columnResized)}this.updateColumnPreset()};updateColumnPreset=()=>{this.columnPresetControl.innerHTML="";const e=this.getColumnPresetOptions.map(({label:t,...n})=>U.create({tag:"option",content:t,attrs:n}));this.columnPresetControl.append(...e)};setColumnWidths=e=>{typeof e=="string"&&(e=e.split(",")),this.children.forEach((t,n)=>{t.setWidth(`${e[n]}%`),t.refreshFieldPanels()})};get getColumnPresetOptions(){const e=this.children,n=Yf.get(e.length-1)||[],p=e.map(d=>{const g=d.get("config.width")||"";return Number(g.replace("%","")).toFixed(1)}).join(",");if(n.length){const d=n.slice();return!d.find(m=>m.value===p)&&d.push({value:p,label:p.replace(/,/g," | "),className:Cs}),d.map(m=>{const c={...m};return c.selected=m.value===p,c})}return[]}get columnPresetControlConfig(){return{tag:"select",attrs:{ariaLabel:Q.get("defineColumnLayout"),className:oh},action:{change:({target:t})=>{const{value:n}=t;this.setColumnWidths(n)}},options:this.getColumnPresetOptions}}}const am={actionButtons:{buttons:["move","edit","clone","remove"],disabled:[]}};let lm=class extends Vn{constructor(e){super("rows",e),this.config={all:am}}Component(e){return new sm(e)}};const ia=new lm,cm=()=>({conditions:[Ys()],children:[]});class um extends Yn{constructor(e){super("stage",{...cm(),...e}),this.updateEditPanels(),this.debouncedUpdateEditPanels=$n(this.updateEditPanels),Q.get("Untitled Form"),Q.get("Untitled Form"),Q.get("Form Title"),Q.get("Form novalidate"),Q.get("Tags");const t=this.createChildWrap();this.dom=U.create({attrs:{className:[Ot,"empty"],id:this.id},children:[this.getComponentTag(),this.getActionButtons(),this.editWindow,t]}),te.create(t,{animation:150,fallbackClass:"row-moving",group:{name:"stage",pull:!0,put:["row","column","controls"]},sort:!0,disabled:!1,onAdd:this.onAdd.bind(this),onRemove:this.onRemove.bind(this),onStart:()=>{en.active=this},onSort:this.onSort.bind(this),draggable:`.${Qe}`,handle:".item-move"})}empty(e=!0){return new Promise(t=>{e?(this.dom.classList.add("removing-all-fields"),$e.slideUp(this.dom,qe,()=>{t(super.empty(e)),this.dom.classList.remove("removing-all-fields"),$e.slideDown(this.dom,qe)})):t(super.empty())})}onAdd(...e){const t=super.onAdd(...e);t?.name==="column"&&t.parent.autoColumnWidths()}}const hm=()=>({actionButtons:{buttons:["edit"],disabled:[]},panels:{disabled:[],order:["attrs","options","conditions"]}});let dm=class extends Vn{constructor(e){super("stages",e),this.config={all:hm()}}Component(e){return new um(e)}};const en=new dm,Dn={js:new Set,css:new Set},cu=(l,e,t=ws)=>new Promise(n=>fetch(l).then(p=>{if(!p.ok)return n(t(p));n(e?e(p):p)}).catch(p=>t(p))),Zh=(l,e)=>{l.removeEventListener("load",Zh),e(l.src)},Jh=(l,e)=>{l.removeEventListener("load",Jh),e(l.src)},ed=l=>new Promise((e,t)=>{if(Dn.js.has(l))return e(l);Dn.js.add(l);const n=U.create({tag:"script",attrs:{type:"text/javascript",async:!0,src:l},action:{load:()=>Jh(n,e),error:()=>t(new Error(`${l} failed to load.`))}});document.head.appendChild(n)}),_s=l=>{l=Array.isArray(l)?l:[l];const e=l.map(t=>new Promise((n,p)=>{if(Dn.css.has(t))return n(t);Dn.css.add(t);const d=U.create({tag:"link",attrs:{rel:"stylesheet",href:t},action:{load:()=>Zh(d,n),error:()=>p(new Error(`${(void 0).src} failed to load.`))}});document.head.appendChild(d)}));return Promise.all(e)},fm=l=>{l=Array.isArray(l)?l:[l];const e=l.map(t=>ed(t));return Promise.all(e)},pm=l=>{l=Array.isArray(l)?l:[l];const e=l.map(t=>_s(t));return Promise.all(e)},gm=l=>{let e=document.getElementById(st);return e||(e=U.create({id:st,children:l,attrs:{hidden:!0,style:"display: none;"}}),document.body.insertBefore(e,document.body.childNodes[0])),e},mm=async(l=ih)=>{if(document.getElementById(st))return;const t=async n=>gm(await n.text());return cu(l,t,()=>cu(Of,t))},vm=l=>{const e=Array.isArray(l)?ec.filter(({name:t})=>l.indexOf(t)!==-1):ec;return Promise.all(e.map(({src:t})=>ed(t)))},ym={js:fm,css:pm},td=l=>{const e=Object.entries(l).map(([t,n])=>ym[t](n));return Promise.all(e)},uu=()=>{const l=document.getElementById(st);return window.getComputedStyle(l).visibility==="hidden"},bm=async l=>{if(!uu()&&(await _s(l),!uu()))return await _s(If)};class wm{controlCache=new Set;constructor({events:e={},dependencies:t={},controlAction:n,...p}){this.events=e,this.controlData=p,this.controlAction=n,this.dependencies=t,this.id=p.id||We()}get controlId(){return this.controlData.meta?.id||this.controlData.config?.controlId}get dom(){const{meta:e,config:t}=this.controlData,n=this.i18n(t.label)||t.label,p={tag:"button",attrs:{type:"button"},content:[{tag:"span",className:"control-icon",children:U.icon(e.icon)},{tag:"span",className:"control-label",content:n}],action:{focus:({target:d})=>{const g=d.closest(`.${ot}`);return g&&Lt.panels.nav.refresh(lt(g))},click:({target:d})=>{const g=d.closest(".field-control")?.id;g&&Lt.addElement(g)}}};return U.create({tag:"li",id:this.id,className:["field-control",`${e.group}-control`,`${e.id}-control`],content:p,meta:e,action:this.controlAction})}promise(){return td(this.dependencies)}i18n(e,t){const n=Q.locale,d=this.definition?.i18n?.[n]||{};return(d[e]?.()??d[e])||Q.get(e,t)}}const Cm=Object.freeze({sortable:!0,elementOrder:{},groupOrder:[],groups:[{id:"layout",label:"controls.groups.layout",elementOrder:["row","column"]},{id:"common",label:"controls.groups.form",elementOrder:["button","checkbox"]},{id:"html",label:"controls.groups.html",elementOrder:["header","block-text"]}],disable:{groups:[],elements:[],formActions:[]},elements:[],container:null,panels:{displayType:"slider"}});let nd=class{constructor(){this.data=new Map,this.buttonActions={focus:({target:e})=>{const t=e.closest(`.${ot}`);return t&&this.panels.nav.refresh(lt(t))},click:({target:e})=>{this.addElement(e.parentElement.id)}}}async init(e,t=!1){return await this.applyOptions(e),this.buildDOM(t),this}registerControls(e){return this.controls=[],e.map(t=>{const p=typeof t=="function"?new t:new wm(t);return this.add(p),this.controls.push(p.dom),p.promise()})}groupLabel=e=>Q.get(e)||e||"";groupElements(){let e=this.options.groups.slice(),t=this.controls.slice(),n=[];const p=[];return e=kn(e,this.groupOrder,"id"),e=e.filter(d=>Jl(d.id,this.options.disable.groups)),n=e.map(d=>{const g={tag:"ul",attrs:{className:[ot,rh],id:`${d.id}-${ot}`},config:{label:this.groupLabel(d.label)}};if(this.options.elementOrder[d.id]){const m=this.options.elementOrder[d.id],c=gt(m.concat(d.elementOrder));d.elementOrder=c}return t=kn(t,d.elementOrder,"meta.id"),g.content=t.filter(m=>{const{controlData:c}=this.get(m.id),f=c.meta.id||"",r=[Jl(f,this.options.disable.elements),c.meta.group===d.id,!p.includes(f)];let o=!0;return o=r.every(s=>s===!0),o&&p.push(f),o}),g}),n}add(e=Object.create(null)){const t=Xe(e);return this.data.set(t.id,t),t.controlData.meta.id&&this.data.set(t.controlData.meta.id,t.controlData),t}get(e){return Xe(this.data.get(e))}formActions(){if(this.options.disable.formActions===!0)return null;const e={...U.btnTemplate({content:[U.icon("bin"),Q.get("clear")],title:Q.get("clearAll")}),className:["clear-form"],action:{click:p=>{ia.size?(J.confirmClearAll=new window.CustomEvent("confirmClearAll",{detail:{confirmationMessage:Q.get("confirmClearAll"),clearAllAction:()=>{en.clearAll().then(()=>{const d={src:p.target};J.formeoCleared(d)})},btnCoords:U.coords(p.target)}}),document.dispatchEvent(J.confirmClearAll)):window.alert(Q.get("cannotClearFields"))}}},t={...U.btnTemplate({content:[U.icon("floppy-disk"),Q.get("save")],title:Q.get("save")}),className:["save-form"],action:{click:async({target:p})=>{const{default:d}=await $t(async()=>{const{default:c}=await Promise.resolve().then(()=>Lm);return{default:c}},void 0),{formData:g}=d,m={action:()=>{},coords:U.coords(p),message:"",button:p};return Te.click.btn(m),Te.save.form(g)}}};return{className:"form-actions f-btn-group",content:Object.entries({clearBtn:e,saveBtn:t}).reduce((p,[d,g])=>(this.options.disable.formActions.includes(d)||p.push(g),p),[])}}buildDOM(e){const t=this.groupElements(),n=this.formActions(),{displayType:p}=this.options.panels;this.panels=new Xh({panels:t,type:"controls",displayType:p});const d=["control-groups","formeo-panels-wrap",`panel-count-${t.length}`],g=U.create({className:d,content:[this.panels.panelNav,this.panels.panelsWrap]}),m=["formeo-controls"];e&&m.push("formeo-sticky");const c=U.create({className:m,content:[g,n]}),f=c.getElementsByClassName("control-group");this.dom=c,this.groups=f;const[r]=f;this.currentGroup=r,this.actions={filter:o=>{const s=o!=="",a=this.controls;let i=g.querySelector(".filtered-term");if(U.toggleElementsByStr(a,o),s){const u=Q.get("controls.filteringTerm",o);c.classList.add("filtered"),i?i.textContent=u:(i=U.create({tag:"h5",className:"filtered-term",content:u}),g.insertBefore(i,g.firstChild))}else i&&(c.classList.remove("filtered"),i.remove())},addElement:this.addElement,addGroup:o=>console.log(o)};for(let o=f.length-1;o>=0;o--){const s=`formeo-controls-${f[o]}`;this.options.sortable||window.localStorage.removeItem(s),te.create(f[o],{animation:150,forceFallback:!0,fallbackClass:"control-moving",fallbackOnBody:!0,group:{name:"controls",pull:"clone",put:!1},onStart:async({item:a})=>{const{controlData:i}=this.get(a.id);if(this.options.ghostPreview){const{default:u}=await $t(async()=>{const{default:h}=await Promise.resolve().then(()=>Tm);return{default:h}},void 0);a.innerHTML="",a.appendChild(new u(i).preview)}},onEnd:({from:a,item:i,clone:u})=>{a.contains(u)&&a.replaceChild(i,u)},sort:this.options.sortable,store:{get:()=>{const a=window.localStorage.getItem(s);return a?a.split("|"):[]},set:a=>{const i=a.toArray();window.localStorage.setItem(s,i.join("|"))}}})}return c}layoutTypes={row:()=>en.active.addChild(),column:()=>this.layoutTypes.row().addChild(),field:e=>this.layoutTypes.column().addChild(e)};addElement=e=>{const{meta:{group:t,id:n},...p}=Ie(this.get(e),"controlData");return Gn(p,"config.controlId",n),t==="layout"?this.layoutTypes[n.replace("layout-","")]():this.layoutTypes.field(p)};applyOptions=async(e={})=>{const{container:t,elements:n,groupOrder:p,...d}=je(Cm,e);this.container=t,this.groupOrder=gt(p.concat(["common","html","layout"])),this.options=d;const[g,m,c]=await Promise.all([$t(()=>import("./index.min.js"),[]),$t(()=>import("./index.min2.js"),[]),$t(()=>import("./index.min3.js"),[])]),f=[g.default,m.default,c.default].flat();return Promise.all(this.registerControls([...f,...n]))}};const Lt=new nd,Sm=Object.freeze(Object.defineProperty({__proto__:null,Controls:nd,default:Lt},Symbol.toStringTag,{value:"Module"})),Am=()=>({}),$m=new Set(["checkbox","radio"]),Em=new Set(["radio","checkbox","select-one","select-multiple"]);class id extends Yn{constructor(e=Object.create(null)){super("field",{...Am(),...e}),this.debouncedUpdateEditPanels=$n(this.updateEditPanels),this.debouncedUpdatePreview=$n(this.updatePreview),this.label=U.create(this.labelConfig),this.preview=this.fieldPreview(),this.controlId=this.get("config.controlId")||this.get("meta.id");const t=this.getActionButtons(),n=this.actionButtons.some(d=>d.meta?.id==="edit");this.updateEditPanels();const p=U.create({tag:"li",attrs:{className:Dt},id:this.id,children:[this.label,this.getComponentTag(),t,n&&this.editWindow,this.preview].filter(Boolean),panelNav:this.panelNav,dataset:{hoverTag:Q.get("field")}});this.dom=p,this.isEditing=!1}get labelConfig(){if(!!this.get("config.hideLabel"))return null;const t=this.get("config.editorLabel")||this.get("config.label"),n=this.get("attrs.required"),p=this.config.label.disableHTML;return{className:"prev-label",children:[{...(()=>{const c={tag:"label",attrs:{}};return p?(c.tag="input",c.attrs.value=t,c):(c.attrs.contenteditable=!0,c.children=t,c)})(),action:{input:({target:{innerHTML:c,innerText:f}})=>{super.set("config.label",p?f:c)}}},n&&U.requiredMark()]}}setData=(e,t)=>super.set(e,t);set(e,t){const n=this.setData(e,t);return this.debouncedUpdatePreview(),n}updateLabel(){if(!this.label)return null;const e=U.create(this.labelConfig);this.label.replaceWith(e),this.label=e}updatePreview=()=>{this.updateLabel();const e=this.fieldPreview();this.preview.replaceWith(e),this.preview=e};get defaultPreviewActions(){return{change:e=>{const{target:t}=e,{type:n}=t;if(Em.has(n)){const p=this.preview.querySelectorAll(":checked"),d=this.get("options"),g=d?.[0]?.selected!==void 0?"selected":"checked",m=d.reduce((c,f)=>(c[f.value]=f,c[f.value][g]=!1,c),{});for(const c of p)m[c.value][g]=c.value===m[c.value].value;return super.set("options",Object.values(m)),this.debouncedUpdateEditPanels()}},click:e=>{e.target.contentEditable==="true"&&e.preventDefault()},input:({target:e})=>{if(["input","meter","progress","button"].includes(e.tagName.toLowerCase()))return super.set("attrs.value",e.value),this.debouncedUpdateEditPanels();if(e.contentEditable&&!e.type?.startsWith("select-")){const t=e.parentElement.classList;if(t.contains("f-checkbox")||t.contains("f-radio")){const p=e.parentElement,d=lt(p);return this.setData(`options[${d}].label`,e.innerHTML),this.debouncedUpdateEditPanels()}this.setData("content",e.innerHTML||e.value)}}}}fieldPreview(){const{action:e={},...t}=Xe(this.data);t.id=`prev-${this.id}`,t.action=Object.entries(e).reduce((p,[d,g])=>(p[d]=g.bind(this),p),{}),this.data?.config.editableContent&&(t.attrs={...t.attrs,contenteditable:!0});const n={attrs:{className:"field-preview",style:this.isEditing&&"display: none;"},content:U.create(t,!0),action:this.defaultPreviewActions};return U.create(n,!0)}get isCheckable(){return $m.has(this.get("config.controlId"))}}const Tm=Object.freeze(Object.defineProperty({__proto__:null,default:id},Symbol.toStringTag,{value:"Module"})),Mm=()=>({actionButtons:{buttons:["move","edit","clone","remove"],disabled:[]},panels:{disabled:[],attrs:{disabled:["type"],hideDisabled:!0,locked:[]},order:["attrs","options","conditions"]},label:{disableHTML:!1}});let _m=class extends Vn{constructor(e){super("fields",e),this.config={all:Mm()}}Component(e){return new id(e)}get=e=>{let t=e&&Ie(this.data,e);if(!t){const n=Lt.get(e);n&&(t=this.add(null,n.controlData))}return t};getData=()=>Object.entries(this.data).reduce((e,[t,n])=>{const{conditions:p,...d}=n?.getData()||n;if(p?.length){let g=!0;if(p.length===1){const[m]=p;g=!!m.if[0].source}g&&(d.conditions=p)}return e[t]=d,e},{});load=(e=Object.create(null))=>{const t=zn(e);this.empty();for(const[n,p]of Object.entries(t)){const{meta:d,...g}=p;d?.id&&Gn(g,"config.controlId",d?.id),this.add(n,g)}return this.data}};const rd=new _m,Cn=en,Sn=ia,Zt=Qh,An=rd,In=Lt,xm=(l,e=!1)=>l?Xe(zn(l)):e&&th.get(lh)||En();class od extends Qs{constructor(){super("components"),this.disableEvents=!0,this.stages=Cn,this.rows=Sn,this.columns=Zt,this.fields=An,this.controls=In}load=(e,t)=>{this.empty();const n=xm(e,t.sessionStorage);this.opts=t,this.set("id",n.id),this.add("stages",Cn.load(n.stages)),this.add("rows",Sn.load(n.rows)),this.add("columns",Zt.load(n.columns)),this.add("fields",An.load(n.fields));for(const p of Object.values(this.get("stages")))p.loadChildren();return this.data};flatList(){const e={};for(const t of Object.keys(this.data.stages))nh(this.data,t,"stages",e);return e}getChildData=({type:e,id:t})=>{const n=this.get(e,t);if(n)return n.getData()};get json(){return window.JSON.stringify({$schema:`https://cdn.jsdelivr.net/npm/formeo@${Ps}/dist/formData_schema.json`,...this.formData})}get formData(){return{id:this.get("id"),stages:en.getData(),rows:ia.getData(),columns:Qh.getData(),fields:rd.getData()}}set config(e){const{stages:t,rows:n,columns:p,fields:d}=e;Cn.config=t,Sn.config=n,Zt.config=p,An.config=d}getIndex(e){return this[e]||this[Wf.get(e)]}setAddress(e,t){if(!Pe(e))return;const[n,p,...d]=Array.isArray(e)?e:vt(e),m=this.getIndex(n).get(p);return m?.set(d,t),m}getAddress(e){if(!Pe(e))return;const[t,n,...p]=Array.isArray(e)?e:vt(e),g=this.getIndex(t).get(n);if(!(p.length&&!g))return p.length?g.get(p):g}}const ce=new od,Lm=Object.freeze(Object.defineProperty({__proto__:null,Columns:Zt,Components:od,Controls:In,Fields:An,Rows:Sn,Stages:Cn,default:ce},Symbol.toStringTag,{value:"Module"})),hu="no-transition",Rm={debug:!1,bubbles:!0,formeoLoaded:l=>{},onAdd:()=>{},onChange:l=>J.opts?.debug&&console.log(l),onUpdate:l=>J.opts?.debug&&console.log(l),onUpdateStage:l=>J.opts?.debug&&console.log(l),onUpdateRow:l=>J.opts?.debug&&console.log(l),onUpdateColumn:l=>J.opts?.debug&&console.log(l),onUpdateField:l=>J.opts?.debug&&console.log(l),onAddRow:l=>J.opts?.debug&&console.log(l),onAddColumn:l=>J.opts?.debug&&console.log(l),onAddField:l=>J.opts?.debug&&console.log(l),onRemoveRow:l=>J.opts?.debug&&console.log(l),onRemoveColumn:l=>J.opts?.debug&&console.log(l),onRemoveField:l=>J.opts?.debug&&console.log(l),onRender:l=>J.opts?.debug&&console.log(l),onSave:l=>{},confirmClearAll:l=>{window.confirm(l.confirmationMessage)&&l.clearAllAction(l)}},He=({src:l,...e},t=Jt)=>{const n=new window.CustomEvent(t,{detail:e,bubbles:J.opts?.debug||J.opts?.bubbles});if(n.data=(l||document).dispatchEvent(n),t===Jt){const p=new window.CustomEvent(Xf,{detail:e,bubbles:J.opts?.debug||J.opts?.bubbles});(l||document).dispatchEvent(p)}return n},J={init:function(l){return this.opts={...Rm,...l},this},formeoSaved:l=>He(l,ch),formeoUpdated:(l,e)=>He(l,e||Jt),formeoCleared:l=>He(l,Qf),formeoOnRender:l=>He(l,ph),formeoConditionUpdated:l=>He(l,Zf),formeoAddedRow:l=>He(l,js),formeoAddedColumn:l=>He(l,Us),formeoAddedField:l=>He(l,Gs),formeoRemovedRow:l=>He(l,Vs),formeoRemovedColumn:l=>He(l,Ks),formeoRemovedField:l=>He(l,qs)},km=kf(()=>{const l={timeStamp:window.performance.now(),type:Jt,detail:ce.formData};J.opts.onUpdate(l),J.opts.onChange!==J.opts.onUpdate&&J.opts.onChange(l)},mt);document.addEventListener(Jt,km);document.addEventListener(uh,l=>{const{timeStamp:e,type:t,detail:n}=l,p={timeStamp:e,type:t,detail:n};J.opts.onUpdate(p),J.opts.onUpdateStage(p)});document.addEventListener(hh,l=>{const{timeStamp:e,type:t,detail:n}=l,p={timeStamp:e,type:t,detail:n};J.opts.onUpdate(p),J.opts.onUpdateRow(p)});document.addEventListener(dh,l=>{const{timeStamp:e,type:t,detail:n}=l,p={timeStamp:e,type:t,detail:n};J.opts.onUpdate(p),J.opts.onUpdateColumn(p)});document.addEventListener(fh,l=>{const{timeStamp:e,type:t,detail:n}=l,p={timeStamp:e,type:t,detail:n};J.opts.onUpdate(p),J.opts.onUpdateField(p)});document.addEventListener(js,l=>{const{timeStamp:e,type:t,detail:n}=l,p={timeStamp:e,type:t,detail:n};J.opts.onAddRow(p)});document.addEventListener(Us,l=>{const{timeStamp:e,type:t,detail:n}=l,p={timeStamp:e,type:t,detail:n};J.opts.onAddColumn(p)});document.addEventListener(Gs,l=>{const{timeStamp:e,type:t,detail:n}=l,p={timeStamp:e,type:t,detail:n};J.opts.onAddField(p)});document.addEventListener(Vs,l=>{const{timeStamp:e,type:t,detail:n}=l,p={timeStamp:e,type:t,detail:n};J.opts.onRemoveRow(p)});document.addEventListener(Ks,l=>{const{timeStamp:e,type:t,detail:n}=l,p={timeStamp:e,type:t,detail:n};J.opts.onRemoveColumn(p)});document.addEventListener(qs,l=>{const{timeStamp:e,type:t,detail:n}=l,p={timeStamp:e,type:t,detail:n};J.opts.onRemoveField(p)});document.addEventListener(ph,l=>{const{timeStamp:e,type:t,detail:n}=l;J.opts.onRender({timeStamp:e,type:t,detail:n})});document.addEventListener("confirmClearAll",l=>{l={timeStamp:l.timeStamp,type:l.type,confirmationMessage:l.detail.confirmationMessage,clearAllAction:l.detail.clearAllAction,btnCoords:l.detail.btnCoords},J.opts.confirmClearAll(l)});document.addEventListener(ch,({timeStamp:l,type:e,detail:{formData:t}})=>{const n={timeStamp:l,type:e,formData:t};J.opts.onSave(n)});document.addEventListener("formeoLoaded",l=>{J.opts.formeoLoaded(l.detail.formeo)});let Vo;function Om(){Vo=Vo||window.requestAnimationFrame(()=>{Vo=!1;for(const l of Object.values(Zt.data))l.dom.classList.add(hu),In.dom.classList.add(hu),In.panels.nav.refresh(),l.refreshFieldPanels()})}window.addEventListener("resize",Om);const du={add:{attr:l=>{const e=window.prompt(l.message.attr);if(e&&l.isDisabled(e))return window.alert(Q.get("attributeNotPermitted",e||"")),Te.add.attrs(l);let t;e&&(t=String(window.prompt(l.message.value,"")),l.addAction(e,t))},option:l=>{l.addAction()},condition:l=>{l.addAction(l)}},remove:{attrs:l=>{l.removeAction()},options:l=>{l.removeAction()},conditions:l=>{l.removeAction()}},click:{btn:l=>{l.action()}},save:{form:bs}},Te={init:function(l){const e=Object.keys(du);return this.opts=e.reduce((t,n)=>(t[n]={...du[n],...l[n]},t),l),this},add:{attrs:l=>Te.opts.add.attr(l),options:l=>Te.opts.add.option(l),conditions:l=>(l.template=l.template||Ys(),Te.opts.add.condition(l))},remove:{attrs:l=>Te.opts.remove.attrs(l),options:l=>Te.opts.remove.options(l),conditions:l=>Te.opts.remove.conditions(l)},click:{btn:l=>Te.opts.click.btn(l)},save:{form:l=>(Te.opts.sessionStorage&&th.set(lh,l),J.formeoSaved({formData:l}),Te.opts.save.form(l))}};var Dm={"en-US":"English",dir:"ltr","af-ZA":"Afrikaans (South Africa)","ar-TN":"Arabic (Tunisia)","cs-CZ":"Czech (Czechia)","de-DE":"German (Germany)","es-ES":"European Spanish","fa-IR":"Persian (Iran)","fi-FI":"Finnish (Finland)","fr-FR":"French (France)","hu-HU":"Hungarian (Hungary)","it-IT":"Italian (Italy)","ja-JP":"Japanese (Japan)","nb-NO":"Norwegian Bokmål (Norway)","pl-PL":"Polish (Poland)","pt-BR":"Brazilian Portuguese","pt-PT":"European Portuguese","ro-RO":"Romanian (Romania)","ru-RU":"Russian (Russia)","th-TH":"Thai (Thailand)","tr-TR":"Turkish (Türkiye)","zh-CN":"Chinese (China)","zh-HK":"Chinese (Hong Kong SAR China)","action.add.attrs.attr":"What attribute would you like to add?","action.add.attrs.value":"Default Value",addOption:"Add Option",allFieldsRemoved:"All fields were removed.",allowSelect:"Allow Select",and:"and",attribute:"Attribute",attributeNotPermitted:'Attribute "{attribute}" is not permitted, please choose another.',attributes:"Attributes","attrs.class":"Class","attrs.className":"Class","attrs.dir":"Direction","attrs.id":"Id","attrs.required":"Required","attrs.style":"Style","attrs.title":"Title","attrs.type":"Type","attrs.value":"Value",autocomplete:"Autocomplete",button:"Button",cannotBeEmpty:"This field cannot be empty",cannotClearFields:"There are no fields to clear",checkbox:"Checkbox",checkboxes:"Checkboxes",class:"Class",clear:"Clear",clearAllMessage:"Are you sure you want to clear all fields?",close:"Close",column:"Column","condition.target.placeholder":"target","condition.type.and":"And","condition.type.if":"If","condition.type.or":"Or","condition.type.then":"Then","condition.value.placeholder":"value",confirmClearAll:"Are you sure you want to remove all fields?",content:"Content",control:"Control","controlGroups.nextGroup":"Next Group","controlGroups.prevGroup":"Previous Group","controls.filteringTerm":'Filtering "{term}"',"controls.form.button":"Button","controls.form.checkbox-group":"Checkbox Group","controls.form.input.date":"Date","controls.form.input.email":"Email","controls.form.input.file":"File Upload","controls.form.input.hidden":"Hidden Input","controls.form.input.number":"Number","controls.form.input.text":"Text Input","controls.form.radio-group":"Radio Group","controls.form.select":"Select","controls.form.textarea":"TextArea","controls.groups.form":"Form Fields","controls.groups.html":"HTML Elements","controls.groups.layout":"Layout","controls.html.divider":"Divider","controls.html.header":"Header","controls.html.paragraph":"Paragraph","controls.layout.column":"Column","controls.layout.row":"Row",copy:"Copy To Clipboard",danger:"Danger",defineColumnLayout:"Define a column layout",defineColumnWidths:"Define column widths",description:"Help Text",descriptionField:"Description","editing.row":"Editing Row",editorTitle:"Form Elements",field:"Field","field.property.invalid":"not valid","field.property.isChecked":"is checked","field.property.isNotVisible":"is not visible","field.property.isVisible":"is visible","field.property.label":"label","field.property.valid":"valid","field.property.value":"value",fieldNonEditable:"This field cannot be edited.",fieldRemoveWarning:"Are you sure you want to remove this field?",fileUpload:"File Upload",formUpdated:"Form Updated",getStarted:"Drag a field from the right to get started.",group:"Group",grouped:"Grouped",hidden:"Hidden Input",hide:"Edit",htmlElements:"HTML Elements",if:"If","if.condition.source.placeholder":"source","if.condition.target.placeholder":"target / value",info:"Info","input.date":"Date","input.text":"Text",label:"Label",labelCount:"{label} {count}",labelEmpty:"Field Label cannot be empty","lang.af":"Afrikaans","lang.ar":"Arabic","lang.cs":"Czech","lang.de":"German","lang.en":"English","lang.es":"Spanish","lang.fa":"Persian","lang.fi":"Finnish","lang.fr":"French","lang.hu":"Hungarian","lang.it":"Italian","lang.ja":"Japanese","lang.nb":"Norwegian Bokmål","lang.pl":"Polish","lang.pt":"Portuguese","lang.ro":"Romanian","lang.ru":"Russian","lang.th":"Thai","lang.tr":"Turkish","lang.zh":"Chinese",layout:"Layout",limitRole:"Limit access to one or more of the following roles:",mandatory:"Mandatory",maxlength:"Max Length","meta.group":"Group","meta.icon":"Ico","meta.label":"Label",minOptionMessage:"This field requires a minimum of 2 options",name:"Name",newOptionLabel:"New {type}",no:"No",number:"Number",off:"Off",on:"On","operator.contains":"contains","operator.equals":"equals","operator.notContains":"not contains","operator.notEquals":"not equal","operator.notVisible":"not visible","operator.visible":"visible",option:"Option",optional:"optional",optionEmpty:"Option value required",optionLabel:"Option {count}",options:"Options",or:"or",order:"Order","panel.label.attrs":"Attributes","panel.label.conditions":"Conditions","panel.label.config":"Configuration","panel.label.meta":"Meta","panel.label.options":"Options","panelEditButtons.attrs":"+ Attribute","panelEditButtons.conditions":"+ Condition","panelEditButtons.options":"+ Option",placeholder:"Placeholder","placeholder.className":"space separated classes","placeholder.email":"Enter you email","placeholder.label":"Label","placeholder.password":"Enter your password","placeholder.placeholder":"Placeholder","placeholder.text":"Enter some Text","placeholder.textarea":"Enter a lot of text","placeholder.value":"Value",preview:"Preview",primary:"Primary",remove:"Remove",removeMessage:"Remove Element",removeType:"Remove {type}",required:"Required",reset:"Reset",richText:"Rich Text Editor",roles:"Access",row:"Row","row.makeInputGroup":"Make this row an input group.","row.makeInputGroupDesc":"Input Groups enable users to add sets of inputs at a time.","row.settings.fieldsetWrap":"Wrap row in a &lt;fieldset&gt; tag","row.settings.fieldsetWrap.aria":"Wrap Row in Fieldset",save:"Save",secondary:"Secondary",select:"Select",selectColor:"Select Color",selectionsMessage:"Allow Multiple Selections",selectOptions:"Options",separator:"Separator",settings:"Settings",size:"Size",sizes:"Sizes","sizes.lg":"Large","sizes.m":"Default","sizes.sm":"Small","sizes.xs":"Extra Small",style:"Style",styles:"Styles","styles.btn":"Button Style","styles.btn.danger":"Danger","styles.btn.default":"Default","styles.btn.info":"Info","styles.btn.primary":"Primary","styles.btn.success":"Success","styles.btn.warning":"Warning",subtype:"Type",success:"Success",text:"Text Field",then:"Then","then.condition.target.placeholder":"target",toggle:"Toggle",ungrouped:"Un-Grouped",warning:"Warning",yes:"Yes"};const Im=Dm;Q.addLanguage("en-US",Im);const Nm={get editor(){return{stickyControls:!1,allowEdit:!0,dataType:"json",debug:!1,sessionStorage:!1,editorContainer:null,svgSprite:ih,style:Df,iconFont:null,config:{},events:{},actions:{},controls:{},polyfills:Hh(),i18n:{location:"https://draggable.github.io/formeo/assets/lang/"},onLoad:()=>{}}}};let sd=class{constructor({formData:e,...t},n){const p=je(Nm.editor,t),{actions:d,events:g,debug:m,config:c,editorContainer:f,...r}=p;f&&(this.editorContainer=typeof f=="string"?document.querySelector(f):f),this.opts=r,U.setOptions=r,ce.config=c,this.userFormData=n||e,this.Components=ce,this.dom=U,J.init({debug:m,...g}),Te.init({debug:m,sessionStorage:r.sessionStorage,...d}),this.tooltip=new Pu,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",this.loadResources.bind(this)):this.loadResources()}get formData(){return this.Components.formData}set formData(e={}){this.userFormData=Vt(e),this.load(this.userFormData,this.opts)}loadData(e={}){this.formData=e}get json(){return this.Components.json}clear(){this.userFormData=En(),this.Components.load(this.userFormData,this.opts),this.render()}async loadResources(){document.removeEventListener("DOMContentLoaded",this.loadResources);const e=[];this.opts.polyfills&&vm(this.opts.polyfills),await mm(this.opts.svgSprite),e.push(bm(this.opts.style)),e.push(Q.init({...this.opts.i18n,locale:window.sessionStorage?.getItem(ic)}));const t=await Promise.all(e);return this.opts.allowEdit&&this.init(),t}init(){return Lt.init(this.opts.controls,this.opts.stickyControls).then(e=>{this.controls=e,this.load(this.userFormData,this.opts),this.formId=ce.get("id"),this.i18n={setLang:t=>{window.sessionStorage?.setItem(ic,t),Q.setCurrent(t).then(()=>{this.init()},console.error)}},this.opts.onLoad?.(this)})}load(e=this.userFormData,t=this.opts){this.Components.load(e,t),this.render()}render(){if(!this.controls)return window.requestAnimationFrame(()=>this.render());if(this.stages=Object.values(ce.get("stages")),this.opts.controlOnLeft)for(const n of this.stages)n.dom.style.order=1;const e={attrs:{className:"formeo formeo-editor",id:this.formId},content:[this.stages.map(({dom:n})=>n)]};Q.current.dir&&(e.attrs.dir=Q.current.dir,U.dir=Q.current.dir),this.editor=U.create(e),(this.controls.container||this.editor).appendChild(this.controls.dom),this.editorContainer&&(U.empty(this.editorContainer),this.editorContainer.appendChild(this.editor)),J.formeoLoaded=new window.CustomEvent("formeoLoaded",{detail:{formeo:this}}),document.dispatchEvent(J.formeoLoaded)}};const Ko="f-",fu=l=>typeof l=="string"?document.querySelector(l):l,Fm=({editorContainer:l,renderContainer:e,formData:t,...n})=>{const p={renderContainer:fu(e),editorContainer:fu(l),formData:Vt(t)};return{elements:{},...n,...p}},qo=l=>l.match(ip)?.[0]||l``,pu=l=>{if(!l||l.hasAttribute("hidden")||l.parentElement.hasAttribute("hidden"))return!1;const e=window.getComputedStyle(l);return!(e.display==="none"||e.visibility==="hidden"||e.opacity==="0")},Pm={isChecked:l=>l.checked,isNotChecked:l=>!l.checked,value:l=>l.value,isVisible:l=>pu(l),isNotVisible:l=>!pu(l)},Wm=()=>U.btnTemplate({className:"remove-input-group",children:U.icon("remove"),action:{mouseover:({target:l})=>l.parentElement.classList.add("will-remove"),mouseleave:({target:l})=>l.parentElement.classList.remove("will-remove"),click:({target:l})=>l.parentElement.remove()}}),gu={equals:As,notEquals:(l,e)=>!As(l,e),contains:(l,e)=>l.includes(e),notContains:(l,e)=>!l.includes(e)},Bm=Object.entries(gh).reduce((l,[e,t])=>(l[t]=gu[e],l[e]=gu[e],l),{}),mu={equals:(l,{targetProperty:e,value:t})=>{l[`_${e}`]=l[e],l[e]=t}},Hm=Object.entries(mh).reduce((l,[e,t])=>(l[t]=mu[e],l[e]=mu[e],l),{}),zm={isChecked:l=>{l.checked=!0},isNotChecked:l=>{l.checked=!1},value:(l,{assignment:e,...t})=>{const n=Hm[e]?.(l,t),p=new Event("input",{bubbles:!0});return l.dispatchEvent(p),n},isNotVisible:l=>{l?._required===void 0&&(l._required=l.required),l.parentElement.setAttribute("hidden",!0),l.required=!1},isVisible:l=>{l.parentElement.removeAttribute("hidden"),l.required=l._required}};let ad=class{constructor(e,t){const{renderContainer:n,elements:p,formData:d}=Fm(e);this.container=n,this.form=Vt(t||d),this.dom=U,this.components=Object.create(null),this.elements=p}get formData(){return this.form}set formData(e){this.form=Vt(e)}get userData(){const e=new FormData(this.renderedForm),t={};for(const[n,p]of e.entries())t[n]?Array.isArray(t[n])?t[n].push(p):t[n]=[t[n],p]:t[n]=p;return t}set userData(e={}){const t=this.container.querySelector("form");for(const n of Object.keys(e)){const p=t.elements[n];if(p.length&&p[0].type==="checkbox"){const d=Array.isArray(e[n])?e[n]:[e[n]];for(const g of p)g.checked=d.includes(g.value)}else if(p.length&&p[0].type==="radio")for(const d of p)d.checked=d.value===e[n];else p.type&&(p.value=e[n])}}render(e=this.form){const t=this.getRenderedForm(e),n=this.container.querySelector(".formeo-render");n?n.replaceWith(t):this.container.appendChild(t)}getRenderedForm(e=this.form){this.form=Vt(e);const t=document.getElementsByClassName("formeo-render").length,n={tag:"form",id:this.form.id,className:`formeo-render formeo formeo-rendered-${t}`,children:this.processedData};return this.renderedForm=U.render(n),this.applyConditions(),this.renderedForm}get html(){return(this.renderedForm||this.getRenderedForm()).outerHTML}orderChildren=(e,t)=>t.reduce((n,p)=>(n.push(this.form[e][p]),n),[]);prefixId=e=>Ko+e;processColumn=({id:e,...t})=>({...t,id:this.prefixId(e),children:this.processFields(t.children),style:`width: ${t.config.width||"100%"}`});processRows=e=>this.orderChildren("rows",this.form.stages[e].children).reduce((t,n)=>(n&&t.push(this.processRow(n)),t),[]);cacheComponent=e=>(this.components[qo(e.id)]=e,e);processRow=(e,t="row")=>{const{config:n,id:p}=e,d=[`formeo-${t}-wrap`],g={...e,children:this.processColumns(e.id),id:this.prefixId(p)};this.cacheComponent(g);const c=[{condition:n.legend,result:()=>({tag:n.fieldset?"legend":"h3",children:n.legend})},{condition:!0,result:()=>g},{condition:n.inputGroup,result:()=>this.addButton(p)}].reduce((f,{condition:r,result:o})=>(r&&f.push(o()),f),[]);return n.inputGroup&&d.push(`${Ko}input-group-wrap`),{tag:n.fieldset?"fieldset":"div",className:d,children:c}};cloneComponentData=e=>{const{children:t=[],id:n,...p}=this.components[e];return{...p,id:We(n),children:t?.length&&t.map(({id:d})=>this.cloneComponentData(qo(d)))}};addButton=e=>({tag:"button",attrs:{className:"add-input-group btn pull-right",type:"button"},children:"Add +",action:{click:t=>{const n=t.target.parentElement,p=U.create(this.cloneComponentData(e));n.insertBefore(p,n.lastChild);const d=U.create(Wm());p.appendChild(d)}}});processColumns=e=>this.orderChildren("columns",this.form.rows[e].children).map(t=>this.cacheComponent(this.processColumn(t)));processFields=e=>this.orderChildren("fields",e).map(({id:t,...n})=>{const p=n.config?.controlId||n.meta?.id,{action:d={},dependencies:g={}}=this.elements[p]||{};g&&td(g);const m=je({action:d},n);return this.cacheComponent({...m,id:this.prefixId(t)})});get processedData(){return Object.values(this.form.stages).map(e=>(e.children=this.processRows(e.id),e.className=Ot,this.components[qo(e.id)]=e,e))}handleComponentCondition=(e,t,n)=>{if(e.length){for(const g of e)this.handleComponentCondition(g,t,n);return}const p=jm(e);p&&e.addEventListener(p,g=>{if(this.evaluateCondition(t,g))for(const m of n)this.execResult(m,g)},!1);const d={target:e};if(this.evaluateCondition(t,d))for(const g of n)this.execResult(g,d)};applyConditions=()=>{for(const{conditions:e}of Object.values(this.components))if(e)for(const t of e){const{if:n,then:p}=t;for(const d of n){const{source:g,target:m}=d;if(Pe(g)){const{component:c,options:f}=this.getComponent(g),r=f||c;this.handleComponentCondition(r,d,p)}if(Pe(m)){const{component:c,options:f}=this.getComponent(m),r=f||c;this.handleComponentCondition(r,d,p)}}}};evaluateCondition=({source:e,sourceProperty:t,targetProperty:n,comparison:p,target:d})=>{const g=this.getComponentProperty(e,t);if(typeof g=="boolean")return g;const m=String(Pe(d)?this.getComponentProperty(d,n):d);return Bm[p]?.(g,m)};execResult=({target:e,targetProperty:t,assignment:n,value:p})=>{if(Pe(e)){const{component:d,option:g}=this.getComponent(e),m=g||d;zm[t]?.(m,{targetProperty:t,assignment:n,value:p})}};getComponentProperty=(e,t)=>{const{component:n,option:p}=this.getComponent(e),d=p||n;return Pm[t]?.(d)||d[t]};getComponent=e=>{const t={component:null};if(!Pe(e))return null;const[,n,p,d]=vt(e),g=this.renderedForm.querySelector(`#${Ko}${n}`);if(!g)return t;if(t.component=g,p){const m=g.querySelectorAll("input"),c=m[d];return t.options=m,t.option=c,t}return t};getComponents=e=>{const t=[],n=e.slice(e.indexOf(".")+1);return t.push(...this.renderedForm.querySelectorAll(`[name=f-${n}]`)),t}};const jm=l=>{const e=[["input",n=>["textarea","text"].includes(n.type)],["change",n=>["select"].includes(n.tagName.toLowerCase())||["checkbox","radio"].includes(n.type)]],[t]=e.find(n=>n[1](l))||[!1];return t};window!==void 0&&(window.FormeoEditor=sd,window.FormeoRenderer=ad);const ra=sd,oa=ad,Um={rows:{all:{events:{onAdd:l=>{if(console.log(`You just added a new row with the id "${l.target.id}"`,l.index),l.index===2){const e=l.target.dom.querySelector(".action-btn-wrap"),t=document.createElement("button");t.type="button",t.className="btn btn-sm btn-secondary",t.textContent="Add Column",t.style.border="1px solid #ccc",t.style.width="auto",t.addEventListener("click",()=>{l.target.addChild()}),e.appendChild(t)}}}}},fields:{all:{events:{onRemove:l=>{console.log(`You just removed the field with the id "${l.target.id}"`,l)}}},checkbox:{actionButtons:{},panels:{attrs:{hideDisabled:!0}}}}},Gm={sortable:!1,groupOrder:["common","html"],disable:{},elements:[{tag:"input",config:{label:"Email",disabledAttrs:["type"],lockedAttrs:["required","className"]},meta:{group:"common",id:"email",icon:"@"},attrs:{className:"custom-email",type:"email",required:!0}}],elementOrder:{common:["button","checkbox","date-input","hidden","upload","number","radio","select","text-input","textarea"]}},Vm=".build-form",Km=".render-form",tn={editorContainer:Vm,i18n:{location:"./assets/lang"},actions:{},controls:Gm,config:Um,events:{onSave:console.log,onChange:console.log},sessionStorage:!0,editPanelOrder:["attrs","options"],onLoad:()=>{console.log("demo loaded")}},sa={renderContainer:Km,elements:{tinymce:{action:{onRender:l=>{if(l.id){const e=`#${l.id}`;window.tinymce.remove(e),window.tinymce.init({selector:e})}}}}}};async function qm(l){l.innerHTML=`
  ...
  `;try{await Ym(),await Xm()&&console.log("Highlight.js loaded successfully"),l.innerHTML=`
      <div class="angular-demo">
        <h3>Angular Integration Demo</h3>
...
npm install formeo</code></pre>
          ...
          <div class="guide-section">
            ...
            <pre><code class="language-typescript">${Xo(Jm)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>3. Service for Formeo Management (Optional)</h4>
            <pre><code class="language-typescript">${Xo(ev)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>4. Module Configuration</h4>
            <pre><code class="language-typescript">${Xo(tv)}</code></pre>
          </div>
        </div>
    ...
    `;const t=await Zm();vu();const n=l.querySelector("#toggle-instructions"),p=l.querySelector("#instructions-section"),d=n.querySelector(".toggle-text"),g=n.querySelector(".toggle-icon");return n&&p&&n.addEventListener("click",()=>{const m=p.style.display==="block";p.style.display=m?"none":"block",d.textContent=m?"Show Implementation Guide":"Hide Implementation Guide",g.textContent=m?"▼":"▲",m||setTimeout(()=>vu(),50)}),{angularApp:t,cleanup:()=>{t?.destroy&&t.destroy();const m=document.getElementById("angular-app-root");m&&(m.innerHTML="")}}}catch(e){return console.error("Failed to load Angular demo:",e),l.innerHTML=`
      <div class="angular-demo">
        <h3>Angular Integration Demo</h3>
    ...
    `,{cleanup:()=>{}}}}async function Ym(){await new Promise(l=>setTimeout(l,500)),console.log("Angular-style demo environment ready")}async function Xm(){if(window.hljs)return window.hljs;try{const l=document.createElement("link");return l.rel="stylesheet",l.href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css",document.head.appendChild(l),Qm(),await Yo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"),await Yo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/typescript.min.js"),await Yo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/bash.min.js"),window.hljs}catch(l){return console.warn("Failed to load Highlight.js:",l),null}}function Qm(){const l=document.createElement("style");l.textContent=`
  ...
  `,document.head.appendChild(l)}function Yo(l){return new Promise((e,t)=>{const n=document.createElement("script");n.src=l,n.onload=e,n.onerror=t,document.head.appendChild(n)})}function vu(){window.hljs?document.querySelectorAll("pre code").forEach(l=>{try{window.hljs.highlightElement(l)}catch(e){console.warn("Failed to highlight code block:",e)}}):document.querySelectorAll("pre code").forEach(l=>{l.style.fontFamily="'Monaco', 'Menlo', 'Ubuntu Mono', monospace",l.style.fontSize="14px",l.style.lineHeight="1.5"})}async function Zm(){const l=document.getElementById("angular-app-root");if(!l)return null;l.innerHTML=`
  ...
  `;const e=l.querySelector(".angular-form-editor"),t=l.querySelector(".angular-form-renderer");if(e&&t){const n=document.createElement("form");n.className="build-form-angular-real";const p=document.createElement("div");p.className="render-form-angular-real",e.appendChild(n),t.appendChild(p);const d={...tn,editorContainer:".build-form-angular-real",events:{...tn.events,onSave:s=>{console.log("Angular Component - Form saved:",s)},onChange:s=>{console.log("Angular Component - Form changed:",s)}}},g={...sa,renderContainer:".render-form-angular-real"},m=new ra(d),c=new oa(g),f=l.querySelector("#angular-save-btn"),r=l.querySelector("#angular-render-btn"),o=l.querySelector("#angular-clear-btn");return f&&f.addEventListener("click",()=>{const s=m.formData;console.log("Angular Component - Save clicked:",s),alert("Form saved! Check console for form data.")}),r&&r.addEventListener("click",()=>{const s=m.formData;s&&Object.keys(s).length>0?(p.style.display="block",c.render(s),console.log("Angular Component - Render clicked:",s)):alert("Please create a form first before rendering")}),o&&o.addEventListener("click",()=>{m&&m.clear(),c&&p&&(p.innerHTML="",p.style.display="none"),console.log("Angular Component - Clear clicked")}),{editor:m,renderer:c,destroy:()=>{m?.destroy&&m.destroy(),c?.destroy&&c.destroy()}}}return null}function Xo(l){const e=document.createElement("div");return e.textContent=l,e.innerHTML}const Jm=`import { Component, OnInit, OnDestroy, ElementRef, ViewChild, inject } from '@angular/core';
...
}`,ev=`import { Injectable, signal } from '@angular/core';
import { FormeoEditor, FormeoRenderer } from 'formeo';
...
}`,tv=`// app.config.ts (for standalone applications)
...
bootstrapApplication(AppComponent, appConfig)
  .catch(err => console.error(err));`;async function nv(l){l.innerHTML=`
  ...
  `;try{await iv(),await rv()&&console.log("Highlight.js loaded successfully for React demo"),l.innerHTML=`
      <div class="react-demo">
        <h3>React Integration Demo</h3>
        <div class="demo-description">
...
npm install --save-dev @types/react @types/react-dom typescript</code></pre>
          ...
          <div class="guide-section">
            ...
            <pre><code class="language-typescript">${Zo(av)}</code></pre>
          </div>
          
          <div class="guide-section">
            <h4>3. React Component Implementation</h4>
            <pre><code class="language-typescript">${Zo(lv)}</code></pre>
          </div>
          
          <div class="guide-section">
            <h4>4. Context Provider (Advanced)</h4>
            <pre><code class="language-typescript">${Zo(cv)}</code></pre>
          </div>
        </div>
    ...
    `;const t=await sv();yu();const n=l.querySelector("#toggle-instructions"),p=l.querySelector("#instructions-section"),d=n.querySelector(".toggle-text"),g=n.querySelector(".toggle-icon");return n&&p&&n.addEventListener("click",()=>{const m=p.style.display==="block";p.style.display=m?"none":"block",d.textContent=m?"Show Implementation Guide":"Hide Implementation Guide",g.textContent=m?"▼":"▲",m||setTimeout(()=>yu(),50)}),{reactApp:t,cleanup:()=>{t?.cleanup&&t.cleanup();const m=document.getElementById("react-app-root");m&&(m.innerHTML="")}}}catch(e){return console.error("Failed to load React demo:",e),l.innerHTML=`
      <div class="react-demo">
        <h3>React Integration Demo</h3>
        <div class="error-message">
    ...
    `,{cleanup:()=>{}}}}async function iv(){await new Promise(l=>setTimeout(l,500)),console.log("React-style demo environment ready")}async function rv(){if(window.hljs)return window.hljs;try{const l=document.createElement("link");return l.rel="stylesheet",l.href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css",document.head.appendChild(l),ov(),await Qo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"),await Qo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/typescript.min.js"),await Qo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/bash.min.js"),window.hljs}catch(l){return console.warn("Failed to load Highlight.js:",l),null}}function ov(){const l=document.createElement("style");l.textContent=`
  ...
  `,document.head.appendChild(l)}function Qo(l){return new Promise((e,t)=>{const n=document.createElement("script");n.src=l,n.onload=e,n.onerror=t,document.head.appendChild(n)})}function yu(){window.hljs?document.querySelectorAll("pre code").forEach(l=>{try{window.hljs.highlightElement(l)}catch(e){console.warn("Failed to highlight code block:",e)}}):document.querySelectorAll("pre code").forEach(l=>{l.style.fontFamily="'Monaco', 'Menlo', 'Ubuntu Mono', monospace",l.style.fontSize="14px",l.style.lineHeight="1.5"})}async function sv(){const l=document.getElementById("react-app-root");if(!l)return null;l.innerHTML=`
...
}`,lv=`import React, { useState } from 'react';
...
}`,cv=`import React, { createContext, useContext, useReducer, useCallback } from 'react';
import { FormeoEditor, FormeoRenderer } from 'formeo';
...
`,"error_marker.css",!1)}),ace.define("ace/ace",["require","exports","module","ace/lib/dom","ace/range","ace/editor","ace/edit_session","ace/undomanager","ace/virtual_renderer","ace/worker/worker_client","ace/keyboard/hash_handler","ace/placeholder","ace/multi_select","ace/mode/folding/fold_mode","ace/theme/textmate","ace/ext/error_marker","ace/config","ace/loader_build"],function(t,n,p){t("./loader_build")(n);var d=t("./lib/dom"),g=t("./range").Range,m=t("./editor").Editor,c=t("./edit_session").EditSession,f=t("./undomanager").UndoManager,r=t("./virtual_renderer").VirtualRenderer;t("./worker/worker_client"),t("./keyboard/hash_handler"),t("./placeholder"),t("./multi_select"),t("./mode/folding/fold_mode"),t("./theme/textmate"),t("./ext/error_marker"),n.config=t("./config"),n.edit=function(s,a){if(typeof s=="string"){var i=s;if(s=document.getElementById(i),!s)throw new Error("ace.edit can't find div #"+i)}if(s&&s.env&&s.env.editor instanceof m)return s.env.editor;var u="";if(s&&/input|textarea/i.test(s.tagName)){var h=s;u=h.value,s=d.createElement("pre"),h.parentNode.replaceChild(s,h)}else s&&(u=s.textContent,s.innerHTML="");var y=n.createEditSession(u),b=new m(new r(s),y,a),T={document:y,editor:b,onResize:b.resize.bind(b,null)};return h&&(T.textarea=h),b.on("destroy",function(){T.editor.container.env=null}),b.container.env=b.env=T,b},n.createEditSession=function(s,a){var i=new c(s,a);return i.setUndoManager(new f),i},n.Range=g,n.Editor=m,n.EditSession=c,n.UndoManager=f,n.VirtualRenderer=r;var o=n.config.version;n.version=o}),(function(){ace.require(["ace/ace"],function(t){t&&(t.config.init(!0),t.define=ace.define);var n=(function(){return this})();!n&&typeof window<"u"&&(n=window),!n&&typeof self<"u"&&(n=self),n.ace||(n.ace=t);for(var p in t)t.hasOwnProperty(p)&&(n.ace[p]=t[p]);n.ace.default=n.ace,l&&(l.exports=n.ace)})})()})(Jo)),Jo.exports}var aa=uv();const hv=Rt(aa),dv="/formeo/assets/js/mode-json.min.js",fv="/formeo/assets/js/theme-github_light_default.min.js";var es,wu;function pv(){if(wu)return es;wu=1;function l(e,t,n,p){var d=-1,g=e==null?0:e.length;for(p&&g&&(n=e[++d]);++d<g;)n=t(n,e[d],d,e);return n}return es=l,es}var ts,Cu;function gv(){if(Cu)return ts;Cu=1;function l(e){return function(t){return e?.[t]}}return ts=l,ts}var ns,Su;function mv(){if(Su)return ns;Su=1;var l=gv(),e={À:"A",Á:"A",Â:"A",Ã:"A",Ä:"A",Å:"A",à:"a",á:"a",â:"a",ã:"a",ä:"a",å:"a",Ç:"C",ç:"c",Ð:"D",ð:"d",È:"E",É:"E",Ê:"E",Ë:"E",è:"e",é:"e",ê:"e",ë:"e",Ì:"I",Í:"I",Î:"I",Ï:"I",ì:"i",í:"i",î:"i",ï:"i",Ñ:"N",ñ:"n",Ò:"O",Ó:"O",Ô:"O",Õ:"O",Ö:"O",Ø:"O",ò:"o",ó:"o",ô:"o",õ:"o",ö:"o",ø:"o",Ù:"U",Ú:"U",Û:"U",Ü:"U",ù:"u",ú:"u",û:"u",ü:"u",Ý:"Y",ý:"y",ÿ:"y",Æ:"Ae",æ:"ae",Þ:"Th",þ:"th",ß:"ss",Ā:"A",Ă:"A",Ą:"A",ā:"a",ă:"a",ą:"a",Ć:"C",Ĉ:"C",Ċ:"C",Č:"C",ć:"c",ĉ:"c",ċ:"c",č:"c",Ď:"D",Đ:"D",ď:"d",đ:"d",Ē:"E",Ĕ:"E",Ė:"E",Ę:"E",Ě:"E",ē:"e",ĕ:"e",ė:"e",ę:"e",ě:"e",Ĝ:"G",Ğ:"G",Ġ:"G",Ģ:"G",ĝ:"g",ğ:"g",ġ:"g",ģ:"g",Ĥ:"H",Ħ:"H",ĥ:"h",ħ:"h",Ĩ:"I",Ī:"I",Ĭ:"I",Į:"I",İ:"I",ĩ:"i",ī:"i",ĭ:"i",į:"i",ı:"i",Ĵ:"J",ĵ:"j",Ķ:"K",ķ:"k",ĸ:"k",Ĺ:"L",Ļ:"L",Ľ:"L",Ŀ:"L",Ł:"L",ĺ:"l",ļ:"l",ľ:"l",ŀ:"l",ł:"l",Ń:"N",Ņ:"N",Ň:"N",Ŋ:"N",ń:"n",ņ:"n",ň:"n",ŋ:"n",Ō:"O",Ŏ:"O",Ő:"O",ō:"o",ŏ:"o",ő:"o",Ŕ:"R",Ŗ:"R",Ř:"R",ŕ:"r",ŗ:"r",ř:"r",Ś:"S",Ŝ:"S",Ş:"S",Š:"S",ś:"s",ŝ:"s",ş:"s",š:"s",Ţ:"T",Ť:"T",Ŧ:"T",ţ:"t",ť:"t",ŧ:"t",Ũ:"U",Ū:"U",Ŭ:"U",Ů:"U",Ű:"U",Ų:"U",ũ:"u",ū:"u",ŭ:"u",ů:"u",ű:"u",ų:"u",Ŵ:"W",ŵ:"w",Ŷ:"Y",ŷ:"y",Ÿ:"Y",Ź:"Z",Ż:"Z",Ž:"Z",ź:"z",ż:"z",ž:"z",Ĳ:"IJ",ĳ:"ij",Œ:"Oe",œ:"oe",ŉ:"'n",ſ:"s"},t=l(e);return ns=t,ns}var is,Au;function vv(){if(Au)return is;Au=1;var l=mv(),e=Un(),t=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,n="\\u0300-\\u036f",p="\\ufe20-\\ufe2f",d="\\u20d0-\\u20ff",g=n+p+d,m="["+g+"]",c=RegExp(m,"g");function f(r){return r=e(r),r&&r.replace(t,l).replace(c,"")}return is=f,is}var rs,$u;function yv(){if($u)return rs;$u=1;var l=/[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g;function e(t){return t.match(l)||[]}return rs=e,rs}var os,Eu;function bv(){if(Eu)return os;Eu=1;var l=/[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;function e(t){return l.test(t)}return os=e,os}var ss,Tu;function wv(){if(Tu)return ss;Tu=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",p=e+t+n,d="\\u2700-\\u27bf",g="a-z\\xdf-\\xf6\\xf8-\\xff",m="\\xac\\xb1\\xd7\\xf7",c="\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf",f="\\u2000-\\u206f",r=" \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",o="A-Z\\xc0-\\xd6\\xd8-\\xde",s="\\ufe0e\\ufe0f",a=m+c+f+r,i="['’]",u="["+a+"]",h="["+p+"]",y="\\d+",b="["+d+"]",T="["+g+"]",$="[^"+l+a+y+d+g+o+"]",A="\\ud83c[\\udffb-\\udfff]",S="(?:"+h+"|"+A+")",M="[^"+l+"]",R="(?:\\ud83c[\\udde6-\\uddff]){2}",L="[\\ud800-\\udbff][\\udc00-\\udfff]",_="["+o+"]",O="\\u200d",w="(?:"+T+"|"+$+")",v="(?:"+_+"|"+$+")",C="(?:"+i+"(?:d|ll|m|re|s|t|ve))?",E="(?:"+i+"(?:D|LL|M|RE|S|T|VE))?",x=S+"?",k="["+s+"]?",D="(?:"+O+"(?:"+[M,R,L].join("|")+")"+k+x+")*",I="\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",N="\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",P=k+x+D,z="(?:"+[b,R,L].join("|")+")"+P,F=RegExp([_+"?"+T+"+"+C+"(?="+[u,_,"$"].join("|")+")",v+"+"+E+"(?="+[u,_+w,"$"].join("|")+")",_+"?"+w+"+"+C,_+"+"+E,N,I,y,z].join("|"),"g");function W(H){return H.match(F)||[]}return ss=W,ss}var as,Mu;function Cv(){if(Mu)return as;Mu=1;var l=yv(),e=bv(),t=Un(),n=wv();function p(d,g,m){return d=t(d),g=m?void 0:g,g===void 0?e(d)?n(d):l(d):d.match(g)||[]}return as=p,as}var ls,_u;function Sv(){if(_u)return ls;_u=1;var l=pv(),e=vv(),t=Cv(),n="['’]",p=RegExp(n,"g");function d(g){return function(m){return l(t(e(m).replace(p,"")),g,"")}}return ls=d,ls}var cs,xu;function Av(){if(xu)return cs;xu=1;function l(e,t,n){var p=-1,d=e.length;t<0&&(t=-t>d?0:d+t),n=n>d?d:n,n<0&&(n+=d),d=t>n?0:n-t>>>0,t>>>=0;for(var g=Array(d);++p<d;)g[p]=e[p+t];return g}return cs=l,cs}var us,Lu;function $v(){if(Lu)return us;Lu=1;var l=Av();function e(t,n,p){var d=t.length;return p=p===void 0?d:p,!n&&p>=d?t:l(t,n,p)}return us=e,us}var hs,Ru;function ld(){if(Ru)return hs;Ru=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",p=e+t+n,d="\\ufe0e\\ufe0f",g="\\u200d",m=RegExp("["+g+l+p+d+"]");function c(f){return m.test(f)}return hs=c,hs}var ds,ku;function Ev(){if(ku)return ds;ku=1;function l(e){return e.split("")}return ds=l,ds}var fs,Ou;function Tv(){if(Ou)return fs;Ou=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",p=e+t+n,d="\\ufe0e\\ufe0f",g="["+l+"]",m="["+p+"]",c="\\ud83c[\\udffb-\\udfff]",f="(?:"+m+"|"+c+")",r="[^"+l+"]",o="(?:\\ud83c[\\udde6-\\uddff]){2}",s="[\\ud800-\\udbff][\\udc00-\\udfff]",a="\\u200d",i=f+"?",u="["+d+"]?",h="(?:"+a+"(?:"+[r,o,s].join("|")+")"+u+i+")*",y=u+i+h,b="(?:"+[r+m+"?",m,o,s,g].join("|")+")",T=RegExp(c+"(?="+c+")|"+b+y,"g");function $(A){return A.match(T)||[]}return fs=$,fs}var ps,Du;function Mv(){if(Du)return ps;Du=1;var l=Ev(),e=ld(),t=Tv();function n(p){return e(p)?t(p):l(p)}return ps=n,ps}var gs,Iu;function _v(){if(Iu)return gs;Iu=1;var l=$v(),e=ld(),t=Mv(),n=Un();function p(d){return function(g){g=n(g);var m=e(g)?t(g):void 0,c=m?m[0]:g.charAt(0),f=m?l(m,1).join(""):g.slice(1);return c[d]()+f}}return gs=p,gs}var ms,Nu;function xv(){if(Nu)return ms;Nu=1;var l=_v(),e=l("toUpperCase");return ms=e,ms}var vs,Fu;function Lv(){if(Fu)return vs;Fu=1;var l=Sv(),e=xv(),t=l(function(n,p,d){return n+(d?" ":"")+e(p)});return vs=t,vs}var Rv=Lv();const kv=Rt(Rv);aa.config.setModuleUrl("ace/mode/json",dv);aa.config.setModuleUrl("ace/theme/github_light_default",fv);const et=hv.edit("formData-editor");et.session.setOption("useWorker",!1);et.setOptions({theme:"ace/theme/github_light_default",mode:"ace/mode/json"});const Ov=document.getElementById("submit-formData"),Dv=document.getElementById("formData-popover"),Iv=document.getElementById("editor-action-buttons"),Nv=(l,e)=>({renderForm:()=>{const t=document.querySelector(".render-form");t.style.display="block",e.render(l.formData)},getHtml:()=>{e.formData=l.formData;const t=e.html,n=window.open("","_blank");n.document.body.innerHTML=t},getUserData:()=>{console.log(e.userData)},resetEditor:()=>{window.sessionStorage.removeItem("formeo-formData"),window.location.reload()},editData:()=>{et.setValue(JSON.stringify(l.formData,null,2),1)}}),Fv={editData:{popovertarget:"formData-popover"}},Pv=l=>{const e=Fv[l]||{};return{id:l,type:"button",...e}},Wv=(l,e)=>{Ov.addEventListener("click",()=>{l.formData=et.session.getValue(),Dv.hidePopover()});const t=Nv(l,e);return Object.entries(t).map(([p,d])=>{const g=Pv(p),m=Object.assign(document.createElement("button"),g);for(const[f,r]of Object.entries(g))m.setAttribute(f,r);const c=document.createTextNode(kv(p));return m.appendChild(c),m.addEventListener("click",d,!1),Iv.appendChild(m),m})};document.getElementById("format-json").addEventListener("click",Bv);document.getElementById("collapse-json").addEventListener("click",Hv);document.getElementById("copy-json").addEventListener("click",zv);function Bv(){const l=et.session.getValue(),e=JSON.parse(l);et.setValue(JSON.stringify(e,null,2),1)}function Hv(){const l=et.session.getValue(),e=JSON.parse(l);et.setValue(JSON.stringify(e,null,0),1)}async function zv({target:l}){const e=l.textContent;l.textContent="Copied!";const t=setTimeout(()=>{l.textContent=e,clearTimeout(t)},3e3);try{await navigator.clipboard.writeText(et.session.getValue()),console.log("Text copied to clipboard")}catch(n){console.error("Failed to copy: ",n)}}const jv=l=>{const e=document.getElementById("control-filter"),t=document.getElementById("locale"),n=window.sessionStorage.getItem("formeo-locale"),p=({target:{value:g}})=>l.controls.actions.filter(g),d=({target:{value:g}})=>{window.sessionStorage.setItem("formeo-locale",g),l.i18n.setLang(g)};e.addEventListener("input",p),t.value=n||"en-US",t.addEventListener("change",d,!1)};async function Uv(l){l.innerHTML=`
    <form class="build-form"></form>
    <div class="render-form"></div>
  `;const e=new ra(tn),t=new oa(sa);return Wv(e,t),jv(e),{editor:e,renderer:t,cleanup:()=>{e?.destroy&&e.destroy(),t?.destroy&&t.destroy();const n=document.getElementById("editor-action-buttons");n&&(n.innerHTML="")}}}class Gv{constructor(){if(this.currentFramework=null,this.frameworkContainer=document.getElementById("framework-container"),this.frameworkSelect=document.getElementById("framework-select"),this.currentDemo=null,this.isLoading=!1,this.validFrameworks=["vanilla","angular","react"],!this.frameworkContainer){console.error("Framework container not found");return}if(!this.frameworkSelect){console.error("Framework selector not found");return}this.init()}init(){this.frameworkSelect.addEventListener("change",t=>{this.switchFramework(t.target.value)}),window.addEventListener("popstate",()=>{const t=this.getFrameworkFromURL();this.switchFramework(t,{updateURL:!1})});const e=this.getFrameworkFromURL();this.switchFramework(e)}async switchFramework(e,t={}){const{updateURL:n=!0}=t;if(this.isLoading){console.warn("Framework switch already in progress");return}if(!(this.currentFramework===e&&this.currentDemo!==null)){this.isLoading=!0,this.showLoadingState();try{switch(await this.cleanupCurrentDemo(),this.frameworkContainer.innerHTML="",e){case"vanilla":this.currentDemo=await Uv(this.frameworkContainer);break;case"angular":this.currentDemo=await qm(this.frameworkContainer);break;case"react":this.currentDemo=await nv(this.frameworkContainer);break;default:throw new Error(`Unknown framework: ${e}`)}this.currentFramework=e,this.syncFrameworkSelector(e),n&&this.updateURL(e),console.log(`Loaded ${e} demo successfully`)}catch(p){console.error(`Failed to load ${e} demo:`,p),this.showErrorState(e,p)}finally{this.isLoading=!1}}}async cleanupCurrentDemo(){if(this.currentDemo?.cleanup)try{await Promise.resolve(this.currentDemo.cleanup())}catch(e){console.warn("Error during demo cleanup:",e)}this.currentDemo=null}syncFrameworkSelector(e){this.frameworkSelect.value!==e&&(this.frameworkSelect.value=e)}getFrameworkFromURL(){const t=new URLSearchParams(window.location.search).get("framework");return t&&this.validFrameworks.includes(t)?t:"vanilla"}updateURL(e){const t=new URL(window.location);e==="vanilla"?t.searchParams.delete("framework"):t.searchParams.set("framework",e),window.history.pushState({framework:e},"",t.toString())}showLoadingState(){this.frameworkContainer.innerHTML=`
      <div class="loading-message">
    ...
    `}}document.addEventListener("DOMContentLoaded",()=>{window.frameworkLoader=new Gv});export{wm as C,je as a,Q as m,at as t};
