...
`),n={};for(let m,f=0;f<t.length;f++)m=/^(.+?) *?= *?([^\n]+)/.exec(t[f]),m&&(n[m[1]]=m[2].trim());return n}static getInstance(i){return qt||(qt=new ii(i)),qt}static resetInstance(){qt=null}async loadLang(i,t=!0){if(this.loaded.includes(i)&&t)return this.langs[i];const n=`${this.config.location}${i}${this.config.extension}`;try{const m=await(async function(g){try{const u=await fetch(g);if(!u.ok)throw new Error(`HTTP error! status: ${u.status}`);return await u[g.endsWith(".lang")?"text":"json"]()}catch(u){throw u}})(n),f=ii.processFile(m);return this.applyLanguage(i,f),this.langs[i]}catch{return this.applyLanguage(i)}}applyLanguage(i,t={}){const n=this.config.override[i]||{},m=this.langs[i]||{};return this.langs[i]={...m,...t,...n},this.loaded.push(i),this.langs[i]}get getLangs(){return this.config.langs}async setCurrent(i="en-US"){return this.loaded.includes(i)||await this.loadLang(i),this.locale=i,this.current=this.langs[i],this.current}},{apply:(e,i,t)=>e.getInstance(...t),construct:(e,i)=>new e(...i),get:(e,i)=>e[i]}),Z=qr.getInstance();(function(){"use strict";try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode('._3x4ZIcu-{position:absolute;background:#1f2937;color:#fff;padding:.75rem;border-radius:.375rem;max-width:200px;z-index:50;visibility:hidden;opacity:0;transition:opacity .2s;pointer-events:none;left:0;top:0}._3x4ZIcu-.JIt36hCJ{visibility:visible;opacity:1;pointer-events:all}._3x4ZIcu-:before{content:"";position:absolute;width:0;height:0;border:6px solid transparent}._3x4ZIcu-[data-position=top]:before{border-top-color:#1f2937;bottom:-12px;left:50%;transform:translate(-50%)}._3x4ZIcu-[data-position=bottom]:before{border-bottom-color:#1f2937;top:-12px;left:50%;transform:translate(-50%)}._3x4ZIcu-[data-position=left]:before{border-left-color:#1f2937;right:-12px;top:50%;transform:translateY(-50%)}._3x4ZIcu-[data-position=right]:before{border-right-color:#1f2937;left:-12px;top:50%;transform:translateY(-50%)}._3x4ZIcu-[data-position=top-left]:before{border-top-color:#1f2937;bottom:-12px;left:12px;transform:none}._3x4ZIcu-[data-position=top-right]:before{border-top-color:#1f2937;bottom:-12px;right:12px;left:auto;transform:none}._3x4ZIcu-[data-position=bottom-left]:before{border-bottom-color:#1f2937;top:-12px;left:12px;transform:none}._3x4ZIcu-[data-position=bottom-right]:before{border-bottom-color:#1f2937;top:-12px;right:12px;left:auto;transform:none}')),document.head.appendChild(e)}}catch(i){console.error("vite-plugin-css-injected-by-js",i)}})();var Ts=Object.defineProperty,Ms=(e,i,t)=>i in e?Ts(e,i,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[i]=t,Fe=(e,i,t)=>Ms(e,typeof i!="symbol"?i+"":i,t),Mt={tooltip:"_3x4ZIcu-",visible:"JIt36hCJ"},$s={triggerName:"tooltip"},Yr=class gt{constructor(i=$s){Fe(this,"triggerName"),Fe(this,"tooltip"),Fe(this,"activeTriggerType",null),Fe(this,"spacing",12),Fe(this,"handleClick",t=>{const n=this.triggerName,m=t.target.closest(`[${n}][${n}-type="click"]`);if(m)if(this.isVisible())this.hide();else{const f=m.getAttribute(`${n}`);this.show(m,f),this.activeTriggerType="click"}else this.hide()}),Fe(this,"handleMouseOver",t=>{const n=this.triggerName,m=t.target.closest(`[${n}]`);if(this.activeTriggerType!=="click"&&m?.getAttribute(`${n}-type`)!=="click"){const f=m?.getAttribute(`${n}`);f&&(this.show(m,f),this.activeTriggerType="hover")}}),Fe(this,"handleMouseOut",t=>{const n=this.triggerName,m=t.target.closest(`[${n}]`);this.activeTriggerType!=="click"&&m?.getAttribute(`${n}-type`)!=="click"&&this.hide()}),Fe(this,"handleResize",()=>{this.isVisible()&&this.hide()}),Fe(this,"handleScroll",()=>{this.isVisible()&&this.hide()}),gt.instance&&gt.instance.destroy(),this.triggerName=`data-${i.triggerName}`,this.tooltip=document.createElement("div"),this.tooltip.className=`d-tooltip ${Mt.tooltip}`,document.body.appendChild(this.tooltip),this.setupEventListeners(),gt.instance=this}setupEventListeners(){document.addEventListener("mouseover",this.handleMouseOver),document.addEventListener("mouseout",this.handleMouseOut),document.addEventListener("touchstart",this.handleMouseOver),document.addEventListener("touchend",this.handleMouseOut),document.addEventListener("click",this.handleClick),globalThis.addEventListener("resize",this.handleResize),globalThis.addEventListener("scroll",this.handleScroll,!0)}isVisible(){return this.tooltip.classList.contains(Mt.visible)}calculatePosition(i){const t=i.getBoundingClientRect(),n=this.tooltip.getBoundingClientRect(),m=[{name:"top",x:t.left+(t.width-n.width)/2,y:t.top-n.height-this.spacing},{name:"bottom",x:t.left+(t.width-n.width)/2,y:t.bottom+this.spacing},{name:"left",x:t.left-n.width-this.spacing,y:t.top+(t.height-n.height)/2},{name:"right",x:t.right+this.spacing,y:t.top+(t.height-n.height)/2},{name:"top-left",x:t.left,y:t.top-n.height-this.spacing},{name:"top-right",x:t.right-n.width,y:t.top-n.height-this.spacing},{name:"bottom-left",x:t.left,y:t.bottom+this.spacing},{name:"bottom-right",x:t.right-n.width,y:t.bottom+this.spacing}];return m.find(f=>this.fitsInViewport(f,n))||m[0]}fitsInViewport(i,t){return i.x>=0&&i.y>=0&&i.x+t.width<=globalThis.innerWidth&&i.y+t.height<=globalThis.innerHeight?[[i.x,i.y],[i.x+t.width,i.y],[i.x,i.y+t.height],[i.x+t.width,i.y+t.height],[i.x+t.width/2,i.y+t.height/2]].flatMap(([n,m])=>Array.from(document.elementsFromPoint(n,m))).filter(n=>{if(this.tooltip.contains(n)||n===this.tooltip||n.classList.contains(Mt.tooltip)||getComputedStyle(n).pointerEvents==="none")return!1}).length===0:!1}show(i,t){this.tooltip.innerHTML=t??"",this.tooltip.classList.add(Mt.visible);const n=this.calculatePosition(i);this.tooltip.style.left=`${n.x}px`,this.tooltip.style.top=`${n.y}px`,this.tooltip.dataset.position=n.name}hide(){this.tooltip.classList.remove(Mt.visible),this.activeTriggerType=null}destroy(){document.removeEventListener("mouseover",this.handleMouseOver),document.removeEventListener("mouseout",this.handleMouseOut),document.removeEventListener("touchstart",this.handleMouseOver),document.removeEventListener("touchend",this.handleMouseOut),document.removeEventListener("click",this.handleClick),globalThis.removeEventListener("resize",this.handleResize),globalThis.removeEventListener("scroll",this.handleScroll,!0),this.tooltip.remove(),gt.instance===this&&(gt.instance=null)}};Fe(Yr,"instance",null);var Zr=Yr;globalThis!==void 0&&(globalThis.SmartTooltip=Zr);var Ls="formeo",Rs="5.2.1",_s="module",Os="dist/formeo.cjs.js",Is="dist/formeo.es.js",Ds="dist/formeo.umd.js",Ns={".":{import:"./dist/formeo.es.js",require:"./dist/formeo.cjs.js",default:"./dist/formeo.umd.js"},"./dist/formeo.min.css":{import:"./dist/formeo.min.css",require:"./dist/formeo.min.css",default:"./dist/formeo.min.css"}},Fs=["dist/*","demo/**/*"],zs="https://formeo.io",Ps={url:"https://github.com/Draggable/formeo",type:"git"},Hs="Draggable https://draggable.io",Ws=[{name:"Kevin Chappell",email:"kevin@chappell.dev",url:"https://kevin-chappell.com"}],Bs={url:"https://github.com/draggable/formeo/issues"},js="A zero dependency JavaScript module for drag and drop form creation.",Vs=["drag and drop","form builder","form maker","forms"];var Us=["**/*","node_modules","test"],Gs={files:{test:["test/**/*.spec.js"],"formeo-editor":{js:"src/js/editor.js"},"formeo-renderer":{js:"src/js/renderer.js"},site:["demo/assets/sass/site.scss"]}},Ks={dev:"NODE_ENV=development vite",preview:"vite preview","prebuild:lib":"rm -rf dist","build:lib":"npm-run-all -p build:lib:unminified build:lib:minified","build:lib:unminified":"vite build --config vite.config.lib.mjs --mode production","build:lib:minified":"vite build --config vite.config.lib.mjs --mode production-minified",build:"npm-run-all -p build:icons build:demo",prebuild:"npm run build:lib",postbuild:"npm run generate:jsonSchema","build:demo":"vite build --mode demo","postbuild:demo":"node --no-warnings tools/copy-assets.mjs","build:demo:watch":"vite build --mode demo --watch","build:icons":"node ./tools/generate-sprite",lint:"biome check ./src && node tools/check-color-literals.mjs && node tools/check-doc-links.mjs","lint:fix":"biome check --write ./src",format:"biome format --write .",test:"node --loader=./tools/svg-loader.mjs --import=./tools/__mocks__/sprite-init.mjs --experimental-test-snapshots --require ./tools/test-setup.cjs --test --no-warnings src/**/*.test.{js,mjs}","test:watch":"node --watch --loader=./tools/svg-loader.mjs --import=./tools/__mocks__/sprite-init.mjs --experimental-test-snapshots --require ./tools/test-setup.cjs --test --no-warnings src/**/*.test.{js,mjs}","test:updateSnapshots":"node --loader=./tools/svg-loader.mjs --import=./tools/__mocks__/sprite-init.mjs --experimental-test-snapshots --test-update-snapshots --require ./tools/test-setup.cjs --test --no-warnings src/**/*.test.{js,mjs}","test:ci":"npm test --coverage",start:"npm-run-all build:icons dev","semantic-release":"semantic-release --ci --debug","copy:lang":"node ./tools/copy-directory.mjs ./node_modules/formeo-i18n/dist/lang ./src/demo/assets/lang","travis-deploy-once":"travis-deploy-once --pro","playwright:test":"playwright test","playwright:test:ui":"playwright test --ui","playwright:test:report":"playwright show-report","playwright:test:ci":"playwright test --reporter=dot",prepush:"npm test",prepare:"lefthook install",postmerge:"lefthook install","generate:jsonSchema":"node --experimental-strip-types --no-warnings ./tools/generate-json-schema.ts"},qs={"@biomejs/biome":"^2.3.3","@commitlint/cli":"^21.0.1","@commitlint/config-conventional":"^21.0.1","@playwright/test":"^1.49.1","@semantic-release/changelog":"^6.0.3","@semantic-release/git":"^10.0.1","@semantic-release/github":"^12.0.8","@semantic-release/npm":"^13.1.3","@types/node":"^25.8.0","ace-builds":"^1.36.5",esbuild:"^0.28.0",jsdom:"^29.1.1",lefthook:"^2.1.6","npm-run-all":"^4.1.5","sass-embedded":"^1.80.1","semantic-release":"^25.0.2","svg-sprite":"^2.0.4",vite:"^8.0.13","vite-plugin-banner":"^0.8.0","vite-plugin-compression":"^0.5.1","vite-plugin-html":"^3.2.2",zod:"^4.4.3"},Ys={"@draggable/formeo-languages":"^3.4.1","@draggable/i18n":"^1.0.7","@draggable/tooltip":"^1.2.2",lodash:"^4.17.21",sortablejs:"^1.15.3"},Zs={branches:["main"],verifyConditions:["@semantic-release/changelog","@semantic-release/npm","@semantic-release/git","@semantic-release/github"],prepare:["@semantic-release/changelog","@semantic-release/npm","@semantic-release/git"],publish:["@semantic-release/npm","@semantic-release/github"],success:["@semantic-release/github"],fail:["@semantic-release/github"]},Qs={extends:["@commitlint/config-conventional"],rules:{"type-enum":[2,"always",["build","chore","ci","docs","feat","fix","perf","refactor","revert","style","test"]]}},Qr={name:Ls,version:Rs,type:_s,main:Os,module:Is,unpkg:Ds,exports:Ns,files:Fs,homepage:zs,repository:Ps,author:Hs,contributors:Ws,bugs:Bs,description:js,keywords:Vs,license:"MIT",ignore:Us,config:Gs,scripts:Ks,devDependencies:qs,dependencies:Ys,release:Zs,commitlint:Qs},Xs=j(((e,i)=>{function t(){this.__data__=[],this.size=0}i.exports=t})),Vt=j(((e,i)=>{function t(n,m){return n===m||n!==n&&m!==m}i.exports=t})),Ei=j(((e,i)=>{var t=Vt();function n(m,f){for(var g=m.length;g--;)if(t(m[g][0],f))return g;return-1}i.exports=n})),Js=j(((e,i)=>{var t=Ei(),n=Array.prototype.splice;function m(f){var g=this.__data__,u=t(g,f);return u<0?!1:(u==g.length-1?g.pop():n.call(g,u,1),--this.size,!0)}i.exports=m})),ea=j(((e,i)=>{var t=Ei();function n(m){var f=this.__data__,g=t(f,m);return g<0?void 0:f[g][1]}i.exports=n})),ta=j(((e,i)=>{var t=Ei();function n(m){return t(this.__data__,m)>-1}i.exports=n})),ia=j(((e,i)=>{var t=Ei();function n(m,f){var g=this.__data__,u=t(g,m);return u<0?(++this.size,g.push([m,f])):g[u][1]=f,this}i.exports=n})),Ai=j(((e,i)=>{var t=Xs(),n=Js(),m=ea(),f=ta(),g=ia();function u(o){var h=-1,d=o==null?0:o.length;for(this.clear();++h<d;){var c=o[h];this.set(c[0],c[1])}}u.prototype.clear=t,u.prototype.delete=n,u.prototype.get=m,u.prototype.has=f,u.prototype.set=g,i.exports=u})),na=j(((e,i)=>{var t=Ai();function n(){this.__data__=new t,this.size=0}i.exports=n})),ra=j(((e,i)=>{function t(n){var m=this.__data__,f=m.delete(n);return this.size=m.size,f}i.exports=t})),oa=j(((e,i)=>{function t(n){return this.__data__.get(n)}i.exports=t})),sa=j(((e,i)=>{function t(n){return this.__data__.has(n)}i.exports=t})),Xr=j(((e,i)=>{var t=typeof global=="object"&&global&&global.Object===Object&&global;i.exports=t})),Be=j(((e,i)=>{var t=Xr(),n=typeof self=="object"&&self&&self.Object===Object&&self,m=t||n||Function("return this")();i.exports=m})),ki=j(((e,i)=>{var t=Be().Symbol;i.exports=t})),aa=j(((e,i)=>{var t=ki(),n=Object.prototype,m=n.hasOwnProperty,f=n.toString,g=t?t.toStringTag:void 0;function u(o){var h=m.call(o,g),d=o[g];try{o[g]=void 0;var c=!0}catch{}var l=f.call(o);return c&&(h?o[g]=d:delete o[g]),l}i.exports=u})),la=j(((e,i)=>{var t=Object.prototype.toString;function n(m){return t.call(m)}i.exports=n})),At=j(((e,i)=>{var t=ki(),n=aa(),m=la(),f="[object Null]",g="[object Undefined]",u=t?t.toStringTag:void 0;function o(h){return h==null?h===void 0?g:f:u&&u in Object(h)?n(h):m(h)}i.exports=o})),et=j(((e,i)=>{function t(n){var m=typeof n;return n!=null&&(m=="object"||m=="function")}i.exports=t})),xn=j(((e,i)=>{var t=At(),n=et(),m="[object AsyncFunction]",f="[object Function]",g="[object GeneratorFunction]",u="[object Proxy]";function o(h){if(!n(h))return!1;var d=t(h);return d==f||d==g||d==m||d==u}i.exports=o})),ca=j(((e,i)=>{var t=Be()["__core-js_shared__"];i.exports=t})),ua=j(((e,i)=>{var t=ca(),n=(function(){var f=/[^.]+$/.exec(t&&t.keys&&t.keys.IE_PROTO||"");return f?"Symbol(src)_1."+f:""})();function m(f){return!!n&&n in f}i.exports=m})),Jr=j(((e,i)=>{var t=Function.prototype.toString;function n(m){if(m!=null){try{return t.call(m)}catch{}try{return m+""}catch{}}return""}i.exports=n})),da=j(((e,i)=>{var t=xn(),n=ua(),m=et(),f=Jr(),g=/[\\^$.*+?()[\]{}|]/g,u=/^\[object .+?Constructor\]$/,o=Function.prototype,h=Object.prototype,d=o.toString,c=h.hasOwnProperty,l=RegExp("^"+d.call(c).replace(g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function s(r){return!m(r)||n(r)?!1:(t(r)?l:u).test(f(r))}i.exports=s})),ha=j(((e,i)=>{function t(n,m){return n?.[m]}i.exports=t})),ut=j(((e,i)=>{var t=da(),n=ha();function m(f,g){var u=n(f,g);return t(u)?u:void 0}i.exports=m})),En=j(((e,i)=>{var t=ut()(Be(),"Map");i.exports=t})),Ti=j(((e,i)=>{var t=ut()(Object,"create");i.exports=t})),pa=j(((e,i)=>{var t=Ti();function n(){this.__data__=t?t(null):{},this.size=0}i.exports=n})),fa=j(((e,i)=>{function t(n){var m=this.has(n)&&delete this.__data__[n];return this.size-=m?1:0,m}i.exports=t})),ga=j(((e,i)=>{var t=Ti(),n="__lodash_hash_undefined__",m=Object.prototype.hasOwnProperty;function f(g){var u=this.__data__;if(t){var o=u[g];return o===n?void 0:o}return m.call(u,g)?u[g]:void 0}i.exports=f})),ma=j(((e,i)=>{var t=Ti(),n=Object.prototype.hasOwnProperty;function m(f){var g=this.__data__;return t?g[f]!==void 0:n.call(g,f)}i.exports=m})),va=j(((e,i)=>{var t=Ti(),n="__lodash_hash_undefined__";function m(f,g){var u=this.__data__;return this.size+=this.has(f)?0:1,u[f]=t&&g===void 0?n:g,this}i.exports=m})),ya=j(((e,i)=>{var t=pa(),n=fa(),m=ga(),f=ma(),g=va();function u(o){var h=-1,d=o==null?0:o.length;for(this.clear();++h<d;){var c=o[h];this.set(c[0],c[1])}}u.prototype.clear=t,u.prototype.delete=n,u.prototype.get=m,u.prototype.has=f,u.prototype.set=g,i.exports=u})),ba=j(((e,i)=>{var t=ya(),n=Ai(),m=En();function f(){this.size=0,this.__data__={hash:new t,map:new(m||n),string:new t}}i.exports=f})),wa=j(((e,i)=>{function t(n){var m=typeof n;return m=="string"||m=="number"||m=="symbol"||m=="boolean"?n!=="__proto__":n===null}i.exports=t})),Mi=j(((e,i)=>{var t=wa();function n(m,f){var g=m.__data__;return t(f)?g[typeof f=="string"?"string":"hash"]:g.map}i.exports=n})),Ca=j(((e,i)=>{var t=Mi();function n(m){var f=t(this,m).delete(m);return this.size-=f?1:0,f}i.exports=n})),Sa=j(((e,i)=>{var t=Mi();function n(m){return t(this,m).get(m)}i.exports=n})),xa=j(((e,i)=>{var t=Mi();function n(m){return t(this,m).has(m)}i.exports=n})),Ea=j(((e,i)=>{var t=Mi();function n(m,f){var g=t(this,m),u=g.size;return g.set(m,f),this.size+=g.size==u?0:1,this}i.exports=n})),An=j(((e,i)=>{var t=ba(),n=Ca(),m=Sa(),f=xa(),g=Ea();function u(o){var h=-1,d=o==null?0:o.length;for(this.clear();++h<d;){var c=o[h];this.set(c[0],c[1])}}u.prototype.clear=t,u.prototype.delete=n,u.prototype.get=m,u.prototype.has=f,u.prototype.set=g,i.exports=u})),Aa=j(((e,i)=>{var t=Ai(),n=En(),m=An(),f=200;function g(u,o){var h=this.__data__;if(h instanceof t){var d=h.__data__;if(!n||d.length<f-1)return d.push([u,o]),this.size=++h.size,this;h=this.__data__=new m(d)}return h.set(u,o),this.size=h.size,this}i.exports=g})),eo=j(((e,i)=>{var t=Ai(),n=na(),m=ra(),f=oa(),g=sa(),u=Aa();function o(h){var d=this.__data__=new t(h);this.size=d.size}o.prototype.clear=n,o.prototype.delete=m,o.prototype.get=f,o.prototype.has=g,o.prototype.set=u,i.exports=o})),to=j(((e,i)=>{var t=ut(),n=(function(){try{var m=t(Object,"defineProperty");return m({},"",{}),m}catch{}})();i.exports=n})),kn=j(((e,i)=>{var t=to();function n(m,f,g){f=="__proto__"&&t?t(m,f,{configurable:!0,enumerable:!0,value:g,writable:!0}):m[f]=g}i.exports=n})),io=j(((e,i)=>{var t=kn(),n=Vt();function m(f,g,u){(u!==void 0&&!n(f[g],u)||u===void 0&&!(g in f))&&t(f,g,u)}i.exports=m})),ka=j(((e,i)=>{function t(n){return function(m,f,g){for(var u=-1,o=Object(m),h=g(m),d=h.length;d--;){var c=h[n?d:++u];if(f(o[c],c,o)===!1)break}return m}}i.exports=t})),Ta=j(((e,i)=>{var t=ka()();i.exports=t})),Ma=j(((e,i)=>{var t=Be(),n=typeof e=="object"&&e&&!e.nodeType&&e,m=n&&typeof i=="object"&&i&&!i.nodeType&&i,f=m&&m.exports===n?t.Buffer:void 0,g=f?f.allocUnsafe:void 0;function u(o,h){if(h)return o.slice();var d=o.length,c=g?g(d):new o.constructor(d);return o.copy(c),c}i.exports=u})),no=j(((e,i)=>{var t=Be().Uint8Array;i.exports=t})),$a=j(((e,i)=>{var t=no();function n(m){var f=new m.constructor(m.byteLength);return new t(f).set(new t(m)),f}i.exports=n})),La=j(((e,i)=>{var t=$a();function n(m,f){var g=f?t(m.buffer):m.buffer;return new m.constructor(g,m.byteOffset,m.length)}i.exports=n})),Ra=j(((e,i)=>{function t(n,m){var f=-1,g=n.length;for(m||(m=Array(g));++f<g;)m[f]=n[f];return m}i.exports=t})),_a=j(((e,i)=>{var t=et(),n=Object.create,m=(function(){function f(){}return function(g){if(!t(g))return{};if(n)return n(g);f.prototype=g;var u=new f;return f.prototype=void 0,u}})();i.exports=m})),ro=j(((e,i)=>{function t(n,m){return function(f){return n(m(f))}}i.exports=t})),oo=j(((e,i)=>{var t=ro()(Object.getPrototypeOf,Object);i.exports=t})),Tn=j(((e,i)=>{var t=Object.prototype;function n(m){var f=m&&m.constructor;return m===(typeof f=="function"&&f.prototype||t)}i.exports=n})),Oa=j(((e,i)=>{var t=_a(),n=oo(),m=Tn();function f(g){return typeof g.constructor=="function"&&!m(g)?t(n(g)):{}}i.exports=f})),dt=j(((e,i)=>{function t(n){return n!=null&&typeof n=="object"}i.exports=t})),Ia=j(((e,i)=>{var t=At(),n=dt(),m="[object Arguments]";function f(g){return n(g)&&t(g)==m}i.exports=f})),so=j(((e,i)=>{var t=Ia(),n=dt(),m=Object.prototype,f=m.hasOwnProperty,g=m.propertyIsEnumerable,u=t((function(){return arguments})())?t:function(o){return n(o)&&f.call(o,"callee")&&!g.call(o,"callee")};i.exports=u})),ht=j(((e,i)=>{var t=Array.isArray;i.exports=t})),ao=j(((e,i)=>{var t=9007199254740991;function n(m){return typeof m=="number"&&m>-1&&m%1==0&&m<=t}i.exports=n})),$i=j(((e,i)=>{var t=xn(),n=ao();function m(f){return f!=null&&n(f.length)&&!t(f)}i.exports=m})),Da=j(((e,i)=>{var t=$i(),n=dt();function m(f){return n(f)&&t(f)}i.exports=m})),Na=j(((e,i)=>{function t(){return!1}i.exports=t})),Mn=j(((e,i)=>{var t=Be(),n=Na(),m=typeof e=="object"&&e&&!e.nodeType&&e,f=m&&typeof i=="object"&&i&&!i.nodeType&&i,g=f&&f.exports===m?t.Buffer:void 0,u=(g?g.isBuffer:void 0)||n;i.exports=u})),Fa=j(((e,i)=>{var t=At(),n=oo(),m=dt(),f="[object Object]",g=Function.prototype,u=Object.prototype,o=g.toString,h=u.hasOwnProperty,d=o.call(Object);function c(l){if(!m(l)||t(l)!=f)return!1;var s=n(l);if(s===null)return!0;var r=h.call(s,"constructor")&&s.constructor;return typeof r=="function"&&r instanceof r&&o.call(r)==d}i.exports=c})),za=j(((e,i)=>{var t=At(),n=ao(),m=dt(),f="[object Arguments]",g="[object Array]",u="[object Boolean]",o="[object Date]",h="[object Error]",d="[object Function]",c="[object Map]",l="[object Number]",s="[object Object]",r="[object RegExp]",a="[object Set]",p="[object String]",v="[object WeakMap]",y="[object ArrayBuffer]",k="[object DataView]",x="[object Float32Array]",w="[object Float64Array]",S="[object Int8Array]",M="[object Int16Array]",L="[object Int32Array]",R="[object Uint8Array]",$="[object Uint8ClampedArray]",D="[object Uint16Array]",T="[object Uint32Array]",E={};E[x]=E[w]=E[S]=E[M]=E[L]=E[R]=E[$]=E[D]=E[T]=!0,E[f]=E[g]=E[y]=E[u]=E[k]=E[o]=E[h]=E[d]=E[c]=E[l]=E[s]=E[r]=E[a]=E[p]=E[v]=!1;function C(b){return m(b)&&n(b.length)&&!!E[t(b)]}i.exports=C})),Pa=j(((e,i)=>{function t(n){return function(m){return n(m)}}i.exports=t})),Ha=j(((e,i)=>{var t=Xr(),n=typeof e=="object"&&e&&!e.nodeType&&e,m=n&&typeof i=="object"&&i&&!i.nodeType&&i,f=m&&m.exports===n&&t.process,g=(function(){try{var u=m&&m.require&&m.require("util").types;return u||f&&f.binding&&f.binding("util")}catch{}})();i.exports=g})),$n=j(((e,i)=>{var t=za(),n=Pa(),m=Ha(),f=m&&m.isTypedArray,g=f?n(f):t;i.exports=g})),lo=j(((e,i)=>{function t(n,m){if(!(m==="constructor"&&typeof n[m]=="function")&&m!="__proto__")return n[m]}i.exports=t})),co=j(((e,i)=>{var t=kn(),n=Vt(),m=Object.prototype.hasOwnProperty;function f(g,u,o){var h=g[u];(!(m.call(g,u)&&n(h,o))||o===void 0&&!(u in g))&&t(g,u,o)}i.exports=f})),Wa=j(((e,i)=>{var t=co(),n=kn();function m(f,g,u,o){var h=!u;u||(u={});for(var d=-1,c=g.length;++d<c;){var l=g[d],s=o?o(u[l],f[l],l,u,f):void 0;s===void 0&&(s=f[l]),h?n(u,l,s):t(u,l,s)}return u}i.exports=m})),Ba=j(((e,i)=>{function t(n,m){for(var f=-1,g=Array(n);++f<n;)g[f]=m(f);return g}i.exports=t})),Ln=j(((e,i)=>{var t=9007199254740991,n=/^(?:0|[1-9]\d*)$/;function m(f,g){var u=typeof f;return g=g??t,!!g&&(u=="number"||u!="symbol"&&n.test(f))&&f>-1&&f%1==0&&f<g}i.exports=m})),uo=j(((e,i)=>{var t=Ba(),n=so(),m=ht(),f=Mn(),g=Ln(),u=$n(),o=Object.prototype.hasOwnProperty;function h(d,c){var l=m(d),s=!l&&n(d),r=!l&&!s&&f(d),a=!l&&!s&&!r&&u(d),p=l||s||r||a,v=p?t(d.length,String):[],y=v.length;for(var k in d)(c||o.call(d,k))&&!(p&&(k=="length"||r&&(k=="offset"||k=="parent")||a&&(k=="buffer"||k=="byteLength"||k=="byteOffset")||g(k,y)))&&v.push(k);return v}i.exports=h})),ja=j(((e,i)=>{function t(n){var m=[];if(n!=null)for(var f in Object(n))m.push(f);return m}i.exports=t})),Va=j(((e,i)=>{var t=et(),n=Tn(),m=ja(),f=Object.prototype.hasOwnProperty;function g(u){if(!t(u))return m(u);var o=n(u),h=[];for(var d in u)d=="constructor"&&(o||!f.call(u,d))||h.push(d);return h}i.exports=g})),ho=j(((e,i)=>{var t=uo(),n=Va(),m=$i();function f(g){return m(g)?t(g,!0):n(g)}i.exports=f})),Ua=j(((e,i)=>{var t=Wa(),n=ho();function m(f){return t(f,n(f))}i.exports=m})),Ga=j(((e,i)=>{var t=io(),n=Ma(),m=La(),f=Ra(),g=Oa(),u=so(),o=ht(),h=Da(),d=Mn(),c=xn(),l=et(),s=Fa(),r=$n(),a=lo(),p=Ua();function v(y,k,x,w,S,M,L){var R=a(y,x),$=a(k,x),D=L.get($);if(D){t(y,x,D);return}var T=M?M(R,$,x+"",y,k,L):void 0,E=T===void 0;if(E){var C=o($),b=!C&&d($),A=!C&&!b&&r($);T=$,C||b||A?o(R)?T=R:h(R)?T=f(R):b?(E=!1,T=n($,!0)):A?(E=!1,T=m($,!0)):T=[]:s($)||u($)?(T=R,u(R)?T=p(R):(!l(R)||c(R))&&(T=g($))):E=!1}E&&(L.set($,T),S(T,$,w,M,L),L.delete($)),t(y,x,T)}i.exports=v})),Ka=j(((e,i)=>{var t=eo(),n=io(),m=Ta(),f=Ga(),g=et(),u=ho(),o=lo();function h(d,c,l,s,r){d!==c&&m(c,function(a,p){if(r||(r=new t),g(a))f(d,c,p,l,h,s,r);else{var v=s?s(o(d,p),a,p+"",d,c,r):void 0;v===void 0&&(v=a),n(d,p,v)}},u)}i.exports=h})),po=j(((e,i)=>{function t(n){return n}i.exports=t})),qa=j(((e,i)=>{function t(n,m,f){switch(f.length){case 0:return n.call(m);case 1:return n.call(m,f[0]);case 2:return n.call(m,f[0],f[1]);case 3:return n.call(m,f[0],f[1],f[2])}return n.apply(m,f)}i.exports=t})),Ya=j(((e,i)=>{var t=qa(),n=Math.max;function m(f,g,u){return g=n(g===void 0?f.length-1:g,0),function(){for(var o=arguments,h=-1,d=n(o.length-g,0),c=Array(d);++h<d;)c[h]=o[g+h];h=-1;for(var l=Array(g+1);++h<g;)l[h]=o[h];return l[g]=u(c),t(f,this,l)}}i.exports=m})),Za=j(((e,i)=>{function t(n){return function(){return n}}i.exports=t})),Qa=j(((e,i)=>{var t=Za(),n=to(),m=po(),f=n?function(g,u){return n(g,"toString",{configurable:!0,enumerable:!1,value:t(u),writable:!0})}:m;i.exports=f})),Xa=j(((e,i)=>{var t=800,n=16,m=Date.now;function f(g){var u=0,o=0;return function(){var h=m(),d=n-(h-o);if(o=h,d>0){if(++u>=t)return arguments[0]}else u=0;return g.apply(void 0,arguments)}}i.exports=f})),Ja=j(((e,i)=>{var t=Qa(),n=Xa()(t);i.exports=n})),el=j(((e,i)=>{var t=po(),n=Ya(),m=Ja();function f(g,u){return m(n(g,u,t),g+"")}i.exports=f})),tl=j(((e,i)=>{var t=Vt(),n=$i(),m=Ln(),f=et();function g(u,o,h){if(!f(h))return!1;var d=typeof o;return(d=="number"?n(h)&&m(o,h.length):d=="string"&&o in h)?t(h[o],u):!1}i.exports=g})),il=j(((e,i)=>{var t=el(),n=tl();function m(f){return t(function(g,u){var o=-1,h=u.length,d=h>1?u[h-1]:void 0,c=h>2?u[2]:void 0;for(d=f.length>3&&typeof d=="function"?(h--,d):void 0,c&&n(u[0],u[1],c)&&(d=h<3?void 0:d,h=1),g=Object(g);++o<h;){var l=u[o];l&&f(g,l,o,d)}return g})}i.exports=m})),nl=j(((e,i)=>{var t=Ka(),n=il()(function(m,f,g,u){t(m,f,g,u)});i.exports=n})),rl=Et(nl(),1),ol=()=>crypto.randomUUID().slice(0,8),sl=()=>ol().slice(0,8),ur=(e="",i)=>{if(!i)return console.warn("utils.match missing argument 2."),!1;const t=/[|\\{}()[\]^*$+?.]/g;let n=typeof i=="string"?[i]:i;n=n.map(f=>f==="*"?"":f.replace(t,"\\$&"));let m=!0;return n.length&&(m=!new RegExp(n.join("|"),"i").exec(e)),m},al=(e,i)=>{const t=e.indexOf(i);t!==-1&&e.splice(t,1)},be=e=>{const i=e.className?.match(wl);return i&&yl[i[0]]},st=e=>Array.from(new Set(e)),Te=e=>e?.attrs?.id||e?.id||sl(),De=(e,i)=>{const t=(n,m)=>{if(Array.isArray(n))return m!=null?st(n.concat(m)):m;if(Array.isArray(m))return n!=null?st(m.concat(n)):m};return(0,rl.default)({},e,i,t)},He=e=>{let i;const t=e instanceof Promise;if(e===null||typeof e!="object"||t)return e;if(e instanceof Date)return i=new Date,i.setTime(e.getTime()),i;if(Array.isArray(e)){i=[];for(let n=0,m=e.length;n<m;n++)i[n]=He(e[n]);return i}if(e instanceof Object){i={};for(const n in e)Object.hasOwn(e,n)&&(i[n]=He(e[n]));return i}throw new Error("Unable to copy Object, type not supported.")},zi=(e,i)=>e/i*100,un=e=>`${e.toString()}%`,Rn=Object.create(null,{get:{value:e=>{const i=window.sessionStorage?.getItem(e);try{return JSON.parse(i)}catch{return i}}},set:{value:(e,i)=>{try{return window.sessionStorage?.setItem(e,JSON.stringify(i))}catch(t){console.error(t)}}}}),Ie=e=>/^(stage|row|column|field)s./.test(e),ll=e=>gl.test(e);function fo(e,i=zn){let t=0;return function(...n){const m=Date.now();m-t>=i&&(t=m,e.apply(this,n))}}function fi(e,i=at){let t;return function(...n){t&&clearTimeout(t),t=setTimeout(()=>e.apply(this,n),i)}}function dn(e){return e}function hn(){}function Li(e=Object.create(null)){if(typeof e=="string")try{return JSON.parse(e)}catch(i){return console.error("Invalid JSON string provided:",i),Object.create(null)}return e}var rt=e=>e?He(Li(e)):wt();function go(e,i,t,n={}){if(!i||!e[t][i])return n;const m=`${t}.${i}`;n[m]=e[t][i];const f=xl.get(t);if(f){const g=e[t][i].data?.children||[];for(const u of g)go(e,u,f,n)}return n}var cl='<?xml version="1.0" encoding="utf-8"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><symbol id="f-i-autocomplete" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M6,5h1v1H6V5z M4,4H3v1h1V4z M6,4H5v1h1V4z M2,5v1h1V5H2z M3,7h1V6H3V7z M5,7h1V6H5V7z M4,5v1h1V5H4z M2,14h1v-1H2V14z M4,14h1v-1H4V14z M6,14h1v-1H6V14z M9,13H8v1h1V13z M16,3.5v4C16,8.3,15.3,9,14.5,9H14v3v3c0,0.6-0.4,1-1,1H1c-0.6,0-1-0.4-1-1V3.5 C0,2.7,0.7,2,1.5,2h3H8V1.5V1H7H6V0.5V0h2.5H11v0.5V1h-1H9v0.5V2h3h2.5C15.3,2,16,2.7,16,3.5z M13,12H7H1v3h12V12z M3,11v-1H2v1H3z M5,11v-1H4v1H5z M15,3.5C15,3.2,14.8,3,14.5,3H9v2.5V8H8.5H8V7.5V7H7V6h1V5.5V5H7V4h1V3.5V3H1.5C1.2,3,1,3.2,1,3.5v4 C1,7.8,1.2,8,1.5,8H8v1H6v0.5V10h2.5H11V9.5V9H9V8h5.5C14.8,8,15,7.8,15,7.5V3.5z"/></symbol><symbol viewBox="0 0 32 32" id="f-i-bin" xmlns="http://www.w3.org/2000/svg"><path d="M4 10v20c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2v-20h-22zM10 28h-2v-14h2v14zM14 28h-2v-14h2v14zM18 28h-2v-14h2v14zM22 28h-2v-14h2v14zM26.5 4h-6.5v-2.5c0-.825-.675-1.5-1.5-1.5h-7c-.825 0-1.5.675-1.5 1.5v2.5h-6.5c-.825 0-1.5.675-1.5 1.5v2.5h26v-2.5c0-.825-.675-1.5-1.5-1.5zM18 4h-6v-1.975h6v1.975z"/></symbol><symbol id="f-i-button" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><metadata id="acprefix__metadata8"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><path id="acprefix__rect4140" d="M 0.4765625,4 A 0.47706934,0.47706934 0 0 0 0,4.4765625 L 0,11.523438 A 0.47706934,0.47706934 0 0 0 0.4765625,12 L 15.523438,12 A 0.47706934,0.47706934 0 0 0 16,11.523438 L 16,4.4765625 A 0.47706934,0.47706934 0 0 0 15.523438,4 L 0.4765625,4 Z m 0.4765625,0.953125 14.09375,0 0,6.09375 -14.09375,0 0,-6.09375 z"/><g id="acprefix__layer1"><g id="acprefix__text4203"><g id="acprefix__g4212" transform="translate(0.10112835,0.1001358)"><path id="acprefix__path4208" d="m 6.0690374,6.4093857 q -0.5371093,0 -0.8544922,0.4003906 -0.3149414,0.4003906 -0.3149414,1.0913086 0,0.6884766 0.3149414,1.0888672 0.3173829,0.4003906 0.8544922,0.4003906 0.5371094,0 0.8496094,-0.4003906 0.3149414,-0.4003906 0.3149414,-1.0888672 0,-0.690918 -0.3149414,-1.0913086 -0.3125,-0.4003906 -0.8496094,-0.4003906 z m 0,-0.4003906 q 0.7666016,0 1.225586,0.5151367 0.4589843,0.5126953 0.4589843,1.3769531 0,0.8618164 -0.4589843,1.3769531 -0.4589844,0.5126953 -1.225586,0.5126953 -0.7690429,0 -1.2304687,-0.5126953 -0.4589844,-0.5126953 -0.4589844,-1.3769531 0,-0.8642578 0.4589844,-1.3769531 0.4614258,-0.5151367 1.2304687,-0.5151367 z"/><path id="acprefix__path4210" d="m 8.5250921,6.074913 0.4931641,0 0,1.5405274 1.6357418,-1.5405274 0.634766,0 -1.809082,1.6992188 1.938477,1.9458008 -0.649415,0 -1.7504878,-1.7553711 0,1.7553711 -0.4931641,0 0,-3.6450196 z"/></g></g></g></symbol><symbol viewBox="0 0 32 32" id="f-i-calendar" xmlns="http://www.w3.org/2000/svg"><path d="M12.048 16.961c-0.178 0.257-0.395 0.901-0.652 1.059-0.257 0.157-0.547 0.267-0.869 0.328-0.323 0.062-0.657 0.089-1.002 0.079v1.527h2.467v6.046h1.991v-9.996h-1.584c-0.056 0.381-0.173 0.7-0.351 0.957zM23 8h2c0.553 0 1-0.448 1-1v-6c0-0.552-0.447-1-1-1h-2c-0.553 0-1 0.448-1 1v6c0 0.552 0.447 1 1 1zM7 8h2c0.552 0 1-0.448 1-1v-6c0-0.552-0.448-1-1-1h-2c-0.552 0-1 0.448-1 1v6c0 0.552 0.448 1 1 1zM30 4h-2v5c0 0.552-0.447 1-1 1h-6c-0.553 0-1-0.448-1-1v-5h-8v5c0 0.552-0.448 1-1 1h-6c-0.552 0-1-0.448-1-1v-5h-2c-1.104 0-2 0.896-2 2v24c0 1.104 0.896 2 2 2h28c1.104 0 2-0.896 2-2v-24c0-1.104-0.896-2-2-2zM30 29c0 0.553-0.447 1-1 1h-26c-0.552 0-1-0.447-1-1v-16c0-0.552 0.448-1 1-1h26c0.553 0 1 0.448 1 1v16zM15.985 17.982h4.968c-0.936 1.152-1.689 2.325-2.265 3.705-0.575 1.381-0.638 2.818-0.749 4.312h2.131c0.009-0.666-0.195-1.385-0.051-2.156 0.146-0.771 0.352-1.532 0.617-2.285 0.267-0.752 0.598-1.461 0.996-2.127 0.396-0.667 0.853-1.229 1.367-1.686v-1.742h-7.015v1.979z"/></symbol><symbol id="f-i-checkbox" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M13.5,5v8c0,0.8-0.7,1.5-1.5,1.5H3c-0.8,0-1.5-0.7-1.5-1.5V4c0-0.8,0.7-1.5,1.5-1.5h9c0.7,0,1.3,0.5,1.5,1.2l2.4-1.4L13.5,5 z M12.5,6.2L7.7,12L2.8,5.5l4.9,1.6l4.8-2.9V4c0-0.3-0.2-0.5-0.5-0.5H3C2.7,3.5,2.5,3.7,2.5,4v9c0,0.3,0.2,0.5,0.5,0.5h9 c0.3,0,0.5-0.2,0.5-0.5V6.2z"/></symbol><symbol id="f-i-checkbox-group" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M0,1h16V0H0V1z M0,3h16V2H0V3z M6,5v1h9V5H6z M15,14v-1H6v1H15z M6,10h9V9H6V10z M4,12l-2.5,1.5L0,13l1.5,2L4,12z M4,8 L1.5,9.5L0,9l1.5,2L4,8z M4,4L1.5,5.5L0,5l1.5,2L4,4z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-columns" xmlns="http://www.w3.org/2000/svg"><metadata id="agprefix__metadata4318"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><path id="agprefix__rect4860-3-5" d="M 16,0.5 A 0.50004997,0.50004997 0 0 0 15.5,0 l -5,0 -5,0 -5,0 A 0.50004997,0.50004997 0 0 0 0,0.5 l 0,15 A 0.50004997,0.50004997 0 0 0 0.5,16 l 5,0 5,0 5,0 A 0.50004997,0.50004997 0 0 0 16,15.5 l 0,-15 z M 15,1 15,15 11,15 11,1 15,1 Z M 10,1 10,15 6,15 6,1 10,1 Z M 5,1 5,15 1,15 1,1 5,1 Z"/></symbol><symbol viewBox="0 0 32 32" id="f-i-copy" xmlns="http://www.w3.org/2000/svg"><path d="M20 8v-8h-14l-6 6v18h12v8h20v-24h-12zM6 2.828v3.172h-3.172l3.172-3.172zM2 22v-14h6v-6h10v6l-6 6v8h-10zM18 10.828v3.172h-3.172l3.172-3.172zM30 30h-16v-14h6v-6h10v20z"/></symbol><symbol id="f-i-divider" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg"><metadata id="aiprefix__metadata10"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><rect y="7" x="0" height="1" width="15" id="aiprefix__rect4182"/></symbol><symbol viewBox="0 0 28 32" id="f-i-edit" xmlns="http://www.w3.org/2000/svg"><path d="M22 2l-4 4 6 6 4-4-6-6zM0 24l0.021 6.018 5.979-0.018 16-16-6-6-16 16zM6 28h-4v-4h2v2h2v2z"/></symbol><symbol viewBox="0 0 24 24" id="f-i-email" xmlns="http://www.w3.org/2000/svg"><path d="M12,2 C17.4292399,2 21.8479317,6.32667079 21.9961582,11.7200952 L22,12 L22,13 C22,15.1729208 20.477434,17 18.5,17 C17.3269391,17 16.3139529,16.3570244 15.6839382,15.3803024 C14.770593,16.3757823 13.4581934,17 12,17 C9.23857625,17 7,14.7614237 7,12 C7,9.23857625 9.23857625,7 12,7 C14.6887547,7 16.8818181,9.12230671 16.9953805,11.7831104 L17,12 L17,13 C17,14.1407877 17.7160103,15 18.5,15 C19.2447902,15 19.928229,14.2245609 19.9947109,13.1689341 L20,13 L20,12 C20,7.581722 16.418278,4 12,4 C7.581722,4 4,7.581722 4,12 C4,16.418278 7.581722,20 12,20 C13.1630948,20 14.2892822,19.7522618 15.3225159,19.2798331 C15.8247876,19.0501777 16.4181317,19.271177 16.647787,19.7734487 C16.8774423,20.2757205 16.656443,20.8690646 16.1541713,21.0987199 C14.861218,21.689901 13.4515463,22 12,22 C6.4771525,22 2,17.5228475 2,12 C2,6.4771525 6.4771525,2 12,2 Z M12,9 C10.3431458,9 9,10.3431458 9,12 C9,13.6568542 10.3431458,15 12,15 C13.6568542,15 15,13.6568542 15,12 C15,10.3431458 13.6568542,9 12,9 Z"/></symbol><symbol viewBox="0 0 32 32" id="f-i-floppy-disk" xmlns="http://www.w3.org/2000/svg"><path d="M28 0h-28v32h32v-28l-4-4zM16 4h4v8h-4v-8zM28 28h-24v-24h2v10h18v-10h2.343l1.657 1.657v22.343z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle" xmlns="http://www.w3.org/2000/svg"><metadata id="aqprefix__metadata8"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><g transform="translate(0,-2)" id="aqprefix__g4220"><rect id="aqprefix__rect4191" width="2" height="2" x="2" y="7"/><rect id="aqprefix__rect4191-2" width="2" height="2" x="7" y="7"/><rect id="aqprefix__rect4191-4" width="2" height="2" x="12" y="7"/></g><g transform="translate(0,2)" id="aqprefix__g4220-6"><rect id="aqprefix__rect4191-40" width="2" height="2" x="2" y="7"/><rect id="aqprefix__rect4191-2-3" width="2" height="2" x="7" y="7"/><rect id="aqprefix__rect4191-4-9" width="2" height="2" x="12" y="7"/></g></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-column" xmlns="http://www.w3.org/2000/svg"><path d="M2 7h2v2H2zM7 7h2v2H7zM12 7h2v2h-2zM2 12h2v2H2zM7 12h2v2H7zM12 12h2v2h-2z" transform="rotate(90 9.25 9.25)"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-field" xmlns="http://www.w3.org/2000/svg"><path d="M9.5-6.5h2v2h-2zm-5 0h2v2h-2zm5-5h2v2h-2zm-5 0h2v2h-2z" transform="rotate(90)"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-row" xmlns="http://www.w3.org/2000/svg"><path d="M12 9.5h2v2h-2zm-5 0h2v2H7Zm-5 0h2v2H2Zm10-5h2v2h-2zm-5 0h2v2H7Zm-5 0h2v2H2Z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-stage" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5h2v2H2zM7 4.5h2v2H7zM12 4.5h2v2h-2zM2 9.5h2v2H2zM7 9.5h2v2H7zM12 9.5h2v2h-2zM2-.5h2v2H2zM7-.5h2v2H7zM12-.5h2v2h-2z" transform="translate(0 2.5)"/></symbol><symbol viewBox="0 0 448 512" id="f-i-hash" xmlns="http://www.w3.org/2000/svg"><g id="arprefix__icomoon-ignore"/><path d="M448 192v-64h-80.064l16-128h-64l-16 128h-127.968l16-128h-64l-16 128h-111.968v64h103.968l-15.968 128h-88v64h80l-16 128h64l16-128h127.968l-16 128h64.032l16-128h112v-64h-104l15.936-128h88.064zM279.968 320h-127.968l15.968-128h127.968l-15.968 128z"/></symbol><symbol viewBox="0 0 28 28" id="f-i-header" xmlns="http://www.w3.org/2000/svg"><path d="M26.281 26q-0.688 0-2.070-0.055t-2.086-0.055q-0.688 0-2.063 0.055t-2.063 0.055q-0.375 0-0.578-0.32t-0.203-0.711q0-0.484 0.266-0.719t0.609-0.266 0.797-0.109 0.703-0.234q0.516-0.328 0.516-2.188l-0.016-6.109q0-0.328-0.016-0.484-0.203-0.063-0.781-0.063h-10.547q-0.594 0-0.797 0.063-0.016 0.156-0.016 0.484l-0.016 5.797q0 2.219 0.578 2.562 0.25 0.156 0.75 0.203t0.891 0.055 0.703 0.234 0.313 0.711q0 0.406-0.195 0.75t-0.57 0.344q-0.734 0-2.18-0.055t-2.164-0.055q-0.672 0-2 0.055t-1.984 0.055q-0.359 0-0.555-0.328t-0.195-0.703q0-0.469 0.242-0.703t0.562-0.273 0.742-0.117 0.656-0.234q0.516-0.359 0.516-2.234l-0.016-0.891v-12.703q0-0.047 0.008-0.406t0-0.57-0.023-0.602-0.055-0.656-0.102-0.57-0.172-0.492-0.25-0.281q-0.234-0.156-0.703-0.187t-0.828-0.031-0.641-0.219-0.281-0.703q0-0.406 0.187-0.75t0.562-0.344q0.719 0 2.164 0.055t2.164 0.055q0.656 0 1.977-0.055t1.977-0.055q0.391 0 0.586 0.344t0.195 0.75q0 0.469-0.266 0.68t-0.602 0.227-0.773 0.063-0.672 0.203q-0.547 0.328-0.547 2.5l0.016 5q0 0.328 0.016 0.5 0.203 0.047 0.609 0.047h10.922q0.391 0 0.594-0.047 0.016-0.172 0.016-0.5l0.016-5q0-2.172-0.547-2.5-0.281-0.172-0.914-0.195t-1.031-0.203-0.398-0.773q0-0.406 0.195-0.75t0.586-0.344q0.688 0 2.063 0.055t2.063 0.055q0.672 0 2.016-0.055t2.016-0.055q0.391 0 0.586 0.344t0.195 0.75q0 0.469-0.273 0.688t-0.625 0.227-0.805 0.047-0.688 0.195q-0.547 0.359-0.547 2.516l0.016 14.734q0 1.859 0.531 2.188 0.25 0.156 0.719 0.211t0.836 0.070 0.648 0.242 0.281 0.695q0 0.406-0.187 0.75t-0.562 0.344z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-hidden" xmlns="http://www.w3.org/2000/svg"><path d="M0 12h1v-1H0Zm15-7h1V4h-1zm-1 7h1v-1h-1zm-2 0h1v-1h-1zm-2 0h1v-1h-1Zm-2 0h1v-1H8Zm-2 0h1v-1H6Zm-2 0h1v-1H4Zm-2 0h1v-1H2Zm13-1h1v-1h-1ZM0 10h1V9H0Zm15-1h1V8h-1ZM0 8h1V7H0Zm15-1h1V6h-1ZM0 6h1V5H0Zm13-1h1V4h-1zm-2 0h1V4h-1ZM9 5h1V4H9ZM7 5h1V4H7ZM5 5h1V4H5ZM3 5h1V4H3ZM1 5h1V4H1Z"/></symbol><symbol xml:space="preserve" viewBox="0 0 32 32" id="f-i-info-circle" xmlns="http://www.w3.org/2000/svg"><path d="m17.962 24.725 1.806.096v2.531h-7.534v-2.406l1.045-.094c.568-.063.916-.254.916-1.014v-8.801c0-.699-.188-.92-.791-.92l-1.106-.062v-2.626h5.666zM15.747 4.648c1.394 0 2.405 1.047 2.405 2.374 0 1.331-1.014 2.313-2.438 2.313-1.454 0-2.404-.982-2.404-2.313 0-1.327.95-2.374 2.437-2.374M16 32C7.178 32 0 24.822 0 16S7.178 0 16 0c8.82 0 16 7.178 16 16s-7.18 16-16 16m0-29C8.832 3 3 8.832 3 16s5.832 13 13 13 13-5.832 13-13S23.168 3 16 3"/></symbol><symbol viewBox="0 0 384 512" id="f-i-menu" xmlns="http://www.w3.org/2000/svg"><g id="avprefix__icomoon-ignore"/><path d="M0 96v64h384v-64h-384zM0 288h384v-64h-384v64zM0 416h384v-64h-384v64z"/></symbol><symbol viewBox="0 0 24 24" fill="none" id="f-i-minus" xmlns="http://www.w3.org/2000/svg"><path d="M6 12L18 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></symbol><symbol viewBox="0 0 512 512" id="f-i-move" xmlns="http://www.w3.org/2000/svg"><path d="M287.744 94.736v129.008h128v-64l96.256 96.256-96.256 96.24v-65.488h-128v129.008h64.496l-96.24 96.24-96.256-96.24h64v-129.008h-128v64.992l-95.744-95.744 95.744-95.744v63.488h128v-129.008h-62.496l94.752-94.736 94.752 94.736h-63.008z"/></symbol><symbol viewBox="0 0 512 512" id="f-i-move-vertical" xmlns="http://www.w3.org/2000/svg"><metadata id="axprefix__metadata10"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><sodipodi:namedview pagecolor="#ffffff" bordercolor="#666666" borderopacity="1" objecttolerance="10" gridtolerance="10" guidetolerance="10" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" inkscape:pageopacity="0" inkscape:pageshadow="2" inkscape:window-width="3440" inkscape:window-height="1416" id="axprefix__namedview6" showgrid="false" inkscape:zoom="1.84375" inkscape:cx="421.4312" inkscape:cy="218.56484" inkscape:window-x="0" inkscape:window-y="24" inkscape:window-maximized="1" inkscape:current-layer="svg2" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd"/><path d="m 287.744,94.736 0,321.024 64.496,0 L 256,512 l -96.256,-96.24 64,0 0,-321.024 -62.496,0 L 256,0 350.752,94.736 Z" id="axprefix__path4" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" inkscape:connector-curvature="0" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" sodipodi:nodetypes="ccccccccccc"/></symbol><symbol viewBox="0 0 20 28" id="f-i-paragraph" xmlns="http://www.w3.org/2000/svg"><path d="M19.969 2.953v1.141q0 0.453-0.289 0.953t-0.664 0.5q-0.781 0-0.844 0.016-0.406 0.094-0.5 0.484-0.047 0.172-0.047 1v18q0 0.391-0.281 0.672t-0.672 0.281h-1.687q-0.391 0-0.672-0.281t-0.281-0.672v-19.031h-2.234v19.031q0 0.391-0.273 0.672t-0.68 0.281h-1.687q-0.406 0-0.68-0.281t-0.273-0.672v-7.75q-2.297-0.187-3.828-0.922-1.969-0.906-3-2.797-1-1.828-1-4.047 0-2.594 1.375-4.469 1.375-1.844 3.266-2.484 1.734-0.578 6.516-0.578h7.484q0.391 0 0.672 0.281t0.281 0.672z"/></symbol><symbol id="f-i-phone-receiver" viewBox="0 0 578.106 578.106" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><g><g><path d="M577.83,456.128c1.225,9.385-1.635,17.545-8.568,24.48l-81.396,80.781 c-3.672,4.08-8.465,7.551-14.381,10.404c-5.916,2.857-11.729,4.693-17.439,5.508c-0.408,0-1.635,0.105-3.676,0.309 c-2.037,0.203-4.689,0.307-7.953,0.307c-7.754,0-20.301-1.326-37.641-3.979s-38.555-9.182-63.645-19.584 c-25.096-10.404-53.553-26.012-85.376-46.818c-31.823-20.805-65.688-49.367-101.592-85.68 c-28.56-28.152-52.224-55.08-70.992-80.783c-18.768-25.705-33.864-49.471-45.288-71.299 c-11.425-21.828-19.993-41.616-25.705-59.364S4.59,177.362,2.55,164.51s-2.856-22.95-2.448-30.294 c0.408-7.344,0.612-11.424,0.612-12.24c0.816-5.712,2.652-11.526,5.508-17.442s6.324-10.71,10.404-14.382L98.022,8.756 c5.712-5.712,12.24-8.568,19.584-8.568c5.304,0,9.996,1.53,14.076,4.59s7.548,6.834,10.404,11.322l65.484,124.236 c3.672,6.528,4.692,13.668,3.06,21.42c-1.632,7.752-5.1,14.28-10.404,19.584l-29.988,29.988c-0.816,0.816-1.53,2.142-2.142,3.978 s-0.918,3.366-0.918,4.59c1.632,8.568,5.304,18.36,11.016,29.376c4.896,9.792,12.444,21.726,22.644,35.802 s24.684,30.293,43.452,48.653c18.36,18.77,34.68,33.354,48.96,43.76c14.277,10.4,26.215,18.053,35.803,22.949 c9.588,4.896,16.932,7.854,22.031,8.871l7.648,1.531c0.816,0,2.145-0.307,3.979-0.918c1.836-0.613,3.162-1.326,3.979-2.143 l34.883-35.496c7.348-6.527,15.912-9.791,25.705-9.791c6.938,0,12.443,1.223,16.523,3.672h0.611l118.115,69.768 C571.098,441.238,576.197,447.968,577.83,456.128z"/></g></g><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/></symbol><symbol viewBox="0 0 24 24" fill="none" id="f-i-plus" xmlns="http://www.w3.org/2000/svg"><path d="M6 12H18M12 6V18" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></symbol><symbol id="f-i-radio-group" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M0,1h16V0H0V1z M0,3h16V2H0V3z M5,6h10V5H5V6z M15,9H5v1h10V9z M15,14v-1H5v1H15z M1.5,7C0.7,7,0,6.3,0,5.5S0.7,4,1.5,4 S3,4.7,3,5.5S2.3,7,1.5,7z M1.5,5C1.2,5,1,5.2,1,5.5S1.2,6,1.5,6S2,5.8,2,5.5S1.8,5,1.5,5z M1.5,11.1C0.7,11.1,0,10.4,0,9.6 s0.7-1.5,1.5-1.5S3,8.7,3,9.6S2.3,11.1,1.5,11.1z M1.5,9.1C1.2,9.1,1,9.3,1,9.6s0.2,0.5,0.5,0.5S2,9.8,2,9.6S1.8,9.1,1.5,9.1z M1.5,15C0.7,15,0,14.3,0,13.5S0.7,12,1.5,12S3,12.7,3,13.5S2.3,15,1.5,15z M1.5,13C1.2,13,1,13.2,1,13.5S1.2,14,1.5,14 S2,13.8,2,13.5S1.8,13,1.5,13z"/></symbol><symbol viewBox="0 0 512 512" id="f-i-remove" xmlns="http://www.w3.org/2000/svg"><path d="M193.694-139.2h87.322v510.916h-87.322zM-18.103 159.92V72.597h510.915v87.322z" transform="rotate(45 77.994 208.636)"/></symbol><symbol id="f-i-rich-text" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M15,1H1C0.4,1,0,1.4,0,2v12c0,0.6,0.4,1,1,1h14c0.6,0,1-0.4,1-1V2C16,1.4,15.6,1,15,1z M1,3.1h0.8v0.3H1V3.1z M1,3.6h0.8 v0.3H1V3.6z M15,14H1V5.1h14V14z M15,4.9H1V4.6h14V4.9z M15,4.4H1V4.1h0.8v0.2h1.5V4.1h1.3v0.2H6V4.1h1.3v0.2h1.5V4.1H10v0.2h1.5 V4.1h1.3v0.2h1.5V4.1H15V4.4z M4.5,3.6v0.3H3.3V3.6H4.5z M3.3,3.4V3.1h1.3v0.3H3.3z M7.3,3.6v0.3H6V3.6H7.3z M6,3.4V3.1h1.3v0.3H6z M10,3.6v0.3H8.8V3.6H10z M8.8,3.4V3.1H10v0.3H8.8z M12.8,3.6v0.3h-1.3V3.6H12.8z M11.5,3.4V3.1h1.3v0.3H11.5z M15,3.9h-0.8V3.6H15 V3.9z M15,3.4h-0.8V3.1H15V3.4z M15,2.9h-0.8V2.8h-1.5v0.2h-1.3V2.8H10v0.2H8.8V2.8H7.3v0.2H6V2.8H4.5v0.2H3.3V2.8H1.8v0.2H1V2.6h14 V2.9z M15,2.4H1V2.1h14V2.4z M3,12v-1h10v1H3z M13,10H3V9h10V10z M11,8H3V7h8V8z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-rows" xmlns="http://www.w3.org/2000/svg"><metadata id="bfprefix__metadata4318"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><g transform="matrix(0,1,-1,0,3.0984025,11.835155)" id="bfprefix__g7209"><path id="bfprefix__rect4860-3-5" d="m 4.1640625,-12.402344 a 0.50004997,0.50004997 0 0 0 -0.5,-0.5 l -5,0 -5,0 -5.0000005,0 a 0.50004997,0.50004997 0 0 0 -0.5,0.5 l 0,15.0000002 a 0.50004997,0.50004997 0 0 0 0.5,0.5 l 4.9648442,0 a 0.50004997,0.50004997 0 0 0 0.035156,0 l 4.9648437,0 a 0.50004997,0.50004997 0 0 0 0.035156,0 l 5,0 a 0.50004997,0.50004997 0 0 0 0.5,-0.5 l 0,-15.0000002 z m -1,0.5 0,14.0000002 -4,0 0,-14.0000002 4,0 z m -5,0 0,14.0000002 -4,0 0,-14.0000002 4,0 z m -5,0 0,14.0000002 -4.0000005,0 0,-14.0000002 4.0000005,0 z"/></g></symbol><symbol id="f-i-select" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path id="bgprefix__XMLID_1_" d="M0,0v14h0c0,0.6,0.4,1,1,1h10c0.6,0,1-0.4,1-1h0V5h4V0H0z M1,1h10v3H1V1z M1,7h10v3H1V7z M1,14v-3h10v3H1z M15,4h-3V1h3V4z M2,2h1v1H2V2z M2,12h1v1H2V12z M4,12h1v1H4V12z M6,12h1v1H6V12z M9,12v1H8v-1H9z M2,8h1v1H2V8z M4,8h1v1H4V8z M6,8 h1v1H6V8z M13.5,3.1l-1-1.1h1.9L13.5,3.1z M2,6V5h1v1H2L2,6z M4,6V5h1v1H4L4,6z"/></symbol><symbol viewBox="0 0 448 512" id="f-i-settings" xmlns="http://www.w3.org/2000/svg"><g id="bhprefix__icomoon-ignore"/><path d="M223.969 175c-44.703 0-80.969 36.266-80.969 81 0 44.688 36.266 81.031 80.969 81.031 44.719 0 80.719-36.344 80.719-81.031-0-44.734-36-81-80.719-81zM386.313 302.531l-14.594 35.156 29.469 57.875-36.094 36.094-59.218-27.969-35.156 14.438-17.844 54.625-2.281 7.25h-51.016l-22.078-61.656-35.156-14.5-57.952 29.344-36.078-36.063 27.938-59.25-14.484-35.125-61.767-20.156v-50.984l61.703-22.109 14.485-35.094-25.953-51.234-3.422-6.719 36.031-36.031 59.297 27.922 35.109-14.516 17.828-54.594 2.297-7.234h51l22.094 61.734 35.063 14.516 58.031-29.406 36.063 36.031-27.938 59.203 14.438 35.172 61.875 20.125v50.969l-61.688 22.187z"/></symbol><symbol id="f-i-text-input" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path id="biprefix__XMLID_10_" d="M15,4H4.5V3H6V2H4.5h-1H2v1h1.5v1H1C0.4,4,0,4.5,0,5v6c0,0.6,0.4,1,1,1h2.5v1H2v1h4v-1H4.5v-1H15 c0.6,0,1-0.4,1-1V5C16,4.5,15.6,4,15,4z M1,11V5h2.5v6H1z M15,11H4.5V5H15V11z"/></symbol><symbol id="f-i-textarea" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path id="bjprefix__XMLID_1_" d="M3,11v-1h8v1H3L3,11z M3,7h10V6H3V7L3,7z M3,8v1h10V8H3L3,8z M13,4H3v1h10V4L13,4z M16,14V2c0-0.6-0.4-1-1-1 H1C0.4,1,0,1.4,0,2v12c0,0.6,0.4,1,1,1h14C15.6,15,16,14.6,16,14z M15,2v12H1V2H15z"/></symbol><symbol viewBox="0 0 24 32" id="f-i-triangle-down" xmlns="http://www.w3.org/2000/svg"><path d="M0 12l11.992 11.992 11.992-11.992h-23.984z"/></symbol><symbol viewBox="0 0 12 32" id="f-i-triangle-left" xmlns="http://www.w3.org/2000/svg"><path d="M0 15.996l11.992 11.992v-23.984l-11.992 11.992z"/></symbol><symbol viewBox="0 0 12 32" id="f-i-triangle-right" xmlns="http://www.w3.org/2000/svg"><path d="M0.002 4.008l11.992 11.992-11.992 11.992v-23.984z"/></symbol><symbol viewBox="0 0 24 32" id="f-i-triangle-up" xmlns="http://www.w3.org/2000/svg"><path d="M11.992 8l-11.992 11.992h23.984l-11.992-11.992z"/></symbol><symbol viewBox="0 0 512 512" id="f-i-upload" xmlns="http://www.w3.org/2000/svg"><g id="boprefix__icomoon-ignore"/><path d="M240 352h-240v128h480v-128h-240zM448 416h-64v-32h64v32zM112 160l128-128 128 128h-80v160h-96v-160z"/></symbol></svg>',_n=Qr.name,On=Qr.version,Ri=_n,ul="formeo-sprite",dl=`https://cdn.jsdelivr.net/npm/formeo@${On}/dist/${ul}.svg`,hl=`https://cdn.jsdelivr.net/npm/formeo@${On}/dist/formeo.min.css`,pl="https://draggable.github.io/formeo/assets/css/formeo.min.css",mo="f-panel",ot="control-group",kt=`${Ri}-stage`,Ue=`${Ri}-row`,Ge=`${Ri}-column`,Tt=`${Ri}-field`,pn="custom-column-widths",vo="column-preset",Pi="resizing-columns",fl=new Map([[kt,Ue],[Ue,Ge],[Ge,Tt]]),In=["stage","row","column","field"],Dn=In.map(e=>`${e}s`),ep=new Map(Dn.map((e,i)=>[e,In[i]])),gl=new RegExp(`^${Dn.join("|")}.`),yo=[...In],bo=[...Dn],ml=new Map(bo.map((e,i)=>[e,yo[i]])),tp=new RegExp(`^${bo.join("|")}.`),Hi=yo.reduce((e,i)=>(e[i]=i,e),{}),vl=[{name:"controls",className:ot},{name:"stage",className:kt},{name:"row",className:Ue},{name:"column",className:Ge},{name:"field",className:Tt}],Nn={controls:ot,stage:kt,row:Ue,column:Ge,field:Tt},yl=Object.entries(Nn).reduce((e,[i,t])=>(e[t]=i,e),{}),bl=Object.values(Nn),wl=new RegExp(`${bl.join("|")}`,"g"),{childTypeMapVals:wo,childTypeIndexMapVals:Cl}=vl.reduce((e,{name:i},t,n)=>{const{name:m}=n[t+1]||{};return m&&(e.childTypeMapVals.push([i,m]),e.childTypeIndexMapVals.push([`${i}s`,`${m}s`])),e},{childTypeMapVals:[],childTypeIndexMapVals:[]}),Sl=wo.slice().map(e=>e.slice().reverse()).reverse(),dr=new Map(wo),xl=new Map(Cl),El=new Map(Sl.slice()),Al=[[{value:"100.0",label:"100%"}],[{value:"50.0,50.0",label:"50 | 50"},{value:"33.3,66.6",label:"33 | 66"},{value:"66.6,33.3",label:"66 | 33"}],[{value:"33.3,33.3,33.3",label:"33 | 33 | 33"},{value:"25.0,25.0,50.0",label:"25 | 25 | 50"},{value:"50.0,25.0,25.0",label:"50 | 25 | 25"},{value:"25.0,50.0,25.0",label:"25 | 50 | 25"}],[{value:"25.0,25.0,25.0,25.0",label:"25 | 25 | 25 | 25"}],[{value:"20.0,20.0,20.0,20.0,20.0",label:"20 | 20 | 20 | 20 | 20"}],[{value:"16.66,16.66,16.66,16.66,16.66,16.66",label:"16.66 | 16.66 | 16.66 | 16.66 | 16.66 | 16.66"}]],kl=new Map(Al.reduce((e,i,t)=>(e.push([t,i]),e),[])),Fn=`${_n}-formData`,hr=`${_n}-locale`;var at=Math.round(333/2),zn=Math.round(333*2),ip=Math.round(333/5),Co="formeoSaved",Pn="formeoUpdated",Tl="formeoChanged",So="formeoUpdatedStage",xo="formeoUpdatedRow",Eo="formeoUpdatedColumn",Ao="formeoUpdatedField",Ml="formeoCleared",ko="formeoOnRender",$l="formeoConditionUpdated",Hn="formeoAddedRow",Wn="formeoAddedColumn",Bn="formeoAddedField",jn="formeoRemovedRow",Vn="formeoRemovedColumn",Un="formeoRemovedField",To={equals:"==",notEquals:"!=",contains:"⊃",notContains:"!⊃"},Ll={and:"&&",or:"||"},Mo={equals:"="},Rl=["logical","source","sourceProperty","comparison","target","targetProperty","assignment","value"],pr=["isChecked","isNotChecked"],fr=["isVisible","isNotVisible"],ni=["value"],_l={comparison:To,assignment:Mo,logical:Ll};var Ol="then",Gn=()=>({if:[{source:"",sourceProperty:"",comparison:"",target:"",targetProperty:""}],[Ol]:[{target:"",targetProperty:"",assignment:"",value:""}]}),Il=/(\b[0-9a-f]{8}\b-[0-9a-f]{4}-[0-9a-f]{4}-[0-9a-f]{4}-\b[0-9a-f]{12}\b)|(\b[0-9a-f]{8}\b)/g,fn=/\bcol-\w+-\d+/g,$o="f-i-",wt=()=>({id:Te(),stages:{[Te()]:{}},rows:{},columns:{},fields:{}}),gi=["selected","checked"],Dl=gi.toReversed(),Nl=new Map([["config",new Set(["label","helpText","hideLabel","labelAfter","disableHtmlLabel","tooltip"])]]),Fl="a an and as at but by for for from in into near nor of on onto or the to with".split(" ").map(e=>String.raw`\s${e}\s`),zl=new RegExp(String.raw`(?!${Fl.join("|")})\w\S*`,"g"),Pl=/\s+/g;function je(e){return typeof e!="string"||e.trim().match(Pl)?e:e.replace(zl,i=>i.charAt(0).toUpperCase()+i.substring(1).replace(/[A-Z]/g,t=>` ${t}`))}var Lo=(e,i="-")=>e.toString().normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim().replace(/[^a-z0-9 -]/g,"").replace(/\s+/g,i),lt=e=>{if(Array.isArray(e))return e;const i=/[.[\]]/g,t=[];let n=0,m=i.exec(e);for(;m!==null;)t.push(e.slice(n,m.index)),n=m.index+m[0].length,m=i.exec(e);return n<e.length&&t.push(e.slice(n)),t.filter(Boolean)},gr=(e,i="-")=>lt(e).join(i),Hl=e=>{const i=document.createElement("div");return i.innerHTML=e,i.textContent||i.innerText||""},Wl=(e,i,t="…")=>{if(e.length<=i)return e;const n=e.slice(0,i),m=n.lastIndexOf(" ");let f=`${m>0?n.slice(0,m):n}`;return t&&(f+=t),f},Bl=/^attrs\.|^meta\.|^options\.|^config\./g;function mi(e){return e.replaceAll(Bl,"")}var Kn=j(((e,i)=>{var t=At(),n=dt(),m="[object Symbol]";function f(g){return typeof g=="symbol"||n(g)&&t(g)==m}i.exports=f})),jl=j(((e,i)=>{var t=ht(),n=Kn(),m=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,f=/^\w*$/;function g(u,o){if(t(u))return!1;var h=typeof u;return h=="number"||h=="symbol"||h=="boolean"||u==null||n(u)?!0:f.test(u)||!m.test(u)||o!=null&&u in Object(o)}i.exports=g})),Vl=j(((e,i)=>{var t=An(),n="Expected a function";function m(f,g){if(typeof f!="function"||g!=null&&typeof g!="function")throw new TypeError(n);var u=function(){var o=arguments,h=g?g.apply(this,o):o[0],d=u.cache;if(d.has(h))return d.get(h);var c=f.apply(this,o);return u.cache=d.set(h,c)||d,c};return u.cache=new(m.Cache||t),u}m.Cache=t,i.exports=m})),Ul=j(((e,i)=>{var t=Vl(),n=500;function m(f){var g=t(f,function(o){return u.size===n&&u.clear(),o}),u=g.cache;return g}i.exports=m})),Gl=j(((e,i)=>{var t=Ul(),n=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,m=/\\(\\)?/g,f=t(function(g){var u=[];return g.charCodeAt(0)===46&&u.push(""),g.replace(n,function(o,h,d,c){u.push(d?c.replace(m,"$1"):h||o)}),u});i.exports=f})),Kl=j(((e,i)=>{function t(n,m){for(var f=-1,g=n==null?0:n.length,u=Array(g);++f<g;)u[f]=m(n[f],f,n);return u}i.exports=t})),ql=j(((e,i)=>{var t=ki(),n=Kl(),m=ht(),f=Kn(),g=1/0,u=t?t.prototype:void 0,o=u?u.toString:void 0;function h(d){if(typeof d=="string")return d;if(m(d))return n(d,h)+"";if(f(d))return o?o.call(d):"";var c=d+"";return c=="0"&&1/d==-g?"-0":c}i.exports=h})),_i=j(((e,i)=>{var t=ql();function n(m){return m==null?"":t(m)}i.exports=n})),Ro=j(((e,i)=>{var t=ht(),n=jl(),m=Gl(),f=_i();function g(u,o){return t(u)?u:n(u,o)?[u]:m(f(u))}i.exports=g})),_o=j(((e,i)=>{var t=Kn(),n=1/0;function m(f){if(typeof f=="string"||t(f))return f;var g=f+"";return g=="0"&&1/f==-n?"-0":g}i.exports=m})),Yl=j(((e,i)=>{var t=Ro(),n=_o();function m(f,g){g=t(g,f);for(var u=0,o=g.length;f!=null&&u<o;)f=f[n(g[u++])];return u&&u==o?f:void 0}i.exports=m})),Zl=j(((e,i)=>{var t=Yl();function n(m,f,g){var u=m==null?void 0:t(m,f);return u===void 0?g:u}i.exports=n})),Ql=j(((e,i)=>{var t=co(),n=Ro(),m=Ln(),f=et(),g=_o();function u(o,h,d,c){if(!f(o))return o;h=n(h,o);for(var l=-1,s=h.length,r=s-1,a=o;a!=null&&++l<s;){var p=g(h[l]),v=d;if(p==="__proto__"||p==="constructor"||p==="prototype")return o;if(l!=r){var y=a[p];v=c?c(y,p,a):void 0,v===void 0&&(v=f(y)?y:m(h[l+1])?[]:{})}t(a,p,v),a=a[p]}return o}i.exports=u})),Xl=j(((e,i)=>{var t=Ql();function n(m,f,g){return m==null?m:t(m,f,g)}i.exports=n})),Jl=Et(Zl(),1),ec=Et(Xl(),1),we=Jl.default,Oi=ec.default;function tc(e,i={}){const t={...e};for(const n in i)Object.hasOwn(i,n)&&(Object.hasOwn(t,n)?Array.isArray(t[n])?t[n].push(i[n]):t[n]=[t[n],i[n]]:t[n]=i[n]);return t}function ri(...e){return e.flat().reduce((i,t)=>(i[t]=t,i),{})}var ic=j(((e,i)=>{var t="__lodash_hash_undefined__";function n(m){return this.__data__.set(m,t),this}i.exports=n})),nc=j(((e,i)=>{function t(n){return this.__data__.has(n)}i.exports=t})),rc=j(((e,i)=>{var t=An(),n=ic(),m=nc();function f(g){var u=-1,o=g==null?0:g.length;for(this.__data__=new t;++u<o;)this.add(g[u])}f.prototype.add=f.prototype.push=n,f.prototype.has=m,i.exports=f})),oc=j(((e,i)=>{function t(n,m){for(var f=-1,g=n==null?0:n.length;++f<g;)if(m(n[f],f,n))return!0;return!1}i.exports=t})),sc=j(((e,i)=>{function t(n,m){return n.has(m)}i.exports=t})),Oo=j(((e,i)=>{var t=rc(),n=oc(),m=sc(),f=1,g=2;function u(o,h,d,c,l,s){var r=d&f,a=o.length,p=h.length;if(a!=p&&!(r&&p>a))return!1;var v=s.get(o),y=s.get(h);if(v&&y)return v==h&&y==o;var k=-1,x=!0,w=d&g?new t:void 0;for(s.set(o,h),s.set(h,o);++k<a;){var S=o[k],M=h[k];if(c)var L=r?c(M,S,k,h,o,s):c(S,M,k,o,h,s);if(L!==void 0){if(L)continue;x=!1;break}if(w){if(!n(h,function(R,$){if(!m(w,$)&&(S===R||l(S,R,d,c,s)))return w.push($)})){x=!1;break}}else if(!(S===M||l(S,M,d,c,s))){x=!1;break}}return s.delete(o),s.delete(h),x}i.exports=u})),ac=j(((e,i)=>{function t(n){var m=-1,f=Array(n.size);return n.forEach(function(g,u){f[++m]=[u,g]}),f}i.exports=t})),lc=j(((e,i)=>{function t(n){var m=-1,f=Array(n.size);return n.forEach(function(g){f[++m]=g}),f}i.exports=t})),cc=j(((e,i)=>{var t=ki(),n=no(),m=Vt(),f=Oo(),g=ac(),u=lc(),o=1,h=2,d="[object Boolean]",c="[object Date]",l="[object Error]",s="[object Map]",r="[object Number]",a="[object RegExp]",p="[object Set]",v="[object String]",y="[object Symbol]",k="[object ArrayBuffer]",x="[object DataView]",w=t?t.prototype:void 0,S=w?w.valueOf:void 0;function M(L,R,$,D,T,E,C){switch($){case x:if(L.byteLength!=R.byteLength||L.byteOffset!=R.byteOffset)return!1;L=L.buffer,R=R.buffer;case k:return!(L.byteLength!=R.byteLength||!E(new n(L),new n(R)));case d:case c:case r:return m(+L,+R);case l:return L.name==R.name&&L.message==R.message;case a:case v:return L==R+"";case s:var b=g;case p:var A=D&o;if(b||(b=u),L.size!=R.size&&!A)return!1;var _=C.get(L);if(_)return _==R;D|=h,C.set(L,R);var O=f(b(L),b(R),D,T,E,C);return C.delete(L),O;case y:if(S)return S.call(L)==S.call(R)}return!1}i.exports=M})),uc=j(((e,i)=>{function t(n,m){for(var f=-1,g=m.length,u=n.length;++f<g;)n[u+f]=m[f];return n}i.exports=t})),dc=j(((e,i)=>{var t=uc(),n=ht();function m(f,g,u){var o=g(f);return n(f)?o:t(o,u(f))}i.exports=m})),hc=j(((e,i)=>{function t(n,m){for(var f=-1,g=n==null?0:n.length,u=0,o=[];++f<g;){var h=n[f];m(h,f,n)&&(o[u++]=h)}return o}i.exports=t})),pc=j(((e,i)=>{function t(){return[]}i.exports=t})),fc=j(((e,i)=>{var t=hc(),n=pc(),m=Object.prototype.propertyIsEnumerable,f=Object.getOwnPropertySymbols,g=f?function(u){return u==null?[]:(u=Object(u),t(f(u),function(o){return m.call(u,o)}))}:n;i.exports=g})),gc=j(((e,i)=>{var t=ro()(Object.keys,Object);i.exports=t})),mc=j(((e,i)=>{var t=Tn(),n=gc(),m=Object.prototype.hasOwnProperty;function f(g){if(!t(g))return n(g);var u=[];for(var o in Object(g))m.call(g,o)&&o!="constructor"&&u.push(o);return u}i.exports=f})),vc=j(((e,i)=>{var t=uo(),n=mc(),m=$i();function f(g){return m(g)?t(g):n(g)}i.exports=f})),yc=j(((e,i)=>{var t=dc(),n=fc(),m=vc();function f(g){return t(g,m,n)}i.exports=f})),bc=j(((e,i)=>{var t=yc(),n=1,m=Object.prototype.hasOwnProperty;function f(g,u,o,h,d,c){var l=o&n,s=t(g),r=s.length;if(r!=t(u).length&&!l)return!1;for(var a=r;a--;){var p=s[a];if(!(l?p in u:m.call(u,p)))return!1}var v=c.get(g),y=c.get(u);if(v&&y)return v==u&&y==g;var k=!0;c.set(g,u),c.set(u,g);for(var x=l;++a<r;){p=s[a];var w=g[p],S=u[p];if(h)var M=l?h(S,w,p,u,g,c):h(w,S,p,g,u,c);if(!(M===void 0?w===S||d(w,S,o,h,c):M)){k=!1;break}x||(x=p=="constructor")}if(k&&!x){var L=g.constructor,R=u.constructor;L!=R&&"constructor"in g&&"constructor"in u&&!(typeof L=="function"&&L instanceof L&&typeof R=="function"&&R instanceof R)&&(k=!1)}return c.delete(g),c.delete(u),k}i.exports=f})),wc=j(((e,i)=>{var t=ut()(Be(),"DataView");i.exports=t})),Cc=j(((e,i)=>{var t=ut()(Be(),"Promise");i.exports=t})),Sc=j(((e,i)=>{var t=ut()(Be(),"Set");i.exports=t})),xc=j(((e,i)=>{var t=ut()(Be(),"WeakMap");i.exports=t})),Ec=j(((e,i)=>{var t=wc(),n=En(),m=Cc(),f=Sc(),g=xc(),u=At(),o=Jr(),h="[object Map]",d="[object Object]",c="[object Promise]",l="[object Set]",s="[object WeakMap]",r="[object DataView]",a=o(t),p=o(n),v=o(m),y=o(f),k=o(g),x=u;(t&&x(new t(new ArrayBuffer(1)))!=r||n&&x(new n)!=h||m&&x(m.resolve())!=c||f&&x(new f)!=l||g&&x(new g)!=s)&&(x=function(w){var S=u(w),M=S==d?w.constructor:void 0,L=M?o(M):"";if(L)switch(L){case a:return r;case p:return h;case v:return c;case y:return l;case k:return s}return S}),i.exports=x})),Ac=j(((e,i)=>{var t=eo(),n=Oo(),m=cc(),f=bc(),g=Ec(),u=ht(),o=Mn(),h=$n(),d=1,c="[object Arguments]",l="[object Array]",s="[object Object]",r=Object.prototype.hasOwnProperty;function a(p,v,y,k,x,w){var S=u(p),M=u(v),L=S?l:g(p),R=M?l:g(v);L=L==c?s:L,R=R==c?s:R;var $=L==s,D=R==s,T=L==R;if(T&&o(p)){if(!o(v))return!1;S=!0,$=!1}if(T&&!$)return w||(w=new t),S||h(p)?n(p,v,y,k,x,w):m(p,v,L,y,k,x,w);if(!(y&d)){var E=$&&r.call(p,"__wrapped__"),C=D&&r.call(v,"__wrapped__");if(E||C){var b=E?p.value():p,A=C?v.value():v;return w||(w=new t),x(b,A,y,k,w)}}return T?(w||(w=new t),f(p,v,y,k,x,w)):!1}i.exports=a})),kc=j(((e,i)=>{var t=Ac(),n=dt();function m(f,g,u,o,h){return f===g?!0:f==null||g==null||!n(f)&&!n(g)?f!==f&&g!==g:t(f,g,u,o,m,h)}i.exports=m})),Tc=j(((e,i)=>{var t=kc();function n(m,f){return t(m,f)}i.exports=n})),gn=Et(Tc(),1),Mc=(e,i)=>e===void 0?"added":i===void 0?"removed":(0,gn.default)(e,i)?"unchanged":"changed",qn=class{constructor(e,i=Object.create(null)){this.name=e,this.data=i,this.dataPath=""}get size(){return Object.keys(this.data).length}get js(){return this.data}get json(){return this.data}toJSON=(e,i)=>JSON.stringify(e,null,i);get=e=>we(this.data,e);set(e,i){const t=we(this.data,e),n=Oi(this.data,e,i),m=Array.isArray(e)?e.join("."):e,f=Object.keys(this.setCallbacks).filter(u=>new RegExp(u).test(m)),g={newVal:i,oldVal:t,path:e};for(const u of f)for(const o of this.setCallbacks[u])o(g);if(!this.disableEvents){const u={entity:this,dataPath:this.dataPath.replace(/\.+$/,""),changePath:this.dataPath+e,value:i,data:n,changeType:Mc(t,i),src:this.dom};if(t&&(u.previousValue=t),Q.formeoUpdated(u),this.name){const o={stage:So,row:xo,column:Eo,field:Ao}[this.name];o&&Q.formeoUpdated(u,o)}}return n}addSetCallback(e,i){this.setCallbacks[e]?this.setCallbacks[e].push(i):this.setCallbacks[e]=[i]}removeSetCallback(e,i){this.setCallbacks[e]=this.setCallbacks[e].filter(t=>t!==i)}add=(e,i=Object.create(null))=>{const{id:t}=i,n=e||t||Te();return this.set(n,i)};remove=e=>{const i=lt(e),t=i.pop(),n=this.get(i);return Array.isArray(n)?n.splice(Number(t),1):n&&delete n[t],n};empty(){this.data=Object.create(null)}getData=()=>Object.entries(this.data).reduce((e,[i,t])=>(e[i]=t?.data?t.getData():t,e),{});setCallbacks={};configVal=Object.create(null)},Ii=class extends qn{load=e=>{const i=Li(e);this.empty();for(const[t,n]of Object.entries(i))this.add(t,n);return this.data};get=e=>e?we(this.data,e):this.add();add=(e,i=Object.create(null))=>{const t=e||Te(),n=this.Component({...i,id:t});this.data[t]=n,this.active=n;const m={row:Hn,column:Wn,field:Bn}[this.name];return m&&Q.formeoUpdated({entity:n,componentId:t,componentType:this.name,data:n.data},m),n};remove=e=>{if(Array.isArray(e))for(const i of e)this.get(i).remove();else this.get(e).remove();return this.data};delete=e=>(delete this.data[e],e);clearAll=(e=!0)=>{const i=Object.values(this.data).map(t=>t.empty(e));return Promise.all(i)};set config(e){this.configVal=De(this.configVal,He(e))}get config(){return this.configVal}conditionMap=new Map};function $c(e,i,t){return(i=Oc(i))in e?Object.defineProperty(e,i,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[i]=t,e}function Ke(){return Ke=Object.assign?Object.assign.bind():function(e){for(var i=1;i<arguments.length;i++){var t=arguments[i];for(var n in t)({}).hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e},Ke.apply(null,arguments)}function mr(e,i){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);i&&(n=n.filter(function(m){return Object.getOwnPropertyDescriptor(e,m).enumerable})),t.push.apply(t,n)}return t}function We(e){for(var i=1;i<arguments.length;i++){var t=arguments[i]!=null?arguments[i]:{};i%2?mr(Object(t),!0).forEach(function(n){$c(e,n,t[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):mr(Object(t)).forEach(function(n){Object.defineProperty(e,n,Object.getOwnPropertyDescriptor(t,n))})}return e}function Lc(e,i){if(e==null)return{};var t,n,m=Rc(e,i);if(Object.getOwnPropertySymbols){var f=Object.getOwnPropertySymbols(e);for(n=0;n<f.length;n++)t=f[n],i.indexOf(t)===-1&&{}.propertyIsEnumerable.call(e,t)&&(m[t]=e[t])}return m}function Rc(e,i){if(e==null)return{};var t={};for(var n in e)if({}.hasOwnProperty.call(e,n)){if(i.indexOf(n)!==-1)continue;t[n]=e[n]}return t}function _c(e,i){if(typeof e!="object"||!e)return e;var t=e[Symbol.toPrimitive];if(t!==void 0){var n=t.call(e,i||"default");if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(i==="string"?String:Number)(e)}function Oc(e){var i=_c(e,"string");return typeof i=="symbol"?i:i+""}function mn(e){"@babel/helpers - typeof";return mn=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(i){return typeof i}:function(i){return i&&typeof Symbol=="function"&&i.constructor===Symbol&&i!==Symbol.prototype?"symbol":typeof i},mn(e)}var Ic="1.15.7";function Ve(e){if(typeof window<"u"&&window.navigator)return!!navigator.userAgent.match(e)}var Ye=Ve(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),Ut=Ve(/Edge/i),vr=Ve(/firefox/i),Dt=Ve(/safari/i)&&!Ve(/chrome/i)&&!Ve(/android/i),Yn=Ve(/iP(ad|od|hone)/i),Io=Ve(/chrome/i)&&Ve(/android/i),Do={capture:!1,passive:!1};function re(e,i,t){e.addEventListener(i,t,!Ye&&Do)}function ne(e,i,t){e.removeEventListener(i,t,!Ye&&Do)}function vi(e,i){if(i){if(i[0]===">"&&(i=i.substring(1)),e)try{if(e.matches)return e.matches(i);if(e.msMatchesSelector)return e.msMatchesSelector(i);if(e.webkitMatchesSelector)return e.webkitMatchesSelector(i)}catch{return!1}return!1}}function No(e){return e.host&&e!==document&&e.host.nodeType&&e.host!==e?e.host:e.parentNode}function Oe(e,i,t,n){if(e){t=t||document;do{if(i!=null&&(i[0]===">"?e.parentNode===t&&vi(e,i):vi(e,i))||n&&e===t)return e;if(e===t)break}while(e=No(e))}return null}var yr=/\s+/g;function xe(e,i,t){e&&i&&(e.classList?e.classList[t?"add":"remove"](i):e.className=((" "+e.className+" ").replace(yr," ").replace(" "+i+" "," ")+(t?" "+i:"")).replace(yr," "))}function ee(e,i,t){var n=e&&e.style;if(n){if(t===void 0)return document.defaultView&&document.defaultView.getComputedStyle?t=document.defaultView.getComputedStyle(e,""):e.currentStyle&&(t=e.currentStyle),i===void 0?t:t[i];!(i in n)&&i.indexOf("webkit")===-1&&(i="-webkit-"+i),n[i]=t+(typeof t=="string"?"":"px")}}function Ct(e,i){var t="";if(typeof e=="string")t=e;else do{var n=ee(e,"transform");n&&n!=="none"&&(t=n+" "+t)}while(!i&&(e=e.parentNode));var m=window.DOMMatrix||window.WebKitCSSMatrix||window.CSSMatrix||window.MSCSSMatrix;return m&&new m(t)}function Fo(e,i,t){if(e){var n=e.getElementsByTagName(i),m=0,f=n.length;if(t)for(;m<f;m++)t(n[m],m);return n}return[]}function Pe(){var e=document.scrollingElement;return e||document.documentElement}function de(e,i,t,n,m){if(!(!e.getBoundingClientRect&&e!==window)){var f,g,u,o,h,d,c;if(e!==window&&e.parentNode&&e!==Pe()?(f=e.getBoundingClientRect(),g=f.top,u=f.left,o=f.bottom,h=f.right,d=f.height,c=f.width):(g=0,u=0,o=window.innerHeight,h=window.innerWidth,d=window.innerHeight,c=window.innerWidth),(i||t)&&e!==window&&(m=m||e.parentNode,!Ye))do if(m&&m.getBoundingClientRect&&(ee(m,"transform")!=="none"||t&&ee(m,"position")!=="static")){var l=m.getBoundingClientRect();g-=l.top+parseInt(ee(m,"border-top-width")),u-=l.left+parseInt(ee(m,"border-left-width")),o=g+f.height,h=u+f.width;break}while(m=m.parentNode);if(n&&e!==window){var s=Ct(m||e),r=s&&s.a,a=s&&s.d;s&&(g/=a,u/=r,c/=r,d/=a,o=g+d,h=u+c)}return{top:g,left:u,bottom:o,right:h,width:c,height:d}}}function br(e,i,t){for(var n=Xe(e,!0),m=de(e)[i];n;){var f=de(n)[t],g=void 0;if(t==="top"||t==="left"?g=m>=f:g=m<=f,!g)return n;if(n===Pe())break;n=Xe(n,!1)}return!1}function St(e,i,t,n){for(var m=0,f=0,g=e.children;f<g.length;){if(g[f].style.display!=="none"&&g[f]!==J.ghost&&(n||g[f]!==J.dragged)&&Oe(g[f],t.draggable,e,!1)){if(m===i)return g[f];m++}f++}return null}function Zn(e,i){for(var t=e.lastElementChild;t&&(t===J.ghost||ee(t,"display")==="none"||i&&!vi(t,i));)t=t.previousElementSibling;return t||null}function ke(e,i){var t=0;if(!e||!e.parentNode)return-1;for(;e=e.previousElementSibling;)e.nodeName.toUpperCase()!=="TEMPLATE"&&e!==J.clone&&(!i||vi(e,i))&&t++;return t}function wr(e){var i=0,t=0,n=Pe();if(e)do{var m=Ct(e),f=m.a,g=m.d;i+=e.scrollLeft*f,t+=e.scrollTop*g}while(e!==n&&(e=e.parentNode));return[i,t]}function Dc(e,i){for(var t in e)if(e.hasOwnProperty(t)){for(var n in i)if(i.hasOwnProperty(n)&&i[n]===e[t][n])return Number(t)}return-1}function Xe(e,i){if(!e||!e.getBoundingClientRect)return Pe();var t=e,n=!1;do if(t.clientWidth<t.scrollWidth||t.clientHeight<t.scrollHeight){var m=ee(t);if(t.clientWidth<t.scrollWidth&&(m.overflowX=="auto"||m.overflowX=="scroll")||t.clientHeight<t.scrollHeight&&(m.overflowY=="auto"||m.overflowY=="scroll")){if(!t.getBoundingClientRect||t===document.body)return Pe();if(n||i)return t;n=!0}}while(t=t.parentNode);return Pe()}function Nc(e,i){if(e&&i)for(var t in i)i.hasOwnProperty(t)&&(e[t]=i[t]);return e}function Wi(e,i){return Math.round(e.top)===Math.round(i.top)&&Math.round(e.left)===Math.round(i.left)&&Math.round(e.height)===Math.round(i.height)&&Math.round(e.width)===Math.round(i.width)}var Nt;function zo(e,i){return function(){if(!Nt){var t=arguments,n=this;t.length===1?e.call(n,t[0]):e.apply(n,t),Nt=setTimeout(function(){Nt=void 0},i)}}}function Fc(){clearTimeout(Nt),Nt=void 0}function Po(e,i,t){e.scrollLeft+=i,e.scrollTop+=t}function Ho(e){var i=window.Polymer,t=window.jQuery||window.Zepto;return i&&i.dom?i.dom(e).cloneNode(!0):t?t(e).clone(!0)[0]:e.cloneNode(!0)}function Wo(e,i,t){var n={};return Array.from(e.children).forEach(function(m){var f,g,u,o;if(!(!Oe(m,i.draggable,e,!1)||m.animated||m===t)){var h=de(m);n.left=Math.min((f=n.left)!==null&&f!==void 0?f:1/0,h.left),n.top=Math.min((g=n.top)!==null&&g!==void 0?g:1/0,h.top),n.right=Math.max((u=n.right)!==null&&u!==void 0?u:-1/0,h.right),n.bottom=Math.max((o=n.bottom)!==null&&o!==void 0?o:-1/0,h.bottom)}}),n.width=n.right-n.left,n.height=n.bottom-n.top,n.x=n.left,n.y=n.top,n}var Ce="Sortable"+new Date().getTime();function zc(){var e=[],i;return{captureAnimationState:function(){e=[],this.options.animation&&[].slice.call(this.el.children).forEach(function(n){if(!(ee(n,"display")==="none"||n===J.ghost)){e.push({target:n,rect:de(n)});var m=We({},e[e.length-1].rect);if(n.thisAnimationDuration){var f=Ct(n,!0);f&&(m.top-=f.f,m.left-=f.e)}n.fromRect=m}})},addAnimationState:function(n){e.push(n)},removeAnimationState:function(n){e.splice(Dc(e,{target:n}),1)},animateAll:function(n){var m=this;if(!this.options.animation){clearTimeout(i),typeof n=="function"&&n();return}var f=!1,g=0;e.forEach(function(u){var o=0,h=u.target,d=h.fromRect,c=de(h),l=h.prevFromRect,s=h.prevToRect,r=u.rect,a=Ct(h,!0);a&&(c.top-=a.f,c.left-=a.e),h.toRect=c,h.thisAnimationDuration&&Wi(l,c)&&!Wi(d,c)&&(r.top-c.top)/(r.left-c.left)===(d.top-c.top)/(d.left-c.left)&&(o=Hc(r,l,s,m.options)),Wi(c,d)||(h.prevFromRect=d,h.prevToRect=c,o||(o=m.options.animation),m.animate(h,r,c,o)),o&&(f=!0,g=Math.max(g,o),clearTimeout(h.animationResetTimer),h.animationResetTimer=setTimeout(function(){h.animationTime=0,h.prevFromRect=null,h.fromRect=null,h.prevToRect=null,h.thisAnimationDuration=null},o),h.thisAnimationDuration=o)}),clearTimeout(i),f?i=setTimeout(function(){typeof n=="function"&&n()},g):typeof n=="function"&&n(),e=[]},animate:function(n,m,f,g){if(g){ee(n,"transition",""),ee(n,"transform","");var u=Ct(this.el),o=u&&u.a,h=u&&u.d,d=(m.left-f.left)/(o||1),c=(m.top-f.top)/(h||1);n.animatingX=!!d,n.animatingY=!!c,ee(n,"transform","translate3d("+d+"px,"+c+"px,0)"),this.forRepaintDummy=Pc(n),ee(n,"transition","transform "+g+"ms"+(this.options.easing?" "+this.options.easing:"")),ee(n,"transform","translate3d(0,0,0)"),typeof n.animated=="number"&&clearTimeout(n.animated),n.animated=setTimeout(function(){ee(n,"transition",""),ee(n,"transform",""),n.animated=!1,n.animatingX=!1,n.animatingY=!1},g)}}}}function Pc(e){return e.offsetWidth}function Hc(e,i,t,n){return Math.sqrt(Math.pow(i.top-e.top,2)+Math.pow(i.left-e.left,2))/Math.sqrt(Math.pow(i.top-t.top,2)+Math.pow(i.left-t.left,2))*n.animation}var pt=[],Bi={initializeByDefault:!0},Gt={mount:function(i){for(var t in Bi)Bi.hasOwnProperty(t)&&!(t in i)&&(i[t]=Bi[t]);pt.forEach(function(n){if(n.pluginName===i.pluginName)throw"Sortable: Cannot mount plugin ".concat(i.pluginName," more than once")}),pt.push(i)},pluginEvent:function(i,t,n){var m=this;this.eventCanceled=!1,n.cancel=function(){m.eventCanceled=!0};var f=i+"Global";pt.forEach(function(g){t[g.pluginName]&&(t[g.pluginName][f]&&t[g.pluginName][f](We({sortable:t},n)),t.options[g.pluginName]&&t[g.pluginName][i]&&t[g.pluginName][i](We({sortable:t},n)))})},initializePlugins:function(i,t,n,m){pt.forEach(function(u){var o=u.pluginName;if(!(!i.options[o]&&!u.initializeByDefault)){var h=new u(i,t,i.options);h.sortable=i,h.options=i.options,i[o]=h,Ke(n,h.defaults)}});for(var f in i.options)if(i.options.hasOwnProperty(f)){var g=this.modifyOption(i,f,i.options[f]);typeof g<"u"&&(i.options[f]=g)}},getEventProperties:function(i,t){var n={};return pt.forEach(function(m){typeof m.eventProperties=="function"&&Ke(n,m.eventProperties.call(t[m.pluginName],i))}),n},modifyOption:function(i,t,n){var m;return pt.forEach(function(f){i[f.pluginName]&&f.optionListeners&&typeof f.optionListeners[t]=="function"&&(m=f.optionListeners[t].call(i[f.pluginName],n))}),m}};function Wc(e){var i=e.sortable,t=e.rootEl,n=e.name,m=e.targetEl,f=e.cloneEl,g=e.toEl,u=e.fromEl,o=e.oldIndex,h=e.newIndex,d=e.oldDraggableIndex,c=e.newDraggableIndex,l=e.originalEvent,s=e.putSortable,r=e.extraEventProperties;if(i=i||t&&t[Ce],!!i){var a,p=i.options,v="on"+n.charAt(0).toUpperCase()+n.substr(1);window.CustomEvent&&!Ye&&!Ut?a=new CustomEvent(n,{bubbles:!0,cancelable:!0}):(a=document.createEvent("Event"),a.initEvent(n,!0,!0)),a.to=g||t,a.from=u||t,a.item=m||t,a.clone=f,a.oldIndex=o,a.newIndex=h,a.oldDraggableIndex=d,a.newDraggableIndex=c,a.originalEvent=l,a.pullMode=s?s.lastPutMode:void 0;var y=We(We({},r),Gt.getEventProperties(n,i));for(var k in y)a[k]=y[k];t&&t.dispatchEvent(a),p[v]&&p[v].call(i,a)}}var Bc=["evt"],ye=function(i,t){var n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},m=n.evt,f=Lc(n,Bc);Gt.pluginEvent.bind(J)(i,t,We({dragEl:K,parentEl:ce,ghostEl:ie,rootEl:se,nextEl:nt,lastDownEl:oi,cloneEl:ae,cloneHidden:Qe,dragStarted:_t,putSortable:pe,activeSortable:J.active,originalEvent:m,oldIndex:yt,oldDraggableIndex:Ft,newIndex:Ee,newDraggableIndex:Ze,hideGhostForTarget:Uo,unhideGhostForTarget:Go,cloneNowHidden:function(){Qe=!0},cloneNowShown:function(){Qe=!1},dispatchSortableEvent:function(u){ve({sortable:t,name:u,originalEvent:m})}},f))};function ve(e){Wc(We({putSortable:pe,cloneEl:ae,targetEl:K,rootEl:se,oldIndex:yt,oldDraggableIndex:Ft,newIndex:Ee,newDraggableIndex:Ze},e))}var K,ce,ie,se,nt,oi,ae,Qe,yt,Ee,Ft,Ze,Yt,pe,mt=!1,yi=!1,bi=[],tt,Re,ji,Vi,Cr,Sr,_t,ft,zt,Pt=!1,Zt=!1,si,fe,Ui=[],vn=!1,wi=[],Di=typeof document<"u",Qt=Yn,xr=Ut||Ye?"cssFloat":"float",jc=Di&&!Io&&!Yn&&"draggable"in document.createElement("div"),Bo=(function(){if(Di){if(Ye)return!1;var e=document.createElement("x");return e.style.cssText="pointer-events:auto",e.style.pointerEvents==="auto"}})(),jo=function(i,t){var n=ee(i),m=parseInt(n.width)-parseInt(n.paddingLeft)-parseInt(n.paddingRight)-parseInt(n.borderLeftWidth)-parseInt(n.borderRightWidth),f=St(i,0,t),g=St(i,1,t),u=f&&ee(f),o=g&&ee(g),h=u&&parseInt(u.marginLeft)+parseInt(u.marginRight)+de(f).width,d=o&&parseInt(o.marginLeft)+parseInt(o.marginRight)+de(g).width;if(n.display==="flex")return n.flexDirection==="column"||n.flexDirection==="column-reverse"?"vertical":"horizontal";if(n.display==="grid")return n.gridTemplateColumns.split(" ").length<=1?"vertical":"horizontal";if(f&&u.float&&u.float!=="none"){var c=u.float==="left"?"left":"right";return g&&(o.clear==="both"||o.clear===c)?"vertical":"horizontal"}return f&&(u.display==="block"||u.display==="flex"||u.display==="table"||u.display==="grid"||h>=m&&n[xr]==="none"||g&&n[xr]==="none"&&h+d>m)?"vertical":"horizontal"},Vc=function(i,t,n){var m=n?i.left:i.top,f=n?i.right:i.bottom,g=n?i.width:i.height,u=n?t.left:t.top,o=n?t.right:t.bottom,h=n?t.width:t.height;return m===u||f===o||m+g/2===u+h/2},Uc=function(i,t){var n;return bi.some(function(m){var f=m[Ce].options.emptyInsertThreshold;if(!(!f||Zn(m))){var g=de(m),u=i>=g.left-f&&i<=g.right+f,o=t>=g.top-f&&t<=g.bottom+f;if(u&&o)return n=m}}),n},Vo=function(i){function t(f,g){return function(u,o,h,d){var c=u.options.group.name&&o.options.group.name&&u.options.group.name===o.options.group.name;if(f==null&&(g||c))return!0;if(f==null||f===!1)return!1;if(g&&f==="clone")return f;if(typeof f=="function")return t(f(u,o,h,d),g)(u,o,h,d);var l=(g?u:o).options.group.name;return f===!0||typeof f=="string"&&f===l||f.join&&f.indexOf(l)>-1}}var n={},m=i.group;(!m||mn(m)!="object")&&(m={name:m}),n.name=m.name,n.checkPull=t(m.pull,!0),n.checkPut=t(m.put),n.revertClone=m.revertClone,i.group=n},Uo=function(){!Bo&&ie&&ee(ie,"display","none")},Go=function(){!Bo&&ie&&ee(ie,"display","")};Di&&!Io&&document.addEventListener("click",function(e){if(yi)return e.preventDefault(),e.stopPropagation&&e.stopPropagation(),e.stopImmediatePropagation&&e.stopImmediatePropagation(),yi=!1,!1},!0);var it=function(i){if(K){i=i.touches?i.touches[0]:i;var t=Uc(i.clientX,i.clientY);if(t){var n={};for(var m in i)i.hasOwnProperty(m)&&(n[m]=i[m]);n.target=n.rootEl=t,n.preventDefault=void 0,n.stopPropagation=void 0,t[Ce]._onDragOver(n)}}},Gc=function(i){K&&K.parentNode[Ce]._isOutsideThisEl(i.target)};function J(e,i){if(!(e&&e.nodeType&&e.nodeType===1))throw"Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(e));this.el=e,this.options=i=Ke({},i),e[Ce]=this;var t={group:null,sort:!0,disabled:!1,store:null,handle:null,draggable:/^[uo]l$/i.test(e.nodeName)?">li":">*",swapThreshold:1,invertSwap:!1,invertedSwapThreshold:null,removeCloneOnHide:!0,direction:function(){return jo(e,this.options)},ghostClass:"sortable-ghost",chosenClass:"sortable-chosen",dragClass:"sortable-drag",ignore:"a, img",filter:null,preventOnFilter:!0,animation:0,easing:null,setData:function(g,u){g.setData("Text",u.textContent)},dropBubble:!1,dragoverBubble:!1,dataIdAttr:"data-id",delay:0,delayOnTouchOnly:!1,touchStartThreshold:(Number.parseInt?Number:window).parseInt(window.devicePixelRatio,10)||1,forceFallback:!1,fallbackClass:"sortable-fallback",fallbackOnBody:!1,fallbackTolerance:0,fallbackOffset:{x:0,y:0},supportPointer:J.supportPointer!==!1&&"PointerEvent"in window&&(!Dt||Yn),emptyInsertThreshold:5};Gt.initializePlugins(this,e,t);for(var n in t)!(n in i)&&(i[n]=t[n]);Vo(i);for(var m in this)m.charAt(0)==="_"&&typeof this[m]=="function"&&(this[m]=this[m].bind(this));this.nativeDraggable=i.forceFallback?!1:jc,this.nativeDraggable&&(this.options.touchStartThreshold=1),i.supportPointer?re(e,"pointerdown",this._onTapStart):(re(e,"mousedown",this._onTapStart),re(e,"touchstart",this._onTapStart)),this.nativeDraggable&&(re(e,"dragover",this),re(e,"dragenter",this)),bi.push(this.el),i.store&&i.store.get&&this.sort(i.store.get(this)||[]),Ke(this,zc())}J.prototype={constructor:J,_isOutsideThisEl:function(i){!this.el.contains(i)&&i!==this.el&&(ft=null)},_getDirection:function(i,t){return typeof this.options.direction=="function"?this.options.direction.call(this,i,t,K):this.options.direction},_onTapStart:function(i){if(i.cancelable){var t=this,n=this.el,m=this.options,f=m.preventOnFilter,g=i.type,u=i.touches&&i.touches[0]||i.pointerType&&i.pointerType==="touch"&&i,o=(u||i).target,h=i.target.shadowRoot&&(i.path&&i.path[0]||i.composedPath&&i.composedPath()[0])||o,d=m.filter;if(eu(n),!K&&!(/mousedown|pointerdown/.test(g)&&i.button!==0||m.disabled)&&!h.isContentEditable&&!(!this.nativeDraggable&&Dt&&o&&o.tagName.toUpperCase()==="SELECT")&&(o=Oe(o,m.draggable,n,!1),!(o&&o.animated)&&oi!==o)){if(yt=ke(o),Ft=ke(o,m.draggable),typeof d=="function"){if(d.call(this,i,o,this)){ve({sortable:t,rootEl:h,name:"filter",targetEl:o,toEl:n,fromEl:n}),ye("filter",t,{evt:i}),f&&i.preventDefault();return}}else if(d&&(d=d.split(",").some(function(c){if(c=Oe(h,c.trim(),n,!1),c)return ve({sortable:t,rootEl:c,name:"filter",targetEl:o,fromEl:n,toEl:n}),ye("filter",t,{evt:i}),!0}),d)){f&&i.preventDefault();return}m.handle&&!Oe(h,m.handle,n,!1)||this._prepareDragStart(i,u,o)}}},_prepareDragStart:function(i,t,n){var m=this,f=m.el,g=m.options,u=f.ownerDocument,o;if(n&&!K&&n.parentNode===f){var h=de(n);if(se=f,K=n,ce=K.parentNode,nt=K.nextSibling,oi=n,Yt=g.group,J.dragged=K,tt={target:K,clientX:(t||i).clientX,clientY:(t||i).clientY},Cr=tt.clientX-h.left,Sr=tt.clientY-h.top,this._lastX=(t||i).clientX,this._lastY=(t||i).clientY,K.style["will-change"]="all",o=function(){if(ye("delayEnded",m,{evt:i}),J.eventCanceled){m._onDrop();return}m._disableDelayedDragEvents(),!vr&&m.nativeDraggable&&(K.draggable=!0),m._triggerDragStart(i,t),ve({sortable:m,name:"choose",originalEvent:i}),xe(K,g.chosenClass,!0)},g.ignore.split(",").forEach(function(d){Fo(K,d.trim(),Gi)}),re(u,"dragover",it),re(u,"mousemove",it),re(u,"touchmove",it),g.supportPointer?(re(u,"pointerup",m._onDrop),!this.nativeDraggable&&re(u,"pointercancel",m._onDrop)):(re(u,"mouseup",m._onDrop),re(u,"touchend",m._onDrop),re(u,"touchcancel",m._onDrop)),vr&&this.nativeDraggable&&(this.options.touchStartThreshold=4,K.draggable=!0),ye("delayStart",this,{evt:i}),g.delay&&(!g.delayOnTouchOnly||t)&&(!this.nativeDraggable||!(Ut||Ye))){if(J.eventCanceled){this._onDrop();return}g.supportPointer?(re(u,"pointerup",m._disableDelayedDrag),re(u,"pointercancel",m._disableDelayedDrag)):(re(u,"mouseup",m._disableDelayedDrag),re(u,"touchend",m._disableDelayedDrag),re(u,"touchcancel",m._disableDelayedDrag)),re(u,"mousemove",m._delayedDragTouchMoveHandler),re(u,"touchmove",m._delayedDragTouchMoveHandler),g.supportPointer&&re(u,"pointermove",m._delayedDragTouchMoveHandler),m._dragStartTimer=setTimeout(o,g.delay)}else o()}},_delayedDragTouchMoveHandler:function(i){var t=i.touches?i.touches[0]:i;Math.max(Math.abs(t.clientX-this._lastX),Math.abs(t.clientY-this._lastY))>=Math.floor(this.options.touchStartThreshold/(this.nativeDraggable&&window.devicePixelRatio||1))&&this._disableDelayedDrag()},_disableDelayedDrag:function(){K&&Gi(K),clearTimeout(this._dragStartTimer),this._disableDelayedDragEvents()},_disableDelayedDragEvents:function(){var i=this.el.ownerDocument;ne(i,"mouseup",this._disableDelayedDrag),ne(i,"touchend",this._disableDelayedDrag),ne(i,"touchcancel",this._disableDelayedDrag),ne(i,"pointerup",this._disableDelayedDrag),ne(i,"pointercancel",this._disableDelayedDrag),ne(i,"mousemove",this._delayedDragTouchMoveHandler),ne(i,"touchmove",this._delayedDragTouchMoveHandler),ne(i,"pointermove",this._delayedDragTouchMoveHandler)},_triggerDragStart:function(i,t){t=t||i.pointerType=="touch"&&i,!this.nativeDraggable||t?this.options.supportPointer?re(document,"pointermove",this._onTouchMove):t?re(document,"touchmove",this._onTouchMove):re(document,"mousemove",this._onTouchMove):(re(K,"dragend",this),re(se,"dragstart",this._onDragStart));try{document.selection?ai(function(){document.selection.empty()}):window.getSelection().removeAllRanges()}catch{}},_dragStarted:function(i,t){if(mt=!1,se&&K){ye("dragStarted",this,{evt:t}),this.nativeDraggable&&re(document,"dragover",Gc);var n=this.options;!i&&xe(K,n.dragClass,!1),xe(K,n.ghostClass,!0),J.active=this,i&&this._appendGhost(),ve({sortable:this,name:"start",originalEvent:t})}else this._nulling()},_emulateDragOver:function(){if(Re){this._lastX=Re.clientX,this._lastY=Re.clientY,Uo();for(var i=document.elementFromPoint(Re.clientX,Re.clientY),t=i;i&&i.shadowRoot&&(i=i.shadowRoot.elementFromPoint(Re.clientX,Re.clientY),i!==t);)t=i;if(K.parentNode[Ce]._isOutsideThisEl(i),t)do{if(t[Ce]){var n=void 0;if(n=t[Ce]._onDragOver({clientX:Re.clientX,clientY:Re.clientY,target:i,rootEl:t}),n&&!this.options.dragoverBubble)break}i=t}while(t=No(t));Go()}},_onTouchMove:function(i){if(tt){var t=this.options,n=t.fallbackTolerance,m=t.fallbackOffset,f=i.touches?i.touches[0]:i,g=ie&&Ct(ie,!0),u=ie&&g&&g.a,o=ie&&g&&g.d,h=Qt&&fe&&wr(fe),d=(f.clientX-tt.clientX+m.x)/(u||1)+(h?h[0]-Ui[0]:0)/(u||1),c=(f.clientY-tt.clientY+m.y)/(o||1)+(h?h[1]-Ui[1]:0)/(o||1);if(!J.active&&!mt){if(n&&Math.max(Math.abs(f.clientX-this._lastX),Math.abs(f.clientY-this._lastY))<n)return;this._onDragStart(i,!0)}if(ie){g?(g.e+=d-(ji||0),g.f+=c-(Vi||0)):g={a:1,b:0,c:0,d:1,e:d,f:c};var l="matrix(".concat(g.a,",").concat(g.b,",").concat(g.c,",").concat(g.d,",").concat(g.e,",").concat(g.f,")");ee(ie,"webkitTransform",l),ee(ie,"mozTransform",l),ee(ie,"msTransform",l),ee(ie,"transform",l),ji=d,Vi=c,Re=f}i.cancelable&&i.preventDefault()}},_appendGhost:function(){if(!ie){var i=this.options.fallbackOnBody?document.body:se,t=de(K,!0,Qt,!0,i),n=this.options;if(Qt){for(fe=i;ee(fe,"position")==="static"&&ee(fe,"transform")==="none"&&fe!==document;)fe=fe.parentNode;fe!==document.body&&fe!==document.documentElement?(fe===document&&(fe=Pe()),t.top+=fe.scrollTop,t.left+=fe.scrollLeft):fe=Pe(),Ui=wr(fe)}ie=K.cloneNode(!0),xe(ie,n.ghostClass,!1),xe(ie,n.fallbackClass,!0),xe(ie,n.dragClass,!0),ee(ie,"transition",""),ee(ie,"transform",""),ee(ie,"box-sizing","border-box"),ee(ie,"margin",0),ee(ie,"top",t.top),ee(ie,"left",t.left),ee(ie,"width",t.width),ee(ie,"height",t.height),ee(ie,"opacity","0.8"),ee(ie,"position",Qt?"absolute":"fixed"),ee(ie,"zIndex","100000"),ee(ie,"pointerEvents","none"),J.ghost=ie,i.appendChild(ie),ee(ie,"transform-origin",Cr/parseInt(ie.style.width)*100+"% "+Sr/parseInt(ie.style.height)*100+"%")}},_onDragStart:function(i,t){var n=this,m=i.dataTransfer,f=n.options;if(ye("dragStart",this,{evt:i}),J.eventCanceled){this._onDrop();return}ye("setupClone",this),J.eventCanceled||(ae=Ho(K),ae.removeAttribute("id"),ae.draggable=!1,ae.style["will-change"]="",this._hideClone(),xe(ae,this.options.chosenClass,!1),J.clone=ae),n.cloneId=ai(function(){ye("clone",n),!J.eventCanceled&&(n.options.removeCloneOnHide||se.insertBefore(ae,K),n._hideClone(),ve({sortable:n,name:"clone"}))}),!t&&xe(K,f.dragClass,!0),t?(yi=!0,n._loopId=setInterval(n._emulateDragOver,50)):(ne(document,"mouseup",n._onDrop),ne(document,"touchend",n._onDrop),ne(document,"touchcancel",n._onDrop),m&&(m.effectAllowed="move",f.setData&&f.setData.call(n,m,K)),re(document,"drop",n),ee(K,"transform","translateZ(0)")),mt=!0,n._dragStartId=ai(n._dragStarted.bind(n,t,i)),re(document,"selectstart",n),_t=!0,window.getSelection().removeAllRanges(),Dt&&ee(document.body,"user-select","none")},_onDragOver:function(i){var t=this.el,n=i.target,m,f,g,u=this.options,o=u.group,h=J.active,d=Yt===o,c=u.sort,l=pe||h,s,r=this,a=!1;if(vn)return;function p(O,I){ye(O,r,We({evt:i,isOwner:d,axis:s?"vertical":"horizontal",revert:g,dragRect:m,targetRect:f,canSort:c,fromSortable:l,target:n,completed:y,onMove:function(F,z){return Xt(se,t,K,m,F,de(F),i,z)},changed:k},I))}function v(){p("dragOverAnimationCapture"),r.captureAnimationState(),r!==l&&l.captureAnimationState()}function y(O){return p("dragOverCompleted",{insertion:O}),O&&(d?h._hideClone():h._showClone(r),r!==l&&(xe(K,pe?pe.options.ghostClass:h.options.ghostClass,!1),xe(K,u.ghostClass,!0)),pe!==r&&r!==J.active?pe=r:r===J.active&&pe&&(pe=null),l===r&&(r._ignoreWhileAnimating=n),r.animateAll(function(){p("dragOverAnimationComplete"),r._ignoreWhileAnimating=null}),r!==l&&(l.animateAll(),l._ignoreWhileAnimating=null)),(n===K&&!K.animated||n===t&&!n.animated)&&(ft=null),!u.dragoverBubble&&!i.rootEl&&n!==document&&(K.parentNode[Ce]._isOutsideThisEl(i.target),!O&&it(i)),!u.dragoverBubble&&i.stopPropagation&&i.stopPropagation(),a=!0}function k(){Ee=ke(K),Ze=ke(K,u.draggable),ve({sortable:r,name:"change",toEl:t,newIndex:Ee,newDraggableIndex:Ze,originalEvent:i})}if(i.preventDefault!==void 0&&i.cancelable&&i.preventDefault(),n=Oe(n,u.draggable,t,!0),p("dragOver"),J.eventCanceled)return a;if(K.contains(i.target)||n.animated&&n.animatingX&&n.animatingY||r._ignoreWhileAnimating===n)return y(!1);if(yi=!1,h&&!u.disabled&&(d?c||(g=ce!==se):pe===this||(this.lastPutMode=Yt.checkPull(this,h,K,i))&&o.checkPut(this,h,K,i))){if(s=this._getDirection(i,n)==="vertical",m=de(K),p("dragOverValid"),J.eventCanceled)return a;if(g)return ce=se,v(),this._hideClone(),p("revert"),J.eventCanceled||(nt?se.insertBefore(K,nt):se.appendChild(K)),y(!0);var x=Zn(t,u.draggable);if(!x||Zc(i,s,this)&&!x.animated){if(x===K)return y(!1);if(x&&t===i.target&&(n=x),n&&(f=de(n)),Xt(se,t,K,m,n,f,i,!!n)!==!1)return v(),x&&x.nextSibling?t.insertBefore(K,x.nextSibling):t.appendChild(K),ce=t,k(),y(!0)}else if(x&&Yc(i,s,this)){var w=St(t,0,u,!0);if(w===K)return y(!1);if(n=w,f=de(n),Xt(se,t,K,m,n,f,i,!1)!==!1)return v(),t.insertBefore(K,w),ce=t,k(),y(!0)}else if(n.parentNode===t){f=de(n);var S=0,M,L=K.parentNode!==t,R=!Vc(K.animated&&K.toRect||m,n.animated&&n.toRect||f,s),$=s?"top":"left",D=br(n,"top","top")||br(K,"top","top"),T=D?D.scrollTop:void 0;ft!==n&&(M=f[$],Pt=!1,Zt=!R&&u.invertSwap||L),S=Qc(i,n,f,s,R?1:u.swapThreshold,u.invertedSwapThreshold==null?u.swapThreshold:u.invertedSwapThreshold,Zt,ft===n);var E;if(S!==0){var C=ke(K);do C-=S,E=ce.children[C];while(E&&(ee(E,"display")==="none"||E===ie))}if(S===0||E===n)return y(!1);ft=n,zt=S;var b=n.nextElementSibling,A=!1;A=S===1;var _=Xt(se,t,K,m,n,f,i,A);if(_!==!1)return(_===1||_===-1)&&(A=_===1),vn=!0,setTimeout(qc,30),v(),A&&!b?t.appendChild(K):n.parentNode.insertBefore(K,A?b:n),D&&Po(D,0,T-D.scrollTop),ce=K.parentNode,M!==void 0&&!Zt&&(si=Math.abs(M-de(n)[$])),k(),y(!0)}if(t.contains(K))return y(!1)}return!1},_ignoreWhileAnimating:null,_offMoveEvents:function(){ne(document,"mousemove",this._onTouchMove),ne(document,"touchmove",this._onTouchMove),ne(document,"pointermove",this._onTouchMove),ne(document,"dragover",it),ne(document,"mousemove",it),ne(document,"touchmove",it)},_offUpEvents:function(){var i=this.el.ownerDocument;ne(i,"mouseup",this._onDrop),ne(i,"touchend",this._onDrop),ne(i,"pointerup",this._onDrop),ne(i,"pointercancel",this._onDrop),ne(i,"touchcancel",this._onDrop),ne(document,"selectstart",this)},_onDrop:function(i){var t=this.el,n=this.options;if(Ee=ke(K),Ze=ke(K,n.draggable),ye("drop",this,{evt:i}),ce=K&&K.parentNode,Ee=ke(K),Ze=ke(K,n.draggable),J.eventCanceled){this._nulling();return}mt=!1,Zt=!1,Pt=!1,clearInterval(this._loopId),clearTimeout(this._dragStartTimer),yn(this.cloneId),yn(this._dragStartId),this.nativeDraggable&&(ne(document,"drop",this),ne(t,"dragstart",this._onDragStart)),this._offMoveEvents(),this._offUpEvents(),Dt&&ee(document.body,"user-select",""),ee(K,"transform",""),i&&(_t&&(i.cancelable&&i.preventDefault(),!n.dropBubble&&i.stopPropagation()),ie&&ie.parentNode&&ie.parentNode.removeChild(ie),(se===ce||pe&&pe.lastPutMode!=="clone")&&ae&&ae.parentNode&&ae.parentNode.removeChild(ae),K&&(this.nativeDraggable&&ne(K,"dragend",this),Gi(K),K.style["will-change"]="",_t&&!mt&&xe(K,pe?pe.options.ghostClass:this.options.ghostClass,!1),xe(K,this.options.chosenClass,!1),ve({sortable:this,name:"unchoose",toEl:ce,newIndex:null,newDraggableIndex:null,originalEvent:i}),se!==ce?(Ee>=0&&(ve({rootEl:ce,name:"add",toEl:ce,fromEl:se,originalEvent:i}),ve({sortable:this,name:"remove",toEl:ce,originalEvent:i}),ve({rootEl:ce,name:"sort",toEl:ce,fromEl:se,originalEvent:i}),ve({sortable:this,name:"sort",toEl:ce,originalEvent:i})),pe&&pe.save()):Ee!==yt&&Ee>=0&&(ve({sortable:this,name:"update",toEl:ce,originalEvent:i}),ve({sortable:this,name:"sort",toEl:ce,originalEvent:i})),J.active&&((Ee==null||Ee===-1)&&(Ee=yt,Ze=Ft),ve({sortable:this,name:"end",toEl:ce,originalEvent:i}),this.save()))),this._nulling()},_nulling:function(){ye("nulling",this),se=K=ce=ie=nt=ae=oi=Qe=tt=Re=_t=Ee=Ze=yt=Ft=ft=zt=pe=Yt=J.dragged=J.ghost=J.clone=J.active=null;var i=this.el;wi.forEach(function(t){i.contains(t)&&(t.checked=!0)}),wi.length=ji=Vi=0},handleEvent:function(i){switch(i.type){case"drop":case"dragend":this._onDrop(i);break;case"dragenter":case"dragover":K&&(this._onDragOver(i),Kc(i));break;case"selectstart":i.preventDefault();break}},toArray:function(){for(var i=[],t,n=this.el.children,m=0,f=n.length,g=this.options;m<f;m++)t=n[m],Oe(t,g.draggable,this.el,!1)&&i.push(t.getAttribute(g.dataIdAttr)||Jc(t));return i},sort:function(i,t){var n={},m=this.el;this.toArray().forEach(function(f,g){var u=m.children[g];Oe(u,this.options.draggable,m,!1)&&(n[f]=u)},this),t&&this.captureAnimationState(),i.forEach(function(f){n[f]&&(m.removeChild(n[f]),m.appendChild(n[f]))}),t&&this.animateAll()},save:function(){var i=this.options.store;i&&i.set&&i.set(this)},closest:function(i,t){return Oe(i,t||this.options.draggable,this.el,!1)},option:function(i,t){var n=this.options;if(t===void 0)return n[i];var m=Gt.modifyOption(this,i,t);typeof m<"u"?n[i]=m:n[i]=t,i==="group"&&Vo(n)},destroy:function(){ye("destroy",this);var i=this.el;i[Ce]=null,ne(i,"mousedown",this._onTapStart),ne(i,"touchstart",this._onTapStart),ne(i,"pointerdown",this._onTapStart),this.nativeDraggable&&(ne(i,"dragover",this),ne(i,"dragenter",this)),Array.prototype.forEach.call(i.querySelectorAll("[draggable]"),function(t){t.removeAttribute("draggable")}),this._onDrop(),this._disableDelayedDragEvents(),bi.splice(bi.indexOf(this.el),1),this.el=i=null},_hideClone:function(){if(!Qe){if(ye("hideClone",this),J.eventCanceled)return;ee(ae,"display","none"),this.options.removeCloneOnHide&&ae.parentNode&&ae.parentNode.removeChild(ae),Qe=!0}},_showClone:function(i){if(i.lastPutMode!=="clone"){this._hideClone();return}if(Qe){if(ye("showClone",this),J.eventCanceled)return;K.parentNode==se&&!this.options.group.revertClone?se.insertBefore(ae,K):nt?se.insertBefore(ae,nt):se.appendChild(ae),this.options.group.revertClone&&this.animate(K,ae),ee(ae,"display",""),Qe=!1}}};function Kc(e){e.dataTransfer&&(e.dataTransfer.dropEffect="move"),e.cancelable&&e.preventDefault()}function Xt(e,i,t,n,m,f,g,u){var o,h=e[Ce],d=h.options.onMove,c;return window.CustomEvent&&!Ye&&!Ut?o=new CustomEvent("move",{bubbles:!0,cancelable:!0}):(o=document.createEvent("Event"),o.initEvent("move",!0,!0)),o.to=i,o.from=e,o.dragged=t,o.draggedRect=n,o.related=m||i,o.relatedRect=f||de(i),o.willInsertAfter=u,o.originalEvent=g,e.dispatchEvent(o),d&&(c=d.call(h,o,g)),c}function Gi(e){e.draggable=!1}function qc(){vn=!1}function Yc(e,i,t){var n=de(St(t.el,0,t.options,!0)),m=Wo(t.el,t.options,ie),f=10;return i?e.clientX<m.left-f||e.clientY<n.top&&e.clientX<n.right:e.clientY<m.top-f||e.clientY<n.bottom&&e.clientX<n.left}function Zc(e,i,t){var n=de(Zn(t.el,t.options.draggable)),m=Wo(t.el,t.options,ie),f=10;return i?e.clientX>m.right+f||e.clientY>n.bottom&&e.clientX>n.left:e.clientY>m.bottom+f||e.clientX>n.right&&e.clientY>n.top}function Qc(e,i,t,n,m,f,g,u){var o=n?e.clientY:e.clientX,h=n?t.height:t.width,d=n?t.top:t.left,c=n?t.bottom:t.right,l=!1;if(!g){if(u&&si<h*m){if(!Pt&&(zt===1?o>d+h*f/2:o<c-h*f/2)&&(Pt=!0),Pt)l=!0;else if(zt===1?o<d+si:o>c-si)return-zt}else if(o>d+h*(1-m)/2&&o<c-h*(1-m)/2)return Xc(i)}return l=l||g,l&&(o<d+h*f/2||o>c-h*f/2)?o>d+h/2?1:-1:0}function Xc(e){return ke(K)<ke(e)?1:-1}function Jc(e){for(var i=e.tagName+e.className+e.src+e.href+e.textContent,t=i.length,n=0;t--;)n+=i.charCodeAt(t);return n.toString(36)}function eu(e){wi.length=0;for(var i=e.getElementsByTagName("input"),t=i.length;t--;){var n=i[t];n.checked&&wi.push(n)}}function ai(e){return setTimeout(e,0)}function yn(e){return clearTimeout(e)}Di&&re(document,"touchmove",function(e){(J.active||mt)&&e.cancelable&&e.preventDefault()});J.utils={on:re,off:ne,css:ee,find:Fo,is:function(i,t){return!!Oe(i,t,i,!1)},extend:Nc,throttle:zo,closest:Oe,toggleClass:xe,clone:Ho,index:ke,nextTick:ai,cancelNextTick:yn,detectDirection:jo,getChild:St,expando:Ce};J.get=function(e){return e[Ce]};J.mount=function(){for(var e=arguments.length,i=new Array(e),t=0;t<e;t++)i[t]=arguments[t];i[0].constructor===Array&&(i=i[0]),i.forEach(function(n){if(!n.prototype||!n.prototype.constructor)throw"Sortable: Mounted plugin must be a constructor function, not ".concat({}.toString.call(n));n.utils&&(J.utils=We(We({},J.utils),n.utils)),Gt.mount(n)})};J.create=function(e,i){return new J(e,i)};J.version=Ic;var ue=[],Ot,bn,wn=!1,Ki,qi,Ci,It;function tu(){function e(){this.defaults={scroll:!0,forceAutoScrollFallback:!1,scrollSensitivity:30,scrollSpeed:10,bubbleScroll:!0};for(var i in this)i.charAt(0)==="_"&&typeof this[i]=="function"&&(this[i]=this[i].bind(this))}return e.prototype={dragStarted:function(t){var n=t.originalEvent;this.sortable.nativeDraggable?re(document,"dragover",this._handleAutoScroll):this.options.supportPointer?re(document,"pointermove",this._handleFallbackAutoScroll):n.touches?re(document,"touchmove",this._handleFallbackAutoScroll):re(document,"mousemove",this._handleFallbackAutoScroll)},dragOverCompleted:function(t){var n=t.originalEvent;!this.options.dragOverBubble&&!n.rootEl&&this._handleAutoScroll(n)},drop:function(){this.sortable.nativeDraggable?ne(document,"dragover",this._handleAutoScroll):(ne(document,"pointermove",this._handleFallbackAutoScroll),ne(document,"touchmove",this._handleFallbackAutoScroll),ne(document,"mousemove",this._handleFallbackAutoScroll)),Er(),li(),Fc()},nulling:function(){Ci=bn=Ot=wn=It=Ki=qi=null,ue.length=0},_handleFallbackAutoScroll:function(t){this._handleAutoScroll(t,!0)},_handleAutoScroll:function(t,n){var m=this,f=(t.touches?t.touches[0]:t).clientX,g=(t.touches?t.touches[0]:t).clientY,u=document.elementFromPoint(f,g);if(Ci=t,n||this.options.forceAutoScrollFallback||Ut||Ye||Dt){Yi(t,this.options,u,n);var o=Xe(u,!0);wn&&(!It||f!==Ki||g!==qi)&&(It&&Er(),It=setInterval(function(){var h=Xe(document.elementFromPoint(f,g),!0);h!==o&&(o=h,li()),Yi(t,m.options,h,n)},10),Ki=f,qi=g)}else{if(!this.options.bubbleScroll||Xe(u,!0)===Pe()){li();return}Yi(t,this.options,Xe(u,!1),!1)}}},Ke(e,{pluginName:"scroll",initializeByDefault:!0})}function li(){ue.forEach(function(e){clearInterval(e.pid)}),ue=[]}function Er(){clearInterval(It)}var Yi=zo(function(e,i,t,n){if(i.scroll){var m=(e.touches?e.touches[0]:e).clientX,f=(e.touches?e.touches[0]:e).clientY,g=i.scrollSensitivity,u=i.scrollSpeed,o=Pe(),h=!1,d;bn!==t&&(bn=t,li(),Ot=i.scroll,d=i.scrollFn,Ot===!0&&(Ot=Xe(t,!0)));var c=0,l=Ot;do{var s=l,r=de(s),a=r.top,p=r.bottom,v=r.left,y=r.right,k=r.width,x=r.height,w=void 0,S=void 0,M=s.scrollWidth,L=s.scrollHeight,R=ee(s),$=s.scrollLeft,D=s.scrollTop;s===o?(w=k<M&&(R.overflowX==="auto"||R.overflowX==="scroll"||R.overflowX==="visible"),S=x<L&&(R.overflowY==="auto"||R.overflowY==="scroll"||R.overflowY==="visible")):(w=k<M&&(R.overflowX==="auto"||R.overflowX==="scroll"),S=x<L&&(R.overflowY==="auto"||R.overflowY==="scroll"));var T=w&&(Math.abs(y-m)<=g&&$+k<M)-(Math.abs(v-m)<=g&&!!$),E=S&&(Math.abs(p-f)<=g&&D+x<L)-(Math.abs(a-f)<=g&&!!D);if(!ue[c])for(var C=0;C<=c;C++)ue[C]||(ue[C]={});(ue[c].vx!=T||ue[c].vy!=E||ue[c].el!==s)&&(ue[c].el=s,ue[c].vx=T,ue[c].vy=E,clearInterval(ue[c].pid),(T!=0||E!=0)&&(h=!0,ue[c].pid=setInterval(function(){n&&this.layer===0&&J.active._onTouchMove(Ci);var b=ue[this.layer].vy?ue[this.layer].vy*u:0,A=ue[this.layer].vx?ue[this.layer].vx*u:0;typeof d=="function"&&d.call(J.dragged.parentNode[Ce],A,b,e,Ci,ue[this.layer].el)!=="continue"||Po(ue[this.layer].el,A,b)}.bind({layer:c}),24))),c++}while(i.bubbleScroll&&l!==o&&(l=Xe(l,!1)));wn=h}},30),Ko=function(i){var t=i.originalEvent,n=i.putSortable,m=i.dragEl,f=i.activeSortable,g=i.dispatchSortableEvent,u=i.hideGhostForTarget,o=i.unhideGhostForTarget;if(t){var h=n||f;u();var d=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:t,c=document.elementFromPoint(d.clientX,d.clientY);o(),h&&!h.el.contains(c)&&(g("spill"),this.onSpill({dragEl:m,putSortable:n}))}};function Qn(){}Qn.prototype={startIndex:null,dragStart:function(i){var t=i.oldDraggableIndex;this.startIndex=t},onSpill:function(i){var t=i.dragEl,n=i.putSortable;this.sortable.captureAnimationState(),n&&n.captureAnimationState();var m=St(this.sortable.el,this.startIndex,this.options);m?this.sortable.el.insertBefore(t,m):this.sortable.el.appendChild(t),this.sortable.animateAll(),n&&n.animateAll()},drop:Ko};Ke(Qn,{pluginName:"revertOnSpill"});function Xn(){}Xn.prototype={onSpill:function(i){var t=i.dragEl,n=i.putSortable||this.sortable;n.captureAnimationState(),t.parentNode&&t.parentNode.removeChild(t),n.animateAll()},drop:Ko};Ke(Xn,{pluginName:"removeOnSpill"});J.mount(new tu);J.mount(Xn,Qn);var me={getStyle:(e,i=!1)=>{let t;return window.getComputedStyle?t=window.getComputedStyle(e,null):e.currentStyle&&(t=e.currentStyle),i?t[i]:t},fadeOut:(e,i=250)=>{const t=1/(i/60);e.style.opacity=1,(function n(){const m=Number(e.style.opacity)-t;m>0?(e.style.opacity=m,window.requestAnimationFrame(n)):e.remove()})()},slideDown:(e,i=250,t=!1)=>{e.style.display="block";const n=me.getStyle(e),m=Number.parseInt(n.height,10),f=m/(i/60);e.style.height="0px",(function g(){const u=Number.parseFloat(e.style.height),o=u+f;u<m?(e.style.height=`${o}px`,window.requestAnimationFrame(g)):(e.style.height="auto",t&&t(e))})()},slideUp:(e,i=250,t=!1)=>{const n=me.getStyle(e),m=Number.parseInt(n.height,10),f=n.overflow;e.style.overflow="hidden",e.style.height=`${m}px`;const g=n.minHeight;e.style.minHeight="auto";const u=parseFloat(m/(i/60)).toFixed(2);(function o(){const h=Number.parseInt(e.style.height,10)-u;h>0?(e.style.height=`${h}px`,window.requestAnimationFrame(o)):(e.style.overflow=f,e.style.display="none",e.style.minHeight=g,delete e.style.height,t&&t(e))})()},slideToggle:(e,i=250,t=me.getStyle(e,"display")==="none")=>{t?me.slideDown(e,i):me.slideUp(e,i)}},qo=e=>Number.isInteger(Number(e)),Je=e=>{let i=0,t=e;for(;t?.previousElementSibling;)t=t.previousElementSibling,i++;return i},Si=(e,i,t)=>{const n=t.split("||");return st(st(i).map(m=>e.find(f=>{const g=n.find(u=>!!we(f,u));return g&&we(f,g)===m})).filter(Boolean).concat(e))},Ni=(e,i,t)=>{for(let n=0;n<e.length;n++)i.call(t,e[n],n)},Jn=(e,i)=>{const t=[];return Ni(e,(n,m)=>t.push(i(n,m))),t},Zi={},Yo=e=>{const i={className:"class"};if(Zi[e])return Zi[e];const t=(i[e]||e).replace(/^\d+/,"").replace(/[^a-zA-Z0-9-:]/g,"");return Zi[e]=t,t},Zo=e=>e.replace(/\b\w/g,i=>i.toUpperCase()),iu=e=>window.JSON.parse(window.JSON.stringify(e)),nu=(e,i)=>i.filter(t=>!~e.indexOf(t)),Ae={capitalize:Zo,safeAttrName:Yo,forEach:Ni,copyObj:iu,map:Jn,subtract:nu,indexOfNode:Je,isInt:qo,get:we,orderObjectsBy:Si},Me={js:new Set,css:new Set,formeoSprite:null},ru=1e4,Ar=(e,i,t=hn,n=ru)=>new Promise(m=>{const f=typeof AbortSignal<"u"&&AbortSignal.timeout?AbortSignal.timeout(n):void 0;return fetch(e,f?{signal:f}:void 0).then(g=>{if(!g.ok)return m(t(g));m(i?i(g):g)}).catch(g=>m(t(g)))}),Qo=(e,i)=>{e.removeEventListener("load",Qo),i(e.src)},Xo=(e,i)=>{e.removeEventListener("load",Xo),i(e.src)},ou=e=>new Promise((i,t)=>{if(Me.js.has(e))return i(e);Me.js.add(e);const n=V.create({tag:"script",attrs:{type:"text/javascript",async:!0,src:e},action:{load:()=>Xo(n,i),error:()=>t(new Error(`${e} failed to load.`))}});document.head.appendChild(n)}),Cn=e=>{e=Array.isArray(e)?e:[e];const i=e.map(t=>new Promise((n,m)=>{if(Me.css.has(t))return n(t);Me.css.add(t);const f=V.create({tag:"link",attrs:{rel:"stylesheet",href:t},action:{load:()=>Qo(f,n),error:()=>m(new Error(`${t} failed to load.`))}});document.head.appendChild(f)}));return Promise.all(i)},su=e=>{e=Array.isArray(e)?e:[e];const i=e.map(t=>ou(t));return Promise.all(i)},au=e=>{e=Array.isArray(e)?e:[e];const i=e.map(t=>Cn(t));return Promise.all(i)},kr=e=>(Me.formeoSprite=new DOMParser().parseFromString(e,"image/svg+xml").documentElement,Me.formeoSprite),lu=async(e=null)=>{if(Me.formeoSprite)return Me.formeoSprite;if(!e)return kr(cl);const i=async t=>kr(await t.text());return Ar(e,i,()=>Ar(dl,i))},cu={js:su,css:au},Jo=e=>{const i=Object.entries(e).map(([t,n])=>cu[t](n));return Promise.all(i)},uu=async e=>{if(e&&!Me.css.has(e)&&(await Cn(e),!Me.css.has(e)&&!Me.css.has("https://draggable.github.io/formeo/assets/css/formeo.min.css")))return await Cn(pl)},du={glyphicons:e=>`<span class="glyphicon glyphicon-${e}" aria-hidden="true"></span>`,"font-awesome":e=>{const[i,t]=e.split(" ");return`<i class="${i} fa-${t}"></i>`},fontello:e=>`<i class="${$o}${e}">${e}</i>`},hu=new Set(["input","textarea","select"]),pu=e=>e.replace(/^on([A-Z])/,(i,t)=>t.toLowerCase()),fu=new Set(["focus","blur"]),gu=e=>{const i=pu(e);return(t,n)=>t.addEventListener(i,n,fu.has(i))},es=(e={})=>{let i=e?.attrs?.name||e?.name;if(i)return i;const t=Te(e);let n=e.config?.label||e.attrs?.label||e?.label;return n&&(typeof n=="object"&&(n=V.create(n).textContent),/^<.+>.+<.+>$/gim.test(n)&&(n=Hl(n)),i=`${t}-${Lo(Wl(n,24,null))}`),i||t},mu=class{constructor(e=Object.create(null)){this.options=e}set setOptions(e){this.options=De(this.options,e)}processElemArg(e){let i=e,t;if(typeof i=="string")return t=i,i={tag:t},i;if(i.attrs){const{tag:n,...m}=i.attrs;n&&(typeof n=="string"?t=n:t=(n.find(f=>f.selected===!0)||n[0]).value),i.attrs=m}return i.tag=t||i.tag||"div",i}render=e=>(e.id=`f-${e.id||Te()}`,this.create(e));create=(e,i=!1)=>{if(!e)return;if(this.isDOMElement(e))return e;const t=this,n=["children","content"],{className:m,options:f,dataset:g,...u}=this.processElemArg(e);n.push("tag");let o;const{tag:h}=u;let d;const c={attrs:{},className:[Ae.get(u,"config.inputWrap")],children:[],config:{}};let l=document.createElement(h);const s={string:a=>{l.innerHTML+=a},object:a=>a&&l.appendChild(t.create(a,i)),node:a=>l.appendChild(a),component:a=>l.appendChild(a.dom),array:a=>{for(const p of a)o=t.childType(p),s[o](p)},function:a=>{a=a(),o=t.childType(a),s[o](a)},undefined:()=>null,boolean:()=>null};if(m&&(u.attrs=De(u.attrs,{className:m})),f){const a=this.processOptions(f,u,i);if(this.holdsContent(l)&&h!=="button")s.array.call(this,a),u.content=void 0;else return Ae.forEach(a,p=>{c.children.push(t.create(p,i))}),u.attrs.className&&(c.className=u.attrs.className),c.id=u.id,c.config={...u.config},this.create(c,i);n.push("options")}if(u.attrs&&(t.processAttrs(u,l,i),n.push("attrs")),u.config){if(u.config.label&&(u.config.label&&h!=="button"||["radio","checkbox"].includes(Ae.get(u,"attrs.type")))&&!i){const a=t.label(u);if(!u.config.hideLabel){const p=[a,l];t.labelAfter(u)&&p.reverse(),c.children.push(p)}}n.push("config")}if(u.content||u.children){const a=u.content||u.children;o=t.childType(a),s[o]||console.error(`childType: ${o} is not supported`),s[o].call(this,a)}if(g){for(const a in g)Object.hasOwn(g,a)&&(l.dataset[a]=typeof g[a]=="function"?g[a]():g[a]);n.push("dataset")}u.action&&(this.actionHandler(l,u.action),n.push("action"));const r=Ae.subtract(n,Object.keys(u));for(d=r.length-1;d>=0;d--)l[r[d]]=u[r[d]];return c.children.length&&(l=this.create(c)),l};onRender=(e,i,t=333)=>{const n=Date.now(),m=()=>{!e.parentElement&&Date.now()-n<t?window.requestAnimationFrame(m):e.parentElement&&i(e)};m()};actionHandler(e,i){const t={onRender:V.onRender,render:V.onRender};return Object.entries(i).map(([n,m])=>(Array.isArray(m)?m:[m]).map(f=>(t[n]||gu(n))(e,f)))}get icons(){if(this.iconSymbols)return this.iconSymbols;const e=Me.formeoSprite.querySelectorAll("svg symbol"),i=t=>{const n=t.getAttribute("viewBox")||"0 0 24 24",m=Array.from(t.children).map(f=>f.cloneNode(!0).outerHTML).join("");return{tag:"svg",attrs:{className:["svg-icon",t.id],viewBox:n,xmlns:"http://www.w3.org/2000/svg"},children:m}};return this.iconSymbols=Array.from(e).reduce((t,n)=>{const m=n.id.replace($o,"");return t[m]=i(n),t},{}),this.cachedIcons={},this.iconSymbols}icon(e,i){if(!e)return;const t=`${e}?${new URLSearchParams(i).toString()}`;if(this.cachedIcons?.[t])return this.cachedIcons[t];const n=this.icons[e];if(n){if(i){const m=De(n,i);return this.cachedIcons[t]=V.create(m).outerHTML,this.cachedIcons[t]}return this.cachedIcons[t]=V.create(n).outerHTML,this.cachedIcons[t]}return du[V.options.iconFont]?.(e)||e}processAttrs(e,i,t){const{attrs:n={}}=e;if(!t&&!n.name&&n.name!==null&&this.isInput(e.tag)){const m=es(e);m&&i.setAttribute("name",m)}for(const m of Object.keys(n)){const f=Ae.safeAttrName(m),g=this.processAttrValue(n[m]);if(g!==!1)try{i.setAttribute(f,g)}catch(u){console.warn(`Could not set attribute ${f} with value ${g}`,u)}}}processAttrValue(e){if(typeof e=="function")return e();if(typeof e=="boolean")return e&&"";let i=e||"";if(Array.isArray(i))if(typeof i[0]=="object"){const t=i.filter(n=>n.selected===!0);i=t.length?t[0].value:i[0].value}else i=i.join(" ");return i}toggleElementsByStr=(e,i)=>{const t=[],n=(m,f)=>{f?(m.style.display="block",t.push(m)):m.style.display="none"};return V.elementsContainText(e,i,n),t};elementsContainText=(e,i,t)=>{const n=[];return Ni(e,m=>{const f=m.textContent.toLowerCase().indexOf(i.toLowerCase())!==-1;t?.(m,f),f&&n.push(m)}),n};generateOption=({type:e="option",label:i,value:t,i:n=0,selected:m})=>({tag:e==="option"?"option":"input",attrs:{type:e,value:t||`${e}-${n}`,[e==="option"?"selected":"checked"]:m||!n},config:{label:i||Z.get("labelCount",{label:Z.get("option"),count:n})}});processOptions(e,i,t){const{action:n,attrs:m={}}=i,f=m.type||i.tag,g=m.id||i.id,u=(o,h)=>{const{label:d,value:c,...l}=o,s=()=>{const r={tag:"input",attrs:{name:g,type:f,value:c||"",id:`${g}-${h}`,...l},action:n},a={tag:"label",attrs:{for:`${g}-${h}`},children:d},p={children:[r,a],className:[`f-${f}`]};return m.className&&(i.config.inputWrap=m.className),i.config.inline&&p.className.push(`f-${f}-inline`),o.selected&&(r.attrs.checked=!0),t&&(a.attrs.contenteditable=!0),p};return{select:()=>{const r=o.attrs||o,{label:a,checked:p,selected:v,attrs:y}={attrs:r,...o,...r};return{tag:"option",attrs:{...y,selected:!!(p||v)},children:a}},button:r=>{const{type:a,label:p,className:v,id:y}=r;return{...i,attrs:{type:a},className:v,id:y||Te(),options:void 0,children:p,action:i.action}},checkbox:s,radio:s}[f]?.(o)};return e.map(u)}holdsContent(e){return e.outerHTML.includes("/")}isBlockInput(e){return!this.isInput(e)&&this.holdsContent(e)}isInput(e){let i=e;return typeof i!="string"&&(i=i.tagName),hu.has(i)}parsedHtml(e){const i=document.createElement("textarea");return i.innerHTML=e,i.textContent}labelAfter(e){const i=Ae.get(e,"attrs.type"),t=Ae.get(e,"config.labelAfter");return t===void 0?i==="checkbox"||i==="radio":t}requiredMark=()=>({tag:"span",className:"text-error",children:"*"});tooltip=e=>({tag:"span",className:"f-tooltip",dataset:{tooltip:e},content:V.icon("info-circle")});helpText=e=>({tag:"small",className:"f-help-text",children:e});label(e,i){const t=Ae.get(e,"attrs.required");let{config:{label:n="",helpText:m="",tooltip:f=null}}=e;const{id:g,attrs:u}=e;typeof n=="function"&&(n=n());const o={tag:"label",attrs:{for:g||u?.id},className:[],children:[n,t&&this.requiredMark(),f&&this.tooltip(f),m&&this.helpText(m)],action:{}};return i&&(o.attrs.for=void 0,o.attrs.contenteditable=!0,o.fMap=i),o}childType(e){return e===void 0?e:[["array",i=>Array.isArray(i)],["node",i=>i instanceof window.Node||i instanceof window.HTMLElement],["component",()=>e?.dom],[typeof e,()=>!0]].find(i=>i[1](e))[0]}getStyle(e,i=!1){let t;return window.getComputedStyle?t=window.getComputedStyle(e,null):e.currentStyle&&(t=e.currentStyle),i?t[i]:t}getElement(e){return{node:()=>e,object:()=>document.getElementById(e.id),string:()=>document.getElementById(e)}[this.childType(e)]()}empty(e){for(;e.firstChild;)this.remove(e.firstChild);return e}removeEmpty=e=>{const i=e.parentElement,t=be(e),n=i.getElementsByClassName(`formeo-${t}`);if(this.remove(e),!n.length)return this.isStage(i)?this.emptyClass(i):this.removeEmpty(i)};remove(e){const i=be(e);return i?oe.remove(`${i}s.${e.id}`):e.parentElement.removeChild(e)}removeClasses(e,i){const t={string:n=>n.classList.remove(i),array:n=>{for(const m of i)n.classList.remove(m)}};t.object=t.string,Ae.forEach(e,t[this.childType(i)])}addClasses(e,i){Ae.forEach(e,{string:t=>t.classList.add(i),array:t=>{for(const n of i)t.classList.add(n)}}[this.childType(i)])}formGroup(e,i=""){return{className:["f-field-group",i],children:e}}coords(e){const i=e.getBoundingClientRect(),t=document.body.getBoundingClientRect();return{pageX:i.left+i.width/2,pageY:i.top-t.top-i.height/2}}clearStage(e){e.classList.add("removing-all-fields");const i=()=>{V.empty(e),e.classList.remove("removing-all-fields"),V.emptyClass(e),me.slideDown(e,300)};me.slideUp(e,600,i)}toggleSortable(e,i){let t=i;const n=be(e);if(!n)return;const m=be(e.parentElement),f=V[n].get(e.id).sortable;t||(t=!f.option("disabled")),f.option("disabled",t),m&&["rows","columns","stages"].includes(m)&&this.toggleSortable(e.parentElement,t)}emptyClass(e){const i=e.getElementsByClassName(fl.get(e.classList.item(0)));e.classList.toggle("empty",!i.length)}btnTemplate=({title:e="",...i})=>({tag:"button",attrs:{type:"button",title:e},...i});isControls=e=>be(e)===ot;isStage=e=>be(e)===kt;isRow=e=>be(e)===Ue;isColumn=e=>be(e)===Ge;isField=e=>be(e)===Tt;asComponent=e=>oe[`${be(e)}s`].get(e.id);isDOMElement(e){return e instanceof window.Element||e instanceof window.HTMLElement||!!(e&&typeof e=="object"&&e.nodeType===1&&typeof e.nodeName=="string")}resolveContainer(e){return typeof e=="string"?document.querySelector(e):e}},V=new mu,bt="f-autocomplete",vu=`${bt}-display-field`,er=`${bt}-list`,$t="highlight-component",xi=`${er}-item`,yu=(e,i)=>{const t=e.reduce((n,m)=>n+(m===i),0);return t>1?`(${t})`:""},ts=["config.label","config.controlId"],bu=["config.legend","name"],wu=[...ts,...bu],Qi=e=>ts.reduce((i,t)=>i||e.get(t),null),Tr=e=>wu.reduce((i,t)=>i||e.get(t),null)||je(e.name),Cu=new Map([["condition.source",Qi],["if.condition.source",Qi],["if.condition.target",Qi],["then.condition.target",Tr],["condition.target",Tr]]),is=({id:e,...i},t)=>{const{name:n,label:m}=i;return n?Cu.get(t)(i):m},Su=({selectedId:e,...i})=>(i.value===e&&(i.selected=!0),i),Xi=e=>(e.classList.contains(xi)||(e=e.parentElement),e),ns=({value:e,textLabel:i,htmlLabel:t,componentType:n,depth:m=0},f)=>{const g={tag:"li",children:t,dataset:{value:e,label:i},className:[xi,`${xi}-depth-${m}`,`component-type-${n}`],action:{mousedown:({target:u})=>{u=Xi(u),f.setValue(u),f.selectOption(u),f.hideList()},mouseover:({target:u})=>{u=Xi(u),f.removeHighlight(),f.highlightComponent(u)},mouseleave:({target:u})=>{u=Xi(u),f.removeHighlight()}}};return V.create(g)},xu=(e,i)=>{const t=e.data.options.map((n,m)=>{const f=`${e.address}.options[${m}]`,g=n.label,u=n.label;return ns({value:f,textLabel:g,htmlLabel:u,componentType:"option",depth:1},i)});return V.create({tag:"ul",attrs:{className:[er,"options-list"]},children:t})},Eu=e=>{const i=e.value,t=[],n=oe.flatList();return Object.entries(n).reduce((m,[f,g])=>{const u=is(g,e.key);if(u){const o=g.name,h={tag:"span",content:` ${je(o)}`,className:"component-type"},d=`${o}.${u}`;t.push(d);const c=yu(t,d),l={tag:"span",content:c,className:"component-label-count"},s=[`${u} `,l,h],r=[u,c].join(" ").trim();if(g.isCheckable){const p=xu(g,e);s.push(p)}const a=Su({value:f,textLabel:r,htmlLabel:s,componentType:o,selectedId:i});m.push(ns(a,e))}return m},[])},Au=class{lastCache=Date.now();optionsCache=null;constructor({key:e,value:i,className:t,onChange:n=hn}){this.key=e,this.className=[t||this.key.replace(/\./g,"-")].flat(),this.value=i,this.onChange=n||hn,this.events=[],this.build()}createProxy(){return new Proxy(this,{get(e,i){if(i in e)return e[i];if(i in e.dom){const t=e.dom[i];return typeof t=="function"?t.bind(e.dom):t}},set(e,i,t){return i in e?e[i]=t:e.dom[i]=t,!0}})}get isAddress(){return Ie(this.value)}get valueComponent(){return Ie(this.value)&&oe.getAddress(this.value)}build(){const e=t=>{const n=this.list,m=this.getActiveOption();let f=new Map([[38,()=>{const g=this.getPreviousOption(m);g&&this.selectOption(g)}],[40,()=>{const g=this.getNextOption(m);g&&this.selectOption(g)}],[13,()=>{m&&(this.selectOption(m),this.setValue(m),n.style.display==="none"?this.showList(m):this.hideList()),t.preventDefault()}],[27,()=>{this.hideList()}]]).get(t.keyCode);return f||(f=()=>!1),f()},i={focus:({target:t})=>{this.updateOptions(),t.parentElement.classList.add(`${bt}-focused`);const n=V.toggleElementsByStr(this.list.querySelectorAll(`.${xi}-depth-0`),t.value);t.addEventListener("keydown",e);const m=this.list.querySelector(".active-option")||n[0];this.showList(m)},blur:({target:t})=>{t.parentElement.classList.remove(`${bt}-focused`),t.removeEventListener("keydown",e),this.hideList()},input:t=>{const{value:n}=t.target,m=V.toggleElementsByStr(this.list.querySelectorAll("li"),n);if(n.length===0&&this.clearValue(),m.length===0)this.hideList();else{const f=this.getActiveOption()||m[0];this.showList(f)}this.setValue({dataset:{label:n,value:n}})}};return this.displayField=V.create({tag:"input",autocomplete:"off",action:i,attrs:{type:"text",className:vu,value:this.label||this.value,placeholder:Z.get(`${this.key}.placeholder`)}}),this.hiddenField=V.create({tag:"input",attrs:{type:"hidden",className:bt,value:this.value}}),this.list=V.create({tag:"ul",attrs:{className:er}}),this.clearButton=V.create({tag:"span",content:V.icon("remove"),className:"clear-button hidden",action:{click:()=>this.clearValue()}}),this.dom=V.create({children:[this.displayField,this.clearButton,this.hiddenField],className:[bt,this.className].flat(),action:{onRender:t=>{this.stage=t.closest(".formeo-stage"),this.value&&(this.displayField.value=this.label),this.clearButton.classList.toggle("hidden",!this.value.length)}}}),this.dom}get label(){if(!Ie(this.value))return this.value;const e=this.value&&oe.getAddress(this.value);return e&&is(e,`${this.key}`)||this.value}updateOptions(){let e=this.optionsCache;const i=Date.now();(i-this.lastCache>zn*5||!e)&&(V.empty(this.list),e=this.generateOptions(),this.lastCache=i),this.list.children.length||this.list.append(...e)}generateOptions(){return this.optionsCache=Eu(this),this.optionsCache}setListPosition(){const{offsetHeight:e,offsetWidth:i}=this.displayField,t=this.displayField.closest(".formeo-stage").getBoundingClientRect(),n=this.displayField.getBoundingClientRect(),m={position:"absolute",top:`${n.y+e-t.y}px`,left:`${n.x+window.scrollX-t.x+2}px`,width:`${i}px`};Object.assign(this.list.style,m)}showList(e,i=this.list){this.stage.contains(this.list)||this.stage.appendChild(this.list),this.setListPosition(),this.selectOption(e),me.slideDown(i,at)}hideList(e=this.list){me.slideUp(e,at),this.removeHighlight(),this.stage.contains(this.list)&&this.stage.removeChild(this.list)}getActiveOption(e=this.list){const i=e.querySelector(".active-option");return i?.style.display!=="none"?i:null}getPreviousOption(e){let i=e;do i=i?i.previousSibling:null;while(i!=null&&i.style.display==="none");return i}getNextOption(e){let i=e;do i=i?i.nextSibling:null;while(i!=null&&i.style.display==="none");return i}selectOption(e,i=this.list){const t=i.querySelectorAll("li");for(const n of t){const{dataset:{value:m}}=n;n.classList.remove("active-option"),Ie(m)&&oe.getAddress(m)?.dom?.classList.remove($t)}e&&(e.classList.add("active-option"),this.highlightComponent(e))}removeHighlight(){const e=document.getElementsByClassName($t);for(const i of e)i.classList.remove($t)}highlightComponent(e){const{dataset:{value:i}}=e;if(Ie(i)){const{componentAddress:t,isOptionAddress:n,optionIndex:m}=lt(i).reduce((g,u)=>u==="options"?(g.isOptionAddress=!0,g):g.isOptionAddress?(g.optionIndex=+u,g):(g.componentAddress.push(u),g),{componentAddress:[],optionIndex:null,isOptionAddress:!1}),f=oe.getAddress(t);f?.dom&&(f.dom.classList.add($t),n&&f.dom.querySelectorAll(".field-preview .f-checkbox, .field-preview .f-radio")[m]?.classList.add($t))}}clearValue(){this.selectOption(null),this.setValue({dataset:{label:"",value:""}}),this.displayField.focus()}setValue(e){const{label:i,value:t}=e.dataset;this.displayField.value=i,this.hiddenField.value=t,this.value=t,this.clearButton.classList.toggle("hidden",!t.length),this.onChange?.({target:this.hiddenField})}},rs=e=>Z.get(`${e}.placeholder`)||je(mi(e)),tr=e=>e.replaceAll(".","-"),Mr=new Map([["config.helpText",(...e)=>$r(...e)],["config.tooltip",(...e)=>$r(...e)]]);function Ji({key:e,value:i,type:t="text",checked:n}){const m={tag:"input",attrs:{type:t,value:i,placeholder:rs(e)},className:[tr(e)],config:{}};return n&&(m.attrs.checked=!0),m}function $r({key:e,value:i}){return{tag:"textarea",attrs:{placeholder:rs(e)},className:[tr(e)],config:{},textContent:i}}function ze(e){const i=Z.get(e);if(i)return i;const t=mi(e);return Z.get(t)||je(t)}var xt={autocomplete:(...e)=>new Au(...e).createProxy(),string:({key:e,value:i})=>Mr.has(e)?Mr.get(e)({key:e,value:i}):Ji({key:e,value:i}),boolean:({key:e,value:i})=>Ji({key:e,value:i,type:e==="selected"?"radio":"checkbox",checked:!!i}),number:({key:e,value:i})=>Ji({key:e,value:i,type:"number"}),array:({key:e,value:i})=>({tag:"select",attrs:{placeholder:ze(`placeholder.${e}`)},className:[tr(e)],options:i}),object:e=>Object.entries(e).map(([i,t])=>xt[V.childType(t)]({key:i,value:t}))},ku={boolean:(e,i)=>({click:({target:t})=>{if(t.type==="radio"){const n=i.data.options.map(m=>({...m,selected:!1}));i.set("options",n)}i.set(e,t.checked),i.updatePreview()}}),string:(e,i)=>({input:({target:{value:t}})=>{i.set(e,t),i.debouncedUpdatePreview()}}),number:(e,i)=>({input:({target:{value:t}})=>{i.set(e,Number(t)),i.debouncedUpdatePreview()}}),array:(e,i)=>({change:({target:{value:t}})=>{i.set(e,t),i.debouncedUpdatePreview()}}),object:()=>({})},Tu=Object.freeze({title:"",content:null,confirmText:()=>ze("save"),cancelText:()=>ze("cancel"),onConfirm:()=>{},onCancel:()=>{},className:"",closeOnEscape:!0,position:"top",triggerElement:null,triggerCoords:null}),Mu=class ci{constructor(i){this.opts=De(Tu,i),this.dialog=null}createDialog(){const{title:i,content:t,confirmText:n,cancelText:m,className:f,closeOnEscape:g,position:u}=this.opts,o=`dialog-position-${u}`,h=[];return i&&h.push({tag:"h3",className:"dialog-title",textContent:i}),t&&h.push({tag:"div",className:"dialog-body",children:Array.isArray(t)?t:[t]}),h.push({tag:"div",className:"dialog-actions",children:[{tag:"button",type:"button",className:"btn btn-sm btn-secondary",textContent:typeof m=="function"?m():m,action:{click:()=>this.handleCancel()}},{tag:"button",type:"submit",className:"btn btn-sm btn-primary",textContent:typeof n=="function"?n():n}]}),V.create({tag:"dialog",className:["formeo-dialog","formeo",o,f],children:[{tag:"form",className:"dialog-form",method:"dialog",children:h,action:{submit:d=>this.handleSubmit(d)}}],action:{cancel:d=>{g?this.handleCancel():d.preventDefault()}}})}handleSubmit(i){i.preventDefault();const t=new FormData(i.target);this.opts.onConfirm(t,this),this.close()}handleCancel(){this.opts.onCancel(this),this.close()}setPosition(){const{position:i,triggerElement:t,triggerCoords:n}=this.opts;if(i!=="trigger"||!this.dialog)return;let m=n;if(!m&&t){const f=t.getBoundingClientRect();m={x:f.left+f.width/2,y:f.bottom+8}}if(m){const f=this.dialog.getBoundingClientRect(),g=window.innerWidth,u=window.innerHeight;let o=m.x-f.width/2,h=m.y;const d=16;o=Math.max(d,Math.min(o,g-f.width-d)),h=Math.max(d,Math.min(h,u-f.height-d)),this.dialog.style.left=`${o}px`,this.dialog.style.top=`${h}px`,this.dialog.style.transform="none"}}open(){if(this.dialog||(this.dialog=this.createDialog()),document.body.appendChild(this.dialog),this.dialog.showModal(),this.opts.position==="trigger"){const i=setTimeout(()=>{this.setPosition(),clearTimeout(i)},0)}return this}close(){this.dialog&&(this.dialog.close(),this.dialog.remove(),this.dialog=null)}static alert(i,t=()=>{}){return new ci({content:{tag:"p",className:"dialog-message",textContent:i},confirmText:()=>Z.get("ok")||"OK",cancelText:"",onConfirm:()=>t()})}static confirm(i,t=()=>{},n=()=>{}){return new ci({content:{tag:"p",className:"dialog-message",textContent:i},confirmText:()=>Z.get("confirm")||"Confirm",onConfirm:()=>t(),onCancel:()=>n()})}static prompt(i,t=()=>{},n=""){return new ci({content:[{tag:"label",className:"dialog-prompt-label",children:[{tag:"p",className:"dialog-message",textContent:i},{tag:"input",type:"text",name:"prompt-value",className:"dialog-prompt-input",value:n}]}],onConfirm:m=>{t(m.get("prompt-value"))}})}},os="hidden-property",$u="hidden-option",en=/\.options\[\d+\]$/,Lu={"if-sourceProperty":ri(ni,pr,fr),"if-targetProperty":ri(ni),"then-targetProperty":ri(ni,pr,fr),...Object.entries(_l).reduce((e,[i,t])=>(e[`if-${i}`]=t,e[`then-${i}`]=t,e),{})},ss={assignment:Lt,comparison:Lt,logical:Lt,source:({key:e,value:i,onChange:t,conditionType:n})=>xt.autocomplete({key:`${n}.condition.${e}`,value:i,onChange:t,className:`condition-${e}`}),sourceProperty:Lt,targetProperty:Lt,target:e=>ss.source(e),value:({key:e,value:i,onChange:t},n)=>{const m=xt.string({key:`condition.${e}`,value:i});return m.action={input:t},m}};function Ru({key:e,value:i,conditionType:t}){return Object.entries(Lu[`${t}-${e}`]||{}).map(([n,m])=>_u({fieldName:e,fieldValue:i,key:n,optionValue:m}))}function _u({fieldName:e,fieldValue:i,key:t,optionValue:n}){return{label:Z.get(`${e}.${t}`)||je(t).toLowerCase(),value:n,selected:n===i}}function Lt({key:e,value:i,onChange:t,conditionType:n}){const m=Ru({key:e,value:i,conditionType:n}),f=xt.array({key:`condition.${e}`,value:m});return f.action={change:t},f}var Ou=e=>!e?.classList.contains(os),Iu={sourceProperty:e=>{const i=e.get("source"),t=e.get("sourceProperty"),n=!!i.value;return Rr(!!i.value.match(en),t),!n},comparison:e=>{const i=e.get("source"),t=e.get("sourceProperty"),n=!!i.value,m=!!i.value.match(en);return!n||m||t.value!=="value"},assignment:e=>{const i=e.get("target"),t=e.get("targetProperty");return!i.value||t.value.startsWith("is")},targetProperty:e=>{const i=e.get("target"),t=e.get("targetProperty");return Rr(!!i.value.match(en),t),!ll(i.value)},target:e=>{const i=e.get("source"),t=e.get("sourceProperty"),n=!!i?.value;return t&&!n?!0:t&&t?.value!=="value"},value:e=>{const i=e.get("target"),t=e.get("targetProperty");return t===void 0?!1:i&&!i.value||!Ou(e.get("comparison"))||t.value===as?!0:t.value.startsWith("is")}},Lr=e=>{for(const[i,t]of e){const n=!!Iu[i]?.(e)||!1;t.classList.toggle(os,n)}},as="isChecked",tn=e=>e.value.endsWith("Checked"),Rr=(e,i)=>{if(e&&tn(i))return null;const t=Array.from(i.querySelectorAll("option")),n=[];for(const m of t){const f=tn(m),g=e?!f:f;g&&n.push(m.value),m.classList.toggle($u,g)}n.includes(i.value)&&(i.value=e?as:t.find(m=>!tn(m))?.value||i.value)};function Du(e,i=Rl){return i.reduce((t,n)=>(e[n]!==void 0&&t.push([n,e[n]]),t),[])}var Nu=class{constructor({conditionValues:e,conditionType:i,conditionCount:t,index:n},m){this.values=new Map(Du(e)),this.conditionType=i,this.parent=m,this.baseAddress=`${m.address}.${i}`,this.fields=new Map,this.conditionCount=t,this.index=n,this.dom=this.generateDom()}setConditionIndex(e){this.index=e}get address(){return`${this.baseAddress}[${this.index}]`}destroy(){const e=oe.getAddress(this.baseAddress);e.splice(this.index,1),oe.setAddress(this.baseAddress,e),me.slideUp(this.dom,at,()=>{this.dom.remove()})}label(){return this.index?null:{tag:"label",className:`condition-label ${this.conditionType}-condition-label`,content:Z.get(`condition.type.${this.conditionType}`)}}generateDom(){const e=[];for(const[t,n]of this.values){const m=o=>this.onChangeCondition({key:t,target:o.target}),f={key:t,value:n,conditionType:this.conditionType,onChange:m},g=ss[t](f,this.values),u=g.dom||V.create(g);this.fields.set(t,g.dom?g:u),e.push(u)}const i={children:[this.label(),...e,...this.generateConditionTypeActionButtons()],className:`f-condition-row ${this.conditionType}-condition-row display-none`,action:{onRender:t=>{this.processUiState()}}};return V.create(i)}generateConditionTypeActionButtons(){const e=[],i="manage-condition-type",t=f=>`${f}-condition-type`,n=V.btnTemplate({title:Z.get(`remove${this.conditionType}Condition`),className:[i,t("remove")],content:V.icon("minus"),action:{click:()=>this.destroy(),mouseover:f=>{this.dom.classList.add("to-remove")},mouseout:f=>{this.dom.classList.remove("to-remove")}}});e.push(n);const m=V.btnTemplate({title:Z.get(`add${this.conditionType}Condition`),className:[i,t("add")],content:V.icon("plus"),action:{click:()=>{const f=this.parent.addConditionType(this.conditionType),g={changedProperty:null,dataPath:f.address,value:f.value,src:f.dom};this.updateDataDebounced(g)}}});return e.push(m),e}get value(){return Array.from(this.fields).reduce((e,[i,t])=>(e[i]=t.value,e),{})}processUiState(){Lr(this.fields),this.dom.classList.remove("display-none")}updateDataDebounced=fi(e=>{Q.formeoUpdated(e),oe.setAddress(e.dataPath,e.value)});onChangeCondition=({key:e,target:i})=>{const t={changedProperty:e,dataPath:this.address,value:this.value,src:i};Lr(this.fields),this.updateDataDebounced(t)}},Fu=new Map([["attrs",({itemKey:e})=>e],["options",({itemKey:e,key:i})=>`${e}.${i}`]]),ls=(e,i)=>{if(i.controlId==="select"){const t=i.editPanels.get("options"),[n,m]=e?gi:Dl,f=t.data.map(({[n]:g,...u})=>({[m]:g,...u}));t.setData(f)}},zu=new Map([["attrs-multiple",e=>({change:({target:i})=>{e.field.controlId==="select"&&ls(i.checked,e.field)}})]]),Rt=class{constructor({key:e,index:i,field:t,panel:n,data:m}){this.field=t,this.itemKey=e,this.itemIndex=i,this.panel=n,this.panelName=n.name,this.isDisabled=t.isDisabledProp(e,this.panelName),this.isHidden=this.isDisabled&&t.config.panels[this.panelName].hideDisabled,this.isLocked=t.isLockedProp(e,this.panelName),this.address=`${t.indexName}.${t.id}.${e}`,this.itemSlug=gr(e),this.conditionTypeWrap=new Map,m!==void 0&&this.field.get(this.itemKey)===void 0&&this.field.set(this.itemKey,m);const f=[`field-${this.itemSlug}`,"prop-wrap"];this.isHidden&&f.push("hidden-property"),this.dom=V.create({tag:"li",className:f,children:{className:"component-prop",children:[this.itemInputs(),this.itemControls]}})}get itemValues(){const e=this.field.get(this.itemKey);return e?.constructor===Object?Si(Object.entries(e),gi,"0"):[[this.itemKey,e]]}findOrCreateConditionTypeWrap(e){let i=this.conditionTypeWrap.get(e);return i||(i=V.create({className:`type-conditions-wrap ${e}-conditions-wrap`}),this.conditionTypeWrap.set(e,i),i)}itemInputs(){const e=V.create({className:`${this.panelName}-prop-inputs prop-inputs f-input-group`,children:this.itemValues.map(([i,t])=>this.panelName==="conditions"?this.generateConditionFields(i,t):this.itemInput(i,t))});return this.inputs&&this.inputs.replaceWith(e),this.inputs=e,e}addConditionType=(e,i)=>{const t=this.findOrCreateConditionTypeWrap(e);let n=i;if(!n){const[f]=Gn()[e],g=t.children.length;e==="if"&&(f.logical="||"),n={conditionValues:f,conditionCount:g,index:g}}const m=new Nu({conditionType:e,...n},this);return t.appendChild(m.dom),m};removeConditionType=(e,i)=>{const t=this.conditionTypeWrap.get(e).children[i];t.destroy(),t.dom.remove()};generateConditionFields=(e,i)=>(this.conditions=new Map,i.forEach((t,n)=>{const m=this.addConditionType(e,{index:n,conditionCount:i.length,conditionValues:t});this.conditions.set(n,m)}),this.findOrCreateConditionTypeWrap(e));get itemControls(){if(this.isLocked)return{className:`${this.panelName}-prop-controls prop-controls`,content:[]};const e={tag:"button",attrs:{type:"button",className:"prop-remove prop-control"},action:{click:()=>{me.slideUp(this.dom,333,i=>{this.field.remove(this.itemKey),i.remove(),this.panel.updateProps()})},mouseover:i=>{this.dom.classList.add("to-remove")},mouseout:i=>{this.dom.classList.remove("to-remove")}},content:V.icon("remove")};return{className:`${this.panelName}-prop-controls prop-controls`,content:[e]}}getConfigAttrOptions(e){const i=e.split(".").pop(),t=this.field.config?.attrs?.[i];return Array.isArray(t)?t:null}itemInput(e,i){if(this.isDisabled)return null;let t=V.childType(i)||"string",n=i;if(this.panelName==="attrs"){const s=this.getConfigAttrOptions(e);s&&(n=s.map(r=>({...r,selected:r.value===i})),t="array")}const m=Fu.get(this.panelName)?.({itemKey:this.itemKey,key:e})||this.itemKey,f=m.split(".").filter(Number.isNaN).join(".")||e,g=xt[t]({key:e,value:n}),u=`${this.field.shortId}-${gr(m).replaceAll(/-\d+-(selected)/g,"-$1")}`,o={label:this.panelName!=="options"&&ze(f),labelAfter:!1,inputWrap:["f-input-wrap",this.isLocked&&"locked-prop",this.isDisabled&&"disabled-prop"].filter(Boolean).join(" ")},h={name:g.attrs.type==="checkbox"?`${u}[]`:u};h.disabled=this.isDisabled,h.readonly=this.isLocked;const d=zu.get(this.itemSlug)?.(this),c=tc(ku[t](m,this.field),d||{}),l=De(xt[t]({key:e,value:n}),{action:c,attrs:h,config:o});return gi.includes(e)?{className:"f-addon",children:l}:l}},Pu={multiple:(e,i)=>{ls(!!e,i)}},Hu=[{label:ze("config.label"),value:"label"},{label:ze("config.hideLabel"),value:"hideLabel"},{label:ze("config.helpText"),value:"helpText"},{label:ze("config.labelAfter"),value:"labelAfter"},{label:ze("config.disableHtmlLabel"),value:"disableHtmlLabel"},{label:ze("config.tooltip"),value:"tooltip"}],Wu={label:"New Field",hideLabel:!1,helpText:"",labelAfter:!1,disableHtmlLabel:!1,tooltip:""},Bu=class{constructor(e,i,t){this.type=V.childType(e),this.name=i,this.component=t,this.panelConfig=this.getPanelConfig(this.data)}get data(){const e=this.component.get(this.name);return this.type==="object"?Object.entries(e):e}getPanelConfig(e){return this.props=this.createProps(e),this.editButtons=this.createEditButtons(),{config:{label:Z.get(`panel.label.${this.name}`)},attrs:{className:`${mo} ${this.name}-panel`},children:[this.props,this.editButtons]}}createProps(e=this.data){this.editPanelItems=Array.from(e).map((t,n)=>{const m=this.type==="array",f=t[0],g=m?`[${n}]`:`.${t[0]}`,u=m?t:{[t[0]]:t[1]},o=`${this.name}${g}`,h=this.component.isDisabledProp(o,this.name),d=Nl.get(this.name)?.has(f)??!0;return h||!d?null:new Rt({key:o,data:u,field:this.component,index:n,panel:this})}).filter(Boolean);const i={tag:"ul",attrs:{className:["edit-group",`${this.component.name}-edit-group`,`${this.component.name}-edit-${this.name}`]},editGroup:this.name,isSortable:this.name==="options",content:this.editPanelItems};return V.create(i)}updateProps(){const e=this.createProps();this.props.replaceWith(e),this.props=e}createEditButtons(){const e=this.name,i={attrs:this.addAttribute,options:this.addOption,conditions:this.addCondition,config:this.addConfiguration},t=[];if(e==="conditions"){Z.current&&!Z.current.clearAll&&Z.put("clearAll","Clear All");const f={...V.btnTemplate({content:[V.icon("bin"),Z.get("clearAll")],title:Z.get("clearAll")}),className:`clear-all-${e}`,action:{click:()=>{this.clearAllItems()}}};t.push(f)}const n=Z.get(`panelEditButtons.${e}`)||`+ Add ${je(e)}`,m={...V.btnTemplate({content:n,title:n}),className:`add-${e}`,action:{click:f=>{const g={btnCoords:V.coords(f.target),addAction:i[e]};e==="attrs"&&(g.isDisabled=this.component.isDisabledProp,g.isLocked=this.component.isLockedProp,g.message={attr:Z.get(`action.add.${e}.attr`),value:Z.get(`action.add.${e}.value`)});const u=je(e),o=new globalThis.CustomEvent(`onAdd${u}`,{detail:g});ge.add[e](g),document.dispatchEvent(o)}}};return t.push(m),{className:"panel-action-buttons",content:t}}addAttribute=(e,i)=>{let t=i;const n=Yo(e),m=`attrs.${n}`;Z.current[m]||Z.put(m,Zo(e)),typeof t=="string"&&["true","false"].includes(t)&&(t=JSON.parse(t)),this.component.set(`attrs.${e}`,t),Pu[n]?.(t,this.component);const f=this.props.querySelector(`.${this.component.name}-attrs-${n}`),g=new Rt({key:m,data:{[n]:t},field:this.component,panel:this});f?f.replaceWith(g.dom):this.props.appendChild(g.dom),this.component.resizePanelWrap()};addOption=()=>{const e=this.component.data.config.controlId,i=this.component.get("options"),t=e==="select"?"option":e,n=Z.get("newOptionLabel",{type:t})||"New Option",m=`${this.name}[${this.data.length}]`,f=i[i.length-1],g={...i.length?f:{},label:n};e!=="button"&&(g.value=Lo(n));const u=new Rt({key:m,data:g,field:this.component,index:this.props.children.length,panel:this});this.editPanelItems.push(u),this.props.appendChild(u.dom),this.component.debouncedUpdatePreview(),this.component.resizePanelWrap()};addCondition=e=>{const i=`conditions[${this.component.get("conditions").length}]`,t=new Rt({key:i,data:e.template,field:this.component,panel:this});this.props.appendChild(t.dom),this.component.set(i,e.template),this.component.resizePanelWrap()};addConfiguration=()=>{const e=this.component.get("config");new Mu({className:"config-item-dialog",content:[{tag:"select",config:{label:Z.get("selectConfigKey")||"Select Configuration Key"},attrs:{name:"selectConfigKey",required:!0,className:"config-key-select"},options:Hu.filter(i=>!(i.value in e))}],onConfirm:i=>{const t=i.get("selectConfigKey").trim(),n=`config.${t}`;if(t){const m=new Rt({key:n,data:Wu[t],field:this.component,panel:this});this.editPanelItems.push(m),this.props.appendChild(m.dom),this.component.debouncedUpdatePreview(),this.component.resizePanelWrap()}}}).open()};clearAllItems=()=>{const e=this.type==="array"?[]:{},i={type:this.name,removeAction:()=>{this.component.set(this.name,e),this.updateProps()}};ge.remove[this.name](i);const t=je(this.name),n=new globalThis.CustomEvent(`onRemove${t}`,{detail:i});document.dispatchEvent(n)};setData(e){this.data=e,this.component.set(this.name,e),this.updateProps()}},_r=Object.freeze({type:"field",displayType:"slider"}),Jt=e=>({transform:`translateX(${e?`${e}px`:0})`}),cs=class{constructor(e){this.opts=De(_r,e),this.panelDisplay=this.opts.displayType,this.activePanelIndex=0,this.panelNav=this.createPanelNav();const i=this.createPanelsWrap();this.nav=this.navActions(),this.nav.groupChange(this.activePanelIndex);const t=new window.ResizeObserver(([{contentRect:{width:m}}])=>{this.currentWidth!==m&&(this.toggleTabbedLayout(),this.currentWidth=m,this.nav.setTranslateX(this.activePanelIndex,!1))}),n=window.setTimeout(()=>{t.observe(i),window.clearTimeout(n)},zn)}getPanelDisplay(){const e=this.panelsWrap,i=Number.parseInt(V.getStyle(e,"width"),10)>390?"tabbed":"slider",t=this.opts.displayType==="auto";return this.panelDisplay=t?i:this.opts.displayType||_r.displayType,this.panelDisplay}toggleTabbedLayout=()=>{this.getPanelDisplay();const e=this.isTabbed;return this.panelsWrap.parentElement?.classList.toggle("tabbed-panels",e),e&&this.panelNav.removeAttribute("style"),e};resizePanels=()=>{this.toggleTabbedLayout()};createPanelsWrap(){const e=V.create({className:"panels",content:this.opts.panels.map(({config:i,...t})=>t)});return this.opts.type==="field"&&this.sortableProperties(e),this.panelsWrap=e,this.panels=e.children,this.currentPanel=this.panels[this.activePanelIndex],e}sortableProperties(e){const i=e.getElementsByClassName("field-edit-group");return Ae.forEach(i,t=>{t.fieldId=this.opts.id,t.isSortable&&J.create(t,{animation:150,group:{name:`edit-${t.editGroup}`,pull:!0,put:["properties"]},sort:!0,handle:".prop-order",onSort:n=>{this.propertySave(n.to),this.resizePanels()}})})}createPanelNavLabels(){const e=this.opts.panels.map(n=>({tag:"h5",action:{click:m=>{const f=Je(m.target);this.nav.setTranslateX(f,!1),this.nav.groupChange(f)}},content:n.config.label})),i={className:"panel-labels",content:{content:e}},[t]=e;return t.className="active-tab",V.create(i)}createPanelNav(){this.labels=this.createPanelNavLabels();const e={tag:"button",attrs:{className:"next-group",title:Z.get("controlGroups.nextGroup"),type:"button"},action:{click:t=>this.nav.nextGroup(t)},content:V.icon("triangle-right")},i={tag:"button",attrs:{className:"prev-group",title:Z.get("controlGroups.prevGroup"),type:"button"},action:{click:t=>this.nav.prevGroup(t)},content:V.icon("triangle-left")};return V.create({tag:"nav",attrs:{className:"panel-nav"},content:[i,this.labels,e]})}get isTabbed(){return this.panelDisplay==="tabbed"}navActions(){const e={},i=this.currentPanel.parentElement,t=this.labels.firstChild,n=t.children,m=this.currentPanel.parentElement.childNodes;this.activePanelIndex=Je(this.currentPanel);let f={nav:0,panel:0},g={...f};e.groupChange=h=>(this.activePanelIndex=h,this.currentPanel=m[h],V.removeClasses(m,"active-panel"),V.removeClasses(n,"active-tab"),this.currentPanel.classList.add("active-panel"),n[h].classList.add("active-tab"),this.currentPanel);const u=h=>({nav:-t.offsetWidth*h,panel:-i.offsetWidth*h}),o=({offset:h,reset:d,duration:c=at,animate:l=!this.isTabbed})=>{const s=[Jt(g.panel),Jt(h.panel)],r=[Jt(g.nav),Jt(this.isTabbed?0:h.nav)];if(d){const[y]=s,[k]=r;s.push(y),r.push(k)}const a={easing:"ease-in-out",duration:l?c:0,fill:"forwards"},p=i.animate(s,a);t.animate(r,a);const v=()=>{p.removeEventListener("finish",v),d||(g=h)};p.addEventListener("finish",v)};return e.setTranslateX=(h=this.activePanelIndex,d=!0)=>{f=u(h),o({offset:f,animate:d})},e.refresh=(h=this.activePanelIndex)=>{this.activePanelIndex!==h&&e.groupChange(h),e.setTranslateX(this.activePanelIndex,!1),this.resizePanels()},e.nextGroup=()=>{const h=this.activePanelIndex+1;if(h!==m.length){const d=m[h];f={nav:-t.offsetWidth*h,panel:-d.offsetLeft},o({offset:f}),e.groupChange(h)}else f={nav:g.nav-8,panel:g.panel-8},o({offset:f,reset:!0});return this.currentPanel},e.prevGroup=()=>{if(this.activePanelIndex!==0){const h=this.activePanelIndex-1,d=m[h];f={nav:-t.offsetWidth*h,panel:-d.offsetLeft},o({offset:f}),e.groupChange(h)}else f={nav:8,panel:8},o({offset:f,reset:!0})},e}},ju="modulepreload",Vu=function(e){return"/formeo/"+e},Or={},vt=function(i,t,n){let m=Promise.resolve();if(t&&t.length>0){let h=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(l=>({status:"fulfilled",value:l}),l=>({status:"rejected",reason:l}))))};const g=document.getElementsByTagName("link"),u=document.querySelector("meta[property=csp-nonce]"),o=u?.nonce||u?.getAttribute("nonce");m=h(t.map(d=>{if(d=Vu(d,n),d in Or)return;Or[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(n)for(let r=g.length-1;r>=0;r--){const a=g[r];if(a.href===d&&(!c||a.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${d}"]${l}`))return;const s=document.createElement("link");if(s.rel=c?"stylesheet":ju,c||(s.as="script"),s.crossOrigin="",s.href=d,o&&s.setAttribute("nonce",o),document.head.appendChild(s),c)return new Promise((r,a)=>{s.addEventListener("load",r),s.addEventListener("error",()=>a(new Error(`Unable to preload CSS for ${d}`)))})}))}function f(g){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=g,window.dispatchEvent(u),!u.defaultPrevented)throw g}return m.then(g=>{for(const u of g||[])u.status==="rejected"&&f(u.reason);return i().catch(f)})},nn=null,rn=ri(ni),Fi=class extends qn{constructor(e,i={}){const t={...i,id:i.id||Te()};super(e,t),this.id=t.id,this.shortId=this.id.slice(0,this.id.indexOf("-")),this.name=e,this.indexName=`${e}s`,this.config={...t.config,...oe[`${this.name}s`].config},this.address=`${this.name}s.${this.id}`,this.dataPath=`${this.address}.`,this.editPanels=new Map,this.eventListeners=new Map,this.initEventHandlers()}initEventHandlers(){this.config.events&&Object.entries(this.config.events).forEach(([e,i])=>{this.addEventListener(e,i)})}addEventListener(e,i){this.eventListeners.has(e)||this.eventListeners.set(e,[]),this.eventListeners.get(e).push(i)}removeEventListener(e,i){if(!this.eventListeners?.has(e))return;const t=this.eventListeners.get(e),n=t.indexOf(i);n>-1&&t.splice(n,1)}dispatchComponentEvent(e,i={}){const t={component:this,target:this,type:e,timestamp:Date.now(),...i};return this.eventListeners?.has(e)&&this.eventListeners.get(e).forEach(n=>{try{typeof n=="function"&&n(t)}catch(m){console.error(`Error in ${e} event handler for ${this.name} ${this.id}:`,m)}}),t}set(e,i){const t=this.get(e),n=super.set(e,i);return t!==i&&this.dom&&this.dispatchComponentEvent("onUpdate",{path:e,oldValue:t,newValue:i}),n}get js(){return this.data}get json(){return this.data}remove=e=>{if(e){const m=lt(e),f=m.pop(),g=this.get(m);return Array.isArray(g)?qo(f)?g.splice(Number(f),1):this.set(m,g.filter(u=>u!==f)):delete g[f],g}if(this.name==="stage")return null;const i=this.parent,t=this.children;this.dispatchComponentEvent("onRemove",{path:e,parent:i,children:[...t]}),Ni(t,m=>m.remove()),this.dom.remove(),al(oe.getAddress(`${i.name}s.${i.id}.children`),this.id),i.children.length||i.emptyClass(),i.name==="row"&&i.autoColumnWidths();const n={row:jn,column:Vn,field:Un}[this.name];return n&&Q.formeoUpdated({componentId:this.id,componentType:this.name,parent:i},n),oe[`${this.name}s`].delete(this.id)};empty(){const e=this.children.map(i=>(i.remove(),i));return this.dom.classList.add("empty"),e}emptyClass=()=>this.dom.classList.toggle("empty",!this.children.length);getActionButtons(){const e=[`hovering-${this.name}`,"hovering"];return{className:[`${this.name}-actions`,"group-actions"],action:{mouseenter:()=>{oe.stages.active.dom.classList.add(`active-hover-${this.name}`),this.dom.classList.add(...e)},mouseleave:({target:i})=>{this.dom.classList.remove(...e),oe.stages.active.dom.classList.remove(`active-hover-${this.name}`),i.removeAttribute("style")}},children:[{...V.btnTemplate({content:V.icon(`handle-${this.name}`)}),className:["component-handle",`${this.name}-handle`]},{className:["action-btn-wrap",`${this.name}-action-btn-wrap`],children:this.buttons}]}}getComponentTag=()=>V.create({tag:"span",className:["component-tag",`${this.name}-tag`],children:[V.icon(`handle-${this.name}`),je(this.name)].filter(Boolean)});toggleEdit(e=!this.isEditing){this.isEditing=e;const i=this.dom,t="editing",n=`${t}-${this.name}`,m=this.dom.querySelector(`.${this.name}-edit`);me.slideToggle(m,333,e),this.name==="field"&&(me.slideToggle(this.preview,333,!e),i.parentElement.classList.toggle(`column-${n}`,e)),i.classList.toggle(t,e),i.classList.toggle(n,e)}get buttons(){if(this.actionButtons)return this.actionButtons;const e={handle:(m=`handle-${this.name}`)=>({...V.btnTemplate({content:V.icon(m)}),className:["component-handle"]}),move:(m="move")=>({...V.btnTemplate({content:V.icon(m)}),className:["item-move"],meta:{id:"move"}}),edit:(m="edit")=>({...V.btnTemplate({content:V.icon(m)}),className:["edit-toggle"],meta:{id:"edit"},action:{click:()=>{this.toggleEdit()}}}),remove:(m="remove")=>({...V.btnTemplate({content:V.icon(m)}),className:["item-remove"],meta:{id:"remove"},action:{click:()=>{me.slideUp(this.dom,333,()=>{this.name==="column"?(this.parent.autoColumnWidths(),this.remove()):this.remove()})}}}),clone:(m="copy")=>({...V.btnTemplate({content:V.icon(m)}),className:["item-clone"],meta:{id:"clone"},action:{click:()=>{this.clone(this.parent),this.name==="column"&&this.parent.autoColumnWidths()}}})},{buttons:i,disabled:t}=this.config.actionButtons,n=i.filter(m=>!t.includes(m)).map(m=>e[m]?.()||m);return this.actionButtons=n,this.actionButtons}get index(){return Je(this.dom)}removeClasses=e=>{const i={string:()=>this.dom.classList.remove(e),array:()=>e.map(t=>this.dom.classList.remove(t))};return i.object=i.string,i[V.childType(e)](this.dom)};get parentType(){return El.get(this.name)}get parent(){const e=this.parentType;if(!this.dom||!e)return null;const i=this.dom.closest(`.${Nn[e]}`);return i&&V.asComponent(i)}get children(){if(!this.dom)return[];const e=this.domChildren,i=dr.get(this.name);return Jn(e,t=>oe.getAddress(`${i}s.${t.id}`)).filter(Boolean)}loadChildren=(e=this.data.children)=>e.map(i=>this.addChild({id:i}));get domChildren(){const e=this.dom.querySelector(".children");return e?e.children:[]}addChild(e={},i=this.domChildren.length){let t=e;typeof e!="object"&&(t={id:t});const n=this.dom.querySelector(".children"),{id:m=Te()}=t,f=dr.get(this.name);if(!f)return null;const g=`${f}s`,u=oe.getAddress(`${g}.${m}`)||oe[g].add(m,t);i>=n.children.length?n.appendChild(u.dom):n.children[i].before(u.dom),this.dispatchComponentEvent("onAddChild",{parent:this,target:u,child:u,index:i}),u.dispatchComponentEvent("onAdd",{parent:this,target:u,index:i,addedVia:"addChild"}),this.config.events?.onAddChild?.({parent:this,child:u});const o=u.get("children");return o?.length&&u.loadChildren(o),this.removeClasses("empty"),this.saveChildOrder(),u}saveChildOrder=()=>{if(this.render)return;const e=this.children.map(({id:i})=>i);return this.set("children",e),e};onAdd({from:e,to:i,item:t,newIndex:n}){e.classList.contains("control-group")||(e=e.parentElement);const m=be(e),f=be(i.parentElement),g=()=>{this.saveChildOrder(),this.removeClasses("empty")},u=new Map([[-2,()=>{const h=this.addChild({},n).addChild();return h.addChild.bind(h)}],[-1,()=>{const h=this.addChild({},n);return h.addChild.bind(h)}],[0,()=>this.addChild.bind(this)],[1,h=>{const d=Je(this.dom);return()=>this.parent.addChild(h,d+1)}],[2,h=>()=>this.parent.parent.addChild(h)]]),o={controls:async()=>{if(!nn){const{default:p}=await vt(async()=>{const{default:v}=await Promise.resolve().then(()=>sd);return{default:v}},void 0);nn=p}const{controlData:{meta:{id:h},...d}}=nn.get(t.id);Oi(d,"config.controlId",h);const c=h.startsWith("layout-"),l=c?h.replace(/^layout-/,""):"field",s=c?{}:d,r=we({stage:{row:0,column:-1,field:-2},row:{row:1,column:0,field:-1},column:{row:2,column:1,field:0},field:1},`${this.name}.${l}`),a=u.get(r)();return V.remove(t),a(s,n)},row:()=>(u.get({stage:-1,row:0,column:1}[f])||dn)()?.({id:t.id},n),column:()=>(u.get({stage:-2,row:-1}[f])||dn)()?.(t.id)}[m]?.(t,n);return this.dispatchComponentEvent("onAdd",{from:e,to:i,item:t,newIndex:n,fromType:m,toType:f,addedComponent:o,addedVia:"dragDrop"}),g(),o}onSort=()=>this.saveChildOrder();onRemove({from:{parentElement:e}}){return e.classList.contains(Ge)&&e.classList.remove("column-editing-field"),this.name!=="stage"&&!this.children.length?this.remove():(this.emptyClass(),this.saveChildOrder())}onEnd=({to:{parentElement:e},from:{parentElement:i}})=>{e?.classList.remove(`hovering-${be(e)}`),i?.classList.remove(`hovering-${be(i)}`)};onRender(){this.dispatchComponentEvent("onRender",{dom:this.dom});const{events:e}=this.config;if(!e)return null;e.onRender&&V.onRender(this.dom,e.onRender)}set config(e){const i=we(e,"all"),t=we(this.data,"config.controlId"),n=[i,t&&we(e,t),we(e,this.id)].reduce((m,f)=>f?De(m,f):m,this.configVal);this.configVal=n}get config(){return this.configVal}runConditions=()=>{const e=this.get("conditions");return e?.length?e.map(i=>{const t=this.processConditions(i.if),n=this.processResults(i.then);return t.map(m=>this.evaluateConditions(m)&&this.execResults(n))}):null};getComponent(e){const[i,t]=e.split("."),n=oe[i];return t===this.id?this:n?.get(t)}value=(e,i)=>{const t=e.split("."),n=this.getComponent(e),m=n&&t.slice(2,t.length).join(".");return[!n,!m,!rn[m]].some(Boolean)?e:i?n.set(rn[m],i):n.get(rn[m])};getResult=e=>({"=":(i,t,n)=>i.set(t,n)})[e];processResults=e=>e.map(({operator:i,target:t,value:n})=>{const m=this.getComponent(t);return{target:m,propertyPath:m&&t.split(".").slice(2,t.length).join("."),action:this.getResult(i),value:this.value(n)}});execResults=e=>{const i=e.map(t=>this.execResult(t));return Promise.all(i)};execResult=({target:e,action:i,value:t,_propertyPath:n})=>new Promise((m,f)=>{try{return m(i(e,t))}catch(g){return f(g)}});cloneData=()=>{const e={...He(this.data),id:Te()};return this.name!=="field"&&(e.children=[]),e};clone=(e=this.parent)=>{const i=e.addChild(this.cloneData(),this.index+1);return this.name!=="field"&&this.cloneChildren(i),this.dispatchComponentEvent("onClone",{original:this,clone:i,parent:e}),i};cloneChildren(e){for(const i of this.children)i?.clone(e)}createChildWrap=e=>V.create({tag:"ul",attrs:{className:"children"},children:e});get isRow(){return this.name===Hi.row}get isColumn(){return this.name===Hi.column}get isField(){return this.name===Hi.field}isDisabledProp=(e,i="attrs")=>{if(we(this.config,e))return!1;if((this.config?.disabled||[]).includes(e))return!0;const t=mi(e);return(this.config?.panels[i]?.disabled||[]).includes(t)};isLockedProp=(e,i="attrs")=>{if((this.config?.locked||[]).includes(e))return!0;const t=mi(e);return!!(this.config?.panels[i]?.locked||[]).includes(t)};get editWindow(){const e={className:["component-edit",`${this.name}-edit`,"slide-toggle","formeo-panels-wrap"]},i=this.editPanels.size;return i&&(e.className.push(`panel-count-${i}`),e.content=[this.panels.panelNav,this.panels.panelsWrap],this.panelNav=this.panels.nav,this.resizePanelWrap=this.panels.nav.refresh),e.action={onRender:()=>{if(i===0){const t=this.dom.querySelector(".edit-toggle"),n=this.dom.querySelector(`.${this.name}-actions`),m=n.getElementsByTagName("button");n.style.maxWidth=`${m.length*m[0].clientWidth}px`,V.remove(t)}else this.resizePanelWrap()}},V.create(e)}updateEditPanels=()=>{if(!this.config)return null;const e=new Set(["object","array"]),i=st([...this.config.panels.order,...Object.keys(this.data)]),t=new Set(["children","meta","action","events",...this.config.panels.disabled]),n=i.filter(f=>!t.has(f));for(const f of n){const g=this.get(f),u=V.childType(g);if(e.has(u)){const o=new Bu(g,f,this);this.editPanels.set(o.name,o)}}const m={panels:Array.from(this.editPanels.values()).map(({panelConfig:f})=>f),id:this.id,displayType:"auto"};this.panels=new cs(m),this.dom&&(this.dom.querySelector(".panel-nav").replaceWith(this.panels.panelNav),this.dom.querySelector(".panels").replaceWith(this.panels.panelsWrap))}},Uu=class{constructor(){this.onMove=this.onMove.bind(this),this.onStop=this.onStop.bind(this),this.cleanup=this.cleanup.bind(this)}getRowWidth(e){const i=e.querySelector(".children");if(!i)return 0;const t=i.children.length,n=V.getStyle(i,"gap")||"0px",m=parseFloat(n,10)||0;return this.totalGapWidth=m*(t-1),i.offsetWidth-this.totalGapWidth}validateResizeTarget(e,i){return e&&i&&e.offsetWidth&&i.offsetWidth}onStart(e){if(e.preventDefault(),this.resized=!1,e.button!==0)return;const i=e.target.parentElement,t=i.nextSibling||i.previousSibling,n=i.closest(`.${Ue}`);if(!this.validateResizeTarget(i,t)){console.warn("Invalid resize targets"),this.cleanup();return}if(this.startX=e.type==="touchstart"?e.touches[0].clientX:e.clientX,n.classList.add(Pi),this.columnPreset=n.querySelector(`.${vo}`),this.originalColumnClass=i.className,this.originalSiblingClass=t.className,i.className=i.className.replace(fn,""),t.className=t.className.replace(fn,""),this.colStartWidth=i.offsetWidth,this.sibStartWidth=t.offsetWidth,this.rowWidth=this.getRowWidth(n),this.rowWidth<=0){console.warn("Invalid row width calculated"),this.cleanup();return}this.column=i,this.sibling=t,this.row=n;try{window.addEventListener("pointermove",this.onMove,!1),window.addEventListener("pointerup",this.onStop,!1)}catch(m){console.error("Failed to initialize resize listeners:",m),this.cleanup()}}calculateNewWidths(e){const i=this.colStartWidth+e-this.startX,t=this.sibStartWidth-e+this.startX,n=parseFloat(zi(i,this.rowWidth)),m=parseFloat(zi(t,this.rowWidth));return n<10||m<10?null:{colWidth:un(n.toFixed(1)),siblingColWidth:un(m.toFixed(1))}}onMove(e){e.preventDefault();const{column:i,sibling:t}=this,n=e.type==="touchmove"?e.touches[0].clientX:e.clientX,m=this.calculateNewWidths(n);if(!m)return;const{colWidth:f,siblingColWidth:g}=m;i.dataset.colWidth=f,t.dataset.colWidth=g,i.style.width=f,t.style.width=g,this.resized=!0}onStop(){const{column:e,sibling:i}=this;window.removeEventListener("pointermove",this.onMove),window.removeEventListener("pointerup",this.onStop),this.resized&&(this.setCustomWidthValue(),oe.setAddress(`columns.${e.id}.config.width`,e.dataset.colWidth),oe.setAddress(`columns.${i.id}.config.width`,i.dataset.colWidth),this.row.classList.remove(Pi),this.resized=!1,this.cleanup())}cleanup(){this.column&&this.originalColumnClass&&(this.column.className=this.originalColumnClass),this.sibling&&this.originalSiblingClass&&(this.sibling.className=this.originalSiblingClass),this.row&&this.row.classList.remove(Pi),window.removeEventListener("pointermove",this.onMove),window.removeEventListener("pointerup",this.onStop)}setCustomWidthValue(){const e=this.columnPreset;let i=e.querySelector(`.${pn}`);const t=this.row.querySelector(".children").children,n=Jn(t,g=>zi(g.clientWidth,this.rowWidth).toFixed(1)),m=n.join(","),f=n.join(" | ");return i||(i=V.create({tag:"option",attrs:{className:pn,value:m,selected:!0},content:f}),e.append(i)),i.value=m,i.textContent=f,m}},Gu=()=>Object.freeze({config:{width:"100%"},children:[],className:[Ge]}),Ir={resizeHandle:e=>({className:"resize-x-handle",action:{pointerdown:e.onStart.bind(e)},content:[V.icon("triangle-down"),V.icon("triangle-up")]}),editWindow:()=>({className:"column-edit group-config"})},Ku=class extends Fi{constructor(e){super("column",{...Gu(),...e});const i=this.createChildWrap();this.dom=V.create({tag:"li",className:[Ge,"empty"],dataset:{hoverTag:Z.get("column")},id:this.id,content:[this.getComponentTag(),this.getActionButtons(),Ir.editWindow(),Ir.resizeHandle(new Uu),i]}),this.processConfig(),Q.columnResized=new window.CustomEvent("columnResized",{detail:{column:this.dom,instance:this}}),J.create(i,{animation:150,fallbackClass:"field-moving",forceFallback:!0,group:{name:"column",pull:!0,put:["column","controls"]},sort:!0,disabled:!1,onEnd:this.onEnd.bind(this),onAdd:this.onAdd.bind(this),onSort:this.onSort.bind(this),onRemove:this.onRemove.bind(this),onMove:t=>{t.from!==t.to&&t.from.classList.remove("hovering-column")},draggable:`.${Tt}`,handle:".item-move"})}processConfig(){const e=Ae.get(this.data,"config.width");e&&this.setDomWidth(e)}refreshFieldPanels=()=>{for(const e of this.children)e.panels.nav.refresh()};setDomWidth=e=>{this.dom.dataset.colWidth=e,this.dom.style.width=e};setWidth=e=>(this.setDomWidth(e),this.set("config.width",e))},qu={actionButtons:{buttons:["clone","move","remove"],disabled:[]}},Yu=class extends Ii{constructor(e){super("columns",e),this.config={all:qu}}Component(e){return new Ku(e)}},us=new Yu,Zu=()=>Object.freeze({config:{fieldset:!1,legend:"",inputGroup:!1},children:[],className:[Ue]}),Qu=class extends Fi{constructor(e){super("row",{...Zu(),...e});const i=this.createChildWrap();this.dom=V.create({tag:"li",className:[Ue,"empty"],dataset:{hoverTag:Z.get("row"),editingHoverTag:Z.get("editing.row")},id:this.id,content:[this.getComponentTag(),this.getActionButtons(),this.editWindow,i]}),J.create(i,{animation:150,fallbackClass:"column-moving",forceFallback:!0,group:{name:"row",pull:!0,put:["row","column","controls"]},sort:!0,disabled:!1,onRemove:this.onRemove.bind(this),onEnd:this.onEnd.bind(this),onAdd:this.onAdd.bind(this),onSort:this.onSort.bind(this),draggable:`.${Ge}`,handle:".item-move"})}get editWindow(){const e={tag:"input",id:`${this.id}-fieldset`,attrs:{type:"checkbox",checked:this.get("config.fieldset"),ariaLabel:Z.get("row.settings.fieldsetWrap.aria")},action:{click:({target:{checked:u}})=>{this.set("config.fieldset",!!u)}},config:{label:Z.get("row.settings.fieldsetWrap")}},i={tag:"input",id:`${this.id}-inputGroup`,attrs:{type:"checkbox",checked:this.get("config.inputGroup"),ariaLabel:Z.get("row.settings.inputGroup.aria")},action:{click:({target:{checked:u}})=>this.set("config.inputGroup",u)},config:{label:Z.get("row.makeInputGroup"),description:Z.get("row.makeInputGroupDesc")}},t={className:"input-group",content:{tag:"input",attrs:{type:"text",ariaLabel:"Legend for fieldset",value:this.get("config.legend"),placeholder:"Title"},config:{label:{children:["Row Title",{tag:"span",content:" ⓘ",dataset:{tooltip:"Row title will be used as the legend for the fieldset"}}]}},action:{input:({target:{value:u}})=>this.set("config.legend",u)},className:""}},n=V.formGroup([e,t]),m={tag:"label",content:Z.get("defineColumnWidths"),className:"col-sm-4 form-control-label"};this.columnPresetControl=V.create(this.columnPresetControlConfig);const f={className:"col-sm-8",content:this.columnPresetControl,action:{onRender:()=>{this.updateColumnPreset()}}},g=[i,"hr",n,"hr",V.formGroup([m,f],"row")];return V.create({className:`${this.name}-edit group-config`,action:{onRender:u=>{const o=g.map(h=>V.create(h));u.append(...o)}}})}onAdd(...e){super.onAdd(...e),this.autoColumnWidths()}onRemove(...e){super.onRemove(...e),this.autoColumnWidths()}autoColumnWidths=()=>{const e=this.children;if(!e.length)return;const i=Number.parseFloat((100/e.length).toFixed(1))/1;for(const t of e){t.removeClasses(fn);const n=t.dom,m=un(i);t.set("config.width",m),n.style.width=m,n.dataset.colWidth=m;const f=setTimeout(()=>{clearTimeout(f),t.refreshFieldPanels()},at);document.dispatchEvent(Q.columnResized)}this.updateColumnPreset()};updateColumnPreset=()=>{this.columnPresetControl.innerHTML="";const e=this.getColumnPresetOptions.map(({label:i,...t})=>V.create({tag:"option",content:i,attrs:t}));this.columnPresetControl.append(...e)};setColumnWidths=e=>{typeof e=="string"&&(e=e.split(",")),this.children.forEach((i,t)=>{i.setWidth(`${e[t]}%`),i.refreshFieldPanels()})};get getColumnPresetOptions(){const e=this.children,i=kl.get(e.length-1)||[],t=e.map(n=>{const m=n.get("config.width")||"";return Number(m.replace("%","")).toFixed(1)}).join(",");if(i.length){const n=i.slice();return n.find(m=>m.value===t)||n.push({value:t,label:t.replace(/,/g," | "),className:pn}),n.map(m=>{const f={...m};return f.selected=m.value===t,f})}return[]}get columnPresetControlConfig(){return{tag:"select",attrs:{ariaLabel:Z.get("defineColumnLayout"),className:vo},action:{change:({target:e})=>{const{value:i}=e;this.setColumnWidths(i)}},options:this.getColumnPresetOptions}}},Xu={actionButtons:{buttons:["move","edit","clone","remove"],disabled:[]}},Ju=class extends Ii{constructor(e){super("rows",e),this.config={all:Xu}}Component(e){return new Qu(e)}},ir=new Ju,ed=()=>({conditions:[Gn()],children:[]}),td=class extends Fi{constructor(e){super("stage",{...ed(),...e}),this.updateEditPanels(),this.debouncedUpdateEditPanels=fi(this.updateEditPanels),Z.get("Untitled Form"),Z.get("Untitled Form"),Z.get("Form Title"),Z.get("Form novalidate"),Z.get("Tags");const i=this.createChildWrap();this.dom=V.create({attrs:{className:[kt,"empty"],id:this.id},children:[this.getComponentTag(),this.getActionButtons(),this.editWindow,i]}),J.create(i,{animation:150,fallbackClass:"row-moving",group:{name:"stage",pull:!0,put:["row","column","controls"]},sort:!0,disabled:!1,onAdd:this.onAdd.bind(this),onRemove:this.onRemove.bind(this),onStart:()=>{Bt.active=this},onSort:this.onSort.bind(this),draggable:`.${Ue}`,handle:".item-move"})}empty(e=!0){return new Promise(i=>{e?(this.dom.classList.add("removing-all-fields"),me.slideUp(this.dom,333,()=>{i(super.empty(e)),this.dom.classList.remove("removing-all-fields"),me.slideDown(this.dom,333)})):i(super.empty())})}onAdd(...e){const i=super.onAdd(...e);i?.name==="column"&&i.parent.autoColumnWidths()}},id=()=>({actionButtons:{buttons:["edit"],disabled:[]},panels:{disabled:[],order:["attrs","options","conditions"]}}),nd=class extends Ii{constructor(e){super("stages",e),this.config={all:id()}}Component(e){return new td(e)}},Bt=new nd,rd=class{controlCache=new Set;constructor({events:e={},dependencies:i={},controlAction:t,...n}){this.events=e,this.controlData=n,this.controlAction=t,this.dependencies=i,this.id=n.id||Te()}get controlId(){return this.controlData.meta?.id||this.controlData.config?.controlId}get dom(){const{meta:e,config:i}=this.controlData,t=this.i18n(i.label)||i.label,n={tag:"button",attrs:{type:"button"},content:[{tag:"span",className:"control-icon",children:V.icon(e.icon)},{tag:"span",className:"control-label",content:t}],action:{focus:({target:m})=>{const f=m.closest(`.${ot}`);return f&&ct.panels.nav.refresh(Je(f))},click:({target:m})=>{const f=m.closest(".field-control")?.id;f&&ct.addElement(f)}}};return V.create({tag:"li",id:this.id,className:["field-control",`${e.group}-control`,`${e.id}-control`],content:n,meta:e,action:this.controlAction})}promise(){return Jo(this.dependencies)}i18n(e,i){const t=Z.locale,n=this.definition?.i18n?.[t]||{};return(n[e]?.()??n[e])||Z.get(e,i)}},od=Object.freeze({sortable:!0,elementOrder:{},groupOrder:[],groups:[{id:"layout",label:"controls.groups.layout",elementOrder:["row","column"]},{id:"common",label:"controls.groups.form",elementOrder:["button","checkbox"]},{id:"html",label:"controls.groups.html",elementOrder:["header","block-text"]}],disable:{groups:[],elements:[],formActions:[]},elements:[],container:null,panels:{displayType:"slider"}}),sd=Sn({Controls:()=>ds,default:()=>ct}),ds=class{constructor(){this.data=new Map,this.buttonActions={focus:({target:e})=>{const i=e.closest(`.${ot}`);return i&&this.panels.nav.refresh(Je(i))},click:({target:e})=>{this.addElement(e.parentElement.id)}}}async init(e,i=!1){return await this.applyOptions(e),this.buildDOM(i),this}registerControls(e){return this.controls=[],e.map(i=>{const t=typeof i=="function"?new i:new rd(i);return this.add(t),this.controls.push(t.dom),t.promise()})}groupLabel=e=>Z.get(e)||e||"";groupElements(){let e=this.options.groups.slice(),i=this.controls.slice(),t=[];const n=[];return e=Si(e,this.groupOrder,"id"),e=e.filter(m=>ur(m.id,this.options.disable.groups)),t=e.map(m=>{const f={tag:"ul",attrs:{className:[ot,mo],id:`${m.id}-${ot}`},config:{label:this.groupLabel(m.label)}};if(this.options.elementOrder[m.id]){const g=this.options.elementOrder[m.id];m.elementOrder=st(g.concat(m.elementOrder))}return i=Si(i,m.elementOrder,"meta.id"),f.content=i.filter(g=>{const{controlData:u}=this.get(g.id),o=u.meta.id||"",h=[ur(o,this.options.disable.elements),u.meta.group===m.id,!n.includes(o)];let d=!0;return d=h.every(c=>c===!0),d&&n.push(o),d}),f}),t}add(e=Object.create(null)){const i=He(e);return this.data.set(i.id,i),i.controlData.meta.id&&this.data.set(i.controlData.meta.id,i.controlData),i}get(e){return He(this.data.get(e))}formActions(){if(this.options.disable.formActions===!0)return null;const e={...V.btnTemplate({content:[V.icon("bin"),Z.get("clear")],title:Z.get("clearAll")}),className:["clear-form"],action:{click:t=>{ir.size?(Q.confirmClearAll=new window.CustomEvent("confirmClearAll",{detail:{confirmationMessage:Z.get("confirmClearAll"),clearAllAction:()=>{Bt.clearAll().then(()=>{const n={src:t.target};Q.formeoCleared(n)})},btnCoords:V.coords(t.target)}}),document.dispatchEvent(Q.confirmClearAll)):window.alert(Z.get("cannotClearFields"))}}},i={...V.btnTemplate({content:[V.icon("floppy-disk"),Z.get("save")],title:Z.get("save")}),className:["save-form"],action:{click:async({target:t})=>{const{default:n}=await vt(async()=>{const{default:g}=await Promise.resolve().then(()=>hd);return{default:g}},void 0),{formData:m}=n,f={action:()=>{},coords:V.coords(t),message:"",button:t};return ge.click.btn(f),ge.save.form(m)}}};return{className:"form-actions f-btn-group",content:Object.entries({clearBtn:e,saveBtn:i}).reduce((t,[n,m])=>(this.options.disable.formActions.includes(n)||t.push(m),t),[])}}buildDOM(e){const i=this.groupElements(),t=this.formActions(),{displayType:n}=this.options.panels;this.panels=new cs({panels:i,type:"controls",displayType:n});const m=["control-groups","formeo-panels-wrap",`panel-count-${i.length}`],f=V.create({className:m,content:[this.panels.panelNav,this.panels.panelsWrap]}),g=["formeo-controls"];e&&g.push("formeo-sticky");const u=V.create({className:g,content:[f,t]}),o=u.getElementsByClassName("control-group");this.dom=u,this.groups=o;const[h]=o;this.currentGroup=h,this.actions={filter:d=>{const c=d!=="",l=this.controls;let s=f.querySelector(".filtered-term");if(V.toggleElementsByStr(l,d),c){const r=Z.get("controls.filteringTerm",d);u.classList.add("filtered"),s?s.textContent=r:(s=V.create({tag:"h5",className:"filtered-term",content:r}),f.insertBefore(s,f.firstChild))}else s&&(u.classList.remove("filtered"),s.remove())},addElement:this.addElement,addGroup:d=>console.log(d)};for(let d=o.length-1;d>=0;d--){const c=`formeo-controls-${o[d]}`;this.options.sortable||globalThis.localStorage.removeItem(c),J.create(o[d],{animation:150,fallbackClass:"control-moving",fallbackOnBody:!0,forceFallback:!0,fallbackTolerance:5,group:{name:"controls",pull:"clone",put:!1,revertClone:!0},onClone:({clone:l,item:s})=>{if(l.id=s.id,this.options.ghostPreview){const{controlData:r}=this.get(s.id);vt(async()=>{const{default:a}=await Promise.resolve().then(()=>ad);return{default:a}},void 0).then(({default:a})=>{l.innerHTML="",l.appendChild(new a(r).preview)})}},onStart:()=>{this.originalDocumentOverflow=document.documentElement.style.overflow,document.documentElement.style.overflow="hidden"},onEnd:()=>{document.documentElement.style.overflow=this.originalDocumentOverflow,this.originalDocumentOverflow=null},sort:this.options.sortable,store:{get:()=>{const l=globalThis.localStorage.getItem(c);return l?l.split("|"):[]},set:l=>{const s=l.toArray();globalThis.localStorage.setItem(c,s.join("|"))}}})}return u}layoutTypes={row:()=>Bt.active.addChild(),column:()=>this.layoutTypes.row().addChild(),field:e=>this.layoutTypes.column().addChild(e)};addElement=e=>{const{meta:{group:i,id:t},...n}=we(this.get(e),"controlData");return Oi(n,"config.controlId",t),i==="layout"?this.layoutTypes[t.replace("layout-","")]():this.layoutTypes.field(n)};applyOptions=async(e={})=>{const{container:i,elements:t,groupOrder:n,...m}=De(od,e);this.container=V.resolveContainer(i),this.groupOrder=st(n.concat(["common","html","layout"])),this.options=m;const[f,g,u]=await Promise.all([vt(()=>import("./layout.min.js"),[]),vt(()=>import("./form.min.js"),[]),vt(()=>import("./html.min.js"),[])]),o=[f.default,g.default,u.default].flat();return Promise.all(this.registerControls([...o,...t]))}},ct=new ds,ad=Sn({default:()=>hs}),ld=new Set(["checkbox","radio"]),cd=new Set(["radio","checkbox","select-one","select-multiple"]),hs=class extends Fi{constructor(e=Object.create(null)){super("field",e),this.debouncedUpdateEditPanels=fi(this.updateEditPanels),this.debouncedUpdatePreview=fi(this.updatePreview),this.label=V.create(this.labelConfig),this.preview=this.fieldPreview(),this.controlId=this.get("config.controlId")||this.get("meta.id");const i=this.getActionButtons(),t=this.actionButtons.some(m=>m.meta?.id==="edit");this.updateEditPanels();const n=V.create({tag:"li",attrs:{className:Tt},id:this.id,children:[this.label,this.getComponentTag(),i,t&&this.editWindow,this.preview].filter(Boolean),panelNav:this.panelNav,dataset:{hoverTag:Z.get("field")}});this.dom=n,this.isEditing=!1}get labelConfig(){if(this.get("config.hideLabel"))return null;const{label:e,editorLabel:i,disableHtmlLabel:t,helpText:n,tooltip:m}=this.get("config"),{required:f}=this.get("attrs")||{},g=i||e,u={tag:"label",attrs:{}};return t?(u.tag="input",u.attrs.value=g):(u.attrs.contenteditable=!0,u.children=g),{className:"prev-label",children:[{...u,action:{input:({target:{innerHTML:o,value:h}})=>{const d=t?h:o;super.set("config.label",d);const c=this.dom.querySelector(".config-label");c&&(c.value=d)}}},f&&V.requiredMark(),m&&V.tooltip(m),n&&V.helpText(n)]}}setData=(e,i)=>super.set(e,i);set(e,i){return this.setData(e,i)}updateLabel(){const e=V.create(this.labelConfig);(this.label||!e)&&this.label.remove(),e&&(this.data.config?.labelAfter?this.dom.append(e):this.dom.prepend(e)),this.label=e}updatePreview=()=>{this.updateLabel();const e=this.fieldPreview();this.preview.replaceWith(e),this.preview=e};get defaultPreviewActions(){return{change:e=>{const{target:i}=e,{type:t}=i;if(cd.has(t)){const n=this.preview.querySelectorAll(":checked"),m=this.get("options"),f=m?.[0]?.selected===void 0?"checked":"selected",g=m.reduce((u,o)=>(u[o.value]=o,u[o.value][f]=!1,u),{});for(const u of n)g[u.value][f]=u.value===g[u.value].value;return super.set("options",Object.values(g)),this.debouncedUpdateEditPanels()}},click:e=>{e.target.contentEditable==="true"&&e.preventDefault()},input:({target:e})=>{if(["input","meter","progress","button"].includes(e.tagName.toLowerCase()))return super.set("attrs.value",e.value),this.debouncedUpdateEditPanels();if(e.contentEditable&&!e.type?.startsWith("select-")){const i=e.parentElement.classList;if(i.contains("f-checkbox")||i.contains("f-radio")){const t=e.parentElement,n=Je(t);return this.setData(`options[${n}].label`,e.innerHTML),this.debouncedUpdateEditPanels()}this.setData("content",e.innerHTML||e.value)}}}}fieldPreview(){const{action:e={},...i}=He(this.data);i.id=`prev-${this.id}`,i.action=Object.entries(e).reduce((n,[m,f])=>(n[m]=f.bind(this),n),{}),this.data?.config.editableContent&&(i.attrs={...i.attrs,contenteditable:!0});const t={attrs:{className:"field-preview",style:this.isEditing&&"display: none;"},content:V.create(i,!0),action:this.defaultPreviewActions};return V.create(t,!0)}get isCheckable(){return ld.has(this.get("config.controlId"))}},ud=()=>({actionButtons:{buttons:["move","edit","clone","remove"],disabled:[]},panels:{disabled:[],attrs:{disabled:["type"],hideDisabled:!0,locked:[]},order:["attrs","options","conditions"]},label:{disableHTML:!1}}),dd=class extends Ii{constructor(e){super("fields",e),this.config={all:ud()}}Component(e){return new hs(e)}get=e=>{let i=e&&we(this.data,e);if(!i){const t=ct.get(e);t&&(i=this.add(null,t.controlData))}return i};getData=()=>Object.entries(this.data).reduce((e,[i,t])=>{const{conditions:n,...m}=t?.getData()||t;if(n?.length){let f=!0;if(n.length===1){const[g]=n;f=!!g.if[0].source}f&&(m.conditions=n)}return e[i]=m,e},{});load=(e=Object.create(null))=>{const i=Li(e);this.empty();for(const[t,n]of Object.entries(i)){const{meta:m,...f}=n;m?.id&&Oi(f,"config.controlId",m?.id),this.add(t,f)}return this.data}},ps=new dd,hd=Sn({Columns:()=>Ht,Components:()=>fs,Controls:()=>Wt,Fields:()=>hi,Rows:()=>di,Stages:()=>ui,default:()=>oe}),ui=Bt,di=ir,Ht=us,hi=ps,Wt=ct,pd=(e,i=!1)=>{if(e!=null){const t=Li(e);if(t&&typeof t=="object"){const n=He(t);return{id:n.id||wt().id,stages:n.stages||wt().stages,rows:n.rows||{},columns:n.columns||{},fields:n.fields||{}}}console.warn("Formeo: Invalid formData provided, using default")}if(i){const t=Rn.get(Fn);if(t)return t}return wt()},fs=class extends qn{constructor(){super("components"),this.disableEvents=!0,this.stages=ui,this.rows=di,this.columns=Ht,this.fields=hi,this.controls=Wt}load=(e,i)=>{this.empty();const t=pd(e,i.sessionStorage);this.opts=i,this.set("id",t.id),this.add("stages",ui.load(t.stages)),this.add("rows",di.load(t.rows)),this.add("columns",Ht.load(t.columns)),this.add("fields",hi.load(t.fields));for(const n of Object.values(this.get("stages")))n.loadChildren();return this.data};flatList(){const e={};for(const i of Object.keys(this.data.stages))go(this.data,i,"stages",e);return e}getChildData=({type:e,id:i})=>{const t=this.get(e,i);if(t)return t.getData()};get json(){return window.JSON.stringify({$schema:`https://cdn.jsdelivr.net/npm/formeo@${On}/dist/formData_schema.json`,...this.formData})}get formData(){return{id:this.get("id"),stages:Bt.getData(),rows:ir.getData(),columns:us.getData(),fields:ps.getData()}}set config(e){const{stages:i,rows:t,columns:n,fields:m}=e;ui.config=i,di.config=t,Ht.config=n,hi.config=m}getIndex(e){return this[e]||this[ml.get(e)]}setAddress(e,i){if(!Ie(e))return;const[t,n,...m]=Array.isArray(e)?e:lt(e),f=this.getIndex(t).get(n);return f?.set(m,i),f}getAddress(e){if(!Ie(e))return;const[i,t,...n]=Array.isArray(e)?e:lt(e),m=this.getIndex(i).get(t);if(!(n.length&&!m))return n.length?m.get(n):m}},oe=new fs,ei="no-transition",fd={debug:!1,bubbles:!0,formeoLoaded:e=>{},onAdd:()=>{},onRemove:()=>{},onChange:e=>Q.opts?.debug&&console.log(e),onUpdate:e=>Q.opts?.debug&&console.log(e),onUpdateStage:e=>Q.opts?.debug&&console.log(e),onUpdateRow:e=>Q.opts?.debug&&console.log(e),onUpdateColumn:e=>Q.opts?.debug&&console.log(e),onUpdateField:e=>Q.opts?.debug&&console.log(e),onAddRow:e=>Q.opts?.debug&&console.log(e),onAddColumn:e=>Q.opts?.debug&&console.log(e),onAddField:e=>Q.opts?.debug&&console.log(e),onRemoveRow:e=>Q.opts?.debug&&console.log(e),onRemoveColumn:e=>Q.opts?.debug&&console.log(e),onRemoveField:e=>Q.opts?.debug&&console.log(e),onRender:e=>Q.opts?.debug&&console.log(e),onSave:e=>{},confirmClearAll:e=>{globalThis.confirm(e.confirmationMessage)&&e.clearAllAction(e)}},_e=({src:e,...i},t=Pn)=>{const n=new globalThis.CustomEvent(t,{detail:i,bubbles:Q.opts?.debug||Q.opts?.bubbles});if(n.data=(e||document).dispatchEvent(n),t==="formeoUpdated"){const m=new globalThis.CustomEvent(Tl,{detail:i,bubbles:Q.opts?.debug||Q.opts?.bubbles});(e||document).dispatchEvent(m)}return n},Q={init:function(e){return this.opts={...fd,...e},this},formeoSaved:e=>_e(e,Co),formeoUpdated:(e,i)=>_e(e,i||"formeoUpdated"),formeoCleared:e=>_e(e,Ml),formeoOnRender:e=>_e(e,ko),formeoConditionUpdated:e=>_e(e,$l),formeoAddedRow:e=>_e(e,Hn),formeoAddedColumn:e=>_e(e,Wn),formeoAddedField:e=>_e(e,Bn),formeoRemovedRow:e=>_e(e,jn),formeoRemovedColumn:e=>_e(e,Vn),formeoRemovedField:e=>_e(e,Un)},gd=fo(()=>{const e={timeStamp:globalThis.performance.now(),type:Pn,detail:oe.formData};Q.opts.onUpdate(e),Q.opts.onChange!==Q.opts.onUpdate&&Q.opts.onChange(e)},at);document.addEventListener(Pn,gd);document.addEventListener(So,e=>{const{timeStamp:i,type:t,detail:n}=e,m={timeStamp:i,type:t,detail:n};Q.opts.onUpdate(m),Q.opts.onUpdateStage(m)});document.addEventListener(xo,e=>{const{timeStamp:i,type:t,detail:n}=e,m={timeStamp:i,type:t,detail:n};Q.opts.onUpdate(m),Q.opts.onUpdateRow(m)});document.addEventListener(Eo,e=>{const{timeStamp:i,type:t,detail:n}=e,m={timeStamp:i,type:t,detail:n};Q.opts.onUpdate(m),Q.opts.onUpdateColumn(m)});document.addEventListener(Ao,e=>{const{timeStamp:i,type:t,detail:n}=e,m={timeStamp:i,type:t,detail:n};Q.opts.onUpdate(m),Q.opts.onUpdateField(m)});document.addEventListener(Hn,e=>{const{timeStamp:i,type:t,detail:n}=e,m={timeStamp:i,type:t,detail:n};Q.opts.onAdd(m),Q.opts.onAddRow(m)});document.addEventListener(Wn,e=>{const{timeStamp:i,type:t,detail:n}=e,m={timeStamp:i,type:t,detail:n};Q.opts.onAdd(m),Q.opts.onAddColumn(m)});document.addEventListener(Bn,e=>{const{timeStamp:i,type:t,detail:n}=e,m={timeStamp:i,type:t,detail:n};Q.opts.onAdd(m),Q.opts.onAddField(m)});document.addEventListener(jn,e=>{const{timeStamp:i,type:t,detail:n}=e,m={timeStamp:i,type:t,detail:n};Q.opts.onRemove(m),Q.opts.onRemoveRow(m)});document.addEventListener(Vn,e=>{const{timeStamp:i,type:t,detail:n}=e,m={timeStamp:i,type:t,detail:n};Q.opts.onRemove(m),Q.opts.onRemoveColumn(m)});document.addEventListener(Un,e=>{const{timeStamp:i,type:t,detail:n}=e,m={timeStamp:i,type:t,detail:n};Q.opts.onRemove(m),Q.opts.onRemoveField(m)});document.addEventListener(ko,e=>{const{timeStamp:i,type:t,detail:n}=e;Q.opts.onRender({timeStamp:i,type:t,detail:n})});document.addEventListener("confirmClearAll",e=>{e={timeStamp:e.timeStamp,type:e.type,confirmationMessage:e.detail.confirmationMessage,clearAllAction:e.detail.clearAllAction,btnCoords:e.detail.btnCoords},Q.opts.confirmClearAll(e)});document.addEventListener(Co,({timeStamp:e,type:i,detail:{formData:t}})=>{const n={timeStamp:e,type:i,formData:t};Q.opts.onSave(n)});document.addEventListener("formeoLoaded",e=>{Q.opts.formeoLoaded(e.detail.formeo)});var on;function md(){on=on||window.requestAnimationFrame(()=>{on=!1;for(const e of Object.values(Ht.data))e.dom.classList.add(ei),Wt.dom.classList.add(ei),Wt.panels.nav.refresh(),e.refreshFieldPanels(),fo(()=>{e.dom.classList.remove(ei),Wt.dom.classList.remove(ei)},333)})}window.addEventListener("resize",md);var Dr={add:{attr:e=>{const i=globalThis.prompt(e.message.attr);if(i&&e.isDisabled(i))return globalThis.alert(Z.get("attributeNotPermitted",i)),ge.add.attrs(e);let t;i&&(t=String(globalThis.prompt(e.message.value,"")),e.addAction(i,t))},option:e=>{e.addAction()},condition:e=>{e.addAction(e)},config:e=>{e.addAction(e)}},remove:{attrs:e=>{e.removeAction()},options:e=>{e.removeAction()},conditions:e=>{e.removeAction()}},click:{btn:e=>{e.action()}},save:{form:dn}},ge={init:function(e){const i=Object.keys(Dr);return this.opts=i.reduce((t,n)=>(t[n]={...Dr[n],...e[n]},t),e),this},add:{attrs:e=>ge.opts.add.attr(e),options:e=>ge.opts.add.option(e),conditions:e=>(e.template=e.template||Gn(),ge.opts.add.condition(e)),config:e=>ge.opts.add.config(e)},remove:{attrs:e=>ge.opts.remove.attrs(e),options:e=>ge.opts.remove.options(e),conditions:e=>ge.opts.remove.conditions(e)},click:{btn:e=>ge.opts.click.btn(e)},save:{form:e=>(ge.opts.sessionStorage&&Rn.set(Fn,e),Q.formeoSaved({formData:e}),ge.opts.save.form(e))}},vd={get editor(){return{stickyControls:!1,allowEdit:!0,dataType:"json",debug:!1,sessionStorage:!1,editorContainer:null,svgSprite:null,style:hl,iconFont:null,config:{},events:{},actions:{},controls:{container:null},i18n:{location:"https://draggable.github.io/formeo/assets/lang/"},onLoad:()=>{}}}},Se={CREATED:"created",LOADING_RESOURCES:"loading",INITIALIZING:"initializing",READY:"ready",ERROR:"error"},gs=class{#e=Se.CREATED;#i=null;#t=null;#n=!1;constructor({formData:e,...i},t){const{actions:n,events:m,debug:f,config:g,editorContainer:u,...o}=De(vd.editor,i);u&&(this.editorContainer=V.resolveContainer(u)||null),this.opts=o,V.setOptions=o,oe.config=g;const h=t||e;this.#t=h?rt(h):null,this.userFormData=this.#t,this.Components=oe,this.dom=V,Q.init({debug:f,...m}),ge.init({debug:f,sessionStorage:o.sessionStorage,...n}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",this.loadResources.bind(this)):this.loadResources()}get formData(){return this.Components.formData}set formData(e={}){const i=rt(e);this.#t=i,this.userFormData=i,this.load(this.userFormData,this.opts)}loadData(e={}){this.formData=e}get json(){return this.Components.json}clear(){const e=wt();this.#t=e,this.userFormData=e,this.Components.load(this.userFormData,this.opts),this.render()}async loadResources(){document.removeEventListener("DOMContentLoaded",this.loadResources),this.#e=Se.LOADING_RESOURCES;const e=[lu(this.opts.svgSprite),uu(this.opts.style),Z.init({preloaded:{"en-US":ks},...this.opts.i18n,locale:globalThis.sessionStorage?.getItem(hr)})].filter(Boolean);try{await Promise.all(e),this.opts.allowEdit&&this.init()}catch(i){throw this.#e=Se.ERROR,console.error("Failed to load resources:",i),i}}init(){return this.#e===Se.INITIALIZING?this.#i:this.#e===Se.READY?this.#r():(this.#e=Se.INITIALIZING,this.#i=ct.init(this.opts.controls,this.opts.stickyControls).then(e=>(this.controls=e,this.#n||(this.#s(),this.#n=!0),this.formId=oe.get("id"),this.i18n={setLang:this.#o.bind(this)},this.render(),this.#e=Se.READY,this.opts.onLoad?.(this),this.tooltipInstance=new Zr,this)).catch(e=>{throw this.#e=Se.ERROR,console.error("Failed to initialize editor:",e),e}),this.#i)}async#o(e){globalThis.sessionStorage?.setItem(hr,e),await Z.setCurrent(e),await this.#r()}async#r(){return this.controls=await ct.init(this.opts.controls,this.opts.stickyControls),this.render(),this}#s(){const e=this.#a();this.Components.load(e,this.opts)}#a(){if(this.#t)return He(this.#t);if(this.opts.sessionStorage){const e=Rn.get(Fn);if(e)return e}return wt()}load(e=this.userFormData,i=this.opts){this.Components.load(e,i),this.render()}get initState(){return this.#e}get isReady(){return this.#e===Se.READY}async whenReady(){return this.#e===Se.READY?this:this.#e===Se.ERROR?Promise.reject(new Error("Editor initialization failed")):this.#i?this.#i:new Promise((e,i)=>{const t=()=>{this.#e===Se.READY?e(this):this.#e===Se.ERROR?i(new Error("Editor initialization failed")):globalThis.requestAnimationFrame(t)};t()})}render(){if(!this.controls)return globalThis.requestAnimationFrame(()=>this.render());if(this.stages=Object.values(oe.get("stages")),this.opts.controlOnLeft)for(const t of this.stages)t.dom.style.order=1;const e={attrs:{className:"formeo formeo-editor",id:this.formId},content:[this.stages.map(({dom:t})=>t)]};Z.current.dir&&(e.attrs.dir=Z.current.dir,V.dir=Z.current.dir),this.editor=V.create(e);const i=this.controls.container||this.editor;i&&(i!==this.editor&&V.empty(i),i.appendChild(this.controls.dom)),this.editorContainer&&(V.empty(this.editorContainer),this.editorContainer.appendChild(this.editor)),Q.formeoLoaded=new globalThis.CustomEvent("formeoLoaded",{detail:{formeo:this}}),document.dispatchEvent(Q.formeoLoaded)}},Nr=e=>typeof e=="string"?document.querySelector(e):e,yd=({editorContainer:e,renderContainer:i,formData:t,...n})=>{const m={renderContainer:Nr(i),editorContainer:Nr(e),formData:rt(t)};return{elements:{},...n,...m}},ti=e=>e.match(Il)?.[0]||e,Fr=e=>{if(!e||e.hasAttribute("hidden")||e.parentElement?.hasAttribute("hidden"))return!1;const i=window.getComputedStyle(e);return!(i.display==="none"||i.visibility==="hidden"||i.opacity==="0")},bd='input[type="checkbox"], input[type="radio"]',wd=new Set(["checkbox","radio"]),ms=e=>e?.tagName?.toLowerCase(),vs=e=>ms(e)==="input"&&wd.has(e.type),nr=e=>{if(!e||vs(e)||typeof e.querySelectorAll!="function")return null;const i=e.querySelectorAll(bd);return i.length?Array.from(i):null},Cd=e=>!!nr(e),zr=e=>{if(!e)return;const i=nr(e);if(i){const t=i.filter(n=>n.checked).map(n=>n.value);return i.every(n=>n.type==="radio")?t[0]??"":t}return ms(e)==="select"&&e.multiple?Array.from(e.selectedOptions,t=>t.value):vs(e)?e.checked?e.value:"":e.value},Pr=e=>{const i=nr(e);return i?i.some(t=>t.checked):!!e?.checked},Hr={isChecked:e=>Pr(e),isNotChecked:e=>!Pr(e),value:zr,checked:zr,isVisible:e=>Fr(e),isNotVisible:e=>!Fr(e)},Sd=()=>V.btnTemplate({className:"remove-input-group",children:V.icon("remove"),action:{mouseover:({target:e})=>e.parentElement.classList.add("will-remove"),mouseleave:({target:e})=>e.parentElement.classList.remove("will-remove"),click:({target:e})=>e.parentElement.remove()}}),Wr=(e,i)=>Array.isArray(e)?e.some(t=>(0,gn.default)(t,i)):(0,gn.default)(e,i),Br=(e,i)=>e==null?!1:Array.isArray(e)?e.includes(i):String(e).includes(i),jr={equals:Wr,notEquals:(e,i)=>!Wr(e,i),contains:Br,notContains:(e,i)=>!Br(e,i)},xd=Object.entries(To).reduce((e,[i,t])=>(e[t]=jr[i],e[i]=jr[i],e),{}),Vr={equals:(e,{targetProperty:i,value:t})=>{e[`_${i}`]=e[i],e[i]=t}},Ed=Object.entries(Mo).reduce((e,[i,t])=>(e[t]=Vr[i],e[i]=Vr[i],e),{}),Ad={isChecked:e=>{e.checked=!0},isNotChecked:e=>{e.checked=!1},value:(e,{assignment:i,...t})=>{const n=Ed[i]?.(e,t),m=new Event("input",{bubbles:!0});return e.dispatchEvent(m),n},isNotVisible:e=>{e?._required===void 0&&(e._required=e.required),e.parentElement.setAttribute("hidden",!0),e.required=!1},isVisible:e=>{e.parentElement.removeAttribute("hidden"),e.required=e._required}},ys=class{constructor(e,i){const{renderContainer:t,elements:n,formData:m,config:f}=yd(e);this.container=t,this.form=rt(i||m),this.elements=n,this.config=f,this.components=Object.create(null),this.dom=V}get formData(){return this.form}set formData(e){this.form=rt(e)}get userData(){const e=this.container.querySelector(".formeo-render")||this.renderedForm;if(!e)return{};const i=new FormData(e),t={};for(const[n,m]of i.entries())t[n]?Array.isArray(t[n])?t[n].push(m):t[n]=[t[n],m]:t[n]=m;return t}get userFormData(){const e=[];for(const[i,t]of Object.entries(this.userData)){const n={key:i,value:t,label:this.components[ti(i)]?.config?.label||""};e.push(n)}return e}set userData(e={}){const i=this.container.querySelector("form");for(const t of Object.keys(e)){const n=i.elements[t];if(n.length&&n[0].type==="checkbox"){const m=Array.isArray(e[t])?e[t]:[e[t]];for(const f of n)f.checked=m.includes(f.value)}else if(n.length&&n[0].type==="radio")for(const m of n)m.checked=m.value===e[t];else n.type&&(n.value=e[t])}}render(e=this.form){this.form=rt(e);const i=this.getRenderedForm(e),t=this.container.querySelector(".formeo-render");t?t.replaceWith(i):this.container.appendChild(i)}getRenderedForm(e=this.form){this.form=rt(e);const i=document.getElementsByClassName("formeo-render").length,t={...this.config,tag:"form",id:this.form.id,className:`formeo-render formeo formeo-rendered-${i}`,children:this.processedData};return this.renderedForm=V.render(t),this.applyConditions(),this.renderedForm}get html(){return(this.renderedForm||this.getRenderedForm()).outerHTML}orderChildren=(e,i)=>i.reduce((t,n)=>(t.push(this.form[e][n]),t),[]);prefixId=e=>"f-"+e;processColumn=({id:e,...i})=>({...i,id:this.prefixId(e),children:this.processFields(i.children),style:`width: ${i.config.width||"100%"}`});processRows=e=>this.orderChildren("rows",this.form.stages[e].children).reduce((i,t)=>(t&&i.push(this.processRow(t)),i),[]);cacheComponent=e=>(this.components[ti(e.id)]=e,e);processRow=(e,i="row")=>{const{config:t,id:n}=e,m=[`formeo-${i}-wrap`],f={...e,children:this.processColumns(e.id),id:this.prefixId(n)};this.cacheComponent(f);const g=[{condition:t.legend,result:()=>({tag:t.fieldset?"legend":"h3",children:t.legend})},{condition:!0,result:()=>f},{condition:t.inputGroup,result:()=>this.addButton(n)}].reduce((u,{condition:o,result:h})=>(o&&u.push(h()),u),[]);return t.inputGroup&&m.push("f-input-group-wrap"),{tag:t.fieldset?"fieldset":"div",className:m,children:g}};cloneComponentData=e=>{const{children:i=[],id:t,attrs:n={},...m}=this.components[e],f={...n,"data-clone-of":t};return m.tag==="input"&&(f.name=es(this.components[e])),{...m,id:"f-"+Te(t),children:i?.length&&i.map(({id:g})=>this.cloneComponentData(ti(g))),attrs:f}};addButton=e=>({tag:"button",attrs:{className:"add-input-group btn pull-right",type:"button"},children:"Add +",action:{click:i=>{const t=i.target.parentElement,n=V.create(this.cloneComponentData(e));t.insertBefore(n,t.lastChild);const m=V.create(Sd());n.appendChild(m)}}});processColumns=e=>this.orderChildren("columns",this.form.rows[e].children).map(i=>this.cacheComponent(this.processColumn(i)));processFields=e=>this.orderChildren("fields",e).map(({id:i,...t})=>{const n=t.config?.controlId||t.meta?.id,{action:m={},dependencies:f={}}=this.elements[n]||{};f&&Jo(f);const g=De({action:m},t);return this.cacheComponent({...g,id:this.prefixId(i)})});get processedData(){return Object.values(this.form.stages).map(e=>(e.children=this.processRows(e.id),e.className=kt,this.components[ti(e.id)]=e,e))}handleComponentCondition=(e,i,t)=>{if(!e)return;if(Td(e)){for(const f of e)this.handleComponentCondition(f,i,t);return}const n=$d(e);n&&e.addEventListener(n,f=>{if(this.evaluateCondition(i,f))for(const g of t)this.execResult(g,f)},!1);const m={target:e};if(this.evaluateCondition(i,m))for(const f of t)this.execResult(f,m)};applyConditions=()=>{for(const{conditions:e}of Object.values(this.components))if(e)for(const i of e){const{if:t=[],then:n=[]}=i;for(const m of t)try{this.applyCondition(m,n)}catch(f){console.error("formeo: condition skipped",m,f)}}};applyCondition=(e,i)=>{for(const t of[e.source,e.target]){if(!Ie(t))continue;const{component:n,options:m}=this.getComponent(t);this.handleComponentCondition(m||n,e,i)}};evaluateCondition=({source:e,sourceProperty:i,targetProperty:t,comparison:n,target:m})=>{const f=this.getComponentProperty(e,i);if(typeof f=="boolean")return f;const g=String(Ie(m)?this.getComponentProperty(m,t):m);return xd[n]?.(f,g)};execResult=({target:e,targetProperty:i,assignment:t,value:n})=>{if(Ie(e)){const{component:m,option:f}=this.getComponent(e),g=f||m;Ad[i]?.(g,{targetProperty:i,assignment:t,value:n})}};getComponentProperty=(e,i)=>{const{component:t,option:n}=this.getComponent(e)||{},m=n||t;if(m)return Hr[i]?Hr[i](m):m[i]};getComponent=e=>{const i={component:null};if(!Ie(e))return null;const[,t,n,m]=lt(e),f=this.renderedForm.querySelector(`#f-${t}`);if(!f)return i;if(i.component=f,n){const g=f.querySelectorAll("input"),u=g[m];return i.options=g,i.option=u,i}return i};getComponents=e=>{const i=[],t=e.slice(e.indexOf(".")+1);return i.push(...this.renderedForm.querySelectorAll(`[name=f-${t}]`)),i}},kd=e=>!!e&&typeof e.nodeType=="number",Td=e=>!!e&&!kd(e)&&typeof e.length=="number",Ur=e=>e.tagName?.toLowerCase(),Md=[["change",e=>Cd(e)],["change",e=>Ur(e)==="select"||["checkbox","radio"].includes(e.type)],["input",e=>["input","textarea"].includes(Ur(e))]],$d=e=>{const[i]=Md.find(t=>t[1](e))||[!1];return i};window!==void 0&&(window.FormeoEditor=gs,window.FormeoRenderer=ys);var rr=gs,or=ys,Ld={rows:{all:{events:{onAdd:e=>{if(console.log(`You just added a new row with the id "${e.target.id}"`,e.index),e.index===2){const i=e.target.dom.querySelector(".action-btn-wrap"),t=document.createElement("button");t.type="button",t.className="btn btn-sm btn-secondary",t.textContent="Add Column",t.style.border="1px solid #ccc",t.style.width="auto",t.addEventListener("click",()=>{e.target.addChild()}),i.appendChild(t)}}}}},fields:{all:{panels:{attrs:{}},events:{onRemove:e=>{console.log(`You just removed the field with the id "${e.target.id}"`,e)}}},"text-input":{attrs:{type:[{label:"text",value:"text"},{label:"phone",value:"phone"},{label:"email",value:"email"}]},config:{helpText:"This is a custom help text for text input fields.",hideLabel:!1}},checkbox:{actionButtons:{},panels:{attrs:{hideDisabled:!0}}}}},Rd={sortable:!1,groupOrder:["common","html"],disable:{},elements:[{tag:"input",config:{label:"Email",disabledAttrs:["type"],lockedAttrs:["required","className"]},meta:{group:"common",id:"email",icon:"@"},attrs:{className:"custom-email",type:"email",required:!0}}],elementOrder:{common:["button","checkbox","date-input","hidden","upload","number","radio","select","text-input","textarea"]}},_d=".build-form",Od=".render-form",jt={editorContainer:_d,actions:{},controls:Rd,config:Ld,events:{onSave:console.log,onChange:console.log},style:null,sessionStorage:!0,editPanelOrder:["attrs","options"],onLoad:()=>{console.log("demo loaded")}},sr={renderContainer:Od,elements:{tinymce:{action:{onRender:e=>{if(e.id){const i=`#${e.id}`;globalThis.tinymce.remove(i),globalThis.tinymce.init({selector:i})}}}}}};async function Id(e){e.innerHTML=`
  ...
  `;try{await Dd(),await Nd()&&console.log("Highlight.js loaded successfully"),e.innerHTML=`
      <div class="angular-demo">
        <h3>Angular Integration Demo</h3>
...
npm install formeo</code></pre>
          ...
          <div class="guide-section">
            ...
            <pre><code class="language-typescript">${an(Pd)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>3. Service for Formeo Management (Optional)</h4>
            <pre><code class="language-typescript">${an(Hd)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>4. Module Configuration</h4>
            <pre><code class="language-typescript">${an(Wd)}</code></pre>
          </div>
        </div>
    ...
    `;const i=await zd();Gr();const t=e.querySelector("#toggle-instructions"),n=e.querySelector("#instructions-section"),m=t.querySelector(".toggle-text"),f=t.querySelector(".toggle-icon");return t&&n&&t.addEventListener("click",()=>{const g=n.style.display==="block";n.style.display=g?"none":"block",m.textContent=g?"Show Implementation Guide":"Hide Implementation Guide",f.textContent=g?"▼":"▲",g||setTimeout(()=>Gr(),50)}),{angularApp:i,cleanup:()=>{i?.destroy&&i.destroy();const g=document.getElementById("angular-app-root");g&&(g.innerHTML="")}}}catch(i){return console.error("Failed to load Angular demo:",i),e.innerHTML=`
      <div class="angular-demo">
        <h3>Angular Integration Demo</h3>
    ...
    `,{cleanup:()=>{}}}}async function Dd(){await new Promise(e=>setTimeout(e,500)),console.log("Angular-style demo environment ready")}async function Nd(){if(window.hljs)return window.hljs;try{const e=document.createElement("link");return e.rel="stylesheet",e.href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css",document.head.appendChild(e),Fd(),await sn("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"),await sn("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/typescript.min.js"),await sn("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/bash.min.js"),window.hljs}catch(e){return console.warn("Failed to load Highlight.js:",e),null}}function Fd(){const e=document.createElement("style");e.textContent=`
  ...
  `,document.head.appendChild(e)}function sn(e){return new Promise((i,t)=>{const n=document.createElement("script");n.src=e,n.onload=i,n.onerror=t,document.head.appendChild(n)})}function Gr(){window.hljs?document.querySelectorAll("pre code").forEach(e=>{try{window.hljs.highlightElement(e)}catch(i){console.warn("Failed to highlight code block:",i)}}):document.querySelectorAll("pre code").forEach(e=>{e.style.fontFamily="'Monaco', 'Menlo', 'Ubuntu Mono', monospace",e.style.fontSize="14px",e.style.lineHeight="1.5"})}async function zd(){const e=document.getElementById("angular-app-root");if(!e)return null;e.innerHTML=`
  ...
  `;const i=e.querySelector(".angular-form-editor"),t=e.querySelector(".angular-form-renderer");if(i&&t){const n=document.createElement("form");n.className="build-form-angular-real";const m=document.createElement("div");m.className="render-form-angular-real",i.appendChild(n),t.appendChild(m);const f={...jt,editorContainer:".build-form-angular-real",events:{...jt.events,onSave:l=>{console.log("Angular Component - Form saved:",l)},onChange:l=>{console.log("Angular Component - Form changed:",l)}}},g={...sr,renderContainer:".render-form-angular-real"},u=new rr(f),o=new or(g),h=e.querySelector("#angular-save-btn"),d=e.querySelector("#angular-render-btn"),c=e.querySelector("#angular-clear-btn");return h&&h.addEventListener("click",()=>{const l=u.formData;console.log("Angular Component - Save clicked:",l),alert("Form saved! Check console for form data.")}),d&&d.addEventListener("click",()=>{const l=u.formData;l&&Object.keys(l).length>0?(m.style.display="block",o.render(l),console.log("Angular Component - Render clicked:",l)):alert("Please create a form first before rendering")}),c&&c.addEventListener("click",()=>{u&&u.clear(),o&&m&&(m.innerHTML="",m.style.display="none"),console.log("Angular Component - Clear clicked")}),{editor:u,renderer:o,destroy:()=>{u?.destroy&&u.destroy(),o?.destroy&&o.destroy()}}}return null}function an(e){const i=document.createElement("div");return i.textContent=e,i.innerHTML}var Pd=`import { Component, OnInit, OnDestroy, ElementRef, ViewChild, inject } from '@angular/core';
...
}`,Hd=`import { Injectable, signal } from '@angular/core';
import { FormeoEditor, FormeoRenderer } from 'formeo';
...
}`,Wd=`// app.config.ts (for standalone applications)
...
bootstrapApplication(AppComponent, appConfig)
  .catch(err => console.error(err));`;async function Bd(e){e.innerHTML=`
  ...
  `;try{await jd(),await Vd()&&console.log("Highlight.js loaded successfully for React demo"),e.innerHTML=`
      <div class="react-demo">
        <h3>React Integration Demo</h3>
        <div class="demo-description">
...
npm install --save-dev @types/react @types/react-dom typescript</code></pre>
          ...
          <div class="guide-section">
            ...
            <pre><code class="language-typescript">${cn(Kd)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>3. React Component Implementation</h4>
            <pre><code class="language-typescript">${cn(qd)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>4. Context Provider (Advanced)</h4>
            <pre><code class="language-typescript">${cn(Yd)}</code></pre>
          </div>
        </div>
    ...
    `;const i=await Gd();Kr();const t=e.querySelector("#toggle-instructions"),n=e.querySelector("#instructions-section"),m=t.querySelector(".toggle-text"),f=t.querySelector(".toggle-icon");return t&&n&&t.addEventListener("click",()=>{const g=n.style.display==="block";n.style.display=g?"none":"block",m.textContent=g?"Show Implementation Guide":"Hide Implementation Guide",f.textContent=g?"▼":"▲",g||setTimeout(()=>Kr(),50)}),{reactApp:i,cleanup:()=>{i?.cleanup&&i.cleanup();const g=document.getElementById("react-app-root");g&&(g.innerHTML="")}}}catch(i){return console.error("Failed to load React demo:",i),e.innerHTML=`
      <div class="react-demo">
        <h3>React Integration Demo</h3>
        <div class="error-message">
    ...
    `,{cleanup:()=>{}}}}async function jd(){await new Promise(e=>setTimeout(e,500)),console.log("React-style demo environment ready")}async function Vd(){if(window.hljs)return window.hljs;try{const e=document.createElement("link");return e.rel="stylesheet",e.href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css",document.head.appendChild(e),Ud(),await ln("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"),await ln("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/typescript.min.js"),await ln("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/bash.min.js"),window.hljs}catch(e){return console.warn("Failed to load Highlight.js:",e),null}}function Ud(){const e=document.createElement("style");e.textContent=`
  ...
  `,document.head.appendChild(e)}function ln(e){return new Promise((i,t)=>{const n=document.createElement("script");n.src=e,n.onload=i,n.onerror=t,document.head.appendChild(n)})}function Kr(){window.hljs?document.querySelectorAll("pre code").forEach(e=>{try{window.hljs.highlightElement(e)}catch(i){console.warn("Failed to highlight code block:",i)}}):document.querySelectorAll("pre code").forEach(e=>{e.style.fontFamily="'Monaco', 'Menlo', 'Ubuntu Mono', monospace",e.style.fontSize="14px",e.style.lineHeight="1.5"})}async function Gd(){const e=document.getElementById("react-app-root");if(!e)return null;e.innerHTML=`
  ...
  `;const i=e.querySelector(".react-form-editor"),t=e.querySelector(".react-form-renderer");if(i&&t){const n=document.createElement("form");n.className="build-form-react-real";const m=document.createElement("div");m.className="render-form-react-real",i.appendChild(n),t.appendChild(m);const f={...jt,editorContainer:".build-form-react-real",events:{...jt.events,onSave:s=>{console.log("React Component - Form saved:",s)},onChange:s=>{console.log("React Component - Form changed:",s)}}},g={...sr,renderContainer:".render-form-react-real"},u=new rr(f),o=new or(g),h=e.querySelector("#react-save-btn"),d=e.querySelector("#react-render-btn"),c=e.querySelector("#react-clear-btn"),l=e.querySelector("#react-export-btn");return h&&h.addEventListener("click",()=>{const s=u.formData;console.log("React Component - Save clicked:",s),localStorage.setItem("formeo-react-form",JSON.stringify(s)),alert("Form saved! Check console for form data.")}),d&&d.addEventListener("click",()=>{const s=u.formData;s&&Object.keys(s).length>0?(m.style.display="block",o.render(s),console.log("React Component - Render clicked:",s)):alert("Please create a form first before rendering")}),c&&c.addEventListener("click",()=>{u?.clear(),m.style.display="none",localStorage.removeItem("formeo-react-form"),console.log("React Component - Clear clicked")}),l&&l.addEventListener("click",()=>{const s=u.formData;if(s&&Object.keys(s).length>0){const r=new Blob([JSON.stringify(s,null,2)],{type:"application/json"}),a=URL.createObjectURL(r),p=document.createElement("a");p.href=a,p.download="formeo-react-form.json",p.click(),URL.revokeObjectURL(a),console.log("React Component - Export clicked")}else alert("Please create a form first before exporting")}),{editor:u,renderer:o,cleanup:()=>{u?.destroy&&u.destroy(),o?.destroy&&o.destroy()}}}return null}function cn(e){const i=document.createElement("div");return i.textContent=e,i.innerHTML}var Kd=`import { useEffect, useRef, useCallback } from 'react';
import { FormeoEditor, FormeoRenderer } from 'formeo';
...
}`,qd=`import React, { useState } from 'react';
...
}`,Yd=`import React, { createContext, useContext, useReducer, useCallback } from 'react';
import { FormeoEditor, FormeoRenderer } from 'formeo';
...
};`,Zd=j(((e,i)=>{(function(){var t="ace",n=(function(){return this})();if(!n&&typeof window<"u"&&(n=window),!t&&typeof requirejs<"u")return;var m=function(d,c,l){if(typeof d!="string"){m.original?m.original.apply(this,arguments):(console.error("dropping module because define wasn't a string."),console.trace());return}arguments.length==2&&(l=c),m.modules[d]||(m.payloads[d]=l,m.modules[d]=null)};m.modules={},m.payloads={};var f=function(d,c,l){if(typeof c=="string"){var s=o(d,c);if(s!=null)return l&&l(),s}else if(Object.prototype.toString.call(c)==="[object Array]"){for(var r=[],a=0,p=c.length;a<p;++a){var v=o(d,c[a]);if(v==null&&g.original)return;r.push(v)}return l&&l.apply(null,r)||!0}},g=function(d,c){var l=f("",d,c);return l==null&&g.original?g.original.apply(this,arguments):l},u=function(d,c){if(c.indexOf("!")!==-1){var l=c.split("!");return u(d,l[0])+"!"+u(d,l[1])}if(c.charAt(0)==".")for(c=d.split("/").slice(0,-1).join("/")+"/"+c;c.indexOf(".")!==-1&&s!=c;){var s=c;c=c.replace(/\/\.\//,"/").replace(/[^\/]+\/\.\.\//,"")}return c},o=function(d,c){c=u(d,c);var l=m.modules[c];if(!l){if(l=m.payloads[c],typeof l=="function"){var s={},r={id:c,uri:"",exports:s,packaged:!0},a=function(p,v){return f(c,p,v)};s=l(a,s,r)||r.exports,m.modules[c]=s,delete m.payloads[c]}l=m.modules[c]=s||l}return l};function h(d){var c=n;d&&(n[d]||(n[d]={}),c=n[d]),(!c.define||!c.define.packaged)&&(m.original=c.define,c.define=m,c.define.packaged=!0),(!c.require||!c.require.packaged)&&(g.original=c.require,c.require=g,c.require.packaged=!0)}h(t)})(),ace.define("ace/lib/es6-shim",["require","exports","module"],function(t,n,m){function f(g,u,o){Object.defineProperty(g,u,{value:o,enumerable:!1,writable:!0,configurable:!0})}String.prototype.startsWith||f(String.prototype,"startsWith",function(g,u){return u=u||0,this.lastIndexOf(g,u)===u}),String.prototype.endsWith||f(String.prototype,"endsWith",function(g,u){var o=this;(u===void 0||u>o.length)&&(u=o.length),u-=g.length;var h=o.indexOf(g,u);return h!==-1&&h===u}),String.prototype.repeat||f(String.prototype,"repeat",function(g){for(var u="",o=this;g>0;)g&1&&(u+=o),(g>>=1)&&(o+=o);return u}),String.prototype.includes||f(String.prototype,"includes",function(g,u){return this.indexOf(g,u)!=-1}),Object.assign||(Object.assign=function(g){if(g==null)throw new TypeError("Cannot convert undefined or null to object");for(var u=Object(g),o=1;o<arguments.length;o++){var h=arguments[o];h!=null&&Object.keys(h).forEach(function(d){u[d]=h[d]})}return u}),Object.values||(Object.values=function(g){return Object.keys(g).map(function(u){return g[u]})}),Array.prototype.find||f(Array.prototype,"find",function(g){for(var u=this.length,o=arguments[1],h=0;h<u;h++){var d=this[h];if(g.call(o,d,h,this))return d}}),Array.prototype.findIndex||f(Array.prototype,"findIndex",function(g){for(var u=this.length,o=arguments[1],h=0;h<u;h++){var d=this[h];if(g.call(o,d,h,this))return h}}),Array.prototype.includes||f(Array.prototype,"includes",function(g,u){return this.indexOf(g,u)!=-1}),Array.prototype.fill||f(Array.prototype,"fill",function(g){for(var u=this,o=u.length>>>0,h=arguments[1]>>0,d=h<0?Math.max(o+h,0):Math.min(h,o),c=arguments[2],l=c===void 0?o:c>>0,s=l<0?Math.max(o+l,0):Math.min(l,o);d<s;)u[d]=g,d++;return u}),Array.of||f(Array,"of",function(){return Array.prototype.slice.call(arguments)})}),ace.define("ace/lib/fixoldbrowsers",["require","exports","module","ace/lib/es6-shim"],function(t,n,m){"use strict";t("./es6-shim")}),ace.define("ace/lib/deep_copy",["require","exports","module"],function(t,n,m){n.deepCopy=function f(g){if(typeof g!="object"||!g)return g;var u;if(Array.isArray(g)){u=[];for(var o=0;o<g.length;o++)u[o]=f(g[o]);return u}if(Object.prototype.toString.call(g)!=="[object Object]")return g;u={};for(var o in g)u[o]=f(g[o]);return u}}),ace.define("ace/lib/lang",["require","exports","module","ace/lib/deep_copy"],function(t,n,m){"use strict";n.last=function(u){return u[u.length-1]},n.stringReverse=function(u){return u.split("").reverse().join("")},n.stringRepeat=function(u,o){for(var h="";o>0;)o&1&&(h+=u),(o>>=1)&&(u+=u);return h};var f=/^\s\s*/,g=/\s\s*$/;n.stringTrimLeft=function(u){return u.replace(f,"")},n.stringTrimRight=function(u){return u.replace(g,"")},n.copyObject=function(u){var o={};for(var h in u)o[h]=u[h];return o},n.copyArray=function(u){for(var o=[],h=0,d=u.length;h<d;h++)u[h]&&typeof u[h]=="object"?o[h]=this.copyObject(u[h]):o[h]=u[h];return o},n.deepCopy=t("./deep_copy").deepCopy,n.arrayToMap=function(u){for(var o={},h=0;h<u.length;h++)o[u[h]]=1;return o},n.createMap=function(u){var o=Object.create(null);for(var h in u)o[h]=u[h];return o},n.arrayRemove=function(u,o){for(var h=0;h<=u.length;h++)o===u[h]&&u.splice(h,1)},n.escapeRegExp=function(u){return u.replace(/([.*+?^${}()|[\]\/\\])/g,"\\$1")},n.escapeHTML=function(u){return(""+u).replace(/&/g,"&#38;").replace(/"/g,"&#34;").replace(/'/g,"&#39;").replace(/</g,"&#60;")},n.getMatchOffsets=function(u,o){var h=[];return u.replace(o,function(d){h.push({offset:arguments[arguments.length-2],length:d.length})}),h},n.deferredCall=function(u){var o=null,h=function(){o=null,u()},d=function(c){return d.cancel(),o=setTimeout(h,c||0),d};return d.schedule=d,d.call=function(){return this.cancel(),u(),d},d.cancel=function(){return clearTimeout(o),o=null,d},d.isPending=function(){return o},d},n.delayedCall=function(u,o){var h=null,d=function(){h=null,u()},c=function(l){h==null&&(h=setTimeout(d,l||o))};return c.delay=function(l){h&&clearTimeout(h),h=setTimeout(d,l||o)},c.schedule=c,c.call=function(){this.cancel(),u()},c.cancel=function(){h&&clearTimeout(h),h=null},c.isPending=function(){return h},c},n.sleep=function(u){return new Promise(function(o){setTimeout(o,u)})},n.supportsLookbehind=function(){return!0},n.skipEmptyMatch=function(u,o,h){return h&&u.codePointAt(o)>65535?2:1}}),ace.define("ace/lib/useragent",["require","exports","module"],function(t,n,m){"use strict";n.OS={LINUX:"LINUX",MAC:"MAC",WINDOWS:"WINDOWS"},n.getOS=function(){return n.isMac?n.OS.MAC:n.isLinux?n.OS.LINUX:n.OS.WINDOWS};var f=typeof navigator=="object"?navigator:{},g=(/mac|win|linux/i.exec(f.platform)||["other"])[0].toLowerCase(),u=f.userAgent||"",o=f.appName||"";n.isWin=g=="win",n.isMac=g=="mac",n.isLinux=g=="linux",n.isIE=o=="Microsoft Internet Explorer"||o.indexOf("MSAppHost")>=0?parseFloat((u.match(/(?:MSIE |Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/)||[])[1]):parseFloat((u.match(/(?:Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/)||[])[1]),n.isOldIE=n.isIE&&n.isIE<9,n.isGecko=n.isMozilla=u.match(/ Gecko\/\d+/),n.isOpera=typeof opera=="object"&&Object.prototype.toString.call(window.opera)=="[object Opera]",n.isWebKit=parseFloat(u.split("WebKit/")[1])||void 0,n.isChrome=parseFloat(u.split(" Chrome/")[1])||void 0,n.isSafari=parseFloat(u.split(" Safari/")[1])&&!n.isChrome||void 0,n.isEdge=parseFloat(u.split(" Edge/")[1])||void 0,n.isAIR=u.indexOf("AdobeAIR")>=0,n.isAndroid=u.indexOf("Android")>=0,n.isChromeOS=u.indexOf(" CrOS ")>=0,n.isIOS=/iPad|iPhone|iPod/.test(u)&&!window.MSStream,n.isIOS&&(n.isMac=!0),n.isMobile=n.isIOS||n.isAndroid}),ace.define("ace/lib/dom",["require","exports","module","ace/lib/useragent"],function(t,n,m){"use strict";var f=t("./useragent"),g="http://www.w3.org/1999/xhtml";n.buildDom=function l(s,r,a){if(typeof s=="string"&&s){var p=document.createTextNode(s);return r&&r.appendChild(p),p}if(!Array.isArray(s))return s&&s.appendChild&&r&&r.appendChild(s),s;if(typeof s[0]!="string"||!s[0]){for(var v=[],y=0;y<s.length;y++){var k=l(s[y],r,a);k&&v.push(k)}return v}var x=document.createElement(s[0]),w=s[1],S=1;w&&typeof w=="object"&&!Array.isArray(w)&&(S=2);for(var y=S;y<s.length;y++)l(s[y],x,a);return S==2&&Object.keys(w).forEach(function(M){var L=w[M];M==="class"?x.className=Array.isArray(L)?L.join(" "):L:typeof L=="function"||M=="value"||M[0]=="$"?x[M]=L:M==="ref"?a&&(a[L]=x):M==="style"?typeof L=="string"&&(x.style.cssText=L):L!=null&&x.setAttribute(M,L)}),r&&r.appendChild(x),x},n.getDocumentHead=function(l){return l||(l=document),l.head||l.getElementsByTagName("head")[0]||l.documentElement},n.createElement=function(l,s){return document.createElementNS?document.createElementNS(s||g,l):document.createElement(l)},n.removeChildren=function(l){l.innerHTML=""},n.createTextNode=function(l,s){return(s?s.ownerDocument:document).createTextNode(l)},n.createFragment=function(l){return(l?l.ownerDocument:document).createDocumentFragment()},n.hasCssClass=function(l,s){return(l.className+"").split(/\s+/g).indexOf(s)!==-1},n.addCssClass=function(l,s){n.hasCssClass(l,s)||(l.className+=" "+s)},n.removeCssClass=function(l,s){for(var r=l.className.split(/\s+/g);;){var a=r.indexOf(s);if(a==-1)break;r.splice(a,1)}l.className=r.join(" ")},n.toggleCssClass=function(l,s){for(var r=l.className.split(/\s+/g),a=!0;;){var p=r.indexOf(s);if(p==-1)break;a=!1,r.splice(p,1)}return a&&r.push(s),l.className=r.join(" "),a},n.setCssClass=function(l,s,r){r?n.addCssClass(l,s):n.removeCssClass(l,s)},n.hasCssString=function(l,s){var r=0,a;if(s=s||document,a=s.querySelectorAll("style")){for(;r<a.length;)if(a[r++].id===l)return!0}},n.removeElementById=function(l,s){s=s||document,s.getElementById(l)&&s.getElementById(l).remove()};var u,o=[];n.useStrictCSP=function(l){u=l,l==!1?h():o||(o=[])};function h(){var l=o;o=null,l&&l.forEach(function(s){d(s[0],s[1])})}function d(l,s,r){if(!(typeof document>"u")){if(o){if(r)h();else if(r===!1)return o.push([l,s])}if(!u){var a=r;!r||!r.getRootNode?a=document:(a=r.getRootNode(),(!a||a==r)&&(a=document));var p=a.ownerDocument||a;if(s&&n.hasCssString(s,a))return null;s&&(l+=`
/*# sourceURL=ace/css/`+s+" */");var v=n.createElement("style");v.appendChild(p.createTextNode(l)),s&&(v.id=s),a==p&&(a=n.getDocumentHead(p)),a.insertBefore(v,a.firstChild)}}}if(n.importCssString=d,n.importCssStylsheet=function(l,s){n.buildDom(["link",{rel:"stylesheet",href:l}],n.getDocumentHead(s))},n.$fixPositionBug=function(l){var s=l.getBoundingClientRect();if(l.style.left){var r=parseFloat(l.style.left),a=+s.left;Math.abs(r-a)>1&&(l.style.left=2*r-a+"px")}if(l.style.right){var r=parseFloat(l.style.right),a=window.innerWidth-s.right;Math.abs(r-a)>1&&(l.style.right=2*r-a+"px")}if(l.style.top){var r=parseFloat(l.style.top),a=+s.top;Math.abs(r-a)>1&&(l.style.top=2*r-a+"px")}if(l.style.bottom){var r=parseFloat(l.style.bottom),a=window.innerHeight-s.bottom;Math.abs(r-a)>1&&(l.style.bottom=2*r-a+"px")}},n.scrollbarWidth=function(l){var s=n.createElement("ace_inner");s.style.width="100%",s.style.minWidth="0px",s.style.height="200px",s.style.display="block";var r=n.createElement("ace_outer"),a=r.style;a.position="absolute",a.left="-10000px",a.overflow="hidden",a.width="200px",a.minWidth="0px",a.height="150px",a.display="block",r.appendChild(s);var p=l&&l.documentElement||document&&document.documentElement;if(!p)return 0;p.appendChild(r);var v=s.offsetWidth;a.overflow="scroll";var y=s.offsetWidth;return v===y&&(y=r.clientWidth),p.removeChild(r),v-y},n.computedStyle=function(l,s){return window.getComputedStyle(l,"")||{}},n.setStyle=function(l,s,r){l[s]!==r&&(l[s]=r)},n.HAS_CSS_ANIMATION=!1,n.HAS_CSS_TRANSFORMS=!1,n.HI_DPI=f.isWin?typeof window<"u"&&window.devicePixelRatio>=1.5:!0,f.isChromeOS&&(n.HI_DPI=!1),typeof document<"u"){var c=document.createElement("div");n.HI_DPI&&c.style.transform!==void 0&&(n.HAS_CSS_TRANSFORMS=!0),!f.isEdge&&typeof c.style.animationName<"u"&&(n.HAS_CSS_ANIMATION=!0),c=null}n.HAS_CSS_TRANSFORMS?n.translate=function(l,s,r){l.style.transform="translate("+Math.round(s)+"px, "+Math.round(r)+"px)"}:n.translate=function(l,s,r){l.style.top=Math.round(r)+"px",l.style.left=Math.round(s)+"px"}}),ace.define("ace/lib/net",["require","exports","module","ace/lib/dom"],function(t,n,m){"use strict";var f=t("./dom");n.get=function(g,u){var o=new XMLHttpRequest;o.open("GET",g,!0),o.onreadystatechange=function(){o.readyState===4&&u(o.responseText)},o.send(null)},n.loadScript=function(g,u){var o=f.getDocumentHead(),h=document.createElement("script");h.src=g,o.appendChild(h),h.onload=h.onreadystatechange=function(d,c){(c||!h.readyState||h.readyState=="loaded"||h.readyState=="complete")&&(h=h.onload=h.onreadystatechange=null,c||u())}},n.qualifyURL=function(g){var u=document.createElement("a");return u.href=g,u.href}}),ace.define("ace/lib/oop",["require","exports","module"],function(t,n,m){"use strict";n.inherits=function(f,g){f.super_=g,f.prototype=Object.create(g.prototype,{constructor:{value:f,enumerable:!1,writable:!0,configurable:!0}})},n.mixin=function(f,g){for(var u in g)f[u]=g[u];return f},n.implement=function(f,g){n.mixin(f,g)}}),ace.define("ace/lib/event_emitter",["require","exports","module"],function(t,n,m){"use strict";var f={},g=function(){this.propagationStopped=!0},u=function(){this.defaultPrevented=!0};f._emit=f._dispatchEvent=function(o,h){this._eventRegistry||(this._eventRegistry={}),this._defaultHandlers||(this._defaultHandlers={});var d=this._eventRegistry[o]||[],c=this._defaultHandlers[o];if(!(!d.length&&!c)){(typeof h!="object"||!h)&&(h={}),h.type||(h.type=o),h.stopPropagation||(h.stopPropagation=g),h.preventDefault||(h.preventDefault=u),d=d.slice();for(var l=0;l<d.length&&(d[l](h,this),!h.propagationStopped);l++);if(c&&!h.defaultPrevented)return c(h,this)}},f._signal=function(o,h){var d=(this._eventRegistry||{})[o];if(d){d=d.slice();for(var c=0;c<d.length;c++)d[c](h,this)}},f.once=function(o,h){var d=this;if(this.on(o,function c(){d.off(o,c),h.apply(null,arguments)}),!h)return new Promise(function(c){h=c})},f.setDefaultHandler=function(o,h){var d=this._defaultHandlers;if(d||(d=this._defaultHandlers={_disabled_:{}}),d[o]){var c=d[o],l=d._disabled_[o];l||(d._disabled_[o]=l=[]),l.push(c);var s=l.indexOf(h);s!=-1&&l.splice(s,1)}d[o]=h},f.removeDefaultHandler=function(o,h){var d=this._defaultHandlers;if(d){var c=d._disabled_[o];if(d[o]==h)c&&this.setDefaultHandler(o,c.pop());else if(c){var l=c.indexOf(h);l!=-1&&c.splice(l,1)}}},f.on=f.addEventListener=function(o,h,d){this._eventRegistry=this._eventRegistry||{};var c=this._eventRegistry[o];return c||(c=this._eventRegistry[o]=[]),c.indexOf(h)==-1&&c[d?"unshift":"push"](h),h},f.off=f.removeListener=f.removeEventListener=function(o,h){this._eventRegistry=this._eventRegistry||{};var d=this._eventRegistry[o];if(d){var c=d.indexOf(h);c!==-1&&d.splice(c,1)}},f.removeAllListeners=function(o){o||(this._eventRegistry=this._defaultHandlers=void 0),this._eventRegistry&&(this._eventRegistry[o]=void 0),this._defaultHandlers&&(this._defaultHandlers[o]=void 0)},n.EventEmitter=f}),ace.define("ace/lib/report_error",["require","exports","module"],function(t,n,m){n.reportError=function(g,u){var o=new Error(g);o.data=u,typeof console=="object"&&console.error&&console.error(o),setTimeout(function(){throw o})}}),ace.define("ace/lib/default_english_messages",["require","exports","module"],function(t,n,m){n.defaultEnglishMessages={"autocomplete.popup.aria-roledescription":"Autocomplete suggestions","autocomplete.popup.aria-label":"Autocomplete suggestions","autocomplete.popup.item.aria-roledescription":"item","autocomplete.loading":"Loading...","editor.scroller.aria-roledescription":"editor","editor.scroller.aria-label":"Editor content, press Enter to start editing, press Escape to exit","editor.gutter.aria-roledescription":"editor gutter","editor.gutter.aria-label":"Editor gutter, press Enter to interact with controls using arrow keys, press Escape to exit","error-marker.good-state":"Looks good!","prompt.recently-used":"Recently used","prompt.other-commands":"Other commands","prompt.no-matching-commands":"No matching commands","search-box.find.placeholder":"Search for","search-box.find-all.text":"All","search-box.replace.placeholder":"Replace with","search-box.replace-next.text":"Replace","search-box.replace-all.text":"All","search-box.toggle-replace.title":"Toggle Replace mode","search-box.toggle-regexp.title":"RegExp Search","search-box.toggle-case.title":"CaseSensitive Search","search-box.toggle-whole-word.title":"Whole Word Search","search-box.toggle-in-selection.title":"Search In Selection","search-box.search-counter":"$0 of $1","text-input.aria-roledescription":"editor","text-input.aria-label":"Cursor at row $0","gutter.code-folding.range.aria-label":"Toggle code folding, rows $0 through $1","gutter.code-folding.closed.aria-label":"Toggle code folding, rows $0 through $1","gutter.code-folding.open.aria-label":"Toggle code folding, row $0","gutter.code-folding.closed.title":"Unfold code","gutter.code-folding.open.title":"Fold code","gutter.annotation.aria-label.error":"Error, read annotations row $0","gutter.annotation.aria-label.warning":"Warning, read annotations row $0","gutter.annotation.aria-label.info":"Info, read annotations row $0","inline-fold.closed.title":"Unfold code","gutter-tooltip.aria-label.error.singular":"error","gutter-tooltip.aria-label.error.plural":"errors","gutter-tooltip.aria-label.warning.singular":"warning","gutter-tooltip.aria-label.warning.plural":"warnings","gutter-tooltip.aria-label.info.singular":"information message","gutter-tooltip.aria-label.info.plural":"information messages","gutter.annotation.aria-label.security":"Security finding, read annotations row $0","gutter.annotation.aria-label.hint":"Suggestion, read annotations row $0","gutter-tooltip.aria-label.security.singular":"security finding","gutter-tooltip.aria-label.security.plural":"security findings","gutter-tooltip.aria-label.hint.singular":"suggestion","gutter-tooltip.aria-label.hint.plural":"suggestions","editor.tooltip.disable-editing":"Editing is disabled"}}),ace.define("ace/lib/app_config",["require","exports","module","ace/lib/oop","ace/lib/event_emitter","ace/lib/report_error","ace/lib/default_english_messages"],function(t,n,m){"no use strict";var f=t("./oop"),g=t("./event_emitter").EventEmitter,u=t("./report_error").reportError,o=t("./default_english_messages").defaultEnglishMessages,h={setOptions:function(r){Object.keys(r).forEach(function(a){this.setOption(a,r[a])},this)},getOptions:function(r){var a={};if(r)Array.isArray(r)||(r=Object.keys(r));else{var p=this.$options;r=Object.keys(p).filter(function(v){return!p[v].hidden})}return r.forEach(function(v){a[v]=this.getOption(v)},this),a},setOption:function(r,a){if(this["$"+r]!==a){var p=this.$options[r];if(!p)return d('misspelled option "'+r+'"');if(p.forwardTo)return this[p.forwardTo]&&this[p.forwardTo].setOption(r,a);p.handlesSet||(this["$"+r]=a),p&&p.set&&p.set.call(this,a)}},getOption:function(r){var a=this.$options[r];return a?a.forwardTo?this[a.forwardTo]&&this[a.forwardTo].getOption(r):a&&a.get?a.get.call(this):this["$"+r]:d('misspelled option "'+r+'"')}};function d(r){typeof console<"u"&&console.warn&&console.warn.apply(console,arguments)}var c,l,s=(function(){function r(){this.$defaultOptions={},c=o,l="dollarSigns"}return r.prototype.defineOptions=function(a,p,v){return a.$options||(this.$defaultOptions[p]=a.$options={}),Object.keys(v).forEach(function(y){var k=v[y];typeof k=="string"&&(k={forwardTo:k}),k.name||(k.name=y),a.$options[k.name]=k,"initialValue"in k&&(a["$"+k.name]=k.initialValue)}),f.implement(a,h),this},r.prototype.resetOptions=function(a){Object.keys(a.$options).forEach(function(p){var v=a.$options[p];"value"in v&&a.setOption(p,v.value)})},r.prototype.setDefaultValue=function(a,p,v){if(!a){for(a in this.$defaultOptions)if(this.$defaultOptions[a][p])break;if(!this.$defaultOptions[a][p])return!1}var y=this.$defaultOptions[a]||(this.$defaultOptions[a]={});y[p]&&(y.forwardTo?this.setDefaultValue(y.forwardTo,p,v):y[p].value=v)},r.prototype.setDefaultValues=function(a,p){Object.keys(p).forEach(function(v){this.setDefaultValue(a,v,p[v])},this)},r.prototype.setMessages=function(a,p){c=a,p&&p.placeholders&&(l=p.placeholders)},r.prototype.nls=function(a,p,v){c[a]||(d("No message found for the key '"+a+"' in messages with id "+c.$id+", trying to find a translation for the default string '"+p+"'."),c[p]||d("No message found for the default string '"+p+"' in the provided messages. Falling back to the default English message."));var y=c[a]||c[p]||p;return v&&(l==="dollarSigns"&&(y=y.replace(/\$(\$|[\d]+)/g,function(k,x){return x=="$"?"$":v[x]})),l==="curlyBrackets"&&(y=y.replace(/\{([^\}]+)\}/g,function(k,x){return v[x]}))),y},r})();s.prototype.warn=d,s.prototype.reportError=u,f.implement(s.prototype,g),n.AppConfig=s}),ace.define("ace/theme/textmate-css",["require","exports","module"],function(t,n,m){m.exports=`.ace-tm .ace_gutter {
  background: #f0f0f0;
  color: #333;
}
...
`}),ace.define("ace/theme/textmate",["require","exports","module","ace/theme/textmate-css","ace/lib/dom"],function(t,n,m){"use strict";n.isDark=!1,n.cssClass="ace-tm",n.cssText=t("./textmate-css"),n.$id="ace/theme/textmate",t("../lib/dom").importCssString(n.cssText,n.cssClass,!1)}),ace.define("ace/config",["require","exports","module","ace/lib/lang","ace/lib/net","ace/lib/dom","ace/lib/app_config","ace/theme/textmate"],function(t,n,m){"no use strict";var f=t("./lib/lang"),g=t("./lib/net"),u=t("./lib/dom"),o=t("./lib/app_config").AppConfig;m.exports=n=new o;var h={packaged:!1,workerPath:null,modePath:null,themePath:null,basePath:"",suffix:".js",$moduleUrls:{},loadWorkerFromBlob:!0,sharedPopups:!1,useStrictCSP:null};n.get=function(s){if(!h.hasOwnProperty(s))throw new Error("Unknown config key: "+s);return h[s]},n.set=function(s,r){if(h.hasOwnProperty(s))h[s]=r;else if(this.setDefaultValue("",s,r)==!1)throw new Error("Unknown config key: "+s);s=="useStrictCSP"&&u.useStrictCSP(r)},n.all=function(){return f.copyObject(h)},n.$modes={},n.moduleUrl=function(s,r){if(h.$moduleUrls[s])return h.$moduleUrls[s];var a=s.split("/");r=r||a[a.length-2]||"";var p=r=="snippets"?"/":"-",v=a[a.length-1];if(r=="worker"&&p=="-"){var y=new RegExp("^"+r+"[\\-_]|[\\-_]"+r+"$","g");v=v.replace(y,"")}(!v||v==r)&&a.length>1&&(v=a[a.length-2]);var k=h[r+"Path"];return k==null?k=h.basePath:p=="/"&&(r=p=""),k&&k.slice(-1)!="/"&&(k+="/"),k+r+p+v+this.get("suffix")},n.setModuleUrl=function(s,r){return h.$moduleUrls[s]=r};var d=function(s,r){if(s==="ace/theme/textmate"||s==="./theme/textmate")return r(null,t("./theme/textmate"));if(c)return c(s,r);console.error("loader is not configured")},c;n.setLoader=function(s){c=s},n.dynamicModules=Object.create(null),n.$loading={},n.$loaded={},n.loadModule=function(s,r){var a;if(Array.isArray(s))var p=s[0],v=s[1];else if(typeof s=="string")var v=s;var y=function(k){if(k&&!n.$loading[v])return r&&r(k);if(n.$loading[v]||(n.$loading[v]=[]),n.$loading[v].push(r),!(n.$loading[v].length>1)){var x=function(){d(v,function(w,S){S&&(n.$loaded[v]=S),n._emit("load.module",{name:v,module:S});var M=n.$loading[v];n.$loading[v]=null,M.forEach(function(L){L&&L(S)})})};if(!n.get("packaged"))return x();g.loadScript(n.moduleUrl(v,p),x),l()}};if(n.dynamicModules[v])n.dynamicModules[v]().then(function(k){k.default?y(k.default):y(k)});else{try{a=this.$require(v)}catch{}y(a||n.$loaded[v])}},n.$require=function(s){if(typeof m.require=="function")return m.require(s)},n.setModuleLoader=function(s,r){n.dynamicModules[s]=r};var l=function(){!h.basePath&&!h.workerPath&&!h.modePath&&!h.themePath&&!Object.keys(h.$moduleUrls).length&&(console.error("Unable to infer path to ace from script src,","use ace.config.set('basePath', 'path') to enable dynamic loading of modes and themes","or with webpack use ace/webpack-resolver"),l=function(){})};n.version="1.44.0"}),ace.define("ace/loader_build",["require","exports","module","ace/lib/fixoldbrowsers","ace/config"],function(t,n,m){"use strict";t("./lib/fixoldbrowsers");var f=t("./config");f.setLoader(function(h,d){t([h],function(c){d(null,c)})});var g=(function(){return this||typeof window<"u"&&window})();m.exports=function(h){f.init=u,f.$require=t,h.require=t,typeof define=="function"&&(h.define=define)},u(!0);function u(h){if(!(!g||!g.document)){f.set("packaged",h||t.packaged||m.packaged||g.define&&define.packaged);var d={},c="",l=document.currentScript||document._currentScript,s=l&&l.ownerDocument||document;l&&l.src&&(c=l.src.split(/[?#]/)[0].split("/").slice(0,-1).join("/")||"");for(var r=s.getElementsByTagName("script"),a=0;a<r.length;a++){var p=r[a],v=p.src||p.getAttribute("src");if(v){for(var y=p.attributes,k=0,x=y.length;k<x;k++){var w=y[k];w.name.indexOf("data-ace-")===0&&(d[o(w.name.replace(/^data-ace-/,""))]=w.value)}var S=v.match(/^(.*)\/ace([\-.]\w+)?\.js(\?|$)/);S&&(c=S[1])}}c&&(d.base=d.base||c,d.packaged=!0),d.basePath=d.base,d.workerPath=d.workerPath||d.base,d.modePath=d.modePath||d.base,d.themePath=d.themePath||d.base,delete d.base;for(var M in d)typeof d[M]<"u"&&f.set(M,d[M])}}function o(h){return h.replace(/-(.)/g,function(d,c){return c.toUpperCase()})}}),ace.define("ace/range",["require","exports","module"],function(t,n,m){"use strict";var f=(function(){function g(u,o,h,d){this.start={row:u,column:o},this.end={row:h,column:d}}return g.prototype.isEqual=function(u){return this.start.row===u.start.row&&this.end.row===u.end.row&&this.start.column===u.start.column&&this.end.column===u.end.column},g.prototype.toString=function(){return"Range: ["+this.start.row+"/"+this.start.column+"] -> ["+this.end.row+"/"+this.end.column+"]"},g.prototype.contains=function(u,o){return this.compare(u,o)==0},g.prototype.compareRange=function(u){var o,h=u.end,d=u.start;return o=this.compare(h.row,h.column),o==1?(o=this.compare(d.row,d.column),o==1?2:o==0?1:0):o==-1?-2:(o=this.compare(d.row,d.column),o==-1?-1:o==1?42:0)},g.prototype.comparePoint=function(u){return this.compare(u.row,u.column)},g.prototype.containsRange=function(u){return this.comparePoint(u.start)==0&&this.comparePoint(u.end)==0},g.prototype.intersects=function(u){var o=this.compareRange(u);return o==-1||o==0||o==1},g.prototype.isEnd=function(u,o){return this.end.row==u&&this.end.column==o},g.prototype.isStart=function(u,o){return this.start.row==u&&this.start.column==o},g.prototype.setStart=function(u,o){typeof u=="object"?(this.start.column=u.column,this.start.row=u.row):(this.start.row=u,this.start.column=o)},g.prototype.setEnd=function(u,o){typeof u=="object"?(this.end.column=u.column,this.end.row=u.row):(this.end.row=u,this.end.column=o)},g.prototype.inside=function(u,o){return this.compare(u,o)==0?!(this.isEnd(u,o)||this.isStart(u,o)):!1},g.prototype.insideStart=function(u,o){return this.compare(u,o)==0?!this.isEnd(u,o):!1},g.prototype.insideEnd=function(u,o){return this.compare(u,o)==0?!this.isStart(u,o):!1},g.prototype.compare=function(u,o){return!this.isMultiLine()&&u===this.start.row?o<this.start.column?-1:o>this.end.column?1:0:u<this.start.row?-1:u>this.end.row?1:this.start.row===u?o>=this.start.column?0:-1:this.end.row===u?o<=this.end.column?0:1:0},g.prototype.compareStart=function(u,o){return this.start.row==u&&this.start.column==o?-1:this.compare(u,o)},g.prototype.compareEnd=function(u,o){return this.end.row==u&&this.end.column==o?1:this.compare(u,o)},g.prototype.compareInside=function(u,o){return this.end.row==u&&this.end.column==o?1:this.start.row==u&&this.start.column==o?-1:this.compare(u,o)},g.prototype.clipRows=function(u,o){if(this.end.row>o)var h={row:o+1,column:0};else if(this.end.row<u)var h={row:u,column:0};if(this.start.row>o)var d={row:o+1,column:0};else if(this.start.row<u)var d={row:u,column:0};return g.fromPoints(d||this.start,h||this.end)},g.prototype.extend=function(u,o){var h=this.compare(u,o);if(h==0)return this;if(h==-1)var d={row:u,column:o};else var c={row:u,column:o};return g.fromPoints(d||this.start,c||this.end)},g.prototype.isEmpty=function(){return this.start.row===this.end.row&&this.start.column===this.end.column},g.prototype.isMultiLine=function(){return this.start.row!==this.end.row},g.prototype.clone=function(){return g.fromPoints(this.start,this.end)},g.prototype.collapseRows=function(){return this.end.column==0?new g(this.start.row,0,Math.max(this.start.row,this.end.row-1),0):new g(this.start.row,0,this.end.row,0)},g.prototype.toScreenRange=function(u){var o=u.documentToScreenPosition(this.start),h=u.documentToScreenPosition(this.end);return new g(o.row,o.column,h.row,h.column)},g.prototype.moveBy=function(u,o){this.start.row+=u,this.start.column+=o,this.end.row+=u,this.end.column+=o},g})();f.fromPoints=function(g,u){return new f(g.row,g.column,u.row,u.column)},f.comparePoints=function(g,u){return g.row-u.row||g.column-u.column},n.Range=f}),ace.define("ace/lib/keys",["require","exports","module","ace/lib/oop"],function(t,n,m){"use strict";for(var f=t("./oop"),g={MODIFIER_KEYS:{16:"Shift",17:"Ctrl",18:"Alt",224:"Meta",91:"MetaLeft",92:"MetaRight",93:"ContextMenu"},KEY_MODS:{ctrl:1,alt:2,option:2,shift:4,super:8,meta:8,command:8,cmd:8,control:1},FUNCTION_KEYS:{8:"Backspace",9:"Tab",13:"Return",19:"Pause",27:"Esc",32:"Space",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"Left",38:"Up",39:"Right",40:"Down",44:"Print",45:"Insert",46:"Delete","-13":"NumpadEnter",144:"Numlock",145:"Scrolllock"},PRINTABLE_KEYS:{32:" ",59:";",61:"=",107:"+",109:"-",110:".",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'",111:"/",106:"*"}},u={Command:224,Backspace:8,Tab:9,Return:13,Enter:13,Pause:19,Escape:27,PageUp:33,PageDown:34,End:35,Home:36,Insert:45,Delete:46,ArrowLeft:37,ArrowUp:38,ArrowRight:39,ArrowDown:40,Backquote:192,Minus:189,Equal:187,BracketLeft:219,Backslash:220,BracketRight:221,Semicolon:186,Quote:222,Comma:188,Period:190,Slash:191,Space:32,NumpadAdd:107,NumpadDecimal:110,NumpadSubtract:109,NumpadDivide:111,NumpadMultiply:106},o=0;o<10;o++)u["Digit"+o]=48+o,u["Numpad"+o]=96+o,g.PRINTABLE_KEYS[48+o]=""+o,g.FUNCTION_KEYS[96+o]="Numpad"+o;for(var o=65;o<91;o++){var h=String.fromCharCode(o+32);u["Key"+h.toUpperCase()]=o,g.PRINTABLE_KEYS[o]=h}for(var o=1;o<13;o++)u["F"+o]=111+o,g.FUNCTION_KEYS[111+o]="F"+o;var d={Shift:16,Control:17,Alt:18,Meta:224};for(var c in d)u[c]=u[c+"Left"]=u[c+"Right"]=d[c];n.$codeToKeyCode=u,g.PRINTABLE_KEYS[173]="-";for(var l in g.FUNCTION_KEYS){var s=g.FUNCTION_KEYS[l].toLowerCase();g[s]=parseInt(l,10)}for(var l in g.PRINTABLE_KEYS){var s=g.PRINTABLE_KEYS[l].toLowerCase();g[s]=parseInt(l,10)}f.mixin(g,g.MODIFIER_KEYS),f.mixin(g,g.PRINTABLE_KEYS),f.mixin(g,g.FUNCTION_KEYS),g.enter=g.return,g.escape=g.esc,g.del=g.delete,(function(){for(var r=["cmd","ctrl","alt","shift"],a=Math.pow(2,r.length);a--;)g.KEY_MODS[a]=r.filter(function(p){return a&g.KEY_MODS[p]}).join("-")+"-"})(),g.KEY_MODS[0]="",g.KEY_MODS[-1]="input-",f.mixin(n,g),n.default=n,n.keyCodeToString=function(r){var a=g[r];return typeof a!="string"&&(a=String.fromCharCode(r)),a.toLowerCase()}}),ace.define("ace/lib/event",["require","exports","module","ace/lib/keys","ace/lib/useragent"],function(t,n,m){"use strict";var f=t("./keys"),g=t("./useragent"),u=null,o=0,h;function d(){h=!1;try{document.createComment("").addEventListener("test",function(){},{get passive(){return h={passive:!1},!0}})}catch{}}function c(){return h==null&&d(),h}function l(k,x,w){this.elem=k,this.type=x,this.callback=w}l.prototype.destroy=function(){r(this.elem,this.type,this.callback),this.elem=this.type=this.callback=void 0};var s=n.addListener=function(k,x,w,S){k.addEventListener(x,w,c()),S&&S.$toDestroy.push(new l(k,x,w))},r=n.removeListener=function(k,x,w){k.removeEventListener(x,w,c())};n.stopEvent=function(k){return n.stopPropagation(k),n.preventDefault(k),!1},n.stopPropagation=function(k){k.stopPropagation&&k.stopPropagation()},n.preventDefault=function(k){k.preventDefault&&k.preventDefault()},n.getButton=function(k){return k.type=="dblclick"?0:k.type=="contextmenu"||g.isMac&&k.ctrlKey&&!k.altKey&&!k.shiftKey?2:k.button},n.capture=function(k,x,w){var S=k&&k.ownerDocument||document;function M(L){x&&x(L),w&&w(L),r(S,"mousemove",x),r(S,"mouseup",M),r(S,"dragstart",M)}return s(S,"mousemove",x),s(S,"mouseup",M),s(S,"dragstart",M),M},n.addMouseWheelListener=function(k,x,w){s(k,"wheel",function(S){var M=.15,L=S.deltaX||0,R=S.deltaY||0;switch(S.deltaMode){case S.DOM_DELTA_PIXEL:S.wheelX=L*M,S.wheelY=R*M;break;case S.DOM_DELTA_LINE:var $=15;S.wheelX=L*$,S.wheelY=R*$;break;case S.DOM_DELTA_PAGE:var D=150;S.wheelX=L*D,S.wheelY=R*D;break}x(S)},w)},n.addMultiMouseDownListener=function(k,x,w,S,M){var L=0,R,$,D,T={2:"dblclick",3:"tripleclick",4:"quadclick"};function E(C){if(n.getButton(C)!==0?L=0:C.detail>1?(L++,L>4&&(L=1)):L=1,g.isIE){var b=Math.abs(C.clientX-R)>5||Math.abs(C.clientY-$)>5;(!D||b)&&(L=1),D&&clearTimeout(D),D=setTimeout(function(){D=null},x[L-1]||600),L==1&&(R=C.clientX,$=C.clientY)}if(C._clicks=L,w[S]("mousedown",C),L>4)L=0;else if(L>1)return w[S](T[L],C)}Array.isArray(k)||(k=[k]),k.forEach(function(C){s(C,"mousedown",E,M)})};function a(k){return 0|(k.ctrlKey?1:0)|(k.altKey?2:0)|(k.shiftKey?4:0)|(k.metaKey?8:0)}n.getModifierString=function(k){return f.KEY_MODS[a(k)]};function p(k,x,w){var S=a(x);if(!w&&x.code&&(w=f.$codeToKeyCode[x.code]||w),!g.isMac&&u){if(x.getModifierState&&(x.getModifierState("OS")||x.getModifierState("Win"))&&(S|=8),u.altGr)if((3&S)!=3)u.altGr=0;else return;if(w===18||w===17){var M=x.location;w===17&&M===1?u[w]==1&&(o=x.timeStamp):w===18&&S===3&&M===2&&x.timeStamp-o<50&&(u.altGr=!0)}}if(w in f.MODIFIER_KEYS&&(w=-1),!(!S&&w===13&&x.location===3&&(k(x,S,-w),x.defaultPrevented))){if(g.isChromeOS&&S&8){if(k(x,S,w),x.defaultPrevented)return;S&=-9}return!S&&!(w in f.FUNCTION_KEYS)&&!(w in f.PRINTABLE_KEYS)?!1:k(x,S,w)}}n.addCommandKeyListener=function(k,x,w){var S=null;s(k,"keydown",function(M){u[M.keyCode]=(u[M.keyCode]||0)+1;var L=p(x,M,M.keyCode);return S=M.defaultPrevented,L},w),s(k,"keypress",function(M){S&&(M.ctrlKey||M.altKey||M.shiftKey||M.metaKey)&&(n.stopEvent(M),S=null)},w),s(k,"keyup",function(M){u[M.keyCode]=null},w),u||(v(),s(window,"focus",v))};function v(){u=Object.create(null)}if(typeof window=="object"&&window.postMessage&&!g.isOldIE){var y=1;n.nextTick=function(k,x){x=x||window;var w="zero-timeout-message-"+y++,S=function(M){M.data==w&&(n.stopPropagation(M),r(x,"message",S),k())};s(x,"message",S),x.postMessage(w,"*")}}n.$idleBlocked=!1,n.onIdle=function(k,x){return setTimeout(function w(){n.$idleBlocked?setTimeout(w,100):k()},x)},n.$idleBlockId=null,n.blockIdle=function(k){n.$idleBlockId&&clearTimeout(n.$idleBlockId),n.$idleBlocked=!0,n.$idleBlockId=setTimeout(function(){n.$idleBlocked=!1},k||100)},n.nextFrame=typeof window=="object"&&(window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame||window.oRequestAnimationFrame),n.nextFrame?n.nextFrame=n.nextFrame.bind(window):n.nextFrame=function(k){setTimeout(k,17)}}),ace.define("ace/clipboard",["require","exports","module"],function(t,n,m){"use strict";var f;m.exports={lineMode:!1,pasteCancelled:function(){return f&&f>Date.now()-50?!0:f=!1},cancel:function(){f=Date.now()}}}),ace.define("ace/keyboard/textinput",["require","exports","module","ace/lib/event","ace/config","ace/lib/useragent","ace/lib/dom","ace/lib/lang","ace/clipboard","ace/lib/keys"],function(t,n,m){"use strict";var f=t("../lib/event"),g=t("../config").nls,u=t("../lib/useragent"),o=t("../lib/dom"),h=t("../lib/lang"),d=t("../clipboard"),c=u.isChrome<18,l=u.isIE,s=u.isChrome>63,r=400,a=t("../lib/keys"),p=a.KEY_MODS,v=u.isIOS,y=v?/\s/:/\n/,k=u.isMobile;n.TextInput=(function(){function x(w,S){var M=this;this.host=S,this.text=o.createElement("textarea"),this.text.className="ace_text-input",this.text.setAttribute("wrap","off"),this.text.setAttribute("autocomplete","off"),this.text.setAttribute("autocorrect","off"),this.text.setAttribute("autocapitalize","off"),this.text.setAttribute("spellcheck","false"),this.text.style.opacity="0",w.insertBefore(this.text,w.firstChild),this.copied=!1,this.pasted=!1,this.inComposition=!1,this.sendingText=!1,this.tempStyle="",k||(this.text.style.fontSize="1px"),this.commandMode=!1,this.ignoreFocusEvents=!1,this.lastValue="",this.lastSelectionStart=0,this.lastSelectionEnd=0,this.lastRestoreEnd=0,this.rowStart=Number.MAX_SAFE_INTEGER,this.rowEnd=Number.MIN_SAFE_INTEGER,this.numberOfExtraLines=0;try{this.$isFocused=document.activeElement===this.text}catch{}this.cancelComposition=this.cancelComposition.bind(this),this.setAriaOptions({role:"textbox"}),f.addListener(this.text,"blur",function(L){M.ignoreFocusEvents||(S.onBlur(L),M.$isFocused=!1)},S),f.addListener(this.text,"focus",function(L){if(!M.ignoreFocusEvents){if(M.$isFocused=!0,u.isEdge)try{if(!document.hasFocus())return}catch{}S.onFocus(L),u.isEdge?setTimeout(M.resetSelection.bind(M)):M.resetSelection()}},S),this.$focusScroll=!1,S.on("beforeEndOperation",function(){var L=S.curOp,R=L&&L.command&&L.command.name;if(R!="insertstring"){var $=R&&(L.docChanged||L.selectionChanged);M.inComposition&&$&&(M.lastValue=M.text.value="",M.onCompositionEnd()),M.resetSelection()}}),S.on("changeSelection",this.setAriaLabel.bind(this)),this.resetSelection=v?this.$resetSelectionIOS:this.$resetSelection,this.$isFocused&&S.onFocus(),this.inputHandler=null,this.afterContextMenu=!1,f.addCommandKeyListener(this.text,function(L,R,$){if(!M.inComposition)return S.onCommandKey(L,R,$)},S),f.addListener(this.text,"select",this.onSelect.bind(this),S),f.addListener(this.text,"input",this.onInput.bind(this),S),f.addListener(this.text,"cut",this.onCut.bind(this),S),f.addListener(this.text,"copy",this.onCopy.bind(this),S),f.addListener(this.text,"paste",this.onPaste.bind(this),S),(!("oncut"in this.text)||!("oncopy"in this.text)||!("onpaste"in this.text))&&f.addListener(w,"keydown",function(L){if(!(u.isMac&&!L.metaKey||!L.ctrlKey))switch(L.keyCode){case 67:M.onCopy(L);break;case 86:M.onPaste(L);break;case 88:M.onCut(L);break}},S),this.syncComposition=h.delayedCall(this.onCompositionUpdate.bind(this),50).schedule.bind(null,null),f.addListener(this.text,"compositionstart",this.onCompositionStart.bind(this),S),f.addListener(this.text,"compositionupdate",this.onCompositionUpdate.bind(this),S),f.addListener(this.text,"keyup",this.onKeyup.bind(this),S),f.addListener(this.text,"keydown",this.syncComposition.bind(this),S),f.addListener(this.text,"compositionend",this.onCompositionEnd.bind(this),S),this.closeTimeout,f.addListener(this.text,"mouseup",this.$onContextMenu.bind(this),S),f.addListener(this.text,"mousedown",function(L){L.preventDefault(),M.onContextMenuClose()},S),f.addListener(S.renderer.scroller,"contextmenu",this.$onContextMenu.bind(this),S),f.addListener(this.text,"contextmenu",this.$onContextMenu.bind(this),S),v&&this.addIosSelectionHandler(w,S,this.text)}return x.prototype.addIosSelectionHandler=function(w,S,M){var L=this,R=null,$=!1;M.addEventListener("keydown",function(T){R&&clearTimeout(R),$=!0},!0),M.addEventListener("keyup",function(T){R=setTimeout(function(){$=!1},100)},!0);var D=function(T){if(document.activeElement===M&&!($||L.inComposition||S.$mouseHandler.isMousePressed)&&!L.copied){var E=M.selectionStart,C=M.selectionEnd,b=null,A=0;if(E==0?b=a.up:E==1?b=a.home:C>L.lastSelectionEnd&&L.lastValue[C]==`
...
`;_!=this.lastValue&&(this.text.value=this.lastValue=_,this.lastSelectionStart=this.lastSelectionEnd=_.length)}if(this.afterContextMenu&&(this.lastSelectionStart=this.text.selectionStart,this.lastSelectionEnd=this.text.selectionEnd),this.lastSelectionEnd!=M||this.lastSelectionStart!=S||this.text.selectionEnd!=this.lastSelectionEnd)try{this.text.setSelectionRange(S,M),this.lastSelectionStart=S,this.lastSelectionEnd=M}catch{}this.inComposition=!1}},x.prototype.setHost=function(w){this.host=w},x.prototype.setNumberOfExtraLines=function(w){if(this.rowStart=Number.MAX_SAFE_INTEGER,this.rowEnd=Number.MIN_SAFE_INTEGER,w<0){this.numberOfExtraLines=0;return}this.numberOfExtraLines=w},x.prototype.setAriaLabel=function(){var w="";if(this.host.$textInputAriaLabel&&(w+="".concat(this.host.$textInputAriaLabel,", ")),this.host.session){var S=this.host.session.selection.cursor.row;w+=g("text-input.aria-label","Cursor at row $0",[S+1])}this.text.setAttribute("aria-label",w)},x.prototype.setAriaOptions=function(w){w.activeDescendant?(this.text.setAttribute("aria-haspopup","true"),this.text.setAttribute("aria-autocomplete",w.inline?"both":"list"),this.text.setAttribute("aria-activedescendant",w.activeDescendant)):(this.text.setAttribute("aria-haspopup","false"),this.text.setAttribute("aria-autocomplete","both"),this.text.removeAttribute("aria-activedescendant")),w.role&&this.text.setAttribute("role",w.role),w.setLabel&&(this.text.setAttribute("aria-roledescription",g("text-input.aria-roledescription","editor")),this.setAriaLabel())},x.prototype.focus=function(){var w=this;if(this.setAriaOptions({setLabel:this.host.renderer.enableKeyboardAccessibility}),this.tempStyle||s||this.$focusScroll=="browser")return this.text.focus({preventScroll:!0});var S=this.text.style.top;this.text.style.position="fixed",this.text.style.top="0px";try{var M=this.text.getBoundingClientRect().top!=0}catch{return}var L=[];if(M)for(var R=this.text.parentElement;R&&R.nodeType==1;)L.push(R),R.setAttribute("ace_nocontext","true"),!R.parentElement&&R.getRootNode?R=R.getRootNode().host:R=R.parentElement;this.text.focus({preventScroll:!0}),M&&L.forEach(function($){$.removeAttribute("ace_nocontext")}),setTimeout(function(){w.text.style.position="",w.text.style.top=="0px"&&(w.text.style.top=S)},0)},x.prototype.blur=function(){this.text.blur()},x.prototype.isFocused=function(){return this.$isFocused},x.prototype.setInputHandler=function(w){this.inputHandler=w},x.prototype.getInputHandler=function(){return this.inputHandler},x.prototype.getElement=function(){return this.text},x.prototype.setCommandMode=function(w){this.commandMode=w,this.text.readOnly=!1},x.prototype.setReadOnly=function(w){this.commandMode||(this.text.readOnly=w)},x.prototype.setCopyWithEmptySelection=function(w){},x.prototype.onContextMenu=function(w){this.afterContextMenu=!0,this.resetSelection(),this.host._emit("nativecontextmenu",{target:this.host,domEvent:w}),this.moveToMouse(w,!0)},x.prototype.moveToMouse=function(w,S){var M=this;this.tempStyle||(this.tempStyle=this.text.style.cssText),this.text.style.cssText=(S?"z-index:100000;":"")+(u.isIE?"opacity:0.1;":"")+"text-indent: -"+(this.lastSelectionStart+this.lastSelectionEnd)*this.host.renderer.characterWidth*.5+"px;";var L=this.host.container.getBoundingClientRect(),R=o.computedStyle(this.host.container),$=L.top+(parseInt(R.borderTopWidth)||0),D=L.left+(parseInt(R.borderLeftWidth)||0),T=L.bottom-$-this.text.clientHeight-2,E=function(C){o.translate(M.text,C.clientX-D-2,Math.min(C.clientY-$-2,T))};E(w),w.type=="mousedown"&&(this.host.renderer.$isMousePressed=!0,clearTimeout(this.closeTimeout),u.isWin&&f.capture(this.host.container,E,this.onContextMenuClose.bind(this)))},x.prototype.destroy=function(){this.text.parentElement&&this.text.parentElement.removeChild(this.text)},x})(),n.$setUserAgentForTests=function(x,w){k=x,v=w}}),ace.define("ace/mouse/default_handlers",["require","exports","module","ace/lib/useragent"],function(t,n,m){"use strict";var f=t("../lib/useragent"),g=0,u=550,o=(function(){function c(l){l.$clickSelection=null;var s=l.editor;s.setDefaultHandler("mousedown",this.onMouseDown.bind(l)),s.setDefaultHandler("dblclick",this.onDoubleClick.bind(l)),s.setDefaultHandler("tripleclick",this.onTripleClick.bind(l)),s.setDefaultHandler("quadclick",this.onQuadClick.bind(l)),s.setDefaultHandler("mousewheel",this.onMouseWheel.bind(l)),["select","startSelect","selectEnd","selectAllEnd","selectByWordsEnd","selectByLinesEnd","dragWait","dragWaitEnd","focusWait"].forEach(function(r){l[r]=this[r]},this),l.selectByLines=this.extendSelectionBy.bind(l,"getLineRange"),l.selectByWords=this.extendSelectionBy.bind(l,"getWordRange")}return c.prototype.onMouseDown=function(l){var s=l.inSelection(),r=l.getDocumentPosition();this.mousedownEvent=l;var a=this.editor,p=l.getButton();if(p!==0){(a.getSelectionRange().isEmpty()||p==1)&&a.selection.moveToPosition(r),p==2&&(a.textInput.onContextMenu(l.domEvent),f.isMozilla||l.preventDefault());return}if(this.mousedownEvent.time=Date.now(),s&&!a.isFocused()&&(a.focus(),this.$focusTimeout&&!this.$clickSelection&&!a.inMultiSelectMode)){this.setState("focusWait"),this.captureMouse(l);return}return this.captureMouse(l),this.startSelect(r,l.domEvent._clicks>1),l.preventDefault()},c.prototype.startSelect=function(l,s){l=l||this.editor.renderer.screenToTextCoordinates(this.x,this.y);var r=this.editor;this.mousedownEvent&&(this.mousedownEvent.getShiftKey()?r.selection.selectToPosition(l):s||r.selection.moveToPosition(l),s||this.select(),r.setStyle("ace_selecting"),this.setState("select"))},c.prototype.select=function(){var l,s=this.editor,r=s.renderer.screenToTextCoordinates(this.x,this.y);if(this.$clickSelection){var a=this.$clickSelection.comparePoint(r);if(a==-1)l=this.$clickSelection.end;else if(a==1)l=this.$clickSelection.start;else{var p=d(this.$clickSelection,r,s.session);r=p.cursor,l=p.anchor}s.selection.setSelectionAnchor(l.row,l.column)}s.selection.selectToPosition(r),s.renderer.scrollCursorIntoView()},c.prototype.extendSelectionBy=function(l){var s,r=this.editor,a=r.renderer.screenToTextCoordinates(this.x,this.y),p=r.selection[l](a.row,a.column);if(this.$clickSelection){var v=this.$clickSelection.comparePoint(p.start),y=this.$clickSelection.comparePoint(p.end);if(v==-1&&y<=0)s=this.$clickSelection.end,(p.end.row!=a.row||p.end.column!=a.column)&&(a=p.start);else if(y==1&&v>=0)s=this.$clickSelection.start,(p.start.row!=a.row||p.start.column!=a.column)&&(a=p.end);else if(v==-1&&y==1)a=p.end,s=p.start;else{var k=d(this.$clickSelection,a,r.session);a=k.cursor,s=k.anchor}r.selection.setSelectionAnchor(s.row,s.column)}r.selection.selectToPosition(a),r.renderer.scrollCursorIntoView()},c.prototype.selectByLinesEnd=function(){this.$clickSelection=null,this.editor.unsetStyle("ace_selecting")},c.prototype.focusWait=function(){(h(this.mousedownEvent.x,this.mousedownEvent.y,this.x,this.y)>g||Date.now()-this.mousedownEvent.time>this.$focusTimeout)&&this.startSelect(this.mousedownEvent.getDocumentPosition())},c.prototype.onDoubleClick=function(l){var s=l.getDocumentPosition(),r=this.editor,a=r.session.getBracketRange(s);a?(a.isEmpty()&&(a.start.column--,a.end.column++),this.setState("select")):(a=r.selection.getWordRange(s.row,s.column),this.setState("selectByWords")),this.$clickSelection=a,this.select()},c.prototype.onTripleClick=function(l){var s=l.getDocumentPosition(),r=this.editor;this.setState("selectByLines");var a=r.getSelectionRange();a.isMultiLine()&&a.contains(s.row,s.column)?(this.$clickSelection=r.selection.getLineRange(a.start.row),this.$clickSelection.end=r.selection.getLineRange(a.end.row).end):this.$clickSelection=r.selection.getLineRange(s.row),this.select()},c.prototype.onQuadClick=function(l){var s=this.editor;s.selectAll(),this.$clickSelection=s.getSelectionRange(),this.setState("selectAll")},c.prototype.onMouseWheel=function(l){if(!l.getAccelKey()){l.getShiftKey()&&l.wheelY&&!l.wheelX&&(l.wheelX=l.wheelY,l.wheelY=0);var s=this.editor;this.$lastScroll||(this.$lastScroll={t:0,vx:0,vy:0,allowed:0});var r=this.$lastScroll,a=l.domEvent.timeStamp,p=a-r.t,v=p?l.wheelX/p:r.vx,y=p?l.wheelY/p:r.vy;p<u&&(v=(v+r.vx)/2,y=(y+r.vy)/2);var k=Math.abs(v/y),x=!1;if(k>=1&&s.renderer.isScrollableBy(l.wheelX*l.speed,0)&&(x=!0),k<=1&&s.renderer.isScrollableBy(0,l.wheelY*l.speed)&&(x=!0),x?r.allowed=a:a-r.allowed<u&&(Math.abs(v)<=1.5*Math.abs(r.vx)&&Math.abs(y)<=1.5*Math.abs(r.vy)?(x=!0,r.allowed=a):r.allowed=0),r.t=a,r.vx=v,r.vy=y,x)return s.renderer.scrollBy(l.wheelX*l.speed,l.wheelY*l.speed),l.stop()}},c})();o.prototype.selectEnd=o.prototype.selectByLinesEnd,o.prototype.selectAllEnd=o.prototype.selectByLinesEnd,o.prototype.selectByWordsEnd=o.prototype.selectByLinesEnd,n.DefaultHandlers=o;function h(c,l,s,r){return Math.sqrt(Math.pow(s-c,2)+Math.pow(r-l,2))}function d(c,l,s){if(c.start.row==c.end.row)var r=2*l.column-c.start.column-c.end.column;else if(c.start.row==c.end.row-1&&!c.start.column&&!c.end.column)var r=3*l.column-2*s.getLine(c.start.row).length;else var r=2*l.row-c.start.row-c.end.row;return r<0?{cursor:c.start,anchor:c.end}:{cursor:c.end,anchor:c.start}}}),ace.define("ace/mouse/mouse_event",["require","exports","module","ace/lib/event","ace/lib/useragent"],function(t,n,m){"use strict";var f=t("../lib/event"),g=t("../lib/useragent");n.MouseEvent=(function(){function u(o,h){this.speed,this.wheelX,this.wheelY,this.domEvent=o,this.editor=h,this.x=this.clientX=o.clientX,this.y=this.clientY=o.clientY,this.$pos=null,this.$inSelection=null,this.propagationStopped=!1,this.defaultPrevented=!1}return u.prototype.stopPropagation=function(){f.stopPropagation(this.domEvent),this.propagationStopped=!0},u.prototype.preventDefault=function(){f.preventDefault(this.domEvent),this.defaultPrevented=!0},u.prototype.stop=function(){this.stopPropagation(),this.preventDefault()},u.prototype.getDocumentPosition=function(){return this.$pos?this.$pos:(this.$pos=this.editor.renderer.screenToTextCoordinates(this.clientX,this.clientY),this.$pos)},u.prototype.getGutterRow=function(){var o=this.getDocumentPosition().row;return this.editor.session.documentToScreenRow(o,0)-this.editor.session.documentToScreenRow(this.editor.renderer.$gutterLayer.$lines.get(0).row,0)},u.prototype.inSelection=function(){if(this.$inSelection!==null)return this.$inSelection;var o=this.editor.getSelectionRange();if(o.isEmpty())this.$inSelection=!1;else{var h=this.getDocumentPosition();this.$inSelection=o.contains(h.row,h.column)}return this.$inSelection},u.prototype.getButton=function(){return f.getButton(this.domEvent)},u.prototype.getShiftKey=function(){return this.domEvent.shiftKey},u.prototype.getAccelKey=function(){return g.isMac?this.domEvent.metaKey:this.domEvent.ctrlKey},u})()}),ace.define("ace/lib/scroll",["require","exports","module"],function(t,n,m){n.preventParentScroll=function(g){g.stopPropagation();var u=g.currentTarget;u.scrollHeight>u.clientHeight||g.preventDefault()}}),ace.define("ace/tooltip",["require","exports","module","ace/lib/dom","ace/lib/event","ace/range","ace/lib/scroll"],function(t,n,m){"use strict";var f=this&&this.__extends||(function(){var s=function(r,a){return s=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(p,v){p.__proto__=v}||function(p,v){for(var y in v)Object.prototype.hasOwnProperty.call(v,y)&&(p[y]=v[y])},s(r,a)};return function(r,a){if(typeof a!="function"&&a!==null)throw new TypeError("Class extends value "+String(a)+" is not a constructor or null");s(r,a);function p(){this.constructor=r}r.prototype=a===null?Object.create(a):(p.prototype=a.prototype,new p)}})(),g=this&&this.__values||function(s){var r=typeof Symbol=="function"&&Symbol.iterator,a=r&&s[r],p=0;if(a)return a.call(s);if(s&&typeof s.length=="number")return{next:function(){return s&&p>=s.length&&(s=void 0),{value:s&&s[p++],done:!s}}};throw new TypeError(r?"Object is not iterable.":"Symbol.iterator is not defined.")},u=t("./lib/dom");t("./lib/event");var o=t("./range").Range,h=t("./lib/scroll").preventParentScroll,d="ace_tooltip",c=(function(){function s(r){this.isOpen=!1,this.$element=null,this.$parentNode=r}return s.prototype.$init=function(){return this.$element=u.createElement("div"),this.$element.className=d,this.$element.style.display="none",this.$parentNode.appendChild(this.$element),this.$element},s.prototype.getElement=function(){return this.$element||this.$init()},s.prototype.setText=function(r){this.getElement().textContent=r},s.prototype.setHtml=function(r){this.getElement().innerHTML=r},s.prototype.setPosition=function(r,a){this.getElement().style.left=r+"px",this.getElement().style.top=a+"px"},s.prototype.setClassName=function(r){u.addCssClass(this.getElement(),r)},s.prototype.setTheme=function(r){this.theme&&(this.theme.isDark&&u.removeCssClass(this.getElement(),"ace_dark"),this.theme.cssClass&&u.removeCssClass(this.getElement(),this.theme.cssClass)),r.isDark&&u.addCssClass(this.getElement(),"ace_dark"),r.cssClass&&u.addCssClass(this.getElement(),r.cssClass),this.theme={isDark:r.isDark,cssClass:r.cssClass}},s.prototype.show=function(r,a,p){r!=null&&this.setText(r),a!=null&&p!=null&&this.setPosition(a,p),this.isOpen||(this.getElement().style.display="block",this.isOpen=!0)},s.prototype.hide=function(r){this.isOpen&&(this.getElement().style.display="none",this.getElement().className=d,this.isOpen=!1)},s.prototype.getHeight=function(){return this.getElement().offsetHeight},s.prototype.getWidth=function(){return this.getElement().offsetWidth},s.prototype.destroy=function(){this.isOpen=!1,this.$element&&this.$element.parentNode&&this.$element.parentNode.removeChild(this.$element)},s})(),l=new((function(){function s(){this.popups=[]}return s.prototype.addPopup=function(r){this.popups.push(r),this.updatePopups()},s.prototype.removePopup=function(r){var a=this.popups.indexOf(r);a!==-1&&(this.popups.splice(a,1),this.updatePopups())},s.prototype.updatePopups=function(){var r,a,p,v;this.popups.sort(function($,D){return D.priority-$.priority});var y=[];try{for(var k=g(this.popups),x=k.next();!x.done;x=k.next()){var w=x.value,S=!0;try{for(var M=(p=void 0,g(y)),L=M.next();!L.done;L=M.next()){var R=L.value;if(this.doPopupsOverlap(R,w)){S=!1;break}}}catch($){p={error:$}}finally{try{L&&!L.done&&(v=M.return)&&v.call(M)}finally{if(p)throw p.error}}S?y.push(w):w.hide()}}catch($){r={error:$}}finally{try{x&&!x.done&&(a=k.return)&&a.call(k)}finally{if(r)throw r.error}}},s.prototype.doPopupsOverlap=function(r,a){var p=r.getElement().getBoundingClientRect(),v=a.getElement().getBoundingClientRect();return p.left<v.right&&p.right>v.left&&p.top<v.bottom&&p.bottom>v.top},s})());n.popupManager=l,n.Tooltip=c,n.HoverTooltip=(function(s){f(r,s);function r(a){a===void 0&&(a=document.body);var p=s.call(this,a)||this;p.timeout=void 0,p.lastT=0,p.idleTime=350,p.lastEvent=void 0,p.onMouseOut=p.onMouseOut.bind(p),p.onMouseMove=p.onMouseMove.bind(p),p.waitForHover=p.waitForHover.bind(p),p.hide=p.hide.bind(p);var v=p.getElement();return v.style.whiteSpace="pre-wrap",v.style.pointerEvents="auto",v.addEventListener("mouseout",p.onMouseOut),v.tabIndex=-1,v.addEventListener("blur",function(){v.contains(document.activeElement)||this.hide()}.bind(p)),v.addEventListener("wheel",h),p}return r.prototype.addToEditor=function(a){a.on("mousemove",this.onMouseMove),a.on("mousedown",this.hide);var p=a.renderer.getMouseEventTarget();p&&typeof p.removeEventListener=="function"&&p.addEventListener("mouseout",this.onMouseOut,!0)},r.prototype.removeFromEditor=function(a){a.off("mousemove",this.onMouseMove),a.off("mousedown",this.hide);var p=a.renderer.getMouseEventTarget();p&&typeof p.removeEventListener=="function"&&p.removeEventListener("mouseout",this.onMouseOut,!0),this.timeout&&(clearTimeout(this.timeout),this.timeout=null)},r.prototype.onMouseMove=function(a,p){this.lastEvent=a,this.lastT=Date.now();var v=p.$mouseHandler.isMousePressed;if(this.isOpen){var y=this.lastEvent&&this.lastEvent.getDocumentPosition();(!this.range||!this.range.contains(y.row,y.column)||v||this.isOutsideOfText(this.lastEvent))&&this.hide()}this.timeout||v||(this.lastEvent=a,this.timeout=setTimeout(this.waitForHover,this.idleTime))},r.prototype.waitForHover=function(){this.timeout&&clearTimeout(this.timeout);var a=Date.now()-this.lastT;if(this.idleTime-a>10){this.timeout=setTimeout(this.waitForHover,this.idleTime-a);return}this.timeout=null,this.lastEvent&&!this.isOutsideOfText(this.lastEvent)&&this.$gatherData(this.lastEvent,this.lastEvent.editor)},r.prototype.isOutsideOfText=function(a){var p=a.editor,v=a.getDocumentPosition(),y=p.session.getLine(v.row);if(v.column==y.length){var k=p.renderer.pixelToScreenCoordinates(a.clientX,a.clientY),x=p.session.documentToScreenPosition(v.row,v.column);if(x.column!=k.column||x.row!=k.row)return!0}return!1},r.prototype.setDataProvider=function(a){this.$gatherData=a},r.prototype.showForRange=function(a,p,v,y){if(!(y&&y!=this.lastEvent)&&!(this.isOpen&&document.activeElement==this.getElement())){var k=a.renderer;this.isOpen||(l.addPopup(this),this.$registerCloseEvents(),this.setTheme(k.theme)),this.isOpen=!0,this.range=o.fromPoints(p.start,p.end);var x=k.textToScreenCoordinates(p.start.row,p.start.column),w=k.scroller.getBoundingClientRect();x.pageX<w.left&&(x.pageX=w.left);var S=this.getElement();S.innerHTML="",S.appendChild(v),S.style.maxHeight="",S.style.display="block",this.$setPosition(a,x,!0,p),u.$fixPositionBug(S)}},r.prototype.$setPosition=function(a,p,v,y){var k=10;v&&this.addMarker(y,a.session);var x=a.renderer,w=this.getElement(),S=w.offsetHeight,M=w.offsetWidth,L=p.pageY,R=p.pageX,$=window.innerHeight-L-x.lineHeight,D=this.$shouldPlaceAbove(S,L,$-k);w.style.maxHeight=(D?L:$)-k+"px",w.style.top=D?"":L+x.lineHeight+"px",w.style.bottom=D?window.innerHeight-L+"px":"",w.style.left=Math.min(R,window.innerWidth-M-k)+"px"},r.prototype.$shouldPlaceAbove=function(a,p,v){return!(p-a<0&&p<v)},r.prototype.addMarker=function(a,p){this.marker&&this.$markerSession.removeMarker(this.marker),this.$markerSession=p,this.marker=p&&p.addMarker(a,"ace_highlight-marker","text")},r.prototype.hide=function(a){a&&this.$fromKeyboard&&a.type=="keydown"&&a.code=="Escape"||!a&&document.activeElement==this.getElement()||a&&a.target&&(a.type!="keydown"||a.ctrlKey||a.metaKey)&&this.$element.contains(a.target)||(this.lastEvent=null,this.timeout&&clearTimeout(this.timeout),this.timeout=null,this.addMarker(null),this.isOpen&&(this.$fromKeyboard=!1,this.$removeCloseEvents(),this.getElement().style.display="none",this.isOpen=!1,l.removePopup(this)))},r.prototype.$registerCloseEvents=function(){window.addEventListener("keydown",this.hide,!0),window.addEventListener("wheel",this.hide,!0),window.addEventListener("mousedown",this.hide,!0)},r.prototype.$removeCloseEvents=function(){window.removeEventListener("keydown",this.hide,!0),window.removeEventListener("wheel",this.hide,!0),window.removeEventListener("mousedown",this.hide,!0)},r.prototype.onMouseOut=function(a){this.timeout&&(clearTimeout(this.timeout),this.timeout=null),this.lastEvent=null,this.isOpen&&(!a.relatedTarget||this.getElement().contains(a.relatedTarget)||a&&a.currentTarget.contains(a.relatedTarget)||a.relatedTarget.classList.contains("ace_content")||this.hide())},r})(c)}),ace.define("ace/mouse/default_gutter_handler",["require","exports","module","ace/lib/dom","ace/mouse/mouse_event","ace/tooltip","ace/config","ace/range"],function(t,n,m){"use strict";var f=this&&this.__extends||(function(){var r=function(a,p){return r=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(v,y){v.__proto__=y}||function(v,y){for(var k in y)Object.prototype.hasOwnProperty.call(y,k)&&(v[k]=y[k])},r(a,p)};return function(a,p){if(typeof p!="function"&&p!==null)throw new TypeError("Class extends value "+String(p)+" is not a constructor or null");r(a,p);function v(){this.constructor=a}a.prototype=p===null?Object.create(p):(v.prototype=p.prototype,new v)}})(),g=this&&this.__values||function(r){var a=typeof Symbol=="function"&&Symbol.iterator,p=a&&r[a],v=0;if(p)return p.call(r);if(r&&typeof r.length=="number")return{next:function(){return r&&v>=r.length&&(r=void 0),{value:r&&r[v++],done:!r}}};throw new TypeError(a?"Object is not iterable.":"Symbol.iterator is not defined.")},u=t("../lib/dom"),o=t("./mouse_event").MouseEvent,h=t("../tooltip").HoverTooltip,d=t("../config").nls,c=t("../range").Range;function l(r){var a=r.editor,p=a.renderer.$gutterLayer;r.$tooltip=new s(a),r.$tooltip.addToEditor(a),r.$tooltip.setDataProvider(function(v,y){var k=v.getDocumentPosition().row;r.$tooltip.showTooltip(k)}),r.editor.setDefaultHandler("guttermousedown",function(v){if(!(!a.isFocused()||v.getButton()!=0)&&p.getRegion(v)!="foldWidgets"){var y=v.getDocumentPosition().row,k=a.session.selection;if(v.getShiftKey())k.selectTo(y,0);else{if(v.domEvent.detail==2)return a.selectAll(),v.preventDefault();r.$clickSelection=a.selection.getLineRange(y)}return r.setState("selectByLines"),r.captureMouse(v),v.preventDefault()}})}n.GutterHandler=l;var s=(function(r){f(a,r);function a(p){var v=r.call(this,p.container)||this;v.id="gt"+ ++a.$uid,v.editor=p,v.visibleTooltipRow;var y=v.getElement();return y.setAttribute("role","tooltip"),y.setAttribute("id",v.id),y.style.pointerEvents="auto",v.idleTime=50,v.onDomMouseMove=v.onDomMouseMove.bind(v),v.onDomMouseOut=v.onDomMouseOut.bind(v),v.setClassName("ace_gutter-tooltip"),v}return a.prototype.onDomMouseMove=function(p){var v=new o(p,this.editor);this.onMouseMove(v,this.editor)},a.prototype.onDomMouseOut=function(p){var v=new o(p,this.editor);this.onMouseOut(v)},a.prototype.addToEditor=function(p){var v=p.renderer.$gutter;v.addEventListener("mousemove",this.onDomMouseMove),v.addEventListener("mouseout",this.onDomMouseOut),r.prototype.addToEditor.call(this,p)},a.prototype.removeFromEditor=function(p){var v=p.renderer.$gutter;v.removeEventListener("mousemove",this.onDomMouseMove),v.removeEventListener("mouseout",this.onDomMouseOut),r.prototype.removeFromEditor.call(this,p)},a.prototype.destroy=function(){this.editor&&this.removeFromEditor(this.editor),r.prototype.destroy.call(this)},Object.defineProperty(a,"annotationLabels",{get:function(){return{error:{singular:d("gutter-tooltip.aria-label.error.singular","error"),plural:d("gutter-tooltip.aria-label.error.plural","errors")},security:{singular:d("gutter-tooltip.aria-label.security.singular","security finding"),plural:d("gutter-tooltip.aria-label.security.plural","security findings")},warning:{singular:d("gutter-tooltip.aria-label.warning.singular","warning"),plural:d("gutter-tooltip.aria-label.warning.plural","warnings")},info:{singular:d("gutter-tooltip.aria-label.info.singular","information message"),plural:d("gutter-tooltip.aria-label.info.plural","information messages")},hint:{singular:d("gutter-tooltip.aria-label.hint.singular","suggestion"),plural:d("gutter-tooltip.aria-label.hint.plural","suggestions")}}},enumerable:!1,configurable:!0}),a.prototype.showTooltip=function(p){var v,y=this.editor.renderer.$gutterLayer,k=y.$annotations[p],x;k?x={displayText:Array.from(k.displayText),type:Array.from(k.type)}:x={displayText:[],type:[]};var w=y.session.getFoldLine(p);if(w&&y.$showFoldedAnnotations){for(var S={error:[],security:[],warning:[],info:[],hint:[]},M={error:1,security:2,warning:3,info:4,hint:5},L,R=p+1;R<=w.end.row;R++)if(y.$annotations[R])for(var $=0;$<y.$annotations[R].text.length;$++){var D=y.$annotations[R].type[$];S[D].push(y.$annotations[R].text[$]),(!L||M[D]<M[L])&&(L=D)}if(["error","security","warning"].includes(L)){var T="".concat(a.annotationsToSummaryString(S)," in folded code.");x.displayText.push(T),x.type.push(L+"_fold")}}if(x.displayText.length===0)return this.hide();for(var E={error:[],security:[],warning:[],info:[],hint:[]},C=y.$useSvgGutterIcons?"ace_icon_svg":"ace_icon",R=0;R<x.displayText.length;R++){var b=u.createElement("span"),A=u.createElement("span");(v=A.classList).add.apply(v,["ace_".concat(x.type[R]),C]),A.setAttribute("aria-label","".concat(a.annotationLabels[x.type[R].replace("_fold","")].singular)),A.setAttribute("role","img"),A.appendChild(u.createTextNode(" ")),b.appendChild(A),b.appendChild(u.createTextNode(x.displayText[R])),b.appendChild(u.createElement("br")),E[x.type[R].replace("_fold","")].push(b)}var _=u.createElement("span");E.error.forEach(function(N){return _.appendChild(N)}),E.security.forEach(function(N){return _.appendChild(N)}),E.warning.forEach(function(N){return _.appendChild(N)}),E.info.forEach(function(N){return _.appendChild(N)}),E.hint.forEach(function(N){return _.appendChild(N)}),_.setAttribute("aria-live","polite");var O=this.$findLinkedAnnotationNode(p);O&&O.setAttribute("aria-describedby",this.id);var I=c.fromPoints({row:p,column:0},{row:p,column:0});this.showForRange(this.editor,I,_),this.visibleTooltipRow=p,this.editor._signal("showGutterTooltip",this)},a.prototype.$setPosition=function(p,v,y,k){var x=this.$findCellByRow(k.start.row);if(x){var w=x&&x.element,S=w&&w.querySelector(".ace_gutter_annotation");if(S){var M=S.getBoundingClientRect();if(M){var L={pageX:M.right,pageY:M.top};return r.prototype.$setPosition.call(this,p,L,!1,k)}}}},a.prototype.$shouldPlaceAbove=function(p,v,y){return y<p},a.prototype.$findLinkedAnnotationNode=function(p){var v=this.$findCellByRow(p);if(v){var y=v.element;if(y.childNodes.length>2)return y.childNodes[2]}},a.prototype.$findCellByRow=function(p){return this.editor.renderer.$gutterLayer.$lines.cells.find(function(v){return v.row===p})},a.prototype.hide=function(p){if(this.isOpen){if(this.$element.removeAttribute("aria-live"),this.visibleTooltipRow!=null){var v=this.$findLinkedAnnotationNode(this.visibleTooltipRow);v&&v.removeAttribute("aria-describedby")}this.visibleTooltipRow=void 0,this.editor._signal("hideGutterTooltip",this),r.prototype.hide.call(this,p)}},a.annotationsToSummaryString=function(p){var v,y,k=[],x=["error","security","warning","info","hint"];try{for(var w=g(x),S=w.next();!S.done;S=w.next()){var M=S.value;if(p[M].length){var L=p[M].length===1?a.annotationLabels[M].singular:a.annotationLabels[M].plural;k.push("".concat(p[M].length," ").concat(L))}}}catch(R){v={error:R}}finally{try{S&&!S.done&&(y=w.return)&&y.call(w)}finally{if(v)throw v.error}}return k.join(", ")},a.prototype.isOutsideOfText=function(p){var v=p.editor.renderer.$gutter.getBoundingClientRect();return!(p.clientX>=v.left&&p.clientX<=v.right&&p.clientY>=v.top&&p.clientY<=v.bottom)},a})(h);s.$uid=0,n.GutterTooltip=s}),ace.define("ace/mouse/dragdrop_handler",["require","exports","module","ace/lib/dom","ace/lib/event","ace/lib/useragent"],function(t,n,m){"use strict";var f=t("../lib/dom"),g=t("../lib/event"),u=t("../lib/useragent"),o=200,h=200,d=5;function c(s){var r=s.editor,a=f.createElement("div");a.style.cssText="top:-100px;position:absolute;z-index:2147483647;opacity:0.5",a.textContent=" ",["dragWait","dragWaitEnd","startDrag","dragReadyEnd","onMouseDrag"].forEach(function(z){s[z]=this[z]},this),r.on("mousedown",this.onMouseDown.bind(s));var p=r.container,v,y,k,x,w,S,M=0,L,R,$,D,T;this.onDragStart=function(z){if(this.cancelDrag||!p.draggable){var P=this;return setTimeout(function(){P.startSelect(),P.captureMouse(z)},0),z.preventDefault()}w=r.getSelectionRange();var W=z.dataTransfer;W.effectAllowed=r.getReadOnly()?"copy":"copyMove",r.container.appendChild(a),W.setDragImage&&W.setDragImage(a,0,0),setTimeout(function(){r.container.removeChild(a)}),W.clearData(),W.setData("Text",r.session.getTextRange()),R=!0,this.setState("drag")},this.onDragEnd=function(z){if(p.draggable=!1,R=!1,this.setState(null),!r.getReadOnly()){var P=z.dataTransfer.dropEffect;!L&&P=="move"&&r.session.remove(r.getSelectionRange()),r.$resetCursorStyle()}this.editor.unsetStyle("ace_dragging"),this.editor.renderer.setCursorStyle("")},this.onDragEnter=function(z){if(!(r.getReadOnly()||!N(z.dataTransfer)))return y=z.clientX,k=z.clientY,v||A(),M++,z.dataTransfer.dropEffect=L=F(z),g.preventDefault(z)},this.onDragOver=function(z){if(!(r.getReadOnly()||!N(z.dataTransfer)))return y=z.clientX,k=z.clientY,v||(A(),M++),O!==null&&(O=null),z.dataTransfer.dropEffect=L=F(z),g.preventDefault(z)},this.onDragLeave=function(z){if(M--,M<=0&&v)return _(),L=null,g.preventDefault(z)},this.onDrop=function(z){if(S){var P=z.dataTransfer;if(R)switch(L){case"move":w.contains(S.row,S.column)?w={start:S,end:S}:w=r.moveText(w,S);break;case"copy":w=r.moveText(w,S,!0);break}else{var W=P.getData("Text");w={start:S,end:r.session.insert(S,W)},r.focus(),L=null}return _(),g.preventDefault(z)}},g.addListener(p,"dragstart",this.onDragStart.bind(s),r),g.addListener(p,"dragend",this.onDragEnd.bind(s),r),g.addListener(p,"dragenter",this.onDragEnter.bind(s),r),g.addListener(p,"dragover",this.onDragOver.bind(s),r),g.addListener(p,"dragleave",this.onDragLeave.bind(s),r),g.addListener(p,"drop",this.onDrop.bind(s),r);function E(z,P){var W=Date.now(),B=!P||z.row!=P.row,H=!P||z.column!=P.column;!D||B||H?(r.moveCursorToPosition(z),D=W,T={x:y,y:k}):l(T.x,T.y,y,k)>d?D=null:W-D>=h&&(r.renderer.scrollCursorIntoView(),D=null)}function C(z,P){var W=Date.now(),B=r.renderer.layerConfig.lineHeight,H=r.renderer.layerConfig.characterWidth,U=r.renderer.scroller.getBoundingClientRect(),G={x:{left:y-U.left,right:U.right-y},y:{top:k-U.top,bottom:U.bottom-k}},Y=Math.min(G.x.left,G.x.right),q=Math.min(G.y.top,G.y.bottom),X={row:z.row,column:z.column};Y/H<=2&&(X.column+=G.x.left<G.x.right?-3:2),q/B<=1&&(X.row+=G.y.top<G.y.bottom?-1:1);var le=z.row!=X.row,$e=z.column!=X.column,Ne=!P||z.row!=P.row;le||$e&&!Ne?$?W-$>=o&&r.renderer.scrollCursorIntoView(X):$=W:$=null}function b(){var z=S;S=r.renderer.screenToTextCoordinates(y,k),E(S,z),C(S,z)}function A(){w=r.selection.toOrientedRange(),v=r.session.addMarker(w,"ace_selection",r.getSelectionStyle()),r.clearSelection(),r.isFocused()&&r.renderer.$cursorLayer.setBlinking(!1),clearInterval(x),b(),x=setInterval(b,20),M=0,g.addListener(document,"mousemove",I)}function _(){clearInterval(x),r.session.removeMarker(v),v=null,r.selection.fromOrientedRange(w),r.isFocused()&&!R&&r.$resetCursorStyle(),w=null,S=null,M=0,$=null,D=null,g.removeListener(document,"mousemove",I)}var O=null;function I(){O==null&&(O=setTimeout(function(){O!=null&&v&&_()},20))}function N(z){var P=z.types;return!P||Array.prototype.some.call(P,function(W){return W=="text/plain"||W=="Text"})}function F(z){var P=["copy","copymove","all","uninitialized"],W=["move","copymove","linkmove","all","uninitialized"],B=u.isMac?z.altKey:z.ctrlKey,H="uninitialized";try{H=z.dataTransfer.effectAllowed.toLowerCase()}catch{}var U="none";return B&&P.indexOf(H)>=0?U="copy":W.indexOf(H)>=0?U="move":P.indexOf(H)>=0&&(U="copy"),U}}(function(){this.dragWait=function(){Date.now()-this.mousedownEvent.time>this.editor.getDragDelay()&&this.startDrag()},this.dragWaitEnd=function(){var s=this.editor.container;s.draggable=!1,this.startSelect(this.mousedownEvent.getDocumentPosition()),this.selectEnd()},this.dragReadyEnd=function(s){this.editor.$resetCursorStyle(),this.editor.unsetStyle("ace_dragging"),this.editor.renderer.setCursorStyle(""),this.dragWaitEnd()},this.startDrag=function(){this.cancelDrag=!1;var s=this.editor,r=s.container;r.draggable=!0,s.renderer.$cursorLayer.setBlinking(!1),s.setStyle("ace_dragging");var a=u.isWin?"default":"move";s.renderer.setCursorStyle(a),this.setState("dragReady")},this.onMouseDrag=function(s){var r=this.editor.container;if(u.isIE&&this.state=="dragReady"){var a=l(this.mousedownEvent.x,this.mousedownEvent.y,this.x,this.y);a>3&&r.dragDrop()}if(this.state==="dragWait"){var a=l(this.mousedownEvent.x,this.mousedownEvent.y,this.x,this.y);a>0&&(r.draggable=!1,this.startSelect(this.mousedownEvent.getDocumentPosition()))}},this.onMouseDown=function(s){if(this.$dragEnabled){this.mousedownEvent=s;var r=this.editor,a=s.inSelection(),p=s.getButton();if((s.domEvent.detail||1)===1&&p===0&&a){if(s.editor.inMultiSelectMode&&(s.getAccelKey()||s.getShiftKey()))return;this.mousedownEvent.time=Date.now();var v=s.domEvent.target||s.domEvent.srcElement;if("unselectable"in v&&(v.unselectable="on"),r.getDragDelay()){if(u.isWebKit){this.cancelDrag=!0;var y=r.container;y.draggable=!0}this.setState("dragWait")}else this.startDrag();this.captureMouse(s,this.onMouseDrag.bind(this)),s.defaultPrevented=!0}}}}).call(c.prototype);function l(s,r,a,p){return Math.sqrt(Math.pow(a-s,2)+Math.pow(p-r,2))}n.DragdropHandler=c}),ace.define("ace/mouse/touch_handler",["require","exports","module","ace/mouse/mouse_event","ace/lib/event","ace/lib/dom"],function(t,n,m){"use strict";var f=t("./mouse_event").MouseEvent,g=t("../lib/event"),u=t("../lib/dom");n.addTouchListeners=function(o,h){var d="scroll",c,l,s,r,a,p,v=0,y,k=0,x=0,w=0,S,M;function L(){var C=window.navigator&&window.navigator.clipboard,b=!1,A=function(){var I=h.getCopyText(),N=h.session.getUndoManager().hasUndo();M.replaceChild(u.buildDom(b?["span",!I&&_("selectall")&&["span",{class:"ace_mobile-button",action:"selectall"},"Select All"],I&&_("copy")&&["span",{class:"ace_mobile-button",action:"copy"},"Copy"],I&&_("cut")&&["span",{class:"ace_mobile-button",action:"cut"},"Cut"],C&&_("paste")&&["span",{class:"ace_mobile-button",action:"paste"},"Paste"],N&&_("undo")&&["span",{class:"ace_mobile-button",action:"undo"},"Undo"],_("find")&&["span",{class:"ace_mobile-button",action:"find"},"Find"],_("openCommandPalette")&&["span",{class:"ace_mobile-button",action:"openCommandPalette"},"Palette"]]:["span"]),M.firstChild)},_=function(I){return h.commands.canExecute(I,h)},O=function(I){var N=I.target.getAttribute("action");if(N=="more"||!b)return b=!b,A();N=="paste"?C.readText().then(function(F){h.execCommand(N,F)}):N&&((N=="cut"||N=="copy")&&(C?C.writeText(h.getCopyText()):document.execCommand("copy")),h.execCommand(N)),M.firstChild.style.display="none",b=!1,N!="openCommandPalette"&&h.focus()};M=u.buildDom(["div",{class:"ace_mobile-menu",onclick:O},["span"],["span",{class:"ace_mobile-button",action:"more"},"..."]],h.container),M.addEventListener("touchstart",function(I){d="menu",I.stopPropagation(),I.preventDefault(),h.textInput.focus()}),M.addEventListener("touchend",function(I){I.stopPropagation(),I.preventDefault(),O(I)})}function R(){if(!h.getOption("enableMobileMenu")){M&&$();return}M||L();var C=h.selection.cursor,b=h.renderer.textToScreenCoordinates(C.row,C.column),A=h.renderer.textToScreenCoordinates(0,0).pageX,_=h.renderer.scrollLeft,O=h.container.getBoundingClientRect();M.style.top=b.pageY-O.top-3+"px",b.pageX-O.left<O.width-70?(M.style.left="",M.style.right="10px"):(M.style.right="",M.style.left=A+_-O.left+"px"),M.style.display="",M.firstChild.style.display="none",h.on("input",$)}function $(C){M&&(M.style.display="none"),h.off("input",$)}function D(){a=null,clearTimeout(a);var C=h.selection.getRange(),b=C.contains(y.row,y.column);(C.isEmpty()||!b)&&(h.selection.moveToPosition(y),h.selection.selectWord()),d="wait",R()}function T(){a=null,clearTimeout(a),h.selection.moveToPosition(y);var C=k>=2?h.selection.getLineRange(y.row):h.session.getBracketRange(y);C&&!C.isEmpty()?h.selection.setRange(C):h.selection.selectWord(),d="wait"}g.addListener(o,"contextmenu",function(C){S&&h.textInput.getElement().focus()},h),g.addListener(o,"touchstart",function(C){var b=C.touches;if(a||b.length>1){clearTimeout(a),a=null,s=-1,d="zoom";return}S=h.$mouseHandler.isMousePressed=!0;var A=h.renderer.layerConfig.lineHeight,_=h.renderer.layerConfig.lineHeight,O=C.timeStamp;r=O;var I=b[0],N=I.clientX,F=I.clientY;if(Math.abs(c-N)+Math.abs(l-F)>A&&(s=-1),c=C.clientX=N,l=C.clientY=F,x=w=0,y=new f(C,h).getDocumentPosition(),O-s<500&&b.length==1&&!v)k++,C.preventDefault(),C.button=0,T();else{k=0;var z=h.selection.cursor,P=h.selection.isEmpty()?z:h.selection.anchor,W=h.renderer.$cursorLayer.getPixelPosition(z,!0),B=h.renderer.$cursorLayer.getPixelPosition(P,!0),H=h.renderer.scroller.getBoundingClientRect(),U=h.renderer.layerConfig.offset,G=h.renderer.scrollLeft,Y=function(le,$e){return le=le/_,$e=$e/A-.75,le*le+$e*$e};if(C.clientX<H.left){d="zoom";return}var q=Y(C.clientX-H.left-W.left+G,C.clientY-H.top-W.top+U),X=Y(C.clientX-H.left-B.left+G,C.clientY-H.top-B.top+U);q<3.5&&X<3.5&&(d=q>X?"cursor":"anchor"),X<3.5?d="anchor":q<3.5?d="cursor":d="scroll",a=setTimeout(D,450)}s=O},h),g.addListener(o,"touchend",function(C){S=h.$mouseHandler.isMousePressed=!1,p&&clearInterval(p),d=="zoom"?(d="",v=0):a?(h.selection.moveToPosition(y),v=0,R()):d=="scroll"?(E(),$()):R(),clearTimeout(a),a=null},h),g.addListener(o,"touchmove",function(C){a&&(clearTimeout(a),a=null);var b=C.touches;if(!(b.length>1||d=="zoom")){var A=b[0],_=c-A.clientX,O=l-A.clientY;if(d=="wait")if(_*_+O*O>4)d="cursor";else return C.preventDefault();c=A.clientX,l=A.clientY,C.clientX=A.clientX,C.clientY=A.clientY;var I=C.timeStamp,N=I-r;if(r=I,d=="scroll"){var F=new f(C,h);F.speed=1,F.wheelX=_,F.wheelY=O,10*Math.abs(_)<Math.abs(O)&&(_=0),10*Math.abs(O)<Math.abs(_)&&(O=0),N!=0&&(x=_/N,w=O/N),h._emit("mousewheel",F),F.propagationStopped||(x=w=0)}else{var z=new f(C,h).getDocumentPosition();d=="cursor"?h.selection.moveCursorToPosition(z):d=="anchor"&&h.selection.setSelectionAnchor(z.row,z.column),h.renderer.scrollCursorIntoView(z),C.preventDefault()}}},h);function E(){v+=60,p=setInterval(function(){v--<=0&&(clearInterval(p),p=null),Math.abs(x)<.01&&(x=0),Math.abs(w)<.01&&(w=0),v<20&&(x=.9*x),v<20&&(w=.9*w);var C=h.session.getScrollTop();h.renderer.scrollBy(10*x,10*w),C==h.session.getScrollTop()&&(v=0)},10)}}}),ace.define("ace/mouse/mouse_handler",["require","exports","module","ace/lib/event","ace/lib/useragent","ace/mouse/default_handlers","ace/mouse/default_gutter_handler","ace/mouse/mouse_event","ace/mouse/dragdrop_handler","ace/mouse/touch_handler","ace/config"],function(t,n,m){"use strict";var f=t("../lib/event"),g=t("../lib/useragent"),u=t("./default_handlers").DefaultHandlers,o=t("./default_gutter_handler").GutterHandler,h=t("./mouse_event").MouseEvent,d=t("./dragdrop_handler").DragdropHandler,c=t("./touch_handler").addTouchListeners,l=t("../config"),s=(function(){function r(a){this.$dragDelay,this.$dragEnabled,this.$mouseMoved,this.mouseEvent,this.$focusTimeout;var p=this;this.editor=a,new u(this),new o(this),new d(this);var v=function(x){(!document.hasFocus||!document.hasFocus()||!a.isFocused()&&document.activeElement==(a.textInput&&a.textInput.getElement()))&&window.focus(),a.focus(),setTimeout(function(){a.isFocused()||a.focus()})},y=a.renderer.getMouseEventTarget();f.addListener(y,"click",this.onMouseEvent.bind(this,"click"),a),f.addListener(y,"mousemove",this.onMouseMove.bind(this,"mousemove"),a),f.addMultiMouseDownListener([y,a.renderer.scrollBarV&&a.renderer.scrollBarV.inner,a.renderer.scrollBarH&&a.renderer.scrollBarH.inner,a.textInput&&a.textInput.getElement()].filter(Boolean),[400,300,250],this,"onMouseEvent",a),f.addMouseWheelListener(a.container,this.onMouseWheel.bind(this,"mousewheel"),a),c(a.container,a);var k=a.renderer.$gutter;f.addListener(k,"mousedown",this.onMouseEvent.bind(this,"guttermousedown"),a),f.addListener(k,"click",this.onMouseEvent.bind(this,"gutterclick"),a),f.addListener(k,"dblclick",this.onMouseEvent.bind(this,"gutterdblclick"),a),f.addListener(k,"mousemove",this.onMouseEvent.bind(this,"guttermousemove"),a),f.addListener(y,"mousedown",v,a),f.addListener(k,"mousedown",v,a),g.isIE&&a.renderer.scrollBarV&&(f.addListener(a.renderer.scrollBarV.element,"mousedown",v,a),f.addListener(a.renderer.scrollBarH.element,"mousedown",v,a)),a.on("mousemove",function(x){if(!(p.state||p.$dragDelay||!p.$dragEnabled)){var w=a.renderer.screenToTextCoordinates(x.x,x.y),S=a.session.selection.getRange(),M=a.renderer;!S.isEmpty()&&S.insideStart(w.row,w.column)?M.setCursorStyle("default"):M.setCursorStyle("")}},a)}return r.prototype.onMouseEvent=function(a,p){this.editor.session&&this.editor._emit(a,new h(p,this.editor))},r.prototype.onMouseMove=function(a,p){var v=this.editor._eventRegistry&&this.editor._eventRegistry.mousemove;!v||!v.length||this.editor._emit(a,new h(p,this.editor))},r.prototype.onMouseWheel=function(a,p){var v=new h(p,this.editor);v.speed=this.$scrollSpeed*2,v.wheelX=p.wheelX,v.wheelY=p.wheelY,this.editor._emit(a,v)},r.prototype.setState=function(a){this.state=a},r.prototype.captureMouse=function(a,p){this.x=a.x,this.y=a.y,this.isMousePressed=!0;var v=this.editor,y=this.editor.renderer;y.$isMousePressed=!0;var k=this,x=!0,w=function($){if($){if(g.isWebKit&&!$.which&&k.releaseMouse)return k.releaseMouse();k.x=$.clientX,k.y=$.clientY,p&&p($),k.mouseEvent=new h($,k.editor),k.$mouseMoved=!0}},S=function($){v.off("beforeEndOperation",R),x=!1,v.session&&M(),k[k.state+"End"]&&k[k.state+"End"]($),k.state="",k.isMousePressed=y.$isMousePressed=!1,y.$keepTextAreaAtCursor&&y.$moveTextAreaToCursor(),k.$onCaptureMouseMove=k.releaseMouse=null,$&&k.onMouseEvent("mouseup",$),v.endOperation()},M=function(){k[k.state]&&k[k.state](),k.$mouseMoved=!1},L=function(){x&&(M(),f.nextFrame(L))};if(g.isOldIE&&a.domEvent.type=="dblclick")return setTimeout(function(){S(a)});var R=function($){k.releaseMouse&&v.curOp.command.name&&v.curOp.selectionChanged&&(k[k.state+"End"]&&k[k.state+"End"](),k.state="",k.releaseMouse())};v.on("beforeEndOperation",R),v.startOperation({command:{name:"mouse"}}),k.$onCaptureMouseMove=w,k.releaseMouse=f.capture(this.editor.container,w,S),L()},r.prototype.cancelContextMenu=function(){var a=function(p){p&&p.domEvent&&p.domEvent.type!="contextmenu"||(this.editor.off("nativecontextmenu",a),p&&p.domEvent&&f.stopEvent(p.domEvent))}.bind(this);setTimeout(a,10),this.editor.on("nativecontextmenu",a)},r.prototype.destroy=function(){this.releaseMouse&&this.releaseMouse(),this.$tooltip&&this.$tooltip.destroy()},r})();s.prototype.releaseMouse=null,l.defineOptions(s.prototype,"mouseHandler",{scrollSpeed:{initialValue:2},dragDelay:{initialValue:g.isMac?150:0},dragEnabled:{initialValue:!0},focusTimeout:{initialValue:0}}),n.MouseHandler=s}),ace.define("ace/mouse/fold_handler",["require","exports","module","ace/lib/dom"],function(t,n,m){"use strict";var f=t("../lib/dom");n.FoldHandler=(function(){function g(u){u.on("click",function(o){var h=o.getDocumentPosition(),d=u.session,c=d.getFoldAt(h.row,h.column,1);c&&(o.getAccelKey()?d.removeFold(c):d.expandFold(c),o.stop());var l=o.domEvent&&o.domEvent.target;l&&f.hasCssClass(l,"ace_inline_button")&&f.hasCssClass(l,"ace_toggle_wrap")&&(d.setOption("wrap",!d.getUseWrapMode()),u.renderer.scrollCursorIntoView())}),u.on("gutterclick",function(o){if(u.renderer.$gutterLayer.getRegion(o)=="foldWidgets"){var h=o.getDocumentPosition().row,d=u.session;d.foldWidgets&&d.foldWidgets[h]&&u.session.onFoldWidgetClick(h,o),u.isFocused()||u.focus(),o.stop()}}),u.on("gutterdblclick",function(o){if(u.renderer.$gutterLayer.getRegion(o)=="foldWidgets"){var h=o.getDocumentPosition().row,d=u.session,c=d.getParentFoldRangeData(h,!0),l=c.range||c.firstRange;if(l){h=l.start.row;var s=d.getFoldAt(h,d.getLine(h).length,1);s?d.removeFold(s):(d.addFold("...",l),u.renderer.scrollCursorIntoView({row:l.start.row,column:0}))}o.stop()}})}return g})()}),ace.define("ace/keyboard/keybinding",["require","exports","module","ace/lib/keys","ace/lib/event"],function(t,n,m){"use strict";var f=t("../lib/keys"),g=t("../lib/event");n.KeyBinding=(function(){function u(o){this.$editor=o,this.$data={editor:o},this.$handlers=[],this.setDefaultHandler(o.commands)}return u.prototype.setDefaultHandler=function(o){this.removeKeyboardHandler(this.$defaultHandler),this.$defaultHandler=o,this.addKeyboardHandler(o,0)},u.prototype.setKeyboardHandler=function(o){var h=this.$handlers;if(h[h.length-1]!=o){for(;h[h.length-1]&&h[h.length-1]!=this.$defaultHandler;)this.removeKeyboardHandler(h[h.length-1]);this.addKeyboardHandler(o,1)}},u.prototype.addKeyboardHandler=function(o,h){if(o){typeof o=="function"&&!o.handleKeyboard&&(o.handleKeyboard=o);var d=this.$handlers.indexOf(o);d!=-1&&this.$handlers.splice(d,1),h==null?this.$handlers.push(o):this.$handlers.splice(h,0,o),d==-1&&o.attach&&o.attach(this.$editor)}},u.prototype.removeKeyboardHandler=function(o){var h=this.$handlers.indexOf(o);return h==-1?!1:(this.$handlers.splice(h,1),o.detach&&o.detach(this.$editor),!0)},u.prototype.getKeyboardHandler=function(){return this.$handlers[this.$handlers.length-1]},u.prototype.getStatusText=function(){var o=this.$data,h=o.editor;return this.$handlers.map(function(d){return d.getStatusText&&d.getStatusText(h,o)||""}).filter(Boolean).join(" ")},u.prototype.$callKeyboardHandlers=function(o,h,d,c){for(var l,s=!1,r=this.$editor.commands,a=this.$handlers.length;a--&&(l=this.$handlers[a].handleKeyboard(this.$data,o,h,d,c),!(!(!l||!l.command)&&(l.command=="null"?s=!0:s=r.exec(l.command,this.$editor,l.args,c),s&&c&&o!=-1&&l.passEvent!=!0&&l.command.passEvent!=!0&&g.stopEvent(c),s))););return!s&&o==-1&&(l={command:"insertstring"},s=r.exec("insertstring",this.$editor,h)),s&&this.$editor._signal&&this.$editor._signal("keyboardActivity",l),s},u.prototype.onCommandKey=function(o,h,d){var c=f.keyCodeToString(d);return this.$callKeyboardHandlers(h,c,d,o)},u.prototype.onTextInput=function(o){return this.$callKeyboardHandlers(-1,o)},u})()}),ace.define("ace/lib/bidiutil",["require","exports","module"],function(t,n,m){"use strict";var f=0,g=0,u=!1,o=!1,h=!1,d=[[0,3,0,1,0,0,0],[0,3,0,1,2,2,0],[0,3,0,17,2,0,1],[0,3,5,5,4,1,0],[0,3,21,21,4,0,1],[0,3,5,5,4,2,0]],c=[[2,0,1,1,0,1,0],[2,0,1,1,0,2,0],[2,0,2,1,3,2,0],[2,0,2,33,3,1,1]],l=0,s=1,r=0,a=1,p=2,v=3,y=4,k=5,x=6,w=7,S=8,M=9,L=10,R=11,$=12,D=13,T=14,E=15,C=16,b=17,A=18,_=[A,A,A,A,A,A,A,A,A,x,k,x,S,k,A,A,A,A,A,A,A,A,A,A,A,A,A,A,k,k,k,x,S,y,y,R,R,R,y,y,y,y,y,L,M,L,M,M,p,p,p,p,p,p,p,p,p,p,M,y,y,y,y,y,y,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,y,y,y,y,y,y,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,y,y,y,y,A,A,A,A,A,A,k,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,A,M,y,R,R,R,R,y,y,y,y,r,y,y,A,y,y,R,R,p,p,y,r,y,y,y,p,r,y,y,y,y,y],O=[S,S,S,S,S,S,S,S,S,S,S,A,A,A,r,a,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,S,k,D,T,E,C,b,M,R,R,R,R,R,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,M,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,y,S];function I(P,W,B,H){var U=f?c:d,G=null,Y=null,q=null,X=0,le=null,$e=null,Ne=-1,he=null,Le=null,lr=[];if(!H)for(he=0,H=[];he<B;he++)H[he]=z(P[he]);for(g=f,u=!1,o=!1,h=!1,Le=0;Le<B;Le++){if(G=X,lr[Le]=Y=F(P,H,lr,Le),X=U[G][Y],le=X&240,X&=15,W[Le]=q=U[X][5],le>0)if(le==16){for(he=Ne;he<Le;he++)W[he]=1;Ne=-1}else Ne=-1;if($e=U[X][6],$e)Ne==-1&&(Ne=Le);else if(Ne>-1){for(he=Ne;he<Le;he++)W[he]=q;Ne=-1}H[Le]==k&&(W[Le]=0),g|=q}if(h){for(he=0;he<B;he++)if(H[he]==x){W[he]=f;for(var Kt=he-1;Kt>=0&&H[Kt]==S;Kt--)W[Kt]=f}}}function N(P,W,B){if(!(g<P)){if(P==1&&f==s&&!o){B.reverse();return}for(var H=B.length,U=0,G,Y,q,X;U<H;){if(W[U]>=P){for(G=U+1;G<H&&W[G]>=P;)G++;for(Y=U,q=G-1;Y<q;Y++,q--)X=B[Y],B[Y]=B[q],B[q]=X;U=G}U++}}}function F(P,W,B,H){var U=W[H],G,Y,q,X;switch(U){case r:case a:u=!1;case y:case v:return U;case p:return u?v:p;case w:return u=!0,a;case S:return y;case M:return H<1||H+1>=W.length||(G=B[H-1])!=p&&G!=v||(Y=W[H+1])!=p&&Y!=v?y:(u&&(Y=v),Y==G?Y:y);case L:return G=H>0?B[H-1]:k,G==p&&H+1<W.length&&W[H+1]==p?p:y;case R:if(H>0&&B[H-1]==p)return p;if(u)return y;for(X=H+1,q=W.length;X<q&&W[X]==R;)X++;return X<q&&W[X]==p?p:y;case $:for(q=W.length,X=H+1;X<q&&W[X]==$;)X++;if(X<q){var le=P[H],$e=le>=1425&&le<=2303||le==64286;if(G=W[X],$e&&(G==a||G==w))return a}return H<1||(G=W[H-1])==k?y:B[H-1];case k:return u=!1,o=!0,f;case x:return h=!0,y;case D:case T:case C:case b:case E:u=!1;case A:return y}}function z(P){var W=P.charCodeAt(0),B=W>>8;return B==0?W>191?r:_[W]:B==5?/[\u0591-\u05f4]/.test(P)?a:r:B==6?/[\u0610-\u061a\u064b-\u065f\u06d6-\u06e4\u06e7-\u06ed]/.test(P)?$:/[\u0660-\u0669\u066b-\u066c]/.test(P)?v:W==1642?R:/[\u06f0-\u06f9]/.test(P)?p:w:B==32&&W<=8287?O[W&255]:B==254&&W>=65136?w:y}n.L=r,n.R=a,n.EN=p,n.ON_R=3,n.AN=4,n.R_H=5,n.B=6,n.RLE=7,n.DOT="·",n.doBidiReorder=function(P,W,B){if(P.length<2)return{};var H=P.split(""),U=new Array(H.length),G=new Array(H.length),Y=[];f=B?s:l,I(H,Y,H.length,W);for(var q=0;q<U.length;U[q]=q,q++);N(2,Y,U),N(1,Y,U);for(var q=0;q<U.length-1;q++)W[q]===v?Y[q]=n.AN:Y[q]===a&&(W[q]>w&&W[q]<D||W[q]===y||W[q]===A)?Y[q]=n.ON_R:q>0&&H[q-1]==="ل"&&/\u0622|\u0623|\u0625|\u0627/.test(H[q])&&(Y[q-1]=Y[q]=n.R_H,q++);H[H.length-1]===n.DOT&&(Y[H.length-1]=n.B),H[0]==="‫"&&(Y[0]=n.RLE);for(var q=0;q<U.length;q++)G[q]=Y[U[q]];return{logicalFromVisual:U,bidiLevels:G}},n.hasBidiCharacters=function(P,W){for(var B=!1,H=0;H<P.length;H++)W[H]=z(P.charAt(H)),!B&&(W[H]==a||W[H]==w||W[H]==v)&&(B=!0);return B},n.getVisualFromLogicalIdx=function(P,W){for(var B=0;B<W.logicalFromVisual.length;B++)if(W.logicalFromVisual[B]==P)return B;return 0}}),ace.define("ace/bidihandler",["require","exports","module","ace/lib/bidiutil","ace/lib/lang"],function(t,n,m){"use strict";var f=t("./lib/bidiutil"),g=t("./lib/lang"),u=/[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\u202B]/;n.BidiHandler=(function(){function o(h){this.session=h,this.bidiMap={},this.currentRow=null,this.bidiUtil=f,this.charWidths=[],this.EOL="¬",this.showInvisibles=!0,this.isRtlDir=!1,this.$isRtl=!1,this.line="",this.wrapIndent=0,this.EOF="¶",this.RLE="‫",this.contentWidth=0,this.fontMetrics=null,this.rtlLineOffset=0,this.wrapOffset=0,this.isMoveLeftOperation=!1,this.seenBidi=u.test(h.getValue())}return o.prototype.isBidiRow=function(h,d,c){return this.seenBidi?(h!==this.currentRow&&(this.currentRow=h,this.updateRowLine(d,c),this.updateBidiMap()),this.bidiMap.bidiLevels):!1},o.prototype.onChange=function(h){this.seenBidi?this.currentRow=null:h.action=="insert"&&u.test(h.lines.join(`
`))&&(this.seenBidi=!0,this.currentRow=null)},o.prototype.getDocumentRow=function(){var h=0,d=this.session.$screenRowCache;if(d.length){var c=this.session.$getRowCacheIndex(d,this.currentRow);c>=0&&(h=this.session.$docRowCache[c])}return h},o.prototype.getSplitIndex=function(){var h=0,d=this.session.$screenRowCache;if(d.length)for(var c,l=this.session.$getRowCacheIndex(d,this.currentRow);this.currentRow-h>0&&(c=this.session.$getRowCacheIndex(d,this.currentRow-h-1),c===l);)l=c,h++;else h=this.currentRow;return h},o.prototype.updateRowLine=function(h,d){h===void 0&&(h=this.getDocumentRow());var c=h===this.session.getLength()-1?this.EOF:this.EOL;if(this.wrapIndent=0,this.line=this.session.getLine(h),this.isRtlDir=this.$isRtl||this.line.charAt(0)===this.RLE,this.session.$useWrapMode){var l=this.session.$wrapData[h];l&&(d===void 0&&(d=this.getSplitIndex()),d>0&&l.length?(this.wrapIndent=l.indent,this.wrapOffset=this.wrapIndent*this.charWidths[f.L],this.line=d<l.length?this.line.substring(l[d-1],l[d]):this.line.substring(l[l.length-1])):this.line=this.line.substring(0,l[d]),d==l.length&&(this.line+=this.showInvisibles?c:f.DOT))}else this.line+=this.showInvisibles?c:f.DOT;var s=this.session,r=0,a;this.line=this.line.replace(/\t|[\u1100-\u2029, \u202F-\uFFE6]/g,function(p,v){return p==="	"||s.isFullWidth(p.charCodeAt(0))?(a=p==="	"?s.getScreenTabSize(v+r):2,r+=a-1,g.stringRepeat(f.DOT,a)):p}),this.isRtlDir&&(this.fontMetrics.$main.textContent=this.line.charAt(this.line.length-1)==f.DOT?this.line.substr(0,this.line.length-1):this.line,this.rtlLineOffset=this.contentWidth-this.fontMetrics.$main.getBoundingClientRect().width)},o.prototype.updateBidiMap=function(){var h=[];f.hasBidiCharacters(this.line,h)||this.isRtlDir?this.bidiMap=f.doBidiReorder(this.line,h,this.isRtlDir):this.bidiMap={}},o.prototype.markAsDirty=function(){this.currentRow=null},o.prototype.updateCharacterWidths=function(h){if(this.characterWidth!==h.$characterSize.width){this.fontMetrics=h;var d=this.characterWidth=h.$characterSize.width,c=h.$measureCharWidth("ה");this.charWidths[f.L]=this.charWidths[f.EN]=this.charWidths[f.ON_R]=d,this.charWidths[f.R]=this.charWidths[f.AN]=c,this.charWidths[f.R_H]=c*.45,this.charWidths[f.B]=this.charWidths[f.RLE]=0,this.currentRow=null}},o.prototype.setShowInvisibles=function(h){this.showInvisibles=h,this.currentRow=null},o.prototype.setEolChar=function(h){this.EOL=h},o.prototype.setContentWidth=function(h){this.contentWidth=h},o.prototype.isRtlLine=function(h){return this.$isRtl?!0:h!=null?this.session.getLine(h).charAt(0)==this.RLE:this.isRtlDir},o.prototype.setRtlDirection=function(h,d){for(var c=h.getCursorPosition(),l=h.selection.getSelectionAnchor().row;l<=c.row;l++)!d&&h.session.getLine(l).charAt(0)===h.session.$bidiHandler.RLE?h.session.doc.removeInLine(l,0,1):d&&h.session.getLine(l).charAt(0)!==h.session.$bidiHandler.RLE&&h.session.doc.insert({column:0,row:l},h.session.$bidiHandler.RLE)},o.prototype.getPosLeft=function(h){h-=this.wrapIndent;var d=this.line.charAt(0)===this.RLE?1:0,c=h>d?this.session.getOverwrite()?h:h-1:d,l=f.getVisualFromLogicalIdx(c,this.bidiMap),s=this.bidiMap.bidiLevels,r=0;!this.session.getOverwrite()&&h<=d&&s[l]%2!==0&&l++;for(var a=0;a<l;a++)r+=this.charWidths[s[a]];return!this.session.getOverwrite()&&h>d&&s[l]%2===0&&(r+=this.charWidths[s[l]]),this.wrapIndent&&(r+=this.isRtlDir?-1*this.wrapOffset:this.wrapOffset),this.isRtlDir&&(r+=this.rtlLineOffset),r},o.prototype.getSelections=function(h,d){var c=this.bidiMap,l=c.bidiLevels,s,r=[],a=0,p=Math.min(h,d)-this.wrapIndent,v=Math.max(h,d)-this.wrapIndent,y=!1,k=!1,x=0;this.wrapIndent&&(a+=this.isRtlDir?-1*this.wrapOffset:this.wrapOffset);for(var w,S=0;S<l.length;S++)w=c.logicalFromVisual[S],s=l[S],y=w>=p&&w<v,y&&!k?x=a:!y&&k&&r.push({left:x,width:a-x}),a+=this.charWidths[s],k=y;if(y&&S===l.length&&r.push({left:x,width:a-x}),this.isRtlDir)for(var M=0;M<r.length;M++)r[M].left+=this.rtlLineOffset;return r},o.prototype.offsetToCol=function(c){this.isRtlDir&&(c-=this.rtlLineOffset);var d=0,c=Math.max(c,0),l=0,s=0,r=this.bidiMap.bidiLevels,a=this.charWidths[r[s]];for(this.wrapIndent&&(c-=this.isRtlDir?-1*this.wrapOffset:this.wrapOffset);c>l+a/2;){if(l+=a,s===r.length-1){a=0;break}a=this.charWidths[r[++s]]}return s>0&&r[s-1]%2!==0&&r[s]%2===0?(c<l&&s--,d=this.bidiMap.logicalFromVisual[s]):s>0&&r[s-1]%2===0&&r[s]%2!==0?d=1+(c>l?this.bidiMap.logicalFromVisual[s]:this.bidiMap.logicalFromVisual[s-1]):this.isRtlDir&&s===r.length-1&&a===0&&r[s-1]%2===0||!this.isRtlDir&&s===0&&r[s]%2!==0?d=1+this.bidiMap.logicalFromVisual[s]:(s>0&&r[s-1]%2!==0&&a!==0&&s--,d=this.bidiMap.logicalFromVisual[s]),d===0&&this.isRtlDir&&d++,d+this.wrapIndent},o})()}),ace.define("ace/selection",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/lib/event_emitter","ace/range"],function(t,n,m){"use strict";var f=t("./lib/oop"),g=t("./lib/lang"),u=t("./lib/event_emitter").EventEmitter,o=t("./range").Range,h=(function(){function d(c){this.session=c,this.doc=c.getDocument(),this.clearSelection(),this.cursor=this.lead=this.doc.createAnchor(0,0),this.anchor=this.doc.createAnchor(0,0),this.$silent=!1;var l=this;this.cursor.on("change",function(s){l.$cursorChanged=!0,l.$silent||l._emit("changeCursor"),!l.$isEmpty&&!l.$silent&&l._emit("changeSelection"),!l.$keepDesiredColumnOnChange&&s.old.column!=s.value.column&&(l.$desiredColumn=null)}),this.anchor.on("change",function(){l.$anchorChanged=!0,!l.$isEmpty&&!l.$silent&&l._emit("changeSelection")})}return d.prototype.isEmpty=function(){return this.$isEmpty||this.anchor.row==this.lead.row&&this.anchor.column==this.lead.column},d.prototype.isMultiLine=function(){return!this.$isEmpty&&this.anchor.row!=this.cursor.row},d.prototype.getCursor=function(){return this.lead.getPosition()},d.prototype.setAnchor=function(c,l){this.$isEmpty=!1,this.anchor.setPosition(c,l)},d.prototype.getAnchor=function(){return this.$isEmpty?this.getSelectionLead():this.anchor.getPosition()},d.prototype.getSelectionLead=function(){return this.lead.getPosition()},d.prototype.isBackwards=function(){var c=this.anchor,l=this.lead;return c.row>l.row||c.row==l.row&&c.column>l.column},d.prototype.getRange=function(){var c=this.anchor,l=this.lead;return this.$isEmpty?o.fromPoints(l,l):this.isBackwards()?o.fromPoints(l,c):o.fromPoints(c,l)},d.prototype.clearSelection=function(){this.$isEmpty||(this.$isEmpty=!0,this._emit("changeSelection"))},d.prototype.selectAll=function(){this.$setSelection(0,0,Number.MAX_VALUE,Number.MAX_VALUE)},d.prototype.setRange=function(c,l){var s=l?c.end:c.start,r=l?c.start:c.end;this.$setSelection(s.row,s.column,r.row,r.column)},d.prototype.$setSelection=function(c,l,s,r){if(!this.$silent){var a=this.$isEmpty,p=this.inMultiSelectMode;this.$silent=!0,this.$cursorChanged=this.$anchorChanged=!1,this.anchor.setPosition(c,l),this.cursor.setPosition(s,r),this.$isEmpty=!o.comparePoints(this.anchor,this.cursor),this.$silent=!1,this.$cursorChanged&&this._emit("changeCursor"),(this.$cursorChanged||this.$anchorChanged||a!=this.$isEmpty||p)&&this._emit("changeSelection")}},d.prototype.$moveSelection=function(c){var l=this.lead;this.$isEmpty&&this.setSelectionAnchor(l.row,l.column),c.call(this)},d.prototype.selectTo=function(c,l){this.$moveSelection(function(){this.moveCursorTo(c,l)})},d.prototype.selectToPosition=function(c){this.$moveSelection(function(){this.moveCursorToPosition(c)})},d.prototype.moveTo=function(c,l){this.clearSelection(),this.moveCursorTo(c,l)},d.prototype.moveToPosition=function(c){this.clearSelection(),this.moveCursorToPosition(c)},d.prototype.selectUp=function(){this.$moveSelection(this.moveCursorUp)},d.prototype.selectDown=function(){this.$moveSelection(this.moveCursorDown)},d.prototype.selectRight=function(){this.$moveSelection(this.moveCursorRight)},d.prototype.selectLeft=function(){this.$moveSelection(this.moveCursorLeft)},d.prototype.selectLineStart=function(){this.$moveSelection(this.moveCursorLineStart)},d.prototype.selectLineEnd=function(){this.$moveSelection(this.moveCursorLineEnd)},d.prototype.selectFileEnd=function(){this.$moveSelection(this.moveCursorFileEnd)},d.prototype.selectFileStart=function(){this.$moveSelection(this.moveCursorFileStart)},d.prototype.selectWordRight=function(){this.$moveSelection(this.moveCursorWordRight)},d.prototype.selectWordLeft=function(){this.$moveSelection(this.moveCursorWordLeft)},d.prototype.getWordRange=function(c,l){if(typeof l>"u"){var s=c||this.lead;c=s.row,l=s.column}return this.session.getWordRange(c,l)},d.prototype.selectWord=function(){this.setSelectionRange(this.getWordRange())},d.prototype.selectAWord=function(){var c=this.getCursor(),l=this.session.getAWordRange(c.row,c.column);this.setSelectionRange(l)},d.prototype.getLineRange=function(c,l){var s=typeof c=="number"?c:this.lead.row,r,a=this.session.getFoldLine(s);return a?(s=a.start.row,r=a.end.row):r=s,l===!0?new o(s,0,r,this.session.getLine(r).length):new o(s,0,r+1,0)},d.prototype.selectLine=function(){this.setSelectionRange(this.getLineRange())},d.prototype.moveCursorUp=function(){this.moveCursorBy(-1,0)},d.prototype.moveCursorDown=function(){this.moveCursorBy(1,0)},d.prototype.wouldMoveIntoSoftTab=function(c,l,s){var r=c.column,a=c.column+l;return s<0&&(r=c.column-l,a=c.column),this.session.isTabStop(c)&&this.doc.getLine(c.row).slice(r,a).split(" ").length-1==l},d.prototype.moveCursorLeft=function(){var c=this.lead.getPosition(),l;if(l=this.session.getFoldAt(c.row,c.column,-1))this.moveCursorTo(l.start.row,l.start.column);else if(c.column===0)c.row>0&&this.moveCursorTo(c.row-1,this.doc.getLine(c.row-1).length);else{var s=this.session.getTabSize();this.wouldMoveIntoSoftTab(c,s,-1)&&!this.session.getNavigateWithinSoftTabs()?this.moveCursorBy(0,-s):this.moveCursorBy(0,-1)}},d.prototype.moveCursorRight=function(){var c=this.lead.getPosition(),l;if(l=this.session.getFoldAt(c.row,c.column,1))this.moveCursorTo(l.end.row,l.end.column);else if(this.lead.column==this.doc.getLine(this.lead.row).length)this.lead.row<this.doc.getLength()-1&&this.moveCursorTo(this.lead.row+1,0);else{var s=this.session.getTabSize(),c=this.lead;this.wouldMoveIntoSoftTab(c,s,1)&&!this.session.getNavigateWithinSoftTabs()?this.moveCursorBy(0,s):this.moveCursorBy(0,1)}},d.prototype.moveCursorLineStart=function(){var c=this.lead.row,l=this.lead.column,s=this.session.documentToScreenRow(c,l),r=this.session.screenToDocumentPosition(s,0),a=this.session.getDisplayLine(c,null,r.row,r.column).match(/^\s*/);a[0].length!=l&&!this.session.$useEmacsStyleLineStart&&(r.column+=a[0].length),this.moveCursorToPosition(r)},d.prototype.moveCursorLineEnd=function(){var c=this.lead,l=this.session.getDocumentLastRowColumnPosition(c.row,c.column);if(this.lead.column==l.column){var s=this.session.getLine(l.row);if(l.column==s.length){var r=s.search(/\s+$/);r>0&&(l.column=r)}}this.moveCursorTo(l.row,l.column)},d.prototype.moveCursorFileEnd=function(){var c=this.doc.getLength()-1,l=this.doc.getLine(c).length;this.moveCursorTo(c,l)},d.prototype.moveCursorFileStart=function(){this.moveCursorTo(0,0)},d.prototype.moveCursorLongWordRight=function(){var c=this.lead.row,l=this.lead.column,s=this.doc.getLine(c),r=s.substring(l);this.session.nonTokenRe.lastIndex=0,this.session.tokenRe.lastIndex=0;var a=this.session.getFoldAt(c,l,1);if(a){this.moveCursorTo(a.end.row,a.end.column);return}if(this.session.nonTokenRe.exec(r)&&(l+=this.session.nonTokenRe.lastIndex,this.session.nonTokenRe.lastIndex=0,r=s.substring(l)),l>=s.length){this.moveCursorTo(c,s.length),this.moveCursorRight(),c<this.doc.getLength()-1&&this.moveCursorWordRight();return}this.session.tokenRe.exec(r)&&(l+=this.session.tokenRe.lastIndex,this.session.tokenRe.lastIndex=0),this.moveCursorTo(c,l)},d.prototype.moveCursorLongWordLeft=function(){var c=this.lead.row,l=this.lead.column,s;if(s=this.session.getFoldAt(c,l,-1)){this.moveCursorTo(s.start.row,s.start.column);return}var r=this.session.getFoldStringAt(c,l,-1);r==null&&(r=this.doc.getLine(c).substring(0,l));var a=g.stringReverse(r);if(this.session.nonTokenRe.lastIndex=0,this.session.tokenRe.lastIndex=0,this.session.nonTokenRe.exec(a)&&(l-=this.session.nonTokenRe.lastIndex,a=a.slice(this.session.nonTokenRe.lastIndex),this.session.nonTokenRe.lastIndex=0),l<=0){this.moveCursorTo(c,0),this.moveCursorLeft(),c>0&&this.moveCursorWordLeft();return}this.session.tokenRe.exec(a)&&(l-=this.session.tokenRe.lastIndex,this.session.tokenRe.lastIndex=0),this.moveCursorTo(c,l)},d.prototype.$shortWordEndIndex=function(c){var l=0,s,r=/\s/,a=this.session.tokenRe;if(a.lastIndex=0,this.session.tokenRe.exec(c))l=this.session.tokenRe.lastIndex;else{for(;(s=c[l])&&r.test(s);)l++;if(l<1){for(a.lastIndex=0;(s=c[l])&&!a.test(s);)if(a.lastIndex=0,l++,r.test(s))if(l>2){l--;break}else{for(;(s=c[l])&&r.test(s);)l++;if(l>2)break}}}return a.lastIndex=0,l},d.prototype.moveCursorShortWordRight=function(){var c=this.lead.row,l=this.lead.column,s=this.doc.getLine(c),r=s.substring(l),a=this.session.getFoldAt(c,l,1);if(a)return this.moveCursorTo(a.end.row,a.end.column);if(l==s.length){var p=this.doc.getLength();do c++,r=this.doc.getLine(c);while(c<p&&/^\s*$/.test(r));/^\s+/.test(r)||(r=""),l=0}var v=this.$shortWordEndIndex(r);this.moveCursorTo(c,l+v)},d.prototype.moveCursorShortWordLeft=function(){var c=this.lead.row,l=this.lead.column,s;if(s=this.session.getFoldAt(c,l,-1))return this.moveCursorTo(s.start.row,s.start.column);var r=this.session.getLine(c).substring(0,l);if(l===0){do c--,r=this.doc.getLine(c);while(c>0&&/^\s*$/.test(r));l=r.length,/\s+$/.test(r)||(r="")}var a=g.stringReverse(r),p=this.$shortWordEndIndex(a);return this.moveCursorTo(c,l-p)},d.prototype.moveCursorWordRight=function(){this.session.$selectLongWords?this.moveCursorLongWordRight():this.moveCursorShortWordRight()},d.prototype.moveCursorWordLeft=function(){this.session.$selectLongWords?this.moveCursorLongWordLeft():this.moveCursorShortWordLeft()},d.prototype.moveCursorBy=function(c,l){var s=this.session.documentToScreenPosition(this.lead.row,this.lead.column),r;if(l===0&&(c!==0&&(this.session.$bidiHandler.isBidiRow(s.row,this.lead.row)?(r=this.session.$bidiHandler.getPosLeft(s.column),s.column=Math.round(r/this.session.$bidiHandler.charWidths[0])):r=s.column*this.session.$bidiHandler.charWidths[0]),this.$desiredColumn?s.column=this.$desiredColumn:this.$desiredColumn=s.column),c!=0&&this.session.lineWidgets&&this.session.lineWidgets[this.lead.row]){var a=this.session.lineWidgets[this.lead.row];c<0?c-=a.rowsAbove||0:c>0&&(c+=a.rowCount-(a.rowsAbove||0))}var p=this.session.screenToDocumentPosition(s.row+c,s.column,r);c!==0&&l===0&&p.row===this.lead.row&&(p.column,this.lead.column),this.moveCursorTo(p.row,p.column+l,l===0)},d.prototype.moveCursorToPosition=function(c){this.moveCursorTo(c.row,c.column)},d.prototype.moveCursorTo=function(c,l,s){var r=this.session.getFoldAt(c,l,1);r&&(c=r.start.row,l=r.start.column),this.$keepDesiredColumnOnChange=!0;var a=this.session.getLine(c);/[\uDC00-\uDFFF]/.test(a.charAt(l))&&a.charAt(l-1)&&(this.lead.row==c&&this.lead.column==l+1?l=l-1:l=l+1),this.lead.setPosition(c,l),this.$keepDesiredColumnOnChange=!1,s||(this.$desiredColumn=null)},d.prototype.moveCursorToScreen=function(c,l,s){var r=this.session.screenToDocumentPosition(c,l);this.moveCursorTo(r.row,r.column,s)},d.prototype.detach=function(){this.lead.detach(),this.anchor.detach()},d.prototype.fromOrientedRange=function(c){this.setSelectionRange(c,c.cursor==c.start),this.$desiredColumn=c.desiredColumn||this.$desiredColumn},d.prototype.toOrientedRange=function(c){var l=this.getRange();return c?(c.start.column=l.start.column,c.start.row=l.start.row,c.end.column=l.end.column,c.end.row=l.end.row):c=l,c.cursor=this.isBackwards()?c.start:c.end,c.desiredColumn=this.$desiredColumn,c},d.prototype.getRangeOfMovements=function(c){var l=this.getCursor();try{c(this);var s=this.getCursor();return o.fromPoints(l,s)}catch{return o.fromPoints(l,l)}finally{this.moveCursorToPosition(l)}},d.prototype.toJSON=function(){if(this.rangeCount)var c=this.ranges.map(function(l){var s=l.clone();return s.isBackwards=l.cursor==l.start,s});else{var c=this.getRange();c.isBackwards=this.isBackwards()}return c},d.prototype.fromJSON=function(c){if(c.start==null)if(this.rangeList&&c.length>1){this.toSingleRange(c[0]);for(var l=c.length;l--;){var s=o.fromPoints(c[l].start,c[l].end);c[l].isBackwards&&(s.cursor=s.start),this.addRange(s,!0)}return}else c=c[0];this.rangeList&&this.toSingleRange(c),this.setSelectionRange(c,c.isBackwards)},d.prototype.isEqual=function(c){if((c.length||this.rangeCount)&&c.length!=this.rangeCount)return!1;if(!c.length||!this.ranges)return this.getRange().isEqual(c);for(var l=this.ranges.length;l--;)if(!this.ranges[l].isEqual(c[l]))return!1;return!0},d})();h.prototype.setSelectionAnchor=h.prototype.setAnchor,h.prototype.getSelectionAnchor=h.prototype.getAnchor,h.prototype.setSelectionRange=h.prototype.setRange,f.implement(h.prototype,u),n.Selection=h}),ace.define("ace/tokenizer",["require","exports","module","ace/lib/report_error"],function(t,n,m){"use strict";var f=t("./lib/report_error").reportError,g=2e3,u=(function(){function o(h){this.splitRegex,this.states=h,this.regExps={},this.matchMappings={};for(var d in this.states){for(var c=this.states[d],l=[],s=0,r=this.matchMappings[d]={defaultToken:"text"},a="g",p=[],v=0;v<c.length;v++){var y=c[v];if(y.defaultToken&&(r.defaultToken=y.defaultToken),y.caseInsensitive&&a.indexOf("i")===-1&&(a+="i"),y.unicode&&a.indexOf("u")===-1&&(a+="u"),y.regex!=null){y.regex instanceof RegExp&&(y.regex=y.regex.toString().slice(1,-1));var k=y.regex,x=new RegExp("(?:("+k+")|(.))").exec("a").length-2;Array.isArray(y.token)?y.token.length==1||x==1?y.token=y.token[0]:x-1!=y.token.length?(this.reportError("number of classes and regexp groups doesn't match",{rule:y,groupCount:x-1}),y.token=y.token[0]):(y.tokenArray=y.token,y.token=null,y.onMatch=this.$arrayTokens):typeof y.token=="function"&&!y.onMatch&&(x>1?y.onMatch=this.$applyToken:y.onMatch=y.token),x>1&&(/\\\d/.test(y.regex)?k=y.regex.replace(/\\([0-9]+)/g,function(w,S){return"\\"+(parseInt(S,10)+s+1)}):(x=1,k=this.removeCapturingGroups(y.regex)),!y.splitRegex&&typeof y.token!="string"&&p.push(y)),r[s]=v,s+=x,l.push(k),y.onMatch||(y.onMatch=null)}}l.length||(r[0]=0,l.push("$")),p.forEach(function(w){w.splitRegex=this.createSplitterRegexp(w.regex,a)},this),this.regExps[d]=new RegExp("("+l.join(")|(")+")|($)",a)}}return o.prototype.$setMaxTokenCount=function(h){g=h|0},o.prototype.$applyToken=function(h){var d=this.splitRegex.exec(h).slice(1),c=this.token.apply(this,d);if(typeof c=="string")return[{type:c,value:h}];for(var l=[],s=0,r=c.length;s<r;s++)d[s]&&(l[l.length]={type:c[s],value:d[s]});return l},o.prototype.$arrayTokens=function(h){if(!h)return[];var d=this.splitRegex.exec(h);if(!d)return"text";for(var c=[],l=this.tokenArray,s=0,r=l.length;s<r;s++)d[s+1]&&(c[c.length]={type:l[s],value:d[s+1]});return c},o.prototype.removeCapturingGroups=function(h){return h.replace(/\\.|\[(?:\\.|[^\\\]])*|\(\?[:=!<]|(\()/g,function(d,c){return c?"(?:":d})},o.prototype.createSplitterRegexp=function(h,d){if(h.indexOf("(?=")!=-1){var c=0,l=!1,s={};h.replace(/(\\.)|(\((?:\?[=!])?)|(\))|([\[\]])/g,function(r,a,p,v,y,k){return l?l=y!="]":y?l=!0:v?(c==s.stack&&(s.end=k+1,s.stack=-1),c--):p&&(c++,p.length!=1&&(s.stack=c,s.start=k)),r}),s.end!=null&&/^\)*$/.test(h.substr(s.end))&&(h=h.substring(0,s.start)+h.substr(s.end))}return h.charAt(0)!="^"&&(h="^"+h),h.charAt(h.length-1)!="$"&&(h+="$"),new RegExp(h,(d||"").replace("g",""))},o.prototype.getLineTokens=function(h,d){if(d&&typeof d!="string"){var c=d.slice(0);d=c[0],d==="#tmp"&&(c.shift(),d=c.shift())}else var c=[];var l=d||"start",s=this.states[l];s||(l="start",s=this.states[l]);var r=this.matchMappings[l],a=this.regExps[l];a.lastIndex=0;for(var p,v=[],y=0,k=0,x={type:null,value:""};p=a.exec(h);){var w=r.defaultToken,S=null,M=p[0],L=a.lastIndex;if(L-M.length>y){var R=h.substring(y,L-M.length);x.type==w?x.value+=R:(x.type&&v.push(x),x={type:w,value:R})}for(var $=0;$<p.length-2;$++)if(p[$+1]!==void 0){S=s[r[$]],S.onMatch?w=S.onMatch(M,l,c,h):w=S.token,S.next&&(typeof S.next=="string"?l=S.next:l=S.next(l,c),s=this.states[l],s||(this.reportError("state doesn't exist",l),l="start",s=this.states[l]),r=this.matchMappings[l],y=L,a=this.regExps[l],a.lastIndex=L),S.consumeLineEnd&&(y=L);break}if(M){if(typeof w=="string")(!S||S.merge!==!1)&&x.type===w?x.value+=M:(x.type&&v.push(x),x={type:w,value:M});else if(w){x.type&&v.push(x),x={type:null,value:""};for(var $=0;$<w.length;$++)v.push(w[$])}}if(y==h.length)break;if(y=L,k++>g){for(k>2*h.length&&this.reportError("infinite loop with in ace tokenizer",{startState:d,line:h});y<h.length;)x.type&&v.push(x),x={value:h.substring(y,y+=500),type:"overflow"};l="start",c=[];break}}return x.type&&v.push(x),c.length>1&&c[0]!==l&&c.unshift("#tmp",l),{tokens:v,state:c.length?c:l}},o})();u.prototype.reportError=f,n.Tokenizer=u}),ace.define("ace/mode/text_highlight_rules",["require","exports","module","ace/lib/deep_copy"],function(t,n,m){"use strict";var f=t("../lib/deep_copy").deepCopy,g=function(){this.$rules={start:[{token:"empty_line",regex:"^$"},{defaultToken:"text"}]}};(function(){this.addRules=function(h,d){if(!d){for(var c in h)this.$rules[c]=h[c];return}for(var c in h){for(var l=h[c],s=0;s<l.length;s++){var r=l[s];(r.next||r.onMatch)&&(typeof r.next=="string"&&r.next.indexOf(d)!==0&&(r.next=d+r.next),r.nextState&&r.nextState.indexOf(d)!==0&&(r.nextState=d+r.nextState))}this.$rules[d+c]=l}},this.getRules=function(){return this.$rules},this.embedRules=function(h,d,c,l,s){var r=typeof h=="function"?new h().getRules():h;if(l)for(var a=0;a<l.length;a++)l[a]=d+l[a];else{l=[];for(var p in r)l.push(d+p)}if(this.addRules(r,d),c)for(var v=Array.prototype[s?"push":"unshift"],a=0;a<l.length;a++)v.apply(this.$rules[l[a]],f(c));this.$embeds||(this.$embeds=[]),this.$embeds.push(d)},this.getEmbeds=function(){return this.$embeds};var u=function(h,d){return(h!="start"||d.length)&&d.unshift(this.nextState,h),this.nextState},o=function(h,d){return d.shift(),d.shift()||"start"};this.normalizeRules=function(){var h=0,d=this.$rules;function c(l){var s=d[l];s.processed=!0;for(var r=0;r<s.length;r++){var a=s[r],p=null;Array.isArray(a)&&(p=a,a={}),!a.regex&&a.start&&(a.regex=a.start,a.next||(a.next=[]),a.next.push({defaultToken:a.token},{token:a.token+".end",regex:a.end||a.start,next:"pop"}),a.token=a.token+".start",a.push=!0);var v=a.next||a.push;if(v&&Array.isArray(v)){var y=a.stateName;y||(y=a.token,typeof y!="string"&&(y=y[0]||""),d[y]&&(y+=h++)),d[y]=v,a.next=y,c(y)}else v=="pop"&&(a.next=o);if(a.push&&(a.nextState=a.next||a.push,a.next=u,delete a.push),a.rules)for(var k in a.rules)d[k]?d[k].push&&d[k].push.apply(d[k],a.rules[k]):d[k]=a.rules[k];var x=typeof a=="string"?a:a.include;if(x&&(x==="$self"&&(x="start"),Array.isArray(x)?p=x.map(function(S){return d[S]}):p=d[x]),p){var w=[r,1].concat(p);a.noEscape&&(w=w.filter(function(S){return!S.next})),s.splice.apply(s,w),r--}a.keywordMap&&(a.token=this.createKeywordMapper(a.keywordMap,a.defaultToken||"text",a.caseInsensitive),delete a.defaultToken)}}Object.keys(d).forEach(c,this)},this.createKeywordMapper=function(h,d,c,l){var s=Object.create(null);return this.$keywordList=[],Object.keys(h).forEach(function(r){for(var a=h[r].split(l||"|"),p=a.length;p--;){var v=a[p];this.$keywordList.push(v),c&&(v=v.toLowerCase()),s[v]=r}},this),h=null,c?function(r){return s[r.toLowerCase()]||d}:function(r){return s[r]||d}},this.getKeywords=function(){return this.$keywords}}).call(g.prototype),n.TextHighlightRules=g}),ace.define("ace/mode/behaviour",["require","exports","module"],function(t,n,m){"use strict";var f=function(){this.$behaviours={}};(function(){this.add=function(g,u,o){switch(void 0){case this.$behaviours:this.$behaviours={};case this.$behaviours[g]:this.$behaviours[g]={}}this.$behaviours[g][u]=o},this.addBehaviours=function(g){for(var u in g)for(var o in g[u])this.add(u,o,g[u][o])},this.remove=function(g){this.$behaviours&&this.$behaviours[g]&&delete this.$behaviours[g]},this.inherit=function(g,u){if(typeof g=="function")var o=new g().getBehaviours(u);else var o=g.getBehaviours(u);this.addBehaviours(o)},this.getBehaviours=function(g){if(g){for(var u={},o=0;o<g.length;o++)this.$behaviours[g[o]]&&(u[g[o]]=this.$behaviours[g[o]]);return u}else return this.$behaviours}}).call(f.prototype),n.Behaviour=f}),ace.define("ace/token_iterator",["require","exports","module","ace/range"],function(t,n,m){"use strict";var f=t("./range").Range;n.TokenIterator=(function(){function g(u,o,h){this.$session=u,this.$row=o,this.$rowTokens=u.getTokens(o);var d=u.getTokenAt(o,h);this.$tokenIndex=d?d.index:-1}return g.prototype.stepBackward=function(){for(this.$tokenIndex-=1;this.$tokenIndex<0;){if(this.$row-=1,this.$row<0)return this.$row=0,null;this.$rowTokens=this.$session.getTokens(this.$row),this.$tokenIndex=this.$rowTokens.length-1}return this.$rowTokens[this.$tokenIndex]},g.prototype.stepForward=function(){this.$tokenIndex+=1;for(var u;this.$tokenIndex>=this.$rowTokens.length;){if(this.$row+=1,u||(u=this.$session.getLength()),this.$row>=u)return this.$row=u-1,null;this.$rowTokens=this.$session.getTokens(this.$row),this.$tokenIndex=0}return this.$rowTokens[this.$tokenIndex]},g.prototype.getCurrentToken=function(){return this.$rowTokens[this.$tokenIndex]},g.prototype.getCurrentTokenRow=function(){return this.$row},g.prototype.getCurrentTokenColumn=function(){var u=this.$rowTokens,o=this.$tokenIndex,h=u[o].start;if(h!==void 0)return h;for(h=0;o>0;)o-=1,h+=u[o].value.length;return h},g.prototype.getCurrentTokenPosition=function(){return{row:this.$row,column:this.getCurrentTokenColumn()}},g.prototype.getCurrentTokenRange=function(){var u=this.$rowTokens[this.$tokenIndex],o=this.getCurrentTokenColumn();return new f(this.$row,o,this.$row,o+u.value.length)},g})()}),ace.define("ace/mode/behaviour/cstyle",["require","exports","module","ace/lib/oop","ace/mode/behaviour","ace/token_iterator","ace/lib/lang"],function(t,n,m){"use strict";var f=t("../../lib/oop"),g=t("../behaviour").Behaviour,u=t("../../token_iterator").TokenIterator,o=t("../../lib/lang"),h=["text","paren.rparen","rparen","paren","punctuation.operator"],d=["text","paren.rparen","rparen","paren","punctuation.operator","comment"],c,l={},s={'"':'"',"'":"'"},r=function(v){var y=-1;if(v.multiSelect&&(y=v.selection.index,l.rangeCount!=v.multiSelect.rangeCount&&(l={rangeCount:v.multiSelect.rangeCount})),l[y])return c=l[y];c=l[y]={autoInsertedBrackets:0,autoInsertedRow:-1,autoInsertedLineEnd:"",maybeInsertedBrackets:0,maybeInsertedRow:-1,maybeInsertedLineStart:"",maybeInsertedLineEnd:""}},a=function(v,y,k,x){var w=v.end.row-v.start.row;return{text:k+y+x,selection:[0,v.start.column+1,w,v.end.column+(w?0:1)]}},p=function(v){v=v||{},this.add("braces","insertion",function(y,k,x,w,S){var M=x.getCursorPosition(),L=w.doc.getLine(M.row);if(S=="{"){r(x);var R=x.getSelectionRange(),$=w.doc.getTextRange(R),D=w.getTokenAt(M.row,M.column);if($!==""&&$!=="{"&&x.getWrapBehavioursEnabled())return a(R,$,"{","}");if(D&&/(?:string)\.quasi|\.xml/.test(D.type))return[/tag\-(?:open|name)/,/attribute\-name/].some(function(_){return _.test(D.type)})||/(string)\.quasi/.test(D.type)&&D.value[M.column-D.start-1]!=="$"?void 0:(p.recordAutoInsert(x,w,"}"),{text:"{}",selection:[1,1]});if(p.isSaneInsertion(x,w))return/[\]\}\)]/.test(L[M.column])||x.inMultiSelectMode||v.braces?(p.recordAutoInsert(x,w,"}"),{text:"{}",selection:[1,1]}):(p.recordMaybeInsert(x,w,"{"),{text:"{",selection:[1,1]})}else if(S=="}"){r(x);var T=L.substring(M.column,M.column+1);if(T=="}"&&w.$findOpeningBracket("}",{column:M.column+1,row:M.row})!==null&&p.isAutoInsertedClosing(M,L,S))return p.popAutoInsertedClosing(),{text:"",selection:[1,1]}}else if(S==`
`||S==`\r
`){r(x);var E="";p.isMaybeInsertedClosing(M,L)&&(E=o.stringRepeat("}",c.maybeInsertedBrackets),p.clearMaybeInsertedClosing());var T=L.substring(M.column,M.column+1);if(T==="}"){var C=w.findMatchingBracket({row:M.row,column:M.column+1},"}");if(!C)return null;var b=this.$getIndent(w.getLine(C.row))}else if(E)var b=this.$getIndent(L);else{p.clearMaybeInsertedClosing();return}var A=b+w.getTabString();return{text:`
`+A+`
`+b+E,selection:[1,A.length,1,A.length]}}else p.clearMaybeInsertedClosing()}),this.add("braces","deletion",function(y,k,x,w,S){var M=w.doc.getTextRange(S);if(!S.isMultiLine()&&M=="{"){if(r(x),w.doc.getLine(S.start.row).substring(S.end.column,S.end.column+1)=="}")return S.end.column++,S;c.maybeInsertedBrackets--}}),this.add("parens","insertion",function(y,k,x,w,S){if(S=="("){r(x);var M=x.getSelectionRange(),L=w.doc.getTextRange(M);if(L!==""&&x.getWrapBehavioursEnabled())return a(M,L,"(",")");if(p.isSaneInsertion(x,w))return p.recordAutoInsert(x,w,")"),{text:"()",selection:[1,1]}}else if(S==")"){r(x);var R=x.getCursorPosition(),$=w.doc.getLine(R.row);if($.substring(R.column,R.column+1)==")"&&w.$findOpeningBracket(")",{column:R.column+1,row:R.row})!==null&&p.isAutoInsertedClosing(R,$,S))return p.popAutoInsertedClosing(),{text:"",selection:[1,1]}}}),this.add("parens","deletion",function(y,k,x,w,S){var M=w.doc.getTextRange(S);if(!S.isMultiLine()&&M=="("&&(r(x),w.doc.getLine(S.start.row).substring(S.start.column+1,S.start.column+2)==")"))return S.end.column++,S}),this.add("brackets","insertion",function(y,k,x,w,S){if(S=="["){r(x);var M=x.getSelectionRange(),L=w.doc.getTextRange(M);if(L!==""&&x.getWrapBehavioursEnabled())return a(M,L,"[","]");if(p.isSaneInsertion(x,w))return p.recordAutoInsert(x,w,"]"),{text:"[]",selection:[1,1]}}else if(S=="]"){r(x);var R=x.getCursorPosition(),$=w.doc.getLine(R.row);if($.substring(R.column,R.column+1)=="]"&&w.$findOpeningBracket("]",{column:R.column+1,row:R.row})!==null&&p.isAutoInsertedClosing(R,$,S))return p.popAutoInsertedClosing(),{text:"",selection:[1,1]}}}),this.add("brackets","deletion",function(y,k,x,w,S){var M=w.doc.getTextRange(S);if(!S.isMultiLine()&&M=="["&&(r(x),w.doc.getLine(S.start.row).substring(S.start.column+1,S.start.column+2)=="]"))return S.end.column++,S}),this.add("string_dquotes","insertion",function(y,k,x,w,S){var M=w.$mode.$quotes||s;if(S.length==1&&M[S]){if(this.lineCommentStart&&this.lineCommentStart.indexOf(S)!=-1)return;r(x);var L=S,R=x.getSelectionRange(),$=w.doc.getTextRange(R);if($!==""&&($.length!=1||!M[$])&&x.getWrapBehavioursEnabled())return a(R,$,L,L);if(!$){var D=x.getCursorPosition(),T=w.doc.getLine(D.row),E=T.substring(D.column-1,D.column),C=T.substring(D.column,D.column+1),b=w.getTokenAt(D.row,D.column),A=w.getTokenAt(D.row,D.column+1);if(E=="\\"&&b&&/escape/.test(b.type))return null;var _=b&&/string|escape/.test(b.type),O=!A||/string|escape/.test(A.type),I;if(C==L)I=_!==O,I&&/string\.end/.test(A.type)&&(I=!1);else{if(_&&!O||_&&O)return null;var N=w.$mode.tokenRe;N.lastIndex=0;var F=N.test(E);N.lastIndex=0;var z=N.test(C),P=w.$mode.$pairQuotesAfter;if(!(P&&P[L]&&P[L].test(E))&&F||z||C&&!/[\s;,.})\]\\]/.test(C))return null;var W=T[D.column-2];if(E==L&&(W==L||N.test(W)))return null;I=!0}return{text:I?L+L:"",selection:[1,1]}}}}),this.add("string_dquotes","deletion",function(y,k,x,w,S){var M=w.$mode.$quotes||s,L=w.doc.getTextRange(S);if(!S.isMultiLine()&&M.hasOwnProperty(L)&&(r(x),w.doc.getLine(S.start.row).substring(S.start.column+1,S.start.column+2)==L))return S.end.column++,S}),v.closeDocComment!==!1&&this.add("doc comment end","insertion",function(y,k,x,w,S){if(y==="doc-start"&&(S===`
`||S===`\r
`)&&x.selection.isEmpty()){var M=x.getCursorPosition();if(M.column===0)return;for(var L=w.doc.getLine(M.row),R=w.doc.getLine(M.row+1),$=w.getTokens(M.row),D=0,T=0;T<$.length;T++){D+=$[T].value.length;var E=$[T];if(D>=M.column){if(D===M.column){if(!/\.doc/.test(E.type))return;if(/\*\//.test(E.value)){var C=$[T+1];if(!C||!/\.doc/.test(C.type))return}}var b=M.column-(D-E.value.length),A=E.value.indexOf("*/"),_=E.value.indexOf("/**",A>-1?A+2:0);if(_!==-1&&b>_&&b<_+3||A!==-1&&_!==-1&&b>=A&&b<=_||!/\.doc/.test(E.type))return;break}}var O=this.$getIndent(L);if(/\s*\*/.test(R))return/^\s*\*/.test(L)?{text:S+O+"* ",selection:[1,2+O.length,1,2+O.length]}:{text:S+O+" * ",selection:[1,3+O.length,1,3+O.length]};if(/\/\*\*/.test(L.substring(0,M.column)))return{text:S+O+" * "+S+" "+O+"*/",selection:[1,4+O.length,1,4+O.length]}}})};p.isSaneInsertion=function(v,y){var k=v.getCursorPosition(),x=new u(y,k.row,k.column);if(!this.$matchTokenType(x.getCurrentToken()||"text",h)){if(/[)}\]]/.test(v.session.getLine(k.row)[k.column]))return!0;var w=new u(y,k.row,k.column+1);if(!this.$matchTokenType(w.getCurrentToken()||"text",h))return!1}return x.stepForward(),x.getCurrentTokenRow()!==k.row||this.$matchTokenType(x.getCurrentToken()||"text",d)},p.$matchTokenType=function(v,y){return y.indexOf(v.type||v)>-1},p.recordAutoInsert=function(v,y,k){var x=v.getCursorPosition(),w=y.doc.getLine(x.row);this.isAutoInsertedClosing(x,w,c.autoInsertedLineEnd[0])||(c.autoInsertedBrackets=0),c.autoInsertedRow=x.row,c.autoInsertedLineEnd=k+w.substr(x.column),c.autoInsertedBrackets++},p.recordMaybeInsert=function(v,y,k){var x=v.getCursorPosition(),w=y.doc.getLine(x.row);this.isMaybeInsertedClosing(x,w)||(c.maybeInsertedBrackets=0),c.maybeInsertedRow=x.row,c.maybeInsertedLineStart=w.substr(0,x.column)+k,c.maybeInsertedLineEnd=w.substr(x.column),c.maybeInsertedBrackets++},p.isAutoInsertedClosing=function(v,y,k){return c.autoInsertedBrackets>0&&v.row===c.autoInsertedRow&&k===c.autoInsertedLineEnd[0]&&y.substr(v.column)===c.autoInsertedLineEnd},p.isMaybeInsertedClosing=function(v,y){return c.maybeInsertedBrackets>0&&v.row===c.maybeInsertedRow&&y.substr(v.column)===c.maybeInsertedLineEnd&&y.substr(0,v.column)==c.maybeInsertedLineStart},p.popAutoInsertedClosing=function(){c.autoInsertedLineEnd=c.autoInsertedLineEnd.substr(1),c.autoInsertedBrackets--},p.clearMaybeInsertedClosing=function(){c&&(c.maybeInsertedBrackets=0,c.maybeInsertedRow=-1)},f.inherits(p,g),n.CstyleBehaviour=p}),ace.define("ace/unicode",["require","exports","module"],function(t,n,m){"use strict";for(var f=[48,9,8,25,5,0,2,25,48,0,11,0,5,0,6,22,2,30,2,457,5,11,15,4,8,0,2,0,18,116,2,1,3,3,9,0,2,2,2,0,2,19,2,82,2,138,2,4,3,155,12,37,3,0,8,38,10,44,2,0,2,1,2,1,2,0,9,26,6,2,30,10,7,61,2,9,5,101,2,7,3,9,2,18,3,0,17,58,3,100,15,53,5,0,6,45,211,57,3,18,2,5,3,11,3,9,2,1,7,6,2,2,2,7,3,1,3,21,2,6,2,0,4,3,3,8,3,1,3,3,9,0,5,1,2,4,3,11,16,2,2,5,5,1,3,21,2,6,2,1,2,1,2,1,3,0,2,4,5,1,3,2,4,0,8,3,2,0,8,15,12,2,2,8,2,2,2,21,2,6,2,1,2,4,3,9,2,2,2,2,3,0,16,3,3,9,18,2,2,7,3,1,3,21,2,6,2,1,2,4,3,8,3,1,3,2,9,1,5,1,2,4,3,9,2,0,17,1,2,5,4,2,2,3,4,1,2,0,2,1,4,1,4,2,4,11,5,4,4,2,2,3,3,0,7,0,15,9,18,2,2,7,2,2,2,22,2,9,2,4,4,7,2,2,2,3,8,1,2,1,7,3,3,9,19,1,2,7,2,2,2,22,2,9,2,4,3,8,2,2,2,3,8,1,8,0,2,3,3,9,19,1,2,7,2,2,2,22,2,15,4,7,2,2,2,3,10,0,9,3,3,9,11,5,3,1,2,17,4,23,2,8,2,0,3,6,4,0,5,5,2,0,2,7,19,1,14,57,6,14,2,9,40,1,2,0,3,1,2,0,3,0,7,3,2,6,2,2,2,0,2,0,3,1,2,12,2,2,3,4,2,0,2,5,3,9,3,1,35,0,24,1,7,9,12,0,2,0,2,0,5,9,2,35,5,19,2,5,5,7,2,35,10,0,58,73,7,77,3,37,11,42,2,0,4,328,2,3,3,6,2,0,2,3,3,40,2,3,3,32,2,3,3,6,2,0,2,3,3,14,2,56,2,3,3,66,5,0,33,15,17,84,13,619,3,16,2,25,6,74,22,12,2,6,12,20,12,19,13,12,2,2,2,1,13,51,3,29,4,0,5,1,3,9,34,2,3,9,7,87,9,42,6,69,11,28,4,11,5,11,11,39,3,4,12,43,5,25,7,10,38,27,5,62,2,28,3,10,7,9,14,0,89,75,5,9,18,8,13,42,4,11,71,55,9,9,4,48,83,2,2,30,14,230,23,280,3,5,3,37,3,5,3,7,2,0,2,0,2,0,2,30,3,52,2,6,2,0,4,2,2,6,4,3,3,5,5,12,6,2,2,6,67,1,20,0,29,0,14,0,17,4,60,12,5,0,4,11,18,0,5,0,3,9,2,0,4,4,7,0,2,0,2,0,2,3,2,10,3,3,6,4,5,0,53,1,2684,46,2,46,2,132,7,6,15,37,11,53,10,0,17,22,10,6,2,6,2,6,2,6,2,6,2,6,2,6,2,6,2,31,48,0,470,1,36,5,2,4,6,1,5,85,3,1,3,2,2,89,2,3,6,40,4,93,18,23,57,15,513,6581,75,20939,53,1164,68,45,3,268,4,27,21,31,3,13,13,1,2,24,9,69,11,1,38,8,3,102,3,1,111,44,25,51,13,68,12,9,7,23,4,0,5,45,3,35,13,28,4,64,15,10,39,54,10,13,3,9,7,22,4,1,5,66,25,2,227,42,2,1,3,9,7,11171,13,22,5,48,8453,301,3,61,3,105,39,6,13,4,6,11,2,12,2,4,2,0,2,1,2,1,2,107,34,362,19,63,3,53,41,11,5,15,17,6,13,1,25,2,33,4,2,134,20,9,8,25,5,0,2,25,12,88,4,5,3,5,3,5,3,2],g=0,u=[],o=0;o<f.length;o+=2)u.push(g+=f[o]),f[o+1]&&u.push(45,g+=f[o+1]);n.wordChars=String.fromCharCode.apply(null,u)}),ace.define("ace/mode/text",["require","exports","module","ace/config","ace/tokenizer","ace/mode/text_highlight_rules","ace/mode/behaviour/cstyle","ace/unicode","ace/lib/lang","ace/token_iterator","ace/range"],function(t,n,m){"use strict";var f=t("../config"),g=t("../tokenizer").Tokenizer,u=t("./text_highlight_rules").TextHighlightRules,o=t("./behaviour/cstyle").CstyleBehaviour,h=t("../unicode"),d=t("../lib/lang"),c=t("../token_iterator").TokenIterator,l=t("../range").Range,s=function(){this.HighlightRules=u};(function(){this.$defaultBehaviour=new o,this.tokenRe=new RegExp("^["+h.wordChars+"\\$_]+","g"),this.nonTokenRe=new RegExp("^(?:[^"+h.wordChars+"\\$_]|\\s])+","g"),this.getTokenizer=function(){return this.$tokenizer||(this.$highlightRules=this.$highlightRules||new this.HighlightRules(this.$highlightRuleConfig),this.$tokenizer=new g(this.$highlightRules.getRules())),this.$tokenizer},this.lineCommentStart="",this.blockComment="",this.toggleCommentLines=function(r,a,p,v){var y=a.doc,k=!0,x=!0,w=1/0,S=a.getTabSize(),M=!1;if(this.lineCommentStart){if(Array.isArray(this.lineCommentStart))var $=this.lineCommentStart.map(d.escapeRegExp).join("|"),L=this.lineCommentStart[0];else var $=d.escapeRegExp(this.lineCommentStart),L=this.lineCommentStart;$=new RegExp("^(\\s*)(?:"+$+") ?"),M=a.getUseSoftTabs();var E=function(z,P){var W=z.match($);if(W){var B=W[1].length,H=W[0].length;!A(z,B,H)&&W[0][H-1]==" "&&H--,y.removeInLine(P,B,H)}},b=L+" ",T=function(z,P){(!k||/\S/.test(z))&&(A(z,w,w)?y.insertInLine({row:P,column:w},b):y.insertInLine({row:P,column:w},L))},C=function(z,P){return $.test(z)},A=function(z,P,W){for(var B=0;P--&&z.charAt(P)==" ";)B++;if(B%S!=0)return!1;for(var B=0;z.charAt(W++)==" ";)B++;return S>2?B%S!=S-1:B%S==0}}else{if(!this.blockComment)return!1;var L=this.blockComment.start,R=this.blockComment.end,$=new RegExp("^(\\s*)(?:"+d.escapeRegExp(L)+")"),D=new RegExp("(?:"+d.escapeRegExp(R)+")\\s*$"),T=function(I,N){C(I,N)||(!k||/\S/.test(I))&&(y.insertInLine({row:N,column:I.length},R),y.insertInLine({row:N,column:w},L))},E=function(I,N){var F;(F=I.match(D))&&y.removeInLine(N,I.length-F[0].length,I.length),(F=I.match($))&&y.removeInLine(N,F[1].length,F[0].length)},C=function(I,N){if($.test(I))return!0;for(var F=a.getTokens(N),z=0;z<F.length;z++)if(F[z].type==="comment")return!0}}function _(I){for(var N=p;N<=v;N++)I(y.getLine(N),N)}var O=1/0;_(function(I,N){var F=I.search(/\S/);F!==-1?(F<w&&(w=F),x&&!C(I,N)&&(x=!1)):O>I.length&&(O=I.length)}),w==1/0&&(w=O,k=!1,x=!1),M&&w%S!=0&&(w=Math.floor(w/S)*S),_(x?E:T)},this.toggleBlockComment=function(r,a,p,v){var y=this.blockComment;if(y){!y.start&&y[0]&&(y=y[0]);var k=new c(a,v.row,v.column),x=k.getCurrentToken();a.selection;var w=a.selection.toOrientedRange(),S,M;if(x&&/comment/.test(x.type)){for(var L,R;x&&/comment/.test(x.type);){var $=x.value.indexOf(y.start);if($!=-1){var D=k.getCurrentTokenRow(),T=k.getCurrentTokenColumn()+$;L=new l(D,T,D,T+y.start.length);break}x=k.stepBackward()}for(var k=new c(a,v.row,v.column),x=k.getCurrentToken();x&&/comment/.test(x.type);){var $=x.value.indexOf(y.end);if($!=-1){var D=k.getCurrentTokenRow(),T=k.getCurrentTokenColumn()+$;R=new l(D,T,D,T+y.end.length);break}x=k.stepForward()}R&&a.remove(R),L&&(a.remove(L),S=L.start.row,M=-y.start.length)}else M=y.start.length,S=p.start.row,a.insert(p.end,y.end),a.insert(p.start,y.start);w.start.row==S&&(w.start.column+=M),w.end.row==S&&(w.end.column+=M),a.selection.fromOrientedRange(w)}},this.getNextLineIndent=function(r,a,p){return this.$getIndent(a)},this.checkOutdent=function(r,a,p){return!1},this.autoOutdent=function(r,a,p){},this.$getIndent=function(r){return r.match(/^\s*/)[0]},this.createWorker=function(r){return null},this.createModeDelegates=function(r){this.$embeds=[],this.$modes={};for(var a in r)if(r[a]){var p=r[a],v=p.prototype.$id,y=f.$modes[v];y||(f.$modes[v]=y=new p),f.$modes[a]||(f.$modes[a]=y),this.$embeds.push(a),this.$modes[a]=y}for(var k=["toggleBlockComment","toggleCommentLines","getNextLineIndent","checkOutdent","autoOutdent","transformAction","getCompletions"],x=function(S){(function(M){var L=k[S],R=M[L];M[k[S]]=function(){return this.$delegator(L,arguments,R)}})(w)},w=this,a=0;a<k.length;a++)x(a)},this.$delegator=function(r,a,p){var v=a[0]||"start";if(typeof v!="string"){if(Array.isArray(v[2])){var y=v[2][v[2].length-1],k=this.$modes[y];if(k)return k[r].apply(k,[v[1]].concat([].slice.call(a,1)))}v=v[0]||"start"}for(var x=0;x<this.$embeds.length;x++)if(this.$modes[this.$embeds[x]]){var w=v.split(this.$embeds[x]);if(!w[0]&&w[1]){a[0]=w[1];var k=this.$modes[this.$embeds[x]];return k[r].apply(k,a)}}var S=p.apply(this,a);return p?S:void 0},this.transformAction=function(r,a,p,v,y){if(this.$behaviour){var k=this.$behaviour.getBehaviours();for(var x in k)if(k[x][a]){var w=k[x][a].apply(this,arguments);if(w)return w}}},this.getKeywords=function(r){if(!this.completionKeywords){var a=this.$tokenizer.rules,p=[];for(var v in a)for(var y=a[v],k=0,x=y.length;k<x;k++)if(typeof y[k].token=="string")/keyword|support|storage/.test(y[k].token)&&p.push(y[k].regex);else if(typeof y[k].token=="object"){for(var w=0,S=y[k].token.length;w<S;w++)if(/keyword|support|storage/.test(y[k].token[w])){var v=y[k].regex.match(/\(.+?\)/g)[w];p.push(v.substr(1,v.length-2))}}this.completionKeywords=p}return r?p.concat(this.$keywordList||[]):this.$keywordList},this.$createKeywordList=function(){return this.$highlightRules||this.getTokenizer(),this.$keywordList=this.$highlightRules.$keywordList||[]},this.getCompletions=function(r,a,p,v){return(this.$keywordList||this.$createKeywordList()).map(function(y){return{name:y,value:y,score:0,meta:"keyword"}})},this.$id="ace/mode/text"}).call(s.prototype),n.Mode=s}),ace.define("ace/line_widgets",["require","exports","module","ace/lib/dom"],function(t,n,m){"use strict";var f=t("./lib/dom");n.LineWidgets=(function(){function g(u){this.session=u,this.session.widgetManager=this,this.session.getRowLength=this.getRowLength,this.session.$getWidgetScreenLength=this.$getWidgetScreenLength,this.updateOnChange=this.updateOnChange.bind(this),this.renderWidgets=this.renderWidgets.bind(this),this.measureWidgets=this.measureWidgets.bind(this),this.session._changedWidgets=[],this.$onChangeEditor=this.$onChangeEditor.bind(this),this.session.on("change",this.updateOnChange),this.session.on("changeFold",this.updateOnFold),this.session.on("changeEditor",this.$onChangeEditor)}return g.prototype.getRowLength=function(u){var o;return this.lineWidgets?o=this.lineWidgets[u]&&this.lineWidgets[u].rowCount||0:o=0,!this.$useWrapMode||!this.$wrapData[u]?1+o:this.$wrapData[u].length+1+o},g.prototype.$getWidgetScreenLength=function(){var u=0;return this.lineWidgets.forEach(function(o){o&&o.rowCount&&!o.hidden&&(u+=o.rowCount)}),u},g.prototype.$onChangeEditor=function(u){this.attach(u.editor)},g.prototype.attach=function(u){u&&u.widgetManager&&u.widgetManager!=this&&u.widgetManager.detach(),this.editor!=u&&(this.detach(),this.editor=u,u&&(u.widgetManager=this,u.renderer.on("beforeRender",this.measureWidgets),u.renderer.on("afterRender",this.renderWidgets)))},g.prototype.detach=function(u){var o=this.editor;if(o){this.editor=null,o.widgetManager=null,o.renderer.off("beforeRender",this.measureWidgets),o.renderer.off("afterRender",this.renderWidgets);var h=this.session.lineWidgets;h&&h.forEach(function(d){d&&d.el&&d.el.parentNode&&(d._inDocument=!1,d.el.parentNode.removeChild(d.el))})}},g.prototype.updateOnFold=function(u,o){var h=o.lineWidgets;if(!(!h||!u.action)){for(var d=u.data,c=d.start.row,l=d.end.row,s=u.action=="add",r=c+1;r<l;r++)h[r]&&(h[r].hidden=s);h[l]&&(s?h[c]?h[l].hidden=s:h[c]=h[l]:(h[c]==h[l]&&(h[c]=void 0),h[l].hidden=s))}},g.prototype.updateOnChange=function(u){var o=this.session.lineWidgets;if(o){var h=u.start.row,d=u.end.row-h;if(d!==0)if(u.action=="remove"){var c=o.splice(h+1,d);!o[h]&&c[c.length-1]&&(o[h]=c.pop()),c.forEach(function(s){s&&this.removeLineWidget(s)},this),this.$updateRows()}else{var l=new Array(d);o[h]&&o[h].column!=null&&u.start.column>o[h].column&&h++,l.unshift(h,0),o.splice.apply(o,l),this.$updateRows()}}},g.prototype.$updateRows=function(){var u=this.session.lineWidgets;if(u){var o=!0;u.forEach(function(h,d){if(h)for(o=!1,h.row=d;h.$oldWidget;)h.$oldWidget.row=d,h=h.$oldWidget}),o&&(this.session.lineWidgets=null)}},g.prototype.$registerLineWidget=function(u){this.session.lineWidgets||(this.session.lineWidgets=new Array(this.session.getLength()));var o=this.session.lineWidgets[u.row];return o&&(u.$oldWidget=o,o.el&&o.el.parentNode&&(o.el.parentNode.removeChild(o.el),o._inDocument=!1)),this.session.lineWidgets[u.row]=u,u},g.prototype.addLineWidget=function(u){if(this.$registerLineWidget(u),u.session=this.session,!this.editor)return u;var o=this.editor.renderer;u.html&&!u.el&&(u.el=f.createElement("div"),u.el.innerHTML=u.html),u.text&&!u.el&&(u.el=f.createElement("div"),u.el.textContent=u.text),u.el&&(f.addCssClass(u.el,"ace_lineWidgetContainer"),u.className&&f.addCssClass(u.el,u.className),u.el.style.position="absolute",u.el.style.zIndex="5",o.container.appendChild(u.el),u._inDocument=!0,u.coverGutter||(u.el.style.zIndex="3"),u.pixelHeight==null&&(u.pixelHeight=u.el.offsetHeight)),u.rowCount==null&&(u.rowCount=u.pixelHeight/o.layerConfig.lineHeight);var h=this.session.getFoldAt(u.row,0);if(u.$fold=h,h){var d=this.session.lineWidgets;u.row==h.end.row&&!d[h.start.row]?d[h.start.row]=u:u.hidden=!0}return this.session._emit("changeFold",{data:{start:{row:u.row}}}),this.$updateRows(),this.renderWidgets(null,o),this.onWidgetChanged(u),u},g.prototype.removeLineWidget=function(u){if(u._inDocument=!1,u.session=null,u.el&&u.el.parentNode&&u.el.parentNode.removeChild(u.el),u.editor&&u.editor.destroy)try{u.editor.destroy()}catch{}if(this.session.lineWidgets){var o=this.session.lineWidgets[u.row];if(o==u)this.session.lineWidgets[u.row]=u.$oldWidget,u.$oldWidget&&this.onWidgetChanged(u.$oldWidget);else for(;o;){if(o.$oldWidget==u){o.$oldWidget=u.$oldWidget;break}o=o.$oldWidget}}this.session._emit("changeFold",{data:{start:{row:u.row}}}),this.$updateRows()},g.prototype.getWidgetsAtRow=function(u){for(var o=this.session.lineWidgets,h=o&&o[u],d=[];h;)d.push(h),h=h.$oldWidget;return d},g.prototype.onWidgetChanged=function(u){this.session._changedWidgets.push(u),this.editor&&this.editor.renderer.updateFull()},g.prototype.measureWidgets=function(u,o){var h=this.session._changedWidgets,d=o.layerConfig;if(!(!h||!h.length)){for(var c=1/0,l=0;l<h.length;l++){var s=h[l];if(!(!s||!s.el)&&s.session==this.session){if(!s._inDocument){if(this.session.lineWidgets[s.row]!=s)continue;s._inDocument=!0,o.container.appendChild(s.el)}s.h=s.el.offsetHeight,s.fixedWidth||(s.w=s.el.offsetWidth,s.screenWidth=Math.ceil(s.w/d.characterWidth));var r=s.h/d.lineHeight;s.coverLine&&(r-=this.session.getRowLineCount(s.row),r<0&&(r=0)),s.rowCount!=r&&(s.rowCount=r,s.row<c&&(c=s.row))}}c!=1/0&&(this.session._emit("changeFold",{data:{start:{row:c}}}),this.session.lineWidgetWidth=null),this.session._changedWidgets=[]}},g.prototype.renderWidgets=function(u,o){var h=o.layerConfig,d=this.session.lineWidgets;if(d){for(var c=Math.min(this.firstRow,h.firstRow),l=Math.max(this.lastRow,h.lastRow,d.length);c>0&&!d[c];)c--;this.firstRow=h.firstRow,this.lastRow=h.lastRow,o.$cursorLayer.config=h;for(var s=c;s<=l;s++){var r=d[s];if(!(!r||!r.el)){if(r.hidden){r.el.style.top=-100-(r.pixelHeight||0)+"px";continue}r._inDocument||(r._inDocument=!0,o.container.appendChild(r.el));var a=o.$cursorLayer.getPixelPosition({row:s,column:0},!0).top;r.coverLine||(a+=h.lineHeight*this.session.getRowLineCount(r.row)),r.el.style.top=a-h.offset+"px";var p=r.coverGutter?0:o.gutterWidth;r.fixedWidth||(p-=o.scrollLeft),r.el.style.left=p+"px",r.fullWidth&&r.screenWidth&&(r.el.style.minWidth=h.width+2*h.padding+"px"),r.fixedWidth?r.el.style.right=o.scrollBar.getWidth()+"px":r.el.style.right=""}}}},g})()}),ace.define("ace/apply_delta",["require","exports","module"],function(t,n,m){"use strict";n.applyDelta=function(f,g,u){var o=g.start.row,h=g.start.column,d=f[o]||"";switch(g.action){case"insert":if(g.lines.length===1)f[o]=d.substring(0,h)+g.lines[0]+d.substring(h);else{var c=[o,1].concat(g.lines);f.splice.apply(f,c),f[o]=d.substring(0,h)+f[o],f[o+g.lines.length-1]+=d.substring(h)}break;case"remove":var l=g.end.column,s=g.end.row;o===s?f[o]=d.substring(0,h)+d.substring(l):f.splice(o,s-o+1,d.substring(0,h)+f[s].substring(l));break}}}),ace.define("ace/anchor",["require","exports","module","ace/lib/oop","ace/lib/event_emitter"],function(t,n,m){"use strict";var f=t("./lib/oop"),g=t("./lib/event_emitter").EventEmitter,u=(function(){function d(c,l,s){this.$onChange=this.onChange.bind(this),this.attach(c),typeof l!="number"?this.setPosition(l.row,l.column):this.setPosition(l,s)}return d.prototype.getPosition=function(){return this.$clipPositionToDocument(this.row,this.column)},d.prototype.getDocument=function(){return this.document},d.prototype.onChange=function(c){if(!(c.start.row==c.end.row&&c.start.row!=this.row)&&!(c.start.row>this.row)){var l=h(c,{row:this.row,column:this.column},this.$insertRight);this.setPosition(l.row,l.column,!0)}},d.prototype.setPosition=function(c,l,s){var r;if(s?r={row:c,column:l}:r=this.$clipPositionToDocument(c,l),!(this.row==r.row&&this.column==r.column)){var a={row:this.row,column:this.column};this.row=r.row,this.column=r.column,this._signal("change",{old:a,value:r})}},d.prototype.detach=function(){this.document.off("change",this.$onChange)},d.prototype.attach=function(c){this.document=c||this.document,this.document.on("change",this.$onChange)},d.prototype.$clipPositionToDocument=function(c,l){var s={};return c>=this.document.getLength()?(s.row=Math.max(0,this.document.getLength()-1),s.column=this.document.getLine(s.row).length):c<0?(s.row=0,s.column=0):(s.row=c,s.column=Math.min(this.document.getLine(s.row).length,Math.max(0,l))),l<0&&(s.column=0),s},d})();u.prototype.$insertRight=!1,f.implement(u.prototype,g);function o(d,c,l){var s=l?d.column<=c.column:d.column<c.column;return d.row<c.row||d.row==c.row&&s}function h(d,c,l){var s=d.action=="insert",r=(s?1:-1)*(d.end.row-d.start.row),a=(s?1:-1)*(d.end.column-d.start.column),p=d.start,v=s?p:d.end;return o(c,p,l)?{row:c.row,column:c.column}:o(v,c,!l)?{row:c.row+r,column:c.column+(c.row==v.row?a:0)}:{row:p.row,column:p.column}}n.Anchor=u}),ace.define("ace/document",["require","exports","module","ace/lib/oop","ace/apply_delta","ace/lib/event_emitter","ace/range","ace/anchor"],function(t,n,m){"use strict";var f=t("./lib/oop"),g=t("./apply_delta").applyDelta,u=t("./lib/event_emitter").EventEmitter,o=t("./range").Range,h=t("./anchor").Anchor,d=(function(){function c(l){this.$lines=[""],l.length===0?this.$lines=[""]:Array.isArray(l)?this.insertMergedLines({row:0,column:0},l):this.insert({row:0,column:0},l)}return c.prototype.setValue=function(l){var s=this.getLength()-1;this.remove(new o(0,0,s,this.getLine(s).length)),this.insert({row:0,column:0},l||"")},c.prototype.getValue=function(){return this.getAllLines().join(this.getNewLineCharacter())},c.prototype.createAnchor=function(l,s){return new h(this,l,s)},c.prototype.$detectNewLine=function(l){var s=l.match(/^.*?(\r\n|\r|\n)/m);this.$autoNewLine=s?s[1]:`
...
`,"error_marker.css",!1)}),ace.define("ace/ace",["require","exports","module","ace/lib/dom","ace/range","ace/editor","ace/edit_session","ace/undomanager","ace/virtual_renderer","ace/worker/worker_client","ace/keyboard/hash_handler","ace/placeholder","ace/multi_select","ace/mode/folding/fold_mode","ace/theme/textmate","ace/ext/error_marker","ace/config","ace/loader_build"],function(t,n,m){"use strict";t("./loader_build")(n);var f=t("./lib/dom"),g=t("./range").Range,u=t("./editor").Editor,o=t("./edit_session").EditSession,h=t("./undomanager").UndoManager,d=t("./virtual_renderer").VirtualRenderer;t("./worker/worker_client"),t("./keyboard/hash_handler"),t("./placeholder"),t("./multi_select"),t("./mode/folding/fold_mode"),t("./theme/textmate"),t("./ext/error_marker"),n.config=t("./config"),n.edit=function(c,l){if(typeof c=="string"){var s=c;if(c=document.getElementById(s),!c)throw new Error("ace.edit can't find div #"+s)}if(c&&c.env&&c.env.editor instanceof u)return c.env.editor;var r="";if(c&&/input|textarea/i.test(c.tagName)){var a=c;r=a.value,c=f.createElement("pre"),a.parentNode.replaceChild(c,a)}else c&&(r=c.textContent,c.innerHTML="");var p=n.createEditSession(r),v=new u(new d(c),p,l),y={document:p,editor:v,onResize:v.resize.bind(v,null)};return a&&(y.textarea=a),v.on("destroy",function(){y.editor.container.env=null}),v.container.env=v.env=y,v},n.createEditSession=function(c,l){var s=new o(c,l);return s.setUndoManager(new h),s},n.Range=g,n.Editor=u,n.EditSession=o,n.UndoManager=h,n.VirtualRenderer=d,n.version=n.config.version}),(function(){ace.require(["ace/ace"],function(t){t&&(t.config.init(!0),t.define=ace.define);var n=(function(){return this})();!n&&typeof window<"u"&&(n=window),!n&&typeof self<"u"&&(n=self),n.ace||(n.ace=t);for(var m in t)t.hasOwnProperty(m)&&(n.ace[m]=t[m]);n.ace.default=n.ace,typeof i=="object"&&typeof e=="object"&&i&&(i.exports=n.ace)})})()})),ar=Et(Zd(),1),Qd="/formeo/assets/js/mode-json.min.js",Xd="/formeo/assets/js/theme-github_light_default.min.js",Jd=j(((e,i)=>{function t(n,m,f,g){var u=-1,o=n==null?0:n.length;for(g&&o&&(f=n[++u]);++u<o;)f=m(f,n[u],u,n);return f}i.exports=t})),eh=j(((e,i)=>{function t(n){return function(m){return n?.[m]}}i.exports=t})),th=j(((e,i)=>{var t=eh()({À:"A",Á:"A",Â:"A",Ã:"A",Ä:"A",Å:"A",à:"a",á:"a",â:"a",ã:"a",ä:"a",å:"a",Ç:"C",ç:"c",Ð:"D",ð:"d",È:"E",É:"E",Ê:"E",Ë:"E",è:"e",é:"e",ê:"e",ë:"e",Ì:"I",Í:"I",Î:"I",Ï:"I",ì:"i",í:"i",î:"i",ï:"i",Ñ:"N",ñ:"n",Ò:"O",Ó:"O",Ô:"O",Õ:"O",Ö:"O",Ø:"O",ò:"o",ó:"o",ô:"o",õ:"o",ö:"o",ø:"o",Ù:"U",Ú:"U",Û:"U",Ü:"U",ù:"u",ú:"u",û:"u",ü:"u",Ý:"Y",ý:"y",ÿ:"y",Æ:"Ae",æ:"ae",Þ:"Th",þ:"th",ß:"ss",Ā:"A",Ă:"A",Ą:"A",ā:"a",ă:"a",ą:"a",Ć:"C",Ĉ:"C",Ċ:"C",Č:"C",ć:"c",ĉ:"c",ċ:"c",č:"c",Ď:"D",Đ:"D",ď:"d",đ:"d",Ē:"E",Ĕ:"E",Ė:"E",Ę:"E",Ě:"E",ē:"e",ĕ:"e",ė:"e",ę:"e",ě:"e",Ĝ:"G",Ğ:"G",Ġ:"G",Ģ:"G",ĝ:"g",ğ:"g",ġ:"g",ģ:"g",Ĥ:"H",Ħ:"H",ĥ:"h",ħ:"h",Ĩ:"I",Ī:"I",Ĭ:"I",Į:"I",İ:"I",ĩ:"i",ī:"i",ĭ:"i",į:"i",ı:"i",Ĵ:"J",ĵ:"j",Ķ:"K",ķ:"k",ĸ:"k",Ĺ:"L",Ļ:"L",Ľ:"L",Ŀ:"L",Ł:"L",ĺ:"l",ļ:"l",ľ:"l",ŀ:"l",ł:"l",Ń:"N",Ņ:"N",Ň:"N",Ŋ:"N",ń:"n",ņ:"n",ň:"n",ŋ:"n",Ō:"O",Ŏ:"O",Ő:"O",ō:"o",ŏ:"o",ő:"o",Ŕ:"R",Ŗ:"R",Ř:"R",ŕ:"r",ŗ:"r",ř:"r",Ś:"S",Ŝ:"S",Ş:"S",Š:"S",ś:"s",ŝ:"s",ş:"s",š:"s",Ţ:"T",Ť:"T",Ŧ:"T",ţ:"t",ť:"t",ŧ:"t",Ũ:"U",Ū:"U",Ŭ:"U",Ů:"U",Ű:"U",Ų:"U",ũ:"u",ū:"u",ŭ:"u",ů:"u",ű:"u",ų:"u",Ŵ:"W",ŵ:"w",Ŷ:"Y",ŷ:"y",Ÿ:"Y",Ź:"Z",Ż:"Z",Ž:"Z",ź:"z",ż:"z",ž:"z",Ĳ:"IJ",ĳ:"ij",Œ:"Oe",œ:"oe",ŉ:"'n",ſ:"s"});i.exports=t})),ih=j(((e,i)=>{var t=th(),n=_i(),m=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,f=RegExp("[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]","g");function g(u){return u=n(u),u&&u.replace(m,t).replace(f,"")}i.exports=g})),nh=j(((e,i)=>{var t=/[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g;function n(m){return m.match(t)||[]}i.exports=n})),rh=j(((e,i)=>{var t=/[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;function n(m){return t.test(m)}i.exports=n})),oh=j(((e,i)=>{var t="\\ud800-\\udfff",n="\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff",m="\\u2700-\\u27bf",f="a-z\\xdf-\\xf6\\xf8-\\xff",g="\\xac\\xb1\\xd7\\xf7",u="\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf",o="\\u2000-\\u206f",h=" \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",d="A-Z\\xc0-\\xd6\\xd8-\\xde",c="\\ufe0e\\ufe0f",l=g+u+o+h,s="['’]",r="["+l+"]",a="["+n+"]",p="\\d+",v="["+m+"]",y="["+f+"]",k="[^"+t+l+p+m+f+d+"]",x="(?:"+a+"|\\ud83c[\\udffb-\\udfff])",w="[^"+t+"]",S="(?:\\ud83c[\\udde6-\\uddff]){2}",M="[\\ud800-\\udbff][\\udc00-\\udfff]",L="["+d+"]",R="\\u200d",$="(?:"+y+"|"+k+")",D="(?:"+L+"|"+k+")",T="(?:"+s+"(?:d|ll|m|re|s|t|ve))?",E="(?:"+s+"(?:D|LL|M|RE|S|T|VE))?",C=x+"?",b="["+c+"]?",A="(?:"+R+"(?:"+[w,S,M].join("|")+")"+b+C+")*",_="\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",O="\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",I=b+C+A,N="(?:"+[v,S,M].join("|")+")"+I,F=RegExp([L+"?"+y+"+"+T+"(?="+[r,L,"$"].join("|")+")",D+"+"+E+"(?="+[r,L+$,"$"].join("|")+")",L+"?"+$+"+"+T,L+"+"+E,O,_,p,N].join("|"),"g");function z(P){return P.match(F)||[]}i.exports=z})),sh=j(((e,i)=>{var t=nh(),n=rh(),m=_i(),f=oh();function g(u,o,h){return u=m(u),o=h?void 0:o,o===void 0?n(u)?f(u):t(u):u.match(o)||[]}i.exports=g})),ah=j(((e,i)=>{var t=Jd(),n=ih(),m=sh(),f=RegExp("['’]","g");function g(u){return function(o){return t(m(n(o).replace(f,"")),u,"")}}i.exports=g})),lh=j(((e,i)=>{function t(n,m,f){var g=-1,u=n.length;m<0&&(m=-m>u?0:u+m),f=f>u?u:f,f<0&&(f+=u),u=m>f?0:f-m>>>0,m>>>=0;for(var o=Array(u);++g<u;)o[g]=n[g+m];return o}i.exports=t})),ch=j(((e,i)=>{var t=lh();function n(m,f,g){var u=m.length;return g=g===void 0?u:g,!f&&g>=u?m:t(m,f,g)}i.exports=n})),bs=j(((e,i)=>{var t=RegExp("[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\ufe0e\\ufe0f]");function n(m){return t.test(m)}i.exports=n})),uh=j(((e,i)=>{function t(n){return n.split("")}i.exports=t})),dh=j(((e,i)=>{var t="\\ud800-\\udfff",n="\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff",m="\\ufe0e\\ufe0f",f="["+t+"]",g="["+n+"]",u="\\ud83c[\\udffb-\\udfff]",o="(?:"+g+"|"+u+")",h="[^"+t+"]",d="(?:\\ud83c[\\udde6-\\uddff]){2}",c="[\\ud800-\\udbff][\\udc00-\\udfff]",l="\\u200d",s=o+"?",r="["+m+"]?",a="(?:"+l+"(?:"+[h,d,c].join("|")+")"+r+s+")*",p=r+s+a,v="(?:"+[h+g+"?",g,d,c,f].join("|")+")",y=RegExp(u+"(?="+u+")|"+v+p,"g");function k(x){return x.match(y)||[]}i.exports=k})),hh=j(((e,i)=>{var t=uh(),n=bs(),m=dh();function f(g){return n(g)?m(g):t(g)}i.exports=f})),ph=j(((e,i)=>{var t=ch(),n=bs(),m=hh(),f=_i();function g(u){return function(o){o=f(o);var h=n(o)?m(o):void 0,d=h?h[0]:o.charAt(0),c=h?t(h,1).join(""):o.slice(1);return d[u]()+c}}i.exports=g})),fh=j(((e,i)=>{var t=ph()("toUpperCase");i.exports=t})),gh=j(((e,i)=>{var t=ah(),n=fh(),m=t(function(f,g,u){return f+(u?" ":"")+n(g)});i.exports=m})),mh=Et(gh(),1);ar.config.setModuleUrl("ace/mode/json",Qd);ar.config.setModuleUrl("ace/theme/github_light_default",Xd);var qe=ar.default.edit("formData-editor");qe.session.setOption("useWorker",!1);qe.setOptions({theme:"ace/theme/github_light_default",mode:"ace/mode/json"});var vh=document.getElementById("submit-formData"),yh=document.getElementById("formData-popover"),bh=document.getElementById("editor-action-buttons"),wh=(e,i)=>({renderForm:()=>{const t=document.querySelector(".render-form");t.style.display="block",i.render(e.formData)},getHtml:()=>{i.formData=e.formData;const t=i.html,n=window.open("","_blank");n.document.body.innerHTML=t},getUserData:()=>{console.log(i.userData),console.log("User Form Data:",i.userFormData)},resetEditor:()=>{window.sessionStorage.removeItem("formeo-formData"),window.location.reload()},editData:()=>{qe.setValue(JSON.stringify(e.formData,null,2),1)},toggleDark:()=>document.body.classList.toggle("formeo-dark")}),Ch={editData:{popovertarget:"formData-popover"}},Sh=e=>({id:e,type:"button",...Ch[e]||{}}),xh=(e,i)=>{vh.addEventListener("click",()=>{e.formData=qe.session.getValue(),yh.hidePopover()});const t=wh(e,i);return Object.entries(t).map(([n,m])=>{const f=Sh(n),g=Object.assign(document.createElement("button"),f);for(const[o,h]of Object.entries(f))g.setAttribute(o,h);const u=document.createTextNode((0,mh.default)(n));return g.appendChild(u),g.addEventListener("click",m,!1),bh.appendChild(g),g})};document.getElementById("format-json").addEventListener("click",Eh);document.getElementById("collapse-json").addEventListener("click",Ah);document.getElementById("copy-json").addEventListener("click",kh);function Eh(){const e=qe.session.getValue(),i=JSON.parse(e);qe.setValue(JSON.stringify(i,null,2),1)}function Ah(){const e=qe.session.getValue(),i=JSON.parse(e);qe.setValue(JSON.stringify(i,null,0),1)}async function kh({target:e}){const i=e.textContent;e.textContent="Copied!";const t=setTimeout(()=>{e.textContent=i,clearTimeout(t)},3e3);try{await navigator.clipboard.writeText(qe.session.getValue()),console.log("Text copied to clipboard")}catch(n){console.error("Failed to copy: ",n)}}var Th=e=>{const i=document.getElementById("control-filter"),t=document.getElementById("locale"),n=globalThis.sessionStorage.getItem("formeo-locale"),m=({target:{value:g}})=>e.controls.actions.filter(g),f=({target:{value:g}})=>{globalThis.sessionStorage.setItem("formeo-locale",g),e.i18n.setLang(g)};i.addEventListener("input",m),t.value=n||"en-US",t.addEventListener("change",f,!1)};async function Mh(e){e.innerHTML=`
    <form class="build-form"></form>
    <div class="render-form"></div>
  `;const i=new rr(jt),t=new or(sr);return xh(i,t),Th(i),{editor:i,renderer:t,cleanup:()=>{i?.destroy&&i.destroy(),t?.destroy&&t.destroy();const n=document.getElementById("editor-action-buttons");n&&(n.innerHTML="")}}}var $h=class{constructor(){if(this.currentFramework=null,this.frameworkContainer=document.getElementById("framework-container"),this.frameworkSelect=document.getElementById("framework-select"),this.currentDemo=null,this.isLoading=!1,this.validFrameworks=["vanilla","angular","react"],!this.frameworkContainer){console.error("Framework container not found");return}if(!this.frameworkSelect){console.error("Framework selector not found");return}this.init()}init(){this.frameworkSelect.addEventListener("change",i=>{this.switchFramework(i.target.value)}),window.addEventListener("popstate",()=>{const i=this.getFrameworkFromURL();this.switchFramework(i,{updateURL:!1})});const e=this.getFrameworkFromURL();this.switchFramework(e)}async switchFramework(e,i={}){const{updateURL:t=!0}=i;if(this.isLoading){console.warn("Framework switch already in progress");return}if(!(this.currentFramework===e&&this.currentDemo!==null)){this.isLoading=!0,this.showLoadingState();try{switch(await this.cleanupCurrentDemo(),this.frameworkContainer.innerHTML="",e){case"vanilla":this.currentDemo=await Mh(this.frameworkContainer);break;case"angular":this.currentDemo=await Id(this.frameworkContainer);break;case"react":this.currentDemo=await Bd(this.frameworkContainer);break;default:throw new Error(`Unknown framework: ${e}`)}this.currentFramework=e,this.syncFrameworkSelector(e),t&&this.updateURL(e),console.log(`Loaded ${e} demo successfully`)}catch(n){console.error(`Failed to load ${e} demo:`,n),this.showErrorState(e,n)}finally{this.isLoading=!1}}}async cleanupCurrentDemo(){if(this.currentDemo?.cleanup)try{await Promise.resolve(this.currentDemo.cleanup())}catch(e){console.warn("Error during demo cleanup:",e)}this.currentDemo=null}syncFrameworkSelector(e){this.frameworkSelect.value!==e&&(this.frameworkSelect.value=e)}getFrameworkFromURL(){const e=new URLSearchParams(window.location.search).get("framework");return e&&this.validFrameworks.includes(e)?e:"vanilla"}updateURL(e){const i=new URL(window.location);e==="vanilla"?i.searchParams.delete("framework"):i.searchParams.set("framework",e),window.history.pushState({framework:e},"",i.toString())}showLoadingState(){this.frameworkContainer.innerHTML=`
      <div class="loading-message">
    ...
    `}};document.addEventListener("DOMContentLoaded",()=>{window.frameworkLoader=new $h});export{Z as i,je as n,De as r,rd as t};
