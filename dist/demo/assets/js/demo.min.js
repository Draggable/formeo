...
npm install formeo</code></pre>
          ...
          <div class="guide-section">
            ...
            <pre><code class="language-typescript">${Zo(Zm)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>3. Service for Formeo Management (Optional)</h4>
            <pre><code class="language-typescript">${Zo(Xm)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>4. Module Configuration</h4>
            <pre><code class="language-typescript">${Zo(Qm)}</code></pre>
          </div>
        </div>
    ...
    `;const t=await Ym();mu();const n=l.querySelector("#toggle-instructions"),p=l.querySelector("#instructions-section"),d=n.querySelector(".toggle-text"),g=n.querySelector(".toggle-icon");return n&&p&&n.addEventListener("click",()=>{const m=p.style.display==="block";p.style.display=m?"none":"block",d.textContent=m?"Show Implementation Guide":"Hide Implementation Guide",g.textContent=m?"▼":"▲",m||setTimeout(()=>mu(),50)}),{angularApp:t,cleanup:()=>{t?.destroy&&t.destroy();const m=document.getElementById("angular-app-root");m&&(m.innerHTML="")}}}catch(e){return console.error("Failed to load Angular demo:",e),l.innerHTML=`
      <div class="angular-demo">
        <h3>Angular Integration Demo</h3>
    ...
    `,{cleanup:()=>{}}}}async function Gm(){await new Promise(l=>setTimeout(l,500)),console.log("Angular-style demo environment ready")}async function qm(){if(window.hljs)return window.hljs;try{const l=document.createElement("link");return l.rel="stylesheet",l.href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css",document.head.appendChild(l),Km(),await Yo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"),await Yo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/typescript.min.js"),await Yo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/bash.min.js"),window.hljs}catch(l){return console.warn("Failed to load Highlight.js:",l),null}}function Km(){const l=document.createElement("style");l.textContent=`
  ...
  `,document.head.appendChild(l)}function Yo(l){return new Promise((e,t)=>{const n=document.createElement("script");n.src=l,n.onload=e,n.onerror=t,document.head.appendChild(n)})}function mu(){window.hljs?document.querySelectorAll("pre code").forEach(l=>{try{window.hljs.highlightElement(l)}catch(e){console.warn("Failed to highlight code block:",e)}}):document.querySelectorAll("pre code").forEach(l=>{l.style.fontFamily="'Monaco', 'Menlo', 'Ubuntu Mono', monospace",l.style.fontSize="14px",l.style.lineHeight="1.5"})}async function Ym(){const l=document.getElementById("angular-app-root");if(!l)return null;l.innerHTML=`
...
npm install --save-dev @types/react @types/react-dom typescript</code></pre>
    ...
    `;const t=await iv();vu();const n=l.querySelector("#toggle-instructions"),p=l.querySelector("#instructions-section"),d=n.querySelector(".toggle-text"),g=n.querySelector(".toggle-icon");return n&&p&&n.addEventListener("click",()=>{const m=p.style.display==="block";p.style.display=m?"none":"block",d.textContent=m?"Show Implementation Guide":"Hide Implementation Guide",g.textContent=m?"▼":"▲",m||setTimeout(()=>vu(),50)}),{reactApp:t,cleanup:()=>{t?.cleanup&&t.cleanup();const m=document.getElementById("react-app-root");m&&(m.innerHTML="")}}}catch(e){return console.error("Failed to load React demo:",e),l.innerHTML=`
      <div class="react-demo">
        <h3>React Integration Demo</h3>
        <div class="error-message">
  ...
  `,document.head.appendChild(l)}function Xo(l){return new Promise((e,t)=>{const n=document.createElement("script");n.src=l,n.onload=e,n.onerror=t,document.head.appendChild(n)})}function vu(){window.hljs?document.querySelectorAll("pre code").forEach(l=>{try{window.hljs.highlightElement(l)}catch(e){console.warn("Failed to highlight code block:",e)}}):document.querySelectorAll("pre code").forEach(l=>{l.style.fontFamily="'Monaco', 'Menlo', 'Ubuntu Mono', monospace",l.style.fontSize="14px",l.style.lineHeight="1.5"})}async function iv(){const l=document.getElementById("react-app-root");if(!l)return null;l.innerHTML=`
...
`,"error_marker.css",!1)}),ace.define("ace/ace",["require","exports","module","ace/lib/dom","ace/range","ace/editor","ace/edit_session","ace/undomanager","ace/virtual_renderer","ace/worker/worker_client","ace/keyboard/hash_handler","ace/placeholder","ace/multi_select","ace/mode/folding/fold_mode","ace/theme/textmate","ace/ext/error_marker","ace/config","ace/loader_build"],function(t,n,p){t("./loader_build")(n);var d=t("./lib/dom"),g=t("./range").Range,m=t("./editor").Editor,c=t("./edit_session").EditSession,f=t("./undomanager").UndoManager,r=t("./virtual_renderer").VirtualRenderer;t("./worker/worker_client"),t("./keyboard/hash_handler"),t("./placeholder"),t("./multi_select"),t("./mode/folding/fold_mode"),t("./theme/textmate"),t("./ext/error_marker"),n.config=t("./config"),n.edit=function(s,a){if(typeof s=="string"){var i=s;if(s=document.getElementById(i),!s)throw new Error("ace.edit can't find div #"+i)}if(s&&s.env&&s.env.editor instanceof m)return s.env.editor;var u="";if(s&&/input|textarea/i.test(s.tagName)){var h=s;u=h.value,s=d.createElement("pre"),h.parentNode.replaceChild(s,h)}else s&&(u=s.textContent,s.innerHTML="");var y=n.createEditSession(u),w=new m(new r(s),y,a),M={document:y,editor:w,onResize:w.resize.bind(w,null)};return h&&(M.textarea=h),w.on("destroy",function(){M.editor.container.env=null}),w.container.env=w.env=M,w},n.createEditSession=function(s,a){var i=new c(s,a);return i.setUndoManager(new f),i},n.Range=g,n.Editor=m,n.EditSession=c,n.UndoManager=f,n.VirtualRenderer=r;var o=n.config.version;n.version=o}),(function(){ace.require(["ace/ace"],function(t){t&&(t.config.init(!0),t.define=ace.define);var n=(function(){return this})();!n&&typeof window<"u"&&(n=window),!n&&typeof self<"u"&&(n=self),n.ace||(n.ace=t);for(var p in t)t.hasOwnProperty(p)&&(n.ace[p]=t[p]);n.ace.default=n.ace,l&&(l.exports=n.ace)})})()})(Jo)),Jo.exports}var sa=av();const lv=Rt(sa),cv="/formeo/assets/js/mode-json.min.js",uv="/formeo/assets/js/theme-github_light_default.min.js";var es,wu;function hv(){if(wu)return es;wu=1;function l(e,t,n,p){var d=-1,g=e==null?0:e.length;for(p&&g&&(n=e[++d]);++d<g;)n=t(n,e[d],d,e);return n}return es=l,es}var ts,bu;function dv(){if(bu)return ts;bu=1;function l(e){return function(t){return e?.[t]}}return ts=l,ts}var ns,Cu;function fv(){if(Cu)return ns;Cu=1;var l=dv(),e={À:"A",Á:"A",Â:"A",Ã:"A",Ä:"A",Å:"A",à:"a",á:"a",â:"a",ã:"a",ä:"a",å:"a",Ç:"C",ç:"c",Ð:"D",ð:"d",È:"E",É:"E",Ê:"E",Ë:"E",è:"e",é:"e",ê:"e",ë:"e",Ì:"I",Í:"I",Î:"I",Ï:"I",ì:"i",í:"i",î:"i",ï:"i",Ñ:"N",ñ:"n",Ò:"O",Ó:"O",Ô:"O",Õ:"O",Ö:"O",Ø:"O",ò:"o",ó:"o",ô:"o",õ:"o",ö:"o",ø:"o",Ù:"U",Ú:"U",Û:"U",Ü:"U",ù:"u",ú:"u",û:"u",ü:"u",Ý:"Y",ý:"y",ÿ:"y",Æ:"Ae",æ:"ae",Þ:"Th",þ:"th",ß:"ss",Ā:"A",Ă:"A",Ą:"A",ā:"a",ă:"a",ą:"a",Ć:"C",Ĉ:"C",Ċ:"C",Č:"C",ć:"c",ĉ:"c",ċ:"c",č:"c",Ď:"D",Đ:"D",ď:"d",đ:"d",Ē:"E",Ĕ:"E",Ė:"E",Ę:"E",Ě:"E",ē:"e",ĕ:"e",ė:"e",ę:"e",ě:"e",Ĝ:"G",Ğ:"G",Ġ:"G",Ģ:"G",ĝ:"g",ğ:"g",ġ:"g",ģ:"g",Ĥ:"H",Ħ:"H",ĥ:"h",ħ:"h",Ĩ:"I",Ī:"I",Ĭ:"I",Į:"I",İ:"I",ĩ:"i",ī:"i",ĭ:"i",į:"i",ı:"i",Ĵ:"J",ĵ:"j",Ķ:"K",ķ:"k",ĸ:"k",Ĺ:"L",Ļ:"L",Ľ:"L",Ŀ:"L",Ł:"L",ĺ:"l",ļ:"l",ľ:"l",ŀ:"l",ł:"l",Ń:"N",Ņ:"N",Ň:"N",Ŋ:"N",ń:"n",ņ:"n",ň:"n",ŋ:"n",Ō:"O",Ŏ:"O",Ő:"O",ō:"o",ŏ:"o",ő:"o",Ŕ:"R",Ŗ:"R",Ř:"R",ŕ:"r",ŗ:"r",ř:"r",Ś:"S",Ŝ:"S",Ş:"S",Š:"S",ś:"s",ŝ:"s",ş:"s",š:"s",Ţ:"T",Ť:"T",Ŧ:"T",ţ:"t",ť:"t",ŧ:"t",Ũ:"U",Ū:"U",Ŭ:"U",Ů:"U",Ű:"U",Ų:"U",ũ:"u",ū:"u",ŭ:"u",ů:"u",ű:"u",ų:"u",Ŵ:"W",ŵ:"w",Ŷ:"Y",ŷ:"y",Ÿ:"Y",Ź:"Z",Ż:"Z",Ž:"Z",ź:"z",ż:"z",ž:"z",Ĳ:"IJ",ĳ:"ij",Œ:"Oe",œ:"oe",ŉ:"'n",ſ:"s"},t=l(e);return ns=t,ns}var is,Su;function pv(){if(Su)return is;Su=1;var l=fv(),e=Vn(),t=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,n="\\u0300-\\u036f",p="\\ufe20-\\ufe2f",d="\\u20d0-\\u20ff",g=n+p+d,m="["+g+"]",c=RegExp(m,"g");function f(r){return r=e(r),r&&r.replace(t,l).replace(c,"")}return is=f,is}var rs,Au;function gv(){if(Au)return rs;Au=1;var l=/[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g;function e(t){return t.match(l)||[]}return rs=e,rs}var os,$u;function mv(){if($u)return os;$u=1;var l=/[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;function e(t){return l.test(t)}return os=e,os}var ss,xu;function vv(){if(xu)return ss;xu=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",p=e+t+n,d="\\u2700-\\u27bf",g="a-z\\xdf-\\xf6\\xf8-\\xff",m="\\xac\\xb1\\xd7\\xf7",c="\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf",f="\\u2000-\\u206f",r=" \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",o="A-Z\\xc0-\\xd6\\xd8-\\xde",s="\\ufe0e\\ufe0f",a=m+c+f+r,i="['’]",u="["+a+"]",h="["+p+"]",y="\\d+",w="["+d+"]",M="["+g+"]",$="[^"+l+a+y+d+g+o+"]",A="\\ud83c[\\udffb-\\udfff]",S="(?:"+h+"|"+A+")",E="[^"+l+"]",R="(?:\\ud83c[\\udde6-\\uddff]){2}",L="[\\ud800-\\udbff][\\udc00-\\udfff]",_="["+o+"]",D="\\u200d",b="(?:"+M+"|"+$+")",v="(?:"+_+"|"+$+")",C="(?:"+i+"(?:d|ll|m|re|s|t|ve))?",x="(?:"+i+"(?:D|LL|M|RE|S|T|VE))?",T=S+"?",k="["+s+"]?",O="(?:"+D+"(?:"+[E,R,L].join("|")+")"+k+T+")*",I="\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",N="\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",P=k+T+O,B="(?:"+[w,R,L].join("|")+")"+P,F=RegExp([_+"?"+M+"+"+C+"(?="+[u,_,"$"].join("|")+")",v+"+"+x+"(?="+[u,_+b,"$"].join("|")+")",_+"?"+b+"+"+C,_+"+"+x,N,I,y,B].join("|"),"g");function H(z){return z.match(F)||[]}return ss=H,ss}var as,Mu;function yv(){if(Mu)return as;Mu=1;var l=gv(),e=mv(),t=Vn(),n=vv();function p(d,g,m){return d=t(d),g=m?void 0:g,g===void 0?e(d)?n(d):l(d):d.match(g)||[]}return as=p,as}var ls,Eu;function wv(){if(Eu)return ls;Eu=1;var l=hv(),e=pv(),t=yv(),n="['’]",p=RegExp(n,"g");function d(g){return function(m){return l(t(e(m).replace(p,"")),g,"")}}return ls=d,ls}var cs,_u;function bv(){if(_u)return cs;_u=1;function l(e,t,n){var p=-1,d=e.length;t<0&&(t=-t>d?0:d+t),n=n>d?d:n,n<0&&(n+=d),d=t>n?0:n-t>>>0,t>>>=0;for(var g=Array(d);++p<d;)g[p]=e[p+t];return g}return cs=l,cs}var us,Tu;function Cv(){if(Tu)return us;Tu=1;var l=bv();function e(t,n,p){var d=t.length;return p=p===void 0?d:p,!n&&p>=d?t:l(t,n,p)}return us=e,us}var hs,Lu;function od(){if(Lu)return hs;Lu=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",p=e+t+n,d="\\ufe0e\\ufe0f",g="\\u200d",m=RegExp("["+g+l+p+d+"]");function c(f){return m.test(f)}return hs=c,hs}var ds,Ru;function Sv(){if(Ru)return ds;Ru=1;function l(e){return e.split("")}return ds=l,ds}var fs,ku;function Av(){if(ku)return fs;ku=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",p=e+t+n,d="\\ufe0e\\ufe0f",g="["+l+"]",m="["+p+"]",c="\\ud83c[\\udffb-\\udfff]",f="(?:"+m+"|"+c+")",r="[^"+l+"]",o="(?:\\ud83c[\\udde6-\\uddff]){2}",s="[\\ud800-\\udbff][\\udc00-\\udfff]",a="\\u200d",i=f+"?",u="["+d+"]?",h="(?:"+a+"(?:"+[r,o,s].join("|")+")"+u+i+")*",y=u+i+h,w="(?:"+[r+m+"?",m,o,s,g].join("|")+")",M=RegExp(c+"(?="+c+")|"+w+y,"g");function $(A){return A.match(M)||[]}return fs=$,fs}var ps,Du;function $v(){if(Du)return ps;Du=1;var l=Sv(),e=od(),t=Av();function n(p){return e(p)?t(p):l(p)}return ps=n,ps}var gs,Ou;function xv(){if(Ou)return gs;Ou=1;var l=Cv(),e=od(),t=$v(),n=Vn();function p(d){return function(g){g=n(g);var m=e(g)?t(g):void 0,c=m?m[0]:g.charAt(0),f=m?l(m,1).join(""):g.slice(1);return c[d]()+f}}return gs=p,gs}var ms,Iu;function Mv(){if(Iu)return ms;Iu=1;var l=xv(),e=l("toUpperCase");return ms=e,ms}var vs,Nu;function Ev(){if(Nu)return vs;Nu=1;var l=wv(),e=Mv(),t=l(function(n,p,d){return n+(d?" ":"")+e(p)});return vs=t,vs}var _v=Ev();const Tv=Rt(_v);sa.config.setModuleUrl("ace/mode/json",cv);sa.config.setModuleUrl("ace/theme/github_light_default",uv);const tt=lv.edit("formData-editor");tt.session.setOption("useWorker",!1);tt.setOptions({theme:"ace/theme/github_light_default",mode:"ace/mode/json"});const Lv=document.getElementById("submit-formData"),Rv=document.getElementById("formData-popover"),kv=document.getElementById("editor-action-buttons"),Dv=(l,e)=>({renderForm:()=>{const t=document.querySelector(".render-form");t.style.display="block",e.render(l.formData)},getHtml:()=>{e.formData=l.formData;const t=e.html,n=window.open("","_blank");n.document.body.innerHTML=t},getUserData:()=>{console.log(e.userData)},resetEditor:()=>{window.sessionStorage.removeItem("formeo-formData"),window.location.reload()},editData:()=>{tt.setValue(JSON.stringify(l.formData,null,2),1)}}),Ov={editData:{popovertarget:"formData-popover"}},Iv=l=>{const e=Ov[l]||{};return{id:l,type:"button",...e}},Nv=(l,e)=>{Lv.addEventListener("click",()=>{l.formData=tt.session.getValue(),Rv.hidePopover()});const t=Dv(l,e);return Object.entries(t).map(([p,d])=>{const g=Iv(p),m=Object.assign(document.createElement("button"),g);for(const[f,r]of Object.entries(g))m.setAttribute(f,r);const c=document.createTextNode(Tv(p));return m.appendChild(c),m.addEventListener("click",d,!1),kv.appendChild(m),m})};document.getElementById("format-json").addEventListener("click",Fv);document.getElementById("collapse-json").addEventListener("click",Pv);document.getElementById("copy-json").addEventListener("click",Hv);function Fv(){const l=tt.session.getValue(),e=JSON.parse(l);tt.setValue(JSON.stringify(e,null,2),1)}function Pv(){const l=tt.session.getValue(),e=JSON.parse(l);tt.setValue(JSON.stringify(e,null,0),1)}async function Hv({target:l}){const e=l.textContent;l.textContent="Copied!";const t=setTimeout(()=>{l.textContent=e,clearTimeout(t)},3e3);try{await navigator.clipboard.writeText(tt.session.getValue()),console.log("Text copied to clipboard")}catch(n){console.error("Failed to copy: ",n)}}const Wv=l=>{const e=document.getElementById("control-filter"),t=document.getElementById("locale"),n=window.sessionStorage.getItem("formeo-locale"),p=({target:{value:g}})=>l.controls.actions.filter(g),d=({target:{value:g}})=>{window.sessionStorage.setItem("formeo-locale",g),l.i18n.setLang(g)};e.addEventListener("input",p),t.value=n||"en-US",t.addEventListener("change",d,!1)};async function zv(l){l.innerHTML=`
  ...
  `;const e=new ia(tn),t=new ra(oa);return Nv(e,t),Wv(e),{editor:e,renderer:t,cleanup:()=>{e?.destroy&&e.destroy(),t?.destroy&&t.destroy();const n=document.getElementById("editor-action-buttons");n&&(n.innerHTML="")}}}class Bv{constructor(){if(this.currentFramework=null,this.frameworkContainer=document.getElementById("framework-container"),this.frameworkSelect=document.getElementById("framework-select"),this.currentDemo=null,this.isLoading=!1,this.validFrameworks=["vanilla","angular","react"],!this.frameworkContainer){console.error("Framework container not found");return}if(!this.frameworkSelect){console.error("Framework selector not found");return}this.init()}init(){this.frameworkSelect.addEventListener("change",t=>{this.switchFramework(t.target.value)}),window.addEventListener("popstate",()=>{const t=this.getFrameworkFromURL();this.switchFramework(t,{updateURL:!1})});const e=this.getFrameworkFromURL();this.switchFramework(e)}async switchFramework(e,t={}){const{updateURL:n=!0}=t;if(this.isLoading){console.warn("Framework switch already in progress");return}if(!(this.currentFramework===e&&this.currentDemo!==null)){this.isLoading=!0,this.showLoadingState();try{switch(await this.cleanupCurrentDemo(),this.frameworkContainer.innerHTML="",e){case"vanilla":this.currentDemo=await zv(this.frameworkContainer);break;case"angular":this.currentDemo=await Um(this.frameworkContainer);break;case"react":this.currentDemo=await Jm(this.frameworkContainer);break;default:throw new Error(`Unknown framework: ${e}`)}this.currentFramework=e,this.syncFrameworkSelector(e),n&&this.updateURL(e),console.log(`Loaded ${e} demo successfully`)}catch(p){console.error(`Failed to load ${e} demo:`,p),this.showErrorState(e,p)}finally{this.isLoading=!1}}}async cleanupCurrentDemo(){if(this.currentDemo?.cleanup)try{await Promise.resolve(this.currentDemo.cleanup())}catch(e){console.warn("Error during demo cleanup:",e)}this.currentDemo=null}syncFrameworkSelector(e){this.frameworkSelect.value!==e&&(this.frameworkSelect.value=e)}getFrameworkFromURL(){const t=new URLSearchParams(window.location.search).get("framework");return t&&this.validFrameworks.includes(t)?t:"vanilla"}updateURL(e){const t=new URL(window.location);e==="vanilla"?t.searchParams.delete("framework"):t.searchParams.set("framework",e),window.history.pushState({framework:e},"",t.toString())}showLoadingState(){this.frameworkContainer.innerHTML=`
    ...
    `}}document.addEventListener("DOMContentLoaded",()=>{window.frameworkLoader=new Bv});export{ym as C,je as a,X as m,at as t};
