...
| [editorContainer](#editorcontainer) | String\|Node | define where this instance of Formeo will be added.                             | `'.editor-wrap'`            | `'.formeo-wrap'`                  |
| [svgSprite](#svgsprite)             | String       | loads an svg sprite                                                             | `'path/to/svsprite'`        | `'https://.../formeo-sprite.svg'` |
